...
public class LoggingManager {
	private static final String LOGFILE_NAME = "Java2PCM.log";
	...
	private static String getConfigFileLocation() {
		String logConfigDir = Activator.getDefault().getPreferenceStore()
				.getString(Code2ModelPreferences.log4jConfigDir);
		IPath confFilePath = new Path(logConfigDir);
		confFilePath = confFilePath.append(Code2ModelPreferences.LOG4J_CONFIGFILE_NAME);

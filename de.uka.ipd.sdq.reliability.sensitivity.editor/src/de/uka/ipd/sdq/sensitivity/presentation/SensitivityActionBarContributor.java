...
/**
 * This is the action bar contributor for the Sensitivity model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class SensitivityActionBarContributor extends EditingDomainActionBarContributor implements
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(
                SensitivityEditorPlugin.INSTANCE.getString("_UI_SensitivityEditor_menu"),
                "de.uka.ipd.sdq.sensitivityMenuID");
        ...
        createChildMenuManager = new MenuManager(
                SensitivityEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(
                SensitivityEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

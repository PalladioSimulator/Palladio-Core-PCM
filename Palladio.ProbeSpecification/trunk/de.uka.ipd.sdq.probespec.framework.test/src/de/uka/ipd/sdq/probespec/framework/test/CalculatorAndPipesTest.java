...
public class CalculatorAndPipesTest extends TestCase {
	...
	private Edp2RawWriteStrategy writeStrategy;
	...
	protected void setUp() throws Exception {
		...
		writeStrategy = new Edp2RawWriteStrategy();
	...
	public void testSimulation() {
		...
		ProbeSetSample pss1 = new ProbeSetSample(psv1,
				new RequestContextID("1"), "Model_1", "ProbeSetID_1");
		...
		ProbeSetSample pss2 = new ProbeSetSample(psv2,
				new RequestContextID("1"), "Model_2", "ProbeSetID_2");

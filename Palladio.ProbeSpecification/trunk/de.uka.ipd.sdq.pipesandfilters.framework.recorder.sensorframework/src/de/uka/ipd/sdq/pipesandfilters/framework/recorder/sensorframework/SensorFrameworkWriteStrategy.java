...
public class SensorFrameworkWriteStrategy implements IRawWriteStrategy {
	...
	private static Logger logger = Logger
			.getLogger(SensorFrameworkWriteStrategy.class.getName());
	 ...
	 * has written data that has not yet been flushed; true false.
	 */
	...
	public void initialize(MetaDataInit metaData) {
		...
		if (metaData.getMetricName().equals("Response Time")) {
			...
			writeDataStrategy = new OverallUtilisationWriteDataStrategy(daoFactory,
					experiment, run);
		}

...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.pipesandfilters.Filter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Filter_successors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Filter_successors_feature", "_UI_Filter_type"),
				 pipesandfiltersPackage.Literals.FILTER__SUCCESSORS,
				 true,
				 false,
				 true,
				 null,

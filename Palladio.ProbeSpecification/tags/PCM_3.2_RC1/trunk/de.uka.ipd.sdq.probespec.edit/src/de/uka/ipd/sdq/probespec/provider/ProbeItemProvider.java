...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.probespec.Probe} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProbeItemProvider
	...
	public String getText(Object object) {
		String label = ((Probe)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Probe_type") :
			getString("_UI_Probe_type") + " " + label;
	}

...
public class BeforeReturnValueLoggingPositionLinkItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addProvidedFunctionOfSurroundingSeffPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Provided Function Of Surrounding Seff feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addProvidedFunctionOfSurroundingSeffPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BeforeReturnValueLoggingPositionLink_providedFunctionOfSurroundingSeff_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BeforeReturnValueLoggingPositionLink_providedFunctionOfSurroundingSeff_feature", "_UI_BeforeReturnValueLoggingPositionLink_type"),
				 LoggerlinkPackage.Literals.BEFORE_RETURN_VALUE_LOGGING_POSITION_LINK__PROVIDED_FUNCTION_OF_SURROUNDING_SEFF,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LoggerlinkPackage.Literals.BEFORE_RETURN_VALUE_LOGGING_POSITION_LINK__PARAMETER_LINK);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BeforeReturnValueLoggingPositionLink.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LoggerlinkPackage.Literals.BEFORE_RETURN_VALUE_LOGGING_POSITION_LINK__PARAMETER_LINK,
				 GastPcmLinkFactory.eINSTANCE.createParameterLink()));
	}

...
public class DelayItemProvider extends AbstractUserActionItemProvider implements IEditingDomainItemProvider,
    ...
    public String getText(Object object) {
        String label = ((Delay) object).getId();
        return label == null || label.length() == 0 ? getString("_UI_Delay_type") : getString("_UI_Delay_type") + " "
                + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(UsagemodelPackage.Literals.DELAY__TIME_SPECIFICATION_DELAY,

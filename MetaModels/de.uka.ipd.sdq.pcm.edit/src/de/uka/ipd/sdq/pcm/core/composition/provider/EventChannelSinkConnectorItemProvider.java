...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.pcm.core.composition.EventChannelSinkConnector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventChannelSinkConnectorItemProvider
	 ...
	 * @generated
	 */
	public EventChannelSinkConnectorItemProvider(AdapterFactory adapterFactory) {
	 ...
	 * @generated
	 */
	protected void addSinkRole__EventChannelSinkConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventChannelSinkConnector_sinkRole__EventChannelSinkConnector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventChannelSinkConnector_sinkRole__EventChannelSinkConnector_feature", "_UI_EventChannelSinkConnector_type"),
	...
	/**
	 * This adds a property descriptor for the Assembly Context Event Channel Sink Connector feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAssemblyContext__EventChannelSinkConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CompositionPackage.Literals.EVENT_CHANNEL_SINK_CONNECTOR__FILTER_CONDITION_EVENT_CHANNEL_SINK_CONNECTOR);
		}
	...
	/**
	 * This returns EventChannelSinkConnector.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EventChannelSinkConnector"));
	}
	...
	public String getText(Object object) {
		String label = ((EventChannelSinkConnector)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_EventChannelSinkConnector_type") :
			getString("_UI_EventChannelSinkConnector_type") + " " + label;
	}

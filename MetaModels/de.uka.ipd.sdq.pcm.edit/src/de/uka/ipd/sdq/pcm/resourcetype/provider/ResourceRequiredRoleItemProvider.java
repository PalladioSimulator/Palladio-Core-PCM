...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.pcm.resourcetype.ResourceRequiredRole} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceRequiredRoleItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRequiredResourceInterface_ResourceRequiredRolePropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addRequiredResourceInterface_ResourceRequiredRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceRequiredRole_requiredResourceInterface_ResourceRequiredRole_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceRequiredRole_requiredResourceInterface_ResourceRequiredRole_feature", "_UI_ResourceRequiredRole_type"),
				 ResourcetypePackage.Literals.RESOURCE_REQUIRED_ROLE__REQUIRED_RESOURCE_INTERFACE_RESOURCE_REQUIRED_ROLE,
				 true,
				 false,
				 true,
				 null,

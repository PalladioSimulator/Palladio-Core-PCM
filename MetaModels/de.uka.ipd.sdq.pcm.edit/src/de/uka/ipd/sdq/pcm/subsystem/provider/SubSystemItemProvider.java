 ...
 * $Id$
 */
package de.uka.ipd.sdq.pcm.subsystem.provider;
 ...
 * @generated
 */
public class SubSystemItemProvider extends ComposedProvidingRequiringEntityItemProvider implements
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SubSystem_type") : getString("_UI_SubSystem_type")
                + " " + label;
    }

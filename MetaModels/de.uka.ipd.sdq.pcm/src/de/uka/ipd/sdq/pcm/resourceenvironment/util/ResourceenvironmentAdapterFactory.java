...
public class ResourceenvironmentAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ResourceenvironmentSwitch<Adapter> modelSwitch = new ResourceenvironmentSwitch<Adapter>() {
        ...
        public Adapter caseEModelElement(final EModelElement object) {
            return ResourceenvironmentAdapterFactory.this.createEModelElementAdapter();
        }

        @Override
        public Adapter caseStereotypableElement(final StereotypableElement object) {
            return ResourceenvironmentAdapterFactory.this.createStereotypableElementAdapter();
        }

        @Override
        public Adapter caseProfileableElement(final ProfileableElement object) {
            return ResourceenvironmentAdapterFactory.this.createProfileableElementAdapter();
        }

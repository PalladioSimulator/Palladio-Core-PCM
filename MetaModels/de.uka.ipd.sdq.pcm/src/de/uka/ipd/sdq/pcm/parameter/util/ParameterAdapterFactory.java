...
public class ParameterAdapterFactory extends AdapterFactoryImpl {
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link de.uka.ipd.sdq.pcm.parameter.CharacterisedVariable <em>Characterised Variable</em>}'.
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link de.uka.ipd.sdq.pcm.parameter.VariableUsage <em>Variable Usage</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     * 

...
public class SystemPackageImpl extends EPackageImpl implements SystemPackage {
    ...
    public static SystemPackage init() {
        ...
        final SystemPackageImpl theSystemPackage = (SystemPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SystemPackageImpl ? EPackage.Registry.INSTANCE
    ...
    public void createPackageContents() {
        ...
        this.systemEClass = this.createEClass(SYSTEM);
        this.createEReference(this.systemEClass, SYSTEM__QOS_ANNOTATIONS_SYSTEM);
    }
    ...
    public void initializePackageContents() {
        ...
        this.initEClass(this.systemEClass, de.uka.ipd.sdq.pcm.system.System.class, "System", !IS_ABSTRACT,

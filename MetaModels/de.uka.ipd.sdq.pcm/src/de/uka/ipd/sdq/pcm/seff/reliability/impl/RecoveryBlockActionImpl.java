...
import de.uka.ipd.sdq.pcm.seff.reliability.util.ReliabilityValidator;
 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.reliability.impl.RecoveryBlockActionImpl#getRecoveryBlockAlternativeBehaviours_RecoveryBlockAction <em>Recovery Block Alternative Behaviours Recovery Block Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RecoveryBlockActionImpl extends AbstractInternalControlFlowActionImpl implements RecoveryBlockAction {
	...
	protected EClass eStaticClass() {
		return ReliabilityPackage.Literals.RECOVERY_BLOCK_ACTION;
	}
	...
	public EList<RecoveryBlockAlternativeBehaviour> getRecoveryBlockAlternativeBehaviours_RecoveryBlockAction() {
		if (recoveryBlockAlternativeBehaviours_RecoveryBlockAction == null) {
			recoveryBlockAlternativeBehaviours_RecoveryBlockAction = new EObjectContainmentWithInverseEList<RecoveryBlockAlternativeBehaviour>(RecoveryBlockAlternativeBehaviour.class, this, ReliabilityPackage.RECOVERY_BLOCK_ACTION__RECOVERY_BLOCK_ALTERNATIVE_BEHAVIOURS_RECOVERY_BLOCK_ACTION, ReliabilityPackage.RECOVERY_BLOCK_ALTERNATIVE_BEHAVIOUR__RECOVERY_BLOCK_ACTION_RECOVERY_BLOCK_ALTERNATIVE_BEHAVIOUR);
		}
	...
	public boolean Alternativesformachain(DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (ALTERNATIVESFORMACHAIN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ReliabilityPackage.Literals.RECOVERY_BLOCK_ACTION);
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ReliabilityValidator.RECOVERY_BLOCK_ACTION__ALTERNATIVESFORMACHAIN,

 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.resourceenvironment.ResourceContainer#getNumberOfReplicas_ResourceContainer <em>Number Of Replicas Resource Container</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ResourceContainer extends Entity {
	...
	/**
	 * Returns the value of the '<em><b>Number Of Replicas Resource Container</b></em>' attribute.
	 * The default value is <code>"1"</code>.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Number Of Replicas Resource Container</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Number Of Replicas Resource Container</em>' attribute.
	 * @see #setNumberOfReplicas_ResourceContainer(int)
	 * @see de.uka.ipd.sdq.pcm.resourceenvironment.ResourceenvironmentPackage#getResourceContainer_NumberOfReplicas_ResourceContainer()
	 * @model default="1" required="true" ordered="false"
	 * @generated
	 */
	int getNumberOfReplicas_ResourceContainer();

	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.resourceenvironment.ResourceContainer#getNumberOfReplicas_ResourceContainer <em>Number Of Replicas Resource Container</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Number Of Replicas Resource Container</em>' attribute.
	 * @see #getNumberOfReplicas_ResourceContainer()
	 * @generated
	 */
	void setNumberOfReplicas_ResourceContainer(int value);

...
public interface EntityPackage extends EPackage {
     ...
     * @ordered
     */
    int ENTITY__EANNOTATIONS = IdentifierPackage.IDENTIFIER__EANNOTATIONS;
     ...
     * @ordered
     */
    int RESOURCE_PROVIDED_ROLE__EANNOTATIONS = RepositoryPackage.ROLE__EANNOTATIONS;
     ...
     * @ordered
     */
    int INTERFACE_PROVIDING_ENTITY__EANNOTATIONS = ENTITY__EANNOTATIONS;
     ...
     * @ordered
     */
    int INTERFACE_PROVIDING_REQUIRING_ENTITY__EANNOTATIONS = INTERFACE_PROVIDING_ENTITY__EANNOTATIONS;
     ...
     * @ordered
     */
    int INTERFACE_REQUIRING_ENTITY__EANNOTATIONS = ENTITY__EANNOTATIONS;
     ...
     * @ordered
     */
    int RESOURCE_INTERFACE_REQUIRING_ENTITY__EANNOTATIONS = ENTITY__EANNOTATIONS;
     ...
     * @ordered
     */
    int RESOURCE_REQUIRED_ROLE__EANNOTATIONS = RepositoryPackage.ROLE__EANNOTATIONS;
     ...
     * @ordered
     */
    int RESOURCE_INTERFACE_PROVIDING_ENTITY__EANNOTATIONS = ENTITY__EANNOTATIONS;
     ...
     * @ordered
     */
    int COMPOSED_PROVIDING_REQUIRING_ENTITY__EANNOTATIONS = CompositionPackage.COMPOSED_STRUCTURE__EANNOTATIONS;
     ...
     * @ordered
     */
    int RESOURCE_INTERFACE_PROVIDING_REQUIRING_ENTITY__EANNOTATIONS = RESOURCE_INTERFACE_REQUIRING_ENTITY__EANNOTATIONS;

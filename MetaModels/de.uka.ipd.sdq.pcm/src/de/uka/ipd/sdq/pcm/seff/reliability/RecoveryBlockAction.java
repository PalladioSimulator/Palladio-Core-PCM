 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.reliability.RecoveryBlockAction#getRecoveryBlockAlternativeBehaviours_RecoveryBlockAction <em>Recovery Block Alternative Behaviours Recovery Block Action</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.pcm.seff.reliability.ReliabilityPackage#getRecoveryBlockAction()
 * @model
 * @generated
 */
public interface RecoveryBlockAction extends AbstractInternalControlFlowAction {
	 ...
	 * The list contents are of type {@link de.uka.ipd.sdq.pcm.seff.reliability.RecoveryBlockAlternativeBehaviour}.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.seff.reliability.RecoveryBlockAlternativeBehaviour#getRecoveryBlockAction_RecoveryBlockAlternativeBehaviour <em>Recovery Block Action Recovery Block Alternative Behaviour</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uka.ipd.sdq.pcm.seff.reliability.ReliabilityPackage#getRecoveryBlockAction_RecoveryBlockAlternativeBehaviours_RecoveryBlockAction()

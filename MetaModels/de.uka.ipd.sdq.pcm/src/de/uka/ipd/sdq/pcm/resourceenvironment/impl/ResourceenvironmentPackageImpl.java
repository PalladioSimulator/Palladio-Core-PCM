...
public class ResourceenvironmentPackageImpl extends EPackageImpl implements ResourceenvironmentPackage {
	 ...
	 * @generated
	 */
	public EReference getResourceEnvironment_LinkingResources() {
	 ...
	 * @generated
	 */
	public EReference getLinkingResource_ConnectedResourceContainers() {
	 ...
	 * @generated
	 */
	public EReference getLinkingResource_CommunicationLinkResourceSpecifications() {
	...
	public void createPackageContents() {
		...
		createEReference(resourceEnvironmentEClass, RESOURCE_ENVIRONMENT__LINKING_RESOURCES);
		...
		createEReference(linkingResourceEClass, LINKING_RESOURCE__CONNECTED_RESOURCE_CONTAINERS);
		createEReference(linkingResourceEClass, LINKING_RESOURCE__COMMUNICATION_LINK_RESOURCE_SPECIFICATIONS);
	...
	public void initializePackageContents() {
		...
		initEReference(getResourceEnvironment_LinkingResources(), this.getLinkingResource(), null, "linkingResources", null, 0, -1, ResourceEnvironment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getLinkingResource_ConnectedResourceContainers(), this.getResourceContainer(), null, "connectedResourceContainers", null, 0, -1, LinkingResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getLinkingResource_CommunicationLinkResourceSpecifications(), this.getCommunicationLinkResourceSpecification(), null, "communicationLinkResourceSpecifications", null, 1, 1, LinkingResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

 ...
 * 
 * <!-- begin-model-doc -->
 * Collection&nbsp;Iterator&nbsp;Action&nbsp;Models&nbsp;the&nbsp;repeated&nbsp
 * ;execution&nbsp;of&nbsp
 * ;its&nbsp;inner&nbsp;ResourceDemandingBehaviour&nbsp;for&nbsp;each&nbsp;element
 * &nbsp;of&nbsp;a&nbsp
 * ;collection&nbsp;data&nbsp;type.&nbsp;Therefore&nbsp;it&nbsp;contains&nbsp;a&nbsp
 * ;reference&nbsp;to&nbsp;an&nbsp;input&nbsp;parameter&nbsp;of&nbsp;the&nbsp;service

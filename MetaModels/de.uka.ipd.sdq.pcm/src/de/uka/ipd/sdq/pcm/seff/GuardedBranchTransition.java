 ...
 * 
 * <!-- begin-model-doc -->
 * Guarded&nbsp;Branch&nbsp;Transition&nbsp;Provides&nbsp;a&nbsp;link&nbsp;between
 * &nbsp;a&nbsp;BranchAction
 * &nbsp;and&nbsp;a&nbsp;nested&nbsp;ResourceDemandingBehaviour,&nbsp;which&
 * nbsp;includes&nbsp;the&nbsp
 * ;actions&nbsp;executed&nbsp;inside&nbsp;the&nbsp;branch.&nbsp;It&nbsp;uses
 * &nbsp;a&nbsp;guard,&nbsp
 * ;i.e.&nbsp;a&nbsp;boolean&nbsp;expression&nbsp;specified&nbsp;by&nbsp;a&nbsp
 * ;RandomVariable,&nbsp;
 * to&nbsp;determine&nbsp;whether&nbsp;the&nbsp;transition&nbsp;is&nbsp;chosen.
 * &nbsp;If&nbsp;the&nbsp
 * ;guard&nbsp;evaluates&nbsp;to&nbsp;true,&nbsp;the&nbsp;branch&nbsp;is&nbsp;chosen
 * ,&nbsp;otherwise&
 ...
 * nbsp
 * ;languages&nbsp;such&nbsp;as&nbsp;C&nbsp;or&nbsp;Java,&nbsp;where&nbsp;the&nbsp;conditions&nbsp
 * ;on
 * &nbsp;if/then/else&nbsp;statements&nbsp;are&nbsp;evaluated&nbsp;in&nbsp;the&nbsp;order&nbsp;of&
 * nbsp;their&nbsp;appearance&nbsp;in&nbsp;the&nbsp;code.&nbsp;Such&nbsp;programming&nbsp;languages&
 * nbsp
 * ;allow&nbsp;overlapping&nbsp;branching&nbsp;conditions&nbsp;(for&nbsp;example,&nbsp;if&nbsp;(X
 * &lt;
 * 10)&nbsp;//...&nbsp;else&nbsp;if&nbsp;(X&lt;20)&nbsp;//&nbsp;...),&nbsp;which&nbsp;are&nbsp;not
 * &nbsp
 * ;allowed&nbsp;for&nbsp;the&nbsp;guards&nbsp;in&nbsp;GuardedBranchTransitions,&nbsp;because&nbsp
 * ;the&nbsp;missing&nbsp;order&nbsp;specification&nbsp;would&nbsp;lead&nbsp;to&nbsp;ambiguous&nbsp;
 * boolean
 * &nbsp;expressions&nbsp;and&nbsp;enable&nbsp;more&nbsp;than&nbsp;one&nbsp;guard&nbsp;to&nbsp
 * ;become
 * &nbsp;true.&nbsp;If&nbsp;X&nbsp;would&nbsp;have&nbsp;the&nbsp;value&nbsp;5,&nbsp;both&nbsp;
 * conditions
 * &nbsp;would&nbsp;evaluate&nbsp;to&nbsp;true&nbsp;if&nbsp;they&nbsp;would&nbsp;be&nbsp;used
 * &nbsp;directly
 * &nbsp;as&nbsp;guards&nbsp;in&nbsp;GuardedBranchTransitions.&nbsp;The&nbsp;correct&nbsp
 * ;specification
 * &nbsp;of&nbsp;the&nbsp;guards&nbsp;in&nbsp;this&nbsp;case&nbsp;would&nbsp;be&nbsp;X.
 * VALUE&nbsp;10&
 * nbsp;and&nbsp;X.VALUE&nbsp;10&nbsp;AND&nbsp;X.VALUE&nbsp;20.&nbsp;Guards&nbsp;might&
 * nbsp;lead&nbsp;to&nbsp;stochastic&nbsp;dependencies&nbsp;when&nbsp;evaluating&nbsp;variable&nbsp;
 * characterisations
 * &nbsp;inside&nbsp;a&nbsp;branched&nbsp;behaviour.&nbsp;For&nbsp;example,&nbsp;if&
 * nbsp;the&nbsp;guard
 * &nbsp;X.VALUE&nbsp;&nbsp;&nbsp;10&nbsp;had&nbsp;formerly&nbsp;evaluated&nbsp;to
 * &nbsp;true,&nbsp;and
 * &nbsp;the&nbsp;RDSEFF&nbsp;uses&nbsp;X.VALUE&nbsp;inside&nbsp;the&nbsp;branched
 * &nbsp;behaviour,&nbsp
 * ;the&nbsp;sample&nbsp;space&nbsp;of&nbsp;the&nbsp;random&nbsp;variable&nbsp;specifying
 * &nbsp;the&nbsp
 * ;characterisation&nbsp;must&nbsp;be&nbsp;restricted,&nbsp;as&nbsp;the&nbsp;event&nbsp
 * ;that&nbsp;X&
 * nbsp;takes&nbsp;a&nbsp;values&nbsp;greater&nbsp;than&nbsp;10&nbsp;cannot&nbsp;occur&nbsp
 * ;anymore.&
 * nbsp;Therefore&nbsp;its&nbsp;probability&nbsp;is&nbsp;zero.&nbsp;Any&nbsp;variable&nbsp;
 * characterisation

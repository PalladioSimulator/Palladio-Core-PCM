 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.pcm.repository.impl.CompositeComponentImpl#getRepository__RepositoryComponent
 * <em>Repository Repository Component</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.pcm.repository.impl.CompositeComponentImpl#getParentCompleteComponentTypes
 * <em>Parent Complete Component Types</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.pcm.repository.impl.CompositeComponentImpl#getComponentParameterUsage_ImplementationComponentType
 * <em>Component Parameter Usage Implementation Component Type</em>}</li>
 * <li>{@link de.uka.ipd.sdq.pcm.repository.impl.CompositeComponentImpl#getComponentType <em>
...
public class CompositeComponentImpl extends ComposedProvidingRequiringEntityImpl implements CompositeComponent {
    ...
    /**
     * The cached OCL expression body for the '
     * {@link #ProvideSameInterfaces(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * <em>Provide Same Interfaces</em>}' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * The cached OCL invariant for the '
     * {@link #ProvideSameInterfaces(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * <em>Provide Same Interfaces</em>}' invariant operation. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #ProvideSameInterfaces(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * @generated
    ...
    public boolean ProvideSameInterfaces(DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (PROVIDE_SAME_INTERFACES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
            ...
            try {
                PROVIDE_SAME_INTERFACES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
                        .createInvariant(PROVIDE_SAME_INTERFACES__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
            } catch (ParserException pe) {
                throw new UnsupportedOperationException(pe.getLocalizedMessage());
            }
        }
        if (!EOCL_ENV.createQuery(PROVIDE_SAME_INTERFACES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(this)) {
            if (diagnostics != null) {
                diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, RepositoryValidator.DIAGNOSTIC_SOURCE,
                        RepositoryValidator.COMPOSITE_COMPONENT__PROVIDE_SAME_INTERFACES, EcorePlugin.INSTANCE
                                .getString("_UI_GenericInvariant_diagnostic", new Object[] { "ProvideSameInterfaces",
    ...
    /**
     * The cached OCL expression body for the '
     * {@link #RequireSameInterfaces(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * <em>Require Same Interfaces</em>}' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * The cached OCL invariant for the '
     * {@link #RequireSameInterfaces(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * <em>Require Same Interfaces</em>}' invariant operation. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #RequireSameInterfaces(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * @generated
    ...
    public boolean RequireSameInterfaces(DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (REQUIRE_SAME_INTERFACES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
            ...
            helper.setContext(RepositoryPackage.Literals.COMPOSITE_COMPONENT);
            try {
                REQUIRE_SAME_INTERFACES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
                        .createInvariant(REQUIRE_SAME_INTERFACES__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
            } catch (ParserException pe) {
                throw new UnsupportedOperationException(pe.getLocalizedMessage());
            }
        }
        if (!EOCL_ENV.createQuery(REQUIRE_SAME_INTERFACES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(this)) {
            if (diagnostics != null) {
                diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, RepositoryValidator.DIAGNOSTIC_SOURCE,
                        RepositoryValidator.COMPOSITE_COMPONENT__REQUIRE_SAME_INTERFACES, EcorePlugin.INSTANCE
                                .getString("_UI_GenericInvariant_diagnostic", new Object[] { "RequireSameInterfaces",
                                        EObjectValidator.getObjectLabel(this, context) }), new Object[] { this }));
            }
            return false;
        }

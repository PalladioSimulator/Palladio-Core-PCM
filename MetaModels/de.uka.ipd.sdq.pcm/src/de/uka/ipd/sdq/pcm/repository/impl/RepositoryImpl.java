...
public class RepositoryImpl extends EntityImpl implements Repository {
	...
	public EList<FailureType> getFailureTypes__Repository() {
		if (failureTypes__Repository == null) {
			failureTypes__Repository = new EObjectContainmentWithInverseEList<FailureType>(FailureType.class, this, RepositoryPackage.REPOSITORY__FAILURE_TYPES_REPOSITORY, ReliabilityPackage.FAILURE_TYPE__REPOSITORY_FAILURE_TYPE);
		}
	...
	public EList<DataType> getDataTypes__Repository() {
		if (dataTypes__Repository == null) {
			dataTypes__Repository = new EObjectContainmentWithInverseEList<DataType>(DataType.class, this, RepositoryPackage.REPOSITORY__DATA_TYPES_REPOSITORY, RepositoryPackage.DATA_TYPE__REPOSITORY_DATA_TYPE);
		}

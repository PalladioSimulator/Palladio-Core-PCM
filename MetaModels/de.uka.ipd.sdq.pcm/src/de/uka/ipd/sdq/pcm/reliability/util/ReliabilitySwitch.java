	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ReliabilityPackage.HARDWARE_INDUCED_FAILURE_TYPE: {
				...
				if (result == null) result = caseStopFailureType(hardwareInducedFailureType);
			...
			case ReliabilityPackage.STOP_FAILURE_TYPE: {
			...
			case ReliabilityPackage.NETWORK_INDUCED_FAILURE_TYPE: {
				...
				if (result == null) result = caseStopFailureType(networkInducedFailureType);
			...
			case ReliabilityPackage.SOFTWARE_INDUCED_FAILURE_TYPE: {
				...
				if (result == null) result = caseStopFailureType(softwareInducedFailureType);

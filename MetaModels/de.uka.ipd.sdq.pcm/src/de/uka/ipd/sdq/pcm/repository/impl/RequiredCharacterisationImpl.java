 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.impl.RequiredCharacterisationImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.impl.RequiredCharacterisationImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.impl.RequiredCharacterisationImpl#getInterface_RequiredCharacterisation <em>Interface Required Characterisation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequiredCharacterisationImpl extends EObjectImpl implements RequiredCharacterisation {
	...
	public void setType(VariableCharacterisationType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.REQUIRED_CHARACTERISATION__TYPE, oldType, type));
	}
	...
	public Parameter getParameter() {
		if (parameter != null && parameter.eIsProxy()) {
			...
			if (parameter != oldParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RepositoryPackage.REQUIRED_CHARACTERISATION__PARAMETER, oldParameter, parameter));
			}
		}
		return parameter;
	}
	...
	public void setParameter(Parameter newParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.REQUIRED_CHARACTERISATION__PARAMETER, oldParameter, parameter));
	}
	...
	public NotificationChain basicSetInterface_RequiredCharacterisation(Interface newInterface_RequiredCharacterisation, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newInterface_RequiredCharacterisation, RepositoryPackage.REQUIRED_CHARACTERISATION__INTERFACE_REQUIRED_CHARACTERISATION, msgs);
		return msgs;
	}
	...
	public void setInterface_RequiredCharacterisation(Interface newInterface_RequiredCharacterisation) {
		if (newInterface_RequiredCharacterisation != eInternalContainer() || (eContainerFeatureID() != RepositoryPackage.REQUIRED_CHARACTERISATION__INTERFACE_REQUIRED_CHARACTERISATION && newInterface_RequiredCharacterisation != null)) {
			...
			if (newInterface_RequiredCharacterisation != null)
				msgs = ((InternalEObject)newInterface_RequiredCharacterisation).eInverseAdd(this, RepositoryPackage.INTERFACE__REQUIRED_CHARACTERISATIONS, Interface.class, msgs);
			msgs = basicSetInterface_RequiredCharacterisation(newInterface_RequiredCharacterisation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.REQUIRED_CHARACTERISATION__INTERFACE_REQUIRED_CHARACTERISATION, newInterface_RequiredCharacterisation, newInterface_RequiredCharacterisation));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case RepositoryPackage.REQUIRED_CHARACTERISATION__INTERFACE_REQUIRED_CHARACTERISATION:
				return eInternalContainer().eInverseRemove(this, RepositoryPackage.INTERFACE__REQUIRED_CHARACTERISATIONS, Interface.class, msgs);
		}

...
public class RepositoryPackageImpl extends EPackageImpl implements RepositoryPackage {
	 ...
	 * @generated
	 */
	public EReference getSignature_FailureTypes() {
	 ...
	 * @generated
	 */
	public EReference getRepository_Failuretype() {
	 ...
	 * @generated
	 */
	public EReference getFailureType_Repository() {
	...
	public void createPackageContents() {
		...
		createEReference(signatureEClass, SIGNATURE__FAILURE_TYPES);
		...
		createEReference(repositoryEClass, REPOSITORY__FAILURETYPE);
		...
		createEReference(failureTypeEClass, FAILURE_TYPE__REPOSITORY);
	...
	public void initializePackageContents() {
		...
		initEReference(getSignature_FailureTypes(), this.getFailureType(), null, "failureTypes", null, 0, -1, Signature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getRepository_Failuretype(), this.getFailureType(), this.getFailureType_Repository(), "failuretype", null, 0, -1, Repository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getFailureType_Repository(), this.getRepository(), this.getRepository_Failuretype(), "repository", null, 1, 1, FailureType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		op = addEOperation(environmentFailureTypeEClass, ecorePackage.getEBoolean(), "ExactlyOneType", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);

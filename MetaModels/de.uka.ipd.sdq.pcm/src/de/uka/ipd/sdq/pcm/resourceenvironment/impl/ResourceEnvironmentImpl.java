 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.resourceenvironment.impl.ResourceEnvironmentImpl#getLinkingResources <em>Linking Resources</em>}</li>
...
public class ResourceEnvironmentImpl extends EObjectImpl implements ResourceEnvironment {
	 ...
	 * @ordered
	 */
	protected EList<LinkingResource> linkingResources;
	 ...
	 * @generated
	 */
	public EList<LinkingResource> getLinkingResources() {
		if (linkingResources == null) {
			linkingResources = new EObjectContainmentEList<LinkingResource>(LinkingResource.class, this, ResourceenvironmentPackage.RESOURCE_ENVIRONMENT__LINKING_RESOURCES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourceenvironmentPackage.RESOURCE_ENVIRONMENT__LINKING_RESOURCES:
				...
				getLinkingResources().addAll((Collection<? extends LinkingResource>)newValue);
				return;
			case ResourceenvironmentPackage.RESOURCE_ENVIRONMENT__RESOURCE_CONTAINER_RESOURCE_ENVIRONMENT:

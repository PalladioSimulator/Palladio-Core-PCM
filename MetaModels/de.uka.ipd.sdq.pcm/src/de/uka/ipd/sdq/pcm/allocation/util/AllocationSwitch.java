...
public class AllocationSwitch<T> {
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        ...
        case AllocationPackage.ALLOCATION_CONTEXT: {
            ...
            if (result == null) {
                result = this.caseStereotypableElement(allocationContext);
            }
            if (result == null) {
                result = this.caseEModelElement(allocationContext);
            }
            if (result == null) {
        ...
        case AllocationPackage.ALLOCATION: {
            ...
            if (result == null) {
                result = this.caseProfileableElement(allocation);
            }
            if (result == null) {
            ...
            if (result == null) {
                result = this.caseStereotypableElement(allocation);
            }
            if (result == null) {
                result = this.caseEModelElement(allocation);
            }
            if (result == null) {
                result = this.defaultCase(theEObject);
            }

...
public class QosReliabilityPackageImpl extends EPackageImpl implements QosReliabilityPackage {
	...
	public static QosReliabilityPackage init() {
		if (isInited) return (QosReliabilityPackage)EPackage.Registry.INSTANCE.getEPackage(QosReliabilityPackage.eNS_URI);

		// Obtain or create and register package
		QosReliabilityPackageImpl theQosReliabilityPackage = (QosReliabilityPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof QosReliabilityPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new QosReliabilityPackageImpl());

...
public class ResourceSignatureImpl extends EntityImpl implements ResourceSignature {
     ...
     * <em>Parameter Resource Signature</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    public NotificationChain basicSetParameter__ResourceSignature(Parameter newParameter__ResourceSignature,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ...
                    oldParameter__ResourceSignature, newParameter__ResourceSignature);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setParameter__ResourceSignature(Parameter newParameter__ResourceSignature) {
        if (newParameter__ResourceSignature != parameter__ResourceSignature) {
            ...
            if (parameter__ResourceSignature != null)
                msgs = ((InternalEObject) parameter__ResourceSignature).eInverseRemove(this,
                        RepositoryPackage.PARAMETER__RESOURCE_SIGNATURE_PARAMETER, Parameter.class, msgs);
            if (newParameter__ResourceSignature != null)
                msgs = ((InternalEObject) newParameter__ResourceSignature).eInverseAdd(this,
                        RepositoryPackage.PARAMETER__RESOURCE_SIGNATURE_PARAMETER, Parameter.class, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ResourcetypePackage.RESOURCE_SIGNATURE__PARAMETER_RESOURCE_SIGNATURE,
                    newParameter__ResourceSignature, newParameter__ResourceSignature));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case ResourcetypePackage.RESOURCE_SIGNATURE__PARAMETER_RESOURCE_SIGNATURE:
            if (parameter__ResourceSignature != null)
                msgs = ((InternalEObject) parameter__ResourceSignature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ResourcetypePackage.RESOURCE_SIGNATURE__PARAMETER_RESOURCE_SIGNATURE, null, msgs);

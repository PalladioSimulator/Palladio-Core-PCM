...
public class ResourcetypeAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ResourcetypeSwitch<Adapter> modelSwitch = new ResourcetypeSwitch<Adapter>() {
        ...
        public Adapter caseEModelElement(final EModelElement object) {
            return ResourcetypeAdapterFactory.this.createEModelElementAdapter();
        }

        @Override
        public Adapter caseStereotypableElement(final StereotypableElement object) {
            return ResourcetypeAdapterFactory.this.createStereotypableElementAdapter();
        }
     ...
     * {@link de.uka.ipd.sdq.pcm.resourcetype.ResourceSignature <em>Resource Signature</em>}'. <!--
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link de.uka.ipd.sdq.pcm.resourcetype.ResourceType <em>Resource Type</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     *
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link de.uka.ipd.sdq.pcm.resourcetype.ResourceRepository <em>Resource Repository</em>}'.
     * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link de.uka.ipd.sdq.pcm.resourcetype.SchedulingPolicy <em>Scheduling Policy</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     *
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link de.uka.ipd.sdq.pcm.resourcetype.ResourceInterface <em>Resource Interface</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     *

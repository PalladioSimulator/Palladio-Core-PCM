 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.core.composition.impl.ConnectorImpl#getParentStructure__Connector <em>Parent Structure Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConnectorImpl extends EntityImpl implements Connector {
    ...
    public NotificationChain basicSetParentStructure__Connector(ComposedStructure newParentStructure__Connector,
        ...
        msgs = eBasicSetContainer((InternalEObject)newParentStructure__Connector, CompositionPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR, msgs);
        return msgs;
    }
    ...
    public void setParentStructure__Connector(ComposedStructure newParentStructure__Connector) {
        if (newParentStructure__Connector != eInternalContainer() || (eContainerFeatureID() != CompositionPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR && newParentStructure__Connector != null)) {
            ...
            if (newParentStructure__Connector != null)
                msgs = ((InternalEObject)newParentStructure__Connector).eInverseAdd(this, CompositionPackage.COMPOSED_STRUCTURE__CONNECTORS_COMPOSED_STRUCTURE, ComposedStructure.class, msgs);
            msgs = basicSetParentStructure__Connector(newParentStructure__Connector, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CompositionPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR, newParentStructure__Connector, newParentStructure__Connector));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case CompositionPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR:
                return eInternalContainer().eInverseRemove(this, CompositionPackage.COMPOSED_STRUCTURE__CONNECTORS_COMPOSED_STRUCTURE, ComposedStructure.class, msgs);
        }

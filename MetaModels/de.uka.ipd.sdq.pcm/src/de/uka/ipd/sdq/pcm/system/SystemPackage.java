...
public interface SystemPackage extends EPackage {
     ...
     * @ordered
     */
    int SYSTEM__EANNOTATIONS = MdsdprofilesPackage.PROFILEABLE_ELEMENT__EANNOTATIONS;
     ...
     * @ordered
     */
    int SYSTEM__PROFILEABLE_ELEMENT = MdsdprofilesPackage.PROFILEABLE_ELEMENT__PROFILEABLE_ELEMENT;
     ...
     * @ordered
     */
    int SYSTEM__ID = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int SYSTEM__ENTITY_NAME = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int SYSTEM__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int SYSTEM__RESOURCE_REQUIRED_DELEGATION_CONNECTORS_COMPOSED_STRUCTURE = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    int SYSTEM__EVENT_CHANNEL_COMPOSED_STRUCTURE = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
    int SYSTEM__CONNECTORS_COMPOSED_STRUCTURE = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 5;
     ...
     * @ordered
     */
    int SYSTEM__PROVIDED_ROLES_INTERFACE_PROVIDING_ENTITY = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 6;
     ...
     * @ordered
     */
    int SYSTEM__RESOURCE_REQUIRED_ROLES_RESOURCE_INTERFACE_REQUIRING_ENTITY = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 7;
     ...
     * @ordered
     */
    int SYSTEM__REQUIRED_ROLES_INTERFACE_REQUIRING_ENTITY = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 8;
     ...
     * @ordered
     */
    int SYSTEM__QOS_ANNOTATIONS_SYSTEM = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 9;
     ...
     * @ordered
     */
    int SYSTEM_FEATURE_COUNT = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 10;

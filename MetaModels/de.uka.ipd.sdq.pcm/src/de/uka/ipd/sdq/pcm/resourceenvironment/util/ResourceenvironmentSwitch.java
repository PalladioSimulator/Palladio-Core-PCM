...
public class ResourceenvironmentSwitch<T> {
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        ...
        case ResourceenvironmentPackage.RESOURCE_ENVIRONMENT: {
            ...
            if (result == null) {
                result = this.caseEModelElement(resourceEnvironment);
            }
            if (result == null) {
        ...
        case ResourceenvironmentPackage.LINKING_RESOURCE: {
            ...
            if (result == null) {
                result = this.caseEModelElement(linkingResource);
            }
            if (result == null) {
                result = this.defaultCase(theEObject);
            }
        ...
        case ResourceenvironmentPackage.RESOURCE_CONTAINER: {
            ...
            if (result == null) {
                result = this.caseEModelElement(resourceContainer);
            }
            if (result == null) {
                result = this.defaultCase(theEObject);
            }
        ...
        case ResourceenvironmentPackage.PROCESSING_RESOURCE_SPECIFICATION: {
            ...
            if (result == null) {
                result = this.caseEModelElement(processingResourceSpecification);
            }
            if (result == null) {
                result = this.defaultCase(theEObject);
            }
        ...
        case ResourceenvironmentPackage.COMMUNICATION_LINK_RESOURCE_SPECIFICATION: {
            ...
            if (result == null) {
                result = this.caseEModelElement(communicationLinkResourceSpecification);
            }
            if (result == null) {
                result = this.defaultCase(theEObject);
            }

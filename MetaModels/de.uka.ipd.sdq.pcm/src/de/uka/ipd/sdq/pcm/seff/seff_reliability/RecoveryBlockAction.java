 ...
 * <em><b>Recovery Block Action</b></em>'. <!-- end-user-doc -->
 * 
 ...
 * <em>Recovery Block Alternative Behaviours Recovery Block Action</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface RecoveryBlockAction extends AbstractInternalControlFlowAction {
     ...
     * @model opposite="recoveryBlockAction_RecoveryBlockAlternativeBehaviour" containment="true"
     *        lower="2" ordered="false"
     * @generated
     */
     ...
     * self.recoveryBlockAlternativeBehaviours_RecoveryBlockAction->isUnique(s:
     * RecoveryBlockAlternativeBehaviour | s.nextAlternative_RecoveryBlockAlternativeBehaviour) and
     * self.recoveryBlockAlternativeBehaviours_RecoveryBlockAction->forAll(x:
     * RecoveryBlockAlternativeBehaviour| x <> x.nextAlternative_RecoveryBlockAlternativeBehaviour)
     * 
     * @param diagnostics
     ...
     * @model annotation=
     *        "http://www.eclipse.org/uml2/1.1.0/GenModel body='self.recoveryBlockAlternativeBehaviours_RecoveryBlockAction->isUnique(s: RecoveryBlockAlternativeBehaviour | s.nextAlternative_RecoveryBlockAlternativeBehaviour) and\r\nself.recoveryBlockAlternativeBehaviours_RecoveryBlockAction->forAll(x:RecoveryBlockAlternativeBehaviour| x <> x.nextAlternative_RecoveryBlockAlternativeBehaviour)\r\n'"
     * @generated
     */

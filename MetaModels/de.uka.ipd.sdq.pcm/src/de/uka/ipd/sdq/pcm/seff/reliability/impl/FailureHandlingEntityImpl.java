 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.reliability.impl.FailureHandlingEntityImpl#getFailureTypes_FailureHandlingEntity <em>Failure Types Failure Handling Entity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FailureHandlingEntityImpl extends EntityImpl implements FailureHandlingEntity {
	...
	protected EClass eStaticClass() {
		return ReliabilityPackage.Literals.FAILURE_HANDLING_ENTITY;
	}
	...
	public EList<FailureType> getFailureTypes_FailureHandlingEntity() {
		if (failureTypes_FailureHandlingEntity == null) {
			failureTypes_FailureHandlingEntity = new EObjectResolvingEList<FailureType>(FailureType.class, this, ReliabilityPackage.FAILURE_HANDLING_ENTITY__FAILURE_TYPES_FAILURE_HANDLING_ENTITY);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReliabilityPackage.FAILURE_HANDLING_ENTITY__FAILURE_TYPES_FAILURE_HANDLING_ENTITY:

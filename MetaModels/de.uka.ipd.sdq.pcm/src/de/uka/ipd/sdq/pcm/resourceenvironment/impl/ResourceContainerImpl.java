 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.resourceenvironment.impl.ResourceContainerImpl#getNumberOfReplicas_ResourceContainer <em>Number Of Replicas Resource Container</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceContainerImpl extends EntityImpl implements ResourceContainer {
	...
	/**
	 * The default value of the '{@link #getNumberOfReplicas_ResourceContainer() <em>Number Of Replicas Resource Container</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getNumberOfReplicas_ResourceContainer()
	 * @generated
	 * @ordered
	 */
	protected static final int NUMBER_OF_REPLICAS_RESOURCE_CONTAINER_EDEFAULT = 1;

	/**
	 * The cached value of the '{@link #getNumberOfReplicas_ResourceContainer() <em>Number Of Replicas Resource Container</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getNumberOfReplicas_ResourceContainer()
	 * @generated
	 * @ordered
	 */
	protected int numberOfReplicas_ResourceContainer = NUMBER_OF_REPLICAS_RESOURCE_CONTAINER_EDEFAULT;
	 ...
	 * @generated
	 */
	public int getNumberOfReplicas_ResourceContainer() {
		return numberOfReplicas_ResourceContainer;
	}
	 ...
	 * @generated
	 */
	public void setNumberOfReplicas_ResourceContainer(int newNumberOfReplicas_ResourceContainer) {
		int oldNumberOfReplicas_ResourceContainer = numberOfReplicas_ResourceContainer;
		numberOfReplicas_ResourceContainer = newNumberOfReplicas_ResourceContainer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourceenvironmentPackage.RESOURCE_CONTAINER__NUMBER_OF_REPLICAS_RESOURCE_CONTAINER, oldNumberOfReplicas_ResourceContainer, numberOfReplicas_ResourceContainer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ResourceenvironmentPackage.RESOURCE_CONTAINER__NUMBER_OF_REPLICAS_RESOURCE_CONTAINER:
				return getNumberOfReplicas_ResourceContainer();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ResourceenvironmentPackage.RESOURCE_CONTAINER__RESOURCE_ENVIRONMENT_RESOURCE_CONTAINER:
				...
				return;
			case ResourceenvironmentPackage.RESOURCE_CONTAINER__NUMBER_OF_REPLICAS_RESOURCE_CONTAINER:
				setNumberOfReplicas_ResourceContainer((Integer)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ResourceenvironmentPackage.RESOURCE_CONTAINER__RESOURCE_ENVIRONMENT_RESOURCE_CONTAINER:
				...
				return;
			case ResourceenvironmentPackage.RESOURCE_CONTAINER__NUMBER_OF_REPLICAS_RESOURCE_CONTAINER:
				setNumberOfReplicas_ResourceContainer(NUMBER_OF_REPLICAS_RESOURCE_CONTAINER_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ResourceenvironmentPackage.RESOURCE_CONTAINER__NUMBER_OF_REPLICAS_RESOURCE_CONTAINER:
				return numberOfReplicas_ResourceContainer != NUMBER_OF_REPLICAS_RESOURCE_CONTAINER_EDEFAULT;
		}
	...
	public String toString() {
		...
		result.append(operatingSystem_ResourceContainer);
		result.append(", numberOfReplicas_ResourceContainer: ");
		result.append(numberOfReplicas_ResourceContainer);
		result.append(')');

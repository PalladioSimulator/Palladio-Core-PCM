 ...
 * </p>
 * <p>
 * TODO:&nbsp;We&nbsp;might&nbsp;want&nbsp;to&nbsp;add&nbsp;a&nbsp;constraint& nbsp
 * ;that&nbsp;both&nbsp;sides&nbsp;of&nbsp;the&nbsp;connector&nbsp;must&nbsp;
 * be&nbsp;not&nbsp;null.&nbsp;Then,&nbsp;we&nbsp;don
 * 't&nbsp;have&nbsp;to&nbsp;specify&nbsp;that&nbsp;for&nbsp;example&nbsp;for&nbsp;ComposedProvidingRequiringEntities&nbsp;that&nbsp;the&nbsp;ProvidedDelegationConnector&nbsp;actually&nbsp;points&nbsp;to&nbsp;something&nbsp;inner.&nbsp;If&nbsp;you&nbsp;decide&nbsp;not&nbsp;to&nbsp;add&nbsp;a&nbsp;constraint&nbsp;here,&nbsp;then&nbsp;we&nbsp;need&nbsp;a&nbsp;constraint&nbsp;there&nbsp;and&nbsp;maybe&nbsp;at&nbsp;other&nbsp;places&nbsp;--&nbsp;A
 * n n e
 * </p>
 * <!-- end-model-doc -->
 * 
 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.pcm.core.composition.Connector#getParentStructure__Connector <em>Parent
 * Structure Connector</em>}</li>
 * </ul>
 * </p>
 * 
 * @see de.uka.ipd.sdq.pcm.core.composition.CompositionPackage#getConnector()
 * @model abstract="true"
 * @generated
 */
public interface Connector extends Entity {
     ...
     * @see de.uka.ipd.sdq.pcm.core.composition.CompositionPackage#getConnector_ParentStructure__Connector()

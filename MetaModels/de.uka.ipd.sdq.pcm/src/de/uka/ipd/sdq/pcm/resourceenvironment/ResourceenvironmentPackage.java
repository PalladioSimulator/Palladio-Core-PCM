...
public interface ResourceenvironmentPackage extends EPackage {
     ...
     * @ordered
     */
    int RESOURCE_ENVIRONMENT__EANNOTATIONS = MdsdprofilesPackage.PROFILEABLE_ELEMENT__EANNOTATIONS;
     ...
     * @ordered
     */
    int RESOURCE_ENVIRONMENT__PROFILEABLE_ELEMENT = MdsdprofilesPackage.PROFILEABLE_ELEMENT__PROFILEABLE_ELEMENT;
     ...
     * @ordered
     */
    int RESOURCE_ENVIRONMENT__ENTITY_NAME = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int RESOURCE_ENVIRONMENT__LINKING_RESOURCES_RESOURCE_ENVIRONMENT = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int RESOURCE_ENVIRONMENT__RESOURCE_CONTAINER_RESOURCE_ENVIRONMENT = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int RESOURCE_ENVIRONMENT_FEATURE_COUNT = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    int LINKING_RESOURCE__EANNOTATIONS = EntityPackage.ENTITY__EANNOTATIONS;
     ...
     * @ordered
     */
    int LINKING_RESOURCE__PROFILEABLE_ELEMENT = EntityPackage.ENTITY__PROFILEABLE_ELEMENT;
     ...
     * @ordered
     */
    int RESOURCE_CONTAINER__EANNOTATIONS = EntityPackage.ENTITY__EANNOTATIONS;
     ...
     * @ordered
     */
    int RESOURCE_CONTAINER__PROFILEABLE_ELEMENT = EntityPackage.ENTITY__PROFILEABLE_ELEMENT;
     ...
     * @ordered
     */
    int PROCESSING_RESOURCE_SPECIFICATION__EANNOTATIONS = IdentifierPackage.IDENTIFIER__EANNOTATIONS;
     ...
     * @ordered
     */
    int PROCESSING_RESOURCE_SPECIFICATION__PROFILEABLE_ELEMENT = IdentifierPackage.IDENTIFIER__PROFILEABLE_ELEMENT;
     ...
     * @ordered
     */
    int COMMUNICATION_LINK_RESOURCE_SPECIFICATION__EANNOTATIONS = IdentifierPackage.IDENTIFIER__EANNOTATIONS;
     ...
     * @ordered
     */
    int COMMUNICATION_LINK_RESOURCE_SPECIFICATION__PROFILEABLE_ELEMENT = IdentifierPackage.IDENTIFIER__PROFILEABLE_ELEMENT;

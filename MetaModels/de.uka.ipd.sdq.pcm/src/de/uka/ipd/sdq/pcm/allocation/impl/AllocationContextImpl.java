...
public class AllocationContextImpl extends EntityImpl implements AllocationContext {
	...
	/**
	 * The cached OCL expression body for the '{@link #OneAssemblyContextOrOneEventChannelShouldBeReferred(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>One Assembly Context Or One Event Channel Should Be Referred</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

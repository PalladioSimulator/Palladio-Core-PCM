 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.core.composition.impl.AssemblyEventConnectorImpl#getFilterCondition__AssemblyEventConnector <em>Filter Condition Assembly Event Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssemblyEventConnectorImpl extends ConnectorImpl implements AssemblyEventConnector {
	...
	public NotificationChain basicSetFilterCondition__AssemblyEventConnector(PCMRandomVariable newFilterCondition__AssemblyEventConnector, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CompositionPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR, oldFilterCondition__AssemblyEventConnector, newFilterCondition__AssemblyEventConnector);
	...
	public void setFilterCondition__AssemblyEventConnector(PCMRandomVariable newFilterCondition__AssemblyEventConnector) {
		if (newFilterCondition__AssemblyEventConnector != filterCondition__AssemblyEventConnector) {
			...
			if (filterCondition__AssemblyEventConnector != null)
				msgs = ((InternalEObject)filterCondition__AssemblyEventConnector).eInverseRemove(this, CorePackage.PCM_RANDOM_VARIABLE__ASSEMBLY_EVENT_CONNECTOR_FILTER_CONDITION, PCMRandomVariable.class, msgs);
			if (newFilterCondition__AssemblyEventConnector != null)
				msgs = ((InternalEObject)newFilterCondition__AssemblyEventConnector).eInverseAdd(this, CorePackage.PCM_RANDOM_VARIABLE__ASSEMBLY_EVENT_CONNECTOR_FILTER_CONDITION, PCMRandomVariable.class, msgs);
			msgs = basicSetFilterCondition__AssemblyEventConnector(newFilterCondition__AssemblyEventConnector, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompositionPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR, newFilterCondition__AssemblyEventConnector, newFilterCondition__AssemblyEventConnector));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompositionPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR:
				if (filterCondition__AssemblyEventConnector != null)
					msgs = ((InternalEObject)filterCondition__AssemblyEventConnector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CompositionPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR, null, msgs);

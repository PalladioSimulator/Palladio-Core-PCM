...
public class SeffPerformancePackageImpl extends EPackageImpl implements SeffPerformancePackage {
    ...
    public void initializePackageContents() {
        ...
        initEClass(infrastructureCallEClass, InfrastructureCall.class, "InfrastructureCall", !IS_ABSTRACT,
        ...
        initEReference(getInfrastructureCall_NumberOfCalls__InfrastructureCall(),
        ...
        initEReference(getInfrastructureCall_Action__InfrastructureCall(),
                ...
                IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getInfrastructureCall_RequiredRole__InfrastructureCall(),
        ...
        EOperation op = addEOperation(infrastructureCallEClass, ecorePackage.getEBoolean(),
        ...
        op = addEOperation(infrastructureCallEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(resourceCallEClass, ResourceCall.class, "ResourceCall", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getResourceCall_Action__ResourceCall(), theSeffPackage.getAbstractInternalControlFlowAction(),
        ...
        initEReference(getResourceCall_Signature__ResourceCall(), theResourcetypePackage.getResourceSignature(), null,
                "signature__ResourceCall", null, 1, 1, ResourceCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getResourceCall_NumberOfCalls__ResourceCall(), theCorePackage.getPCMRandomVariable(),
        ...
        initEClass(parametricResourceDemandEClass, ParametricResourceDemand.class, "ParametricResourceDemand",
        ...
        initEReference(getParametricResourceDemand_Specification_ParametericResourceDemand(),
                ...
                !IS_ORDERED);
        initEReference(getParametricResourceDemand_RequiredResource_ParametricResourceDemand(),
        ...
        op = addEOperation(parametricResourceDemandEClass, ecorePackage.getEBoolean(),

...
public interface AllocationPackage extends EPackage {
     ...
     * @ordered
     */
    int ALLOCATION_CONTEXT__EANNOTATIONS = EntityPackage.ENTITY__EANNOTATIONS;
     ...
     * @ordered
     */
    int ALLOCATION_CONTEXT__PROFILEABLE_ELEMENT = EntityPackage.ENTITY__PROFILEABLE_ELEMENT;
     ...
     * @ordered
     */
    int ALLOCATION__EANNOTATIONS = MdsdprofilesPackage.PROFILEABLE_ELEMENT__EANNOTATIONS;
     ...
     * @ordered
     */
    int ALLOCATION__PROFILEABLE_ELEMENT = MdsdprofilesPackage.PROFILEABLE_ELEMENT__PROFILEABLE_ELEMENT;
     ...
     * @ordered
     */
    int ALLOCATION__ID = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int ALLOCATION__ENTITY_NAME = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int ALLOCATION__SYSTEM_ALLOCATION = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    int ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
    int ALLOCATION_FEATURE_COUNT = MdsdprofilesPackage.PROFILEABLE_ELEMENT_FEATURE_COUNT + 5;

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.impl.AbstractBranchTransitionImpl#getBranchAction_AbstractBranchTransition <em>Branch Action Abstract Branch Transition</em>}</li>
...
public abstract class AbstractBranchTransitionImpl extends EntityImpl implements AbstractBranchTransition {
    ...
    public NotificationChain basicSetBranchAction_AbstractBranchTransition(
        ...
        msgs = eBasicSetContainer((InternalEObject)newBranchAction_AbstractBranchTransition, SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION, msgs);
        return msgs;
    }
    ...
    public void setBranchAction_AbstractBranchTransition(BranchAction newBranchAction_AbstractBranchTransition) {
        if (newBranchAction_AbstractBranchTransition != eInternalContainer() || (eContainerFeatureID() != SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION && newBranchAction_AbstractBranchTransition != null)) {
            ...
            if (newBranchAction_AbstractBranchTransition != null)
                msgs = ((InternalEObject)newBranchAction_AbstractBranchTransition).eInverseAdd(this, SeffPackage.BRANCH_ACTION__BRANCHES_BRANCH, BranchAction.class, msgs);
            msgs = basicSetBranchAction_AbstractBranchTransition(newBranchAction_AbstractBranchTransition, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION, newBranchAction_AbstractBranchTransition, newBranchAction_AbstractBranchTransition));
    }
    ...
    public void setBranchBehaviour_BranchTransition(ResourceDemandingBehaviour newBranchBehaviour_BranchTransition) {
        if (newBranchBehaviour_BranchTransition != branchBehaviour_BranchTransition) {
            ...
            if (branchBehaviour_BranchTransition != null)
                msgs = ((InternalEObject)branchBehaviour_BranchTransition).eInverseRemove(this, SeffPackage.RESOURCE_DEMANDING_BEHAVIOUR__ABSTRACT_BRANCH_TRANSITION_RESOURCE_DEMANDING_BEHAVIOUR, ResourceDemandingBehaviour.class, msgs);
            if (newBranchBehaviour_BranchTransition != null)
                msgs = ((InternalEObject)newBranchBehaviour_BranchTransition).eInverseAdd(this, SeffPackage.RESOURCE_DEMANDING_BEHAVIOUR__ABSTRACT_BRANCH_TRANSITION_RESOURCE_DEMANDING_BEHAVIOUR, ResourceDemandingBehaviour.class, msgs);
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION:
                return eInternalContainer().eInverseRemove(this, SeffPackage.BRANCH_ACTION__BRANCHES_BRANCH, BranchAction.class, msgs);
        }

 ...
 * <li>{@link de.uka.ipd.sdq.pcm.resourcetype.impl.ResourceTypeImpl#getUnitSpecification <em>Unit
 * Specification</em>}</li>
 * <li>
...
public abstract class ResourceTypeImpl extends EntityImpl implements ResourceType {
    ...
    public void setUnitSpecification(String newUnitSpecification) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ResourcetypePackage.RESOURCE_TYPE__UNIT_SPECIFICATION, oldUnitSpecification, unitSpecification));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == UnitCarryingElement.class) {
            ...
            case ResourcetypePackage.RESOURCE_TYPE__UNIT_SPECIFICATION:
                return UnitsPackage.UNIT_CARRYING_ELEMENT__UNIT_SPECIFICATION;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == UnitCarryingElement.class) {
            ...
            case UnitsPackage.UNIT_CARRYING_ELEMENT__UNIT_SPECIFICATION:
                return ResourcetypePackage.RESOURCE_TYPE__UNIT_SPECIFICATION;
            default:
                return -1;
            }
        }

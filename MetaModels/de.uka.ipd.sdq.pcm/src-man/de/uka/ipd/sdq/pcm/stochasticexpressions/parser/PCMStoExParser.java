...
public class PCMStoExParser extends Parser {
    public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "AND", "OR",
            ...
            "MOD", "POW", "NOT", "NUMBER", "STRING_LITERAL", "DOT", "ID", "LPAREN", "RPAREN", "COLON", "INTPMF",
        ...
        try {
            ...
            // b1= boolOrExpr ( AND b2= boolOrExpr )*
            {
                ...
                loop2: do {
                    ...
                    // AND b2= boolOrExpr
                    {
                        BooleanOperatorExpression boolExprNew = StoexFactory.eINSTANCE
        ...
        try {
            ...
            // LPAREN (paramList= expressionList )? RPAREN
            {
                ...
                if ((LA14_0 == MINUS || (LA14_0 >= NOT && LA14_0 <= STRING_LITERAL)
                        ...
                        || (LA14_0 >= DOUBLEPMF && LA14_0 <= ENUMPMF) || (LA14_0 >= DOUBLEPDF && LA14_0 <= BOOLPMF) || (LA14_0 >= FALSE && LA14_0 <= TRUE))) {
                    alt14 = 1;
                }
                switch (alt14) {
                case 1:

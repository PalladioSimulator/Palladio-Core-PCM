...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Before External Call Logging Position Link</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.sourcecodedecorator.loggerlink.impl.BeforeExternalCallLoggingPositionLinkImpl#getCalledFunction <em>Called Function</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.sourcecodedecorator.loggerlink.impl.BeforeExternalCallLoggingPositionLinkImpl#getParameterLink <em>Parameter Link</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BeforeExternalCallLoggingPositionLinkImpl extends OutputLoggingPositionLinkImpl implements BeforeExternalCallLoggingPositionLink {
	 ...
	 * @generated
	 */
	protected BeforeExternalCallLoggingPositionLinkImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return LoggerlinkPackage.Literals.BEFORE_EXTERNAL_CALL_LOGGING_POSITION_LINK;
	}
	...
	public Function getCalledFunction() {
		if (calledFunction != null && calledFunction.eIsProxy()) {
			...
			if (calledFunction != oldCalledFunction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LoggerlinkPackage.BEFORE_EXTERNAL_CALL_LOGGING_POSITION_LINK__CALLED_FUNCTION, oldCalledFunction, calledFunction));
			}
		}
	...
	public void setCalledFunction(Function newCalledFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LoggerlinkPackage.BEFORE_EXTERNAL_CALL_LOGGING_POSITION_LINK__CALLED_FUNCTION, oldCalledFunction, calledFunction));
	}
	...
	public EList<ParameterLink> getParameterLink() {
		if (parameterLink == null) {
			parameterLink = new EObjectContainmentEList<ParameterLink>(ParameterLink.class, this, LoggerlinkPackage.BEFORE_EXTERNAL_CALL_LOGGING_POSITION_LINK__PARAMETER_LINK);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LoggerlinkPackage.BEFORE_EXTERNAL_CALL_LOGGING_POSITION_LINK__PARAMETER_LINK:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LoggerlinkPackage.BEFORE_EXTERNAL_CALL_LOGGING_POSITION_LINK__CALLED_FUNCTION:
...
} //BeforeExternalCallLoggingPositionLinkImpl

 ...
 * <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.pcm.resultdecorator.resourceenvironmentdecorator.util.ResourceenvironmentdecoratorResourceImpl
 * @generated
 */
public class ResourceenvironmentdecoratorResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Resource createResource(URI uri) {
		XMLResource result = new ResourceenvironmentdecoratorResourceImpl(uri);

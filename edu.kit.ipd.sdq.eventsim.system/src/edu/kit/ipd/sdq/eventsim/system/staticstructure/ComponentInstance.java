...
public class ComponentInstance {
    ...
    private final EventSimSystemModel model;
     ...
     */
    public ComponentInstance(final EventSimSystemModel model, final BasicComponent type, final AssemblyContext assemblyCtx,

 ...
 * ExternalCallActions accept input parameters and can return output parameters, both of which are realised by modifying
 * the current stack frame (see: {@link StackContext}). These modifications are performed by this command, once
 * installed.
 * 

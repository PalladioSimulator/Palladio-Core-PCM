 ...
 * 
 */
public class ReleaseActionTraversalStrategy implements ITraversalStrategy<AbstractAction, ReleaseAction, Request, RequestState> {

    /**
     * {@inheritDoc}
     */
    @Override
    public ITraversalInstruction<AbstractAction, RequestState> traverse(ReleaseAction action, Request request, RequestState state) {

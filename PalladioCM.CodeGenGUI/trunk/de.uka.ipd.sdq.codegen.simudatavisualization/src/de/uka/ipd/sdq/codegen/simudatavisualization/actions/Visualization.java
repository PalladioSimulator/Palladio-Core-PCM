...
//	public static final String DEFAULT_CONFIG_FILE = "src/de/uka/ipd/sdq/probfunction/visualization/resource/defalutconfig.xml";
//
...
//		}
//
//		ChartSwtViewer csv = new ChartSwtViewer(null,0,idr, cm);
//
//		IViewDescriptor reportView;
//		IViewDescriptor[] views = Activator.getDefault().getWorkbench().getViewRegistry().getViews();
//		
//		reportView = views[1];
//		
//		try {
...
//		cCenter.addControlListener((ControlListener) csv);
//		sh.open();
//		while (!sh.isDisposed()) {

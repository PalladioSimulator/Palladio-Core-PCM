 ...
 * 
 */
public class SensorsView extends ViewPart {

	public static TableViewer viewer;

	private String[] columnNames = new String[] { ICON_COLUMN,SENSOR_NAME_COLUMN};

	public final static String ICON_COLUMN	= "";
	public final static String SENSOR_NAME_COLUMN 	= "Sensor Name";

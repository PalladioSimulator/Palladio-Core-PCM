/* 
VULNERABILITY 
- vb.java.class.12 - Call Overridable Methods in Clone Method

DOES
- select all the non final funtions that are called in a clone method

OBSERVATION 
- non final method = method is not final and  method class is not final 

MESSAGE
- This method calles in clone method is overridable. Either make it final or validate the output.
*/
...
function.Name 		AS ElementName, /* element = overridable method in clone method */

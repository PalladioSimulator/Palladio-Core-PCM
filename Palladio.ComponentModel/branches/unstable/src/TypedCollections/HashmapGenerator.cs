...
namespace Palladio.ComponentModel.TypedCollections
{
    ...
    #endregion
    #region Interface IIServiceCollection

    /// <summary>
    /// Defines size, enumerators, and synchronization methods for strongly
    /// typed collections of <see cref="IService"/> elements.
    /// </summary>
    /// <remarks>
    /// <b>IIServiceCollection</b> provides an <see cref="ICollection"/>
    /// that is strongly typed for <see cref="IService"/> elements.
    /// </remarks>

    internal interface IIServiceCollection {
        #region Properties
        #region Count

        /// <summary>
        /// Gets the number of elements contained in the
        /// <see cref="IIServiceCollection"/>.
        /// </summary>
        /// <value>The number of elements contained in the
        /// <see cref="IIServiceCollection"/>.</value>
        /// <remarks>Please refer to <see cref="ICollection.Count"/> for details.</remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether access to the
        /// <see cref="IIServiceCollection"/> is synchronized (thread-safe).
        /// </summary>
        /// <value><c>true</c> if access to the <see cref="IIServiceCollection"/> is
        /// synchronized (thread-safe); otherwise, <c>false</c>. The default is <c>false</c>.</value>
        /// <remarks>Please refer to <see cref="ICollection.IsSynchronized"/> for details.</remarks>
        ...
        /// <summary>
        /// Gets an object that can be used to synchronize access
        /// to the <see cref="IIServiceCollection"/>.
        /// </summary>
        /// <value>An object that can be used to synchronize access
        /// to the <see cref="IIServiceCollection"/>.</value>
        /// <remarks>Please refer to <see cref="ICollection.SyncRoot"/> for details.</remarks>
        ...
        /// <summary>
        /// Copies the entire <see cref="IIServiceCollection"/> to a one-dimensional <see cref="Array"/>
        /// of <see cref="IService"/> elements, starting at the specified index of the target array.
        /// </summary>
        /// <param name="array">The one-dimensional <see cref="Array"/> that is the destination of the
        /// <see cref="IService"/> elements copied from the <see cref="IIServiceCollection"/>.
        /// The <b>Array</b> must have zero-based indexing.</param>
        /// <param name="arrayIndex">The zero-based index in <paramref name="array"/>
        /// at which copying begins.</param>
        /// <exception cref="ArgumentNullException">
        ...
        /// <paramref name="arrayIndex"/> is equal to or greater than the length of <paramref name="array"/>.
        /// </para><para>-or-</para><para>
        /// The number of elements in the source <see cref="IIServiceCollection"/> is greater
        /// than the available space from <paramref name="arrayIndex"/> to the end of the destination
        /// <paramref name="array"/>.</para></exception>
        /// <remarks>Please refer to <see cref="ICollection.CopyTo"/> for details.</remarks>

        void CopyTo(IService[] array, int arrayIndex);

        #endregion
        #region GetEnumerator

        /// <summary>
        /// Returns an <see cref="IIServiceEnumerator"/> that can
        /// iterate through the <see cref="IIServiceCollection"/>.
        /// </summary>
        /// <returns>An <see cref="IIServiceEnumerator"/>
        /// for the entire <see cref="IIServiceCollection"/>.</returns>
        /// <remarks>Please refer to <see cref="IEnumerable.GetEnumerator"/> for details.</remarks>

        IIServiceEnumerator GetEnumerator();
    ...
    #endregion
    #region Interface IIServiceList

    /// <summary>
    /// Represents a strongly typed collection of <see cref="IService"/>
    /// objects that can be individually accessed by index.
    /// </summary>
    /// <remarks>
    /// <b>IIServiceList</b> provides an <see cref="IList"/>
    /// that is strongly typed for <see cref="IService"/> elements.
    /// </remarks>

    internal interface
        IIServiceList: IIServiceCollection {
        #region Properties
        #region IsFixedSize

        /// <summary>
        /// Gets a value indicating whether the <see cref="IIServiceList"/> has a fixed size.
        /// </summary>
        /// <value><c>true</c> if the <see cref="IIServiceList"/> has a fixed size;
        /// otherwise, <c>false</c>. The default is <c>false</c>.</value>
        /// <remarks>Please refer to <see cref="IList.IsFixedSize"/> for details.</remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="IIServiceList"/> is read-only.
        /// </summary>
        /// <value><c>true</c> if the <see cref="IIServiceList"/> is read-only;
        /// otherwise, <c>false</c>. The default is <c>false</c>.</value>
        /// <remarks>Please refer to <see cref="IList.IsReadOnly"/> for details.</remarks>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IService"/> element at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index of the
        /// <see cref="IService"/> element to get or set.</param>
        /// <value>
        /// The <see cref="IService"/> element at the specified <paramref name="index"/>.
        /// </value>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
        /// <para>-or-</para>
        /// <para><paramref name="index"/> is equal to or greater than
        /// <see cref="IIServiceCollection.Count"/>.</para>
        /// </exception>
        /// <exception cref="NotSupportedException">
        /// The property is set and the <see cref="IIServiceList"/> is read-only.</exception>
        /// <remarks>Please refer to <see cref="IList.this"/> for details.</remarks>

        IService this[int index] { get; set; }
        ...
        /// <summary>
        /// Adds a <see cref="IService"/> to the end
        /// of the <see cref="IIServiceList"/>.
        /// </summary>
        /// <param name="value">The <see cref="IService"/> object
        /// to be added to the end of the <see cref="IIServiceList"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <returns>The <see cref="IIServiceList"/> index at which
        /// the <paramref name="value"/> has been added.</returns>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IIServiceList"/> is read-only.</para>
        /// <para>-or-</para>
        /// <para>The <b>IIServiceList</b> has a fixed size.</para></exception>
        /// <remarks>Please refer to <see cref="IList.Add"/> for details.</remarks>

        int Add(IService value);

        #endregion
        #region Clear

        /// <summary>
        /// Removes all elements from the <see cref="IIServiceList"/>.
        /// </summary>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IIServiceList"/> is read-only.</para>
        /// <para>-or-</para>
        ...
        /// <summary>
        /// Determines whether the <see cref="IIServiceList"/>
        /// contains the specified <see cref="IService"/> element.
        /// </summary>
        /// <param name="value">The <see cref="IService"/> object
        /// to locate in the <see cref="IIServiceList"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <returns><c>true</c> if <paramref name="value"/> is found in the
        /// <see cref="IIServiceList"/>; otherwise, <c>false</c>.</returns>
        /// <remarks>Please refer to <see cref="IList.Contains"/> for details.</remarks>

        bool Contains(IService value);
        ...
        /// <summary>
        /// Returns the zero-based index of the first occurrence of the specified
        /// <see cref="IService"/> in the <see cref="IIServiceList"/>.
        /// </summary>
        /// <param name="value">The <see cref="IService"/> object
        /// to locate in the <see cref="IIServiceList"/>.
        /// This argument can be a null reference.
        ...
        /// <returns>
        /// The zero-based index of the first occurrence of <paramref name="value"/>
        /// in the <see cref="IIServiceList"/>, if found; otherwise, -1.
        /// </returns>
        /// <remarks>Please refer to <see cref="IList.IndexOf"/> for details.</remarks>

        int IndexOf(IService value);

        #endregion
        #region Insert

        /// <summary>
        /// Inserts a <see cref="IService"/> element into the
        /// <see cref="IIServiceList"/> at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which
        /// <paramref name="value"/> should be inserted.</param>
        /// <param name="value">The <see cref="IService"/> object
        /// to insert into the <see cref="IIServiceList"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
        ...
        void Insert(int index, IService value);

        #endregion
        #region Remove

        /// <summary>
        /// Removes the first occurrence of the specified <see cref="IService"/>
        /// from the <see cref="IIServiceList"/>.
        /// </summary>
        /// <param name="value">The <see cref="IService"/> object
        /// to remove from the <see cref="IIServiceList"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IIServiceList"/> is read-only.</para>
    ...
    #endregion
    #region Interface IIServiceEnumerator

    /// <summary>
    /// Supports type-safe iteration over a collection that
    /// contains <see cref="IService"/> elements.
    /// </summary>
    /// <remarks>
    /// <b>IIServiceEnumerator</b> provides an <see cref="IEnumerator"/>
    /// that is strongly typed for <see cref="IService"/> elements.
    /// </remarks>

    internal interface IIServiceEnumerator {
        #region Properties
        #region Current

        /// <summary>
        /// Gets the current <see cref="IService"/> element in the collection.
        /// </summary>
        /// <value>The current <see cref="IService"/> element in the collection.</value>
        /// <exception cref="InvalidOperationException"><para>The enumerator is positioned
        /// before the first element of the collection or after the last element.</para>
        /// <para>-or-</para>
        /// <para>The collection was modified after the enumerator was created.</para></exception>
    ...
    #endregion
    #region Interface IIServiceIServiceEffectSpecificationCollection
    ...
    /// </summary>
    /// <remarks>
    /// <b>IIServiceIServiceEffectSpecificationCollection</b> provides an <see cref="ICollection"/>
    /// that is strongly typed for <see cref="IServiceEntry"/> elements.
    /// </remarks>

    internal interface IIServiceIServiceEffectSpecificationCollection {
        #region Properties
        #region Count

        /// <summary>
        /// Gets the number of elements contained in the
        /// <see cref="IIServiceIServiceEffectSpecificationCollection"/>.
        /// </summary>
        /// <value>The number of elements contained in the
        /// <see cref="IIServiceIServiceEffectSpecificationCollection"/>.</value>
        /// <remarks>Please refer to <see cref="ICollection.Count"/> for details.</remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether access to the
        /// <see cref="IIServiceIServiceEffectSpecificationCollection"/> is synchronized (thread-safe).
        /// </summary>
        /// <value><c>true</c> if access to the <see cref="IIServiceIServiceEffectSpecificationCollection"/>
        /// is synchronized (thread-safe); otherwise, <c>false</c>. The default is <c>false</c>.</value>
        /// <remarks>Please refer to <see cref="ICollection.IsSynchronized"/> for details.</remarks>
        ...
        /// <summary>
        /// Gets an object that can be used to synchronize access
        /// to the <see cref="IIServiceIServiceEffectSpecificationCollection"/>.
        /// </summary>
        /// <value>An object that can be used to synchronize access to the
        /// <see cref="IIServiceIServiceEffectSpecificationCollection"/>.</value>
        /// <remarks>Please refer to <see cref="ICollection.SyncRoot"/> for details.</remarks>
        ...
        /// <summary>
        /// Copies the entire <see cref="IIServiceIServiceEffectSpecificationCollection"/>
        ...
        /// <paramref name="arrayIndex"/> is equal to or greater than the length of <paramref name="array"/>.
        /// </para><para>-or-</para><para>
        /// The number of elements in the source <see cref="IIServiceIServiceEffectSpecificationCollection"/>
        /// is greater than the available space from <paramref name="arrayIndex"/> to the end of the
        /// destination <paramref name="array"/>.</para></exception>
        /// <remarks>Please refer to <see cref="ICollection.CopyTo"/> for details.</remarks>
        ...
        /// <summary>
        /// Returns an <see cref="IIServiceIServiceEffectSpecificationEnumerator"/> that can
        /// iterate through the <see cref="IIServiceIServiceEffectSpecificationCollection"/>.
        /// </summary>
        /// <returns>An <see cref="IIServiceIServiceEffectSpecificationEnumerator"/>
        /// for the entire <see cref="IIServiceIServiceEffectSpecificationCollection"/>.</returns>
        /// <remarks>Please refer to <see cref="IEnumerable.GetEnumerator"/> for details.</remarks>

        IIServiceIServiceEffectSpecificationEnumerator GetEnumerator();
    ...
    #endregion
    #region Interface IIServiceIServiceEffectSpecificationDictionary
    ...
    /// </summary>
    /// <remarks>
    /// <b>IIServiceIServiceEffectSpecificationDictionary</b> provides an
    /// <see cref="IDictionary"/> that is strongly typed for
    /// <see cref="IService"/> keys and <see cref="IServiceEffectSpecification"/> values.
    /// </remarks>

    internal interface
        IIServiceIServiceEffectSpecificationDictionary: IIServiceIServiceEffectSpecificationCollection {
        #region Properties
        #region IsFixedSize

        /// <summary>
        /// Gets a value indicating whether the
        /// <see cref="IIServiceIServiceEffectSpecificationDictionary"/> has a fixed size.
        /// </summary>
        /// <value><c>true</c> if the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>
        /// has a fixed size; otherwise, <c>false</c>. The default is <c>false</c>.</value>
        /// <remarks>Please refer to <see cref="IDictionary.IsFixedSize"/> for details.</remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether the
        /// <see cref="IIServiceIServiceEffectSpecificationDictionary"/> is read-only.
        /// </summary>
        /// <value><c>true</c> if the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>
        /// is read-only; otherwise, <c>false</c>. The default is <c>false</c>.</value>
        /// <remarks>Please refer to <see cref="IDictionary.IsReadOnly"/> for details.</remarks>
        ...
        /// associated with the specified <see cref="IService"/> key.
        /// </summary>
        /// <param name="key">The <see cref="IService"/> key
        /// whose value to get or set.</param>
        ...
        /// <exception cref="NotSupportedException">
        /// <para>The property is set and the
        /// <see cref="IIServiceIServiceEffectSpecificationDictionary"/> is read-only.</para>
        /// <para>-or-</para>
        /// <para>The property is set, <paramref name="key"/> does not exist in the collection,
        /// and the <b>IIServiceIServiceEffectSpecificationDictionary</b> has a fixed size.</para>
        /// </exception>
        /// <remarks>Please refer to <see cref="IDictionary.this"/> for details.</remarks>

        IServiceEffectSpecification this[IService key] { get; set; }

        #endregion
        #region Keys

        /// <summary>
        /// Gets an <see cref="IIServiceCollection"/> containing the keys
        /// in the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.
        /// </summary>
        /// <value>An <see cref="IIServiceCollection"/> containing the keys
        /// in the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.</value>
        /// <remarks>Please refer to <see cref="IDictionary.Keys"/> for details.</remarks>

        IIServiceCollection Keys { get; }
        ...
        /// <summary>
        /// Adds an element with the specified <see cref="IService"/>
        /// key and <see cref="IServiceEffectSpecification"/> value to the
        /// <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.
        /// </summary>
        /// <param name="key">The <see cref="IService"/> key of the element
        /// to add to the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.</param>
        /// <param name="value">The <see cref="IServiceEffectSpecification"/> value of the element
        /// to add to the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.
        /// This argument can be a null reference.
        /// </param>
        /// <exception cref="ArgumentException">
        /// <para>An element with the specified <paramref name="key"/> already exists
        /// in the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.</para>
        /// <para>-or-</para>
        /// <para>The <b>IIServiceIServiceEffectSpecificationDictionary</b> is set to use the
        /// <see cref="IComparable"/> interface, and <paramref name="key"/> does not
        /// implement the <b>IComparable</b> interface.</para></exception>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="key"/> is a null reference.</exception>
        ...
        /// The comparer throws an exception.</exception>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IIServiceIServiceEffectSpecificationDictionary"/> is read-only.
        /// </para><para>-or-</para>
        /// <para>The <b>IIServiceIServiceEffectSpecificationDictionary</b> has a fixed size.
        /// </para></exception>
        /// <remarks>Please refer to <see cref="IDictionary.Add"/> for details.</remarks>

        void Add(IService key, IServiceEffectSpecification value);

        #endregion
        #region Clear

        /// <summary>
        /// Removes all elements from the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.
        /// </summary>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IIServiceIServiceEffectSpecificationDictionary"/> is read-only.
        /// </para><para>-or-</para>
        ...
        /// <summary>
        /// Determines whether the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>
        /// contains the specified <see cref="IService"/> key.
        /// </summary>
        /// <param name="key">The <see cref="IService"/> key to locate
        /// in the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.</param>
        /// <returns><c>true</c> if the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>
        /// contains an element with the specified <paramref name="key"/>; otherwise, <c>false</c>.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="key"/> is a null reference.</exception>
        ...
        bool Contains(IService key);

        #endregion
        #region Remove

        /// <summary>
        /// Removes the element with the specified <see cref="IService"/> key
        /// from the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.
        /// </summary>
        /// <param name="key">The <see cref="IService"/> key of the element to remove
        /// from the <see cref="IIServiceIServiceEffectSpecificationDictionary"/>.</param>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="key"/> is a null reference.</exception>
        /// <exception cref="InvalidOperationException">
        /// The comparer throws an exception.</exception>
    ...
    #endregion
    #region Interface IIServiceIServiceEffectSpecificationList
    ...
    /// </summary>
    /// <remarks>
    /// <b>IIServiceIServiceEffectSpecificationList</b> provides an <see cref="IList"/>
    /// that is strongly typed for <see cref="IServiceEntry"/> elements.
    /// </remarks>

    internal interface
        IIServiceIServiceEffectSpecificationList: IIServiceIServiceEffectSpecificationCollection {
        #region Properties
        #region IsFixedSize

        /// <summary>
        /// Gets a value indicating whether the
        /// <see cref="IIServiceIServiceEffectSpecificationList"/> has a fixed size.
        /// </summary>
        /// <value><c>true</c> if the <see cref="IIServiceIServiceEffectSpecificationList"/>
        /// has a fixed size; otherwise, <c>false</c>. The default is <c>false</c>.</value>
        /// <remarks>Please refer to <see cref="IList.IsFixedSize"/> for details.</remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether the
        /// <see cref="IIServiceIServiceEffectSpecificationList"/> is read-only.
        /// </summary>
        /// <value><c>true</c> if the <see cref="IIServiceIServiceEffectSpecificationList"/>
        /// is read-only; otherwise, <c>false</c>. The default is <c>false</c>.</value>
        /// <remarks>Please refer to <see cref="IList.IsReadOnly"/> for details.</remarks>
        ...
        /// <para>-or-</para>
        /// <para><paramref name="index"/> is equal to or greater than
        /// <see cref="IIServiceIServiceEffectSpecificationCollection.Count"/>.</para>
        /// </exception>
        /// <exception cref="NotSupportedException">The property is set and the
        /// <see cref="IIServiceIServiceEffectSpecificationList"/> is read-only.</exception>
        /// <remarks>Please refer to <see cref="IList.this"/> for details.</remarks>
        ...
        /// of the <see cref="IIServiceIServiceEffectSpecificationList"/>.
        /// </summary>
        /// <param name="entry">The <see cref="IServiceEntry"/> object
        /// to be added to the end of the <see cref="IIServiceIServiceEffectSpecificationList"/>.
        /// </param>
        /// <returns>The <see cref="IIServiceIServiceEffectSpecificationList"/> index at which
        /// the <paramref name="entry"/> has been added.</returns>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IIServiceIServiceEffectSpecificationList"/> is read-only.</para>
        /// <para>-or-</para>
        /// <para>The <b>IIServiceIServiceEffectSpecificationList</b> has a fixed size.</para>
        /// </exception>
        /// <remarks>Please refer to <see cref="IList.Add"/> for details.</remarks>
        ...
        /// <summary>
        /// Removes all elements from the <see cref="IIServiceIServiceEffectSpecificationList"/>.
        /// </summary>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IIServiceIServiceEffectSpecificationList"/> is read-only.</para>
        /// <para>-or-</para>
        ...
        /// <summary>
        /// Determines whether the <see cref="IIServiceIServiceEffectSpecificationList"/>
        /// contains the specified <see cref="IServiceEntry"/> element.
        /// </summary>
        /// <param name="entry">The <see cref="IServiceEntry"/> object
        /// to locate in the <see cref="IIServiceIServiceEffectSpecificationList"/>.</param>
        /// <returns><c>true</c> if <paramref name="entry"/> is found in the
        /// <see cref="IIServiceIServiceEffectSpecificationList"/>; otherwise, <c>false</c>.</returns>
        /// <remarks>Please refer to <see cref="IList.Contains"/> for details.</remarks>
        ...
        /// <summary>
        /// Returns the zero-based index of the first occurrence of the specified
        /// <see cref="IServiceEntry"/> in the <see cref="IIServiceIServiceEffectSpecificationList"/>.
        /// </summary>
        /// <param name="entry">The <see cref="IServiceEntry"/> object
        /// to locate in the <see cref="IIServiceIServiceEffectSpecificationList"/>.</param>
        /// <returns>
        /// The zero-based index of the first occurrence of <paramref name="entry"/>
        /// in the <see cref="IIServiceIServiceEffectSpecificationList"/>, if found; otherwise, -1.
        /// </returns>
        /// <remarks>Please refer to <see cref="IList.IndexOf"/> for details.</remarks>
        ...
        /// <see cref="IIServiceIServiceEffectSpecificationList"/> at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which
        /// <paramref name="entry"/> should be inserted.</param>
        /// <param name="entry">The <see cref="IServiceEntry"/> object to insert
        /// into the <see cref="IIServiceIServiceEffectSpecificationList"/>.</param>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
        /// <para>-or-</para>
        /// <para><paramref name="index"/> is greater than
        ...
        /// <para>The <see cref="IIServiceIServiceEffectSpecificationList"/> is read-only.</para>
        /// <para>-or-</para>
        /// <para>The <b>IIServiceIServiceEffectSpecificationList</b> has a fixed size.</para></exception>
        /// <remarks>Please refer to <see cref="IList.Insert"/> for details.</remarks>
        ...
        /// from the <see cref="IIServiceIServiceEffectSpecificationList"/>.
        /// </summary>
        /// <param name="entry">The <see cref="IServiceEntry"/> object to remove
        /// from the <see cref="IIServiceIServiceEffectSpecificationList"/>.</param>
        /// <exception cref="NotSupportedException">
        /// <para>The <see cref="IIServiceIServiceEffectSpecificationList"/> is read-only.</para>
        /// <para>-or-</para>
        /// <para>The <b>IIServiceIServiceEffectSpecificationList</b> has a fixed size.</para></exception>
        ...
        /// <summary>
        /// Removes the element at the specified index of the
        /// <see cref="IIServiceIServiceEffectSpecificationList"/>.
        /// </summary>
        /// <param name="index">The zero-based index of the element to remove.</param>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <para><paramref name="index"/> is less than zero.</para>
    ...
    #endregion
    #region Interface IIServiceIServiceEffectSpecificationEnumerator
    ...
    /// </summary>
    /// <remarks>
    /// <b>IIServiceIServiceEffectSpecificationEnumerator</b> provides an
    /// <see cref="IDictionaryEnumerator"/> that is strongly typed for
    /// <see cref="IService"/> keys and <see cref="IServiceEffectSpecification"/> values.
    /// </remarks>

    internal interface IIServiceIServiceEffectSpecificationEnumerator {
        #region Properties
        #region Current
        ...
        /// <summary>
        /// Gets the <see cref="IService"/> key of the current dictionary entry.
        /// </summary>
        /// <value>The <see cref="IService"/> key
        /// of the current element of the enumeration.</value>
        /// <exception cref="InvalidOperationException"><para>The enumerator is positioned
        /// before the first element of the dictionary or after the last element.</para>
        /// <para>-or-</para>
    ...
    /// <summary>
    /// Implements a strongly typed pair of one <see cref="IService"/>
    ...
    /// typed for <see cref="IService"/> keys and <see cref="IServiceEffectSpecification"/> values.
    /// </remarks>
    ...
    internal struct IServiceEntry {
        ...
        /// </summary>
        /// <param name="key">
        /// The <see cref="IService"/> key in the key-and-value pair.</param>
        /// <param name="value">
        ...
        public IServiceEntry(IService key, IServiceEffectSpecification value) {
            if ((object) key == null)
                throw new ArgumentNullException("key");
        ...
        /// <summary>
        /// Gets or sets the <see cref="IService"/> key in the key-and-value pair.
        /// </summary>
        /// <value>
        /// The <see cref="IService"/> key in the key-and-value pair.
        /// The default is a null reference.
        /// </value>
        /// <exception cref="ArgumentNullException">
        /// <b>Key</b> is set to a null reference.</exception>
        ...
        public static implicit operator IServiceEntry(DictionaryEntry entry) {
            ...
            if (entry.Key != null) pair.Key = (IService) entry.Key;
    ...
    /// for <see cref="IService"/> keys and <see cref="IServiceEffectSpecification"/> values.
    /// </remarks>

    [Serializable]
    internal class ServiceEffectHashmap:
        IIServiceIServiceEffectSpecificationDictionary, IDictionary, ICloneable {
        #region Private Fields
        ...
        #endregion
        #region Item[IService]: IServiceEffectSpecification
        ...
        public IServiceEffectSpecification this[IService key] {
            get {
        ...
        /// </summary>
        /// <param name="key">The key whose value to get or set.
        /// This argument must be compatible with <see cref="IService"/>.</param>
        /// <value>
        /// The value associated with the specified <paramref name="key"/>. If the specified
        /// <paramref name="key"/> is not found, attempting to get it returns
        /// a null reference,
        ...
        /// <paramref name="key"/> is a null reference.</exception>
        /// <exception cref="InvalidCastException">
        /// <para><paramref name="key"/> is not compatible with <see cref="IService"/>.</para>
        /// <para>-or-</para>
        /// <para>The property is set to a value that is not compatible with
        ...
        object IDictionary.this[object key] {
            get { return this[(IService) key]; }
            set { this[(IService) key] = (IServiceEffectSpecification) value; }
        }

        #endregion
        #region Keys: IIServiceCollection

        /// <summary>
        /// Gets an <see cref="IIServiceCollection"/> containing
        /// the keys in the <see cref="ServiceEffectHashmap"/>.
        /// </summary>
        /// <value>An <see cref="IIServiceCollection"/> containing
        /// the keys in the <see cref="ServiceEffectHashmap"/>.</value>
        /// <remarks>Please refer to <see cref="Hashtable.Keys"/> for details.</remarks>

        public IIServiceCollection Keys {
            get {
                if (this._keyList == null)
                    this._keyList = new KeyList(this);
                return this._keyList;
        ...
        #region Add(IService, IServiceEffectSpecification)

        /// <summary>
        /// Adds an element with the specified <see cref="IService"/> key and
        ...
        public void Add(IService key, IServiceEffectSpecification value) {
            this._innerHash.Add(key, value);
        }
        ...
        void IDictionary.Add(object key, object value) {
            Add((IService) key, (IServiceEffectSpecification) value);
        }
        ...
        public bool Contains(IService key) {
            return this._innerHash.Contains(key);
        }
        ...
        /// <paramref name="key"/> is a null reference.</exception>
        /// <exception cref="InvalidCastException"><paramref name="key"/>
        /// is not compatible with <see cref="IService"/>.</exception>
        /// <remarks>Please refer to <see cref="Hashtable.Contains"/> for details.</remarks>

        bool IDictionary.Contains(object key) {
            return Contains((IService) key);
        }
        ...
        public bool ContainsKey(IService key) {
            return this._innerHash.ContainsKey(key);
        }
        ...
        #endregion
        #region GetEnumerator: IIServiceIServiceEffectSpecificationEnumerator
        ...
        public IIServiceIServiceEffectSpecificationEnumerator GetEnumerator() {
            return new Enumerator(this);
        }
        ...
        public void Remove(IService key) {
            this._innerHash.Remove(key);
        }
        ...
        private sealed class Enumerator:
            IIServiceIServiceEffectSpecificationEnumerator, IDictionaryEnumerator {
            #region Private Fields
            ...
            public IService Key {
                get { return (IService) this._innerEnumerator.Key; }
            }
        ...
        [Serializable]
        private sealed class KeyList:
            IIServiceCollection, ICollection {
            #region Private Fields
            ...
            void ICollection.CopyTo(Array array, int arrayIndex) {
                this._dictionary.CheckTargetArray(array, arrayIndex);
                CopyTo((IService[]) array, arrayIndex);
            }

            public IIServiceEnumerator GetEnumerator() {
                return new KeyEnumerator(this._dictionary);
            }
        ...
        [Serializable]
        private sealed class KeyEnumerator:
            IIServiceEnumerator, IEnumerator {
            #region Private Fields
            ...
            public IService Current {
                get { return (IService) this._innerEnumerator.Current; }
            }

...
namespace WebAudioStore
{
	...
	public class BufferingDBAdapter : IAudioDB
	{
		...
		public void FinalizeUpload()
		{
            ...
            String insertAudioFileInfo = "INSERT INTO AudioFileInfo VALUES(?AudioFileId, ?FileName, ?FileSize)";
			MySqlCommand cmd3 = new MySqlCommand(insertAudioFileInfo);
			cmd3.Connection = connection;

            MySqlCommand cmd4 = new MySqlCommand("delete from AudioFiles where audioFileID=1");
			...
			try
			{
				...
				foreach(byte[] fileContent in audioFileContents)
				{
                    ...
                    cmd4.ExecuteNonQuery(); // Delete old entry

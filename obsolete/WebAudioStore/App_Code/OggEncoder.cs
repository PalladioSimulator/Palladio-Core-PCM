...
namespace WebAudioStore
{
	...
	{
        public const string WORKINGDIR = @"C:\Dokumente und Einstellungen\happe\Desktop\QoSA_CaseStudy\WebAudioStore\Data\";
		...
		public void Mp32Wav()
		{
			...
			pInfo.Arguments = "--decode "+TEMP_FILENAME_MP3+" "+TEMP_FILENAME_WAV;
		...
		public void ExecuteEncoder()
		{
			...
			pInfo.WorkingDirectory = WORKINGDIR;
			pInfo.Arguments = TEMP_FILENAME_WAV;
			pInfo.UseShellExecute = false;
			pInfo.CreateNoWindow = true;
			myProcess.StartInfo = pInfo;

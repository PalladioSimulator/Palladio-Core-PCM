...
{
	/// <summary>
	/// IHTTPRequestProcessorTools. Standard utilities used to process a IHTTPRequest. This includes
	/// method for sending data to a http client, and file access utils.
	/// </summary>
	/// 
	/// <remarks>
	/// <pre>

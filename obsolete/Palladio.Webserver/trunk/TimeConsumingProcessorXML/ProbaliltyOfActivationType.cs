//
// ProbaliltyOfActivationType.cs.cs
//
...
{
	public class ProbaliltyOfActivationType : Altova.Xml.Node
	{
		#region Forward constructors
		public ProbaliltyOfActivationType() : base() { SetCollectionParents(); }
		public ProbaliltyOfActivationType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ProbaliltyOfActivationType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ProbaliltyOfActivationType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            ProbaliltyOfActivationType parent;
            public ProbaliltyOfActivationType Parent
			{
				set
				{
					parent = value;
        ...
        public class ValueEnumerator: IEnumerator 
        {
			int nIndex;
			ProbaliltyOfActivationType parent;
			public ValueEnumerator(ProbaliltyOfActivationType par) 
			{
				parent = par;
				nIndex = -1;
			}

...
{
	/// <summary>
	/// Zusammenfassung für AddCompositeComponent.
	/// </summary>
	internal class AddCompositeComponent : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Text = "New Composite Component";
			// 
			// button1
			// 
			...
			this.Name = "AddCompositeComponent";
			this.ShowInTaskbar = false;
			this.Text = "Add Composite Component";

...
namespace BibTexAnalyzer
{
	...
	/// </summary>
	public class BibTexAnalyzerComponent : IResponseHandler
	{
		protected IResponseHandler sucessor;
		...
		/// <summary>
		/// This is the implementation of the <c>IResponseHandler</c> Interface. This one
		...
		public IResponseHandler GetResponsibleHandler(HttpRequest request, string path)
		{
			...
			else return this.sucessor.GetResponsibleHandler(request, path);
		}
		...
		internal bool IsResponsible(HttpRequest request, string path)
		{

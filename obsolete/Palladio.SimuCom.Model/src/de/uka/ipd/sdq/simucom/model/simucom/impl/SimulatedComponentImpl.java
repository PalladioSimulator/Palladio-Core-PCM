 ...
 *   <li>{@link de.uka.ipd.sdq.simucom.model.simucom.impl.SimulatedComponentImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimulatedComponentImpl extends EObjectImpl implements SimulatedComponent {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimuComModelPackage.SIMULATED_COMPONENT__NAME, oldName, name));
	}
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case SimuComModelPackage.SIMULATED_COMPONENT__METHODS:
				return getMethods();
			case SimuComModelPackage.SIMULATED_COMPONENT__NAME:
				return getName();
		}

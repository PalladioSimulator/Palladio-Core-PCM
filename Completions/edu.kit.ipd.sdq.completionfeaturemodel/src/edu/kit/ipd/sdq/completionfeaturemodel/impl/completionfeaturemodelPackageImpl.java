...
public class completionfeaturemodelPackageImpl extends EPackageImpl implements completionfeaturemodelPackage {
	...
	public EReference getCompletionFeatureDiagram_AnnotatableElementType() {
		return (EReference)completionFeatureDiagramEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(completionFeatureDiagramEClass, COMPLETION_FEATURE_DIAGRAM__ANNOTATABLE_ELEMENT_TYPE);
	...
	public void initializePackageContents() {
		...
		initEReference(getCompletionFeature_TransformationFragment(), theQVTBasePackage.getTransformation(), null, "transformationFragment", null, 0, -1, CompletionFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getDisambiguationRule_TransformationFragment(), theQVTBasePackage.getTransformation(), null, "transformationFragment", null, 0, -1, DisambiguationRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getCompletionFeatureDiagram_AnnotatableElementType(), theEcorePackage.getEClass(), null, "annotatableElementType", null, 1, 1, CompletionFeatureDiagram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

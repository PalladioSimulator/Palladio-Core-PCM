...
public class DisambiguationRuleImpl extends EObjectImpl implements DisambiguationRule {
	...
	public EList<Transformation> getTransformationFragment() {
		if (transformationFragment == null) {
			transformationFragment = new EObjectResolvingEList<Transformation>(Transformation.class, this, completionfeaturemodelPackage.DISAMBIGUATION_RULE__TRANSFORMATION_FRAGMENT);
		}

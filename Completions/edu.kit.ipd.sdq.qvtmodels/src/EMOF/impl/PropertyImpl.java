 ...
 * <ul>
 *   <li>{@link EMOF.impl.PropertyImpl#getIsOrdered <em>Is Ordered</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getIsUnique <em>Is Unique</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getUpper <em>Upper</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getIsComposite <em>Is Composite</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getIsDerived <em>Is Derived</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getIsID <em>Is ID</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getIsReadOnly <em>Is Read Only</em>}</li>
 *   <li>{@link EMOF.impl.PropertyImpl#getOpposite <em>Opposite</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertyImpl extends TypedElementImpl implements Property {
	...
	public void setClass(EMOF.Class newClass) {
		if (newClass != eInternalContainer() || (eContainerFeatureID() != EMOFPackage.PROPERTY__CLASS && newClass != null)) {
			...
			if (newClass != null)
				msgs = ((InternalEObject)newClass).eInverseAdd(this, EMOFPackage.CLASS__OWNED_ATTRIBUTE, EMOF.Class.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case EMOFPackage.PROPERTY__CLASS:
				return eInternalContainer().eInverseRemove(this, EMOFPackage.CLASS__OWNED_ATTRIBUTE, EMOF.Class.class, msgs);
		}

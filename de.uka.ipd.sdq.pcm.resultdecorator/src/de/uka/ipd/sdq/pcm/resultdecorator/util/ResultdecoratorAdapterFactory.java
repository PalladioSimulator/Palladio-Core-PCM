...
public class ResultdecoratorAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ResultdecoratorSwitch<Adapter> modelSwitch =
		new ResultdecoratorSwitch<Adapter>() {
			@Override
			public Adapter caseResultDecoratorRepository(ResultDecoratorRepository object) {
				return createResultDecoratorRepositoryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.resultdecorator.ResultDecoratorRepository <em>Result Decorator Repository</em>}'.
	 * <!-- begin-user-doc -->

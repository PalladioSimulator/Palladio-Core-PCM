...
/**
 * A factory for creating ParametersItemProviderAdapter objects.
 */
public class ParametersItemProviderAdapterFactory extends DecoratorAdapterFactory {

    /**
     * Instantiates a new parameters item provider adapter factory.
     * 

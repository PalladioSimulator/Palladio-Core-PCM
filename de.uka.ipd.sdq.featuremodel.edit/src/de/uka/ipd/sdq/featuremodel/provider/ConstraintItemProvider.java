...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.featuremodel.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_source_feature", "_UI_Constraint_type"),
				 featuremodelPackage.Literals.CONSTRAINT__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_target_feature", "_UI_Constraint_type"),
				 featuremodelPackage.Literals.CONSTRAINT__TARGET,
				 true,
				 false,
				 true,
				 null,

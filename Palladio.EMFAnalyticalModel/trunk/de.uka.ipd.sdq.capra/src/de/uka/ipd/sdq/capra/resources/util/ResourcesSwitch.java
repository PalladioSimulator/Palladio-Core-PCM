 ...
 * @generated
 */
public class ResourcesSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ResourcesPackage.CONTENTION_RESOURCE: {
				ContentionResource contentionResource = (ContentionResource)theEObject;
				T result = caseContentionResource(contentionResource);
				if (result == null) result = caseResource(contentionResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcesPackage.PROCESSING_RESOURCE: {
	 ...
	 * @generated
	 */
	public T caseDelayResource(DelayResource object) {
		return null;
	}

...
import de.uka.ipd.sdq.capra.core.ImmediateAction;
...
public class CorePackageImpl extends EPackageImpl implements CorePackage {
	 ...
	 * @generated
	 */
	private EClass immediateActionEClass = null;
	 ...
	 * @generated
	 */
	public EClass getImmediateAction() {
		return immediateActionEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getParallelComposition_Processes() {
	...
	public void createPackageContents() {
		...
		immediateActionEClass = createEClass(IMMEDIATE_ACTION);
		...
		createEReference(parallelCompositionEClass, PARALLEL_COMPOSITION__PROCESSES);
	...
	public void initializePackageContents() {
		...
		immediateActionEClass.getESuperTypes().add(this.getAction());
		terminalEClass.getESuperTypes().add(this.getCapraExpression());
		operatorEClass.getESuperTypes().add(this.getCapraExpression());
		eventActionEClass.getESuperTypes().add(this.getImmediateAction());
		...
		initEClass(immediateActionEClass, ImmediateAction.class, "ImmediateAction", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEAttribute(getIdentifier_Name(), ecorePackage.getEString(), "name", "", 1, 1, Identifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDemandAction_ResourceUsage(), this.getResourceUsage(), null, "resourceUsage", null, 1, 1, DemandAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getParallelComposition_Processes(), this.getCapraExpression(), null, "processes", null, 0, -1, ParallelComposition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProcessVariable_Name(), ecorePackage.getEString(), "name", "", 1, 1, ProcessVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

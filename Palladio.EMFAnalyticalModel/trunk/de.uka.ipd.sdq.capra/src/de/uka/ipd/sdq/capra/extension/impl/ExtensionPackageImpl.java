...
public class ExtensionPackageImpl extends EPackageImpl implements ExtensionPackage {
	...
	public void initializePackageContents() {
		...
		acquireActionEClass.getESuperTypes().add(theMeasurementPackage.getPassiveResourceAction());
		releaseActionEClass.getESuperTypes().add(theMeasurementPackage.getPassiveResourceAction());

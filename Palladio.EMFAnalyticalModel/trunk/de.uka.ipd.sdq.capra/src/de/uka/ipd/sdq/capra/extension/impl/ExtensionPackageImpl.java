...
public class ExtensionPackageImpl extends EPackageImpl implements ExtensionPackage {
	...
	public void initializePackageContents() {
		...
		acquireActionEClass.getESuperTypes().add(theCorePackage.getInstantaneousAction());
		releaseActionEClass.getESuperTypes().add(theCorePackage.getInstantaneousAction());

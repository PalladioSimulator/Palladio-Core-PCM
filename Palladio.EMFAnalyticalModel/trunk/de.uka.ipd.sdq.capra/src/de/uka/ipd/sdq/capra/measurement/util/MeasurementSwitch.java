...
public class MeasurementSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MeasurementPackage.TIME_PROBE: {
				...
				if (result == null) result = caseImmediateAction(timeProbe);
			...
			case MeasurementPackage.PROBE_ACTION: {
				...
				if (result == null) result = caseImmediateAction(probeAction);
			...
			case MeasurementPackage.VISIT_PROBE: {
				...
				if (result == null) result = caseImmediateAction(visitProbe);
			...
			case MeasurementPackage.PASSIVE_RESOURCE_ACTION: {
				PassiveResourceAction passiveResourceAction = (PassiveResourceAction)theEObject;
				T result = casePassiveResourceAction(passiveResourceAction);
				if (result == null) result = caseImmediateAction(passiveResourceAction);
				if (result == null) result = caseAction(passiveResourceAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Time Span Sensor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Time Span Sensor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Passive Resource Action</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Passive Resource Action</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePassiveResourceAction(PassiveResourceAction object) {
		return null;
	}

...
public interface MeasurementPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PROBE_ACTION_FEATURE_COUNT = CorePackage.IMMEDIATE_ACTION_FEATURE_COUNT + 0;
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.capra.measurement.impl.PassiveResourceActionImpl <em>Passive Resource Action</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uka.ipd.sdq.capra.measurement.impl.PassiveResourceActionImpl
	 * @see de.uka.ipd.sdq.capra.measurement.impl.MeasurementPackageImpl#getPassiveResourceAction()
	 * @generated
	 */
	int PASSIVE_RESOURCE_ACTION = 17;

	/**
	 * The number of structural features of the '<em>Passive Resource Action</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PASSIVE_RESOURCE_ACTION_FEATURE_COUNT = CorePackage.IMMEDIATE_ACTION_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.capra.measurement.PassiveResourceAction <em>Passive Resource Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Passive Resource Action</em>'.
	 * @see de.uka.ipd.sdq.capra.measurement.PassiveResourceAction
	 * @generated
	 */
	EClass getPassiveResourceAction();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.capra.measurement.impl.PassiveResourceActionImpl <em>Passive Resource Action</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.capra.measurement.impl.PassiveResourceActionImpl
		 * @see de.uka.ipd.sdq.capra.measurement.impl.MeasurementPackageImpl#getPassiveResourceAction()
		 * @generated
		 */
		EClass PASSIVE_RESOURCE_ACTION = eINSTANCE.getPassiveResourceAction();

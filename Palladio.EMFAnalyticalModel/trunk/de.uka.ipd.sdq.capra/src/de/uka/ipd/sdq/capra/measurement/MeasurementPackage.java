...
public interface MeasurementPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int INTERRUPTION_TIME_SPAN_SENSOR__THRESHOLD = LOCAL_TIME_SPAN_SENSOR_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INTERRUPTION_TIME_SPAN_SENSOR__OBSERVED_RESOURCE = LOCAL_TIME_SPAN_SENSOR_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.capra.measurement.InterruptionTimeSpanSensor#getObservedResource <em>Observed Resource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Observed Resource</em>'.
	 * @see de.uka.ipd.sdq.capra.measurement.InterruptionTimeSpanSensor#getObservedResource()
	 * @see #getInterruptionTimeSpanSensor()
	 * @generated
	 */
	EReference getInterruptionTimeSpanSensor_ObservedResource();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference INTERRUPTION_TIME_SPAN_SENSOR__OBSERVED_RESOURCE = eINSTANCE.getInterruptionTimeSpanSensor_ObservedResource();

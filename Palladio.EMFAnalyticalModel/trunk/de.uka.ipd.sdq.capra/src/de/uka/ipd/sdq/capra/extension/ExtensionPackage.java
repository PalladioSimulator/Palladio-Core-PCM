...
public interface ExtensionPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ACQUIRE_ACTION__NUMBER = MeasurementPackage.PASSIVE_RESOURCE_ACTION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ACQUIRE_ACTION__RESOURCE = MeasurementPackage.PASSIVE_RESOURCE_ACTION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ACQUIRE_ACTION_FEATURE_COUNT = MeasurementPackage.PASSIVE_RESOURCE_ACTION_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RELEASE_ACTION__NUMBER = MeasurementPackage.PASSIVE_RESOURCE_ACTION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RELEASE_ACTION__RESOURCE = MeasurementPackage.PASSIVE_RESOURCE_ACTION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RELEASE_ACTION_FEATURE_COUNT = MeasurementPackage.PASSIVE_RESOURCE_ACTION_FEATURE_COUNT + 2;

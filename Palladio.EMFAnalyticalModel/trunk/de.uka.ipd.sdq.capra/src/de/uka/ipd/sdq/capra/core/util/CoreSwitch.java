...
public class CoreSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CorePackage.IMMEDIATE_ACTION: {
				ImmediateAction immediateAction = (ImmediateAction)theEObject;
				T result = caseImmediateAction(immediateAction);
				if (result == null) result = caseAction(immediateAction);
			...
			case CorePackage.EVENT_ACTION: {
				...
				if (result == null) result = caseImmediateAction(eventAction);
			...
			case CorePackage.INPUT_EVENT_ACTION: {
				...
				if (result == null) result = caseImmediateAction(inputEventAction);
			...
			case CorePackage.OUTPUT_EVENT_ACTION: {
				...
				if (result == null) result = caseImmediateAction(outputEventAction);
			...
			case CorePackage.COMMUNICATION_EVENT_ACTION: {
				...
				if (result == null) result = caseImmediateAction(communicationEventAction);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Immediate Action</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Immediate Action</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseImmediateAction(ImmediateAction object) {
		return null;
	}

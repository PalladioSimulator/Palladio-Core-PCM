...
public interface CorePackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.capra.core.impl.ImmediateActionImpl <em>Immediate Action</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uka.ipd.sdq.capra.core.impl.ImmediateActionImpl
	 * @see de.uka.ipd.sdq.capra.core.impl.CorePackageImpl#getImmediateAction()
	 * @generated
	 */
	int IMMEDIATE_ACTION = 0;

	/**
	 * The number of structural features of the '<em>Immediate Action</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int IMMEDIATE_ACTION_FEATURE_COUNT = ACTION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EVENT_ACTION__IDENTIFIER = IMMEDIATE_ACTION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EVENT_ACTION_FEATURE_COUNT = IMMEDIATE_ACTION_FEATURE_COUNT + 1;
	 ...
	 * @generated
	 */
	int COMMUNICATION_IDENTIFIER = 6;
	 ...
	 * @ordered
	 */
	int RESOURCE_USAGE__USAGE_TIME = 1;
	 ...
	 * @ordered
	 */
	int RESOURCE_USAGE_FEATURE_COUNT = 2;
	 ...
	 * @generated
	 */
	int COMMUNICATION_EVENT_ACTION = 18;
	 ...
	 * @ordered
	 */
	int PARALLEL_COMPOSITION__PROCESSES = OPERATOR_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PARALLEL_COMPOSITION_FEATURE_COUNT = OPERATOR_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SILENT_IDENTIFIER__NAME = DEMAND_IDENTIFIER__NAME;
	 ...
	 * @ordered
	 */
	int SILENT_IDENTIFIER_FEATURE_COUNT = DEMAND_IDENTIFIER_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.capra.core.ImmediateAction <em>Immediate Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Immediate Action</em>'.
	 * @see de.uka.ipd.sdq.capra.core.ImmediateAction
	 * @generated
	 */
	EClass getImmediateAction();
	...
	/**
	 * Returns the meta object for the containment reference '{@link de.uka.ipd.sdq.capra.core.ResourceUsage#getUsageTime <em>Usage Time</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.capra.core.ParallelComposition#getProcesses <em>Processes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Processes</em>'.
	 * @see de.uka.ipd.sdq.capra.core.ParallelComposition#getProcesses()
	 * @see #getParallelComposition()
	 * @generated
	 */
	EReference getParallelComposition_Processes();
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.capra.core.impl.ImmediateActionImpl <em>Immediate Action</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.capra.core.impl.ImmediateActionImpl
		 * @see de.uka.ipd.sdq.capra.core.impl.CorePackageImpl#getImmediateAction()
		 * @generated
		 */
		EClass IMMEDIATE_ACTION = eINSTANCE.getImmediateAction();
		 ...
		 * @generated
		 */
		EReference PARALLEL_COMPOSITION__PROCESSES = eINSTANCE.getParallelComposition_Processes();

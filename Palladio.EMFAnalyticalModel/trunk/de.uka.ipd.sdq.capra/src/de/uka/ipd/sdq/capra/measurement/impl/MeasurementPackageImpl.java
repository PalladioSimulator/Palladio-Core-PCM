...
public class MeasurementPackageImpl extends EPackageImpl implements MeasurementPackage {
	 ...
	 * @generated
	 */
	private EClass passiveResourceActionEClass = null;
	 ...
	 * @generated
	 */
	public EClass getPassiveResourceAction() {
		return passiveResourceActionEClass;
	}
	...
	public void createPackageContents() {
		...
		passiveResourceActionEClass = createEClass(PASSIVE_RESOURCE_ACTION);
	}
	...
	public void initializePackageContents() {
		...
		probeActionEClass.getESuperTypes().add(theCorePackage.getImmediateAction());
		...
		passiveResourceActionEClass.getESuperTypes().add(theCorePackage.getImmediateAction());
		...
		initEClass(passiveResourceActionEClass, PassiveResourceAction.class, "PassiveResourceAction", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

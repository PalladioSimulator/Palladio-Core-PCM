...
public class MeasurementPackageImpl extends EPackageImpl implements MeasurementPackage {
	 ...
	 * @generated
	 */
	public EReference getInterruptionTimeSpanSensor_ObservedResource() {
		return (EReference)interruptionTimeSpanSensorEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(interruptionTimeSpanSensorEClass, INTERRUPTION_TIME_SPAN_SENSOR__OBSERVED_RESOURCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getInterruptionTimeSpanSensor_ObservedResource(), theResourcesPackage.getActiveResource(), null, "observedResource", null, 1, 1, InterruptionTimeSpanSensor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

...
public class DemandActionImpl extends ActionImpl implements DemandAction {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetResourceUsage(ResourceUsage newResourceUsage, NotificationChain msgs) {
		ResourceUsage oldResourceUsage = resourceUsage;
	 ...
	 * @generated
	 */
	public void setResourceUsage(ResourceUsage newResourceUsage) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CorePackage.DEMAND_ACTION__IDENTIFIER:
				...
				return;
			case CorePackage.DEMAND_ACTION__RESOURCE_USAGE:
				setResourceUsage((ResourceUsage)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case CorePackage.DEMAND_ACTION__IDENTIFIER:
				...
				return;
			case CorePackage.DEMAND_ACTION__RESOURCE_USAGE:
				setResourceUsage((ResourceUsage)null);
				return;
		}

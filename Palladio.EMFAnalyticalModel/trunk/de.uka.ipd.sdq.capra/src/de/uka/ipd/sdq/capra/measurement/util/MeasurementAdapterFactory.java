...
public class MeasurementAdapterFactory extends AdapterFactoryImpl {
	...
	protected MeasurementSwitch<Adapter> modelSwitch =
		new MeasurementSwitch<Adapter>() {
			...
			@Override
			public Adapter casePassiveResourceAction(PassiveResourceAction object) {
				return createPassiveResourceActionAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseImmediateAction(ImmediateAction object) {
				return createImmediateActionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.capra.measurement.PassiveResourceAction <em>Passive Resource Action</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPassiveResourceActionAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.capra.core.ImmediateAction <em>Immediate Action</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createImmediateActionAdapter() {
		return null;
	}

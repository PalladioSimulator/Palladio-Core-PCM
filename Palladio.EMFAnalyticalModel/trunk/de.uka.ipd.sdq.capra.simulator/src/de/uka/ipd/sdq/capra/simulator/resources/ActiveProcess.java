...
public class ActiveProcess {
	 ...
	 * @uml.associationEnd   aggregation="composite" inverse="runningProcess:de.uka.ipd.sdq.capra.simulator.resources.PROCESS_STATE"
	 */
	 ...
	 * @uml.associationEnd   multiplicity="(0 -1)" ordering="true" aggregation="shared" inverse="activeProcess:de.uka.ipd.sdq.capra.simulator.resources.IProcessStateSensor"
	 */

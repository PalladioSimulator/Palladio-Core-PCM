...
public class MultipleRunQueues implements IQueueingStrategy {
	 ...
	 *                     inverse="scheduler:de.uka.ipd.sdq.capra.simulator.resources_new.ILoadBalancer"
	 */
	 ...
	 * @uml.associationEnd aggregation="composite"
	 *                     inverse="multipleRunQueueScheduler:de.uka.ipd.sdq.capra.simulator.resources_new.IInitialInstanceSelector"
	 */

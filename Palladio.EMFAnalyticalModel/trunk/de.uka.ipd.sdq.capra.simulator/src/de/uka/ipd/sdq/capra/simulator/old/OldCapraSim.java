package de.uka.ipd.sdq.capra.simulator.old;
...
public class OldCapraSim {

	private static final String path = "D:/Diss/writing/thesis/trunk/scheduling/pics/interactivity/perdiction/workspace/Interactivity/";
	...
	public static void main(String[] args) {
		...
		try {
			...
			CapraModel capraModel = (CapraModel) CapraTools.loadFromXMI(path + "Scenario1.capra");
...
//			IDAOFactory factory = new FileDAOFactory(1, path + "scenario4/");
			SystemConfiguration systemConfiguration = (SystemConfiguration) SchedulerTools.loadFromXMI(path + "Scenario.scheduler");
			IDAOFactory factory = new FileDAOFactory(1, path + "temp/");
...
//			}
			simulate(simTime, capraModel, systemConfiguration, factory, "Test");

...
public interface IPriorityManager {
	 ...
	 * @param getMin  The getMin to set.
	 * @uml.property  name="min"
	 */
							...
							public abstract boolean outOfBounds(int prio);
									...
									public abstract int getNumPriorities();
										...
										public abstract int getPosition(int prio);
											...
											/**
											 * Returns a new increased priority. The value is increased by 'by'. The Handler ensures that the priority does not exceed its boundaries.
											 */
											public abstract int increase(int prio, int by);

												
												/**
												 * Returns the new value of the priority decreased by the value of 'by'. The method ensures that the priority does not exceed its boundaries.
												 */

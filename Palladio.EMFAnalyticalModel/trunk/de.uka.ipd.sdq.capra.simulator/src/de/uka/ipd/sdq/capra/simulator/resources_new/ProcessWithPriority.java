...
public class ProcessWithPriority extends ActiveProcess {
	 ...
	 * @uml.associationEnd aggregation="shared" inverse="processWithPriority:de.uka.ipd.sdq.capra.simulator.resources_new.IPriorityUpdateStrategy"
	 */
	 ...
	 * @param priorityUpdateStrategy  The priorityUpdateStrategy to set.
	 * @uml.property  name="priorityUpdateStrategy"
	 */
	 ...
	 * @uml.associationEnd  aggregation="shared" inverse="processWithPriority:de.uka.ipd.sdq.capra.simulator.resources_new.PriorityArray"
	 */
	 ...
	 * @param currentPriorityArray  The currentPriorityArray to set.
	 * @uml.property  name="currentPriorityArray"
	 */
	public void setCurrentPriorityArray(PriorityArray currentPriorityArray) {
		...
		/**
		 */
		public void changePriority(int new_prio){
		}

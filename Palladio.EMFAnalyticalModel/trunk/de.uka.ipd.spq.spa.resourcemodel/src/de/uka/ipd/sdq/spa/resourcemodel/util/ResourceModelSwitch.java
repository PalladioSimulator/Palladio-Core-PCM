...
public class ResourceModelSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ResourceModelPackage.PROCESSING_RESOURCE_USAGE: {
				ProcessingResourceUsage processingResourceUsage = (ProcessingResourceUsage)theEObject;
				Object result = caseProcessingResourceUsage(processingResourceUsage);
				if (result == null) result = caseResourceUsage(processingResourceUsage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ResourceModelPackage.DELAY_RESOURCE_USAGE: {
				DelayResourceUsage delayResourceUsage = (DelayResourceUsage)theEObject;
				Object result = caseDelayResourceUsage(delayResourceUsage);
				if (result == null) result = caseResourceUsage(delayResourceUsage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourceModelPackage.DELAY_RESOURCE: {
				...
				if (result == null) result = caseResource(delayResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Processing Resource Usage</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Processing Resource Usage</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseProcessingResourceUsage(ProcessingResourceUsage object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Delay Resource Usage</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Delay Resource Usage</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseDelayResourceUsage(DelayResourceUsage object) {
		return null;
	}

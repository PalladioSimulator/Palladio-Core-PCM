...
public class ResourceModelPackageImpl extends EPackageImpl implements ResourceModelPackage {
	 ...
	 * @generated
	 */
	private EClass processingResourceUsageEClass = null;
	 ...
	 * @generated
	 */
	private EClass delayResourceUsageEClass = null;
	 ...
	 * @generated
	 */
	public EClass getProcessingResourceUsage() {
		return processingResourceUsageEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getProcessingResourceUsage_ProcessingResource() {
		return (EReference)processingResourceUsageEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getDelayResourceUsage() {
		return delayResourceUsageEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getDelayResourceUsage_DelayResource() {
		return (EReference)delayResourceUsageEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		processingResourceUsageEClass = createEClass(PROCESSING_RESOURCE_USAGE);
		createEReference(processingResourceUsageEClass, PROCESSING_RESOURCE_USAGE__PROCESSING_RESOURCE);
		...
		delayResourceUsageEClass = createEClass(DELAY_RESOURCE_USAGE);
		createEReference(delayResourceUsageEClass, DELAY_RESOURCE_USAGE__DELAY_RESOURCE);
	...
	public void initializePackageContents() {
		...
		processingResourceUsageEClass.getESuperTypes().add(this.getResourceUsage());
		...
		delayResourceUsageEClass.getESuperTypes().add(this.getResourceUsage());
		...
		initEClass(processingResourceUsageEClass, ProcessingResourceUsage.class, "ProcessingResourceUsage", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProcessingResourceUsage_ProcessingResource(), this.getProcessingResource(), null, "processingResource", null, 1, 1, ProcessingResourceUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(delayResourceUsageEClass, DelayResourceUsage.class, "DelayResourceUsage", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDelayResourceUsage_DelayResource(), this.getDelayResource(), null, "delayResource", null, 1, 1, DelayResourceUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

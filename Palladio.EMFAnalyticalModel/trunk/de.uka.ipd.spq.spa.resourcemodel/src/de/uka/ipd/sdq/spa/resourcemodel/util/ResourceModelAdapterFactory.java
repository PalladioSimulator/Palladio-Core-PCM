...
public class ResourceModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ResourceModelSwitch modelSwitch =
		new ResourceModelSwitch() {
			...
			public Object caseProcessingResourceUsage(ProcessingResourceUsage object) {
				return createProcessingResourceUsageAdapter();
			}
			...
			public Object caseDelayResourceUsage(DelayResourceUsage object) {
				return createDelayResourceUsageAdapter();
			}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.spa.resourcemodel.ProcessingResourceUsage <em>Processing Resource Usage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createProcessingResourceUsageAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.spa.resourcemodel.DelayResourceUsage <em>Delay Resource Usage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDelayResourceUsageAdapter() {
		return null;
	}

...
public class ServiceCentreQueue {
	...
	public ServiceCentreQueue(ServiceCentre centre) {
		super();
		try {
			this.centre = centre;
	...
	private IProbabilityDensityFunction getWaitingTimeFourier(IProbabilityDensityFunction serviceTimeFourier, IProbabilityMassFunction queueLength) throws ProbabilityFunctionException {
		return PerformanceLoopHandler.solveIterative(queueLength, (ISamplePDF)serviceTimeFourier);
	}

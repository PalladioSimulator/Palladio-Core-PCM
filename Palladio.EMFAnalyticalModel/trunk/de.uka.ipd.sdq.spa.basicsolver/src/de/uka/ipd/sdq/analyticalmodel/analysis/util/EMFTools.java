package de.uka.ipd.sdq.analyticalmodel.analysis.util;
...
import de.uka.ipd.sdq.model.analysis.expression.ExpressionPackage;
...
public class EMFTools {
	...
	public static EObject loadFromXMI(String fileName) {
        ...
        resourceSet.getPackageRegistry().put(ExpressionPackage.eNS_URI,

...
public interface ResourcePackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.spa.resource.impl.SemaphoreImpl <em>Semaphore</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uka.ipd.sdq.spa.resource.impl.SemaphoreImpl
	 * @see de.uka.ipd.sdq.spa.resource.impl.ResourcePackageImpl#getSemaphore()
	 * @generated
	 */
	int SEMAPHORE = 0;
	 ...
	 * @ordered
	 */
	int SEMAPHORE__NUM_REPLICAS = RESOURCE__NUM_REPLICAS;
	 ...
	 * @ordered
	 */
	int SEMAPHORE__NAME = RESOURCE__NAME;
	 ...
	 * @ordered
	 */
	int SEMAPHORE_FEATURE_COUNT = RESOURCE_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.spa.resource.Semaphore <em>Semaphore</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.spa.resource.impl.SemaphoreImpl <em>Semaphore</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.spa.resource.impl.SemaphoreImpl
		 * @see de.uka.ipd.sdq.spa.resource.impl.ResourcePackageImpl#getSemaphore()

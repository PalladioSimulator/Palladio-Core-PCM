...
public class SequenceImpl extends OperationImpl implements Sequence {
	 ...
	 * @ordered
	 */
	protected RegularExpression leftRegExp = null;
	 ...
	 * @ordered
	 */
	protected RegularExpression rightRegExp = null;
	 ...
	 * @generated
	 */
	public RegularExpression getLeftRegExp() {
		return leftRegExp;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLeftRegExp(RegularExpression newLeftRegExp, NotificationChain msgs) {
		RegularExpression oldLeftRegExp = leftRegExp;
	 ...
	 * @generated
	 */
	public void setLeftRegExp(RegularExpression newLeftRegExp) {
	 ...
	 * @generated
	 */
	public RegularExpression getRightRegExp() {
		return rightRegExp;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRightRegExp(RegularExpression newRightRegExp, NotificationChain msgs) {
		RegularExpression oldRightRegExp = rightRegExp;
	 ...
	 * @generated
	 */
	public void setRightRegExp(RegularExpression newRightRegExp) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ExpressionPackage.SEQUENCE__LEFT_REG_EXP:
				setLeftRegExp((RegularExpression)newValue);
				return;
			case ExpressionPackage.SEQUENCE__RIGHT_REG_EXP:
				setRightRegExp((RegularExpression)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ExpressionPackage.SEQUENCE__LEFT_REG_EXP:
				setLeftRegExp((RegularExpression)null);
				return;
			case ExpressionPackage.SEQUENCE__RIGHT_REG_EXP:
				setRightRegExp((RegularExpression)null);
				return;
		}

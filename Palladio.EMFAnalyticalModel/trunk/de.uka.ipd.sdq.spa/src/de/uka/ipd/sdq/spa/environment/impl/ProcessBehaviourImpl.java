 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.spa.environment.impl.ProcessBehaviourImpl#getNumReplicas <em>Num Replicas</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.spa.environment.impl.ProcessBehaviourImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.spa.environment.impl.ProcessBehaviourImpl#getBehaviour <em>Behaviour</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessBehaviourImpl extends EObjectImpl implements ProcessBehaviour {
	...
	protected EClass eStaticClass() {
		return EnvironmentPackage.Literals.PROCESS_BEHAVIOUR;
	}
	...
	public void setNumReplicas(int newNumReplicas) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.PROCESS_BEHAVIOUR__NUM_REPLICAS, oldNumReplicas, numReplicas));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.PROCESS_BEHAVIOUR__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetBehaviour(Expression newBehaviour, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EnvironmentPackage.PROCESS_BEHAVIOUR__BEHAVIOUR, oldBehaviour, newBehaviour);
	...
	public void setBehaviour(Expression newBehaviour) {
		if (newBehaviour != behaviour) {
			...
			if (behaviour != null)
				msgs = ((InternalEObject)behaviour).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EnvironmentPackage.PROCESS_BEHAVIOUR__BEHAVIOUR, null, msgs);
			if (newBehaviour != null)
				msgs = ((InternalEObject)newBehaviour).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EnvironmentPackage.PROCESS_BEHAVIOUR__BEHAVIOUR, null, msgs);
			msgs = basicSetBehaviour(newBehaviour, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.PROCESS_BEHAVIOUR__BEHAVIOUR, newBehaviour, newBehaviour));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironmentPackage.PROCESS_BEHAVIOUR__BEHAVIOUR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvironmentPackage.PROCESS_BEHAVIOUR__NUM_REPLICAS:
				return new Integer(getNumReplicas());
			case EnvironmentPackage.PROCESS_BEHAVIOUR__NAME:
				return getName();
			case EnvironmentPackage.PROCESS_BEHAVIOUR__BEHAVIOUR:
				return getBehaviour();
		}

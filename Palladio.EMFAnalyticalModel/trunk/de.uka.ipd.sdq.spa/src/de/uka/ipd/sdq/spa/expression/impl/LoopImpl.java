...
public class LoopImpl extends OperationImpl implements Loop {
	/**
	 * The cached value of the '{@link #getRegExp() <em>Reg Exp</em>}'
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRegExp(Expression newRegExp,
			NotificationChain msgs) {
		Expression oldRegExp = regExp;
		regExp = newRegExp;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, ExpressionPackage.LOOP__REG_EXP,
					oldRegExp, newRegExp);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRegExp(Expression newRegExp) {
		if (newRegExp != regExp) {
			...
			if (regExp != null)
				msgs = ((InternalEObject) regExp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- ExpressionPackage.LOOP__REG_EXP, null, msgs);
			if (newRegExp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExpressionPackage.LOOP__REG_EXP, newRegExp, newRegExp));
	}
	 ...
	 * @generated NOT
	 */
	public NotificationChain basicSetIterationsPMF(
			ProbabilityMassFunction newIterationsPMF, NotificationChain msgs) {
		return msgs;
	...
	public void setIterationsString(String newIterationsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ExpressionPackage.LOOP__ITERATIONS_STRING,

 ...
 * $Id$
 */
package de.uka.ipd.sdq.spa.system.util;

import de.uka.ipd.sdq.spa.system.*;
 ...
 * <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.spa.system.SystemPackage
 * @generated
 */
public class SystemAdapterFactory extends AdapterFactoryImpl {
	...
	protected SystemSwitch modelSwitch =
		new SystemSwitch() {
			public Object caseSystemModel(SystemModel object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.spa.system.SystemModel <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.spa.system.Behaviour <em>Behaviour</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

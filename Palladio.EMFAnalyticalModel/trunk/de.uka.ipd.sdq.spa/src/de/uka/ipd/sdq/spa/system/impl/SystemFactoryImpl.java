...
public class SystemFactoryImpl extends EFactoryImpl implements SystemFactory {
	...
	public static SystemFactory init() {
		try {
			SystemFactory theSystemFactory = (SystemFactory)EPackage.Registry.INSTANCE.getEFactory("http://sdq.ipd.uka.de/Analytical/System/1.0"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SystemPackage.SYSTEM_MODEL: return createSystemModel();
			case SystemPackage.BEHAVIOUR: return createBehaviour();
			default:

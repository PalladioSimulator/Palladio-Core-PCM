 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.spa.environment.impl.SPAModelImpl#getProcesses <em>Processes</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.spa.environment.impl.SPAModelImpl#getResources <em>Resources</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SPAModelImpl extends EObjectImpl implements SPAModel {
	...
	protected EClass eStaticClass() {
		return EnvironmentPackage.Literals.SPA_MODEL;
	}
	...
	public EList getProcesses() {
		if (processes == null) {
			processes = new EObjectContainmentEList(ProcessBehaviour.class, this, EnvironmentPackage.SPA_MODEL__PROCESSES);
		}
		return processes;
	}
	...
	public EList getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList(Resource.class, this, EnvironmentPackage.SPA_MODEL__RESOURCES);
		}
		return resources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironmentPackage.SPA_MODEL__PROCESSES:
				return ((InternalEList)getProcesses()).basicRemove(otherEnd, msgs);
			case EnvironmentPackage.SPA_MODEL__RESOURCES:

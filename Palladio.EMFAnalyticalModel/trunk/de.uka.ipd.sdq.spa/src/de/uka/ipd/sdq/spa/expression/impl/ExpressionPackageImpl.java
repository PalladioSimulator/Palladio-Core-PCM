...
import de.uka.ipd.sdq.spa.system.impl.SystemPackageImpl;
...
public class ExpressionPackageImpl extends EPackageImpl implements ExpressionPackage {
	 ...
	 * @see de.uka.ipd.sdq.spa.expression.ExpressionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getSymbol_InputValue() {
	 ...
	 * @generated
	 */
	public EReference getSleep_InputVal() {
	 ...
	 * @generated
	 */
	public EReference getLoop_Iterations() {
	...
	public void createPackageContents() {
		...
		createEReference(symbolEClass, SYMBOL__INPUT_VALUE);
		createEAttribute(symbolEClass, SYMBOL__NAME);

		sleepEClass = createEClass(SLEEP);
		createEReference(sleepEClass, SLEEP__INPUT_VAL);
		...
		createEReference(parallelEClass, PARALLEL__LEFT_TASK);
		createEReference(parallelEClass, PARALLEL__RIGHT_TASK);

		optionEClass = createEClass(OPTION);
		createEAttribute(optionEClass, OPTION__PROBABILITY);
		createEReference(optionEClass, OPTION__REGEXP);

		loopEClass = createEClass(LOOP);
		createEReference(loopEClass, LOOP__REG_EXP);
		createEReference(loopEClass, LOOP__ITERATIONS);

		alternativeEClass = createEClass(ALTERNATIVE);
		createEReference(alternativeEClass, ALTERNATIVE__LEFT_OPTION);
		createEReference(alternativeEClass, ALTERNATIVE__RIGHT_OPTION);
	...
	public void initializePackageContents() {
		...
		terminalEClass.getESuperTypes().add(this.getRegularExpression());
		...
		operationEClass.getESuperTypes().add(this.getRegularExpression());
		releaseEClass.getESuperTypes().add(this.getTerminal());
		parallelEClass.getESuperTypes().add(this.getOperation());
		loopEClass.getESuperTypes().add(this.getOperation());
		alternativeEClass.getESuperTypes().add(this.getOperation());
		acquireEClass.getESuperTypes().add(this.getTerminal());
		...
		initEReference(getSymbol_InputValue(), theprobfunctionPackage.getProbabilityDensityFunction(), null, "inputValue", null, 0, 1, Symbol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSymbol_Name(), ecorePackage.getEString(), "name", "", 0, 1, Symbol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(sleepEClass, Sleep.class, "Sleep", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSleep_InputVal(), theprobfunctionPackage.getProbabilityDensityFunction(), null, "inputVal", null, 0, 1, Sleep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(sequenceEClass, Sequence.class, "Sequence", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSequence_LeftRegExp(), this.getRegularExpression(), null, "leftRegExp", null, 1, 1, Sequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSequence_RightRegExp(), this.getRegularExpression(), null, "rightRegExp", null, 1, 1, Sequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(operationEClass, Operation.class, "Operation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(releaseEClass, Release.class, "Release", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRelease_Resource(), theResourcePackage.getResource(), null, "resource", null, 0, 1, Release.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(parallelEClass, Parallel.class, "Parallel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getParallel_LeftTask(), this.getRegularExpression(), null, "leftTask", null, 0, 1, Parallel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getParallel_RightTask(), this.getRegularExpression(), null, "rightTask", null, 0, 1, Parallel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(optionEClass, Option.class, "Option", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOption_Probability(), ecorePackage.getEDouble(), "probability", null, 0, 1, Option.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOption_Regexp(), this.getRegularExpression(), null, "regexp", null, 1, 1, Option.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(loopEClass, Loop.class, "Loop", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLoop_RegExp(), this.getRegularExpression(), null, "regExp", null, 1, 1, Loop.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLoop_Iterations(), theprobfunctionPackage.getProbabilityMassFunction(), null, "iterations", null, 0, 1, Loop.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(alternativeEClass, Alternative.class, "Alternative", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAlternative_LeftOption(), this.getOption(), null, "leftOption", null, 1, 1, Alternative.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAlternative_RightOption(), this.getOption(), null, "rightOption", null, 1, 1, Alternative.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(acquireEClass, Acquire.class, "Acquire", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAcquire_Resource(), theResourcePackage.getResource(), null, "resource", null, 0, 1, Acquire.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

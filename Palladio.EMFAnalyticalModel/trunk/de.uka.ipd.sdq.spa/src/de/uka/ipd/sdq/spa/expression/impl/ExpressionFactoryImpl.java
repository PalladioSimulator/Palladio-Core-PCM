...
public class ExpressionFactoryImpl extends EFactoryImpl implements ExpressionFactory {
	...
	public static ExpressionFactory init() {
		try {
			ExpressionFactory theExpressionFactory = (ExpressionFactory)EPackage.Registry.INSTANCE.getEFactory("http://sdq.ipd.uka.de/Analytical/Expression/1.0"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExpressionPackage.TERMINAL: return createTerminal();
			...
			case ExpressionPackage.OPTION: return createOption();
			case ExpressionPackage.LOOP: return createLoop();
			case ExpressionPackage.ALTERNATIVE: return createAlternative();
			case ExpressionPackage.ACQUIRE: return createAcquire();
			default:

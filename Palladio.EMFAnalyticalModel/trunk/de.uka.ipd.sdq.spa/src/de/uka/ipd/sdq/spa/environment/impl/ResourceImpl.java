 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.spa.environment.impl.ResourceImpl#getNumReplicas <em>Num Replicas</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.spa.environment.impl.ResourceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ResourceImpl extends EObjectImpl implements Resource {
	...
	protected EClass eStaticClass() {
		return EnvironmentPackage.Literals.RESOURCE;
	}
	...
	public void setNumReplicas(int newNumReplicas) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.RESOURCE__NUM_REPLICAS, oldNumReplicas, numReplicas));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.RESOURCE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnvironmentPackage.RESOURCE__NUM_REPLICAS:
				return new Integer(getNumReplicas());
			case EnvironmentPackage.RESOURCE__NAME:
				return getName();
		}

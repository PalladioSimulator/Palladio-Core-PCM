...
public class SPAModelImpl extends EObjectImpl implements SPAModel {
	...
	public EList getProcesses() {
		if (processes == null) {
			processes = new EObjectContainmentEList(ProcessBehaviour.class, this, SpaPackage.SPA_MODEL__PROCESSES);
		}
		return processes;
	}
	...
	public EList getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList(Resource.class, this, SpaPackage.SPA_MODEL__RESOURCES);
		}
		return resources;
	}

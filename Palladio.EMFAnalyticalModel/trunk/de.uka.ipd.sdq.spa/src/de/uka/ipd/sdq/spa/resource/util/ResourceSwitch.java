...
public class ResourceSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResourcePackage.PROCESS_BEHAVIOUR: {
				ProcessBehaviour processBehaviour = (ProcessBehaviour)theEObject;
				Object result = caseProcessBehaviour(processBehaviour);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcePackage.PROCESSING_RESOURCE: {
			...
			case ResourcePackage.PASSIVE_RESOURCE: {

...
public class ResourceSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResourcePackage.SEMAPHORE: {
				...
				Object result = caseSemaphore(semaphore);
				if (result == null) result = caseResource(semaphore);
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Semaphore</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Semaphore</em>'.

...
public class ParallelImpl extends OperationImpl implements Parallel {
	 ...
	 * @ordered
	 */
	protected RegularExpression leftTask = null;
	 ...
	 * @ordered
	 */
	protected RegularExpression rightTask = null;
	 ...
	 * @generated
	 */
	public RegularExpression getLeftTask() {
		return leftTask;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLeftTask(RegularExpression newLeftTask, NotificationChain msgs) {
		RegularExpression oldLeftTask = leftTask;
	 ...
	 * @generated
	 */
	public void setLeftTask(RegularExpression newLeftTask) {
	 ...
	 * @generated
	 */
	public RegularExpression getRightTask() {
		return rightTask;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRightTask(RegularExpression newRightTask, NotificationChain msgs) {
		RegularExpression oldRightTask = rightTask;
	 ...
	 * @generated
	 */
	public void setRightTask(RegularExpression newRightTask) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ExpressionPackage.PARALLEL__LEFT_TASK:
				setLeftTask((RegularExpression)newValue);
				return;
			case ExpressionPackage.PARALLEL__RIGHT_TASK:
				setRightTask((RegularExpression)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ExpressionPackage.PARALLEL__LEFT_TASK:
				setLeftTask((RegularExpression)null);
				return;
			case ExpressionPackage.PARALLEL__RIGHT_TASK:
				setRightTask((RegularExpression)null);
				return;
		}

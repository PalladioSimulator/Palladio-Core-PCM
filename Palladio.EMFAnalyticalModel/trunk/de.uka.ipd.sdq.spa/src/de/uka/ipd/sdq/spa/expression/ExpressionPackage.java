...
public interface ExpressionPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.spa.expression.impl.RegularExpressionImpl <em>Regular Expression</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uka.ipd.sdq.spa.expression.impl.RegularExpressionImpl
	 * @see de.uka.ipd.sdq.spa.expression.impl.ExpressionPackageImpl#getRegularExpression()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int TERMINAL_FEATURE_COUNT = REGULAR_EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SYMBOL__INPUT_VALUE = TERMINAL_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SYMBOL__NAME = TERMINAL_FEATURE_COUNT + 1;
	...
	/**
	 * The feature id for the '<em><b>Input Val</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SLEEP__INPUT_VAL = TERMINAL_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int OPERATION_FEATURE_COUNT = REGULAR_EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LOOP__ITERATIONS = OPERATION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int LOOP_FEATURE_COUNT = OPERATION_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.spa.expression.RegularExpression <em>Regular Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Regular Expression</em>'.
	 * @see de.uka.ipd.sdq.spa.expression.RegularExpression
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link de.uka.ipd.sdq.spa.expression.Symbol#getInputValue <em>Input Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Input Value</em>'.
	 * @see de.uka.ipd.sdq.spa.expression.Symbol#getInputValue()
	 * @see #getSymbol()
	 * @generated
	 */
	EReference getSymbol_InputValue();
	...
	/**
	 * Returns the meta object for the containment reference '{@link de.uka.ipd.sdq.spa.expression.Sleep#getInputVal <em>Input Val</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Input Val</em>'.
	 * @see de.uka.ipd.sdq.spa.expression.Sleep#getInputVal()
	 * @see #getSleep()
	 * @generated
	 */
	EReference getSleep_InputVal();
	...
	/**
	 * Returns the meta object for the containment reference '{@link de.uka.ipd.sdq.spa.expression.Loop#getIterations <em>Iterations</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Iterations</em>'.
	 * @see de.uka.ipd.sdq.spa.expression.Loop#getIterations()
	 * @see #getLoop()
	 * @generated
	 */
	EReference getLoop_Iterations();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.spa.expression.impl.RegularExpressionImpl <em>Regular Expression</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.spa.expression.impl.RegularExpressionImpl
		 * @see de.uka.ipd.sdq.spa.expression.impl.ExpressionPackageImpl#getRegularExpression()
		 ...
		 * @generated
		 */
		EReference SYMBOL__INPUT_VALUE = eINSTANCE.getSymbol_InputValue();
		...
		/**
		 * The meta object literal for the '<em><b>Input Val</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference SLEEP__INPUT_VAL = eINSTANCE.getSleep_InputVal();
		 ...
		 * @generated
		 */
		EReference LOOP__ITERATIONS = eINSTANCE.getLoop_Iterations();

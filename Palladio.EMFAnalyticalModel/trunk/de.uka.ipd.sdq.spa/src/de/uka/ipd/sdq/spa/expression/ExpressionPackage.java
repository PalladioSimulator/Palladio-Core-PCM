...
public interface ExpressionPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SYMBOL__DEMAND = TERMINAL_FEATURE_COUNT + 1;
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.spa.expression.impl.ResourceDemandImpl <em>Resource Demand</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uka.ipd.sdq.spa.expression.impl.ResourceDemandImpl
	 * @see de.uka.ipd.sdq.spa.expression.impl.ExpressionPackageImpl#getResourceDemand()
	 * @generated
	 */
	int RESOURCE_DEMAND = 3;
	 ...
	 * @ordered
	 */
	int RESOURCE_DEMAND__RESOURCE = 1;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.spa.expression.Symbol#getDemand <em>Demand</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Demand</em>'.
	 * @see de.uka.ipd.sdq.spa.expression.Symbol#getDemand()
	 * @see #getSymbol()
	 * @generated
	 */
	EReference getSymbol_Demand();

	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.spa.expression.ResourceDemand <em>Resource Demand</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Resource Demand</em>'.
	 * @see de.uka.ipd.sdq.spa.expression.ResourceDemand
	 * @generated
	 */
	EClass getResourceDemand();

	/**
	 * Returns the meta object for the containment reference '{@link de.uka.ipd.sdq.spa.expression.ResourceDemand#getPdf <em>Pdf</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Pdf</em>'.
	 * @see de.uka.ipd.sdq.spa.expression.ResourceDemand#getPdf()
	 * @see #getResourceDemand()
	 * @generated
	 */
	EReference getResourceDemand_Pdf();

	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.spa.expression.ResourceDemand#getResource <em>Resource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Resource</em>'.
	 * @see de.uka.ipd.sdq.spa.expression.ResourceDemand#getResource()
	 * @see #getResourceDemand()
	 * @generated
	 */
	...
	interface Literals  {
		 ...
		 * @generated
		 */
		EReference SYMBOL__DEMAND = eINSTANCE.getSymbol_Demand();

		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.spa.expression.impl.ResourceDemandImpl <em>Resource Demand</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.spa.expression.impl.ResourceDemandImpl
		 * @see de.uka.ipd.sdq.spa.expression.impl.ExpressionPackageImpl#getResourceDemand()
		 ...
		 * @generated
		 */
		EReference RESOURCE_DEMAND__PDF = eINSTANCE.getResourceDemand_Pdf();

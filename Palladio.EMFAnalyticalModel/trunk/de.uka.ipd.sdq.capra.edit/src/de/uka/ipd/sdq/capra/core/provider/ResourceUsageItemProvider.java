...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.capra.core.ResourceUsage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceUsageItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addUsageTimeSpecificationPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.RESOURCE_USAGE__RESOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Usage Time Specification feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUsageTimeSpecificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceUsage_usageTimeSpecification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceUsage_usageTimeSpecification_feature", "_UI_ResourceUsage_type"),
				 CorePackage.Literals.RESOURCE_USAGE__USAGE_TIME_SPECIFICATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.RESOURCE_USAGE__USAGE_TIME);
		}
	...
	public String getText(Object object) {
		String label = ((ResourceUsage)object).getUsageTimeSpecification();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.RESOURCE_USAGE__USAGE_TIME,

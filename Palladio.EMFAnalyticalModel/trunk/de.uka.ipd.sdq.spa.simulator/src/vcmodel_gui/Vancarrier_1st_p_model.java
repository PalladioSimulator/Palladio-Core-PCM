 ...
 */
public class Vancarrier_1st_p_model extends Model implements Parameterizable {
	/**
	...
	*/
	protected ProcessQueue truckQueue;
	/**
	...
	*/
	protected ProcessQueue idleVCQueue;
	 ...
	 */
	public Vancarrier_1st_p_model() {
		this(null, "VC1stModel", true, true);
	}
	...
	public void init() {
		...
		//true								= show in report?
		//false								= show in trace?
		truckQueue = new ProcessQueue(this, "Truck Queue", true, false);
		...
		//true								= show in report?
		//false								= show in trace?
		idleVCQueue = new ProcessQueue(this, "idle VC Queue", true, false);
	}
	/**
	...
	public static void main(java.lang.String[] args) {
		...
		for (int i = 0; i < 200; i++) {
			...
			Vancarrier_1st_p_model vc_1st_p_Model =
				new Vancarrier_1st_p_model(
					null,
			...
			vc_1st_p_Experiment.stop(new SimTime(15000));

...
public class ResultmodelPackageImpl extends EPackageImpl implements ResultmodelPackage {
	 ...
	 * @generated
	 */
	private EClass resourceResultEClass = null;
	 ...
	 * @generated
	 */
	public EReference getQNMResultModel_ResourceResults() {
	 ...
	 * @generated
	 */
	public EReference getQNMResultModel_TaskResults() {
	...
	public EReference getQNMResultModel_Taskresourceusages() {
		return (EReference)qnmResultModelEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getQNMResultModel_ResourceUsageTimes() {
		return (EReference)qnmResultModelEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EClass getResourceResult() {
		return resourceResultEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getResourceResult_Resource() {
		return (EReference)resourceResultEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getResourceResult_Taskresourceusages() {
		return (EReference)resourceResultEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getTaskResult_Task() {
	 ...
	 * @generated
	 */
	public EReference getTaskResult_Taskresourceusages() {
		return (EReference)taskResultEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(qnmResultModelEClass, QNM_RESULT_MODEL__RESOURCE_RESULTS);
		createEReference(qnmResultModelEClass, QNM_RESULT_MODEL__TASK_RESULTS);
		createEReference(qnmResultModelEClass, QNM_RESULT_MODEL__TASKRESOURCEUSAGES);
		createEReference(qnmResultModelEClass, QNM_RESULT_MODEL__RESOURCE_USAGE_TIMES);

		resourceResultEClass = createEClass(RESOURCE_RESULT);
		createEReference(resourceResultEClass, RESOURCE_RESULT__RESOURCE);
		createEReference(resourceResultEClass, RESOURCE_RESULT__TASKRESOURCEUSAGES);
		...
		createEReference(taskResourceUsageEClass, TASK_RESOURCE_USAGE__TASKRESULT);
		createEReference(taskResourceUsageEClass, TASK_RESOURCE_USAGE__RESOURCE_RESULT);

		taskResultEClass = createEClass(TASK_RESULT);
		createEReference(taskResultEClass, TASK_RESULT__TASK);
		createEReference(taskResultEClass, TASK_RESULT__TASKRESOURCEUSAGES);
	...
	public void initializePackageContents() {
		...
		initEReference(getQNMResultModel_ResourceResults(), this.getResourceResult(), null, "resourceResults", null, 0, -1, QNMResultModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getQNMResultModel_TaskResults(), this.getTaskResult(), null, "taskResults", null, 0, -1, QNMResultModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EOperation op = addEOperation(qnmResultModelEClass, this.getResourceUsageTime(), "getTimeForResourceUsage", 0, 1);
		addEParameter(op, theResourcemodelPackage.getAbstractResourceUsage(), "resourceUsage", 0, 1);

		op = addEOperation(qnmResultModelEClass, this.getTaskResult(), "getResultForTask", 0, 1);
		addEParameter(op, theQnmPackage.getTask(), "task", 0, 1);

		op = addEOperation(qnmResultModelEClass, this.getResourceResult(), "getResultForResource", 0, 1);
		addEParameter(op, theResourcemodelPackage.getResource(), "OwnedParameter1", 0, 1);

		initEClass(resourceResultEClass, ResourceResult.class, "ResourceResult", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getResourceResult_Resource(), theResourcemodelPackage.getResource(), null, "resource", null, 1, 1, ResourceResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceResult_Taskresourceusages(), this.getTaskResourceUsage(), this.getTaskResourceUsage_ResourceResult(), "taskresourceusages", null, 0, -1, ResourceResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTaskResourceUsage_Taskresult(), this.getTaskResult(), this.getTaskResult_Taskresourceusages(), "taskresult", null, 1, 1, TaskResourceUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTaskResourceUsage_ResourceResult(), this.getResourceResult(), this.getResourceResult_Taskresourceusages(), "resourceResult", null, 1, 1, TaskResourceUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(taskResultEClass, TaskResult.class, "TaskResult", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTaskResult_Task(), theQnmPackage.getTask(), null, "task", null, 1, 1, TaskResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTaskResult_Taskresourceusages(), this.getTaskResourceUsage(), this.getTaskResourceUsage_Taskresult(), "taskresourceusages", null, 0, -1, TaskResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

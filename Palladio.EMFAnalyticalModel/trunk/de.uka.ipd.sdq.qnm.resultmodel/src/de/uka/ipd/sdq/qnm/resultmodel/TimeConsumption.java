 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.qnm.resultmodel.TimeConsumption#getResourceUsage <em>Resource Usage</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.qnm.resultmodel.TimeConsumption#getServiceTime <em>Service Time</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.qnm.resultmodel.TimeConsumption#getResponseTime <em>Response Time</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.qnm.resultmodel.TimeConsumption#getServiceTimeBreakDowns <em>Service Time Break Downs</em>}</li>
 * </ul>
 * </p>
 *
...
public interface TimeConsumption extends EObject {
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.qnm.resultmodel.TimeConsumption#getResourceUsage <em>Resource Usage</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.qnm.resultmodel.TimeConsumption#getServiceTime <em>Service Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.qnm.resultmodel.TimeConsumption#getResponseTime <em>Response Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

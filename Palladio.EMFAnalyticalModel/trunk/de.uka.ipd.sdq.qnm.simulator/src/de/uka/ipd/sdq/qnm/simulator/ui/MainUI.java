package de.uka.ipd.sdq.qnm.simulator.ui;
...
import de.uka.ipd.sdq.qnm.simulator.sensors.ISensorObserver;
import de.uka.ipd.sdq.qnm.simulator.sensors.SensorAddedEvent;
...
public class MainUI extends JFrame {
	...
	public MainUI(SimuQNModel model)
	{
		super("SimuQN Monitor");
		try {
		...
		myModel.getSensorFactory().addSensorObserver(new ISensorObserver(){

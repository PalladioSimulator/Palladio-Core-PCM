	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VariationPackage.VARIATION_TYPE: {
				...
				if (result == null) result = caseIdentifier(variationType);
			...
			case VariationPackage.VALUE_VARIATION: {
				...
				if (result == null) result = caseVariationType(valueVariation);
				if (result == null) result = caseIdentifier(valueVariation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VariationPackage.STRUCTURAL_VARIATION: {
				...
				if (result == null) result = caseVariationType(structuralVariation);
				if (result == null) result = caseIdentifier(structuralVariation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

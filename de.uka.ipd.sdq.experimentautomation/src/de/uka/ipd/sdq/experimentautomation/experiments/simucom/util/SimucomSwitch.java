 ...
 * @generated
 */
public class SimucomSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimucomPackage.SIMU_COM_CONFIGURATION: {
				...
				if (result == null) result = caseAbstractSimulationConfiguration(simuComConfiguration);
				if (result == null) result = caseToolConfiguration(simuComConfiguration);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Simu Com Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Simu Com Configuration</em>'.

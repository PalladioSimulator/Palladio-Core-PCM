 ...
 * @generated
 */
public class EventsimAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected EventsimSwitch<Adapter> modelSwitch =
		new EventsimSwitch<Adapter>() {
			@Override
			public Adapter caseEventSimConfiguration(EventSimConfiguration object) {
				return createEventSimConfigurationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.experimentautomation.experiments.eventsim.EventSimConfiguration <em>Event Sim Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEventSimConfigurationAdapter() {
		return null;
	}

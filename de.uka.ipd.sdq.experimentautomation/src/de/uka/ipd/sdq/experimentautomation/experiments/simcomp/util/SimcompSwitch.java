 ...
 * @generated
 */
public class SimcompSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimcompPackage.SIM_COMP_CONFIGURATION: {
				SimCompConfiguration simCompConfiguration = (SimCompConfiguration)theEObject;
				T result = caseSimCompConfiguration(simCompConfiguration);
				if (result == null) result = caseAbstractSimulationConfiguration(simCompConfiguration);
				if (result == null) result = caseToolConfiguration(simCompConfiguration);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sim Comp Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sim Comp Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSimCompConfiguration(SimCompConfiguration object) {
		return null;
	}

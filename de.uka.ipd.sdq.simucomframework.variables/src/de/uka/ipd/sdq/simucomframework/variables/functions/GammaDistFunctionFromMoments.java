...
public class GammaDistFunctionFromMoments extends AbstractProbDistFunction {
    ...
    /**
     * Checks the validity of the parameter. GammaDistFunctionFromMoments takes two parameters mean
     * and c coefficient of variance mean needs to be larger than 0. c needs to be larger than 0.
     */

...
public class UserData {
	...
	public void overwriteParametersForAssemblyContext(String assemblyContext, SimulatedStackframe<Object> currentStackframe){
...
class UserDataEntry {
	...
	public UserDataEntry(String assemblyContextID, String variableName, 
			Object value) {
		super();

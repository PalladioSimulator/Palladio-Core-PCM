...
public class LogNormDistFunction extends AbstractProbDistFunction {
    ...
    /**
     * Checks the validity of the parameter. Lognorm takes two parameters mu (scale parameter) and
     * sigma (shape parameter) sigma needs to be larger than 0. mu parameter can be any double
     */

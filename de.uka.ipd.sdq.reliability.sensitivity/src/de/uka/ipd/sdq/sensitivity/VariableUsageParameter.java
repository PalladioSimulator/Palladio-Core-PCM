 ...
 *
 * <!-- begin-model-doc -->
 * This&nbsp;parameter&nbsp;refers&nbsp;to&nbsp;a&nbsp;stochastic&nbsp;specification&nbsp;of&nbsp;a
 * variable usage. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.uka.ipd.sdq.sensitivity.VariableUsageParameter#getVariableName <em>Variable Name
 * </em>}</li>
 * <li>
...
public interface VariableUsageParameter extends SingleSensitivityParameter {
     ...
     * <p>
     * If the meaning of the '<em>Variable Name</em>' attribute isn't clear, there really should be
    ...
    /**
     * Returns the value of the '<em><b>Entry Level System Call Variable Usage Parameter</b></em>'
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Entry Level System Call Variable Usage Parameter</em>' reference
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Entry Level System Call Variable Usage Parameter</em>'
     *         reference.
     ...
     * 
     * @param value
     *            the new value of the '<em>Entry Level System Call Variable Usage Parameter</em>'
     *            reference.
     ...
     * <em><b>Variable Characterisation Type Variable Usage Parameter</b></em>' attribute. The
     * literals are from the enumeration
     * {@link de.uka.ipd.sdq.pcm.parameter.VariableCharacterisationType}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Variable Characterisation Type Variable Usage Parameter</em>'
     * attribute isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Variable Characterisation Type Variable Usage Parameter</em>'
     *         attribute.
    ...
    /**
     * Returns the value of the '<em><b>Variable Usage Type Variable Usage Parameter</b></em>'
     * attribute. The literals are from the enumeration
     * {@link de.uka.ipd.sdq.sensitivity.VariableUsageType}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Variable Usage Type Variable Usage Parameter</em>' attribute isn't
     ...
     * 
     * @param value
     *            the new value of the '<em>Variable Usage Type Variable Usage Parameter</em>'
     *            attribute.
     * @see de.uka.ipd.sdq.sensitivity.VariableUsageType
    ...
    /**
     * Returns the value of the '<em><b>Basic Component Variable Usage Parameter</b></em>'
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Basic Component Variable Usage Parameter</em>' reference isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * 
     * @param value
     *            the new value of the '<em>Basic Component Variable Usage Parameter</em>'
     *            reference.
     ...
     * .oclIsTypeOf(StringParameterSequence)
     * 
     * @param diagnostics

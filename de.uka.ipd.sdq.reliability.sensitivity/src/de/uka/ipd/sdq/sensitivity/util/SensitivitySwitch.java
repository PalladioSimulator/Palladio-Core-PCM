...
public class SensitivitySwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case SensitivityPackage.SENSITIVITY_CONFIGURATION: {
            ...
            if (result == null)
                result = caseEntity(sensitivityConfiguration);
            if (result == null)
                result = caseIdentifier(sensitivityConfiguration);
            if (result == null)
                result = caseNamedElement(sensitivityConfiguration);
            if (result == null)
        ...
        case SensitivityPackage.SENSITIVITY_PARAMETER: {
            ...
            if (result == null)
                result = caseEntity(sensitivityParameter);
            if (result == null)
                result = caseIdentifier(sensitivityParameter);
            if (result == null)
                result = caseNamedElement(sensitivityParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.COMBINED_SENSITIVITY_PARAMETER: {
            ...
            if (result == null)
                result = caseSensitivityParameter(combinedSensitivityParameter);
            if (result == null)
                result = caseEntity(combinedSensitivityParameter);
            if (result == null)
                result = caseIdentifier(combinedSensitivityParameter);
            if (result == null)
                result = caseNamedElement(combinedSensitivityParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.SENSITIVITY_RESULT_SPECIFICATION: {
            ...
            if (result == null)
                result = caseEntity(sensitivityResultSpecification);
            if (result == null)
                result = caseIdentifier(sensitivityResultSpecification);
            if (result == null)
                result = caseNamedElement(sensitivityResultSpecification);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.SINGLE_SENSITIVITY_PARAMETER: {
            ...
            if (result == null)
                result = caseSensitivityParameter(singleSensitivityParameter);
            if (result == null)
                result = caseEntity(singleSensitivityParameter);
            if (result == null)
                result = caseIdentifier(singleSensitivityParameter);
            if (result == null)
                result = caseNamedElement(singleSensitivityParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        ...
        case SensitivityPackage.COMPONENT_RELIABILITY_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(componentReliabilityParameter);
            if (result == null)
                result = caseSensitivityParameter(componentReliabilityParameter);
            if (result == null)
                result = caseEntity(componentReliabilityParameter);
            if (result == null)
                result = caseIdentifier(componentReliabilityParameter);
            if (result == null)
                result = caseNamedElement(componentReliabilityParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.DOUBLE_PARAMETER_VARIATION: {
            ...
            if (result == null)
                result = caseSensitivityParameterVariation(doubleParameterVariation);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.STRING_PARAMETER_SEQUENCE: {
            ...
            if (result == null)
                result = caseSensitivityParameterVariation(stringParameterSequence);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.DOUBLE_PARAMETER_RANGE: {
            ...
            if (result == null)
                result = caseDoubleParameterVariation(doubleParameterRange);
            if (result == null)
                result = caseSensitivityParameterVariation(doubleParameterRange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.DOUBLE_PARAMETER_SEQUENCE: {
            ...
            if (result == null)
                result = caseDoubleParameterVariation(doubleParameterSequence);
            if (result == null)
                result = caseSensitivityParameterVariation(doubleParameterSequence);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.DOUBLE_PARAMETER_FUNCTION: {
            ...
            if (result == null)
                result = caseDoubleParameterVariation(doubleParameterFunction);
            if (result == null)
                result = caseSensitivityParameterVariation(doubleParameterFunction);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.INTERNAL_ACTION_RELIABILITY_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(internalActionReliabilityParameter);
            if (result == null)
                result = caseSensitivityParameter(internalActionReliabilityParameter);
            if (result == null)
                result = caseEntity(internalActionReliabilityParameter);
            if (result == null)
                result = caseIdentifier(internalActionReliabilityParameter);
            if (result == null)
                result = caseNamedElement(internalActionReliabilityParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.PROBABILISTIC_BRANCH_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(probabilisticBranchParameter);
            if (result == null)
                result = caseSensitivityParameter(probabilisticBranchParameter);
            if (result == null)
                result = caseEntity(probabilisticBranchParameter);
            if (result == null)
                result = caseIdentifier(probabilisticBranchParameter);
            if (result == null)
                result = caseNamedElement(probabilisticBranchParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.HARDWARE_MTTF_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(hardwareMTTFParameter);
            if (result == null)
                result = caseSensitivityParameter(hardwareMTTFParameter);
            if (result == null)
                result = caseEntity(hardwareMTTFParameter);
            if (result == null)
                result = caseIdentifier(hardwareMTTFParameter);
            if (result == null)
                result = caseNamedElement(hardwareMTTFParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.HARDWARE_MTTR_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(hardwareMTTRParameter);
            if (result == null)
                result = caseSensitivityParameter(hardwareMTTRParameter);
            if (result == null)
                result = caseEntity(hardwareMTTRParameter);
            if (result == null)
                result = caseIdentifier(hardwareMTTRParameter);
            if (result == null)
                result = caseNamedElement(hardwareMTTRParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.RESOURCE_MTTF_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(resourceMTTFParameter);
            if (result == null)
                result = caseSensitivityParameter(resourceMTTFParameter);
            if (result == null)
                result = caseEntity(resourceMTTFParameter);
            if (result == null)
                result = caseIdentifier(resourceMTTFParameter);
            if (result == null)
                result = caseNamedElement(resourceMTTFParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.RESOURCE_MTTR_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(resourceMTTRParameter);
            if (result == null)
                result = caseSensitivityParameter(resourceMTTRParameter);
            if (result == null)
                result = caseEntity(resourceMTTRParameter);
            if (result == null)
                result = caseIdentifier(resourceMTTRParameter);
            if (result == null)
                result = caseNamedElement(resourceMTTRParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.NETWORK_RELIABILITY_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(networkReliabilityParameter);
            if (result == null)
                result = caseSensitivityParameter(networkReliabilityParameter);
            if (result == null)
                result = caseEntity(networkReliabilityParameter);
            if (result == null)
                result = caseIdentifier(networkReliabilityParameter);
            if (result == null)
                result = caseNamedElement(networkReliabilityParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.COMMUNICATION_LINK_RELIABILITY_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(communicationLinkReliabilityParameter);
            if (result == null)
                result = caseSensitivityParameter(communicationLinkReliabilityParameter);
            if (result == null)
                result = caseEntity(communicationLinkReliabilityParameter);
            if (result == null)
                result = caseIdentifier(communicationLinkReliabilityParameter);
            if (result == null)
                result = caseNamedElement(communicationLinkReliabilityParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.SOFTWARE_RELIABILITY_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(softwareReliabilityParameter);
            if (result == null)
                result = caseSensitivityParameter(softwareReliabilityParameter);
            if (result == null)
                result = caseEntity(softwareReliabilityParameter);
            if (result == null)
                result = caseIdentifier(softwareReliabilityParameter);
            if (result == null)
                result = caseNamedElement(softwareReliabilityParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.VARIABLE_USAGE_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(variableUsageParameter);
            if (result == null)
                result = caseSensitivityParameter(variableUsageParameter);
            if (result == null)
                result = caseEntity(variableUsageParameter);
            if (result == null)
                result = caseIdentifier(variableUsageParameter);
            if (result == null)
                result = caseNamedElement(variableUsageParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.USAGE_BRANCH_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(usageBranchParameter);
            if (result == null)
                result = caseSensitivityParameter(usageBranchParameter);
            if (result == null)
                result = caseEntity(usageBranchParameter);
            if (result == null)
                result = caseIdentifier(usageBranchParameter);
            if (result == null)
                result = caseNamedElement(usageBranchParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.DOUBLE_OFFSET_SEQUENCE: {
            ...
            if (result == null)
                result = caseDoubleParameterVariation(doubleOffsetSequence);
            if (result == null)
                result = caseSensitivityParameterVariation(doubleOffsetSequence);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.SOFTWARE_FAILURE_TYPES_PARAMETER: {
            ...
            if (result == null)
                result = caseSingleSensitivityParameter(softwareFailureTypesParameter);
            if (result == null)
                result = caseSensitivityParameter(softwareFailureTypesParameter);
            if (result == null)
                result = caseEntity(softwareFailureTypesParameter);
            if (result == null)
                result = caseIdentifier(softwareFailureTypesParameter);
            if (result == null)
                result = caseNamedElement(softwareFailureTypesParameter);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.FAILURE_TYPE_RESULT_SPECIFICATION: {
            ...
            if (result == null)
                result = caseSensitivityResultSpecification(failureTypeResultSpecification);
            if (result == null)
                result = caseEntity(failureTypeResultSpecification);
            if (result == null)
                result = caseIdentifier(failureTypeResultSpecification);
            if (result == null)
                result = caseNamedElement(failureTypeResultSpecification);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SensitivityPackage.FAILURE_DIMENSION_RESULT_SPECIFICATION: {
            ...
            if (result == null)
                result = caseSensitivityResultSpecification(failureDimensionResultSpecification);
            if (result == null)
                result = caseEntity(failureDimensionResultSpecification);
            if (result == null)
                result = caseIdentifier(failureDimensionResultSpecification);
            if (result == null)
                result = caseNamedElement(failureDimensionResultSpecification);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }

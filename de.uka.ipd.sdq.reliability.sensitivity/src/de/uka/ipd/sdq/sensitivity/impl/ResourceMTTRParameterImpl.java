 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.ResourceMTTRParameterImpl#getResourceContainer__ResourceMTTRParameter
 * <em>Resource Container Resource MTTR Parameter</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.ResourceMTTRParameterImpl#getProcessingResourceType__ResourceMTTRParameter
...
public class ResourceMTTRParameterImpl extends SingleSensitivityParameterImpl implements ResourceMTTRParameter {
            ...
            if (resourceContainer__ResourceMTTRParameter != oldResourceContainer__ResourceMTTRParameter) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ...
                            oldResourceContainer__ResourceMTTRParameter, resourceContainer__ResourceMTTRParameter));
            }
        }
    ...
    public void setResourceContainer__ResourceMTTRParameter(
            ResourceContainer newResourceContainer__ResourceMTTRParameter) {
    ...
    public ProcessingResourceType getProcessingResourceType__ResourceMTTRParameter() {
        if (processingResourceType__ResourceMTTRParameter != null
                && processingResourceType__ResourceMTTRParameter.eIsProxy()) {
            ...
            if (processingResourceType__ResourceMTTRParameter != oldProcessingResourceType__ResourceMTTRParameter) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            processingResourceType__ResourceMTTRParameter));
            }
        }
    ...
    public void setProcessingResourceType__ResourceMTTRParameter(
            ProcessingResourceType newProcessingResourceType__ResourceMTTRParameter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SensitivityPackage.RESOURCE_MTTR_PARAMETER__PROCESSING_RESOURCE_TYPE_RESOURCE_MTTR_PARAMETER,
                    oldProcessingResourceType__ResourceMTTRParameter, processingResourceType__ResourceMTTRParameter));
    }
                ...
                diagnostics
                        .add(new BasicDiagnostic(
                                ...
                                EcorePlugin.INSTANCE.getString(
                                        ...
                                        new Object[] {
                                                "ResourceMTTRParameterMustHaveDoubleVariation",
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case SensitivityPackage.RESOURCE_MTTR_PARAMETER__RESOURCE_CONTAINER_RESOURCE_MTTR_PARAMETER:
            if (resolve)
                return getResourceContainer__ResourceMTTRParameter();
        ...
        case SensitivityPackage.RESOURCE_MTTR_PARAMETER__PROCESSING_RESOURCE_TYPE_RESOURCE_MTTR_PARAMETER:
            if (resolve)
                return getProcessingResourceType__ResourceMTTRParameter();

 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.ComponentReliabilityParameterImpl#getBasicComponent__ComponentReliabilityParameter
 ...
 * @generated
 */
public class ComponentReliabilityParameterImpl extends SingleSensitivityParameterImpl implements
    ...
    public BasicComponent getBasicComponent__ComponentReliabilityParameter() {
        if (basicComponent__ComponentReliabilityParameter != null
                && basicComponent__ComponentReliabilityParameter.eIsProxy()) {
            ...
            if (basicComponent__ComponentReliabilityParameter != oldBasicComponent__ComponentReliabilityParameter) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            basicComponent__ComponentReliabilityParameter));
            }
        }
    ...
    public void setBasicComponent__ComponentReliabilityParameter(
            BasicComponent newBasicComponent__ComponentReliabilityParameter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                    ...
                    Notification.SET,
                    SensitivityPackage.COMPONENT_RELIABILITY_PARAMETER__BASIC_COMPONENT_COMPONENT_RELIABILITY_PARAMETER,
                    oldBasicComponent__ComponentReliabilityParameter, basicComponent__ComponentReliabilityParameter));
    }
     ...
     * @generated
     */
    public boolean ComponentReliabilityParameterMustHaveDoubleVariation(DiagnosticChain diagnostics,
                ...
                diagnostics
                        .add(new BasicDiagnostic(
                                ...
                                EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic",
                                        new Object[] {
                                                "ComponentReliabilityParameterMustHaveDoubleVariation",
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case SensitivityPackage.COMPONENT_RELIABILITY_PARAMETER__BASIC_COMPONENT_COMPONENT_RELIABILITY_PARAMETER:
            if (resolve)
                return getBasicComponent__ComponentReliabilityParameter();

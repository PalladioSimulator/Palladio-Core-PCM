 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.SoftwareFailureTypesParameterImpl#getSoftwareInducedFailureTypes__SoftwareFailureTypeReliabilityParameter
 ...
 * @generated
 */
public class SoftwareFailureTypesParameterImpl extends SingleSensitivityParameterImpl implements
    ...
    public EList<SoftwareInducedFailureType> getSoftwareInducedFailureTypes__SoftwareFailureTypeReliabilityParameter() {
        if (softwareInducedFailureTypes__SoftwareFailureTypeReliabilityParameter == null) {
            softwareInducedFailureTypes__SoftwareFailureTypeReliabilityParameter = new EObjectResolvingEList<SoftwareInducedFailureType>(
                    SoftwareInducedFailureType.class,
                    this,
     ...
     * @generated
     */
    public boolean SoftwareFailureTypeReliabilityParameterMustHaveDoubleVariation(DiagnosticChain diagnostics,
                ...
                diagnostics
                        .add(new BasicDiagnostic(
                                ...
                                EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] {
                                        "SoftwareFailureTypeReliabilityParameterMustHaveDoubleVariation",
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case SensitivityPackage.SOFTWARE_FAILURE_TYPES_PARAMETER__SOFTWARE_INDUCED_FAILURE_TYPES_SOFTWARE_FAILURE_TYPE_RELIABILITY_PARAMETER:
            ...
            getSoftwareInducedFailureTypes__SoftwareFailureTypeReliabilityParameter().addAll(
                    (Collection<? extends SoftwareInducedFailureType>) newValue);
            return;
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case SensitivityPackage.SOFTWARE_FAILURE_TYPES_PARAMETER__SOFTWARE_INDUCED_FAILURE_TYPES_SOFTWARE_FAILURE_TYPE_RELIABILITY_PARAMETER:
            return softwareInducedFailureTypes__SoftwareFailureTypeReliabilityParameter != null
                    && !softwareInducedFailureTypes__SoftwareFailureTypeReliabilityParameter.isEmpty();
        }

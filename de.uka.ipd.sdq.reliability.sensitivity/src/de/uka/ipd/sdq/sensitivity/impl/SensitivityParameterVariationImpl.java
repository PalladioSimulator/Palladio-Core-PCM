 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.SensitivityParameterVariationImpl#getSingleSensitivityParameter__SensitivityParameterVariation
...
public abstract class SensitivityParameterVariationImpl extends EObjectImpl implements SensitivityParameterVariation {
    ...
    public SingleSensitivityParameter getSingleSensitivityParameter__SensitivityParameterVariation() {
        if (eContainerFeatureID() != SensitivityPackage.SENSITIVITY_PARAMETER_VARIATION__SINGLE_SENSITIVITY_PARAMETER_SENSITIVITY_PARAMETER_VARIATION)
            return null;
    ...
    public NotificationChain basicSetSingleSensitivityParameter__SensitivityParameterVariation(
            SingleSensitivityParameter newSingleSensitivityParameter__SensitivityParameterVariation,
            NotificationChain msgs) {
        msgs = eBasicSetContainer(
                (InternalEObject) newSingleSensitivityParameter__SensitivityParameterVariation,
    ...
    public void setSingleSensitivityParameter__SensitivityParameterVariation(
            SingleSensitivityParameter newSingleSensitivityParameter__SensitivityParameterVariation) {
        if (newSingleSensitivityParameter__SensitivityParameterVariation != eInternalContainer()
                || (eContainerFeatureID() != SensitivityPackage.SENSITIVITY_PARAMETER_VARIATION__SINGLE_SENSITIVITY_PARAMETER_SENSITIVITY_PARAMETER_VARIATION && newSingleSensitivityParameter__SensitivityParameterVariation != null)) {
            ...
            if (newSingleSensitivityParameter__SensitivityParameterVariation != null)
                msgs = ((InternalEObject) newSingleSensitivityParameter__SensitivityParameterVariation)
                        .eInverseAdd(
                                this,
            ...
            msgs = basicSetSingleSensitivityParameter__SensitivityParameterVariation(
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case SensitivityPackage.SENSITIVITY_PARAMETER_VARIATION__SINGLE_SENSITIVITY_PARAMETER_SENSITIVITY_PARAMETER_VARIATION:
            if (eInternalContainer() != null)
                msgs = eBasicRemoveFromContainer(msgs);
            return basicSetSingleSensitivityParameter__SensitivityParameterVariation(

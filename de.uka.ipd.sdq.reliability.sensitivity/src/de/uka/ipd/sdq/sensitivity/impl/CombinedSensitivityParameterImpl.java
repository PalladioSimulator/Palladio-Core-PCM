 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.sensitivity.impl.CombinedSensitivityParameterImpl#isCombinatory <em>Is
 * Combinatory</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.CombinedSensitivityParameterImpl#getChildParameters__CombinedSensitivityParameter
...
public class CombinedSensitivityParameterImpl extends SensitivityParameterImpl implements CombinedSensitivityParameter {
    ...
    public void setIsCombinatory(boolean newIsCombinatory) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SensitivityPackage.COMBINED_SENSITIVITY_PARAMETER__IS_COMBINATORY, oldIsCombinatory, isCombinatory));
    }
    ...
    public EList<SensitivityParameter> getChildParameters__CombinedSensitivityParameter() {
        if (childParameters__CombinedSensitivityParameter == null) {
            childParameters__CombinedSensitivityParameter = new EObjectContainmentWithInverseEList<SensitivityParameter>(
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case SensitivityPackage.COMBINED_SENSITIVITY_PARAMETER__CHILD_PARAMETERS_COMBINED_SENSITIVITY_PARAMETER:
            return ((InternalEList<InternalEObject>) (InternalEList<?>) getChildParameters__CombinedSensitivityParameter())
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case SensitivityPackage.COMBINED_SENSITIVITY_PARAMETER__CHILD_PARAMETERS_COMBINED_SENSITIVITY_PARAMETER:
            ...
            getChildParameters__CombinedSensitivityParameter().addAll(
                    (Collection<? extends SensitivityParameter>) newValue);
            return;
        }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case SensitivityPackage.COMBINED_SENSITIVITY_PARAMETER__CHILD_PARAMETERS_COMBINED_SENSITIVITY_PARAMETER:
            return childParameters__CombinedSensitivityParameter != null
                    && !childParameters__CombinedSensitivityParameter.isEmpty();
        }

 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.ProbabilisticBranchParameterImpl#getProbabilisticBranchTransition__ProbabilisticBranchParameter
 ...
 * @generated
 */
public class ProbabilisticBranchParameterImpl extends SingleSensitivityParameterImpl implements
    ...
    public ProbabilisticBranchTransition getProbabilisticBranchTransition__ProbabilisticBranchParameter() {
        if (probabilisticBranchTransition__ProbabilisticBranchParameter != null
                && probabilisticBranchTransition__ProbabilisticBranchParameter.eIsProxy()) {
            ...
            if (probabilisticBranchTransition__ProbabilisticBranchParameter != oldProbabilisticBranchTransition__ProbabilisticBranchParameter) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            probabilisticBranchTransition__ProbabilisticBranchParameter));
            }
        }
    ...
    public void setProbabilisticBranchTransition__ProbabilisticBranchParameter(
            ProbabilisticBranchTransition newProbabilisticBranchTransition__ProbabilisticBranchParameter) {
     ...
     * @generated
     */
    public boolean ProbabilisticBranchParameterMustHaveDoubleVariation(DiagnosticChain diagnostics,
                ...
                diagnostics
                        .add(new BasicDiagnostic(
                                ...
                                EcorePlugin.INSTANCE.getString(
                                        ...
                                        new Object[] {
                                                "ProbabilisticBranchParameterMustHaveDoubleVariation",
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case SensitivityPackage.PROBABILISTIC_BRANCH_PARAMETER__PROBABILISTIC_BRANCH_TRANSITION_PROBABILISTIC_BRANCH_PARAMETER:
            if (resolve)
                return getProbabilisticBranchTransition__ProbabilisticBranchParameter();

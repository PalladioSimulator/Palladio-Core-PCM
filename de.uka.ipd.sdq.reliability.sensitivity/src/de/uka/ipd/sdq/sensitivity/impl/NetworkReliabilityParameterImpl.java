...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Network Reliability Parameter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
...
public class NetworkReliabilityParameterImpl extends SingleSensitivityParameterImpl implements NetworkReliabilityParameter {
	 ...
	 * @generated
	 */
	public boolean NetworkReliabilityParameterMustHaveDoubleVariation(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NetworkReliabilityParameterMustHaveDoubleVariation", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}

 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.UsageBranchParameterImpl#getBranch__UsageBranchParameter
 * <em>Branch Usage Branch Parameter</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.UsageBranchParameterImpl#getScenarioBehaviour__UsageBranchParameter
...
public class UsageBranchParameterImpl extends SingleSensitivityParameterImpl implements UsageBranchParameter {
            ...
            if (branch__UsageBranchParameter != oldBranch__UsageBranchParameter) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ...
                            oldBranch__UsageBranchParameter, branch__UsageBranchParameter));
            }
        }
            ...
            if (scenarioBehaviour__UsageBranchParameter != oldScenarioBehaviour__UsageBranchParameter) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ...
                            oldScenarioBehaviour__UsageBranchParameter, scenarioBehaviour__UsageBranchParameter));
            }
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case SensitivityPackage.USAGE_BRANCH_PARAMETER__BRANCH_USAGE_BRANCH_PARAMETER:
            if (resolve)
                return getBranch__UsageBranchParameter();
        ...
        case SensitivityPackage.USAGE_BRANCH_PARAMETER__SCENARIO_BEHAVIOUR_USAGE_BRANCH_PARAMETER:
            if (resolve)
                return getScenarioBehaviour__UsageBranchParameter();

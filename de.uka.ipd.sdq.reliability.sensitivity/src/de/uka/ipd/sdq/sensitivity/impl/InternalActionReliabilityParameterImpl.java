 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.InternalActionReliabilityParameterImpl#getSoftwareInducedFailureType__InternalActionReliabilityParameter
 * <em>Software Induced Failure Type Internal Action Reliability Parameter</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.InternalActionReliabilityParameterImpl#getInternalAction__InternalActionReliabilityParameter
 ...
 * @generated
 */
public class InternalActionReliabilityParameterImpl extends SingleSensitivityParameterImpl implements
    ...
    public SoftwareInducedFailureType getSoftwareInducedFailureType__InternalActionReliabilityParameter() {
        if (softwareInducedFailureType__InternalActionReliabilityParameter != null
                && softwareInducedFailureType__InternalActionReliabilityParameter.eIsProxy()) {
            ...
            if (softwareInducedFailureType__InternalActionReliabilityParameter != oldSoftwareInducedFailureType__InternalActionReliabilityParameter) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            softwareInducedFailureType__InternalActionReliabilityParameter));
            }
        }
    ...
    public void setSoftwareInducedFailureType__InternalActionReliabilityParameter(
            SoftwareInducedFailureType newSoftwareInducedFailureType__InternalActionReliabilityParameter) {
    ...
    public InternalAction getInternalAction__InternalActionReliabilityParameter() {
        if (internalAction__InternalActionReliabilityParameter != null
                && internalAction__InternalActionReliabilityParameter.eIsProxy()) {
    ...
    public void setInternalAction__InternalActionReliabilityParameter(
            InternalAction newInternalAction__InternalActionReliabilityParameter) {
     ...
     * @generated
     */
    public boolean InternalActionReliabilityParameterMustHaveDoubleVariation(DiagnosticChain diagnostics,
                ...
                diagnostics
                        .add(new BasicDiagnostic(
                                ...
                                EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic",
                                        new Object[] {
                                                "InternalActionReliabilityParameterMustHaveDoubleVariation",
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case SensitivityPackage.INTERNAL_ACTION_RELIABILITY_PARAMETER__SOFTWARE_INDUCED_FAILURE_TYPE_INTERNAL_ACTION_RELIABILITY_PARAMETER:
            if (resolve)
                return getSoftwareInducedFailureType__InternalActionReliabilityParameter();
        ...
        case SensitivityPackage.INTERNAL_ACTION_RELIABILITY_PARAMETER__INTERNAL_ACTION_INTERNAL_ACTION_RELIABILITY_PARAMETER:
            if (resolve)
                return getInternalAction__InternalActionReliabilityParameter();

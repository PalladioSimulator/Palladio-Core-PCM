...
import de.uka.ipd.sdq.cip.CIPluginActivator;

public class CIPOptionsTab extends AbstractLaunchConfigurationTab {
	...
	public void createControl(Composite parent) {
		final ModifyListener modifyListener = new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				CIPOptionsTab.this.setDirty(true);
				CIPOptionsTab.this.updateLaunchConfigurationDialog();
			}
		};
	...
	public Image getImage() {
		if (icon == null){
			icon = CIPluginActivator.getImageDescriptor("icons/completion.gif").createImage(); 
		}
		return icon;
	}
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		try {
			maximumIterations.setText(configuration.getAttribute(
					CIPConstantsContainer.MAX_ITERATIONS, ""));

 ...
 */
public class CIPluginActivator extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "de.uka.ipd.sdq.cip";

	// The shared instance
	private static CIPluginActivator plugin;
	
	/**
	 * The constructor
	 */
	public CIPluginActivator() {
		plugin= this;
	}
	 ...
	 */
	public static CIPluginActivator getDefault() {
		return plugin;
	}

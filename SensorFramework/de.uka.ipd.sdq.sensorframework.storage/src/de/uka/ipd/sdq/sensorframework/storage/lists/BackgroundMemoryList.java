 ...
 * list. It relies on HDD memory as background storage. It uses chunks which are filled and upon fully filled swapped to disk.
 * The list has some restrictions for this to work. First, all elements have to be serialisable with constant memory footprint. Second,

...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.edp2.models.ExperimentData.ExperimentSetting} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExperimentSettingItemProvider
	 ...
	 * @generated
	 */
	public ExperimentSettingItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExperimentSetting_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExperimentSetting_description_feature", "_UI_ExperimentSetting_type"),
	...
	protected void addMeasurePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExperimentSetting_measure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExperimentSetting_measure_feature", "_UI_ExperimentSetting_type"),
				 ExperimentDataPackage.Literals.EXPERIMENT_SETTING__MEASURE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExperimentDataPackage.Literals.EXPERIMENT_SETTING__EXPERIMENT_RUNS);
		}
	...
	/**
	 * This returns ExperimentSetting.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExperimentSetting"));
	}
	...
	public String getText(Object object) {
		String label = ((ExperimentSetting)object).getUuid();
		return label == null || label.length() == 0 ?
			getString("_UI_ExperimentSetting_type") :

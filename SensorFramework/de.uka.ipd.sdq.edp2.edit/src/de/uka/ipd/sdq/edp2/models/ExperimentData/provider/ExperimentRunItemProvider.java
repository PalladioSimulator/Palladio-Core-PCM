...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.edp2.models.ExperimentData.ExperimentRun} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExperimentRunItemProvider
	 ...
	 * @generated
	 */
	public ExperimentRunItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExperimentRun_startTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExperimentRun_startTime_feature", "_UI_ExperimentRun_type"),
				 ExperimentDataPackage.Literals.EXPERIMENT_RUN__START_TIME,
				 true,
				 false,
				 false,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExperimentRun_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExperimentRun_duration_feature", "_UI_ExperimentRun_type"),
				 ExperimentDataPackage.Literals.EXPERIMENT_RUN__DURATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExperimentDataPackage.Literals.EXPERIMENT_RUN__MEASUREMENTS);
		}
	...
	/**
	 * This returns ExperimentRun.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExperimentRun"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExperimentRun.class)) {

 ...
 * @generated
 */
public class BranchBranchCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		EObject nextValue;
		int nodeVID;
		for (Iterator values = ((Branch) modelObject)
				.getBranchTransitions_Branch().iterator(); values.hasNext();) {

...
import de.uka.ipd.sdq.pcm.gmf.usage.edit.policies.ScenarioBehaviour3ItemSemanticEditPolicy;
import de.uka.ipd.sdq.pcm.gmf.usage.part.PalladioComponentModelVisualIDRegistry;

/**
 * @generated
 */
public class ScenarioBehaviour3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ScenarioBehaviour3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ScenarioBehaviour3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScenarioBehaviourIdEditPart) {
			((ScenarioBehaviourIdEditPart) childEditPart)

...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.policies.AquireActionItemSemanticEditPolicy;
import de.uka.ipd.sdq.pcm.gmf.seff.part.PalladioComponentModelVisualIDRegistry;

/**
 * @generated
 */
public class AquireActionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AquireActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AquireActionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AquireActionEntityNameEditPart) {
			((AquireActionEntityNameEditPart) childEditPart)

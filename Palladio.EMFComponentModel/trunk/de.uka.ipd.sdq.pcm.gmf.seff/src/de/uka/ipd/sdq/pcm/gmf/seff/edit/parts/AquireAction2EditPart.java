...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.policies.AquireAction2ItemSemanticEditPolicy;
import de.uka.ipd.sdq.pcm.gmf.seff.part.PalladioComponentModelVisualIDRegistry;

/**
 * @generated
 */
public class AquireAction2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AquireAction2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AquireAction2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AquireActionEntityName2EditPart) {
			((AquireActionEntityName2EditPart) childEditPart)
	...
	public class AquireFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			setFigureAquireNameLabelFigure(aquireNameLabelFigure0);
		 ...
		 * @generated
		 */
		private WrapLabel fAquireNameLabelFigure;

		/**
		 * @generated
		 */
		public WrapLabel getFigureAquireNameLabelFigure() {
			return fAquireNameLabelFigure;
		}

		/**
		 * @generated
		 */
		private void setFigureAquireNameLabelFigure(WrapLabel fig) {
			fAquireNameLabelFigure = fig;
		}

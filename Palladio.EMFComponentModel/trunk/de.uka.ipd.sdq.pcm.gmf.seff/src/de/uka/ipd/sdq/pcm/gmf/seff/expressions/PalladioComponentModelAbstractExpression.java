...
public abstract class PalladioComponentModelAbstractExpression {
	...
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform
							.getDebugOption(PalladioComponentModelSeffDiagramEditorPlugin
	 ...
	 * @generated
	 */
	protected PalladioComponentModelAbstractExpression(EClassifier context) {
		this(null, context);
	}
	 ...
	 * @generated
	 */
	protected PalladioComponentModelAbstractExpression(String body,
			EClassifier context) {
		this.body = body;
		...
		if (context().isInstance(context)) {
			try {
				...
				PalladioComponentModelSeffDiagramEditorPlugin.getInstance()
						.logError("Expression evaluation failure: " + body, e);
			}
		}
		return null;
	}

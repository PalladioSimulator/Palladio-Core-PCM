 ...
 * @generated
 */
public class InternalActionResourceDemandResourceDemandingActionCompartmentViewFactory
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.InternalActionResourceDemandResourceDemandingActionCompartmentEditPart.VISUAL_ID);

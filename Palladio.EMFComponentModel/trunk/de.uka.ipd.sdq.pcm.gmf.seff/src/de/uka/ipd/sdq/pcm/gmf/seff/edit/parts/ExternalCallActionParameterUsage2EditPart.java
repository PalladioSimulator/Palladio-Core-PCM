...
public class ExternalCallActionParameterUsage2EditPart extends
	...
	public String getCompartmentName() {
		return Messages.ExternalCallActionParameterUsage2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ExternalCallActionParameterUsage2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ExternalCallActionParameterUsage2CanonicalEditPolicy());
	}

 ...
 * @generated
 */
public class ExternalCallActionOutputVariableUsageCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		EObject nextValue;
		int nodeVID;
		for (Iterator values = ((ExternalCallAction) modelObject)
				.getOutputVariableUsage_ExternalCallAction().iterator(); values
				.hasNext();) {

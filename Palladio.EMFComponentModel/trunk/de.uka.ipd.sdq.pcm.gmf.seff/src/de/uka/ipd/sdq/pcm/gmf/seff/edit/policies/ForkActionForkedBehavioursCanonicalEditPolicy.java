 ...
 * @generated
 */
public class ForkActionForkedBehavioursCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		EObject nextValue;
		int nodeVID;
		for (Iterator values = ((ForkAction) modelObject)
				.getForkedBehaviours_Fork().iterator(); values.hasNext();) {

...
public class PalladioComponentModelElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType ParametricResourceDemand_3008 = getElementType("de.uka.ipd.sdq.pcm.gmf.seff.ParametricResourceDemand_3008"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ParametricResourceDemand_3008, SeffPackage.eINSTANCE

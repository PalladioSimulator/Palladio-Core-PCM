 ...
 * @generated
 */
public class LoopAction2ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.ipd.uka.sdq.pcm.gmf.seff.edit.parts.LoopAction2EditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				PcmVisualIDRegistry
						.getType(LoopActionIterationsEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						semanticAdapter,

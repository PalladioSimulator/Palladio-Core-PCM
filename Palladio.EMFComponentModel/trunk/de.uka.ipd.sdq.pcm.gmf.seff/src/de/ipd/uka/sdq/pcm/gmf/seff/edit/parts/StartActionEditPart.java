...
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.StartActionCanonicalEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.StartActionGraphicalNodeEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.StartActionItemSemanticEditPolicy;
...
public class StartActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new StartActionGraphicalNodeEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new StartActionCanonicalEditPolicy());

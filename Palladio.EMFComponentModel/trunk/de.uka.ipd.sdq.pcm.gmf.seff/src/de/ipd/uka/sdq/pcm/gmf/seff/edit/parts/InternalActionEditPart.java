...
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.InternalActionCanonicalEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.InternalActionGraphicalNodeEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.InternalActionItemSemanticEditPolicy;
...
public class InternalActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new InternalActionGraphicalNodeEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new InternalActionCanonicalEditPolicy());

 ...
 * @generated
 */
public class PrimitiveParametricParameterUsageViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.ipd.uka.sdq.pcm.gmf.seff.edit.parts.PrimitiveParametricParameterUsageEditPart.VISUAL_ID);

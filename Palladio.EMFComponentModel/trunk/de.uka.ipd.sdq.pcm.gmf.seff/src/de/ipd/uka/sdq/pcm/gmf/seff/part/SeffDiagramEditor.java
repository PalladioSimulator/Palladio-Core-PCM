...
import de.ipd.uka.sdq.pcm.gmf.seff.edit.parts.PcmEditPartFactory;
 ...
 * @generated
 */
public class SeffDiagramEditor extends FileDiagramEditor implements IGotoMarker {

	/**
	 * @generated
	 */
	public static final String ID = "de.ipd.uka.sdq.pcm.gmf.seff.part.SeffDiagramEditorID"; //$NON-NLS-1$
	...
	protected String getEditingDomainID() {
		return "de.uka.ipd.sdq.pcm.gmf.seff.EditingDomain"; //$NON-NLS-1$
	}

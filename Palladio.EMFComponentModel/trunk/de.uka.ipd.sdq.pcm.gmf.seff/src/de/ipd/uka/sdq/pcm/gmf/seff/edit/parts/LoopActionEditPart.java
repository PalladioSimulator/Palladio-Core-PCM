...
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.LoopActionCanonicalEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.LoopActionGraphicalNodeEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.LoopActionItemSemanticEditPolicy;
...
public class LoopActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LoopActionItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new LoopActionGraphicalNodeEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new LoopActionCanonicalEditPolicy());

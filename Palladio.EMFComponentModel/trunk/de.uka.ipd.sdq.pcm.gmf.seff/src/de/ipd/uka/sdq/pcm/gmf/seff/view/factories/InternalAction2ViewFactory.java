 ...
 * @generated
 */
public class InternalAction2ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.ipd.uka.sdq.pcm.gmf.seff.edit.parts.InternalAction2EditPart.VISUAL_ID);

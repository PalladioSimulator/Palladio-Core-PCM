...
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.BranchActionCanonicalEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.BranchActionGraphicalNodeEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.BranchActionItemSemanticEditPolicy;
...
public class BranchActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new BranchActionGraphicalNodeEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new BranchActionCanonicalEditPolicy());

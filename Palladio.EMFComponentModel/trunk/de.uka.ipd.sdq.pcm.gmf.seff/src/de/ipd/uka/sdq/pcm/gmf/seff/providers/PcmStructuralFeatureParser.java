 ...
 * @generated
 */
public class PcmStructuralFeatureParser extends PcmAbstractParser {
	 ...
	 * @generated
	 */
	public PcmStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(PcmDiagramEditorPlugin.ID,

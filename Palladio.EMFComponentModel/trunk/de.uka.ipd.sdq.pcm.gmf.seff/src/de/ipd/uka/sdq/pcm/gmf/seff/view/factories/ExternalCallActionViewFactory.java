 ...
 * @generated
 */
public class ExternalCallActionViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.ipd.uka.sdq.pcm.gmf.seff.edit.parts.ExternalCallActionEditPart.VISUAL_ID);

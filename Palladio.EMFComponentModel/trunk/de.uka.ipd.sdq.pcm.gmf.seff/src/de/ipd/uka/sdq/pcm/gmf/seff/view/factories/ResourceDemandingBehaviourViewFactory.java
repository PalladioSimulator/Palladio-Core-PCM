 ...
 * @generated
 */
public class ResourceDemandingBehaviourViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.ipd.uka.sdq.pcm.gmf.seff.edit.parts.ResourceDemandingBehaviourEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						PcmVisualIDRegistry
								.getType(ResourceDemandingBehaviourLoopCompartmentEditPart.VISUAL_ID),

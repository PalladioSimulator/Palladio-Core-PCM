...
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.ExternalCallActionCanonicalEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.ExternalCallActionGraphicalNodeEditPolicy;
import de.ipd.uka.sdq.pcm.gmf.seff.edit.policies.ExternalCallActionItemSemanticEditPolicy;
...
public class ExternalCallActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new ExternalCallActionGraphicalNodeEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ExternalCallActionCanonicalEditPolicy());

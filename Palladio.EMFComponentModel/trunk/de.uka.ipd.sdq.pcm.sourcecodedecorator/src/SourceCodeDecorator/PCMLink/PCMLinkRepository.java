 ...
 *   <li>{@link SourceCodeDecorator.PCMLink.PCMLinkRepository#getLoggingPositionIds <em>Logging Position Ids</em>}</li>
 * </ul>
 * </p>
 *
...
public interface PCMLinkRepository extends Identifier {
	 ...
	 * The list contents are of type {@link SourceCodeDecorator.loggerLink.LoggingPositionId}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see SourceCodeDecorator.PCMLink.PCMLinkPackage#getPCMLinkRepository_LoggingPositionIds()
	 * @model containment="true" ordered="false"
	 * @generated
	 */

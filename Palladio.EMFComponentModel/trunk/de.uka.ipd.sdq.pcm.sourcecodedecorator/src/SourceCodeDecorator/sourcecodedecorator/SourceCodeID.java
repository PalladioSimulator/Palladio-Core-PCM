 ...
 * <ul>
 *   <li>{@link SourceCodeDecorator.sourcecodedecorator.SourceCodeID#getSourceCodeID <em>Source Code ID</em>}</li>
 * </ul>
 * </p>
 *
 * @see SourceCodeDecorator.sourcecodedecorator.SourcecodedecoratorPackage#getSourceCodeID()
 * @model abstract="true"
 * @generated
 */
public interface SourceCodeID extends Identifier {
	 ...
	 * @see SourceCodeDecorator.sourcecodedecorator.SourcecodedecoratorPackage#getSourceCodeID_SourceCodeID()
	...
	/**
	 * Sets the value of the '{@link SourceCodeDecorator.sourcecodedecorator.SourceCodeID#getSourceCodeID <em>Source Code ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

...
public class ResultDecoratorRepositoryItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ResultdecoratorPackage.Literals.RESULT_DECORATOR_REPOSITORY__INTERFACEPROVIDINGREQUIRINGENTITYRESULTS);
			childrenFeatures.add(ResultdecoratorPackage.Literals.RESULT_DECORATOR_REPOSITORY__UTILISATIONRESULT);
		}
	...
	public String getText(Object object) {
		return getString("_UI_ResultDecoratorRepository_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ResultdecoratorPackage.Literals.RESULT_DECORATOR_REPOSITORY__INTERFACEPROVIDINGREQUIRINGENTITYRESULTS,
				 repositorydecoratorFactory.eINSTANCE.createInterfaceProvidingRequiringEntityResults()));

		newChildDescriptors.add
			(createChildParameter
				(ResultdecoratorPackage.Literals.RESULT_DECORATOR_REPOSITORY__UTILISATIONRESULT,

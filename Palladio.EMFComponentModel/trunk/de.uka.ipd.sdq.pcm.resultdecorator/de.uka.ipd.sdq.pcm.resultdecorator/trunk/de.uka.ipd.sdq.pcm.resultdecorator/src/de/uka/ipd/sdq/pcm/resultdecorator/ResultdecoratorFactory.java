...
public interface ResultdecoratorFactory extends EFactory {
	 ...
	 * @generated
	 */
	ResultdecoratorFactory eINSTANCE = de.uka.ipd.sdq.pcm.resultdecorator.impl.ResultdecoratorFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Result Decorator Repository</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

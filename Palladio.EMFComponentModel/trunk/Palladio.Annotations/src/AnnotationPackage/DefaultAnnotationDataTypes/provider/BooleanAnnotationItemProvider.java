...
/**
 * This is the item provider adapter for a {@link AnnotationPackage.DefaultAnnotationDataTypes.BooleanAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanAnnotationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanAnnotation_dataField_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanAnnotation_dataField_feature", "_UI_BooleanAnnotation_type"),
				 DefaultAnnotationDataTypesPackage.Literals.BOOLEAN_ANNOTATION__DATA_FIELD,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		AnnotationType labelValue = ((BooleanAnnotation)object).getAnnotationTypeID();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_BooleanAnnotation_type") :
			getString("_UI_BooleanAnnotation_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link AnnotationPackage.DefaultAnnotationDataTypes.StringAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringAnnotationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringAnnotation_dataField_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringAnnotation_dataField_feature", "_UI_StringAnnotation_type"),
				 DefaultAnnotationDataTypesPackage.Literals.STRING_ANNOTATION__DATA_FIELD,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		AnnotationType labelValue = ((StringAnnotation)object).getAnnotationTypeID();

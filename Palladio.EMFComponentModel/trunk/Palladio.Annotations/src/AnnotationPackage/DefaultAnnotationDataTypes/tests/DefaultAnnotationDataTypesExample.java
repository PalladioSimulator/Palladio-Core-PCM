...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>DefaultAnnotationDataTypes</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DefaultAnnotationDataTypesExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(DefaultAnnotationDataTypesPackage.eNS_URI, 
			 DefaultAnnotationDataTypesPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.defaultannotationdatatypes"));
				BooleanAnnotation root = DefaultAnnotationDataTypesFactory.eINSTANCE.createBooleanAnnotation();
...
} //DefaultAnnotationDataTypesExample

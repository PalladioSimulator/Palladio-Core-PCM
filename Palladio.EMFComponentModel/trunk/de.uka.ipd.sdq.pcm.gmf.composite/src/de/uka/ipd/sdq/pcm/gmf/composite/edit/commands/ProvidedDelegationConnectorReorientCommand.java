...
public class ProvidedDelegationConnectorReorientCommand extends
	...
	public boolean canExecute() {
		if (!(getElementToEdit() instanceof ProvidedDelegationConnector)) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistProvidedDelegationConnector_4003(container,
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		ComposedStructure container = (ComposedStructure) getLink()
				.eContainer();
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistProvidedDelegationConnector_4003(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ProvidedRole getOldSource() {
	 ...
	 * @generated
	 */
	protected ProvidedRole getNewSource() {

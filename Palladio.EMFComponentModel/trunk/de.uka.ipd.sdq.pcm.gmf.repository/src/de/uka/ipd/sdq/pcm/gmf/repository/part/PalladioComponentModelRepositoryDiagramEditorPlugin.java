...
public class PalladioComponentModelRepositoryDiagramEditorPlugin extends
	...
	protected void fillItemProviderFactories(List factories) {
		...
		factories
				.add(new de.uka.ipd.sdq.pcm.reliability.provider.ReliabilityItemProviderAdapterFactory());
		...
		factories
				.add(new de.uka.ipd.sdq.pcm.seff.reliability.provider.ReliabilityItemProviderAdapterFactory());

 ...
 * @generated
 */
public class ProvidesStereotypeLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(PcmVisualIDRegistry
				.getType(ProvidesStereotypeLabelEditPart.VISUAL_ID), new Point(
				0, 40));
	}
	 ...
	 * @generated
	 */
	public ProvidesStereotypeLabelEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.ProvidedRole_3001;
					}
	 ...
	 * @generated
	 */
	public class ProvidesStereotypeLabelFigure extends

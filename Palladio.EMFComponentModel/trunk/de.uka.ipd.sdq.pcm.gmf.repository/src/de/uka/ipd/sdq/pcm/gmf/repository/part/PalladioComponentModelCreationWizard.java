...
public class PalladioComponentModelCreationWizard extends Wizard implements
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle("New PCM Repository Model Diagram");
		setDefaultPageImageDescriptor(PalladioComponentModelRepositoryDiagramEditorPlugin
	...
	public void addPages() {
		diagramModelFilePage = new PalladioComponentModelCreationWizardPage(
				"DiagramModelFile", getSelection(), "repository_diagram"); //$NON-NLS-1$ //$NON-NLS-2$
		diagramModelFilePage.setTitle("Create PCM Repository Model Diagram");
		...
		domainModelFilePage.setTitle("Create PCM Repository Model Diagram");
		domainModelFilePage

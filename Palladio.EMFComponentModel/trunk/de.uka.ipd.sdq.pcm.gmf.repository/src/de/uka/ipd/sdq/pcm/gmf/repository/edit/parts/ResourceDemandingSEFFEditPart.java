 ...
 * @generated
 */
public class ResourceDemandingSEFFEditPart extends CompartmentEditPart
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.ResourceDemandingSEFF_2002;
					}
	...
	protected IFigure createFigurePrim() {
		return new SEFFLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SEFFLabelFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public SEFFLabelFigure() {

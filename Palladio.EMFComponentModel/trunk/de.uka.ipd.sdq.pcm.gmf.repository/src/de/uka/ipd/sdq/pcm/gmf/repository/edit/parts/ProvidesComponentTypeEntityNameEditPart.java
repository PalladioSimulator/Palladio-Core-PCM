 ...
 * @generated
 */
public class ProvidesComponentTypeEntityNameEditPart extends
	 ...
	 * @generated
	 */
	public ProvidesComponentTypeEntityNameEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.ProvidesComponentType_1004;
					}

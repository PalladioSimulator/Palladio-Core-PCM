 ...
 * @generated
 */
public class ProvidedRoleReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ProvidedRoleReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientTarget() {
		...
		InterfaceProvidingEntity source = (InterfaceProvidingEntity) getLink()
				.eContainer();
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistProvidedRole_4101(source, getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getProvidedRoles_InterfaceProvidingEntity().remove(
				getLink());
		getNewSource().getProvidedRoles_InterfaceProvidingEntity().add(
				getLink());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getLink().setProvidedInterface__ProvidedRole(getNewTarget());
		return CommandResult.newOKCommandResult(getLink());
	}
	 ...
	 * @generated
	 */
	protected ProvidedRole getLink() {
		return (ProvidedRole) getElementToEdit();
	}

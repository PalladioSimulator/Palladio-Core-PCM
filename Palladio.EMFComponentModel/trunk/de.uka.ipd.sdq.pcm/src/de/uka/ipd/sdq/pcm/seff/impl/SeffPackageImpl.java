...
public class SeffPackageImpl extends EPackageImpl implements SeffPackage {
	...
	public void initializePackageContents() {
		...
		de.uka.ipd.sdq.pcm.seff.reliability.ReliabilityPackage theReliabilityPackage_2 = (de.uka.ipd.sdq.pcm.seff.reliability.ReliabilityPackage)EPackage.Registry.INSTANCE.getEPackage(de.uka.ipd.sdq.pcm.seff.reliability.ReliabilityPackage.eNS_URI);
		...
		getESubpackages().add(theReliabilityPackage_2);
		...
		externalCallActionEClass.getESuperTypes().add(theReliabilityPackage_2.getFailureHandlingEntity());
		...
		initEReference(getAbstractInternalControlFlowAction_ResourceDemand_Action(), thePerformancePackage_1.getParametricResourceDemand(), thePerformancePackage_1.getParametricResourceDemand_Action_ParametricResourceDemand(), "resourceDemand_Action", null, 0, -1, AbstractInternalControlFlowAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

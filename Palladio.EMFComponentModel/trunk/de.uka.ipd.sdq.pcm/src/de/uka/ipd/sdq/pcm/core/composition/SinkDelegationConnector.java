 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.core.composition.SinkDelegationConnector#getInnerSinkRole__SinkRole <em>Inner Sink Role Sink Role</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.core.composition.SinkDelegationConnector#getOuterSinkRole__SinkRole <em>Outer Sink Role Sink Role</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.core.composition.SinkDelegationConnector#getParentStructure__SinkDelegationConnector <em>Parent Structure Sink Delegation Connector</em>}</li>
 * </ul>
 * </p>
 *
...
public interface SinkDelegationConnector extends DelegationConnector {
	 ...
	 * @see #setParentStructure__SinkDelegationConnector(ComposedStructure)
	 * @see de.uka.ipd.sdq.pcm.core.composition.CompositionPackage#getSinkDelegationConnector_ParentStructure__SinkDelegationConnector()
	 ...
	 * @generated
	 */
	ComposedStructure getParentStructure__SinkDelegationConnector();

	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.composition.SinkDelegationConnector#getParentStructure__SinkDelegationConnector <em>Parent Structure Sink Delegation Connector</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Parent Structure Sink Delegation Connector</em>' container reference.
	 * @see #getParentStructure__SinkDelegationConnector()
	 * @generated
	 */
	void setParentStructure__SinkDelegationConnector(ComposedStructure value);

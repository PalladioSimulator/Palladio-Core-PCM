...
public interface InterfaceProvidingEntity extends Entity {
	...
	/**
	 * Returns the value of the '<em><b>Provided Roles Interface Providing Entity</b></em>' reference list.
	 ...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Provided Roles Interface Providing Entity</em>' reference list.
	 ...
	 * @model type="de.uka.ipd.sdq.pcm.repository.ProvidedRole" opposite="providingEntity_ProvidedRole" ordered="false"
	 * @generated
	 */

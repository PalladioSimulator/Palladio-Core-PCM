...
public class ReliabilityPackageImpl extends EPackageImpl implements ReliabilityPackage {
	...
	public static ReliabilityPackage init() {
		...
		ReliabilityPackageImpl theReliabilityPackage = (ReliabilityPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ReliabilityPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ReliabilityPackageImpl());
	 ...
	 * @generated
	 */
	public EAttribute getSpecifiedFailureProbability_FailureProbability() {
		return (EAttribute)specifiedFailureProbabilityEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(specifiedFailureProbabilityEClass, SPECIFIED_FAILURE_PROBABILITY__FAILURE_PROBABILITY);
	}
	...
	public void initializePackageContents() {
		...
		specifiedFailureProbabilityEClass.getESuperTypes().add(theQosannotationsPackage.getSpecifiedQoSAnnotation());

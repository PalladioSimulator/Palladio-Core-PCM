 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.allocation.AllocationContext#getReferencedAssemblyContext_AllocationContext <em>Referenced Assembly Context Allocation Context</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.allocation.AllocationContext#getResourceContainer_AllocationContext <em>Resource Container Allocation Context</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.ipd.uka.sdq.pcm.allocation.AllocationPackage#getAllocationContext()
 * @model
 * @generated
 */
public interface AllocationContext extends EObject {
	 ...
	 * @see de.ipd.uka.sdq.pcm.allocation.AllocationPackage#getAllocationContext_ReferencedAssemblyContext_AllocationContext()
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.allocation.AllocationContext#getReferencedAssemblyContext_AllocationContext <em>Referenced Assembly Context Allocation Context</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ipd.uka.sdq.pcm.allocation.AllocationPackage#getAllocationContext_ResourceContainer_AllocationContext()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.allocation.AllocationContext#getResourceContainer_AllocationContext <em>Resource Container Allocation Context</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

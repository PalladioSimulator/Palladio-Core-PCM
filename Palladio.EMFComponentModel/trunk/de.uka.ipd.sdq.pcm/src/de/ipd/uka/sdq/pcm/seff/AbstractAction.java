 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.seff.AbstractAction#getPredecessor_AbstractAction <em>Predecessor Abstract Action</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.seff.AbstractAction#getSuccessor_AbstractAction <em>Successor Abstract Action</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getAbstractAction()
 * @model abstract="true"
 * @generated
 */
public interface AbstractAction extends Entity {
	 ...
	 * It is bidirectional and its opposite is '{@link de.ipd.uka.sdq.pcm.seff.AbstractAction#getSuccessor_AbstractAction <em>Successor Abstract Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getAbstractAction_Predecessor_AbstractAction()
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.seff.AbstractAction#getPredecessor_AbstractAction <em>Predecessor Abstract Action</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.ipd.uka.sdq.pcm.seff.AbstractAction#getPredecessor_AbstractAction <em>Predecessor Abstract Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getAbstractAction_Successor_AbstractAction()
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.seff.AbstractAction#getSuccessor_AbstractAction <em>Successor Abstract Action</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

 ...
 * $Id$
 */
package de.ipd.uka.sdq.pcm.resourceenvironment.impl;

import de.ipd.uka.sdq.pcm.resourceenvironment.CommunicationLinkResourceSpecification;
import de.ipd.uka.sdq.pcm.resourceenvironment.LinkingResource;
import de.ipd.uka.sdq.pcm.resourceenvironment.ResourceContainer;
 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.resourceenvironment.impl.LinkingResourceImpl#getToResourceContainer_LinkingResource <em>To Resource Container Linking Resource</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.resourceenvironment.impl.LinkingResourceImpl#getFromResourceContainer_LinkingResource <em>From Resource Container Linking Resource</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.resourceenvironment.impl.LinkingResourceImpl#getCommunicationLinkResourceSpecifications_LinkingResource <em>Communication Link Resource Specifications Linking Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkingResourceImpl extends EObjectImpl implements LinkingResource {
	 ...
	 * @ordered
	 */
	protected EList toResourceContainer_LinkingResource = null;
	 ...
	 * @ordered
	 */
	protected EList fromResourceContainer_LinkingResource = null;
	 ...
	 * @generated
	 */
	public EList getToResourceContainer_LinkingResource() {
		if (toResourceContainer_LinkingResource == null) {
			toResourceContainer_LinkingResource = new EObjectResolvingEList(ResourceContainer.class, this, ResourceenvironmentPackage.LINKING_RESOURCE__TO_RESOURCE_CONTAINER_LINKING_RESOURCE);
		}
	 ...
	 * @generated
	 */
	public EList getFromResourceContainer_LinkingResource() {
		if (fromResourceContainer_LinkingResource == null) {
			fromResourceContainer_LinkingResource = new EObjectResolvingEList(ResourceContainer.class, this, ResourceenvironmentPackage.LINKING_RESOURCE__FROM_RESOURCE_CONTAINER_LINKING_RESOURCE);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ResourceenvironmentPackage.LINKING_RESOURCE__TO_RESOURCE_CONTAINER_LINKING_RESOURCE:
				...
				getToResourceContainer_LinkingResource().addAll((Collection)newValue);
				return;
			case ResourceenvironmentPackage.LINKING_RESOURCE__FROM_RESOURCE_CONTAINER_LINKING_RESOURCE:
				getFromResourceContainer_LinkingResource().clear();
				getFromResourceContainer_LinkingResource().addAll((Collection)newValue);
				return;
			case ResourceenvironmentPackage.LINKING_RESOURCE__COMMUNICATION_LINK_RESOURCE_SPECIFICATIONS_LINKING_RESOURCE:

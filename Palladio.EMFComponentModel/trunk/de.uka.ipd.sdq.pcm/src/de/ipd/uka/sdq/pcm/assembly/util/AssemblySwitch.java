...
public class AssemblySwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AssemblyPackage.SYSTEM_ASSEMBLY_CONNECTOR: {
				SystemAssemblyConnector systemAssemblyConnector = (SystemAssemblyConnector)theEObject;
				Object result = caseSystemAssemblyConnector(systemAssemblyConnector);
				if (result == null) result = caseConnector(systemAssemblyConnector);
				if (result == null) result = caseEntity(systemAssemblyConnector);
				if (result == null) result = caseIdentifier(systemAssemblyConnector);
			...
			case AssemblyPackage.ASSEMBLY: {
				...
				Object result = caseAssembly(assembly);
				if (result == null) result = caseEntity(assembly);
				if (result == null) result = caseIdentifier(assembly);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>System Assembly Connector</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>System Assembly Connector</em>'.
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Assembly</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Assembly</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */

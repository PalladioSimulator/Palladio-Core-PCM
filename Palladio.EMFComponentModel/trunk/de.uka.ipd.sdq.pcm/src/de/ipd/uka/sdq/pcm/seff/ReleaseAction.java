 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.seff.ReleaseAction#getResourceType_Release <em>Resource Type Release</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getReleaseAction()
 * @model
 * @generated
 */
public interface ReleaseAction extends AbstractResourceDemandingAction {
	 ...
	 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getReleaseAction_ResourceType_Release()
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.seff.ReleaseAction#getResourceType_Release <em>Resource Type Release</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

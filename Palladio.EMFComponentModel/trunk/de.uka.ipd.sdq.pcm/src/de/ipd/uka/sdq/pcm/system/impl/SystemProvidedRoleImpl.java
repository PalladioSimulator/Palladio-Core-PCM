 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.system.impl.SystemProvidedRoleImpl#getSystem_SystemProvidedRole <em>System System Provided Role</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.system.impl.SystemProvidedRoleImpl#getProvidedDelegationConnector_SystemProvidedRole <em>Provided Delegation Connector System Provided Role</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.system.impl.SystemProvidedRoleImpl#getInterface_SystemProvidedRole <em>Interface System Provided Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemProvidedRoleImpl extends EntityImpl implements SystemProvidedRole {
	 ...
	 * @generated
	 */
	public de.ipd.uka.sdq.pcm.system.System getSystem_SystemProvidedRole() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSystem_SystemProvidedRole(de.ipd.uka.sdq.pcm.system.System newSystem_SystemProvidedRole, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setSystem_SystemProvidedRole(de.ipd.uka.sdq.pcm.system.System newSystem_SystemProvidedRole) {
		if (newSystem_SystemProvidedRole != eInternalContainer() || (eContainerFeatureID != SystemPackage.SYSTEM_PROVIDED_ROLE__SYSTEM_SYSTEM_PROVIDED_ROLE && newSystem_SystemProvidedRole != null)) {
			...
			if (newSystem_SystemProvidedRole != null)
				msgs = ((InternalEObject)newSystem_SystemProvidedRole).eInverseAdd(this, SystemPackage.SYSTEM__SYSTEM_PROVIDED_ROLE_SYSTEM, de.ipd.uka.sdq.pcm.system.System.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SystemPackage.SYSTEM_PROVIDED_ROLE__SYSTEM_SYSTEM_PROVIDED_ROLE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetSystem_SystemProvidedRole((de.ipd.uka.sdq.pcm.system.System)otherEnd, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case SystemPackage.SYSTEM_PROVIDED_ROLE__SYSTEM_SYSTEM_PROVIDED_ROLE:
				return eInternalContainer().eInverseRemove(this, SystemPackage.SYSTEM__SYSTEM_PROVIDED_ROLE_SYSTEM, de.ipd.uka.sdq.pcm.system.System.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SystemPackage.SYSTEM_PROVIDED_ROLE__SYSTEM_SYSTEM_PROVIDED_ROLE:
				setSystem_SystemProvidedRole((de.ipd.uka.sdq.pcm.system.System)newValue);
				return;
			case SystemPackage.SYSTEM_PROVIDED_ROLE__PROVIDED_DELEGATION_CONNECTOR_SYSTEM_PROVIDED_ROLE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case SystemPackage.SYSTEM_PROVIDED_ROLE__SYSTEM_SYSTEM_PROVIDED_ROLE:
				setSystem_SystemProvidedRole((de.ipd.uka.sdq.pcm.system.System)null);
				return;
			case SystemPackage.SYSTEM_PROVIDED_ROLE__PROVIDED_DELEGATION_CONNECTOR_SYSTEM_PROVIDED_ROLE:

...
public class ProtocolSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProtocolPackage.SERVICE_CALL: {
				...
				Object result = caseServiceCall(serviceCall);
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Service Call</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Service Call</em>'.

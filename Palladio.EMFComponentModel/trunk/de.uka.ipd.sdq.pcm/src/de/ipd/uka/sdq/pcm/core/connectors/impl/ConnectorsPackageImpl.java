 ...
 * $Id$
 */
package de.ipd.uka.sdq.pcm.core.connectors.impl;
...
import de.ipd.uka.sdq.pcm.core.connectors.ConnectorsFactory;
...
public class ConnectorsPackageImpl extends EPackageImpl implements ConnectorsPackage {
	 ...
	 * @see de.ipd.uka.sdq.pcm.core.connectors.ConnectorsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ConnectorsPackage init() {
		...
		ConnectorsPackageImpl theConnectorsPackage = (ConnectorsPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ConnectorsPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ConnectorsPackageImpl());

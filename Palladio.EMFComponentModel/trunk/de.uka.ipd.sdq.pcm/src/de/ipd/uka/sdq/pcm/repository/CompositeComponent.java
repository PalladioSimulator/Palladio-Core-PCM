 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.CompositeComponent#getProvidedDelegationConnectors__CompositeComponent <em>Provided Delegation Connectors Composite Component</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.CompositeComponent#getRequiredDelegationConnectors__CompositeComponent <em>Required Delegation Connectors Composite Component</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.CompositeComponent#getImplementationComponentType <em>Implementation Component Type</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.CompositeComponent#getChildComponentContexts_CompositeComponent <em>Child Component Contexts Composite Component</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.CompositeComponent#getCompositeAssemblyConnectors_CompositeComponent <em>Composite Assembly Connectors Composite Component</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getCompositeComponent()
 * @model
 * @generated
 */
public interface CompositeComponent extends ImplementationComponentType {
	 ...
	 * The list contents are of type {@link de.ipd.uka.sdq.pcm.repository.ProvidedDelegationConnector}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getCompositeComponent_ProvidedDelegationConnectors__CompositeComponent()
	 * @model type="de.ipd.uka.sdq.pcm.repository.ProvidedDelegationConnector" containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link de.ipd.uka.sdq.pcm.repository.RequiredDelegationConnector}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getCompositeComponent_RequiredDelegationConnectors__CompositeComponent()
	 * @model type="de.ipd.uka.sdq.pcm.repository.RequiredDelegationConnector" containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getCompositeComponent_ImplementationComponentType()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.repository.CompositeComponent#getImplementationComponentType <em>Implementation Component Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.ipd.uka.sdq.pcm.repository.ChildComponentContext}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getCompositeComponent_ChildComponentContexts_CompositeComponent()
	 * @model type="de.ipd.uka.sdq.pcm.repository.ChildComponentContext" containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link de.ipd.uka.sdq.pcm.repository.CompositeAssemblyConnector}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getCompositeComponent_CompositeAssemblyConnectors_CompositeComponent()
	 * @model type="de.ipd.uka.sdq.pcm.repository.CompositeAssemblyConnector" containment="true" ordered="false"
	 * @generated
	 */

 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.RequiredDelegationConnector#getInnerRequiredRole_RequiredDelegationConnector <em>Inner Required Role Required Delegation Connector</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.RequiredDelegationConnector#getOuterRequiredRole_RequiredDelegationConnector <em>Outer Required Role Required Delegation Connector</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.RequiredDelegationConnector#getChildComponentContext_RequiredDelegationConnector <em>Child Component Context Required Delegation Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getRequiredDelegationConnector()
 * @model
 * @generated
 */
public interface RequiredDelegationConnector extends DelegationConnector {
	 ...
	 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getRequiredDelegationConnector_InnerRequiredRole_RequiredDelegationConnector()
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.repository.RequiredDelegationConnector#getInnerRequiredRole_RequiredDelegationConnector <em>Inner Required Role Required Delegation Connector</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getRequiredDelegationConnector_OuterRequiredRole_RequiredDelegationConnector()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.repository.RequiredDelegationConnector#getOuterRequiredRole_RequiredDelegationConnector <em>Outer Required Role Required Delegation Connector</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ipd.uka.sdq.pcm.repository.RepositoryPackage#getRequiredDelegationConnector_ChildComponentContext_RequiredDelegationConnector()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.repository.RequiredDelegationConnector#getChildComponentContext_RequiredDelegationConnector <em>Child Component Context Required Delegation Connector</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

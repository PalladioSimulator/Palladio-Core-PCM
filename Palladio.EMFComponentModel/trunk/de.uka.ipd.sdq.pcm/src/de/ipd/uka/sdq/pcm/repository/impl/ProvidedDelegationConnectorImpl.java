...
import de.ipd.uka.sdq.pcm.repository.ProvidedDelegationConnector;
import de.ipd.uka.sdq.pcm.repository.ProvidedRole;
import de.ipd.uka.sdq.pcm.repository.RepositoryPackage;

import de.ipd.uka.sdq.pcm.repository.util.RepositoryValidator;
 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.impl.ProvidedDelegationConnectorImpl#getInnerProvidedRole_ProvidedDelegationConnector <em>Inner Provided Role Provided Delegation Connector</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.impl.ProvidedDelegationConnectorImpl#getOuterProvidedRole_ProvidedDelegationConnector <em>Outer Provided Role Provided Delegation Connector</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.repository.impl.ProvidedDelegationConnectorImpl#getChildComponentContext_ProvidedDelegationConnector <em>Child Component Context Provided Delegation Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProvidedDelegationConnectorImpl extends DelegationConnectorImpl implements ProvidedDelegationConnector {
	 ...
	 * @ordered
	 */
	protected ChildComponentContext childComponentContext_ProvidedDelegationConnector = null;
	...
	protected EClass eStaticClass() {
		return RepositoryPackage.Literals.PROVIDED_DELEGATION_CONNECTOR;
	}
		...
		if (innerProvidedRole_ProvidedDelegationConnector != null && innerProvidedRole_ProvidedDelegationConnector.eIsProxy()) {
			...
			if (innerProvidedRole_ProvidedDelegationConnector != oldInnerProvidedRole_ProvidedDelegationConnector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__INNER_PROVIDED_ROLE_PROVIDED_DELEGATION_CONNECTOR, oldInnerProvidedRole_ProvidedDelegationConnector, innerProvidedRole_ProvidedDelegationConnector));
			}
		}
	...
	public void setInnerProvidedRole_ProvidedDelegationConnector(ProvidedRole newInnerProvidedRole_ProvidedDelegationConnector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__INNER_PROVIDED_ROLE_PROVIDED_DELEGATION_CONNECTOR, oldInnerProvidedRole_ProvidedDelegationConnector, innerProvidedRole_ProvidedDelegationConnector));
	}
	...
	public ProvidedRole getOuterProvidedRole_ProvidedDelegationConnector() {
		if (outerProvidedRole_ProvidedDelegationConnector != null && outerProvidedRole_ProvidedDelegationConnector.eIsProxy()) {
			...
			if (outerProvidedRole_ProvidedDelegationConnector != oldOuterProvidedRole_ProvidedDelegationConnector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__OUTER_PROVIDED_ROLE_PROVIDED_DELEGATION_CONNECTOR, oldOuterProvidedRole_ProvidedDelegationConnector, outerProvidedRole_ProvidedDelegationConnector));
			}
		}
	...
	public void setOuterProvidedRole_ProvidedDelegationConnector(ProvidedRole newOuterProvidedRole_ProvidedDelegationConnector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__OUTER_PROVIDED_ROLE_PROVIDED_DELEGATION_CONNECTOR, oldOuterProvidedRole_ProvidedDelegationConnector, outerProvidedRole_ProvidedDelegationConnector));
	}
	 ...
	 * @generated
	 */
	public ChildComponentContext getChildComponentContext_ProvidedDelegationConnector() {
		if (childComponentContext_ProvidedDelegationConnector != null && childComponentContext_ProvidedDelegationConnector.eIsProxy()) {
			...
			childComponentContext_ProvidedDelegationConnector = (ChildComponentContext)eResolveProxy(oldChildComponentContext_ProvidedDelegationConnector);
			if (childComponentContext_ProvidedDelegationConnector != oldChildComponentContext_ProvidedDelegationConnector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__CHILD_COMPONENT_CONTEXT_PROVIDED_DELEGATION_CONNECTOR, oldChildComponentContext_ProvidedDelegationConnector, childComponentContext_ProvidedDelegationConnector));
			}
		}
	 ...
	 * @generated
	 */
	public ChildComponentContext basicGetChildComponentContext_ProvidedDelegationConnector() {
		return childComponentContext_ProvidedDelegationConnector;
	}
	 ...
	 * @generated
	 */
	public void setChildComponentContext_ProvidedDelegationConnector(ChildComponentContext newChildComponentContext_ProvidedDelegationConnector) {
		ChildComponentContext oldChildComponentContext_ProvidedDelegationConnector = childComponentContext_ProvidedDelegationConnector;
		childComponentContext_ProvidedDelegationConnector = newChildComponentContext_ProvidedDelegationConnector;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__CHILD_COMPONENT_CONTEXT_PROVIDED_DELEGATION_CONNECTOR, oldChildComponentContext_ProvidedDelegationConnector, childComponentContext_ProvidedDelegationConnector));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 RepositoryValidator.PROVIDED_DELEGATION_CONNECTOR__INNER_AND_OUTER_ROLE_NEED_TO_HAVE_DIFFERENT_CONTEXT_IDS,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 RepositoryValidator.DIAGNOSTIC_SOURCE,
						 RepositoryValidator.PROVIDED_DELEGATION_CONNECTOR__INNER_CONTAINING_COMPONENT_EQUAL_OUTER_PROVIDING_COMPONENT,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__INNER_PROVIDED_ROLE_PROVIDED_DELEGATION_CONNECTOR:
			...
			case RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__OUTER_PROVIDED_ROLE_PROVIDED_DELEGATION_CONNECTOR:
			...
			case RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__CHILD_COMPONENT_CONTEXT_PROVIDED_DELEGATION_CONNECTOR:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__OUTER_PROVIDED_ROLE_PROVIDED_DELEGATION_CONNECTOR:
				...
				return;
			case RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__CHILD_COMPONENT_CONTEXT_PROVIDED_DELEGATION_CONNECTOR:
				setChildComponentContext_ProvidedDelegationConnector((ChildComponentContext)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__OUTER_PROVIDED_ROLE_PROVIDED_DELEGATION_CONNECTOR:
				...
				return;
			case RepositoryPackage.PROVIDED_DELEGATION_CONNECTOR__CHILD_COMPONENT_CONTEXT_PROVIDED_DELEGATION_CONNECTOR:
				setChildComponentContext_ProvidedDelegationConnector((ChildComponentContext)null);
				return;
		}

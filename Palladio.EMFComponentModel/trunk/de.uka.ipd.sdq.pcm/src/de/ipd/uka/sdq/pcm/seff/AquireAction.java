 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.seff.AquireAction#getResourceType_Aquire <em>Resource Type Aquire</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getAquireAction()
 * @model
 * @generated
 */
public interface AquireAction extends AbstractResourceDemandingAction {
	 ...
	 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getAquireAction_ResourceType_Aquire()
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.seff.AquireAction#getResourceType_Aquire <em>Resource Type Aquire</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

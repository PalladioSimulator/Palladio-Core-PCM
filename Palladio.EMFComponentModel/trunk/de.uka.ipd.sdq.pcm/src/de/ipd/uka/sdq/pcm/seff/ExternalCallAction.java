 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.seff.ExternalCallAction#getCalledService_ExternalService <em>Called Service External Service</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.seff.ExternalCallAction#getParametricParameterUsage_ParametricParameterUsage <em>Parametric Parameter Usage Parametric Parameter Usage</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getExternalCallAction()
 * @model
 * @generated
 */
public interface ExternalCallAction extends AbstractAction {
	 ...
	 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getExternalCallAction_CalledService_ExternalService()
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.pcm.seff.ExternalCallAction#getCalledService_ExternalService <em>Called Service External Service</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ipd.uka.sdq.pcm.seff.SeffPackage#getExternalCallAction_ParametricParameterUsage_ParametricParameterUsage()
	 * @model type="de.ipd.uka.sdq.pcm.seff.ParametricParameterUsage" ordered="false"
	 * @generated
	 */

 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.pcm.system.impl.SystemRequiredRoleImpl#getSystem_SystemRequiredRole <em>System System Required Role</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.system.impl.SystemRequiredRoleImpl#getRequiredDelegationConnector_SystemRequiredRole <em>Required Delegation Connector System Required Role</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.system.impl.SystemRequiredRoleImpl#getInterface_SystemRequiredRole <em>Interface System Required Role</em>}</li>
 *   <li>{@link de.ipd.uka.sdq.pcm.system.impl.SystemRequiredRoleImpl#getSpecifiedTimeConsumption_SystemRequiredRole <em>Specified Time Consumption System Required Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemRequiredRoleImpl extends EntityImpl implements SystemRequiredRole {
	 ...
	 * @generated
	 */
	public de.ipd.uka.sdq.pcm.system.System getSystem_SystemRequiredRole() {
		if (eContainerFeatureID != SystemPackage.SYSTEM_REQUIRED_ROLE__SYSTEM_SYSTEM_REQUIRED_ROLE) return null;
		return (de.ipd.uka.sdq.pcm.system.System)eContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSystem_SystemRequiredRole(de.ipd.uka.sdq.pcm.system.System newSystem_SystemRequiredRole, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setSystem_SystemRequiredRole(de.ipd.uka.sdq.pcm.system.System newSystem_SystemRequiredRole) {
		if (newSystem_SystemRequiredRole != eInternalContainer() || (eContainerFeatureID != SystemPackage.SYSTEM_REQUIRED_ROLE__SYSTEM_SYSTEM_REQUIRED_ROLE && newSystem_SystemRequiredRole != null)) {
			...
			if (newSystem_SystemRequiredRole != null)
				msgs = ((InternalEObject)newSystem_SystemRequiredRole).eInverseAdd(this, SystemPackage.SYSTEM__SYSTEM_REQUIRED_ROLE_SYSTEM, de.ipd.uka.sdq.pcm.system.System.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SystemPackage.SYSTEM_REQUIRED_ROLE__SYSTEM_SYSTEM_REQUIRED_ROLE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetSystem_SystemRequiredRole((de.ipd.uka.sdq.pcm.system.System)otherEnd, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case SystemPackage.SYSTEM_REQUIRED_ROLE__SYSTEM_SYSTEM_REQUIRED_ROLE:
				return eInternalContainer().eInverseRemove(this, SystemPackage.SYSTEM__SYSTEM_REQUIRED_ROLE_SYSTEM, de.ipd.uka.sdq.pcm.system.System.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SystemPackage.SYSTEM_REQUIRED_ROLE__SYSTEM_SYSTEM_REQUIRED_ROLE:
				setSystem_SystemRequiredRole((de.ipd.uka.sdq.pcm.system.System)newValue);
				return;
			case SystemPackage.SYSTEM_REQUIRED_ROLE__REQUIRED_DELEGATION_CONNECTOR_SYSTEM_REQUIRED_ROLE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case SystemPackage.SYSTEM_REQUIRED_ROLE__SYSTEM_SYSTEM_REQUIRED_ROLE:
				setSystem_SystemRequiredRole((de.ipd.uka.sdq.pcm.system.System)null);
				return;
			case SystemPackage.SYSTEM_REQUIRED_ROLE__REQUIRED_DELEGATION_CONNECTOR_SYSTEM_REQUIRED_ROLE:

 ...
 * $Id$
 */
package de.ipd.uka.sdq.pcm.parameter.util;

import de.ipd.uka.sdq.pcm.core.stochastics.RandomVariable;

import de.ipd.uka.sdq.pcm.parameter.*;
...
public class ParameterAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ipd.uka.sdq.pcm.parameter.PrimitiveParameterCharacterisation <em>Primitive Parameter Characterisation</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ipd.uka.sdq.pcm.parameter.ParameterUsage <em>Usage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ipd.uka.sdq.pcm.parameter.CompositeParameterUsage <em>Composite Parameter Usage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ipd.uka.sdq.pcm.parameter.CollectionParameterUsage <em>Collection Parameter Usage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ipd.uka.sdq.pcm.parameter.CollectionParameterCharacterisation <em>Collection Parameter Characterisation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

 ...
 * $Id$
 */
package de.ipd.uka.sdq.pcm.system.impl;
...
public class SystemPackageImpl extends EPackageImpl implements SystemPackage {
	 ...
	 * @see de.ipd.uka.sdq.pcm.system.SystemPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(systemEClass, de.ipd.uka.sdq.pcm.system.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_SystemProvidedRole_System(), this.getSystemProvidedRole(), this.getSystemProvidedRole_System_SystemProvidedRole(), "systemProvidedRole_System", null, 0, -1, de.ipd.uka.sdq.pcm.system.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSystem_Assembly_System(), theAssemblyPackage.getAssembly(), null, "assembly_System", null, 1, 1, de.ipd.uka.sdq.pcm.system.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSystem_ProvidedDelegationConnector_System(), this.getSystemProvidedDelegationConnector(), null, "providedDelegationConnector_System", null, 0, -1, de.ipd.uka.sdq.pcm.system.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSystem_RequiredDelegationConnector_System(), this.getSystemRequiredDelegationConnector(), null, "requiredDelegationConnector_System", null, 0, -1, de.ipd.uka.sdq.pcm.system.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSystem_Allocation_System(), theAllocationPackage.getAllocation(), null, "allocation_System", null, 1, 1, de.ipd.uka.sdq.pcm.system.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSystem_SystemRequiredRole_System(), this.getSystemRequiredRole(), this.getSystemRequiredRole_System_SystemRequiredRole(), "systemRequiredRole_System", null, 0, -1, de.ipd.uka.sdq.pcm.system.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

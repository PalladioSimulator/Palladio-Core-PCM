...
/**
 * This is the item provider adapter for a {@link SourceCodeDecorator.sourcecodedecorator.ControlFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlFlowItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ControlFlow_lineNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ControlFlow_lineNumber_feature", "_UI_ControlFlow_type"),
				 SourcecodedecoratorPackage.Literals.CONTROL_FLOW__LINE_NUMBER,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ControlFlow)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ControlFlow.class)) {
			case SourcecodedecoratorPackage.CONTROL_FLOW__LINE_NUMBER:

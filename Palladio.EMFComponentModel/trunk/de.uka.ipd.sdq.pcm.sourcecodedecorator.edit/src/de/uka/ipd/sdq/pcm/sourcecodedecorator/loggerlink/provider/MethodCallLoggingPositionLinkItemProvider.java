...
public class MethodCallLoggingPositionLinkItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addProvidedFunctionPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Provided Function feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addProvidedFunctionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MethodCallLoggingPositionLink_providedFunction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MethodCallLoggingPositionLink_providedFunction_feature", "_UI_MethodCallLoggingPositionLink_type"),
				 LoggerlinkPackage.Literals.METHOD_CALL_LOGGING_POSITION_LINK__PROVIDED_FUNCTION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LoggerlinkPackage.Literals.METHOD_CALL_LOGGING_POSITION_LINK__PARAMETER_LINKS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MethodCallLoggingPositionLink.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LoggerlinkPackage.Literals.METHOD_CALL_LOGGING_POSITION_LINK__PARAMETER_LINKS,

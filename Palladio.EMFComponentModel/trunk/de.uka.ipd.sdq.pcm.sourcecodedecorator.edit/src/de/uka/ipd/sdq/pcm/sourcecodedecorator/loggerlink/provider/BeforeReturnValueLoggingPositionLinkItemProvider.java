		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BeforeReturnValueLoggingPositionLink_serviceEffectSpecification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BeforeReturnValueLoggingPositionLink_serviceEffectSpecification_feature", "_UI_BeforeReturnValueLoggingPositionLink_type"),
				 LoggerlinkPackage.Literals.BEFORE_RETURN_VALUE_LOGGING_POSITION_LINK__SERVICE_EFFECT_SPECIFICATION,
				 true,
				 false,
				 true,
				 null,

...
import de.uka.ipd.sdq.pcm.gmf.allocation.edit.policies.AllocationContextCanonicalEditPolicy;
import de.uka.ipd.sdq.pcm.gmf.allocation.edit.policies.AllocationContextGraphicalNodeEditPolicy;
...
public class AllocationContextEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AllocationContextItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new AllocationContextGraphicalNodeEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AllocationContextCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AllocationContextEntityNameEditPart) {
			((AllocationContextEntityNameEditPart) childEditPart)

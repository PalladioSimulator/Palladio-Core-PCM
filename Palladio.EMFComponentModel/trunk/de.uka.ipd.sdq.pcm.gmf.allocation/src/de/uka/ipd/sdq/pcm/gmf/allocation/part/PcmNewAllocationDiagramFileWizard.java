...
public class PcmNewAllocationDiagramFileWizard extends PcmNewDiagramFileWizard {
	...
	public PcmNewAllocationDiagramFileWizard(IFile selectedModelFile,
			IWorkbenchPage workbenchPage, IStructuredSelection selection,
			EObject diagramRoot, TransactionalEditingDomain editingDomain) {
		super(selectedModelFile, workbenchPage, selection, diagramRoot, editingDomain);

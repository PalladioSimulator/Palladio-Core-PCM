...
import de.uka.ipd.sdq.pcm.gmf.allocation.edit.parts.PcmEditPartFactory;
 ...
 * @generated
 */
public class PcmDiagramEditor extends FileDiagramEditor implements IGotoMarker {

	/**
	 * @generated
	 */
	public static final String ID = "de.uka.ipd.sdq.pcm.gmf.allocation.part.PcmDiagramEditorID"; //$NON-NLS-1$

	/**
	 * @generated
	 */
	public PcmDiagramEditor() {
		super(true);
	}
	...
	protected String getEditingDomainID() {
		return "de.uka.ipd.sdq.pcm.gmf.allocation.EditingDomain"; //$NON-NLS-1$
	}

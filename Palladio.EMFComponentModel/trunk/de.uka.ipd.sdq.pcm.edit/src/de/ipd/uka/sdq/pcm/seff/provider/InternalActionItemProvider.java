...
/**
 * This is the item provider adapter for a {@link de.ipd.uka.sdq.pcm.seff.InternalAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InternalAction_failureProbability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InternalAction_failureProbability_feature", "_UI_InternalAction_type"),
				 SeffPackage.Literals.INTERNAL_ACTION__FAILURE_PROBABILITY,
				 true,
				 false,
				 false,

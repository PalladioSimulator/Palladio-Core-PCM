 ...
 * @generated
 */
public class SystemProvidedRoleLabelEditPart extends PcmExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(PcmVisualIDRegistry
				.getType(SystemProvidedRoleLabelEditPart.VISUAL_ID), new Point(
				0, 0));
	}
	 ...
	 * @generated
	 */
	public SystemProvidedRoleLabelEditPart(View view) {
		super(view);
	}

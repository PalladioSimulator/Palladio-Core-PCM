 ...
 * @generated
 */
public class RoleLabel2EditPart extends PcmExtNodeLabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(PcmVisualIDRegistry
				.getType(RoleLabel2EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public RoleLabel2EditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.Node_2002;
					}

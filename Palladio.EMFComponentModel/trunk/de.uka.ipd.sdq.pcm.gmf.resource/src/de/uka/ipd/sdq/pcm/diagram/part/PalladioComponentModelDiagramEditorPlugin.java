...
public class PalladioComponentModelDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "de.uka.ipd.sdq.pcm.diagram"; //$NON-NLS-1$
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, PalladioComponentModelDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, PalladioComponentModelDiagramEditorPlugin.ID,

...
import de.uka.ipd.sdq.pcm.diagram.part.PalladioComponentModelDiagramUpdater;
import de.uka.ipd.sdq.pcm.diagram.part.PalladioComponentModelLinkDescriptor;
import de.uka.ipd.sdq.pcm.diagram.part.PalladioComponentModelNodeDescriptor;
 ...
 * @generated
 */
public class ResourceEnvironmentCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = PalladioComponentModelDiagramUpdater
				.getResourceEnvironment_1000SemanticChildren(viewObject).iterator(); it
				.hasNext();) {

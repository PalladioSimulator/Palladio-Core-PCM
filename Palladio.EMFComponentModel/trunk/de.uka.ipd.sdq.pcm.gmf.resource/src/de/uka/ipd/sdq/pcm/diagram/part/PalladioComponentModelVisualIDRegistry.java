...
public class PalladioComponentModelVisualIDRegistry {
	 ...
	 * @generated
	 */
	private static final String DEBUG_KEY = "de.uka.ipd.sdq.pcm.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getVisualID(View view) {
		...
		return de.uka.ipd.sdq.pcm.diagram.part.PalladioComponentModelVisualIDRegistry
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = de.uka.ipd.sdq.pcm.diagram.part.PalladioComponentModelVisualIDRegistry
		...
		if (ResourceEnvironmentEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = de.uka.ipd.sdq.pcm.diagram.part.PalladioComponentModelVisualIDRegistry

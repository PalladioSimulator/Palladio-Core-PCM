...
import de.uka.ipd.sdq.pcm.gmf.resource.edit.commands.LinkingResourceReorientCommand;
 ...
 * @generated
 */
public class CommunicationLinkResourceSpecificationItemSemanticEditPolicy
	...
	public CommunicationLinkResourceSpecificationItemSemanticEditPolicy() {
		super(
				PalladioComponentModelElementTypes.CommunicationLinkResourceSpecification_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (PalladioComponentModelVisualIDRegistry.getVisualID(incomingLink) == LinkingResourceEditPart.VISUAL_ID) {

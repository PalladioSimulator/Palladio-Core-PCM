...
public class PalladioComponentModelViewProvider extends AbstractProvider
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = PalladioComponentModelVisualIDRegistry.getNodeVisualID(op
			...
			if (elementType != null) {
				...
				if (!ResourceEnvironmentEditPart.MODEL_ID
						.equals(PalladioComponentModelVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ResourceContainerEditPart.VISUAL_ID:
			return createResourceContainer_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case CommunicationLinkResourceSpecificationEditPart.VISUAL_ID:
			return createCommunicationLinkResourceSpecification_2002(domainElement,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case LinkingResourceEditPart.VISUAL_ID:
			return createLinkingResource_4001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	...
	public Node createResourceContainer_2001(EObject domainElement,
		...
		Node label5001 = createLabel(node, PalladioComponentModelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createCommunicationLinkResourceSpecification_2002(
	 ...
	 * @generated
	 */
	public Node createProcessingResourceSpecification_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities.RGBToInteger(fillRGB));
		Node label5002 = createLabel(node, PalladioComponentModelVisualIDRegistry
				.getType(ProcessingResourceSpecificationMTTFEditPart.VISUAL_ID));
		Node label5003 = createLabel(node, PalladioComponentModelVisualIDRegistry
	 ...
	 * @generated NOT
	 */
	public Edge createLinkingResource_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		// GENERATED: Routing routing = Routing.get(prefStore.getInt(IPreferenceConstants.PREF_LINE_STYLE));

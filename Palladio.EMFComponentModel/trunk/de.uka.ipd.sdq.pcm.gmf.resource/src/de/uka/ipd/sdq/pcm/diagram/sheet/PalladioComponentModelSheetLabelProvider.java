package de.uka.ipd.sdq.pcm.diagram.sheet;
...
import de.uka.ipd.sdq.pcm.diagram.navigator.PalladioComponentModelNavigatorGroup;
...
public class PalladioComponentModelSheetLabelProvider extends
	...
	public String getText(Object element) {
		...
		if (selected instanceof PalladioComponentModelNavigatorGroup) {
			return ((PalladioComponentModelNavigatorGroup) selected).getGroupName();
		}

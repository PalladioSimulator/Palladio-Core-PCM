...
public class PalladioComponentModelLoadResourceAction implements
	 ...
	 * @generated
	 */
	private ResourceEnvironmentEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof ResourceEnvironmentEditPart) {
				mySelectedElement = (ResourceEnvironmentEditPart) structuredSelection
						.getFirstElement();
			}
		}

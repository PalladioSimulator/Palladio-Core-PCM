...
public class PalladioComponentModelElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType ResourceEnvironment_1000 = getElementType("de.uka.ipd.sdq.pcm.diagram.ResourceEnvironment_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ResourceContainer_2001 = getElementType("de.uka.ipd.sdq.pcm.diagram.ResourceContainer_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType CommunicationLinkResourceSpecification_2002 = getElementType("de.uka.ipd.sdq.pcm.diagram.CommunicationLinkResourceSpecification_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ProcessingResourceSpecification_3001 = getElementType("de.uka.ipd.sdq.pcm.diagram.ProcessingResourceSpecification_3001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType LinkingResource_4001 = getElementType("de.uka.ipd.sdq.pcm.diagram.LinkingResource_4001"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ResourceEnvironment_1000,

...
public class ThroughputEditHelperAdvice extends AbstractEditHelperAdvice
...
//				.getElementToConfigure(), ResourceenvironmentPackage.eINSTANCE.getCommunicationLinkResourceSpecification_Throughput_CommunicationLinkResourceSpecification(),
//				rv));
//
//		return cmd;
//	}
	...
	protected ICommand getCommand(IEditCommandRequest request) {
		...
		ICommand cmd = new SetValueCommand(new SetRequest((EObject) request
				.getElementsToEdit().get(0), ResourceenvironmentPackage.eINSTANCE.getCommunicationLinkResourceSpecification_Throughput_CommunicationLinkResourceSpecification(),
				rv));

 ...
 * <ul>
 *   <li>{@link de.ipd.uka.sdq.identifier.Identifier#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.ipd.uka.sdq.identifier.IdentifierPackage#getIdentifier()
 * @model abstract="true"
 * @generated
 */
public interface Identifier extends EObject {
	 ...
	 * @see #setId(String)
	 * @see de.ipd.uka.sdq.identifier.IdentifierPackage#getIdentifier_Id()
	...
	/**
	 * Sets the value of the '{@link de.ipd.uka.sdq.identifier.Identifier#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

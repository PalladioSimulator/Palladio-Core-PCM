 ...
 * @generated
 */
public class ExternalCallActionOutputVariableUsage2ItemSemanticEditPolicy extends PalladioComponentModelBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PalladioComponentModelElementTypes.VariableUsage_3039 == req.getElementType()) {

...
public class ReleaseActionEntityName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected String getLabelText() {
		...
		if (releaseAction != null && releaseAction instanceof ReleaseAction) {
			if (((ReleaseAction) releaseAction).getPassiveResource_ReleaseAction() != null)
				text += " <Resource: " + ((ReleaseAction) releaseAction).getPassiveResource_ReleaseAction().getEntityName() + ">";
		}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ReleaseAction_3020, getParserElement(),
					PalladioComponentModelVisualIDRegistry.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ReleaseActionEntityName2EditPart.VISUAL_ID));
		}
		return parser;
	}

...
public class ForkAction2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ForkActionEntityName2EditPart) {
			((ForkActionEntityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureForkFigureNameLabelFigure());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(ForkActionEntityName2EditPart.VISUAL_ID));
	}

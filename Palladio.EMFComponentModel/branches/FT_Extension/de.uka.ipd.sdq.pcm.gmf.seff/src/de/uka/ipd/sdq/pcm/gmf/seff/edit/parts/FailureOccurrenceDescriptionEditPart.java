...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.policies.FailureOccurrenceDescriptionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FailureOccurrenceDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FailureOccurrenceDescriptionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new FailureOccurrenceDescriptionItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenStoExDialog(PerformancePackage.eINSTANCE
	...
	protected String getLabelText() {
		String text = null;
		if (resolveSemanticElement() instanceof FailureOccurrenceDescription) {

			FailureOccurrenceDescription description = (FailureOccurrenceDescription) resolveSemanticElement();
			if (description.getFailuretype() != null)
				text = description.getFailuretype().getEntityName();
			else
				text = "N/A";
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.FailureOccurrenceDescription_3041, getParserElement(),
					PalladioComponentModelVisualIDRegistry.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.FailureOccurrenceDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this), PalladioComponentModelEditPartFactory
	...
	protected void addSemanticListeners() {
		FailureOccurrenceDescription element = (FailureOccurrenceDescription) resolveSemanticElement();

...
public class ReleaseAction2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ReleaseActionEntityName2EditPart) {
			((ReleaseActionEntityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureReleaseNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(ReleaseActionEntityName2EditPart.VISUAL_ID));
	}

 ...
 * @generated
 */
public class CollectionIteratorActionEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CollectionIteratorActionEntityNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider
					.getParser(PalladioComponentModelElementTypes.CollectionIteratorAction_2007, getParserElement(), PalladioComponentModelVisualIDRegistry
							.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.CollectionIteratorActionEntityNameEditPart.VISUAL_ID));
		}
		return parser;
	}

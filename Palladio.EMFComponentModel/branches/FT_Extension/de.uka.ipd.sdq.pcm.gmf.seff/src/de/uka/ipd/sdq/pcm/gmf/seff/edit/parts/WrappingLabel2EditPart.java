...
public class WrappingLabel2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected String getLabelText() {
		...
		if (action.getParameter_CollectionIteratorAction() != null && action.getParameter_CollectionIteratorAction().getParameterName() != null)
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.CollectionIteratorAction_2007, getParserElement(),
					PalladioComponentModelVisualIDRegistry.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.WrappingLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}

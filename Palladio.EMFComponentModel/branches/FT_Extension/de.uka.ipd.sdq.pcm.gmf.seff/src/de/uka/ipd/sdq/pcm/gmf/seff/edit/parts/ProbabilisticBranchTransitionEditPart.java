...
public class ProbabilisticBranchTransitionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProbabilisticBranchTransitionEntityNameEditPart) {
			((ProbabilisticBranchTransitionEntityNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureBranchTransitionNameLabel());
			return true;
		}
		if (childEditPart instanceof ProbabilisticBranchTransitionBranchProbabilityEditPart) {
			((ProbabilisticBranchTransitionBranchProbabilityEditPart) childEditPart).setLabel(getPrimaryShape().getFigureBranchTransitionProbabilityLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(ProbabilisticBranchTransitionEntityNameEditPart.VISUAL_ID));
	}
	...
	public class BranchTransitionFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureBranchTransitionNameLabel.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode().DPtoLP(0), getMapMode().DPtoLP(2), getMapMode()
					.DPtoLP(0)));
			...
			fFigureBranchTransitionProbabilityLabel.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode().DPtoLP(0), getMapMode().DPtoLP(2),
					getMapMode().DPtoLP(0)));
			...
			fFigureBranchTransitionConditionLabel.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode().DPtoLP(0), getMapMode().DPtoLP(2),
					getMapMode().DPtoLP(0)));

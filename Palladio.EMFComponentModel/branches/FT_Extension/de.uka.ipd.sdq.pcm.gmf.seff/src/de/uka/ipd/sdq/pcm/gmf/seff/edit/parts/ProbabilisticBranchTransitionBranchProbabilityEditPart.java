 ...
 * @generated
 */
public class ProbabilisticBranchTransitionBranchProbabilityEditPart extends CompartmentEditPart implements ITextAwareEditPart {
		...
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ProbabilisticBranchTransition_3010, getParserElement(),
					PalladioComponentModelVisualIDRegistry
							.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ProbabilisticBranchTransitionBranchProbabilityEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class ExternalCallActionInputVariableUsage2EditPart extends ShapeCompartmentEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ExternalCallActionInputVariableUsage2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ExternalCallActionInputVariableUsage2CanonicalEditPolicy());
	}

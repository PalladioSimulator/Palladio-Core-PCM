...
public class ParametricResourceDemandEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ParametricResourceDemandItemSemanticEditPolicy());
	...
	protected String getLabelText() {
		...
		if (resolveSemanticElement() instanceof ParametricResourceDemand) {
			...
			if (demand.getRequiredResource_ParametricResourceDemand() != null) {
				text = new PCMStoExPrettyPrintVisitor().prettyPrint(demand.getSpecification_ParametericResourceDemand().getExpression());
				if (text == null)
					text = "";
				else
					text += " ";
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ParametricResourceDemand_3031, getParserElement(),
					PalladioComponentModelVisualIDRegistry.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ParametricResourceDemandEditPart.VISUAL_ID));
		}
		return parser;
	}

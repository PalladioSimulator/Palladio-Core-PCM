		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof de.uka.ipd.sdq.pcm.gmf.seff.navigator.PalladioComponentModelNavigatorItem
					...
					return ((de.uka.ipd.sdq.pcm.gmf.seff.navigator.PalladioComponentModelNavigatorItem) adaptableObject).getView();
				}
				return null;
			}
	...
	public boolean equals(Object obj) {
		if (obj instanceof de.uka.ipd.sdq.pcm.gmf.seff.navigator.PalladioComponentModelNavigatorItem) {
			return EcoreUtil.getURI(getView()).equals(
					EcoreUtil.getURI(((de.uka.ipd.sdq.pcm.gmf.seff.navigator.PalladioComponentModelNavigatorItem) obj).getView()));
		}

...
public class PalladioComponentModelSeffDiagramEditorPlugin extends AbstractUIPlugin {
	...
	protected void fillItemProviderFactories(List factories) {
		...
		factories.add(new de.uka.ipd.sdq.pcm.qosannotations.performance.provider.PerformanceItemProviderAdapterFactory());
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, PalladioComponentModelSeffDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, PalladioComponentModelSeffDiagramEditorPlugin.ID, IStatus.OK, message, throwable));

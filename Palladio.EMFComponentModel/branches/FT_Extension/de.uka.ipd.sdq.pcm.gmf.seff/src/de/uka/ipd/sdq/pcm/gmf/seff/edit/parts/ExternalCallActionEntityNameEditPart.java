 ...
 * @generated
 */
public class ExternalCallActionEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ExternalCallActionEntityNameEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		if (resolveSemanticElement() instanceof ExternalCallAction) {
			...
			if (eca.getCalledService_ExternalService() != null && eca.getRole_ExternalService() != null) {
				text = eca.getRole_ExternalService().getEntityName() + "." + eca.getCalledService_ExternalService().getServiceName();
			}
		}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ExternalCallAction_2003, getParserElement(),
					PalladioComponentModelVisualIDRegistry.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ExternalCallActionEntityNameEditPart.VISUAL_ID));
		}
		return parser;
	}

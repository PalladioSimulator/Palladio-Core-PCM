...
public class PalladioComponentModelNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = PalladioComponentModelSeffDiagramEditorPlugin.getInstance().getDocumentProvider().getDiagramDocument(anInput);
		if (document == null) {
	...
	public void activateEditor(IWorkbenchPage aPage, IStructuredSelection aSelection) {
		...
		PalladioComponentModelAbstractNavigatorItem abstractNavigatorItem = (PalladioComponentModelAbstractNavigatorItem) aSelection.getFirstElement();

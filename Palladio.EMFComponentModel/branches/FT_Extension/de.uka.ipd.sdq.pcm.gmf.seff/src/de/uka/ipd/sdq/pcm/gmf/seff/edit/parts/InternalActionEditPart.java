...
public class InternalActionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InternalActionEntityNameEditPart) {
			((InternalActionEntityNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureInternalActionFigureNameLabel());
			return true;
		}
		if (childEditPart instanceof InternalActionResourceDemand2EditPart) {
			...
			pane.add(((InternalActionResourceDemand2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof InternalActionFailureOccurrences2EditPart) {
			IFigure pane = getPrimaryShape().getFigureInternalActionCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InternalActionFailureOccurrences2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InternalActionResourceDemand2EditPart) {
			IFigure pane = getPrimaryShape().getFigureInternalActionCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((InternalActionResourceDemand2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof InternalActionFailureOccurrences2EditPart) {
			IFigure pane = getPrimaryShape().getFigureInternalActionCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((InternalActionFailureOccurrences2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof InternalActionFailureOccurrences2EditPart) {
			return getPrimaryShape().getFigureInternalActionCompartment();
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(InternalActionEntityNameEditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == PalladioComponentModelElementTypes.ParametricResourceDemand_3031) {
				return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(InternalActionResourceDemand2EditPart.VISUAL_ID));
			}
			if (type == PalladioComponentModelElementTypes.FailureOccurrenceDescription_3041) {
				return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(InternalActionFailureOccurrences2EditPart.VISUAL_ID));
			}
		}

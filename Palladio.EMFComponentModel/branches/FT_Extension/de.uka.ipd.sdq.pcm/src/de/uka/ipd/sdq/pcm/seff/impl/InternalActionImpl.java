...
public class InternalActionImpl extends AbstractInternalControlFlowActionImpl implements InternalAction {
	...
	public EList<FailureOccurrenceDescription> getFailureOccurrenceDescriptions() {
		if (failureOccurrenceDescriptions == null) {
			failureOccurrenceDescriptions = new EObjectContainmentEList<FailureOccurrenceDescription>(FailureOccurrenceDescription.class, this, SeffPackage.INTERNAL_ACTION__FAILURE_OCCURRENCE_DESCRIPTIONS);
		}
	...
	/**
	 * The cached OCL expression body for the '{@link #Sumoffailureoccurenceprobabilitiesmustnotexeed10(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Sumoffailureoccurenceprobabilitiesmustnotexeed10</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #Sumoffailureoccurenceprobabilitiesmustnotexeed10(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String SUMOFFAILUREOCCURENCEPROBABILITIESMUSTNOTEXEED10__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.failureOccurrenceDescriptions.failureProbability.oclAsType(Real)->sum()<=1";

	/**
	 * The cached OCL invariant for the '{@link #Sumoffailureoccurenceprobabilitiesmustnotexeed10(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Sumoffailureoccurenceprobabilitiesmustnotexeed10</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #Sumoffailureoccurenceprobabilitiesmustnotexeed10(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static Constraint SUMOFFAILUREOCCURENCEPROBABILITIESMUSTNOTEXEED10__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	 ...
	 * @generated
	 */
	public boolean Sumoffailureoccurenceprobabilitiesmustnotexeed10(DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (SUMOFFAILUREOCCURENCEPROBABILITIESMUSTNOTEXEED10__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(SeffPackage.Literals.INTERNAL_ACTION);
			try {
				SUMOFFAILUREOCCURENCEPROBABILITIESMUSTNOTEXEED10__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(SUMOFFAILUREOCCURENCEPROBABILITIESMUSTNOTEXEED10__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(SUMOFFAILUREOCCURENCEPROBABILITIESMUSTNOTEXEED10__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(this)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 SeffValidator.DIAGNOSTIC_SOURCE,
						 SeffValidator.INTERNAL_ACTION__SUMOFFAILUREOCCURENCEPROBABILITIESMUSTNOTEXEED10,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "Sumoffailureoccurenceprobabilitiesmustnotexeed10", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}

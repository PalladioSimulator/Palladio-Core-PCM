...
public class SeffValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final int START_ACTION__START_ACTION_PREDECESSOR_MUST_NOT_BE_DEFINED = 2;
	 ...
	 * @generated
	 */
	public static final int RESOURCE_DEMANDING_BEHAVIOUR__EXACTLY_ONE_STOP_ACTION = 3;
	 ...
	 * @generated
	 */
	public static final int RESOURCE_DEMANDING_BEHAVIOUR__EXACTLY_ONE_START_ACTION = 4;
	 ...
	 * @generated
	 */
	public static final int RESOURCE_DEMANDING_BEHAVIOUR__EACH_ACTION_EXCEPT_START_ACTIONAND_STOP_ACTION_MUST_HHAVE_APREDECESSOR_AND_SUCCESSOR = 5;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Multipleusagesofsamefailuretypearenotallowed' of 'Internal Action'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int INTERNAL_ACTION__MULTIPLEUSAGESOFSAMEFAILURETYPEARENOTALLOWED = 6;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Sumoffailureoccurenceprobabilitiesmustnotexeed10' of 'Internal Action'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int INTERNAL_ACTION__SUMOFFAILUREOCCURENCEPROBABILITIESMUSTNOTEXEED10 = 7;
	 ...
	 * @generated
	 */
	public static final int RECOVERY_BLOCK_ACTION__ALTERNATIVESFORMACHAIN = 10;
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case SeffPackage.FAILURE_OCCURRENCE_DESCRIPTION:
			...
			case SeffPackage.RECOVERY_BLOCK_ACTION:
				return validateRecoveryBlockAction((RecoveryBlockAction)value, diagnostics, context);
			case SeffPackage.RECOVERY_BLOCK_ALTERNATIVE_BEHAVIOUR:
	...
	public boolean validateInternalAction(InternalAction internalAction, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateInternalAction_Multipleusagesofsamefailuretypearenotallowed(internalAction, diagnostics, context);
		if (result || diagnostics != null) result &= validateInternalAction_Sumoffailureoccurenceprobabilitiesmustnotexeed10(internalAction, diagnostics, context);
		return result;
	}

	/**
	 * Validates the Multipleusagesofsamefailuretypearenotallowed constraint of '<em>Internal Action</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateInternalAction_Multipleusagesofsamefailuretypearenotallowed(InternalAction internalAction, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return internalAction.Multipleusagesofsamefailuretypearenotallowed(diagnostics, context);
	}

	/**
	 * Validates the Sumoffailureoccurenceprobabilitiesmustnotexeed10 constraint of '<em>Internal Action</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateInternalAction_Sumoffailureoccurenceprobabilitiesmustnotexeed10(InternalAction internalAction, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return internalAction.Sumoffailureoccurenceprobabilitiesmustnotexeed10(diagnostics, context);
	}
	...
	public boolean validateFailureOccurrenceDescription(FailureOccurrenceDescription failureOccurrenceDescription, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(failureOccurrenceDescription, diagnostics, context);
	}
	...
	public boolean validateRecoveryBlockAlternativeBehaviour(RecoveryBlockAlternativeBehaviour recoveryBlockAlternativeBehaviour, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateResourceDemandingBehaviour_ExactlyOneStopAction(recoveryBlockAlternativeBehaviour, diagnostics, context);
		if (result || diagnostics != null) result &= validateResourceDemandingBehaviour_ExactlyOneStartAction(recoveryBlockAlternativeBehaviour, diagnostics, context);
		if (result || diagnostics != null) result &= validateResourceDemandingBehaviour_EachActionExceptStartActionandStopActionMustHhaveAPredecessorAndSuccessor(recoveryBlockAlternativeBehaviour, diagnostics, context);
		return result;
	}

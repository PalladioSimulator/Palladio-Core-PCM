...
public interface Branch extends AbstractUserAction {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self->collect(branchTransitions_Branch.branchProbability.oclAsType(Real))->sum() > 0.999 and self->collect(branchTransitions_Branch.branchProbability.oclAsType(Real))->sum() <1.001
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self->collect(branchTransitions_Branch.branchProbability.oclAsType(Real))->sum() > 0.999 and self->collect(branchTransitions_Branch.branchProbability.oclAsType(Real))->sum() <1.001'"
	 * @generated
	 */

...
public class BranchImpl extends AbstractUserActionImpl implements Branch {
	 ...
	 * @ordered
	 */
	protected static final String ALL_BRANCH_PROBABILITIES_MUST_SUM_UP_TO1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self->collect(branchTransitions_Branch.branchProbability.oclAsType(Real))->sum() > 0.999 and self->collect(branchTransitions_Branch.branchProbability.oclAsType(Real))->sum() <1.001";

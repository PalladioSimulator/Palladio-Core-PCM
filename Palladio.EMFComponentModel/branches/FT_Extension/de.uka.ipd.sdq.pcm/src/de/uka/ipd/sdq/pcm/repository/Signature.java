 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.Signature#getFailureTypes <em>Failure Types</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Signature extends EObject {
	 ...
	 * @see de.uka.ipd.sdq.pcm.repository.RepositoryPackage#getSignature_FailureTypes()
	 * @model ordered="false"
	 * @generated
	 */

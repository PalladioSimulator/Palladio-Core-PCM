 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.impl.SignatureImpl#getFailureTypes <em>Failure Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignatureImpl extends EObjectImpl implements Signature {
	...
	public EList<FailureType> getFailureTypes() {
		if (failureTypes == null) {
			failureTypes = new EObjectResolvingEList<FailureType>(FailureType.class, this, RepositoryPackage.SIGNATURE__FAILURE_TYPES);
		}
		return failureTypes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RepositoryPackage.SIGNATURE__FAILURE_TYPES:

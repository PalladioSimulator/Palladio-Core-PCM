...
public class PalladioComponentModelDiagramUpdater {
	...
	public static List getLinkingResourceNetworkSwitchCompartment_7003SemanticChildren(View view) {
		...
		LinkingResource modelElement = (LinkingResource) containerView.getElement();
		List result = new LinkedList();
		{
			CommunicationLinkResourceSpecification childElement = modelElement.getCommunicationLinkResourceSpecifications();
			int visualID = PalladioComponentModelVisualIDRegistry.getNodeVisualID(view, childElement);
	...
	public static List getResourceEnvironment_1000SemanticChildren(View view) {
		...
		List result = new LinkedList();
		for (Iterator it = modelElement.getResourceContainer_ResourceEnvironment().iterator(); it.hasNext();) {
		...
		for (Iterator it = modelElement.getLinkingResources().iterator(); it.hasNext();) {
	...
	public static List getContainedLinks(View view) {
		...
		case CommunicationLinkResourceSpecificationEditPart.VISUAL_ID:
			return getCommunicationLinkResourceSpecification_3003ContainedLinks(view);
		}
		return Collections.EMPTY_LIST;
	}
	...
	public static List getIncomingLinks(View view) {
		...
		case CommunicationLinkResourceSpecificationEditPart.VISUAL_ID:
			return getCommunicationLinkResourceSpecification_3003IncomingLinks(view);
		}
		return Collections.EMPTY_LIST;
	}
	...
	public static List getOutgoingLinks(View view) {
		...
		case CommunicationLinkResourceSpecificationEditPart.VISUAL_ID:
			return getCommunicationLinkResourceSpecification_3003OutgoingLinks(view);
		}
		return Collections.EMPTY_LIST;
	}
	...
	public static List getLinkingResource_2003ContainedLinks(View view) {
		...
		List result = new LinkedList();
		result.addAll(getOutgoingFeatureModelFacetLinks_LinkingResource_ConnectedResourceContainers_4003(modelElement));
		return result;
	}
	 ...
	 * @generated
	 */
	public static List getCommunicationLinkResourceSpecification_3003ContainedLinks(View view) {
		return Collections.EMPTY_LIST;
	}
	...
	public static List getResourceContainer_2001IncomingLinks(View view) {
		...
		List result = new LinkedList();
		result.addAll(getIncomingFeatureModelFacetLinks_LinkingResource_ConnectedResourceContainers_4003(modelElement, crossReferences));
		return result;
	}
	 ...
	 * @generated
	 */
	public static List getCommunicationLinkResourceSpecification_3003IncomingLinks(View view) {
		return Collections.EMPTY_LIST;
	}
	 ...
	 * @generated
	 */
	public static List getCommunicationLinkResourceSpecification_3003OutgoingLinks(View view) {
		return Collections.EMPTY_LIST;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_LinkingResource_ConnectedResourceContainers_4003(ResourceContainer target, Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == ResourceenvironmentPackage.eINSTANCE.getLinkingResource_ConnectedResourceContainers()) {
				result.add(new PalladioComponentModelLinkDescriptor(setting.getEObject(), target,
						PalladioComponentModelElementTypes.LinkingResourceConnectedResourceContainers_4003,
						LinkingResourceConnectedResourceContainersEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_LinkingResource_ConnectedResourceContainers_4003(LinkingResource source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getConnectedResourceContainers().iterator(); destinations.hasNext();) {
			ResourceContainer destination = (ResourceContainer) destinations.next();

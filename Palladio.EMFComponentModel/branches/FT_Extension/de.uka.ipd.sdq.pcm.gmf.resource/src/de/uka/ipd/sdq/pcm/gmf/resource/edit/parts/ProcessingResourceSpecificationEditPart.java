...
public class ProcessingResourceSpecificationEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProcessingResourceSpecificationSchedulingPolicyEditPart) {
			((ProcessingResourceSpecificationSchedulingPolicyEditPart) childEditPart).setLabel(getPrimaryShape().getFigureSchedulingPolicyFigure());
			return true;
		}
		if (childEditPart instanceof ProcessingResourceSpecificationMTTFEditPart) {
			((ProcessingResourceSpecificationMTTFEditPart) childEditPart).setLabel(getPrimaryShape().getFigureMTTFFigure());
			return true;
		}
		if (childEditPart instanceof ProcessingResourceSpecificationMTTREditPart) {
			((ProcessingResourceSpecificationMTTREditPart) childEditPart).setLabel(getPrimaryShape().getFigureMTTRFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabelEditPart) {
			((WrappingLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureProcessingRateFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(ProcessingResourceSpecificationMTTFEditPart.VISUAL_ID));
	}
	...
	public class ProcessingResourceSpecificationFigure extends RectangleFigure {
		...
		public ProcessingResourceSpecificationFigure() {
			...
			this.setBorder(new MarginBorder(getMapMode().DPtoLP(25), getMapMode().DPtoLP(0), getMapMode().DPtoLP(0), getMapMode().DPtoLP(0)));
			createContents();
		}

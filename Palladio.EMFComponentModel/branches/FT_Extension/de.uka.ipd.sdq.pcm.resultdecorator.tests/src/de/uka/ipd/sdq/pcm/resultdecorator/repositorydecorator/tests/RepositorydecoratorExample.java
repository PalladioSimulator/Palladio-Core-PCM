...
import de.uka.ipd.sdq.pcm.resultdecorator.repositorydecorator.util.RepositorydecoratorResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>repositorydecorator</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new RepositorydecoratorResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(RepositorydecoratorPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.repositorydecorator"));
				InterfaceProvidingRequiringEntityResults root = RepositorydecoratorFactory.eINSTANCE.createInterfaceProvidingRequiringEntityResults();

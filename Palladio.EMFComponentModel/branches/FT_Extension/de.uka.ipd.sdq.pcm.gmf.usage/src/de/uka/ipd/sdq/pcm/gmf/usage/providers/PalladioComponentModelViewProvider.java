...
public class PalladioComponentModelViewProvider extends AbstractProvider
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return ScenarioBehaviourEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ScenarioBehaviourEditPart.VISUAL_ID:
			return createScenarioBehaviour_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case ClosedWorkloadEditPart.VISUAL_ID:
			return createClosedWorkload_2002(domainElement, containerView,
					index, persisted, preferencesHint);
		case OpenWorkloadEditPart.VISUAL_ID:
			return createOpenWorkload_2003(domainElement, containerView, index,
	 ...
	 * @generated
	 */
	public Node createScenarioBehaviour_2001(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createClosedWorkload_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Node createOpenWorkload_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()

	...
	protected void addFailureTypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signature_failureTypes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signature_failureTypes_feature", "_UI_Signature_type"),
				 RepositoryPackage.Literals.SIGNATURE__FAILURE_TYPES,
				 true,
				 false,
				 true,
				 null,

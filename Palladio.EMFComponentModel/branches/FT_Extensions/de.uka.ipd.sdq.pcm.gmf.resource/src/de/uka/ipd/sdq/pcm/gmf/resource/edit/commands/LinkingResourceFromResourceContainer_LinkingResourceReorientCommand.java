 ...
 * @generated
 */
public class LinkingResourceFromResourceContainer_LinkingResourceReorientCommand
	 ...
	 * @generated
	 */
	public LinkingResourceFromResourceContainer_LinkingResourceReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLinkingResourceFromResourceContainer_LinkingResource_4001(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getFromResourceContainer_LinkingResource().remove(
				getOldTarget());
		getNewSource().getFromResourceContainer_LinkingResource().add(
				getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getFromResourceContainer_LinkingResource().remove(
				getOldTarget());
		getOldSource().getFromResourceContainer_LinkingResource().add(
				getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

 ...
 * @generated
 */
public class LinkingResourceFromResourceContainer_LinkingResourceCreateCommand
	 ...
	 * @generated
	 */
	public LinkingResourceFromResourceContainer_LinkingResourceCreateCommand(
	...
	public boolean canExecute() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateLinkingResourceFromResourceContainer_LinkingResource_4001(
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getFromResourceContainer_LinkingResource().add(getTarget());
		}

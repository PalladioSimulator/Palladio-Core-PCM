 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.qosannotations.performance.SpecifiedExecutionTime#getSpecification_SpecifiedExecutionTime <em>Specification Specified Execution Time</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.pcm.qosannotations.performance.PerformancePackage#getSpecifiedExecutionTime()
 * @model abstract="true"
 * @generated
 */
public interface SpecifiedExecutionTime extends SpecifiedQoSAnnotation {
	 ...
	 * @see de.uka.ipd.sdq.pcm.qosannotations.performance.PerformancePackage#getSpecifiedExecutionTime_Specification_SpecifiedExecutionTime()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.qosannotations.performance.SpecifiedExecutionTime#getSpecification_SpecifiedExecutionTime <em>Specification Specified Execution Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

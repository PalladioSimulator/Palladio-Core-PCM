...
public class PalladioComponentModelNavigatorLabelProvider extends LabelProvider
	...
	public Image getImage(View view) {
		...
		case RecoveryBlockActionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://sdq.ipd.uka.de/PalladioComponentModel/SEFF/Reliability/1.0?RecoveryBlockAction", PalladioComponentModelElementTypes.RecoveryBlockAction_2014); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case RecoveryBlockActionEditPart.VISUAL_ID:
			return getRecoveryBlockAction_2014Text(view);
		case VariableUsageEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getRecoveryBlockAction_2014Text(View view) {
		RecoveryBlockAction domainModelElement = (RecoveryBlockAction) view
				.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getId();
		} else {

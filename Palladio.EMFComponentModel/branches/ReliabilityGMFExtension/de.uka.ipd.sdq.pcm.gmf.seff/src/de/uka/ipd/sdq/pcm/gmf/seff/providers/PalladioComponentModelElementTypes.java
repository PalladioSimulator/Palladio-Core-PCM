...
public class PalladioComponentModelElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType RecoveryBlockAction_2014 = getElementType("de.uka.ipd.sdq.pcm.gmf.seff.RecoveryBlockAction_2014"); //$NON-NLS-1$
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(RecoveryBlockAction_2014);
	...
	public static IElementType getElementType(int visualID) {
		...
		case RecoveryBlockActionEditPart.VISUAL_ID:
			return RecoveryBlockAction_2014;

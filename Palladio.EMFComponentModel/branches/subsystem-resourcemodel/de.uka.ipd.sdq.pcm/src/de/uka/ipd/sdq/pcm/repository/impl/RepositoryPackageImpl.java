...
public class RepositoryPackageImpl extends EPackageImpl implements RepositoryPackage {
	 ...
	 * @generated
	 */
	public EReference getRepository_Subsystems__Repository() {
	 ...
	 * @generated
	 */
	public EReference getProvidesComponentType_Repository_ProvidesComponentType() {
	 ...
	 * @generated
	 */
	public EAttribute getInterface_IsResourceInterface() {
	...
	public void createPackageContents() {
		...
		createEReference(parameterEClass, PARAMETER__SIGNATURE_PARAMETER);
		...
		createEReference(repositoryEClass, REPOSITORY__SUBSYSTEMS_REPOSITORY);
		...
		createEReference(providesComponentTypeEClass, PROVIDES_COMPONENT_TYPE__REPOSITORY_PROVIDES_COMPONENT_TYPE);
		...
		createEAttribute(interfaceEClass, INTERFACE__IS_RESOURCE_INTERFACE);
	...
	public void initializePackageContents() {
		...
		implementationComponentTypeEClass.getESuperTypes().add(theEntityPackage.getInterfaceProvidingRequiringEntity());
		completeComponentTypeEClass.getESuperTypes().add(theEntityPackage.getInterfaceProvidingRequiringEntity());
		...
		EOperation op = addEOperation(signatureEClass, ecorePackage.getEBoolean(), "ParameterNamesHaveToBeUniqueForASignature", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getParameter_Signature_Parameter(), this.getSignature(), this.getSignature_Parameters__Signature(), "signature_Parameter", null, 1, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getRepository_Components__Repository(), this.getProvidesComponentType(), this.getProvidesComponentType_Repository_ProvidesComponentType(), "components__Repository", null, 0, -1, Repository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getRepository_Subsystems__Repository(), theSubsystemPackage.getSubSystem(), theSubsystemPackage.getSubSystem_Repository__SubSystem(), "subsystems__Repository", null, 0, -1, Repository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getProvidesComponentType_Repository_ProvidesComponentType(), this.getRepository(), this.getRepository_Components__Repository(), "repository_ProvidesComponentType", null, 1, 1, ProvidesComponentType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getInterface_IsResourceInterface(), ecorePackage.getEBoolean(), "isResourceInterface", null, 1, 1, Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		op = addEOperation(interfaceEClass, ecorePackage.getEBoolean(), "SignaturesHaveToBeUniqueForAnInterface", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEReference(getBasicComponent_PassiveResource_BasicComponent(), this.getPassiveResource(), null, "passiveResource_BasicComponent", null, 0, -1, BasicComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

...
public class ReliabilityAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.qosannotations.reliability.SpecifiedFailureProbability <em>Specified Failure Probability</em>}'.
	 * <!-- begin-user-doc -->

...
import de.uka.ipd.sdq.pcmbench.ui.provider.OperationSignaturePrinter;

/**
 * @generated
 */
public class OperationSignatureEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OperationSignatureEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OperationSignatureItemSemanticEditPolicy());
	...
	protected String getLabelText() {
		...
		if (resolveSemanticElement() instanceof OperationSignature) {
			...
			text = new OperationSignaturePrinter().doSwitch(sig);
			...
			parser = PalladioComponentModelParserProvider
					.getParser(
							...
							PalladioComponentModelVisualIDRegistry
									.getType(de.uka.ipd.sdq.pcm.gmf.repository.edit.parts.OperationSignatureEditPart.VISUAL_ID));
		}
		return parser;
	}

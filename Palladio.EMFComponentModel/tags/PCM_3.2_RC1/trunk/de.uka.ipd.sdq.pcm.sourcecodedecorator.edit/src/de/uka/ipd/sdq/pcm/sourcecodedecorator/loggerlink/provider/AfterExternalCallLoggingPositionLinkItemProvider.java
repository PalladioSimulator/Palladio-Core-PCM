...
public class AfterExternalCallLoggingPositionLinkItemProvider
	...
	protected void addCalledFunctionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AfterExternalCallLoggingPositionLink_calledFunction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AfterExternalCallLoggingPositionLink_calledFunction_feature", "_UI_AfterExternalCallLoggingPositionLink_type"),
				 LoggerlinkPackage.Literals.AFTER_EXTERNAL_CALL_LOGGING_POSITION_LINK__CALLED_FUNCTION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LoggerlinkPackage.Literals.AFTER_EXTERNAL_CALL_LOGGING_POSITION_LINK__PARAMETER_LINK);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AfterExternalCallLoggingPositionLink.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LoggerlinkPackage.Literals.AFTER_EXTERNAL_CALL_LOGGING_POSITION_LINK__PARAMETER_LINK,

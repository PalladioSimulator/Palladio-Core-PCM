...
public class CompositionPackageImpl extends EPackageImpl implements CompositionPackage {
	 ...
	 * @generated
	 */
	public EReference getAssemblyEventConnector_ComposedStructure__AssemblyEventConnector() {
	 ...
	 * @generated
	 */
	public EReference getSourceDelegationConnector_ParentStructure__SourceDelegationConnector() {
	 ...
	 * @generated
	 */
	public EReference getSinkDelegationConnector_ParentStructure__SinkDelegationConnector() {
	 ...
	 * @generated
	 */
	public EReference getComposedStructure_AssemblyEventConnectors__ComposedStructure() {
	...
	public void createPackageContents() {
		...
		createEReference(composedStructureEClass, COMPOSED_STRUCTURE__ASSEMBLY_EVENT_CONNECTORS_COMPOSED_STRUCTURE);
		...
		createEReference(assemblyEventConnectorEClass, ASSEMBLY_EVENT_CONNECTOR__COMPOSED_STRUCTURE_ASSEMBLY_EVENT_CONNECTOR);
	...
	public void initializePackageContents() {
		...
		initEReference(getComposedStructure_AssemblyEventConnectors__ComposedStructure(), this.getAssemblyEventConnector(), this.getAssemblyEventConnector_ComposedStructure__AssemblyEventConnector(), "assemblyEventConnectors__ComposedStructure", null, 0, -1, ComposedStructure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getComposedStructure_SourceDelegationConnectors__ComposedStructure(), this.getSourceDelegationConnector(), this.getSourceDelegationConnector_ParentStructure__SourceDelegationConnector(), "sourceDelegationConnectors__ComposedStructure", null, 0, -1, ComposedStructure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getComposedStructure_SinkDelegationConnectors__ComposedStructure(), this.getSinkDelegationConnector(), this.getSinkDelegationConnector_ParentStructure__SinkDelegationConnector(), "sinkDelegationConnectors__ComposedStructure", null, 0, -1, ComposedStructure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getAssemblyEventConnector_ComposedStructure__AssemblyEventConnector(), this.getComposedStructure(), this.getComposedStructure_AssemblyEventConnectors__ComposedStructure(), "composedStructure__AssemblyEventConnector", null, 1, 1, AssemblyEventConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getSourceDelegationConnector_ParentStructure__SourceDelegationConnector(), this.getComposedStructure(), this.getComposedStructure_SourceDelegationConnectors__ComposedStructure(), "parentStructure__SourceDelegationConnector", null, 1, 1, SourceDelegationConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getSinkDelegationConnector_ParentStructure__SinkDelegationConnector(), this.getComposedStructure(), this.getComposedStructure_SinkDelegationConnectors__ComposedStructure(), "parentStructure__SinkDelegationConnector", null, 1, 1, SinkDelegationConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getAssemblyContext_ConfigParameterUsages_AssemblyContext(), theParameterPackage.getVariableUsage(), theParameterPackage.getVariableUsage_AssemblyContext_VariableUsage(), "configParameterUsages_AssemblyContext", null, 0, -1, AssemblyContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	}

...
public class RepositoryPackageImpl extends EPackageImpl implements RepositoryPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getParameter_ResourceSignature__Parameter(), this.getResourceSignature(), this.getResourceSignature_Parameter__ResourceSignature(), "resourceSignature__Parameter", null, 0, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getResourceSignature_Parameter__ResourceSignature(), this.getParameter(), this.getParameter_ResourceSignature__Parameter(), "parameter__ResourceSignature", null, 1, 1, ResourceSignature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

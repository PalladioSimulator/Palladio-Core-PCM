...
/**
 * This is the action bar contributor for the Performance model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PerformanceActionBarContributor
	 ...
	 * @generated
	 */
	public PerformanceActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("performance-settings"));
		toolBarManager.add(new Separator("performance-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PalladioComponentModelEditorPlugin.INSTANCE.getString("_UI_PerformanceEditor_menu"), "de.uka.ipd.sdq.pcm.qosannotations.performanceMenuID");

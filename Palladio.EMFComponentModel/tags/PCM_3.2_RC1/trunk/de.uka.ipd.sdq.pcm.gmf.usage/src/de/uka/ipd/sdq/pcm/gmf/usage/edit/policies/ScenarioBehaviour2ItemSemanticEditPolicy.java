 ...
 * @generated
 */
public class ScenarioBehaviour2ItemSemanticEditPolicy extends
					...
					case StartEditPart.VISUAL_ID:
						for (Iterator it = cnode.getTargetEdges().iterator(); it
							...
							if (PalladioComponentModelVisualIDRegistry
									.getVisualID(incomingLink) == AbstractUserActionSuccessorEditPart.VISUAL_ID) {
						...
						for (Iterator it = cnode.getSourceEdges().iterator(); it
							...
							if (PalladioComponentModelVisualIDRegistry
									.getVisualID(outgoingLink) == AbstractUserActionSuccessorEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(

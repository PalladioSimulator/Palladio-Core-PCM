...
public class PalladioComponentModelNavigatorLabelProvider extends LabelProvider
	...
	public Image getImage(View view) {
		...
		case UsageScenarioEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Diagram?http://sdq.ipd.uka.de/PalladioComponentModel/UsageModel/4.0?UsageModel", PalladioComponentModelElementTypes.UsageModel_1000); //$NON-NLS-1$
		case UsageScenario2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://sdq.ipd.uka.de/PalladioComponentModel/UsageModel/4.0?UsageScenario", PalladioComponentModelElementTypes.UsageScenario_2004); //$NON-NLS-1$
		case ScenarioBehaviourEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/UsageModel/4.0?ScenarioBehaviour", PalladioComponentModelElementTypes.ScenarioBehaviour_3014); //$NON-NLS-1$
		...
		case DelayEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/UsageModel/4.0?Delay", PalladioComponentModelElementTypes.Delay_3017); //$NON-NLS-1$
		case ClosedWorkloadEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/UsageModel/4.0?ClosedWorkload", PalladioComponentModelElementTypes.ClosedWorkload_3015); //$NON-NLS-1$
		case OpenWorkloadEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/UsageModel/4.0?OpenWorkload", PalladioComponentModelElementTypes.OpenWorkload_3016); //$NON-NLS-1$
	...
	private String getUsageScenario_2004Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.UsageScenario_2004, view
	...
	private String getDelay_3017Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.Delay_3017, view
						.getElement() != null ? view.getElement() : view,
				PalladioComponentModelVisualIDRegistry
	...
	private String getClosedWorkload_3015Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.ClosedWorkload_3015, view
						.getElement() != null ? view.getElement() : view,
				PalladioComponentModelVisualIDRegistry
	...
	private String getOpenWorkload_3016Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.OpenWorkload_3016, view
						.getElement() != null ? view.getElement() : view,
				PalladioComponentModelVisualIDRegistry

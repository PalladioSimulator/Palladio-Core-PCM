...
public class AssemblyConnectorCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateAssemblyConnector_4004(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		AssemblyConnector newElement = CompositionFactory.eINSTANCE
				.createAssemblyConnector();
		getContainer().getAssemblyConnectors_ComposedStructure()
				.add(newElement);

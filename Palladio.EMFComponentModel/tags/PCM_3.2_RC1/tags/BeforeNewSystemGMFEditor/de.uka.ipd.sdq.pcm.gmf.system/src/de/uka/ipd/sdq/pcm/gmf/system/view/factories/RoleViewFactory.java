 ...
 * @generated
 */
public class RoleViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.uka.ipd.sdq.pcm.gmf.system.edit.parts.RoleEditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view,
				PcmVisualIDRegistry.getType(RoleLabelEditPart.VISUAL_ID),

...
/**
 * This is the action bar contributor for the Assembly model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssemblyActionBarContributor
	 ...
	 * @generated
	 */
	public AssemblyActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("assembly-settings"));
		toolBarManager.add(new Separator("assembly-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PcmEditorPlugin.INSTANCE.getString("_UI_AssemblyEditor_menu"), "de.uka.ipd.sdq.pcm.assemblyMenuID");

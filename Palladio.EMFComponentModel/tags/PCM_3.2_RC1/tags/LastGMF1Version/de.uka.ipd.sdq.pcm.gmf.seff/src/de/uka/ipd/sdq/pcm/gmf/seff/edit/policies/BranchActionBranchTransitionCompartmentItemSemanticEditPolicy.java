...
public class BranchActionBranchTransitionCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PcmElementTypes.ProbabilisticBranchTransition_2010 == req
				.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(SeffPackage.eINSTANCE
						.getBranchAction_Branches_Branch());
			}
			return getMSLWrapper(new CreateProbabilisticBranchTransition_2010Command(
					req));
		}
	 ...
	 * @generated
	 */
	private static class CreateProbabilisticBranchTransition_2010Command extends
			CreateElementCommand {

		/**
		 * @generated
		 */
		public CreateProbabilisticBranchTransition_2010Command(

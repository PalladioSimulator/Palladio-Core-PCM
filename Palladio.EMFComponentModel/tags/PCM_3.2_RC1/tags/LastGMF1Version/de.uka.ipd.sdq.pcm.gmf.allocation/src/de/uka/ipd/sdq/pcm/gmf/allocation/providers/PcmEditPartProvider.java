 ...
 * @generated
 */
public class PcmEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public PcmEditPartProvider() {
		setFactory(new PcmEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!AllocationEditPart.MODEL_ID.equals(PcmVisualIDRegistry
					.getModelID(view))) {
				return false;
			}

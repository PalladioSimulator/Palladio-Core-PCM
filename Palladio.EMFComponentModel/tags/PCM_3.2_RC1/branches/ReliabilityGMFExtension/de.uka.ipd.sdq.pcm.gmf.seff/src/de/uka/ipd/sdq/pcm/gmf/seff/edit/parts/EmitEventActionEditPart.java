...
public class EmitEventActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EmitEventActionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EmitEventActionEntityNameEditPart) {
			((EmitEventActionEntityNameEditPart) childEditPart)
		...
		if (childEditPart instanceof EmitEventActionInputVariableUsageEventEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureEmitEventActionCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((EmitEventActionInputVariableUsageEventEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EmitEventActionInputVariableUsageEventEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((EmitEventActionInputVariableUsageEventEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForTarget(
		...
		if (relationshipType == PalladioComponentModelElementTypes.AbstractActionSuccessor_AbstractAction_4001) {
			types
					.add(PalladioComponentModelElementTypes.RecoveryBlockAction_2014);
		}
		if (relationshipType == PalladioComponentModelElementTypes.AbstractActionSuccessor_AbstractAction_4001) {
	...
	public class EmitEventActionFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureComponentEmitEventAction.setBorder(new MarginBorder(
			...
			this.add(fFigureComponentEmitEventAction,
					constraintFFigureComponentEmitEventAction);
			...
			this.add(fFigureEmitEventActionCompartmentRectangle,
					constraintFFigureEmitEventActionCompartmentRectangle);

...
public class EmitEventAction2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EmitEventAction2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EmitEventActionEntityName2EditPart) {
			((EmitEventActionEntityName2EditPart) childEditPart)
		...
		if (childEditPart instanceof EmitEventActionInputVariableUsageEvent2EditPart) {
			...
			pane
					.add(((EmitEventActionInputVariableUsageEvent2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EmitEventActionInputVariableUsageEvent2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((EmitEventActionInputVariableUsageEvent2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;

...
public interface ResultdecoratorPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int RESULT_DECORATOR_REPOSITORY__INTERFACEPROVIDINGREQUIRINGENTITYRESULTS = EntityPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESULT_DECORATOR_REPOSITORY__UTILISATIONRESULT = EntityPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESULT_DECORATOR_REPOSITORY_FEATURE_COUNT = EntityPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;

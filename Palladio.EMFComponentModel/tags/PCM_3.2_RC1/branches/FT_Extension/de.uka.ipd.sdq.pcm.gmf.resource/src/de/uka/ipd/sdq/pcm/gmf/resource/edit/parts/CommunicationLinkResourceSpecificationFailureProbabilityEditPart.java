 ...
 * @generated
 */
public class CommunicationLinkResourceSpecificationFailureProbabilityEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CommunicationLinkResourceSpecificationFailureProbabilityEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.CommunicationLinkResourceSpecification_3003,

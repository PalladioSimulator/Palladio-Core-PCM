...
public class PalladioComponentModelNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	 ...
	 */
	static {
		PalladioComponentModelDiagramEditorPlugin.getInstance().getImageRegistry().put("Navigator?UnknownElement", ImageDescriptor.getMissingImageDescriptor()); //$NON-NLS-1$
		PalladioComponentModelDiagramEditorPlugin.getInstance().getImageRegistry().put("Navigator?ImageNotFound", ImageDescriptor.getMissingImageDescriptor()); //$NON-NLS-1$
	}
	...
	public Image getImage(Object element) {
		if (element instanceof PalladioComponentModelNavigatorGroup) {
			...
			return PalladioComponentModelDiagramEditorPlugin.getInstance().getBundledImage(group.getIcon());
		}
	...
	public Image getImage(View view) {
		...
		case CommunicationLinkResourceSpecificationEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/ResourceEnvironment/4.0?CommunicationLinkResourceSpecification", PalladioComponentModelElementTypes.CommunicationLinkResourceSpecification_3003); //$NON-NLS-1$
		case LinkingResourceConnectedResourceContainersEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://sdq.ipd.uka.de/PalladioComponentModel/ResourceEnvironment/4.0?LinkingResource?connectedResourceContainers", PalladioComponentModelElementTypes.LinkingResourceConnectedResourceContainers_4003); //$NON-NLS-1$
		}
	...
	public String getText(View view) {
		...
		case CommunicationLinkResourceSpecificationEditPart.VISUAL_ID:
			return getCommunicationLinkResourceSpecification_3003Text(view);
		case LinkingResourceConnectedResourceContainersEditPart.VISUAL_ID:
			return getLinkingResourceConnectedResourceContainers_4003Text(view);
		}
	...
	private String getResourceContainer_2001Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ResourceContainer_2001,
		...
		if (parser != null) {
			...
			PalladioComponentModelDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getLinkingResource_2003Text(View view) {
		...
		if (domainModelElement != null) {
			...
			PalladioComponentModelDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 2003); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getProcessingResourceSpecification_3001Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ProcessingResourceSpecification_3001, view
		...
		if (parser != null) {
			...
			PalladioComponentModelDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getCommunicationLinkResourceSpecification_3003Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.CommunicationLinkResourceSpecification_3003, view
				.getElement() != null ? view.getElement() : view, PalladioComponentModelVisualIDRegistry
				.getType(CommunicationLinkResourceSpecificationFailureProbabilityEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view), ParserOptions.NONE.intValue());
		} else {
			PalladioComponentModelDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5009); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getLinkingResourceConnectedResourceContainers_4003Text(View view) {
		return ""; //$NON-NLS-1$
	}

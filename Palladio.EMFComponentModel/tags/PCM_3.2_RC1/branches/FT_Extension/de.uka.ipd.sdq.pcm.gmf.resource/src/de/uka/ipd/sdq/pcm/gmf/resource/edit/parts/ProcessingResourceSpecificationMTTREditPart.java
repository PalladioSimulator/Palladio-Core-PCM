 ...
 * @generated
 */
public class ProcessingResourceSpecificationMTTREditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ProcessingResourceSpecificationMTTREditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ProcessingResourceSpecification_3001,
					getParserElement(), PalladioComponentModelVisualIDRegistry
							.getType(de.uka.ipd.sdq.pcm.gmf.resource.edit.parts.ProcessingResourceSpecificationMTTREditPart.VISUAL_ID));
		}
		return parser;
	}

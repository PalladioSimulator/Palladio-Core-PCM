...
public class PalladioComponentModelPaletteFactory {
	...
	private ToolEntry createResourceContainer1CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.ResourceContainer1CreationTool_title, Messages.ResourceContainer1CreationTool_desc, types);
		entry.setId("createResourceContainer1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(PalladioComponentModelElementTypes.getImageDescriptor(PalladioComponentModelElementTypes.ResourceContainer_2001));
	...
	private ToolEntry createLinkingResource2CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.LinkingResource2CreationTool_title, Messages.LinkingResource2CreationTool_desc, types);
		entry.setId("createLinkingResource2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(PalladioComponentModelElementTypes.getImageDescriptor(PalladioComponentModelElementTypes.LinkingResource_2003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createProcessingResourceSpecification3CreationTool() {
		List/*<IElementType>*/types = new ArrayList/*<IElementType>*/(1);
		types.add(PalladioComponentModelElementTypes.ProcessingResourceSpecification_3001);
		...
		entry.setSmallIcon(PalladioComponentModelElementTypes.getImageDescriptor(PalladioComponentModelElementTypes.ProcessingResourceSpecification_3001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createConnection4CreationTool() {
		List/*<IElementType>*/types = new ArrayList/*<IElementType>*/(1);
		types.add(PalladioComponentModelElementTypes.LinkingResourceConnectedResourceContainers_4003);
		LinkToolEntry entry = new LinkToolEntry(Messages.Connection4CreationTool_title, Messages.Connection4CreationTool_desc, types);
		entry.setId("createConnection4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(PalladioComponentModelDiagramEditorPlugin.findImageDescriptor("/de.uka.ipd.sdq.pcm.edit/icons/full/obj16/CommunicationLink.gif")); //$NON-NLS-1$
		entry.setLargeIcon(PalladioComponentModelDiagramEditorPlugin.findImageDescriptor("/de.uka.ipd.sdq.pcm.edit/icons/full/obj16/CommunicationLink.gif")); //$NON-NLS-1$
		return entry;
	}

 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.impl.RepositoryImpl#getFailuretype <em>Failuretype</em>}</li>
...
public class RepositoryImpl extends EntityImpl implements Repository {
	...
	/**
	 * The cached value of the '{@link #getFailuretype() <em>Failuretype</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFailuretype()
	 * @generated
	...
	public EList<FailureType> getFailuretype() {
		if (failuretype == null) {
			failuretype = new EObjectContainmentWithInverseEList<FailureType>(FailureType.class, this, RepositoryPackage.REPOSITORY__FAILURETYPE, RepositoryPackage.FAILURE_TYPE__REPOSITORY);
		}
		return failuretype;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RepositoryPackage.REPOSITORY__FAILURETYPE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getFailuretype()).basicAdd(otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RepositoryPackage.REPOSITORY__FAILURETYPE:
				return ((InternalEList<?>)getFailuretype()).basicRemove(otherEnd, msgs);
			case RepositoryPackage.REPOSITORY__DATATYPES_REPOSITORY:

...
public class RepositoryValidator extends EObjectValidator {
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Exactly One Type' of 'Environment Failure Type'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int ENVIRONMENT_FAILURE_TYPE__EXACTLY_ONE_TYPE = 14;
	...
	public boolean validateEnvironmentFailureType(EnvironmentFailureType environmentFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateEnvironmentFailureType_ExactlyOneType(environmentFailureType, diagnostics, context);
		return result;
	}

	/**
	 * Validates the ExactlyOneType constraint of '<em>Environment Failure Type</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateEnvironmentFailureType_ExactlyOneType(EnvironmentFailureType environmentFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return environmentFailureType.ExactlyOneType(diagnostics, context);
	}

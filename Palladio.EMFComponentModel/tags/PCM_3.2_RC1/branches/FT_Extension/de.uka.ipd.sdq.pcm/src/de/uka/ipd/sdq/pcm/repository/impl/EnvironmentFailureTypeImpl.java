...
public class EnvironmentFailureTypeImpl extends StopFailureTypeImpl implements EnvironmentFailureType {
	...
	/**
	 * The cached OCL expression body for the '{@link #ExactlyOneType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Exactly One Type</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #ExactlyOneType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String EXACTLY_ONE_TYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.processingresourcetype <> null";

	/**
	 * The cached OCL invariant for the '{@link #ExactlyOneType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Exactly One Type</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #ExactlyOneType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static Constraint EXACTLY_ONE_TYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	 ...
	 * @generated
	 */
	public boolean ExactlyOneType(DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (EXACTLY_ONE_TYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(RepositoryPackage.Literals.ENVIRONMENT_FAILURE_TYPE);
			try {
				EXACTLY_ONE_TYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(EXACTLY_ONE_TYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(EXACTLY_ONE_TYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(this)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 RepositoryValidator.DIAGNOSTIC_SOURCE,
						 RepositoryValidator.ENVIRONMENT_FAILURE_TYPE__EXACTLY_ONE_TYPE,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ExactlyOneType", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}

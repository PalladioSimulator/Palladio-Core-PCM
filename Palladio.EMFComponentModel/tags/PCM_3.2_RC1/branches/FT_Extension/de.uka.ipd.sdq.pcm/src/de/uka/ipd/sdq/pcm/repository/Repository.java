 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.Repository#getFailuretype <em>Failuretype</em>}</li>
...
public interface Repository extends Entity {
	...
	/**
	 * Returns the value of the '<em><b>Failuretype</b></em>' containment reference list.
	 * The list contents are of type {@link de.uka.ipd.sdq.pcm.repository.FailureType}.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.repository.FailureType#getRepository <em>Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Failuretype</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Failuretype</em>' containment reference list.
	 * @see de.uka.ipd.sdq.pcm.repository.RepositoryPackage#getRepository_Failuretype()

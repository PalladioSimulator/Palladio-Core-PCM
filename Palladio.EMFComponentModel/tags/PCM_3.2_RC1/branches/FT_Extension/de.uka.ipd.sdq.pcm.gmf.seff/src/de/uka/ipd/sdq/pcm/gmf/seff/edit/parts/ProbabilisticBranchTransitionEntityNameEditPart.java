 ...
 * @generated
 */
public class ProbabilisticBranchTransitionEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ProbabilisticBranchTransitionEntityNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ProbabilisticBranchTransition_3010, getParserElement(),
					PalladioComponentModelVisualIDRegistry
							.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ProbabilisticBranchTransitionEntityNameEditPart.VISUAL_ID));
		}
		return parser;
	}

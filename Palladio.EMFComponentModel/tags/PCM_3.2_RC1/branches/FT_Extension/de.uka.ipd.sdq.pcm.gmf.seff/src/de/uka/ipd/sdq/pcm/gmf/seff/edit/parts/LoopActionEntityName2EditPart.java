 ...
 * @generated
 */
public class LoopActionEntityName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.LoopAction_3006, getParserElement(),
					PalladioComponentModelVisualIDRegistry.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.LoopActionEntityName2EditPart.VISUAL_ID));
		}
		return parser;
	}

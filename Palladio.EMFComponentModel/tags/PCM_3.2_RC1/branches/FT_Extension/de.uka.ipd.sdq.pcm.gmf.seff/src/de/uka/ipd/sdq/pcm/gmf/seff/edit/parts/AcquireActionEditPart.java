...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.policies.AcquireActionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AcquireActionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AcquireActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AcquireActionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AcquireActionEntityNameEditPart) {
			((AcquireActionEntityNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAquireNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(AcquireActionEntityNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.AcquireActionEditPart) {
			types.add(PalladioComponentModelElementTypes.AbstractActionSuccessor_AbstractAction_4001);
		}

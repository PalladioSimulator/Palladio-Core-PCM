...
public class CollectionIteratorAction2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CollectionIteratorAction2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CollectionIteratorAction2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel6EditPart) {
			((WrappingLabel6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCollectionIteratorParameterLabelFigure());
			return true;
		}
		if (childEditPart instanceof CollectionIteratorActionEntityName2EditPart) {
			((CollectionIteratorActionEntityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCollectionIteratorNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.CollectionIteratorAction2EditPart) {
			types.add(PalladioComponentModelElementTypes.AbstractActionSuccessor_AbstractAction_4001);
		}
	...
	public class CollectionIteratorFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			collectionIteratorStereotype0.setText("<<CollectionIteratorAction>>");
			collectionIteratorStereotype0.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode().DPtoLP(0), getMapMode().DPtoLP(2), getMapMode()
					.DPtoLP(0)));
			...
			this.add(collectionIteratorStereotype0, constraintCollectionIteratorStereotype0);

			fFigureCollectionIteratorNameLabelFigure = new WrappingLabel();
			fFigureCollectionIteratorNameLabelFigure.setText("myLoop");
			fFigureCollectionIteratorNameLabelFigure.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode().DPtoLP(0), getMapMode().DPtoLP(2),
					getMapMode().DPtoLP(0)));
			...
			this.add(fFigureCollectionIteratorNameLabelFigure, constraintFFigureCollectionIteratorNameLabelFigure);

			fFigureCollectionIteratorParameterLabelFigure = new WrappingLabel();
			fFigureCollectionIteratorParameterLabelFigure.setText("");
			fFigureCollectionIteratorParameterLabelFigure.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode().DPtoLP(0), getMapMode().DPtoLP(2),
					getMapMode().DPtoLP(0)));
			...
			this.add(fFigureCollectionIteratorParameterLabelFigure, constraintFFigureCollectionIteratorParameterLabelFigure);

...
public class PalladioComponentModelBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = PalladioComponentModelElementTypes.getElementType(getVisualID(request));
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateAbstractActionSuccessor_AbstractAction_4001(AbstractAction source, AbstractAction target) {
			if (source != null) {
		 ...
		 * @generated
		 */
		public static boolean canExistAbstractActionSuccessor_AbstractAction_4001(AbstractAction source, AbstractAction target) {
			try {
				if (source == null) {
					return true;
				}
				if (AbstractActionSuccessor_AbstractAction_4001_SourceExpression == null) {
					...
					AbstractActionSuccessor_AbstractAction_4001_SourceExpression = PalladioComponentModelOCLFactory.getExpression(
							"not self.oclIsTypeOf(StopAction)", SeffPackage.eINSTANCE.getAbstractAction(), env); //$NON-NLS-1$
				}
				Object sourceVal = AbstractActionSuccessor_AbstractAction_4001_SourceExpression.evaluate(source, Collections.singletonMap(OPPOSITE_END_VAR,
						target));
				...
				if (AbstractActionSuccessor_AbstractAction_4001_TargetExpression == null) {
					Map env = Collections.singletonMap(OPPOSITE_END_VAR, SeffPackage.eINSTANCE.getAbstractAction());
					AbstractActionSuccessor_AbstractAction_4001_TargetExpression = PalladioComponentModelOCLFactory.getExpression(
				...
				Object targetVal = AbstractActionSuccessor_AbstractAction_4001_TargetExpression.evaluate(target, Collections.singletonMap(OPPOSITE_END_VAR,
						source));
				...
				PalladioComponentModelSeffDiagramEditorPlugin.getInstance().logError("Link constraint evaluation error", e); //$NON-NLS-1$
				return false;
			}
		}

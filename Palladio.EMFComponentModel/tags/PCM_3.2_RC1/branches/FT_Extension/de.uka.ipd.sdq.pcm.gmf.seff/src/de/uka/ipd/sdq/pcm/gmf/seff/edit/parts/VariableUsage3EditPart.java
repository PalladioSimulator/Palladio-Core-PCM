 ...
 * @generated
 */
public class VariableUsage3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public VariableUsage3EditPart(View view) {
		super(view);
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel7EditPart) {
			((WrappingLabel7EditPart) childEditPart).setLabel(getPrimaryShape().getFigureVariableUsageReferenceLabelFigure());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(WrappingLabel7EditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == PalladioComponentModelElementTypes.VariableCharacterisation_3037) {
				return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(VariableUsageVariableCharacterisation3EditPart.VISUAL_ID));
			}
		}

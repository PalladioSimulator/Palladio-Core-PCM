...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.policies.VariableCharacterisation2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class VariableCharacterisation2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public VariableCharacterisation2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new VariableCharacterisation2ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.VariableCharacterisation_3035, getParserElement(),
					PalladioComponentModelVisualIDRegistry.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.VariableCharacterisation2EditPart.VISUAL_ID));
		}
		return parser;
	}

...
public class BranchAction2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BranchActionEntityName2EditPart) {
			((BranchActionEntityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureBranchNameLabelFigure());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(BranchActionEntityName2EditPart.VISUAL_ID));
	}

 ...
 * @generated
 */
public class RequiredRoleEntityNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(PalladioComponentModelVisualIDRegistry
				.getType(RequiredRoleEntityNameEditPart.VISUAL_ID), new Point(
				0, 0));
	}
	 ...
	 * @generated
	 */
	public RequiredRoleEntityNameEditPart(View view) {
		super(view);
	}

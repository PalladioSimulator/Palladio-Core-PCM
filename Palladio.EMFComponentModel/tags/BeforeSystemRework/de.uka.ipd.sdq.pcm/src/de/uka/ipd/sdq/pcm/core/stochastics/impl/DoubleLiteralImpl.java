 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.core.stochastics.impl.DoubleLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoubleLiteralImpl extends NumericLiteralImpl implements DoubleLiteral {
	...
	protected EClass eStaticClass() {
		return StochasticsPackage.Literals.DOUBLE_LITERAL;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StochasticsPackage.DOUBLE_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StochasticsPackage.DOUBLE_LITERAL__VALUE:

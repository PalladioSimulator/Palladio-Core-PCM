 ...
 * @generated
 */
public class AllocationContextEntityNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AllocationContextEntityNameEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.AllocationContext_2001;
					}

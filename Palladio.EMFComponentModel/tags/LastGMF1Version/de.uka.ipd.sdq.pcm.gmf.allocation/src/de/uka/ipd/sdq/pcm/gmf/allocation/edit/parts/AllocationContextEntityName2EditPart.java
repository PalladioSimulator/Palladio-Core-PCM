...
import de.uka.ipd.sdq.pcm.gmf.allocation.edit.policies.PcmTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AllocationContextEntityName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AllocationContextEntityName2EditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		AllocationContext context = (AllocationContext)resolveSemanticElement();
		ImageDescriptor descriptor = PcmDiagramEditorPlugin.getInstance()
				.getItemImageDescriptor(context.getAssemblyContext_AllocationContext().getEncapsulatedComponent_ChildComponentContext());
		if (descriptor == null) {
...
//		}
		AllocationContext context = (AllocationContext)resolveSemanticElement();
		text = context.getAssemblyContext_AllocationContext().getEntityName();
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.AllocationContext_1002;
					}

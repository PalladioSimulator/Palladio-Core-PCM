 ...
 * @generated
 */
public class AllocationContext2ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.uka.ipd.sdq.pcm.gmf.allocation.edit.parts.AllocationContext2EditPart.VISUAL_ID);

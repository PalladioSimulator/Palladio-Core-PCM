 ...
 * @generated
 */
public class SystemRequiredRoleLabelEditPart extends PcmExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(PcmVisualIDRegistry
				.getType(SystemRequiredRoleLabelEditPart.VISUAL_ID), new Point(
				0, 0));
	}
	 ...
	 * @generated
	 */
	public SystemRequiredRoleLabelEditPart(View view) {
		super(view);
	}

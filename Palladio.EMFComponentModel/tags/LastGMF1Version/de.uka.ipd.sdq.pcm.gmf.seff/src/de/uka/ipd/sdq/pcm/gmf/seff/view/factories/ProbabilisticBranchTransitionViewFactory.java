 ...
 * @generated
 */
public class ProbabilisticBranchTransitionViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ProbabilisticBranchTransitionEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						PcmVisualIDRegistry
								.getType(ProbabilisticBranchTransitionBehaviourCompartmentEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
	}

 ...
 * @generated
 */
public class InternalActionResourceDemandResourceDemandingActionCompartment2ViewFactory
		extends ListCompartmentViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = PcmVisualIDRegistry
					.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.InternalActionResourceDemandResourceDemandingActionCompartment2EditPart.VISUAL_ID);

...
public class VariableUsageImpl extends EObjectImpl implements VariableUsage {
	 ...
	 * @ordered
	 */
	protected EList variableCharacterisation_VariableUsage = null;
	 ...
	 * @generated
	 */
	public EList getVariableCharacterisation_VariableUsage() {
		if (variableCharacterisation_VariableUsage == null) {
			variableCharacterisation_VariableUsage = new EObjectContainmentEList(VariableCharacterisation.class, this, ParameterPackage.VARIABLE_USAGE__VARIABLE_CHARACTERISATION_VARIABLE_USAGE);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ParameterPackage.VARIABLE_USAGE__VARIABLE_CHARACTERISATION_VARIABLE_USAGE:
				...
				getVariableCharacterisation_VariableUsage().addAll((Collection)newValue);
				return;
			case ParameterPackage.VARIABLE_USAGE__NAMED_REFERENCE_VARIABLE_USAGE:

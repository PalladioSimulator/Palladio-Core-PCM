...
public class ExternalCallActionImpl extends AbstractActionImpl implements ExternalCallAction {
	 ...
	 * @ordered
	 */
	protected EList outputVariableUsage_ExternalCallAction = null;
	 ...
	 * @generated
	 */
	public EList getOutputVariableUsage_ExternalCallAction() {
		if (outputVariableUsage_ExternalCallAction == null) {
			outputVariableUsage_ExternalCallAction = new EObjectContainmentEList(VariableUsage.class, this, SeffPackage.EXTERNAL_CALL_ACTION__OUTPUT_VARIABLE_USAGE_EXTERNAL_CALL_ACTION);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SeffPackage.EXTERNAL_CALL_ACTION__OUTPUT_VARIABLE_USAGE_EXTERNAL_CALL_ACTION:
				...
				getOutputVariableUsage_ExternalCallAction().addAll((Collection)newValue);
				return;
		}

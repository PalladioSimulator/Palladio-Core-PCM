 ...
 * @generated
 */
public class BasicComponentEntityNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public BasicComponentEntityNameEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.BasicComponent_1002;
					}

...
import de.uka.ipd.sdq.pcm.gmf.repository.edit.policies.CompleteComponentTypeCanonicalEditPolicy;
import de.uka.ipd.sdq.pcm.gmf.repository.edit.policies.CompleteComponentTypeGraphicalNodeEditPolicy;
...
public class CompleteComponentTypeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new CompleteComponentTypeGraphicalNodeEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CompleteComponentTypeCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		CompleteComponentTypeFigure figure = new CompleteComponentTypeFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompleteComponentTypeEntityNameEditPart) {
			((CompleteComponentTypeEntityNameEditPart) childEditPart)
	 ...
	 * @generated
	 */
	public class CompleteComponentTypeFigure extends
		...
		private void createContents() {
			...
			setFigureCompleteComponentTypeLabelFigure(fig_0);
		 ...
		 * @generated
		 */
		private org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel fCompleteComponentTypeLabelFigure;

		/**
		 * @generated
		 */
		public org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel getFigureCompleteComponentTypeLabelFigure() {
		 ...
		 * @generated
		 */
		private void setFigureCompleteComponentTypeLabelFigure(

 ...
 * @generated
 */
public class SystemRequiredRoleEntityNameEditPart extends
	 ...
	 * @generated
	 */
	public SystemRequiredRoleEntityNameEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.SystemRequiredRole_1003;
					}
	...
	protected IFigure createFigurePrim() {
		return new SysReqRoleLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SysReqRoleLabelFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public SysReqRoleLabelFigure() {

 ...
 * @generated
 */
public class SystemProvidedRoleEntityNameEditPart extends
		PcmExtNodeLabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(PcmVisualIDRegistry
	 ...
	 * @generated
	 */
	public SystemProvidedRoleEntityNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		ImageDescriptor descriptor = SystemDiagramEditorPlugin.getInstance()
	...
	protected String getLabelText() {
		...
		//		}
		SystemProvidedRole reqRole = (SystemProvidedRole) getParserElement();
		if (reqRole.getProvidedInterface__ProvidedRole() != null)
			text = reqRole.getProvidedInterface__ProvidedRole().getEntityName();
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof PcmTextSelectionEditPolicy) {
			((PcmTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.SystemProvidedRole_1002;
					}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), PcmEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new SysProvRoleLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SysProvRoleLabelFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public SysProvRoleLabelFigure() {

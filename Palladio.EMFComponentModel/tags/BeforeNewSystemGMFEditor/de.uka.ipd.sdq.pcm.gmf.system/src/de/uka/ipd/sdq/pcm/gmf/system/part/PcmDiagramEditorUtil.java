...
public class PcmDiagramEditorUtil extends IDEEditorUtil {
	...
	public static final IFile createNewDiagramFile(
		...
		IPath modelFileRelativePath = diagramFile.getFullPath()
				.removeFileExtension().addFileExtension("system"); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static de.uka.ipd.sdq.pcm.system.System createInitialModel() {
	 ...
	 * @generated
	 */
	private static EObject createInitialRoot(
			de.uka.ipd.sdq.pcm.system.System model) {
		return model;
	}
}

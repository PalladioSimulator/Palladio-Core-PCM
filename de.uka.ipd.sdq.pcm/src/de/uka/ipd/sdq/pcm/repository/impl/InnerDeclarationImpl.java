 ...
 * @generated
 */
public class InnerDeclarationImpl extends NamedElementImpl implements
		InnerDeclaration {
	/**
	...
	public DataType getDatatype_InnerDeclaration() {
		if (datatype_InnerDeclaration != null
				&& ((EObject) datatype_InnerDeclaration).eIsProxy()) {
	 ...
	 */
	@Override
	public void setDatatype_InnerDeclaration(
			DataType newDatatype_InnerDeclaration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					RepositoryPackage.INNER_DECLARATION__DATATYPE_INNER_DECLARATION,
					oldDatatype_InnerDeclaration, datatype_InnerDeclaration));
	}
	...
	public CompositeDataType getCompositeDataType_InnerDeclaration() {
		if (eContainerFeatureID() != RepositoryPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION)
			return null;
	...
	public NotificationChain basicSetCompositeDataType_InnerDeclaration(
			CompositeDataType newCompositeDataType_InnerDeclaration,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newCompositeDataType_InnerDeclaration,
	 ...
	 */
	@Override
	public void setCompositeDataType_InnerDeclaration(
			CompositeDataType newCompositeDataType_InnerDeclaration) {
		if (newCompositeDataType_InnerDeclaration != eInternalContainer()
				|| (eContainerFeatureID() != RepositoryPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION && newCompositeDataType_InnerDeclaration != null)) {
			if (EcoreUtil.isAncestor(this,
					(EObject) newCompositeDataType_InnerDeclaration))
			...
			if (newCompositeDataType_InnerDeclaration != null)
				msgs = ((InternalEObject) newCompositeDataType_InnerDeclaration)
						.eInverseAdd(
								this,
								RepositoryPackage.COMPOSITE_DATA_TYPE__INNER_DECLARATION_COMPOSITE_DATA_TYPE,
								CompositeDataType.class, msgs);
			msgs = basicSetCompositeDataType_InnerDeclaration(
					newCompositeDataType_InnerDeclaration, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case RepositoryPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetCompositeDataType_InnerDeclaration(
					(CompositeDataType) otherEnd, msgs);
		}

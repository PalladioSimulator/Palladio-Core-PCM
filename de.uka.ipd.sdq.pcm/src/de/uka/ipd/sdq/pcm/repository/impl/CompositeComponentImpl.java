 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.impl.CompositeComponentImpl#getComponentParameter_ImplementationComponentType <em>Component Parameter Implementation Component Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeComponentImpl extends ComposedProvidingRequiringEntityImpl implements CompositeComponent {
	...
	public EList<Variable> getComponentParameter_ImplementationComponentType() {
		if (componentParameter_ImplementationComponentType == null) {
			componentParameter_ImplementationComponentType = new EObjectContainmentWithInverseEList<Variable>(Variable.class, this, RepositoryPackage.COMPOSITE_COMPONENT__COMPONENT_PARAMETER_IMPLEMENTATION_COMPONENT_TYPE, ParameterPackage.VARIABLE__IMPLEMENTATION_COMPONENT_TYPE_VARIABLE);
		}

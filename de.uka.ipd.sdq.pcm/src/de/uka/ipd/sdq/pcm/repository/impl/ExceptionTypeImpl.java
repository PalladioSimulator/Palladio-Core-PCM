 ...
 * @generated
 */
public class ExceptionTypeImpl extends EStereotypableObjectImpl implements
		ExceptionType {
	/**
	...
	public void setExceptionName(String newExceptionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RepositoryPackage.EXCEPTION_TYPE__EXCEPTION_NAME,
	...
	public void setExceptionMessage(String newExceptionMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RepositoryPackage.EXCEPTION_TYPE__EXCEPTION_MESSAGE,
	...
	public boolean eIsSet(int featureID) {
		...
		case RepositoryPackage.EXCEPTION_TYPE__EXCEPTION_MESSAGE:
			return EXCEPTION_MESSAGE_EDEFAULT == null ? exceptionMessage != null
					: !EXCEPTION_MESSAGE_EDEFAULT.equals(exceptionMessage);
		}

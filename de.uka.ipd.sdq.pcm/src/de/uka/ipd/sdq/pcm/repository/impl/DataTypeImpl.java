 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.impl.DataTypeImpl#getCharacterisationDefinitions_Datatype <em>Characterisation Definitions Datatype</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DataTypeImpl extends EntityImpl implements DataType {
	...
	/**
	 * The cached value of the '{@link #getCharacterisationDefinitions_Datatype() <em>Characterisation Definitions Datatype</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCharacterisationDefinitions_Datatype()
	 * @generated
	 * @ordered
	 */
	protected EList<CharacterisationDefinition> characterisationDefinitions_Datatype;
	 ...
	 * @generated
	 */
	public EList<CharacterisationDefinition> getCharacterisationDefinitions_Datatype() {
		if (characterisationDefinitions_Datatype == null) {
			characterisationDefinitions_Datatype = new EObjectResolvingEList<CharacterisationDefinition>(CharacterisationDefinition.class, this, RepositoryPackage.DATA_TYPE__CHARACTERISATION_DEFINITIONS_DATATYPE);
		}
		return characterisationDefinitions_Datatype;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RepositoryPackage.DATA_TYPE__CHARACTERISATION_DEFINITIONS_DATATYPE:
				return getCharacterisationDefinitions_Datatype();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case RepositoryPackage.DATA_TYPE__REPOSITORY_DATA_TYPE:
				...
				return;
			case RepositoryPackage.DATA_TYPE__CHARACTERISATION_DEFINITIONS_DATATYPE:
				getCharacterisationDefinitions_Datatype().clear();
				getCharacterisationDefinitions_Datatype().addAll((Collection<? extends CharacterisationDefinition>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case RepositoryPackage.DATA_TYPE__CHARACTERISATION_DEFINITIONS_DATATYPE:
				return characterisationDefinitions_Datatype != null && !characterisationDefinitions_Datatype.isEmpty();
		}

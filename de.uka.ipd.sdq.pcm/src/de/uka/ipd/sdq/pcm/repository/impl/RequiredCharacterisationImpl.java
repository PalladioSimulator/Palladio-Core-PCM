 ...
 * @generated
 */
public class RequiredCharacterisationImpl extends EStereotypableObjectImpl
		implements RequiredCharacterisation {
	/**
	...
	public void setType(VariableCharacterisationType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RepositoryPackage.REQUIRED_CHARACTERISATION__TYPE, oldType,
					type));
	}
			...
			if (parameter != oldParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							RepositoryPackage.REQUIRED_CHARACTERISATION__PARAMETER,
	...
	public NotificationChain basicSetInterface_RequiredCharacterisation(
			Interface newInterface_RequiredCharacterisation,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newInterface_RequiredCharacterisation,
	 ...
	 */
	@Override
	public void setInterface_RequiredCharacterisation(
			Interface newInterface_RequiredCharacterisation) {
		if (newInterface_RequiredCharacterisation != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newInterface_RequiredCharacterisation))
			...
			if (newInterface_RequiredCharacterisation != null)
				msgs = ((InternalEObject) newInterface_RequiredCharacterisation)
						.eInverseAdd(
								this,
								RepositoryPackage.INTERFACE__REQUIRED_CHARACTERISATIONS,
								Interface.class, msgs);
			msgs = basicSetInterface_RequiredCharacterisation(
					newInterface_RequiredCharacterisation, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case RepositoryPackage.REQUIRED_CHARACTERISATION__INTERFACE_REQUIRED_CHARACTERISATION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetInterface_RequiredCharacterisation(
					(Interface) otherEnd, msgs);
		}

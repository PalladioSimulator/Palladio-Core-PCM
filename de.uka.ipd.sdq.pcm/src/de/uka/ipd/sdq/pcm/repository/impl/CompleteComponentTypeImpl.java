 ...
 * @generated
 */
public class CompleteComponentTypeImpl extends RepositoryComponentImpl
		implements CompleteComponentType {
	/**
	 ...
	 */
	@Override
	public boolean providedInterfacesHaveToConformToProvidedType2(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV
				.createQuery(
						PROVIDED_INTERFACES_HAVE_TO_CONFORM_TO_PROVIDED_TYPE2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
	...
	public void eSet(int featureID, Object newValue) {
		...
		case RepositoryPackage.COMPLETE_COMPONENT_TYPE__PARENT_PROVIDES_COMPONENT_TYPES:
			...
			getParentProvidesComponentTypes().addAll(
					(Collection<? extends ProvidesComponentType>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case RepositoryPackage.COMPLETE_COMPONENT_TYPE__PARENT_PROVIDES_COMPONENT_TYPES:
			return parentProvidesComponentTypes != null
					&& !parentProvidesComponentTypes.isEmpty();
		}

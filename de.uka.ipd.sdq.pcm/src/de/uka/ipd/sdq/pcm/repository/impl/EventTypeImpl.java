...
public class EventTypeImpl extends SignatureImpl implements EventType {
	...
	public EventGroup getEventGroup__EventType() {
		if (eContainerFeatureID() != RepositoryPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEventGroup__EventType(
			EventGroup newEventGroup__EventType, NotificationChain msgs) {
	...
	public void setEventGroup__EventType(EventGroup newEventGroup__EventType) {
		if (newEventGroup__EventType != eInternalContainer()
				|| (eContainerFeatureID() != RepositoryPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE && newEventGroup__EventType != null)) {
			...
			if (newEventGroup__EventType != null)
				msgs = ((InternalEObject) newEventGroup__EventType)
						.eInverseAdd(
								this,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					...
					newEventGroup__EventType, newEventGroup__EventType));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetParameter__EventType(
			Parameter newParameter__EventType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldParameter__EventType, newParameter__EventType);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setParameter__EventType(Parameter newParameter__EventType) {
		if (newParameter__EventType != parameter__EventType) {
			...
			if (parameter__EventType != null)
				msgs = ((InternalEObject) parameter__EventType).eInverseRemove(
						this,
						RepositoryPackage.PARAMETER__EVENT_TYPE_PARAMETER,
						Parameter.class, msgs);
			if (newParameter__EventType != null)
				msgs = ((InternalEObject) newParameter__EventType).eInverseAdd(
						this,
						RepositoryPackage.PARAMETER__EVENT_TYPE_PARAMETER,
						Parameter.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RepositoryPackage.EVENT_TYPE__PARAMETER_EVENT_TYPE,
					newParameter__EventType, newParameter__EventType));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case RepositoryPackage.EVENT_TYPE__PARAMETER_EVENT_TYPE:
			if (parameter__EventType != null)
				msgs = ((InternalEObject) parameter__EventType)
						.eInverseRemove(
								this,

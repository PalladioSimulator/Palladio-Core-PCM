 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.Repository#getCharacterisationDefinitions <em>Characterisation Definitions</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Repository extends Entity {
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.repository.FailureType#getRepository_FailureType <em>Repository Failure Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Failure Types</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Failure Types</em>' containment reference list.
	 * @see de.uka.ipd.sdq.pcm.repository.RepositoryPackage#getRepository_FailureTypes()
	 * @see de.uka.ipd.sdq.pcm.repository.FailureType#getRepository_FailureType
	 * @model opposite="repository_FailureType" containment="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Characterisation Definitions</b></em>' containment reference list.
	 * The list contents are of type {@link de.uka.ipd.sdq.pcm.repository.CharacterisationDefinition}.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.repository.CharacterisationDefinition#getRepository_ChracterisationDefinition <em>Repository Chracterisation Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Characterisation Definitions</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Characterisation Definitions</em>' containment reference list.
	 * @see de.uka.ipd.sdq.pcm.repository.RepositoryPackage#getRepository_CharacterisationDefinitions()
	 * @see de.uka.ipd.sdq.pcm.repository.CharacterisationDefinition#getRepository_ChracterisationDefinition
	 * @model opposite="repository_ChracterisationDefinition" containment="true" ordered="false"
	 * @generated
	 */
	EList<CharacterisationDefinition> getCharacterisationDefinitions();

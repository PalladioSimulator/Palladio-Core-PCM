...
public interface OperationInterface extends Interface {
	 ...
	 * {@link de.uka.ipd.sdq.pcm.repository.OperationSignature}. It is bidirectional and its
	 * opposite is '
	 ...
	 * @generated
	 */
	boolean SignaturesHaveToBeUniqueForAnInterface(DiagnosticChain diagnostics,

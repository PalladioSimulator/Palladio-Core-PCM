...
public class SourceRoleImpl extends RequiredRoleImpl implements SourceRole {
	...
	public EventGroup getEventGroup__SourceRole() {
		if (eventGroup__SourceRole != null
				&& ((EObject) eventGroup__SourceRole).eIsProxy()) {
			...
			if (eventGroup__SourceRole != oldEventGroup__SourceRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							RepositoryPackage.SOURCE_ROLE__EVENT_GROUP_SOURCE_ROLE,
							oldEventGroup__SourceRole, eventGroup__SourceRole));
			}
		}

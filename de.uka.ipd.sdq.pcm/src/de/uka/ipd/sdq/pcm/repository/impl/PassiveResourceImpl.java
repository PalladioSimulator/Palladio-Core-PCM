...
public class PassiveResourceImpl extends EntityImpl implements PassiveResource {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCapacity_PassiveResource(
			PCMRandomVariable newCapacity_PassiveResource,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldCapacity_PassiveResource, newCapacity_PassiveResource);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setCapacity_PassiveResource(
		...
		if (newCapacity_PassiveResource != capacity_PassiveResource) {
			...
			if (newCapacity_PassiveResource != null)
				msgs = ((InternalEObject) newCapacity_PassiveResource)
						.eInverseAdd(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__PASSIVE_RESOURCE_CAPACITY_PCM_RANDOM_VARIABLE,
								PCMRandomVariable.class, msgs);
			msgs = basicSetCapacity_PassiveResource(
					newCapacity_PassiveResource, msgs);
			if (msgs != null)
				msgs.dispatch();
			...
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					RepositoryPackage.PASSIVE_RESOURCE__CAPACITY_PASSIVE_RESOURCE,
					newCapacity_PassiveResource, newCapacity_PassiveResource));
	}
	...
	public NotificationChain basicSetBasicComponent_PassiveResource(
			BasicComponent newBasicComponent_PassiveResource,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newBasicComponent_PassiveResource,
	 ...
	 */
	@Override
	public void setBasicComponent_PassiveResource(
			BasicComponent newBasicComponent_PassiveResource) {
		if (newBasicComponent_PassiveResource != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newBasicComponent_PassiveResource))
			...
			msgs = basicSetBasicComponent_PassiveResource(
					newBasicComponent_PassiveResource, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public ResourceTimeoutFailureType getResourceTimeoutFailureType__PassiveResource() {
		if (resourceTimeoutFailureType__PassiveResource != null
				&& ((EObject) resourceTimeoutFailureType__PassiveResource)
						.eIsProxy()) {
			...
			if (newResourceTimeoutFailureType__PassiveResource != null)
				msgs = ((InternalEObject) newResourceTimeoutFailureType__PassiveResource)
						.eInverseAdd(
								...
								ReliabilityPackage.RESOURCE_TIMEOUT_FAILURE_TYPE__PASSIVE_RESOURCE_RESOURCE_TIMEOUT_FAILURE_TYPE,
								ResourceTimeoutFailureType.class, msgs);
			msgs = basicSetResourceTimeoutFailureType__PassiveResource(
			...
			if (resourceTimeoutFailureType__PassiveResource != null)
				msgs = ((InternalEObject) resourceTimeoutFailureType__PassiveResource)
						.eInverseRemove(
								...
								ReliabilityPackage.RESOURCE_TIMEOUT_FAILURE_TYPE__PASSIVE_RESOURCE_RESOURCE_TIMEOUT_FAILURE_TYPE,
								ResourceTimeoutFailureType.class, msgs);
			return basicSetResourceTimeoutFailureType__PassiveResource(
					(ResourceTimeoutFailureType) otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case RepositoryPackage.PASSIVE_RESOURCE__RESOURCE_TIMEOUT_FAILURE_TYPE_PASSIVE_RESOURCE:
			return basicSetResourceTimeoutFailureType__PassiveResource(null,
					msgs);
		}

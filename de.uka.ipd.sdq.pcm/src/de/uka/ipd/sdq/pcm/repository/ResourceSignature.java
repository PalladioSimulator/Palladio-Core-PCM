 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.ResourceSignature#getParmeter__ResourceSignature <em>Parmeter Resource Signature</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ResourceSignature extends Signature {
	...
	/**
	 * Returns the value of the '<em><b>Parmeter Resource Signature</b></em>' containment reference.
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Parmeter Resource Signature</em>' containment reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Parmeter Resource Signature</em>' containment reference.
	 * @see #setParmeter__ResourceSignature(Variable)
	 * @see de.uka.ipd.sdq.pcm.repository.RepositoryPackage#getResourceSignature_Parmeter__ResourceSignature()
	 ...
	 * @generated
	 */
	Variable getParmeter__ResourceSignature();

	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.repository.ResourceSignature#getParmeter__ResourceSignature <em>Parmeter Resource Signature</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Parmeter Resource Signature</em>' containment reference.
	 * @see #getParmeter__ResourceSignature()
	 * @generated
	 */
	void setParmeter__ResourceSignature(Variable value);

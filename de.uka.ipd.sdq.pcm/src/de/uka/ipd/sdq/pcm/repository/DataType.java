 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.DataType#getCharacterisationDefinitions__Datatype <em>Characterisation Definitions Datatype</em>}</li>
...
public interface DataType extends Entity {
	...
	/**
	 * Returns the value of the '<em><b>Characterisation Definitions Datatype</b></em>' attribute list.
	 * The list contents are of type {@link de.uka.ipd.sdq.pcm.parameter.VariableCharacterisationType}.
	 * The literals are from the enumeration {@link de.uka.ipd.sdq.pcm.parameter.VariableCharacterisationType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Characterisation Definitions Datatype</em>' attribute list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Characterisation Definitions Datatype</em>' attribute list.
	 * @see de.uka.ipd.sdq.pcm.parameter.VariableCharacterisationType
	 * @see de.uka.ipd.sdq.pcm.repository.RepositoryPackage#getDataType_CharacterisationDefinitions__Datatype()
	 * @model ordered="false"
	 * @generated
	 */
	EList<VariableCharacterisationType> getCharacterisationDefinitions__Datatype();

...
public class ParameterImpl extends NamedElementImpl implements Parameter {
	...
	public void setParameterName(String parameterName) {
		super.setEntityName(parameterName);
	}
	...
	public void setModifier__Parameter(ParameterModifier newModifier__Parameter) {
		...
		modifier__Parameter = newModifier__Parameter == null ? MODIFIER_PARAMETER_EDEFAULT
				: newModifier__Parameter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RepositoryPackage.PARAMETER__MODIFIER_PARAMETER,
	...
	public NotificationChain basicSetOperationSignature__Parameter(
			OperationSignature newOperationSignature__Parameter,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newOperationSignature__Parameter,
	 ...
	 */
	@Override
	public void setOperationSignature__Parameter(
			OperationSignature newOperationSignature__Parameter) {
		if (newOperationSignature__Parameter != eInternalContainer()
			...
			if (newOperationSignature__Parameter != null)
				msgs = ((InternalEObject) newOperationSignature__Parameter)
						.eInverseAdd(
								this,
								RepositoryPackage.OPERATION_SIGNATURE__PARAMETERS_OPERATION_SIGNATURE,
								OperationSignature.class, msgs);
			msgs = basicSetOperationSignature__Parameter(
					newOperationSignature__Parameter, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public DataType getDataType__Parameter() {
		if (dataType__Parameter != null
				&& ((EObject) dataType__Parameter).eIsProxy()) {
			...
			if (dataType__Parameter != oldDataType__Parameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RepositoryPackage.PARAMETER__DATA_TYPE_PARAMETER,
	...
	public NotificationChain basicSetResourceSignature__Parameter(
			ResourceSignature newResourceSignature__Parameter,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newResourceSignature__Parameter,
	 ...
	 */
	@Override
	public void setResourceSignature__Parameter(
			ResourceSignature newResourceSignature__Parameter) {
		if (newResourceSignature__Parameter != eInternalContainer()
			...
			if (newResourceSignature__Parameter != null)
				msgs = ((InternalEObject) newResourceSignature__Parameter)
						.eInverseAdd(
								this,
								ResourcetypePackage.RESOURCE_SIGNATURE__PARAMETER_RESOURCE_SIGNATURE,
								ResourceSignature.class, msgs);
			msgs = basicSetResourceSignature__Parameter(
					newResourceSignature__Parameter, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
	...
	public NotificationChain basicSetInfrastructureSignature__Parameter(
			InfrastructureSignature newInfrastructureSignature__Parameter,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newInfrastructureSignature__Parameter,
	...
	public void setInfrastructureSignature__Parameter(
		...
		if (newInfrastructureSignature__Parameter != eInternalContainer()
			...
			if (newInfrastructureSignature__Parameter != null)
				msgs = ((InternalEObject) newInfrastructureSignature__Parameter)
						.eInverseAdd(
								this,
								RepositoryPackage.INFRASTRUCTURE_SIGNATURE__PARAMETERS_INFRASTRUCTURE_SIGNATURE,
								InfrastructureSignature.class, msgs);
			msgs = basicSetInfrastructureSignature__Parameter(
					newInfrastructureSignature__Parameter, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEventType__Parameter(
			EventType newEventType__Parameter, NotificationChain msgs) {
	...
	public void setEventType__Parameter(EventType newEventType__Parameter) {
		if (newEventType__Parameter != eInternalContainer()
			...
			if (newEventType__Parameter != null)
				msgs = ((InternalEObject) newEventType__Parameter).eInverseAdd(
						this,
						RepositoryPackage.EVENT_TYPE__PARAMETER_EVENT_TYPE,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RepositoryPackage.PARAMETER__EVENT_TYPE_PARAMETER,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case RepositoryPackage.PARAMETER__INFRASTRUCTURE_SIGNATURE_PARAMETER:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetInfrastructureSignature__Parameter(
					(InfrastructureSignature) otherEnd, msgs);
		case RepositoryPackage.PARAMETER__OPERATION_SIGNATURE_PARAMETER:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetOperationSignature__Parameter(
					(OperationSignature) otherEnd, msgs);
		...
		case RepositoryPackage.PARAMETER__RESOURCE_SIGNATURE_PARAMETER:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetResourceSignature__Parameter(
					(ResourceSignature) otherEnd, msgs);
		}

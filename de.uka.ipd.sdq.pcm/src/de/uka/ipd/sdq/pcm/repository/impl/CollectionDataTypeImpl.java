 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.impl.CollectionDataTypeImpl#getRepository__DataType <em>Repository Data Type</em>}</li>
 ...
 * @generated
 */
public class CollectionDataTypeImpl extends EntityImpl implements
		CollectionDataType {
	/**
	...
	public NotificationChain basicSetRepository__DataType(
		...
		msgs = eBasicSetContainer((InternalEObject) newRepository__DataType,
				RepositoryPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE,
				msgs);
		return msgs;
	}
	...
	public DataType getInnerType_CollectionDataType() {
		if (innerType_CollectionDataType != null
				&& ((EObject) innerType_CollectionDataType).eIsProxy()) {
			...
			if (innerType_CollectionDataType != oldInnerType_CollectionDataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldInnerType_CollectionDataType,
	 ...
	 */
	@Override
	public void setInnerType_CollectionDataType(
			DataType newInnerType_CollectionDataType) {

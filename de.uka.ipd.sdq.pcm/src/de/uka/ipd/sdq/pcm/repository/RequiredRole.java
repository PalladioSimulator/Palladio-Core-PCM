 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.RequiredRole#getRequiringEntity__RequiredRole <em>Requiring Entity Required Role</em>}</li>
 * </ul>
 * </p>
 *
...
public interface RequiredRole extends Role {
	 ...
	 * @see #setRequiringEntity__RequiredRole(InterfaceRequiringEntity)
	 * @see de.uka.ipd.sdq.pcm.repository.RepositoryPackage#getRequiredRole_RequiringEntity__RequiredRole()
	 ...
	 * @generated
	 */
	InterfaceRequiringEntity getRequiringEntity__RequiredRole();

	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.repository.RequiredRole#getRequiringEntity__RequiredRole <em>Requiring Entity Required Role</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Requiring Entity Required Role</em>' container reference.
	 * @see #getRequiringEntity__RequiredRole()
	 * @generated
	 */
	void setRequiringEntity__RequiredRole(InterfaceRequiringEntity value);

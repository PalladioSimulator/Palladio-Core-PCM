...
public class RepositoryAdapterFactory extends AdapterFactoryImpl {
	...
	protected RepositorySwitch<Adapter> modelSwitch = new RepositorySwitch<Adapter>() {
		...
		public Adapter caseImplementationComponentType(
				ImplementationComponentType object) {
		...
		@Override
		public Adapter caseRequiredCharacterisation(
				RequiredCharacterisation object) {
		...
		@Override
		public Adapter caseInfrastructureSignature(
				InfrastructureSignature object) {
			return createInfrastructureSignatureAdapter();
		}

		@Override
		public Adapter caseInfrastructureInterface(
				InfrastructureInterface object) {
			return createInfrastructureInterfaceAdapter();
		}

		@Override
		public Adapter caseInfrastructureRequiredRole(
		...
		@Override
		public Adapter caseInfrastructureProvidedRole(
				InfrastructureProvidedRole object) {

...
public abstract class SignatureImpl extends EntityImpl implements Signature {
	...
	public EList<ExceptionType> getExceptions__Signature() {
		if (exceptions__Signature == null) {
			exceptions__Signature = new EObjectContainmentEList<ExceptionType>(
					ExceptionType.class, this,
	...
	public EList<FailureType> getFailureType() {
		if (failureType == null) {
			failureType = new EObjectResolvingEList<FailureType>(
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case RepositoryPackage.SIGNATURE__EXCEPTIONS_SIGNATURE:
			return ((InternalEList<?>) getExceptions__Signature()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case RepositoryPackage.SIGNATURE__EXCEPTIONS_SIGNATURE:
			...
			getExceptions__Signature().addAll(
					(Collection<? extends ExceptionType>) newValue);
			return;
		case RepositoryPackage.SIGNATURE__FAILURE_TYPE:
			getFailureType().clear();
			getFailureType().addAll(
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case RepositoryPackage.SIGNATURE__EXCEPTIONS_SIGNATURE:
			return exceptions__Signature != null
					&& !exceptions__Signature.isEmpty();
		case RepositoryPackage.SIGNATURE__FAILURE_TYPE:

...
public class EventGroupImpl extends InterfaceImpl implements EventGroup {
	...
	public EList<EventType> getEventTypes__EventGroup() {
		if (eventTypes__EventGroup == null) {
			eventTypes__EventGroup = new EObjectContainmentWithInverseEList<EventType>(
					EventType.class, this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case RepositoryPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getEventTypes__EventGroup())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case RepositoryPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP:
			return ((InternalEList<?>) getEventTypes__EventGroup())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case RepositoryPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP:
			...
			getEventTypes__EventGroup().addAll(
					(Collection<? extends EventType>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case RepositoryPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP:
			return eventTypes__EventGroup != null
					&& !eventTypes__EventGroup.isEmpty();
		}

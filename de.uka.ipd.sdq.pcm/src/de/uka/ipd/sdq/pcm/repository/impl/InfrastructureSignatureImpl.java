...
public class InfrastructureSignatureImpl extends SignatureImpl implements InfrastructureSignature {
	 ...
	 * @ordered
	 */
	protected EList<Variable> parameters__InfrastructureSignature;
	 ...
	 * @generated
	 */
	public EList<Variable> getParameters__InfrastructureSignature() {
		if (parameters__InfrastructureSignature == null) {
			parameters__InfrastructureSignature = new EObjectContainmentWithInverseEList<Variable>(Variable.class, this, RepositoryPackage.INFRASTRUCTURE_SIGNATURE__PARAMETERS_INFRASTRUCTURE_SIGNATURE, ParameterPackage.VARIABLE__INFRASTRUCTURE_SIGNATURE_VARIABLE);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RepositoryPackage.INFRASTRUCTURE_SIGNATURE__PARAMETERS_INFRASTRUCTURE_SIGNATURE:
				...
				getParameters__InfrastructureSignature().addAll((Collection<? extends Variable>)newValue);
				return;
		}

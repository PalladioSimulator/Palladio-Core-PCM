 ...
 * @generated
 */
public class OperationSignatureImpl extends SignatureImpl implements
		OperationSignature {
	/**
	...
	public NotificationChain basicSetInterface__OperationSignature(
			OperationInterface newInterface__OperationSignature,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newInterface__OperationSignature,
	 ...
	 */
	@Override
	public void setInterface__OperationSignature(
			OperationInterface newInterface__OperationSignature) {
		if (newInterface__OperationSignature != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newInterface__OperationSignature))
			...
			if (newInterface__OperationSignature != null)
				msgs = ((InternalEObject) newInterface__OperationSignature)
						.eInverseAdd(
								this,
								RepositoryPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE,
								OperationInterface.class, msgs);
			msgs = basicSetInterface__OperationSignature(
					newInterface__OperationSignature, msgs);
			if (msgs != null)
				msgs.dispatch();
	 ...
	 */
	@Override
	public boolean ParameterNamesHaveToBeUniqueForASignature(
		...
		if (!EOCL_ENV
				.createQuery(
						PARAMETER_NAMES_HAVE_TO_BE_UNIQUE_FOR_ASIGNATURE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
	...
	public DataType getReturnType__OperationSignature() {
		if (returnType__OperationSignature != null
				&& ((EObject) returnType__OperationSignature).eIsProxy()) {
			...
			if (returnType__OperationSignature != oldReturnType__OperationSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldReturnType__OperationSignature,
	 ...
	 */
	@Override
	public void setReturnType__OperationSignature(
			DataType newReturnType__OperationSignature) {
	...
	public EList<Parameter> getParameters__OperationSignature() {
		if (parameters__OperationSignature == null) {
			parameters__OperationSignature = new EObjectContainmentWithInverseEList<Parameter>(
					Parameter.class,
					this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case RepositoryPackage.OPERATION_SIGNATURE__INTERFACE_OPERATION_SIGNATURE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetInterface__OperationSignature(
					(OperationInterface) otherEnd, msgs);
		case RepositoryPackage.OPERATION_SIGNATURE__PARAMETERS_OPERATION_SIGNATURE:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getParameters__OperationSignature())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case RepositoryPackage.OPERATION_SIGNATURE__PARAMETERS_OPERATION_SIGNATURE:
			return ((InternalEList<?>) getParameters__OperationSignature())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case RepositoryPackage.OPERATION_SIGNATURE__PARAMETERS_OPERATION_SIGNATURE:
			...
			getParameters__OperationSignature().addAll(
	...
	public boolean eIsSet(int featureID) {
		...
		case RepositoryPackage.OPERATION_SIGNATURE__PARAMETERS_OPERATION_SIGNATURE:
			return parameters__OperationSignature != null
					&& !parameters__OperationSignature.isEmpty();
		case RepositoryPackage.OPERATION_SIGNATURE__RETURN_TYPE_OPERATION_SIGNATURE:

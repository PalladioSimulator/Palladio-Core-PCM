 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.repository.impl.OperationSignatureImpl#getReturntype__OperationSignature <em>Returntype Operation Signature</em>}</li>
...
public class OperationSignatureImpl extends SignatureImpl implements OperationSignature {
	 ...
	 * @ordered
	 */
	protected EList<Variable> parameters__OperationSignature;

	/**
	 * The cached value of the '{@link #getReturntype__OperationSignature() <em>Returntype Operation Signature</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected Variable returntype__OperationSignature;
	 ...
	 * @generated
	 */
	public EList<Variable> getParameters__OperationSignature() {
		if (parameters__OperationSignature == null) {
			parameters__OperationSignature = new EObjectContainmentWithInverseEList<Variable>(Variable.class, this, RepositoryPackage.OPERATION_SIGNATURE__PARAMETERS_OPERATION_SIGNATURE, ParameterPackage.VARIABLE__OPERATION_SIGNATURE_VARIABLE);
		}
	 ...
	 * @generated
	 */
	public Variable getReturntype__OperationSignature() {
		if (returntype__OperationSignature != null && returntype__OperationSignature.eIsProxy()) {
			...
			returntype__OperationSignature = (Variable)eResolveProxy(oldReturntype__OperationSignature);
			if (returntype__OperationSignature != oldReturntype__OperationSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RepositoryPackage.OPERATION_SIGNATURE__RETURNTYPE_OPERATION_SIGNATURE, oldReturntype__OperationSignature, returntype__OperationSignature));
			}
		}
	 ...
	 * @generated
	 */
	public Variable basicGetReturntype__OperationSignature() {
		return returntype__OperationSignature;
	}
	 ...
	 * @generated
	 */
	public void setReturntype__OperationSignature(Variable newReturntype__OperationSignature) {
		Variable oldReturntype__OperationSignature = returntype__OperationSignature;
		returntype__OperationSignature = newReturntype__OperationSignature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.OPERATION_SIGNATURE__RETURNTYPE_OPERATION_SIGNATURE, oldReturntype__OperationSignature, returntype__OperationSignature));
	}
	 ...
	 * @ordered
	 */
	protected static final String PARAMETER_NAMES_HAVE_TO_BE_UNIQUE_FOR_ASIGNATURE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.parameters__OperationSignature->isUnique(v : Variable |\n"+"	v.entityName\n"+")";
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RepositoryPackage.OPERATION_SIGNATURE__RETURNTYPE_OPERATION_SIGNATURE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case RepositoryPackage.OPERATION_SIGNATURE__PARAMETERS_OPERATION_SIGNATURE:
				...
				getParameters__OperationSignature().addAll((Collection<? extends Variable>)newValue);
				return;
			case RepositoryPackage.OPERATION_SIGNATURE__RETURNTYPE_OPERATION_SIGNATURE:
				setReturntype__OperationSignature((Variable)newValue);
				return;
			case RepositoryPackage.OPERATION_SIGNATURE__INTERFACE_OPERATION_SIGNATURE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case RepositoryPackage.OPERATION_SIGNATURE__PARAMETERS_OPERATION_SIGNATURE:
				...
				return;
			case RepositoryPackage.OPERATION_SIGNATURE__RETURNTYPE_OPERATION_SIGNATURE:
				setReturntype__OperationSignature((Variable)null);
				return;
			case RepositoryPackage.OPERATION_SIGNATURE__INTERFACE_OPERATION_SIGNATURE:

...
public class ParameterPackageImpl extends EPackageImpl implements ParameterPackage {
	 ...
	 * @generated
	 */
	public EReference getSetVariable_VariableCharacterisation_VariableUsage() {
	 ...
	 * @generated
	 */
	public EReference getSetVariable_UserData_VariableUsage() {
	 ...
	 * @generated
	 */
	public EReference getSetVariable_AssemblyContext_VariableUsage() {
		return (EReference)setVariableEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getSetVariable_EntryLevelSystemCall_InputParameterUsage() {
		return (EReference)setVariableEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getSetVariable_EntryLevelSystemCall_OutputParameterUsage() {
		return (EReference)setVariableEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getSetVariable_CallAction__SetVariable() {
		return (EReference)setVariableEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getSetVariable_SynchronisationPoint_VariableUsage() {
		return (EReference)setVariableEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EReference getSetVariable_CallReturnAction__SetVariable() {
		return (EReference)setVariableEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EReference getSetVariable_SetVariableAction_VariableUsage() {
		return (EReference)setVariableEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getSetVariable_SpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage() {
		return (EReference)setVariableEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EReference getSetVariable_Variable_VariableUsage() {
		return (EReference)setVariableEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 * @generated
	 */
	public EReference getVariableCharacterisation_Type() {
		return (EReference)variableCharacterisationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCharacterisedVariable_Variable() {
		return (EReference)characterisedVariableEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCharacterisedVariable_CharacterisationDefinition() {
		return (EReference)characterisedVariableEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getVariable_ImplementationComponentType_Variable() {
	 ...
	 * @generated
	 */
	public EReference getVariable_CompositeDataType_Variable() {
	...
	public void createPackageContents() {
		...
		createEReference(setVariableEClass, SET_VARIABLE__VARIABLE_CHARACTERISATION_VARIABLE_USAGE);
		createEReference(setVariableEClass, SET_VARIABLE__USER_DATA_VARIABLE_USAGE);
		createEReference(setVariableEClass, SET_VARIABLE__ASSEMBLY_CONTEXT_VARIABLE_USAGE);
		createEReference(setVariableEClass, SET_VARIABLE__ENTRY_LEVEL_SYSTEM_CALL_INPUT_PARAMETER_USAGE);
		createEReference(setVariableEClass, SET_VARIABLE__ENTRY_LEVEL_SYSTEM_CALL_OUTPUT_PARAMETER_USAGE);
		createEReference(setVariableEClass, SET_VARIABLE__CALL_ACTION_SET_VARIABLE);
		createEReference(setVariableEClass, SET_VARIABLE__SYNCHRONISATION_POINT_VARIABLE_USAGE);
		createEReference(setVariableEClass, SET_VARIABLE__CALL_RETURN_ACTION_SET_VARIABLE);
		createEReference(setVariableEClass, SET_VARIABLE__SET_VARIABLE_ACTION_VARIABLE_USAGE);
		createEReference(setVariableEClass, SET_VARIABLE__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION_EXPECTED_EXTERNAL_OUTPUTS_VARIABLE_USAGE);
		createEReference(setVariableEClass, SET_VARIABLE__VARIABLE_VARIABLE_USAGE);

		variableCharacterisationEClass = createEClass(VARIABLE_CHARACTERISATION);
		createEReference(variableCharacterisationEClass, VARIABLE_CHARACTERISATION__TYPE);
		...
		createEReference(characterisedVariableEClass, CHARACTERISED_VARIABLE__VARIABLE);
		createEReference(characterisedVariableEClass, CHARACTERISED_VARIABLE__CHARACTERISATION_DEFINITION);
	...
	public void initializePackageContents() {
		...
		initEReference(getSetVariable_VariableCharacterisation_VariableUsage(), this.getVariableCharacterisation(), this.getVariableCharacterisation_VariableUsage_VariableCharacterisation(), "variableCharacterisation_VariableUsage", null, 0, -1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_UserData_VariableUsage(), theUsagemodelPackage.getUserData(), theUsagemodelPackage.getUserData_UserDataParameterUsages_UserData(), "userData_VariableUsage", null, 0, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_AssemblyContext_VariableUsage(), theCompositionPackage.getAssemblyContext(), theCompositionPackage.getAssemblyContext_ConfigParameterUsages_AssemblyContext(), "assemblyContext_VariableUsage", null, 0, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_EntryLevelSystemCall_InputParameterUsage(), theUsagemodelPackage.getEntryLevelSystemCall(), theUsagemodelPackage.getEntryLevelSystemCall_InputParameterUsages_EntryLevelSystemCall(), "entryLevelSystemCall_InputParameterUsage", null, 0, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_EntryLevelSystemCall_OutputParameterUsage(), theUsagemodelPackage.getEntryLevelSystemCall(), theUsagemodelPackage.getEntryLevelSystemCall_OutputParameterUsages_EntryLevelSystemCall(), "entryLevelSystemCall_OutputParameterUsage", null, 0, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_CallAction__SetVariable(), theSeffPackage.getCallAction(), theSeffPackage.getCallAction_SetVariableInputs__CallAction(), "callAction__SetVariable", null, 0, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_SynchronisationPoint_VariableUsage(), theSeffPackage.getSynchronisationPoint(), theSeffPackage.getSynchronisationPoint_OutputParameterUsage_SynchronisationPoint(), "synchronisationPoint_VariableUsage", null, 0, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_CallReturnAction__SetVariable(), theSeffPackage.getCallReturnAction(), theSeffPackage.getCallReturnAction_SetVariableReturns__CallReturnAction(), "callReturnAction__SetVariable", null, 0, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_SetVariableAction_VariableUsage(), theSeffPackage.getSetVariableAction(), theSeffPackage.getSetVariableAction_LocalVariableUsages_SetVariableAction(), "setVariableAction_VariableUsage", null, 0, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_SpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage(), theQosannotationsPackage.getSpecifiedOutputParameterAbstraction(), theQosannotationsPackage.getSpecifiedOutputParameterAbstraction_ExpectedExternalOutputs_SpecifiedOutputParameterAbstraction(), "specifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage", null, 0, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSetVariable_Variable_VariableUsage(), this.getVariable(), null, "variable_VariableUsage", null, 1, 1, SetVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getVariableCharacterisation_Type(), theRepositoryPackage.getCharacterisationDefinition(), null, "type", null, 1, 1, VariableCharacterisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getVariableCharacterisation_VariableUsage_VariableCharacterisation(), this.getSetVariable(), this.getSetVariable_VariableCharacterisation_VariableUsage(), "variableUsage_VariableCharacterisation", null, 1, 1, VariableCharacterisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getCharacterisedVariable_Variable(), this.getVariable(), null, "variable", null, 1, 1, CharacterisedVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getCharacterisedVariable_CharacterisationDefinition(), theRepositoryPackage.getCharacterisationDefinition(), null, "characterisationDefinition", null, 1, 1, CharacterisedVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getVariable_ImplementationComponentType_Variable(), theRepositoryPackage.getImplementationComponentType(), theRepositoryPackage.getImplementationComponentType_ComponentParameter_ImplementationComponentType(), "implementationComponentType_Variable", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getVariable_CompositeDataType_Variable(), theRepositoryPackage.getCompositeDataType(), theRepositoryPackage.getCompositeDataType_Members_CompositeDataType(), "compositeDataType_Variable", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getVariable_ResourceSignature__Variable(), theRepositoryPackage.getResourceSignature(), theRepositoryPackage.getResourceSignature_Parmeter__ResourceSignature(), "resourceSignature__Variable", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

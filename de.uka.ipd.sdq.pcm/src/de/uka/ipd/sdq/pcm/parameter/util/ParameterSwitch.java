...
public class ParameterSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ParameterPackage.SET_VARIABLE: {
			...
			case ParameterPackage.CHARACTERISED_VARIABLE: {
				...
				if (result == null) result = caseStoex_Variable(characterisedVariable);
			...
			case ParameterPackage.VARIABLE: {
	 ...
	 * @generated
	 */
	public T caseStoex_Variable(de.uka.ipd.sdq.stoex.Variable object) {
		return null;
	}

...
public class ParameterAdapterFactory extends AdapterFactoryImpl {
	...
	protected ParameterSwitch<Adapter> modelSwitch =
		new ParameterSwitch<Adapter>() {
			...
			@Override
			public Adapter caseStoex_Variable(de.uka.ipd.sdq.stoex.Variable object) {
				return createStoex_VariableAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.parameter.SetVariable <em>Set Variable</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStoex_VariableAdapter() {
		return null;
	}

 ...
 * @generated
 */
public class CharacterisedVariableImpl extends VariableImpl implements
	 ...
	 */
	@Override
	public void setCharacterisationType(
			VariableCharacterisationType newCharacterisationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					oldCharacterisationType, characterisationType));
	}

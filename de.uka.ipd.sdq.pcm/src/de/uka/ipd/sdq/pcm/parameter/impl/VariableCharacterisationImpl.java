...
public class VariableCharacterisationImpl extends EObjectImpl implements VariableCharacterisation {
	 ...
	 * @ordered
	 */
	protected CharacterisationDefinition type;
	 ...
	 * @generated
	 */
	public CharacterisationDefinition getType() {
		if (type != null && type.eIsProxy()) {
			InternalEObject oldType = (InternalEObject)type;
			type = (CharacterisationDefinition)eResolveProxy(oldType);
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParameterPackage.VARIABLE_CHARACTERISATION__TYPE, oldType, type));
			}
		}
		return type;
	}
	 ...
	 * @generated
	 */
	public CharacterisationDefinition basicGetType() {
		return type;
	}
	 ...
	 * @generated
	 */
	public void setType(CharacterisationDefinition newType) {
		CharacterisationDefinition oldType = type;
		type = newType;
		if (eNotificationRequired())
	 ...
	 * @generated
	 */
	public NotificationChain basicSetVariableUsage_VariableCharacterisation(SetVariable newVariableUsage_VariableCharacterisation, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setVariableUsage_VariableCharacterisation(SetVariable newVariableUsage_VariableCharacterisation) {
		if (newVariableUsage_VariableCharacterisation != eInternalContainer() || (eContainerFeatureID() != ParameterPackage.VARIABLE_CHARACTERISATION__VARIABLE_USAGE_VARIABLE_CHARACTERISATION && newVariableUsage_VariableCharacterisation != null)) {
			...
			if (newVariableUsage_VariableCharacterisation != null)
				msgs = ((InternalEObject)newVariableUsage_VariableCharacterisation).eInverseAdd(this, ParameterPackage.SET_VARIABLE__VARIABLE_CHARACTERISATION_VARIABLE_USAGE, SetVariable.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ParameterPackage.VARIABLE_CHARACTERISATION__VARIABLE_USAGE_VARIABLE_CHARACTERISATION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetVariableUsage_VariableCharacterisation((SetVariable)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ParameterPackage.VARIABLE_CHARACTERISATION__VARIABLE_USAGE_VARIABLE_CHARACTERISATION:
				return eInternalContainer().eInverseRemove(this, ParameterPackage.SET_VARIABLE__VARIABLE_CHARACTERISATION_VARIABLE_USAGE, SetVariable.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ParameterPackage.VARIABLE_CHARACTERISATION__TYPE:
				setType((CharacterisationDefinition)newValue);
				return;
			case ParameterPackage.VARIABLE_CHARACTERISATION__SPECIFICATION_VARIABLE_CHARACTERISATION:
				setSpecification_VariableCharacterisation((PCMRandomVariable)newValue);
				return;
			case ParameterPackage.VARIABLE_CHARACTERISATION__VARIABLE_USAGE_VARIABLE_CHARACTERISATION:
				setVariableUsage_VariableCharacterisation((SetVariable)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ParameterPackage.VARIABLE_CHARACTERISATION__TYPE:
				setType((CharacterisationDefinition)null);
				return;
			case ParameterPackage.VARIABLE_CHARACTERISATION__SPECIFICATION_VARIABLE_CHARACTERISATION:
				setSpecification_VariableCharacterisation((PCMRandomVariable)null);
				return;
			case ParameterPackage.VARIABLE_CHARACTERISATION__VARIABLE_USAGE_VARIABLE_CHARACTERISATION:
				setVariableUsage_VariableCharacterisation((SetVariable)null);
				return;
		}

 ...
 * @generated
 */
public class VariableCharacterisationImpl extends EStereotypableObjectImpl
		implements VariableCharacterisation {
	/**
	...
	public void setType(VariableCharacterisationType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ParameterPackage.VARIABLE_CHARACTERISATION__TYPE, oldType,
					type));
	}
	...
	public NotificationChain basicSetSpecification_VariableCharacterisation(
			PCMRandomVariable newSpecification_VariableCharacterisation,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldSpecification_VariableCharacterisation,
	...
	public void setSpecification_VariableCharacterisation(
		...
		if (newSpecification_VariableCharacterisation != specification_VariableCharacterisation) {
			...
			if (specification_VariableCharacterisation != null)
				msgs = ((InternalEObject) specification_VariableCharacterisation)
						.eInverseRemove(
								this,
			...
			if (newSpecification_VariableCharacterisation != null)
				msgs = ((InternalEObject) newSpecification_VariableCharacterisation)
						.eInverseAdd(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__VARIABLE_CHARACTERISATION_SPECIFICATION,
								PCMRandomVariable.class, msgs);
			msgs = basicSetSpecification_VariableCharacterisation(
					newSpecification_VariableCharacterisation, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain basicSetVariableUsage_VariableCharacterisation(
			VariableUsage newVariableUsage_VariableCharacterisation,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newVariableUsage_VariableCharacterisation,
	...
	public void setVariableUsage_VariableCharacterisation(
		...
		if (newVariableUsage_VariableCharacterisation != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newVariableUsage_VariableCharacterisation))
			...
			if (newVariableUsage_VariableCharacterisation != null)
				msgs = ((InternalEObject) newVariableUsage_VariableCharacterisation)
						.eInverseAdd(
								this,
								ParameterPackage.VARIABLE_USAGE__VARIABLE_CHARACTERISATION_VARIABLE_USAGE,
								VariableUsage.class, msgs);
			msgs = basicSetVariableUsage_VariableCharacterisation(
					newVariableUsage_VariableCharacterisation, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
				...
				msgs = ((InternalEObject) specification_VariableCharacterisation)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- ParameterPackage.VARIABLE_CHARACTERISATION__SPECIFICATION_VARIABLE_CHARACTERISATION,
								null, msgs);
			return basicSetSpecification_VariableCharacterisation(
					(PCMRandomVariable) otherEnd, msgs);
		case ParameterPackage.VARIABLE_CHARACTERISATION__VARIABLE_USAGE_VARIABLE_CHARACTERISATION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetVariableUsage_VariableCharacterisation(
					(VariableUsage) otherEnd, msgs);
		}

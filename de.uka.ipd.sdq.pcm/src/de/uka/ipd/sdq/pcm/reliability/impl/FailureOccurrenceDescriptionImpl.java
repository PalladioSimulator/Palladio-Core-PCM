 ...
 * @generated
 */
public abstract class FailureOccurrenceDescriptionImpl extends
		EStereotypableObjectImpl implements FailureOccurrenceDescription {
	/**
	...
	public void setFailureProbability(double newFailureProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ReliabilityPackage.FAILURE_OCCURRENCE_DESCRIPTION__FAILURE_PROBABILITY,
	 ...
	 */
	@Override
	public boolean EnsureValidFailureProbabilityRange(
		...
		if (!EOCL_ENV
				.createQuery(
						ENSURE_VALID_FAILURE_PROBABILITY_RANGE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics

...
public class ReliabilityAdapterFactory extends AdapterFactoryImpl {
	...
	protected ReliabilitySwitch<Adapter> modelSwitch = new ReliabilitySwitch<Adapter>() {
		@Override
		public Adapter caseFailureOccurrenceDescription(
				FailureOccurrenceDescription object) {
			return createFailureOccurrenceDescriptionAdapter();
		}

		@Override
		public Adapter caseHardwareInducedFailureType(
				HardwareInducedFailureType object) {
			return createHardwareInducedFailureTypeAdapter();
		}

		@Override
		public Adapter caseSoftwareInducedFailureType(
				SoftwareInducedFailureType object) {
			return createSoftwareInducedFailureTypeAdapter();
		}

		@Override
		public Adapter caseInternalFailureOccurrenceDescription(
				InternalFailureOccurrenceDescription object) {
			return createInternalFailureOccurrenceDescriptionAdapter();
		}

		@Override
		public Adapter caseNetworkInducedFailureType(
				NetworkInducedFailureType object) {
			return createNetworkInducedFailureTypeAdapter();
		}

		@Override
		public Adapter caseExternalFailureOccurrenceDescription(
				ExternalFailureOccurrenceDescription object) {
			return createExternalFailureOccurrenceDescriptionAdapter();
		}

		@Override
		public Adapter caseResourceTimeoutFailureType(
				ResourceTimeoutFailureType object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.reliability.FailureOccurrenceDescription <em>Failure Occurrence Description</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.reliability.HardwareInducedFailureType <em>Hardware Induced Failure Type</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.reliability.ExternalFailureOccurrenceDescription <em>External Failure Occurrence Description</em>}'.
	 * <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.reliability.ResourceTimeoutFailureType <em>Resource Timeout Failure Type</em>}'.
	 * <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.reliability.NetworkInducedFailureType <em>Network Induced Failure Type</em>}'.
	 * <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.reliability.InternalFailureOccurrenceDescription <em>Internal Failure Occurrence Description</em>}'.
	 * <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.reliability.SoftwareInducedFailureType <em>Software Induced Failure Type</em>}'.
	 * <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.

 ...
 * @generated
 */
public class ResourceTimeoutFailureTypeImpl extends
		SoftwareInducedFailureTypeImpl implements ResourceTimeoutFailureType {
	/**
	...
	public PassiveResource getPassiveResource__ResourceTimeoutFailureType() {
		if (passiveResource__ResourceTimeoutFailureType != null
				&& ((EObject) passiveResource__ResourceTimeoutFailureType)
						.eIsProxy()) {
	...
	public void setPassiveResource__ResourceTimeoutFailureType(
		...
		if (newPassiveResource__ResourceTimeoutFailureType != passiveResource__ResourceTimeoutFailureType) {
			...
			if (passiveResource__ResourceTimeoutFailureType != null)
				msgs = ((InternalEObject) passiveResource__ResourceTimeoutFailureType)
						.eInverseRemove(
								this,
			...
			if (newPassiveResource__ResourceTimeoutFailureType != null)
				msgs = ((InternalEObject) newPassiveResource__ResourceTimeoutFailureType)
						.eInverseAdd(
								this,
								RepositoryPackage.PASSIVE_RESOURCE__RESOURCE_TIMEOUT_FAILURE_TYPE_PASSIVE_RESOURCE,
								PassiveResource.class, msgs);
			msgs = basicSetPassiveResource__ResourceTimeoutFailureType(
			...
			if (passiveResource__ResourceTimeoutFailureType != null)
				msgs = ((InternalEObject) passiveResource__ResourceTimeoutFailureType)
						.eInverseRemove(
								...
								RepositoryPackage.PASSIVE_RESOURCE__RESOURCE_TIMEOUT_FAILURE_TYPE_PASSIVE_RESOURCE,
								PassiveResource.class, msgs);
			return basicSetPassiveResource__ResourceTimeoutFailureType(
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case ReliabilityPackage.RESOURCE_TIMEOUT_FAILURE_TYPE__PASSIVE_RESOURCE_RESOURCE_TIMEOUT_FAILURE_TYPE:
			return basicSetPassiveResource__ResourceTimeoutFailureType(null,
					msgs);
		}

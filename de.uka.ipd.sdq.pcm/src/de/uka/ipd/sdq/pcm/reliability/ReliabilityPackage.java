...
public interface ReliabilityPackage extends EPackage {
	 ...
	 * @generated
	 */
	ReliabilityPackage eINSTANCE = de.uka.ipd.sdq.pcm.reliability.impl.ReliabilityPackageImpl
			.init();
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.pcm.reliability.impl.ResourceTimeoutFailureTypeImpl <em>Resource Timeout Failure Type</em>}' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.pcm.reliability.ExternalFailureOccurrenceDescription#getFailureType__ExternalFailureOccurrenceDescription <em>Failure Type External Failure Occurrence Description</em>}'.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.pcm.reliability.ResourceTimeoutFailureType <em>Resource Timeout Failure Type</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.pcm.reliability.ResourceTimeoutFailureType#getPassiveResource__ResourceTimeoutFailureType <em>Passive Resource Resource Timeout Failure Type</em>}'.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EClass FAILURE_OCCURRENCE_DESCRIPTION = eINSTANCE
				.getFailureOccurrenceDescription();
		 ...
		 * @generated
		 */
		EClass HARDWARE_INDUCED_FAILURE_TYPE = eINSTANCE
		 ...
		 * @generated
		 */
		EClass EXTERNAL_FAILURE_OCCURRENCE_DESCRIPTION = eINSTANCE
				.getExternalFailureOccurrenceDescription();
		 ...
		 * @generated
		 */
		EClass RESOURCE_TIMEOUT_FAILURE_TYPE = eINSTANCE
		 ...
		 * @generated
		 */
		EClass NETWORK_INDUCED_FAILURE_TYPE = eINSTANCE
				.getNetworkInducedFailureType();
		 ...
		 * @generated
		 */
		EClass INTERNAL_FAILURE_OCCURRENCE_DESCRIPTION = eINSTANCE
				.getInternalFailureOccurrenceDescription();
		 ...
		 * @generated
		 */
		EClass SOFTWARE_INDUCED_FAILURE_TYPE = eINSTANCE
				.getSoftwareInducedFailureType();
		 ...
		 * @generated
		 */
		EReference FAILURE_TYPE__REPOSITORY_FAILURE_TYPE = eINSTANCE
				.getFailureType_Repository__FailureType();

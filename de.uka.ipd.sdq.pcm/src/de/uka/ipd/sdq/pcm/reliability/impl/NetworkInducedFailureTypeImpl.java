 ...
 * @generated
 */
public class NetworkInducedFailureTypeImpl extends FailureTypeImpl implements
	...
	public CommunicationLinkResourceType getCommunicationLinkResourceType__NetworkInducedFailureType() {
		if (communicationLinkResourceType__NetworkInducedFailureType != null
				&& ((EObject) communicationLinkResourceType__NetworkInducedFailureType)
						.eIsProxy()) {
	 ...
	 */
	@Override
	public boolean NetworkInducedFailureTypeHasCommunicationLinkResourceType(

 ...
 * @generated
 */
public class SubsystemPackageImpl extends EPackageImpl implements
		SubsystemPackage {
	/**
	...
	public static SubsystemPackage init() {
		if (isInited)
			return (SubsystemPackage) EPackage.Registry.INSTANCE
		...
		SubsystemPackageImpl theSubsystemPackage = (SubsystemPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof SubsystemPackageImpl ? EPackage.Registry.INSTANCE
		...
		EPackage.Registry.INSTANCE.put(SubsystemPackage.eNS_URI,
				theSubsystemPackage);

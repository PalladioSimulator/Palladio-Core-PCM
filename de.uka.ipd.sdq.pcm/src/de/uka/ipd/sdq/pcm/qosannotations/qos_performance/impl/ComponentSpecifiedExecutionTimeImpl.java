 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.qosannotations.qos_performance.impl.ComponentSpecifiedExecutionTimeImpl#getAssemblyContext_ComponentSpecifiedExecutionTime <em>Assembly Context Component Specified Execution Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComponentSpecifiedExecutionTimeImpl extends
		SpecifiedExecutionTimeImpl implements ComponentSpecifiedExecutionTime {
	/**
	...
	public AssemblyContext getAssemblyContext_ComponentSpecifiedExecutionTime() {
		if (assemblyContext_ComponentSpecifiedExecutionTime != null
				&& ((EObject) assemblyContext_ComponentSpecifiedExecutionTime)
						.eIsProxy()) {

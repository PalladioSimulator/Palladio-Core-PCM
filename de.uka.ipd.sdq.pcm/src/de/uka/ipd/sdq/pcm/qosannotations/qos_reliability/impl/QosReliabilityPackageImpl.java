 ...
 * @generated
 */
public class QosReliabilityPackageImpl extends EPackageImpl implements
	 ...
	 * 
	 * <p>This method is used to initialize {@link QosReliabilityPackage#eINSTANCE} when that field is accessed.
	...
	public static QosReliabilityPackage init() {
		if (isInited)
			return (QosReliabilityPackage) EPackage.Registry.INSTANCE
		...
		QosReliabilityPackageImpl theQosReliabilityPackage = (QosReliabilityPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof QosReliabilityPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new QosReliabilityPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(QosReliabilityPackage.eNS_URI,
	...
	public EReference getSpecifiedReliabilityAnnotation_ExternalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation() {
		return (EReference) specifiedReliabilityAnnotationEClass
	...
	public void initializePackageContents() {
		...
		specifiedReliabilityAnnotationEClass.getESuperTypes().add(
				theQosannotationsPackage.getSpecifiedQoSAnnotation());

		// Initialize classes and features; add operations and parameters
		initEClass(specifiedReliabilityAnnotationEClass,
				SpecifiedReliabilityAnnotation.class,
				"SpecifiedReliabilityAnnotation", !IS_ABSTRACT, !IS_INTERFACE,
		...
		initEReference(
				...
				null, 1, -1, SpecifiedReliabilityAnnotation.class,
		...
		op = addEOperation(specifiedReliabilityAnnotationEClass,
				ecorePackage.getEBoolean(),

 ...
 * @generated
 */
public abstract class SpecifiedOutputParameterAbstractionImpl extends
		EStereotypableObjectImpl implements SpecifiedOutputParameterAbstraction {
	/**
	...
	public void setQosAnnotations_SpecifiedOutputParameterAbstraction(
		...
		if (newQosAnnotations_SpecifiedOutputParameterAbstraction != eInternalContainer()
			...
			if (EcoreUtil
					.isAncestor(
							this,
							(EObject) newQosAnnotations_SpecifiedOutputParameterAbstraction))
			...
			if (newQosAnnotations_SpecifiedOutputParameterAbstraction != null)
				msgs = ((InternalEObject) newQosAnnotations_SpecifiedOutputParameterAbstraction)
						.eInverseAdd(
								this,
	...
	public Signature getSignature_SpecifiedOutputParameterAbstraction() {
		if (signature_SpecifiedOutputParameterAbstraction != null
				&& ((EObject) signature_SpecifiedOutputParameterAbstraction)
						.eIsProxy()) {
	...
	public Role getRole_SpecifiedOutputParameterAbstraction() {
		if (role_SpecifiedOutputParameterAbstraction != null
				&& ((EObject) role_SpecifiedOutputParameterAbstraction)
						.eIsProxy()) {
			...
			if (role_SpecifiedOutputParameterAbstraction != oldRole_SpecifiedOutputParameterAbstraction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldRole_SpecifiedOutputParameterAbstraction,
	 ...
	 */
	@Override
	public void setRole_SpecifiedOutputParameterAbstraction(
			Role newRole_SpecifiedOutputParameterAbstraction) {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case QosannotationsPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION__QOS_ANNOTATIONS_SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetQosAnnotations_SpecifiedOutputParameterAbstraction(

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.qosannotations.impl.SpecifiedOutputParameterAbstractionImpl#getQosAnnotations_SpecifiedOutputParameterAbstraction <em>Qos Annotations Specified Output Parameter Abstraction</em>}</li>
...
public abstract class SpecifiedOutputParameterAbstractionImpl extends EObjectImpl implements SpecifiedOutputParameterAbstraction {
	 ...
	 * @ordered
	 */
	protected EList<SetVariable> expectedExternalOutputs_SpecifiedOutputParameterAbstraction;
	...
	public NotificationChain basicSetQosAnnotations_SpecifiedOutputParameterAbstraction(QoSAnnotations newQosAnnotations_SpecifiedOutputParameterAbstraction, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newQosAnnotations_SpecifiedOutputParameterAbstraction, QosannotationsPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION__QOS_ANNOTATIONS_SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION, msgs);
		return msgs;
	}
	...
	public void setQosAnnotations_SpecifiedOutputParameterAbstraction(QoSAnnotations newQosAnnotations_SpecifiedOutputParameterAbstraction) {
		if (newQosAnnotations_SpecifiedOutputParameterAbstraction != eInternalContainer() || (eContainerFeatureID() != QosannotationsPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION__QOS_ANNOTATIONS_SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION && newQosAnnotations_SpecifiedOutputParameterAbstraction != null)) {
			...
			if (newQosAnnotations_SpecifiedOutputParameterAbstraction != null)
				msgs = ((InternalEObject)newQosAnnotations_SpecifiedOutputParameterAbstraction).eInverseAdd(this, QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTIONS_QO_SANNOTATIONS, QoSAnnotations.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, QosannotationsPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION__QOS_ANNOTATIONS_SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION, newQosAnnotations_SpecifiedOutputParameterAbstraction, newQosAnnotations_SpecifiedOutputParameterAbstraction));
	}
	 ...
	 * @generated
	 */
	public EList<SetVariable> getExpectedExternalOutputs_SpecifiedOutputParameterAbstraction() {
		if (expectedExternalOutputs_SpecifiedOutputParameterAbstraction == null) {
			expectedExternalOutputs_SpecifiedOutputParameterAbstraction = new EObjectContainmentWithInverseEList<SetVariable>(SetVariable.class, this, QosannotationsPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION__EXPECTED_EXTERNAL_OUTPUTS_SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION, ParameterPackage.SET_VARIABLE__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION_EXPECTED_EXTERNAL_OUTPUTS_VARIABLE_USAGE);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case QosannotationsPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION__QOS_ANNOTATIONS_SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION:
				return eInternalContainer().eInverseRemove(this, QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTIONS_QO_SANNOTATIONS, QoSAnnotations.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case QosannotationsPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION__EXPECTED_EXTERNAL_OUTPUTS_SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION:
				...
				getExpectedExternalOutputs_SpecifiedOutputParameterAbstraction().addAll((Collection<? extends SetVariable>)newValue);
				return;
		}

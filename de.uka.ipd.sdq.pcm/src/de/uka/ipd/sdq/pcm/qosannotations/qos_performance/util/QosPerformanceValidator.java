...
public class QosPerformanceValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value,
		...
		case QosPerformancePackage.SYSTEM_SPECIFIED_EXECUTION_TIME:
			return validateSystemSpecifiedExecutionTime(
					(SystemSpecifiedExecutionTime) value, diagnostics, context);
		case QosPerformancePackage.SPECIFIED_EXECUTION_TIME:
			return validateSpecifiedExecutionTime(
					(SpecifiedExecutionTime) value, diagnostics, context);
		case QosPerformancePackage.COMPONENT_SPECIFIED_EXECUTION_TIME:
			return validateComponentSpecifiedExecutionTime(
					(ComponentSpecifiedExecutionTime) value, diagnostics,
					context);
		default:
			return true;
		}
	...
	public boolean validateSystemSpecifiedExecutionTime(
			SystemSpecifiedExecutionTime systemSpecifiedExecutionTime,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(
				(EObject) systemSpecifiedExecutionTime, diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(
				(EObject) systemSpecifiedExecutionTime, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(
					(EObject) systemSpecifiedExecutionTime, diagnostics,
					context);
		if (result || diagnostics != null)
		...
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(
					...
					context);
		if (result || diagnostics != null)
			result &= validate_UniqueID((EObject) systemSpecifiedExecutionTime,
					diagnostics, context);
		if (result || diagnostics != null)
	 ...
	 * @generated
	 */
	public boolean validateSpecifiedExecutionTime(
			SpecifiedExecutionTime specifiedExecutionTime,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(
				(EObject) specifiedExecutionTime, diagnostics, context);
	}
	...
	public boolean validateComponentSpecifiedExecutionTime(
			ComponentSpecifiedExecutionTime componentSpecifiedExecutionTime,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(
				(EObject) componentSpecifiedExecutionTime, diagnostics, context);
	}

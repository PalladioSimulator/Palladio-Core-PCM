 ...
 * @generated
 */
public class QosPerformancePackageImpl extends EPackageImpl implements
	 ...
	 * @see de.uka.ipd.sdq.pcm.qosannotations.qos_performance.QosPerformancePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>This method is used to initialize {@link QosPerformancePackage#eINSTANCE} when that field is accessed.
	...
	public static QosPerformancePackage init() {
		if (isInited)
			return (QosPerformancePackage) EPackage.Registry.INSTANCE
		...
		QosPerformancePackageImpl theQosPerformancePackage = (QosPerformancePackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof QosPerformancePackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new QosPerformancePackageImpl());
		...
		EPackage.Registry.INSTANCE.put(QosPerformancePackage.eNS_URI,
	...
	public EReference getSpecifiedExecutionTime_Specification_SpecifiedExecutionTime() {
		return (EReference) specifiedExecutionTimeEClass
	...
	public EReference getComponentSpecifiedExecutionTime_AssemblyContext_ComponentSpecifiedExecutionTime() {
		return (EReference) componentSpecifiedExecutionTimeEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(specifiedExecutionTimeEClass,
		...
		createEReference(
				componentSpecifiedExecutionTimeEClass,
	...
	public void initializePackageContents() {
		...
		systemSpecifiedExecutionTimeEClass.getESuperTypes().add(
				this.getSpecifiedExecutionTime());
		specifiedExecutionTimeEClass.getESuperTypes().add(
				theQosannotationsPackage.getSpecifiedQoSAnnotation());
		componentSpecifiedExecutionTimeEClass.getESuperTypes().add(
				this.getSpecifiedExecutionTime());

		// Initialize classes and features; add operations and parameters
		initEClass(systemSpecifiedExecutionTimeEClass,
				SystemSpecifiedExecutionTime.class,
				"SystemSpecifiedExecutionTime", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		EOperation op = addEOperation(
				systemSpecifiedExecutionTimeEClass,
		...
		initEClass(specifiedExecutionTimeEClass, SpecifiedExecutionTime.class,
				"SpecifiedExecutionTime", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(
				...
				"specification_SpecifiedExecutionTime", null, 1, 1,
				SpecifiedExecutionTime.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(componentSpecifiedExecutionTimeEClass,
				ComponentSpecifiedExecutionTime.class,
				"ComponentSpecifiedExecutionTime", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(
				...
				"assemblyContext_ComponentSpecifiedExecutionTime", null, 1, 1,
				ComponentSpecifiedExecutionTime.class, !IS_TRANSIENT,

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.qosannotations.qos_performance.impl.SpecifiedExecutionTimeImpl#getSpecification_SpecifiedExecutionTime <em>Specification Specified Execution Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class SpecifiedExecutionTimeImpl extends
		SpecifiedQoSAnnotationImpl implements SpecifiedExecutionTime {
	/**
	...
	public NotificationChain basicSetSpecification_SpecifiedExecutionTime(
			PCMRandomVariable newSpecification_SpecifiedExecutionTime,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldSpecification_SpecifiedExecutionTime,
	...
	public void setSpecification_SpecifiedExecutionTime(
		...
		if (newSpecification_SpecifiedExecutionTime != specification_SpecifiedExecutionTime) {
			...
			if (newSpecification_SpecifiedExecutionTime != null)
				msgs = ((InternalEObject) newSpecification_SpecifiedExecutionTime)
						.eInverseAdd(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__SPECIFIED_EXECUTION_TIME_PCM_RANDOM_VARIABLE,
								PCMRandomVariable.class, msgs);
			msgs = basicSetSpecification_SpecifiedExecutionTime(
					newSpecification_SpecifiedExecutionTime, msgs);
			if (msgs != null)
				msgs.dispatch();
				...
				msgs = ((InternalEObject) specification_SpecifiedExecutionTime)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- QosPerformancePackage.SPECIFIED_EXECUTION_TIME__SPECIFICATION_SPECIFIED_EXECUTION_TIME,
								null, msgs);
			return basicSetSpecification_SpecifiedExecutionTime(

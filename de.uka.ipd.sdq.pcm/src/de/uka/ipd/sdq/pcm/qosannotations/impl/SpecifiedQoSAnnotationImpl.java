 ...
 * @generated
 */
public abstract class SpecifiedQoSAnnotationImpl extends
		EStereotypableObjectImpl implements SpecifiedQoSAnnotation {
	/**
	...
	public Signature getSignature_SpecifiedQoSAnnation() {
		if (signature_SpecifiedQoSAnnation != null
				&& ((EObject) signature_SpecifiedQoSAnnation).eIsProxy()) {
			...
			if (signature_SpecifiedQoSAnnation != oldSignature_SpecifiedQoSAnnation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldSignature_SpecifiedQoSAnnation,
	 ...
	 */
	@Override
	public void setSignature_SpecifiedQoSAnnation(
			Signature newSignature_SpecifiedQoSAnnation) {
	...
	public Role getRole_SpecifiedQoSAnnotation() {
		if (role_SpecifiedQoSAnnotation != null
				&& ((EObject) role_SpecifiedQoSAnnotation).eIsProxy()) {
			...
			if (role_SpecifiedQoSAnnotation != oldRole_SpecifiedQoSAnnotation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldRole_SpecifiedQoSAnnotation,
	 ...
	 */
	@Override
	public void setRole_SpecifiedQoSAnnotation(
			Role newRole_SpecifiedQoSAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					QosannotationsPackage.SPECIFIED_QO_SANNOTATION__ROLE_SPECIFIED_QO_SANNOTATION,
					oldRole_SpecifiedQoSAnnotation, role_SpecifiedQoSAnnotation));
	}
	...
	public QoSAnnotations getQosAnnotations_SpecifiedQoSAnnotation() {
		if (eContainerFeatureID() != QosannotationsPackage.SPECIFIED_QO_SANNOTATION__QOS_ANNOTATIONS_SPECIFIED_QO_SANNOTATION)
			return null;
	...
	public NotificationChain basicSetQosAnnotations_SpecifiedQoSAnnotation(
			QoSAnnotations newQosAnnotations_SpecifiedQoSAnnotation,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newQosAnnotations_SpecifiedQoSAnnotation,
	...
	public void setQosAnnotations_SpecifiedQoSAnnotation(
			QoSAnnotations newQosAnnotations_SpecifiedQoSAnnotation) {
		if (newQosAnnotations_SpecifiedQoSAnnotation != eInternalContainer()
				|| (eContainerFeatureID() != QosannotationsPackage.SPECIFIED_QO_SANNOTATION__QOS_ANNOTATIONS_SPECIFIED_QO_SANNOTATION && newQosAnnotations_SpecifiedQoSAnnotation != null)) {
			if (EcoreUtil.isAncestor(this,
					(EObject) newQosAnnotations_SpecifiedQoSAnnotation))
			...
			if (newQosAnnotations_SpecifiedQoSAnnotation != null)
				msgs = ((InternalEObject) newQosAnnotations_SpecifiedQoSAnnotation)
						.eInverseAdd(
								this,
								QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS,
								QoSAnnotations.class, msgs);
			msgs = basicSetQosAnnotations_SpecifiedQoSAnnotation(
					newQosAnnotations_SpecifiedQoSAnnotation, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case QosannotationsPackage.SPECIFIED_QO_SANNOTATION__QOS_ANNOTATIONS_SPECIFIED_QO_SANNOTATION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetQosAnnotations_SpecifiedQoSAnnotation(
					(QoSAnnotations) otherEnd, msgs);
		}

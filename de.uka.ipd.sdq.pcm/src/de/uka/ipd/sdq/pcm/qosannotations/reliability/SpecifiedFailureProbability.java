...
public interface SpecifiedFailureProbability extends SpecifiedQoSAnnotation {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.failureProbability.oclAsType(Real) >= 0 and self.failureProbability.oclAsType(Real) <= 1
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.failureProbability.oclAsType(Real) >= 0 and self.failureProbability.oclAsType(Real) <= 1'"
	 * @generated
	 */
	boolean EnsureValidParameterRange(DiagnosticChain diagnostics, Map<Object, Object> context);

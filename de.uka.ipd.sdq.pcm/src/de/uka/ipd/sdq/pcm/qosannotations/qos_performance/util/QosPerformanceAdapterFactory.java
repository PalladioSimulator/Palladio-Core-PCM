...
public class QosPerformanceAdapterFactory extends AdapterFactoryImpl {
	...
	protected QosPerformanceSwitch<Adapter> modelSwitch = new QosPerformanceSwitch<Adapter>() {
		@Override
		public Adapter caseSystemSpecifiedExecutionTime(
				SystemSpecifiedExecutionTime object) {
		...
		@Override
		public Adapter caseComponentSpecifiedExecutionTime(
				ComponentSpecifiedExecutionTime object) {

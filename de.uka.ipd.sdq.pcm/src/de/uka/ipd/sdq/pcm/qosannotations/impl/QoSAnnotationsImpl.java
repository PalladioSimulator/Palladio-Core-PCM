...
public class QoSAnnotationsImpl extends EntityImpl implements QoSAnnotations {
	...
	public NotificationChain basicSetSystem_QoSAnnotations(
			de.uka.ipd.sdq.pcm.system.System newSystem_QoSAnnotations,
	 ...
	 */
	@Override
	public void setSystem_QoSAnnotations(
			de.uka.ipd.sdq.pcm.system.System newSystem_QoSAnnotations) {
		if (newSystem_QoSAnnotations != eInternalContainer()
			...
			if (newSystem_QoSAnnotations != null)
				msgs = ((InternalEObject) newSystem_QoSAnnotations)
						.eInverseAdd(this,
			...
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					QosannotationsPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS,
					newSystem_QoSAnnotations, newSystem_QoSAnnotations));
	}
	 ...
	 */
	@Override
	public boolean MultipleReliabilityAnnotationsPerExternalCallNotAllowed(
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case QosannotationsPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetSystem_QoSAnnotations(
					(de.uka.ipd.sdq.pcm.system.System) otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTIONS_QO_SANNOTATIONS:
			return ((InternalEList<?>) getSpecifiedOutputParameterAbstractions_QoSAnnotations())
					.basicRemove(otherEnd, msgs);
		case QosannotationsPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
			return basicSetSystem_QoSAnnotations(null, msgs);
		case QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS:
			return ((InternalEList<?>) getSpecifiedQoSAnnotations_QoSAnnotations())
					.basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS:
			...
			getSpecifiedQoSAnnotations_QoSAnnotations().addAll(
	...
	public boolean eIsSet(int featureID) {
		...
		case QosannotationsPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS:
			return specifiedQoSAnnotations_QoSAnnotations != null
					&& !specifiedQoSAnnotations_QoSAnnotations.isEmpty();
		}

...
public class AllocationImpl extends EntityImpl implements Allocation {
	...
	public ResourceEnvironment getTargetResourceEnvironment_Allocation() {
		if (targetResourceEnvironment_Allocation != null
				&& ((EObject) targetResourceEnvironment_Allocation).eIsProxy()) {
			...
			if (targetResourceEnvironment_Allocation != oldTargetResourceEnvironment_Allocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldTargetResourceEnvironment_Allocation,
	...
	public void setTargetResourceEnvironment_Allocation(
			ResourceEnvironment newTargetResourceEnvironment_Allocation) {
	...
	public de.uka.ipd.sdq.pcm.system.System getSystem_Allocation() {
		if (system_Allocation != null
				&& ((EObject) system_Allocation).eIsProxy()) {
	 ...
	 */
	@Override
	public void setSystem_Allocation(
			de.uka.ipd.sdq.pcm.system.System newSystem_Allocation) {
	 ...
	 */
	@Override
	public boolean EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce(
	 ...
	 */
	@Override
	public boolean CommunicatingServersHaveToBeConnectedByLinkingResource(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case AllocationPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getAllocationContexts_Allocation())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case AllocationPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
			return ((InternalEList<?>) getAllocationContexts_Allocation())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case AllocationPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
			...
			getAllocationContexts_Allocation().addAll(
					(Collection<? extends AllocationContext>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case AllocationPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
			return allocationContexts_Allocation != null
					&& !allocationContexts_Allocation.isEmpty();
		}

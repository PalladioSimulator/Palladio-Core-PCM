 ...
 * @generated
 */
public class AllocationContextImpl extends EntityImpl implements
		AllocationContext {
	/**
	...
	public ResourceContainer getResourceContainer_AllocationContext() {
		if (resourceContainer_AllocationContext != null
				&& ((EObject) resourceContainer_AllocationContext).eIsProxy()) {
			...
			if (resourceContainer_AllocationContext != oldResourceContainer_AllocationContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldResourceContainer_AllocationContext,
	 ...
	 */
	@Override
	public void setResourceContainer_AllocationContext(
			ResourceContainer newResourceContainer_AllocationContext) {
	...
	public AssemblyContext getAssemblyContext_AllocationContext() {
		if (assemblyContext_AllocationContext != null
				&& ((EObject) assemblyContext_AllocationContext).eIsProxy()) {
			...
			if (assemblyContext_AllocationContext != oldAssemblyContext_AllocationContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldAssemblyContext_AllocationContext,
	 ...
	 */
	@Override
	public void setAssemblyContext_AllocationContext(
			AssemblyContext newAssemblyContext_AllocationContext) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAllocation_AllocationContext(
			Allocation newAllocation_AllocationContext, NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newAllocation_AllocationContext,
	 ...
	 */
	@Override
	public void setAllocation_AllocationContext(
			Allocation newAllocation_AllocationContext) {
		if (newAllocation_AllocationContext != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newAllocation_AllocationContext))
			...
			if (newAllocation_AllocationContext != null)
				msgs = ((InternalEObject) newAllocation_AllocationContext)
						.eInverseAdd(
								this,
								AllocationPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION,
								Allocation.class, msgs);
			msgs = basicSetAllocation_AllocationContext(
					newAllocation_AllocationContext, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public EventChannel getEventChannel__AllocationContext() {
		if (eventChannel__AllocationContext != null
				&& ((EObject) eventChannel__AllocationContext).eIsProxy()) {
			...
			if (eventChannel__AllocationContext != oldEventChannel__AllocationContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldEventChannel__AllocationContext,
	 ...
	 */
	@Override
	public void setEventChannel__AllocationContext(
			EventChannel newEventChannel__AllocationContext) {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case AllocationPackage.ALLOCATION_CONTEXT__ALLOCATION_ALLOCATION_CONTEXT:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetAllocation_AllocationContext((Allocation) otherEnd,
					msgs);
		}

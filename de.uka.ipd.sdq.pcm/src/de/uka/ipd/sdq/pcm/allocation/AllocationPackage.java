...
public interface AllocationPackage extends EPackage {
	 ...
	 * @generated
	 */
	AllocationPackage eINSTANCE = de.uka.ipd.sdq.pcm.allocation.impl.AllocationPackageImpl
			.init();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference ALLOCATION__SYSTEM_ALLOCATION = eINSTANCE
		 ...
		 * @generated
		 */
		EReference ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION = eINSTANCE

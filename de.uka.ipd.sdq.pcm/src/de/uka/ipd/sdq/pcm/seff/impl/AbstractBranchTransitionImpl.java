 ...
 * @generated
 */
public abstract class AbstractBranchTransitionImpl extends EntityImpl implements
	...
	public NotificationChain basicSetBranchAction_AbstractBranchTransition(
			BranchAction newBranchAction_AbstractBranchTransition,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newBranchAction_AbstractBranchTransition,
	 ...
	 */
	@Override
	public void setBranchAction_AbstractBranchTransition(
			BranchAction newBranchAction_AbstractBranchTransition) {
		if (newBranchAction_AbstractBranchTransition != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newBranchAction_AbstractBranchTransition))
			...
			if (newBranchAction_AbstractBranchTransition != null)
				msgs = ((InternalEObject) newBranchAction_AbstractBranchTransition)
						.eInverseAdd(this,
								SeffPackage.BRANCH_ACTION__BRANCHES_BRANCH,
								BranchAction.class, msgs);
			msgs = basicSetBranchAction_AbstractBranchTransition(
					newBranchAction_AbstractBranchTransition, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain basicSetBranchBehaviour_BranchTransition(
			ResourceDemandingBehaviour newBranchBehaviour_BranchTransition,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldBranchBehaviour_BranchTransition,
			...
			if (newBranchBehaviour_BranchTransition != null)
				msgs = ((InternalEObject) newBranchBehaviour_BranchTransition)
						.eInverseAdd(
								...
								SeffPackage.RESOURCE_DEMANDING_BEHAVIOUR__ABSTRACT_BRANCH_TRANSITION_RESOURCE_DEMANDING_BEHAVIOUR,
								ResourceDemandingBehaviour.class, msgs);
			msgs = basicSetBranchBehaviour_BranchTransition(
					newBranchBehaviour_BranchTransition, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetBranchAction_AbstractBranchTransition(
					(BranchAction) otherEnd, msgs);
				...
				msgs = ((InternalEObject) branchBehaviour_BranchTransition)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- SeffPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_BEHAVIOUR_BRANCH_TRANSITION,
								null, msgs);
			return basicSetBranchBehaviour_BranchTransition(

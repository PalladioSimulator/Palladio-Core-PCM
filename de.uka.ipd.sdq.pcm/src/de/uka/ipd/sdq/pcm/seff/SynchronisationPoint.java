...
public interface SynchronisationPoint extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.parameter.SetVariable#getSynchronisationPoint_VariableUsage <em>Synchronisation Point Variable Usage</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @generated
	 */
	EList<SetVariable> getOutputParameterUsage_SynchronisationPoint();

	/**
	 * Returns the value of the '<em><b>Fork Action Synchronisation Point</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.seff.ForkAction#getSynchronisingBehaviours_ForkAction <em>Synchronising Behaviours Fork Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.seff.SynchronisationPoint#getForkAction_SynchronisationPoint <em>Fork Action Synchronisation Point</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

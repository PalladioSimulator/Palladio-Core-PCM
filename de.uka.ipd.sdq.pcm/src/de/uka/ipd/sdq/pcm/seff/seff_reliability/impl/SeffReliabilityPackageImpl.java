 ...
 * @generated
 */
public class SeffReliabilityPackageImpl extends EPackageImpl implements
	 ...
	 * 
	 * <p>This method is used to initialize {@link SeffReliabilityPackage#eINSTANCE} when that field is accessed.
	...
	public static SeffReliabilityPackage init() {
		if (isInited)
			return (SeffReliabilityPackage) EPackage.Registry.INSTANCE
		...
		SeffReliabilityPackageImpl theSeffReliabilityPackage = (SeffReliabilityPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof SeffReliabilityPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new SeffReliabilityPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(SeffReliabilityPackage.eNS_URI,
				theSeffReliabilityPackage);
	...
	public EReference getRecoveryActionBehaviour_FailureHandlingAlternatives__RecoveryActionBehaviour() {
		return (EReference) recoveryActionBehaviourEClass
	...
	public EReference getRecoveryAction_PrimaryBehaviour__RecoveryAction() {
		return (EReference) recoveryActionEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getFailureHandlingEntity_FailureTypes_FailureHandlingEntity() {
		return (EReference) failureHandlingEntityEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(recoveryActionEClass,
				RECOVERY_ACTION__PRIMARY_BEHAVIOUR_RECOVERY_ACTION);
		createEReference(recoveryActionEClass,
		...
		createEReference(failureHandlingEntityEClass,
	...
	public void initializePackageContents() {
		...
		recoveryActionBehaviourEClass.getESuperTypes().add(
				this.getFailureHandlingEntity());
		recoveryActionBehaviourEClass.getESuperTypes().add(
				theSeffPackage.getResourceDemandingBehaviour());
		recoveryActionEClass.getESuperTypes().add(
				theSeffPackage.getAbstractInternalControlFlowAction());
		failureHandlingEntityEClass.getESuperTypes().add(
				theEntityPackage.getEntity());

		// Initialize classes and features; add operations and parameters
		initEClass(recoveryActionBehaviourEClass,
				RecoveryActionBehaviour.class, "RecoveryActionBehaviour",
		...
		initEReference(
				...
				"failureHandlingAlternatives__RecoveryActionBehaviour", null,
				0, -1, RecoveryActionBehaviour.class, !IS_TRANSIENT,
		...
		initEReference(
				...
				"recoveryAction__RecoveryActionBehaviour", null, 1, 1,
				RecoveryActionBehaviour.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		EOperation op = addEOperation(recoveryActionBehaviourEClass,
				ecorePackage.getEBoolean(),
				"RecoveryActionBehaviourHasOnlyOnePredecessor", 0, 1,
		...
		op = addEOperation(recoveryActionBehaviourEClass,
				ecorePackage.getEBoolean(),
				"RecoveryActionBehaviourIsNotSuccessorOfItself", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(recoveryActionEClass, RecoveryAction.class,
				"RecoveryAction", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRecoveryAction_PrimaryBehaviour__RecoveryAction(),
				this.getRecoveryActionBehaviour(), null,
				"primaryBehaviour__RecoveryAction", null, 1, 1,
				RecoveryAction.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(
				...
				"recoveryActionBehaviours__RecoveryAction", null, 2, -1,
				RecoveryAction.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		op = addEOperation(recoveryActionEClass, ecorePackage.getEBoolean(),
				"PrimaryBehaviourOfRecoveryActionMustBeSet", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		initEClass(failureHandlingEntityEClass, FailureHandlingEntity.class,
				"FailureHandlingEntity", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(
				getFailureHandlingEntity_FailureTypes_FailureHandlingEntity(),
				theReliabilityPackage.getFailureType(), null,
				"failureTypes_FailureHandlingEntity", null, 0, -1,
				FailureHandlingEntity.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	}

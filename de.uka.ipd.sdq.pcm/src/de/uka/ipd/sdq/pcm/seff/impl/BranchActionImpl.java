 ...
 * @generated
 */
public class BranchActionImpl extends AbstractInternalControlFlowActionImpl
	...
	public EList<AbstractBranchTransition> getBranches_Branch() {
		if (branches_Branch == null) {
			branches_Branch = new EObjectContainmentWithInverseEList<AbstractBranchTransition>(
					AbstractBranchTransition.class,
					this,
	 ...
	 */
	@Override
	public boolean EitherGuardedBranchesOrProbabilisiticBranchTransitions(
	 ...
	 */
	@Override
	public boolean AllProbabilisticBranchProbabilitiesMustSumUpTo1(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV
				.createQuery(
						ALL_PROBABILISTIC_BRANCH_PROBABILITIES_MUST_SUM_UP_TO1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case SeffPackage.BRANCH_ACTION__BRANCHES_BRANCH:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getBranches_Branch())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case SeffPackage.BRANCH_ACTION__BRANCHES_BRANCH:
			return ((InternalEList<?>) getBranches_Branch()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case SeffPackage.BRANCH_ACTION__BRANCHES_BRANCH:
			...
			getBranches_Branch().addAll(
					(Collection<? extends AbstractBranchTransition>) newValue);
			return;
		}

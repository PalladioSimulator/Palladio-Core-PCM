...
public interface SeffPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Set Variable Inputs Call Action</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int EXTERNAL_CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION = ABSTRACT_ACTION_FEATURE_COUNT + 0;

	/**
	 * The feature id for the '<em><b>Set Variable Returns Call Return Action</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int EXTERNAL_CALL_ACTION__SET_VARIABLE_RETURNS_CALL_RETURN_ACTION = ABSTRACT_ACTION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION = 0;
	 ...
	 * @ordered
	 */
	int CALL_RETURN_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION = CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION;
	 ...
	 * @ordered
	 */
	int CALL_RETURN_ACTION__SET_VARIABLE_RETURNS_CALL_RETURN_ACTION = CALL_ACTION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int COLLECTION_ITERATOR_ACTION_FEATURE_COUNT = ABSTRACT_LOOP_ACTION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INTERNAL_CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION = CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION;
	 ...
	 * @ordered
	 */
	int EMIT_EVENT_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION = ABSTRACT_ACTION_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.pcm.seff.CallReturnAction#getSetVariableReturns__CallReturnAction <em>Set Variable Returns Call Return Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Set Variable Returns Call Return Action</em>'.
	 * @see de.uka.ipd.sdq.pcm.seff.CallReturnAction#getSetVariableReturns__CallReturnAction()
	 * @see #getCallReturnAction()
	 * @generated
	 */
	EReference getCallReturnAction_SetVariableReturns__CallReturnAction();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.pcm.seff.CallAction#getSetVariableInputs__CallAction <em>Set Variable Inputs Call Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Set Variable Inputs Call Action</em>'.
	 * @see de.uka.ipd.sdq.pcm.seff.CallAction#getSetVariableInputs__CallAction()
	 * @see #getCallAction()
	 * @generated
	 */
	EReference getCallAction_SetVariableInputs__CallAction();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Set Variable Returns Call Return Action</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CALL_RETURN_ACTION__SET_VARIABLE_RETURNS_CALL_RETURN_ACTION = eINSTANCE.getCallReturnAction_SetVariableReturns__CallReturnAction();
		...
		/**
		 * The meta object literal for the '<em><b>Set Variable Inputs Call Action</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION = eINSTANCE.getCallAction_SetVariableInputs__CallAction();

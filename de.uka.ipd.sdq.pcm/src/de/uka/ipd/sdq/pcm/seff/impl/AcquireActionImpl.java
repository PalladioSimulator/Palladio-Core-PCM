 ...
 * @generated
 */
public class AcquireActionImpl extends AbstractInternalControlFlowActionImpl
		implements AcquireAction {
	/**
	...
	public PassiveResource getPassiveresource_AcquireAction() {
		if (passiveresource_AcquireAction != null
				&& ((EObject) passiveresource_AcquireAction).eIsProxy()) {
			...
			if (passiveresource_AcquireAction != oldPassiveresource_AcquireAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldPassiveresource_AcquireAction,
	 ...
	 */
	@Override
	public void setPassiveresource_AcquireAction(
			PassiveResource newPassiveresource_AcquireAction) {
	...
	public void setTimeout(boolean newTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SeffPackage.ACQUIRE_ACTION__TIMEOUT, oldTimeout, timeout));
	}
	...
	public void setTimeoutValue(double newTimeoutValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SeffPackage.ACQUIRE_ACTION__TIMEOUT_VALUE, oldTimeoutValue,
					timeoutValue));
	}
	 ...
	 */
	@Override
	public boolean TimeoutValueOfAcquireActionMustNotBeNegative(
		...
		if (!EOCL_ENV
				.createQuery(
						TIMEOUT_VALUE_OF_ACQUIRE_ACTION_MUST_NOT_BE_NEGATIVE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics

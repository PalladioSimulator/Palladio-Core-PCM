 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.ForkedBehaviour#getSynchronisationPoint_ForkedBehaviour <em>Synchronisation Point Forked Behaviour</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.ForkedBehaviour#getNumberOfForks__ForkedBehaviour <em>Number Of Forks Forked Behaviour</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.ForkedBehaviour#getForkAction_ForkedBehaivour <em>Fork Action Forked Behaivour</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ForkedBehaviour extends ResourceDemandingBehaviour {
    ...
    /**
	 * Returns the value of the '<em><b>Number Of Forks Forked Behaviour</b></em>' containment reference.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getForkedBehaviour__PCMRandomVariable <em>Forked Behaviour PCM Random Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Number Of Forks Forked Behaviour</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Number Of Forks Forked Behaviour</em>' containment reference.
	 * @see #setNumberOfForks__ForkedBehaviour(PCMRandomVariable)
	 * @see de.uka.ipd.sdq.pcm.seff.SeffPackage#getForkedBehaviour_NumberOfForks__ForkedBehaviour()
	 * @see de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getForkedBehaviour__PCMRandomVariable
	 * @model opposite="forkedBehaviour__PCMRandomVariable" containment="true" ordered="false"
	 * @generated
	 */
	PCMRandomVariable getNumberOfForks__ForkedBehaviour();

				/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.seff.ForkedBehaviour#getNumberOfForks__ForkedBehaviour <em>Number Of Forks Forked Behaviour</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Number Of Forks Forked Behaviour</em>' containment reference.
	 * @see #getNumberOfForks__ForkedBehaviour()
	 * @generated
	 */
	void setNumberOfForks__ForkedBehaviour(PCMRandomVariable value);

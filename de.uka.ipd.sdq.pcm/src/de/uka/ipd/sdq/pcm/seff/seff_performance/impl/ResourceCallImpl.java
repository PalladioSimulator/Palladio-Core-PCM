...
public class ResourceCallImpl extends CallActionImpl implements ResourceCall {
	...
	public NotificationChain basicSetAction__ResourceCall(
			AbstractInternalControlFlowAction newAction__ResourceCall,
	 ...
	 */
	@Override
	public void setAction__ResourceCall(
			AbstractInternalControlFlowAction newAction__ResourceCall) {
		if (newAction__ResourceCall != eInternalContainer()
			...
			if (newAction__ResourceCall != null)
				msgs = ((InternalEObject) newAction__ResourceCall)
						.eInverseAdd(
								this,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					SeffPerformancePackage.RESOURCE_CALL__ACTION_RESOURCE_CALL,
					newAction__ResourceCall, newAction__ResourceCall));
	}
	...
	public ResourceRequiredRole getResourceRequiredRole__ResourceCall() {
		if (resourceRequiredRole__ResourceCall != null
				&& ((EObject) resourceRequiredRole__ResourceCall).eIsProxy()) {
			...
			if (resourceRequiredRole__ResourceCall != oldResourceRequiredRole__ResourceCall) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldResourceRequiredRole__ResourceCall,
	...
	public void setResourceRequiredRole__ResourceCall(
			ResourceRequiredRole newResourceRequiredRole__ResourceCall) {
	...
	public ResourceSignature getSignature__ResourceCall() {
		if (signature__ResourceCall != null
				&& ((EObject) signature__ResourceCall).eIsProxy()) {
			...
			if (signature__ResourceCall != oldSignature__ResourceCall) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							SeffPerformancePackage.RESOURCE_CALL__SIGNATURE_RESOURCE_CALL,
							oldSignature__ResourceCall, signature__ResourceCall));
			}
		}
	 ...
	 */
	@Override
	public void setSignature__ResourceCall(
			ResourceSignature newSignature__ResourceCall) {
	...
	public NotificationChain basicSetNumberOfCalls__ResourceCall(
			PCMRandomVariable newNumberOfCalls__ResourceCall,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldNumberOfCalls__ResourceCall,
	...
	public void setNumberOfCalls__ResourceCall(
		...
		if (newNumberOfCalls__ResourceCall != numberOfCalls__ResourceCall) {
			...
			if (newNumberOfCalls__ResourceCall != null)
				msgs = ((InternalEObject) newNumberOfCalls__ResourceCall)
						.eInverseAdd(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__RESOURCE_CALL_PCM_RANDOM_VARIABLE,
								PCMRandomVariable.class, msgs);
			msgs = basicSetNumberOfCalls__ResourceCall(
					newNumberOfCalls__ResourceCall, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	 ...
	 */
	@Override
	public boolean ResourceSignatureBelongsToResourceRequiredRole(
		...
		if (!EOCL_ENV
				.createQuery(
						RESOURCE_SIGNATURE_BELONGS_TO_RESOURCE_REQUIRED_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
	 ...
	 */
	@Override
	public boolean ResourceRequiredRoleMustBeReferencedByComponent(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV
				.createQuery(
						RESOURCE_REQUIRED_ROLE_MUST_BE_REFERENCED_BY_COMPONENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case SeffPerformancePackage.RESOURCE_CALL__ACTION_RESOURCE_CALL:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetAction__ResourceCall(
					(AbstractInternalControlFlowAction) otherEnd, msgs);
				...
				msgs = ((InternalEObject) numberOfCalls__ResourceCall)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- SeffPerformancePackage.RESOURCE_CALL__NUMBER_OF_CALLS_RESOURCE_CALL,
								null, msgs);
			return basicSetNumberOfCalls__ResourceCall(

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.seff_performance.impl.ParametricResourceDemandImpl#getSpecification_ParametericResourceDemand <em>Specification Parameteric Resource Demand</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.seff_performance.impl.ParametricResourceDemandImpl#getRequiredResource_ParametricResourceDemand <em>Required Resource Parametric Resource Demand</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.seff_performance.impl.ParametricResourceDemandImpl#getAction_ParametricResourceDemand <em>Action Parametric Resource Demand</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ParametricResourceDemandImpl extends EStereotypableObjectImpl
		implements ParametricResourceDemand {
	/**
	...
	public NotificationChain basicSetSpecification_ParametericResourceDemand(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldSpecification_ParametericResourceDemand,
	...
	public void setSpecification_ParametericResourceDemand(
		...
		if (newSpecification_ParametericResourceDemand != specification_ParametericResourceDemand) {
			...
			if (newSpecification_ParametericResourceDemand != null)
				msgs = ((InternalEObject) newSpecification_ParametericResourceDemand)
						.eInverseAdd(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__PARAMETRIC_RESOURCE_DEMAND_PCM_RANDOM_VARIABLE,
								PCMRandomVariable.class, msgs);
			msgs = basicSetSpecification_ParametericResourceDemand(
					newSpecification_ParametericResourceDemand, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public ProcessingResourceType getRequiredResource_ParametricResourceDemand() {
		if (requiredResource_ParametricResourceDemand != null
				&& ((EObject) requiredResource_ParametricResourceDemand)
						.eIsProxy()) {
	...
	public NotificationChain basicSetAction_ParametricResourceDemand(
		...
		msgs = eBasicSetContainer(
				(InternalEObject) newAction_ParametricResourceDemand,
	...
	public void setAction_ParametricResourceDemand(
		...
		if (newAction_ParametricResourceDemand != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newAction_ParametricResourceDemand))
			...
			if (newAction_ParametricResourceDemand != null)
				msgs = ((InternalEObject) newAction_ParametricResourceDemand)
						.eInverseAdd(
								this,
								SeffPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__RESOURCE_DEMAND_ACTION,
								AbstractInternalControlFlowAction.class, msgs);
			msgs = basicSetAction_ParametricResourceDemand(
					newAction_ParametricResourceDemand, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(

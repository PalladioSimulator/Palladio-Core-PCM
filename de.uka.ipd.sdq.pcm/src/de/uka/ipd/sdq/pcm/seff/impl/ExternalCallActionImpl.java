 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.impl.ExternalCallActionImpl#getSetVariableInputs__CallAction <em>Set Variable Inputs Call Action</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.impl.ExternalCallActionImpl#getSetVariableReturns__CallReturnAction <em>Set Variable Returns Call Return Action</em>}</li>
...
public class ExternalCallActionImpl extends AbstractActionImpl implements ExternalCallAction {
	...
	public EList<SetVariable> getSetVariableInputs__CallAction() {
		if (setVariableInputs__CallAction == null) {
			setVariableInputs__CallAction = new EObjectContainmentWithInverseEList<SetVariable>(SetVariable.class, this, SeffPackage.EXTERNAL_CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION, ParameterPackage.SET_VARIABLE__CALL_ACTION_SET_VARIABLE);
		}
	...
	public EList<SetVariable> getSetVariableReturns__CallReturnAction() {
		if (setVariableReturns__CallReturnAction == null) {
			setVariableReturns__CallReturnAction = new EObjectContainmentWithInverseEList<SetVariable>(SetVariable.class, this, SeffPackage.EXTERNAL_CALL_ACTION__SET_VARIABLE_RETURNS_CALL_RETURN_ACTION, ParameterPackage.SET_VARIABLE__CALL_RETURN_ACTION_SET_VARIABLE);
		}
	 ...
	 * @ordered
	 */
	protected static final String SIGNATURE_BELONGS_TO_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.role_ExternalService.requiredInterface__RequiredRole.signatures__OperationInterface->includes(self.calledService_ExternalService)";
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SeffPackage.EXTERNAL_CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getSetVariableInputs__CallAction()).basicAdd(otherEnd, msgs);
			case SeffPackage.EXTERNAL_CALL_ACTION__SET_VARIABLE_RETURNS_CALL_RETURN_ACTION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CallAction.class) {
			switch (derivedFeatureID) {
				case SeffPackage.EXTERNAL_CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION: return SeffPackage.CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION;
				default: return -1;
			}
		}
		if (baseClass == CallReturnAction.class) {
			switch (derivedFeatureID) {
				case SeffPackage.EXTERNAL_CALL_ACTION__SET_VARIABLE_RETURNS_CALL_RETURN_ACTION: return SeffPackage.CALL_RETURN_ACTION__SET_VARIABLE_RETURNS_CALL_RETURN_ACTION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CallAction.class) {
			switch (baseFeatureID) {
				case SeffPackage.CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION: return SeffPackage.EXTERNAL_CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION;
				default: return -1;
			}
		}
		if (baseClass == CallReturnAction.class) {
			switch (baseFeatureID) {
				case SeffPackage.CALL_RETURN_ACTION__SET_VARIABLE_RETURNS_CALL_RETURN_ACTION: return SeffPackage.EXTERNAL_CALL_ACTION__SET_VARIABLE_RETURNS_CALL_RETURN_ACTION;
				default: return -1;
			}
		}
		if (baseClass == FailureHandlingEntity.class) {

 ...
 * @generated
 */
public class StartActionImpl extends AbstractInternalControlFlowActionImpl
	 ...
	 */
	@Override
	public boolean StartActionPredecessorMustNotBeDefined(
		...
		if (!EOCL_ENV
				.createQuery(
						START_ACTION_PREDECESSOR_MUST_NOT_BE_DEFINED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics

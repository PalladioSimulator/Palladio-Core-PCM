...
public class Seff_performancePackageImpl extends EPackageImpl implements Seff_performancePackage {
	 ...
	 * @see de.uka.ipd.sdq.pcm.seff.seff_performance.Seff_performancePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static Seff_performancePackage init() {
		...
		Seff_performancePackageImpl theSeff_performancePackage = (Seff_performancePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Seff_performancePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Seff_performancePackageImpl());

...
public class SeffPackageImpl extends EPackageImpl implements SeffPackage {
	 ...
	 * @generated
	 */
	public EReference getForkedBehaviour_NumberOfForks__ForkedBehaviour() {
    ...
    public EReference getForkedBehaviour_ForkAction_ForkedBehaivour() {
		return (EReference)forkedBehaviourEClass.getEStructuralFeatures().get(2);
	}
    ...
    public void createPackageContents() {
		...
		createEReference(forkedBehaviourEClass, FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR);
    ...
    public void initializePackageContents() {
		...
		initEReference(getForkedBehaviour_NumberOfForks__ForkedBehaviour(), theCorePackage.getPCMRandomVariable(), theCorePackage.getPCMRandomVariable_ForkedBehaviour__PCMRandomVariable(), "numberOfForks__ForkedBehaviour", null, 0, 1, ForkedBehaviour.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

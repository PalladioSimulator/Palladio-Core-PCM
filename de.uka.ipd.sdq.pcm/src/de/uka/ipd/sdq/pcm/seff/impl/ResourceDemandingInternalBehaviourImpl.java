 ...
 * @generated
 */
public class ResourceDemandingInternalBehaviourImpl extends
		ResourceDemandingBehaviourImpl implements
	...
	public void setResourceDemandingSEFF_ResourceDemandingInternalBehaviour(
		...
		if (newResourceDemandingSEFF_ResourceDemandingInternalBehaviour != eInternalContainer()
			...
			if (EcoreUtil
					.isAncestor(
							this,
							(EObject) newResourceDemandingSEFF_ResourceDemandingInternalBehaviour))
			...
			if (newResourceDemandingSEFF_ResourceDemandingInternalBehaviour != null)
				msgs = ((InternalEObject) newResourceDemandingSEFF_ResourceDemandingInternalBehaviour)
						.eInverseAdd(
								this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case SeffPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR__RESOURCE_DEMANDING_SEFF_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetResourceDemandingSEFF_ResourceDemandingInternalBehaviour(

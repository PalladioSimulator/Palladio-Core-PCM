 ...
 * @generated
 */
public abstract class ServiceEffectSpecificationImpl extends
		EStereotypableObjectImpl implements ServiceEffectSpecification {
	/**
	...
	public void setSeffTypeID(String newSeffTypeID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SeffPackage.SERVICE_EFFECT_SPECIFICATION__SEFF_TYPE_ID,

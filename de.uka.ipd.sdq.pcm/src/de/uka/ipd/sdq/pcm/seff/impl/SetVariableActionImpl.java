...
public class SetVariableActionImpl extends AbstractInternalControlFlowActionImpl implements SetVariableAction {
	 ...
	 * @ordered
	 */
	protected EList<SetVariable> localVariableUsages_SetVariableAction;
	 ...
	 * @generated
	 */
	public EList<SetVariable> getLocalVariableUsages_SetVariableAction() {
		if (localVariableUsages_SetVariableAction == null) {
			localVariableUsages_SetVariableAction = new EObjectContainmentWithInverseEList<SetVariable>(SetVariable.class, this, SeffPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION, ParameterPackage.SET_VARIABLE__SET_VARIABLE_ACTION_VARIABLE_USAGE);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SeffPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION:
				...
				getLocalVariableUsages_SetVariableAction().addAll((Collection<? extends SetVariable>)newValue);
				return;
		}

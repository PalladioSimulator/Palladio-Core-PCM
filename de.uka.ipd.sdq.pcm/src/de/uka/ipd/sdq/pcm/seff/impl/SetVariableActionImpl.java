 ...
 * @generated
 */
public class SetVariableActionImpl extends
		AbstractInternalControlFlowActionImpl implements SetVariableAction {
	/**
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case SeffPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION:
			return ((InternalEList<?>) getLocalVariableUsages_SetVariableAction())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case SeffPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION:
			...
			getLocalVariableUsages_SetVariableAction().addAll(
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case SeffPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION:
			return localVariableUsages_SetVariableAction != null
					&& !localVariableUsages_SetVariableAction.isEmpty();
		}

 ...
 * @generated
 */
public class InfrastructureCallImpl extends CallActionImpl implements
		InfrastructureCall {
	/**
	...
	public InfrastructureSignature getSignature__InfrastructureCall() {
		if (signature__InfrastructureCall != null
				&& ((EObject) signature__InfrastructureCall).eIsProxy()) {
			...
			if (signature__InfrastructureCall != oldSignature__InfrastructureCall) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldSignature__InfrastructureCall,
	 ...
	 */
	@Override
	public void setSignature__InfrastructureCall(
			InfrastructureSignature newSignature__InfrastructureCall) {
	...
	public NotificationChain basicSetNumberOfCalls__InfrastructureCall(
			PCMRandomVariable newNumberOfCalls__InfrastructureCall,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldNumberOfCalls__InfrastructureCall,
	...
	public void setNumberOfCalls__InfrastructureCall(
		...
		if (newNumberOfCalls__InfrastructureCall != numberOfCalls__InfrastructureCall) {
			...
			if (newNumberOfCalls__InfrastructureCall != null)
				msgs = ((InternalEObject) newNumberOfCalls__InfrastructureCall)
						.eInverseAdd(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__INFRASTRUCTURE_CALL_PCM_RANDOM_VARIABLE,
								PCMRandomVariable.class, msgs);
			msgs = basicSetNumberOfCalls__InfrastructureCall(
					newNumberOfCalls__InfrastructureCall, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public AbstractInternalControlFlowAction getAction__InfrastructureCall() {
		if (eContainerFeatureID() != SeffPerformancePackage.INFRASTRUCTURE_CALL__ACTION_INFRASTRUCTURE_CALL)
			return null;
	...
	public NotificationChain basicSetAction__InfrastructureCall(
			AbstractInternalControlFlowAction newAction__InfrastructureCall,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newAction__InfrastructureCall,
	 ...
	 */
	@Override
	public void setAction__InfrastructureCall(
			AbstractInternalControlFlowAction newAction__InfrastructureCall) {
		if (newAction__InfrastructureCall != eInternalContainer()
				|| (eContainerFeatureID() != SeffPerformancePackage.INFRASTRUCTURE_CALL__ACTION_INFRASTRUCTURE_CALL && newAction__InfrastructureCall != null)) {
			if (EcoreUtil.isAncestor(this,
					(EObject) newAction__InfrastructureCall))
			...
			if (newAction__InfrastructureCall != null)
				msgs = ((InternalEObject) newAction__InfrastructureCall)
						.eInverseAdd(
								this,
			...
			msgs = basicSetAction__InfrastructureCall(
					newAction__InfrastructureCall, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public InfrastructureRequiredRole getRequiredRole__InfrastructureCall() {
		if (requiredRole__InfrastructureCall != null
				&& ((EObject) requiredRole__InfrastructureCall).eIsProxy()) {
			...
			if (requiredRole__InfrastructureCall != oldRequiredRole__InfrastructureCall) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldRequiredRole__InfrastructureCall,
	...
	public void setRequiredRole__InfrastructureCall(
			InfrastructureRequiredRole newRequiredRole__InfrastructureCall) {
	 ...
	 */
	@Override
	public boolean SignatureMustBelongToUsedRequiredRole(
		...
		if (!EOCL_ENV
				.createQuery(
						SIGNATURE_MUST_BELONG_TO_USED_REQUIRED_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
	 ...
	 */
	@Override
	public boolean ReferencedRequiredRoleMustBeRequiredByComponent(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV
				.createQuery(
						REFERENCED_REQUIRED_ROLE_MUST_BE_REQUIRED_BY_COMPONENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case SeffPerformancePackage.INFRASTRUCTURE_CALL__SIGNATURE_INFRASTRUCTURE_CALL:
			if (resolve)
				return getSignature__InfrastructureCall();
		...
		case SeffPerformancePackage.INFRASTRUCTURE_CALL__REQUIRED_ROLE_INFRASTRUCTURE_CALL:
			if (resolve)
				return getRequiredRole__InfrastructureCall();

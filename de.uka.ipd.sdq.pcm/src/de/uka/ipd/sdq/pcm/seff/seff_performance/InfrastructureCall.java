 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.seff_performance.InfrastructureCall#getSignature__InfrastructureCall <em>Signature Infrastructure Call</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.seff_performance.InfrastructureCall#getNumberOfCalls__InfrastructureCall <em>Number Of Calls Infrastructure Call</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.seff_performance.InfrastructureCall#getAction__InfrastructureCall <em>Action Infrastructure Call</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.seff_performance.InfrastructureCall#getRequiredRole__InfrastructureCall <em>Required Role Infrastructure Call</em>}</li>
 * </ul>
 * </p>
 *
...
public interface InfrastructureCall extends CallAction {
	 ...
	 * @generated
	 */
	boolean SignatureMustBelongToUsedRequiredRole(DiagnosticChain diagnostics,
	 ...
	 * @generated
	 */
	boolean ReferencedRequiredRoleMustBeRequiredByComponent(
	 ...
	 * @generated
	 */
	boolean SignatureRoleCombinationMustBeUniqueWithinAbstractInternalControlFlowAction(
			DiagnosticChain diagnostics, Map<Object, Object> context);

 ...
 * @generated
 */
public class EmitEventActionImpl extends AbstractActionImpl implements
		EmitEventAction {
	/**
	...
	public EventType getEventType__EmitEventAction() {
		if (eventType__EmitEventAction != null
				&& ((EObject) eventType__EmitEventAction).eIsProxy()) {
			...
			if (eventType__EmitEventAction != oldEventType__EmitEventAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							SeffPackage.EMIT_EVENT_ACTION__EVENT_TYPE_EMIT_EVENT_ACTION,
							oldEventType__EmitEventAction,
	 ...
	 */
	@Override
	public void setEventType__EmitEventAction(
			EventType newEventType__EmitEventAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					SeffPackage.EMIT_EVENT_ACTION__EVENT_TYPE_EMIT_EVENT_ACTION,
					oldEventType__EmitEventAction, eventType__EmitEventAction));
	}
	...
	public SourceRole getSourceRole__EmitEventAction() {
		if (sourceRole__EmitEventAction != null
				&& ((EObject) sourceRole__EmitEventAction).eIsProxy()) {
			...
			if (sourceRole__EmitEventAction != oldSourceRole__EmitEventAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldSourceRole__EmitEventAction,
	 ...
	 */
	@Override
	public void setSourceRole__EmitEventAction(
			SourceRole newSourceRole__EmitEventAction) {

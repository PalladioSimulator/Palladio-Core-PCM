 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.impl.EmitEventActionImpl#getVariableSetterInputs__CallAction <em>Variable Setter Inputs Call Action</em>}</li>
...
public class EmitEventActionImpl extends AbstractActionImpl implements EmitEventAction {
	...
	public EList<VariableSetter> getVariableSetterInputs__CallAction() {
		if (variableSetterInputs__CallAction == null) {
			variableSetterInputs__CallAction = new EObjectContainmentWithInverseEList<VariableSetter>(VariableSetter.class, this, SeffPackage.EMIT_EVENT_ACTION__VARIABLE_SETTER_INPUTS_CALL_ACTION, ParameterPackage.VARIABLE_SETTER__CALL_ACTION_VARIABLE_SETTER);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SeffPackage.EMIT_EVENT_ACTION__VARIABLE_SETTER_INPUTS_CALL_ACTION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CallAction.class) {
			switch (derivedFeatureID) {
				case SeffPackage.EMIT_EVENT_ACTION__VARIABLE_SETTER_INPUTS_CALL_ACTION: return SeffPackage.CALL_ACTION__VARIABLE_SETTER_INPUTS_CALL_ACTION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CallAction.class) {
			switch (baseFeatureID) {
				case SeffPackage.CALL_ACTION__VARIABLE_SETTER_INPUTS_CALL_ACTION: return SeffPackage.EMIT_EVENT_ACTION__VARIABLE_SETTER_INPUTS_CALL_ACTION;
				default: return -1;
			}
		}

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.impl.EmitEventActionImpl#getSetVariableInputs__CallAction <em>Set Variable Inputs Call Action</em>}</li>
...
public class EmitEventActionImpl extends AbstractActionImpl implements EmitEventAction {
	...
	public EList<SetVariable> getSetVariableInputs__CallAction() {
		if (setVariableInputs__CallAction == null) {
			setVariableInputs__CallAction = new EObjectContainmentWithInverseEList<SetVariable>(SetVariable.class, this, SeffPackage.EMIT_EVENT_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION, ParameterPackage.SET_VARIABLE__CALL_ACTION_SET_VARIABLE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SeffPackage.EMIT_EVENT_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CallAction.class) {
			switch (derivedFeatureID) {
				case SeffPackage.EMIT_EVENT_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION: return SeffPackage.CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CallAction.class) {
			switch (baseFeatureID) {
				case SeffPackage.CALL_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION: return SeffPackage.EMIT_EVENT_ACTION__SET_VARIABLE_INPUTS_CALL_ACTION;
				default: return -1;
			}
		}

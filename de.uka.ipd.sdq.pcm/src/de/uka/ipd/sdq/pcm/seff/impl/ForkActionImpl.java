...
public class ForkActionImpl extends AbstractInternalControlFlowActionImpl implements ForkAction {
	...
	public EList<ForkedBehaviour> getAsynchronousForkedBehaviours_ForkAction() {
		if (asynchronousForkedBehaviours_ForkAction == null) {
			asynchronousForkedBehaviours_ForkAction = new EObjectContainmentWithInverseEList<ForkedBehaviour>(ForkedBehaviour.class, this, SeffPackage.FORK_ACTION__ASYNCHRONOUS_FORKED_BEHAVIOURS_FORK_ACTION, SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR);
		}
	...
	public NotificationChain basicSetSynchronisingBehaviours_ForkAction(SynchronisationPoint newSynchronisingBehaviours_ForkAction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SeffPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, oldSynchronisingBehaviours_ForkAction, newSynchronisingBehaviours_ForkAction);
	...
	public void setSynchronisingBehaviours_ForkAction(SynchronisationPoint newSynchronisingBehaviours_ForkAction) {
		if (newSynchronisingBehaviours_ForkAction != synchronisingBehaviours_ForkAction) {
			...
			if (synchronisingBehaviours_ForkAction != null)
				msgs = ((InternalEObject)synchronisingBehaviours_ForkAction).eInverseRemove(this, SeffPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT, SynchronisationPoint.class, msgs);
			if (newSynchronisingBehaviours_ForkAction != null)
				msgs = ((InternalEObject)newSynchronisingBehaviours_ForkAction).eInverseAdd(this, SeffPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT, SynchronisationPoint.class, msgs);
			msgs = basicSetSynchronisingBehaviours_ForkAction(newSynchronisingBehaviours_ForkAction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SeffPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, newSynchronisingBehaviours_ForkAction, newSynchronisingBehaviours_ForkAction));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SeffPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION:
				if (synchronisingBehaviours_ForkAction != null)
					msgs = ((InternalEObject)synchronisingBehaviours_ForkAction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SeffPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, null, msgs);

 ...
 * @generated
 */
public class LoopActionImpl extends AbstractLoopActionImpl implements
		LoopAction {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIterationCount_LoopAction(
			PCMRandomVariable newIterationCount_LoopAction,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldIterationCount_LoopAction, newIterationCount_LoopAction);
			if (msgs == null)
				msgs = notification;
			else
			...
			if (newIterationCount_LoopAction != null)
				msgs = ((InternalEObject) newIterationCount_LoopAction)
						.eInverseAdd(
								...
								CorePackage.PCM_RANDOM_VARIABLE__LOOP_ACTION_PCM_RANDOM_VARIABLE,
								PCMRandomVariable.class, msgs);
			msgs = basicSetIterationCount_LoopAction(
					newIterationCount_LoopAction, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SeffPackage.LOOP_ACTION__ITERATION_COUNT_LOOP_ACTION,
					newIterationCount_LoopAction, newIterationCount_LoopAction));
	}
				...
				msgs = ((InternalEObject) iterationCount_LoopAction)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- SeffPackage.LOOP_ACTION__ITERATION_COUNT_LOOP_ACTION,
								null, msgs);
			return basicSetIterationCount_LoopAction(

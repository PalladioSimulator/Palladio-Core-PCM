 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.seff.impl.ForkedBehaviourImpl#getNumberOfForks__ForkedBehaviour <em>Number Of Forks Forked Behaviour</em>}</li>
...
public class ForkedBehaviourImpl extends ResourceDemandingBehaviourImpl implements ForkedBehaviour {
    ...
    /**
	 * The cached value of the '{@link #getNumberOfForks__ForkedBehaviour() <em>Number Of Forks Forked Behaviour</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getNumberOfForks__ForkedBehaviour()
	 * @generated
	 * @ordered
	 */
	protected PCMRandomVariable numberOfForks__ForkedBehaviour;
	 ...
	 * @generated
	 */
	public PCMRandomVariable getNumberOfForks__ForkedBehaviour() {
		return numberOfForks__ForkedBehaviour;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNumberOfForks__ForkedBehaviour(PCMRandomVariable newNumberOfForks__ForkedBehaviour, NotificationChain msgs) {
		PCMRandomVariable oldNumberOfForks__ForkedBehaviour = numberOfForks__ForkedBehaviour;
		numberOfForks__ForkedBehaviour = newNumberOfForks__ForkedBehaviour;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR, oldNumberOfForks__ForkedBehaviour, newNumberOfForks__ForkedBehaviour);
	 ...
	 * @generated
	 */
	public void setNumberOfForks__ForkedBehaviour(PCMRandomVariable newNumberOfForks__ForkedBehaviour) {
		if (newNumberOfForks__ForkedBehaviour != numberOfForks__ForkedBehaviour) {
			NotificationChain msgs = null;
			if (numberOfForks__ForkedBehaviour != null)
				msgs = ((InternalEObject)numberOfForks__ForkedBehaviour).eInverseRemove(this, CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
			if (newNumberOfForks__ForkedBehaviour != null)
				msgs = ((InternalEObject)newNumberOfForks__ForkedBehaviour).eInverseAdd(this, CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
			msgs = basicSetNumberOfForks__ForkedBehaviour(newNumberOfForks__ForkedBehaviour, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR, newNumberOfForks__ForkedBehaviour, newNumberOfForks__ForkedBehaviour));
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR:
				if (numberOfForks__ForkedBehaviour != null)
					msgs = ((InternalEObject)numberOfForks__ForkedBehaviour).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR, null, msgs);
				return basicSetNumberOfForks__ForkedBehaviour((PCMRandomVariable)otherEnd, msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR:
				return basicSetNumberOfForks__ForkedBehaviour(null, msgs);
			case SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR:
				return getNumberOfForks__ForkedBehaviour();
			case SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR:
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SeffPackage.FORKED_BEHAVIOUR__SYNCHRONISATION_POINT_FORKED_BEHAVIOUR:
				...
				return;
			case SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR:
				setNumberOfForks__ForkedBehaviour((PCMRandomVariable)newValue);
				return;
			case SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR:
    ...
    public void eUnset(int featureID) {
		switch (featureID) {
			case SeffPackage.FORKED_BEHAVIOUR__SYNCHRONISATION_POINT_FORKED_BEHAVIOUR:
				...
				return;
			case SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR:
				setNumberOfForks__ForkedBehaviour((PCMRandomVariable)null);
				return;
			case SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR:
    ...
    public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR:
				return numberOfForks__ForkedBehaviour != null;
			case SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR:

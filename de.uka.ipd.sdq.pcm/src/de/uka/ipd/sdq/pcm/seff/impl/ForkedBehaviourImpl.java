 ...
 * @generated
 */
public class ForkedBehaviourImpl extends ResourceDemandingBehaviourImpl
		implements ForkedBehaviour {
	/**
	...
	public SynchronisationPoint getSynchronisationPoint_ForkedBehaviour() {
		if (eContainerFeatureID() != SeffPackage.FORKED_BEHAVIOUR__SYNCHRONISATION_POINT_FORKED_BEHAVIOUR)
			return null;
	...
	public NotificationChain basicSetSynchronisationPoint_ForkedBehaviour(
			SynchronisationPoint newSynchronisationPoint_ForkedBehaviour,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newSynchronisationPoint_ForkedBehaviour,
	...
	public void setSynchronisationPoint_ForkedBehaviour(
			SynchronisationPoint newSynchronisationPoint_ForkedBehaviour) {
		if (newSynchronisationPoint_ForkedBehaviour != eInternalContainer()
				|| (eContainerFeatureID() != SeffPackage.FORKED_BEHAVIOUR__SYNCHRONISATION_POINT_FORKED_BEHAVIOUR && newSynchronisationPoint_ForkedBehaviour != null)) {
			if (EcoreUtil.isAncestor(this,
					(EObject) newSynchronisationPoint_ForkedBehaviour))
			...
			if (newSynchronisationPoint_ForkedBehaviour != null)
				msgs = ((InternalEObject) newSynchronisationPoint_ForkedBehaviour)
						.eInverseAdd(
								this,
								SeffPackage.SYNCHRONISATION_POINT__SYNCHRONOUS_FORKED_BEHAVIOURS_SYNCHRONISATION_POINT,
								SynchronisationPoint.class, msgs);
			msgs = basicSetSynchronisationPoint_ForkedBehaviour(
					newSynchronisationPoint_ForkedBehaviour, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public ForkAction getForkAction_ForkedBehaivour() {
		if (eContainerFeatureID() != SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetForkAction_ForkedBehaivour(
			ForkAction newForkAction_ForkedBehaivour, NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newForkAction_ForkedBehaivour,
	 ...
	 */
	@Override
	public void setForkAction_ForkedBehaivour(
			ForkAction newForkAction_ForkedBehaivour) {
		if (newForkAction_ForkedBehaivour != eInternalContainer()
				|| (eContainerFeatureID() != SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR && newForkAction_ForkedBehaivour != null)) {
			if (EcoreUtil.isAncestor(this,
					(EObject) newForkAction_ForkedBehaivour))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newForkAction_ForkedBehaivour != null)
				msgs = ((InternalEObject) newForkAction_ForkedBehaivour)
						.eInverseAdd(
								this,
								SeffPackage.FORK_ACTION__ASYNCHRONOUS_FORKED_BEHAVIOURS_FORK_ACTION,
								ForkAction.class, msgs);
			msgs = basicSetForkAction_ForkedBehaivour(
					newForkAction_ForkedBehaivour, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case SeffPackage.FORKED_BEHAVIOUR__SYNCHRONISATION_POINT_FORKED_BEHAVIOUR:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetSynchronisationPoint_ForkedBehaviour(
					(SynchronisationPoint) otherEnd, msgs);
		case SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetForkAction_ForkedBehaivour((ForkAction) otherEnd,
					msgs);
		}

 ...
 * @generated
 */
public class StopActionImpl extends AbstractInternalControlFlowActionImpl
	 ...
	 */
	@Override
	public boolean StopActionSuccessorMustNotBeDefined(
		...
		if (!EOCL_ENV
				.createQuery(
						STOP_ACTION_SUCCESSOR_MUST_NOT_BE_DEFINED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics

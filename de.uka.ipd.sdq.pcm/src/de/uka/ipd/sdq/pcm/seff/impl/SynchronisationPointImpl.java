...
public class SynchronisationPointImpl extends EObjectImpl implements SynchronisationPoint {
	 ...
	 * @ordered
	 */
	protected EList<SetVariable> outputParameterUsage_SynchronisationPoint;
	 ...
	 * @generated
	 */
	public EList<SetVariable> getOutputParameterUsage_SynchronisationPoint() {
		if (outputParameterUsage_SynchronisationPoint == null) {
			outputParameterUsage_SynchronisationPoint = new EObjectContainmentWithInverseEList<SetVariable>(SetVariable.class, this, SeffPackage.SYNCHRONISATION_POINT__OUTPUT_PARAMETER_USAGE_SYNCHRONISATION_POINT, ParameterPackage.SET_VARIABLE__SYNCHRONISATION_POINT_VARIABLE_USAGE);
		}
	...
	public NotificationChain basicSetForkAction_SynchronisationPoint(ForkAction newForkAction_SynchronisationPoint, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newForkAction_SynchronisationPoint, SeffPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT, msgs);
		return msgs;
	}
	...
	public void setForkAction_SynchronisationPoint(ForkAction newForkAction_SynchronisationPoint) {
		if (newForkAction_SynchronisationPoint != eInternalContainer() || (eContainerFeatureID() != SeffPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT && newForkAction_SynchronisationPoint != null)) {
			...
			if (newForkAction_SynchronisationPoint != null)
				msgs = ((InternalEObject)newForkAction_SynchronisationPoint).eInverseAdd(this, SeffPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, ForkAction.class, msgs);
			msgs = basicSetForkAction_SynchronisationPoint(newForkAction_SynchronisationPoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SeffPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT, newForkAction_SynchronisationPoint, newForkAction_SynchronisationPoint));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SeffPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT:
				return eInternalContainer().eInverseRemove(this, SeffPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, ForkAction.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SeffPackage.SYNCHRONISATION_POINT__OUTPUT_PARAMETER_USAGE_SYNCHRONISATION_POINT:
				...
				getOutputParameterUsage_SynchronisationPoint().addAll((Collection<? extends SetVariable>)newValue);
				return;
			case SeffPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT:

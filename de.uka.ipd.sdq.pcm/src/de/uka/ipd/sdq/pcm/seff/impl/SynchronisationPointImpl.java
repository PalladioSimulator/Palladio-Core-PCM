 ...
 * @generated
 */
public class SynchronisationPointImpl extends EStereotypableObjectImpl
		implements SynchronisationPoint {
	/**
	...
	public NotificationChain basicSetForkAction_SynchronisationPoint(
			ForkAction newForkAction_SynchronisationPoint,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newForkAction_SynchronisationPoint,
	 ...
	 */
	@Override
	public void setForkAction_SynchronisationPoint(
			ForkAction newForkAction_SynchronisationPoint) {
		if (newForkAction_SynchronisationPoint != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newForkAction_SynchronisationPoint))
			...
			if (newForkAction_SynchronisationPoint != null)
				msgs = ((InternalEObject) newForkAction_SynchronisationPoint)
						.eInverseAdd(
								this,
								SeffPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION,
								ForkAction.class, msgs);
			msgs = basicSetForkAction_SynchronisationPoint(
					newForkAction_SynchronisationPoint, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case SeffPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetForkAction_SynchronisationPoint(
					(ForkAction) otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case SeffPackage.SYNCHRONISATION_POINT__OUTPUT_PARAMETER_USAGE_SYNCHRONISATION_POINT:
			return ((InternalEList<?>) getOutputParameterUsage_SynchronisationPoint())
					.basicRemove(otherEnd, msgs);
		case SeffPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT:
			return basicSetForkAction_SynchronisationPoint(null, msgs);
		case SeffPackage.SYNCHRONISATION_POINT__SYNCHRONOUS_FORKED_BEHAVIOURS_SYNCHRONISATION_POINT:
			return ((InternalEList<?>) getSynchronousForkedBehaviours_SynchronisationPoint())
					.basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case SeffPackage.SYNCHRONISATION_POINT__OUTPUT_PARAMETER_USAGE_SYNCHRONISATION_POINT:
			...
			getOutputParameterUsage_SynchronisationPoint().addAll(

 ...
 * @generated
 */
public class RecoveryActionImpl extends AbstractInternalControlFlowActionImpl
	...
	public RecoveryActionBehaviour getPrimaryBehaviour__RecoveryAction() {
		if (primaryBehaviour__RecoveryAction != null
				&& ((EObject) primaryBehaviour__RecoveryAction).eIsProxy()) {
			...
			if (primaryBehaviour__RecoveryAction != oldPrimaryBehaviour__RecoveryAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldPrimaryBehaviour__RecoveryAction,
	 ...
	 */
	@Override
	public void setPrimaryBehaviour__RecoveryAction(
			RecoveryActionBehaviour newPrimaryBehaviour__RecoveryAction) {
	 ...
	 */
	@Override
	public boolean PrimaryBehaviourOfRecoveryActionMustBeSet(
		...
		if (!EOCL_ENV
				.createQuery(
						PRIMARY_BEHAVIOUR_OF_RECOVERY_ACTION_MUST_BE_SET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case SeffReliabilityPackage.RECOVERY_ACTION__RECOVERY_ACTION_BEHAVIOURS_RECOVERY_ACTION:
			return ((InternalEList<?>) getRecoveryActionBehaviours__RecoveryAction())

...
public class SeffAdapterFactory extends AdapterFactoryImpl {
	...
	protected SeffSwitch<Adapter> modelSwitch = new SeffSwitch<Adapter>() {
		...
		@Override
		public Adapter caseAbstractInternalControlFlowAction(
		...
		@Override
		public Adapter caseResourceDemandingBehaviour(
		...
		@Override
		public Adapter caseAbstractBranchTransition(
				AbstractBranchTransition object) {
		...
		@Override
		public Adapter caseServiceEffectSpecification(
		...
		@Override
		public Adapter caseResourceDemandingInternalBehaviour(
				ResourceDemandingInternalBehaviour object) {
		...
		@Override
		public Adapter caseProbabilisticBranchTransition(
				ProbabilisticBranchTransition object) {
		...
		@Override
		public Adapter caseCollectionIteratorAction(
				CollectionIteratorAction object) {
			return createCollectionIteratorActionAdapter();
		}

		@Override
		public Adapter caseGuardedBranchTransition(
				GuardedBranchTransition object) {

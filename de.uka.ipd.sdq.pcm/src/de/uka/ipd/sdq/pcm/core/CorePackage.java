...
public interface CorePackage extends EPackage {
	 ...
	 * @generated
	 */
    String eNS_URI = "http://sdq.ipd.uka.de/PalladioComponentModel/Core/5.0";
    ...
    /**
	 * The feature id for the '<em><b>Forked Behaviour PCM Random Variable</b></em>' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
    int PCM_RANDOM_VARIABLE__GUARDED_BRANCH_TRANSITION_PCM_RANDOM_VARIABLE = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
    int PCM_RANDOM_VARIABLE__SPECIFIED_EXECUTION_TIME_PCM_RANDOM_VARIABLE = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 9;
	 ...
	 * @ordered
	 */
    int PCM_RANDOM_VARIABLE__ASSEMBLY_EVENT_CONNECTOR_FILTER_CONDITION = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 11;
     ...
     * @ordered
     */
    int PCM_RANDOM_VARIABLE__LOOP_LOOP_ITERATION = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 12;
	 ...
	 * @ordered
	 */
    int PCM_RANDOM_VARIABLE__OPEN_WORKLOAD_PCM_RANDOM_VARIABLE = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 13;
     ...
     * @ordered
     */
    int PCM_RANDOM_VARIABLE__DELAY_TIME_SPECIFICATION = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 14;
	 ...
	 * @ordered
	 */
    int PCM_RANDOM_VARIABLE__COMMUNICATION_LINK_RESOURCE_SPECIFCATION_THROUGHPUT_PCM_RANDOM_VARIABLE = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 15;
	 ...
	 * @ordered
	 */
    int PCM_RANDOM_VARIABLE__PROCESSING_RESOURCE_SPECIFICATION_PROCESSING_RATE_PCM_RANDOM_VARIABLE = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 16;
	 ...
	 * @ordered
	 */
    int PCM_RANDOM_VARIABLE__COMMUNICATION_LINK_RESOURCE_SPECIFICATION_LATENCY_PCM_RANDOM_VARIABLE = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 17;
     ...
     * @ordered
     */
    int PCM_RANDOM_VARIABLE_FEATURE_COUNT = StoexPackage.RANDOM_VARIABLE_FEATURE_COUNT + 18;
    ...
    /**
	 * Returns the meta object for the container reference '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getForkedBehaviour__PCMRandomVariable <em>Forked Behaviour PCM Random Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Forked Behaviour PCM Random Variable</em>'.
	 * @see de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getForkedBehaviour__PCMRandomVariable()
	 * @see #getPCMRandomVariable()
	 * @generated
	 */
	EReference getPCMRandomVariable_ForkedBehaviour__PCMRandomVariable();
    ...
    /**
	 * Returns the meta object for the container reference '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getLoop_LoopIteration <em>Loop Loop Iteration</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns the meta object for the container reference '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getSpecifiedExecutionTime_PCMRandomVariable <em>Specified Execution Time PCM Random Variable</em>}'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns the meta object for the container reference '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getAssemblyEventConnector__FilterCondition <em>Assembly Event Connector Filter Condition</em>}'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns the meta object for the container reference '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getEventChannelSinkConnector__FilterCondition <em>Event Channel Sink Connector Filter Condition</em>}'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns the meta object for the container reference '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getResourceCall__PCMRandomVariable <em>Resource Call PCM Random Variable</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns the meta object for the container reference '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getDelay_TimeSpecification <em>Delay Time Specification</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    interface Literals {
        ...
        /**
		 * The meta object literal for the '<em><b>Forked Behaviour PCM Random Variable</b></em>' container reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE = eINSTANCE.getPCMRandomVariable_ForkedBehaviour__PCMRandomVariable();

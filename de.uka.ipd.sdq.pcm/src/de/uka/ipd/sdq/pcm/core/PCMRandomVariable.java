 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getVariableCharacterisation_Specification <em>Variable Characterisation Specification</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getInfrastructureCall__PCMRandomVariable <em>Infrastructure Call PCM Random Variable</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getResourceCall__PCMRandomVariable <em>Resource Call PCM Random Variable</em>}</li>
 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getForkedBehaviour__PCMRandomVariable <em>Forked Behaviour PCM Random Variable</em>}</li>
...
public interface PCMRandomVariable extends RandomVariable {
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.parameter.VariableCharacterisation#getSpecification_VariableCharacterisation <em>Specification Variable Characterisation</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_VariableCharacterisation_Specification()
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getVariableCharacterisation_Specification <em>Variable Characterisation Specification</em>}' container reference.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     ...
     * {@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getPassiveResource_capacity_PCMRandomVariable
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.seff.seff_performance.ParametricResourceDemand#getSpecification_ParametericResourceDemand <em>Specification Parameteric Resource Demand</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_ParametricResourceDemand_PCMRandomVariable()
    ...
    /**
     * Sets the value of the '
     * {@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getParametricResourceDemand_PCMRandomVariable
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.seff.LoopAction#getIterationCount_LoopAction <em>Iteration Count Loop Action</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getLoopAction_PCMRandomVariable <em>Loop Action PCM Random Variable</em>}' container reference.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns the value of the '<em><b>Forked Behaviour PCM Random Variable</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.seff.ForkedBehaviour#getNumberOfForks__ForkedBehaviour <em>Number Of Forks Forked Behaviour</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Forked Behaviour PCM Random Variable</em>' container reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Forked Behaviour PCM Random Variable</em>' container reference.
	 * @see #setForkedBehaviour__PCMRandomVariable(ForkedBehaviour)
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_ForkedBehaviour__PCMRandomVariable()
	 * @see de.uka.ipd.sdq.pcm.seff.ForkedBehaviour#getNumberOfForks__ForkedBehaviour
	 * @model opposite="numberOfForks__ForkedBehaviour" transient="false" ordered="false"
	 * @generated
	 */
	ForkedBehaviour getForkedBehaviour__PCMRandomVariable();

				/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getForkedBehaviour__PCMRandomVariable <em>Forked Behaviour PCM Random Variable</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Forked Behaviour PCM Random Variable</em>' container reference.
	 * @see #getForkedBehaviour__PCMRandomVariable()
	 * @generated
	 */
	void setForkedBehaviour__PCMRandomVariable(ForkedBehaviour value);

				/**
	 * Returns the value of the '<em><b>Guarded Branch Transition PCM Random Variable</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.seff.GuardedBranchTransition#getBranchCondition_GuardedBranchTransition <em>Branch Condition Guarded Branch Transition</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_GuardedBranchTransition_PCMRandomVariable()
    ...
    /**
     * Sets the value of the '
     * {@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getGuardedBranchTransition_PCMRandomVariable
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.qosannotations.qos_performance.SpecifiedExecutionTime#getSpecification_SpecifiedExecutionTime <em>Specification Specified Execution Time</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_SpecifiedExecutionTime_PCMRandomVariable()
	 * @see de.uka.ipd.sdq.pcm.qosannotations.qos_performance.SpecifiedExecutionTime#getSpecification_SpecifiedExecutionTime
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.core.composition.AssemblyEventConnector#getFilterCondition__AssemblyEventConnector <em>Filter Condition Assembly Event Connector</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_AssemblyEventConnector__FilterCondition()
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getAssemblyEventConnector__FilterCondition <em>Assembly Event Connector Filter Condition</em>}' container reference.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.core.composition.EventChannelSinkConnector#getFilterCondition__EventChannelSinkConnector <em>Filter Condition Event Channel Sink Connector</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_EventChannelSinkConnector__FilterCondition()
    ...
    /**
     * Sets the value of the '
     * {@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getEventChannelSinkConnector__FilterCondition
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.seff.seff_performance.InfrastructureCall#getNumberOfCalls__InfrastructureCall <em>Number Of Calls Infrastructure Call</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_InfrastructureCall__PCMRandomVariable()
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getInfrastructureCall__PCMRandomVariable <em>Infrastructure Call PCM Random Variable</em>}' container reference.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.seff.seff_performance.ResourceCall#getNumberOfCalls__ResourceCall <em>Number Of Calls Resource Call</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getResourceCall__PCMRandomVariable <em>Resource Call PCM Random Variable</em>}' container reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getOpenWorkload_PCMRandomVariable <em>Open Workload PCM Random Variable</em>}' container reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.usagemodel.ClosedWorkload#getThinkTime_ClosedWorkload <em>Think Time Closed Workload</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getClosedWorkload_PCMRandomVariable <em>Closed Workload PCM Random Variable</em>}' container reference.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.resourceenvironment.CommunicationLinkResourceSpecification#getThroughput_CommunicationLinkResourceSpecification <em>Throughput Communication Link Resource Specification</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_CommunicationLinkResourceSpecifcation_throughput_PCMRandomVariable()
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getCommunicationLinkResourceSpecifcation_throughput_PCMRandomVariable <em>Communication Link Resource Specifcation throughput PCM Random Variable</em>}' container reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.resourceenvironment.ProcessingResourceSpecification#getProcessingRate_ProcessingResourceSpecification <em>Processing Rate Processing Resource Specification</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_ProcessingResourceSpecification_processingRate_PCMRandomVariable()
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getProcessingResourceSpecification_processingRate_PCMRandomVariable <em>Processing Resource Specification processing Rate PCM Random Variable</em>}' container reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.pcm.resourceenvironment.CommunicationLinkResourceSpecification#getLatency_CommunicationLinkResourceSpecification <em>Latency Communication Link Resource Specification</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '
	 ...
	 * @see de.uka.ipd.sdq.pcm.core.CorePackage#getPCMRandomVariable_CommunicationLinkResourceSpecification_latency_PCMRandomVariable()
    ...
    /**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.core.PCMRandomVariable#getCommunicationLinkResourceSpecification_latency_PCMRandomVariable <em>Communication Link Resource Specification latency PCM Random Variable</em>}' container reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->

 ...
 *
 *
 * @see de.uka.ipd.sdq.pcm.core.entity.EntityPackage#getComposedProvidingRequiringEntity()
 * @model abstract="true"
 * @generated
 */
public interface ComposedProvidingRequiringEntity extends ComposedStructure,
	 ...
	 * @model annotation=
	 *        "http://www.eclipse.org/uml2/1.1.0/GenModel body='self.providedRoles_InterfaceProvidingEntity->forAll(role|self.connectors__ComposedStructure->select(conn | conn.oclIsTypeOf(pcm::core::composition::ProvidedDelegationConnector)).oclAsType(pcm::core::composition::ProvidedDelegationConnector)->exists(connector|connector.outerProvidedRole_ProvidedDelegationConnector = role))\r\n\r\n'"
	 * @generated
	 */
	boolean ProvidedRolesMustBeBound(DiagnosticChain diagnostics,

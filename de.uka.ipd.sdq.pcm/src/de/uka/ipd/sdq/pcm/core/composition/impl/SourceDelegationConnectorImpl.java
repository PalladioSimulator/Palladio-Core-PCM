 ...
 * @generated
 */
public class SourceDelegationConnectorImpl extends DelegationConnectorImpl
		implements SourceDelegationConnector {
	/**
	...
	public SourceRole getInnerSourceRole__SourceRole() {
		if (innerSourceRole__SourceRole != null
				&& ((EObject) innerSourceRole__SourceRole).eIsProxy()) {
			...
			if (innerSourceRole__SourceRole != oldInnerSourceRole__SourceRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldInnerSourceRole__SourceRole,
	 ...
	 */
	@Override
	public void setInnerSourceRole__SourceRole(
			SourceRole newInnerSourceRole__SourceRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					CompositionPackage.SOURCE_DELEGATION_CONNECTOR__INNER_SOURCE_ROLE_SOURCE_ROLE,
					oldInnerSourceRole__SourceRole, innerSourceRole__SourceRole));
	}
	...
	public SourceRole getOuterSourceRole__SourceRole() {
		if (outerSourceRole__SourceRole != null
				&& ((EObject) outerSourceRole__SourceRole).eIsProxy()) {
			...
			if (outerSourceRole__SourceRole != oldOuterSourceRole__SourceRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldOuterSourceRole__SourceRole,
	 ...
	 */
	@Override
	public void setOuterSourceRole__SourceRole(
			SourceRole newOuterSourceRole__SourceRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					CompositionPackage.SOURCE_DELEGATION_CONNECTOR__OUTER_SOURCE_ROLE_SOURCE_ROLE,
					oldOuterSourceRole__SourceRole, outerSourceRole__SourceRole));
	}
	...
	public AssemblyContext getAssemblyContext__SourceDelegationConnector() {
		if (assemblyContext__SourceDelegationConnector != null
				&& ((EObject) assemblyContext__SourceDelegationConnector)
						.eIsProxy()) {

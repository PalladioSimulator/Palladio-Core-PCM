 ...
 * @generated
 */
public class ResourceRequiredRoleImpl extends RoleImpl implements
	...
	public ResourceInterface getRequiredResourceInterface__ResourceRequiredRole() {
		if (requiredResourceInterface__ResourceRequiredRole != null
				&& ((EObject) requiredResourceInterface__ResourceRequiredRole)
						.eIsProxy()) {
	...
	public ResourceInterfaceRequiringEntity getResourceInterfaceRequiringEntity__ResourceRequiredRole() {
		if (eContainerFeatureID() != EntityPackage.RESOURCE_REQUIRED_ROLE__RESOURCE_INTERFACE_REQUIRING_ENTITY_RESOURCE_REQUIRED_ROLE)
			return null;
	...
	public NotificationChain basicSetResourceInterfaceRequiringEntity__ResourceRequiredRole(
		...
		msgs = eBasicSetContainer(
				(InternalEObject) newResourceInterfaceRequiringEntity__ResourceRequiredRole,
	...
	public void setResourceInterfaceRequiringEntity__ResourceRequiredRole(
			ResourceInterfaceRequiringEntity newResourceInterfaceRequiringEntity__ResourceRequiredRole) {
		if (newResourceInterfaceRequiringEntity__ResourceRequiredRole != eInternalContainer()
				|| (eContainerFeatureID() != EntityPackage.RESOURCE_REQUIRED_ROLE__RESOURCE_INTERFACE_REQUIRING_ENTITY_RESOURCE_REQUIRED_ROLE && newResourceInterfaceRequiringEntity__ResourceRequiredRole != null)) {
			if (EcoreUtil
					.isAncestor(
							this,
							(EObject) newResourceInterfaceRequiringEntity__ResourceRequiredRole))
			...
			msgs = basicSetResourceInterfaceRequiringEntity__ResourceRequiredRole(

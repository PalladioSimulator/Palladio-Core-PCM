...
public class EntityAdapterFactory extends AdapterFactoryImpl {
	...
	protected EntitySwitch<Adapter> modelSwitch = new EntitySwitch<Adapter>() {
		...
		@Override
		public Adapter caseResourceInterfaceProvidingEntity(
				ResourceInterfaceProvidingEntity object) {
			return createResourceInterfaceProvidingEntityAdapter();
		}

		@Override
		public Adapter caseComposedProvidingRequiringEntity(
				ComposedProvidingRequiringEntity object) {
		...
		public Adapter caseResourceInterfaceProvidingRequiringEntity(
				ResourceInterfaceProvidingRequiringEntity object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceProvidedRole <em>Resource Provided Role</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceInterfaceProvidingRequiringEntity <em>Resource Interface Providing Requiring Entity</em>}'.
	 * <!-- begin-user-doc --> This
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceRequiredRole <em>Resource Required Role</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * @return the new adapter.

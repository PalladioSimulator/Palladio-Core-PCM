...
public class AssemblyContextImpl extends EntityImpl implements AssemblyContext {
	...
	public NotificationChain basicSetParentStructure__AssemblyContext(
			ComposedStructure newParentStructure__AssemblyContext,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newParentStructure__AssemblyContext,
	 ...
	 */
	@Override
	public void setParentStructure__AssemblyContext(
			ComposedStructure newParentStructure__AssemblyContext) {
		if (newParentStructure__AssemblyContext != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newParentStructure__AssemblyContext))
			...
			if (newParentStructure__AssemblyContext != null)
				msgs = ((InternalEObject) newParentStructure__AssemblyContext)
						.eInverseAdd(
								this,
								CompositionPackage.COMPOSED_STRUCTURE__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE,
								ComposedStructure.class, msgs);
			msgs = basicSetParentStructure__AssemblyContext(
					newParentStructure__AssemblyContext, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public RepositoryComponent getEncapsulatedComponent__AssemblyContext() {
		if (encapsulatedComponent__AssemblyContext != null
				&& ((EObject) encapsulatedComponent__AssemblyContext)
						.eIsProxy()) {
			...
			if (encapsulatedComponent__AssemblyContext != oldEncapsulatedComponent__AssemblyContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldEncapsulatedComponent__AssemblyContext,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case CompositionPackage.ASSEMBLY_CONTEXT__PARENT_STRUCTURE_ASSEMBLY_CONTEXT:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetParentStructure__AssemblyContext(
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case CompositionPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT:
			return ((InternalEList<?>) getConfigParameterUsages__AssemblyContext())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case CompositionPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT:
			...
			getConfigParameterUsages__AssemblyContext().addAll(
	...
	public boolean eIsSet(int featureID) {
		...
		case CompositionPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT:
			return configParameterUsages__AssemblyContext != null
					&& !configParameterUsages__AssemblyContext.isEmpty();
		}

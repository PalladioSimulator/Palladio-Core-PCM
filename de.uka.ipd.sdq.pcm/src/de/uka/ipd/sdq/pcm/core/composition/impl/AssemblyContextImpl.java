...
public class AssemblyContextImpl extends EntityImpl implements AssemblyContext {
	 ...
	 * @ordered
	 */
	protected EList<SetVariable> configParameterUsages_AssemblyContext;
	 ...
	 * @generated
	 */
	public EList<SetVariable> getConfigParameterUsages_AssemblyContext() {
		if (configParameterUsages_AssemblyContext == null) {
			configParameterUsages_AssemblyContext = new EObjectContainmentWithInverseEList<SetVariable>(SetVariable.class, this, CompositionPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT, ParameterPackage.SET_VARIABLE__ASSEMBLY_CONTEXT_VARIABLE_USAGE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CompositionPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getConfigParameterUsages_AssemblyContext()).basicAdd(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CompositionPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT:
				...
				getConfigParameterUsages_AssemblyContext().addAll((Collection<? extends SetVariable>)newValue);
				return;
		}

...
public interface ComposedStructure extends Entity {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.assemblyConnectors_ComposedStructure->forAll( c1, c2 | c1 <> c2 implies c1.requiredRole_AssemblyConnector <> c2.requiredRole_AssemblyConnector) 
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.assemblyConnectors_ComposedStructure->forAll( c1, c2 | c1 <> c2 implies c1.requiredRole_AssemblyConnector <> c2.requiredRole_AssemblyConnector) '"
	 * @generated
	 */

...
public class CompositionAdapterFactory extends AdapterFactoryImpl {
	...
	protected CompositionSwitch<Adapter> modelSwitch = new CompositionSwitch<Adapter>() {
		...
		@Override
		public Adapter caseResourceRequiredDelegationConnector(
				ResourceRequiredDelegationConnector object) {
		...
		@Override
		public Adapter caseEventChannelSourceConnector(
				EventChannelSourceConnector object) {
			return createEventChannelSourceConnectorAdapter();
		}

		@Override
		public Adapter caseEventChannelSinkConnector(
				EventChannelSinkConnector object) {
			return createEventChannelSinkConnectorAdapter();
		}

		@Override
		public Adapter caseProvidedDelegationConnector(
				ProvidedDelegationConnector object) {
			return createProvidedDelegationConnectorAdapter();
		}

		@Override
		public Adapter caseRequiredDelegationConnector(
				RequiredDelegationConnector object) {
		...
		@Override
		public Adapter caseSourceDelegationConnector(
				SourceDelegationConnector object) {
			return createSourceDelegationConnectorAdapter();
		}

		@Override
		public Adapter caseSinkDelegationConnector(
				SinkDelegationConnector object) {
			return createSinkDelegationConnectorAdapter();
		}

		@Override
		public Adapter caseAssemblyInfrastructureConnector(
				AssemblyInfrastructureConnector object) {
			return createAssemblyInfrastructureConnectorAdapter();
		}

		@Override
		public Adapter caseProvidedInfrastructureDelegationConnector(
				ProvidedInfrastructureDelegationConnector object) {
		...
		public Adapter caseRequiredInfrastructureDelegationConnector(
				RequiredInfrastructureDelegationConnector object) {
			return createRequiredInfrastructureDelegationConnectorAdapter();
		}

		@Override
		public Adapter caseRequiredResourceDelegationConnector(
				RequiredResourceDelegationConnector object) {
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link de.uka.ipd.sdq.pcm.core.composition.EventChannel <em>Event Channel</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 *

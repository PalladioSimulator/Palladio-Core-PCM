...
public class EventChannelImpl extends EntityImpl implements EventChannel {
	...
	public EventGroup getEventGroup__EventChannel() {
		if (eventGroup__EventChannel != null
				&& ((EObject) eventGroup__EventChannel).eIsProxy()) {
			...
			if (eventGroup__EventChannel != oldEventGroup__EventChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							CompositionPackage.EVENT_CHANNEL__EVENT_GROUP_EVENT_CHANNEL,
							oldEventGroup__EventChannel,
	 ...
	 */
	@Override
	public void setEventGroup__EventChannel(
			EventGroup newEventGroup__EventChannel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					CompositionPackage.EVENT_CHANNEL__EVENT_GROUP_EVENT_CHANNEL,
					oldEventGroup__EventChannel, eventGroup__EventChannel));
	}
	...
	public EList<EventChannelSourceConnector> getEventChannelSourceConnector__EventChannel() {
		if (eventChannelSourceConnector__EventChannel == null) {
			eventChannelSourceConnector__EventChannel = new EObjectWithInverseResolvingEList<EventChannelSourceConnector>(
	...
	public EList<EventChannelSinkConnector> getEventChannelSinkConnector__EventChannel() {
		if (eventChannelSinkConnector__EventChannel == null) {
			eventChannelSinkConnector__EventChannel = new EObjectWithInverseResolvingEList<EventChannelSinkConnector>(
					EventChannelSinkConnector.class,
					this,
	...
	public ComposedStructure getParentStructure__EventChannel() {
		if (eContainerFeatureID() != CompositionPackage.EVENT_CHANNEL__PARENT_STRUCTURE_EVENT_CHANNEL)
			return null;
	...
	public NotificationChain basicSetParentStructure__EventChannel(
			ComposedStructure newParentStructure__EventChannel,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newParentStructure__EventChannel,
	 ...
	 */
	@Override
	public void setParentStructure__EventChannel(
			ComposedStructure newParentStructure__EventChannel) {
		if (newParentStructure__EventChannel != eInternalContainer()
				|| (eContainerFeatureID() != CompositionPackage.EVENT_CHANNEL__PARENT_STRUCTURE_EVENT_CHANNEL && newParentStructure__EventChannel != null)) {
			if (EcoreUtil.isAncestor(this,
					(EObject) newParentStructure__EventChannel))
			...
			if (newParentStructure__EventChannel != null)
				msgs = ((InternalEObject) newParentStructure__EventChannel)
						.eInverseAdd(
								this,
								CompositionPackage.COMPOSED_STRUCTURE__EVENT_CHANNEL_COMPOSED_STRUCTURE,
								ComposedStructure.class, msgs);
			msgs = basicSetParentStructure__EventChannel(
					newParentStructure__EventChannel, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case CompositionPackage.EVENT_CHANNEL__PARENT_STRUCTURE_EVENT_CHANNEL:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetParentStructure__EventChannel(
					(ComposedStructure) otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case CompositionPackage.EVENT_CHANNEL__EVENT_CHANNEL_SOURCE_CONNECTOR_EVENT_CHANNEL:
			return ((InternalEList<?>) getEventChannelSourceConnector__EventChannel())
					.basicRemove(otherEnd, msgs);
		case CompositionPackage.EVENT_CHANNEL__EVENT_CHANNEL_SINK_CONNECTOR_EVENT_CHANNEL:
			return ((InternalEList<?>) getEventChannelSinkConnector__EventChannel())
					.basicRemove(otherEnd, msgs);
		case CompositionPackage.EVENT_CHANNEL__PARENT_STRUCTURE_EVENT_CHANNEL:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case CompositionPackage.EVENT_CHANNEL__EVENT_CHANNEL_SINK_CONNECTOR_EVENT_CHANNEL:
			...
			getEventChannelSinkConnector__EventChannel().addAll(
	...
	public boolean eIsSet(int featureID) {
		...
		case CompositionPackage.EVENT_CHANNEL__EVENT_CHANNEL_SOURCE_CONNECTOR_EVENT_CHANNEL:
			return eventChannelSourceConnector__EventChannel != null
					&& !eventChannelSourceConnector__EventChannel.isEmpty();
		case CompositionPackage.EVENT_CHANNEL__EVENT_CHANNEL_SINK_CONNECTOR_EVENT_CHANNEL:
			return eventChannelSinkConnector__EventChannel != null
					&& !eventChannelSinkConnector__EventChannel.isEmpty();
		case CompositionPackage.EVENT_CHANNEL__PARENT_STRUCTURE_EVENT_CHANNEL:

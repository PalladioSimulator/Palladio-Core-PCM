 ...
 * @generated
 */
public class AssemblyConnectorImpl extends ConnectorImpl implements
		AssemblyConnector {
	/**
	...
	public AssemblyContext getRequiringAssemblyContext_AssemblyConnector() {
		if (requiringAssemblyContext_AssemblyConnector != null
				&& ((EObject) requiringAssemblyContext_AssemblyConnector)
						.eIsProxy()) {
	...
	public AssemblyContext getProvidingAssemblyContext_AssemblyConnector() {
		if (providingAssemblyContext_AssemblyConnector != null
				&& ((EObject) providingAssemblyContext_AssemblyConnector)
						.eIsProxy()) {
	...
	public OperationProvidedRole getProvidedRole_AssemblyConnector() {
		if (providedRole_AssemblyConnector != null
				&& ((EObject) providedRole_AssemblyConnector).eIsProxy()) {
			...
			if (providedRole_AssemblyConnector != oldProvidedRole_AssemblyConnector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldProvidedRole_AssemblyConnector,
	 ...
	 */
	@Override
	public void setProvidedRole_AssemblyConnector(
			OperationProvidedRole newProvidedRole_AssemblyConnector) {
	...
	public OperationRequiredRole getRequiredRole_AssemblyConnector() {
		if (requiredRole_AssemblyConnector != null
				&& ((EObject) requiredRole_AssemblyConnector).eIsProxy()) {
			...
			if (requiredRole_AssemblyConnector != oldRequiredRole_AssemblyConnector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldRequiredRole_AssemblyConnector,
	 ...
	 */
	@Override
	public void setRequiredRole_AssemblyConnector(
			OperationRequiredRole newRequiredRole_AssemblyConnector) {
	 ...
	 */
	@Override
	public boolean AssemblyConnectorsReferencedProvidedRolesAndChildContextMustMatch(
	 ...
	 */
	@Override
	public boolean AssemblyConnectorsReferencedRequiredRoleAndChildContextMustMatch(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 */
	@Override
	public boolean AssemblyConnectorsReferencedInterfacesMustMatch(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV
				.createQuery(
						ASSEMBLY_CONNECTORS_REFERENCED_INTERFACES_MUST_MATCH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CompositionPackage.ASSEMBLY_CONNECTOR__REQUIRING_ASSEMBLY_CONTEXT_ASSEMBLY_CONNECTOR:
			if (resolve)
				return getRequiringAssemblyContext_AssemblyConnector();
		...
		case CompositionPackage.ASSEMBLY_CONNECTOR__PROVIDING_ASSEMBLY_CONTEXT_ASSEMBLY_CONNECTOR:
			if (resolve)
				return getProvidingAssemblyContext_AssemblyConnector();
		...
		case CompositionPackage.ASSEMBLY_CONNECTOR__PROVIDED_ROLE_ASSEMBLY_CONNECTOR:
			if (resolve)
				return getProvidedRole_AssemblyConnector();
		...
		case CompositionPackage.ASSEMBLY_CONNECTOR__REQUIRED_ROLE_ASSEMBLY_CONNECTOR:
			if (resolve)
				return getRequiredRole_AssemblyConnector();

 ...
 *   <li>{@link de.uka.ipd.sdq.pcm.core.impl.PCMRandomVariableImpl#getForkedBehaviour__PCMRandomVariable <em>Forked Behaviour PCM Random Variable</em>}</li>
...
public class PCMRandomVariableImpl extends RandomVariableImpl implements PCMRandomVariable {
	 ...
	 * @generated
	 */
	public ForkedBehaviour getForkedBehaviour__PCMRandomVariable() {
		if (eContainerFeatureID() != CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE) return null;
		return (ForkedBehaviour)eContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetForkedBehaviour__PCMRandomVariable(ForkedBehaviour newForkedBehaviour__PCMRandomVariable, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newForkedBehaviour__PCMRandomVariable, CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE, msgs);
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setForkedBehaviour__PCMRandomVariable(ForkedBehaviour newForkedBehaviour__PCMRandomVariable) {
		if (newForkedBehaviour__PCMRandomVariable != eInternalContainer() || (eContainerFeatureID() != CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE && newForkedBehaviour__PCMRandomVariable != null)) {
			if (EcoreUtil.isAncestor(this, newForkedBehaviour__PCMRandomVariable))
				throw new IllegalArgumentException("Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			if (newForkedBehaviour__PCMRandomVariable != null)
				msgs = ((InternalEObject)newForkedBehaviour__PCMRandomVariable).eInverseAdd(this, SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR, ForkedBehaviour.class, msgs);
			msgs = basicSetForkedBehaviour__PCMRandomVariable(newForkedBehaviour__PCMRandomVariable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE, newForkedBehaviour__PCMRandomVariable, newForkedBehaviour__PCMRandomVariable));
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetForkedBehaviour__PCMRandomVariable((ForkedBehaviour)otherEnd, msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE:
				return basicSetForkedBehaviour__PCMRandomVariable(null, msgs);
			case CorePackage.PCM_RANDOM_VARIABLE__GUARDED_BRANCH_TRANSITION_PCM_RANDOM_VARIABLE:
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			...
			case CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE:
				return eInternalContainer().eInverseRemove(this, SeffPackage.FORKED_BEHAVIOUR__NUMBER_OF_FORKS_FORKED_BEHAVIOUR, ForkedBehaviour.class, msgs);
			case CorePackage.PCM_RANDOM_VARIABLE__GUARDED_BRANCH_TRANSITION_PCM_RANDOM_VARIABLE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE:
				return getForkedBehaviour__PCMRandomVariable();
			case CorePackage.PCM_RANDOM_VARIABLE__GUARDED_BRANCH_TRANSITION_PCM_RANDOM_VARIABLE:
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CorePackage.PCM_RANDOM_VARIABLE__LOOP_ACTION_PCM_RANDOM_VARIABLE:
				...
				return;
			case CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE:
				setForkedBehaviour__PCMRandomVariable((ForkedBehaviour)newValue);
				return;
			case CorePackage.PCM_RANDOM_VARIABLE__GUARDED_BRANCH_TRANSITION_PCM_RANDOM_VARIABLE:
    ...
    public void eUnset(int featureID) {
		switch (featureID) {
			...
			case CorePackage.PCM_RANDOM_VARIABLE__LOOP_ACTION_PCM_RANDOM_VARIABLE:
				...
				return;
			case CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE:
				setForkedBehaviour__PCMRandomVariable((ForkedBehaviour)null);
				return;
			case CorePackage.PCM_RANDOM_VARIABLE__GUARDED_BRANCH_TRANSITION_PCM_RANDOM_VARIABLE:
    ...
    public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CorePackage.PCM_RANDOM_VARIABLE__FORKED_BEHAVIOUR_PCM_RANDOM_VARIABLE:
				return getForkedBehaviour__PCMRandomVariable() != null;
			case CorePackage.PCM_RANDOM_VARIABLE__GUARDED_BRANCH_TRANSITION_PCM_RANDOM_VARIABLE:

 ...
 * @generated
 */
public class PCMRandomVariableImpl extends RandomVariableImpl implements
		PCMRandomVariable {
	/**
	...
	public NotificationChain basicSetVariableCharacterisation_Specification(
		...
		msgs = eBasicSetContainer(
				(InternalEObject) newVariableCharacterisation_Specification,
	...
	public void setVariableCharacterisation_Specification(
		...
		if (newVariableCharacterisation_Specification != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newVariableCharacterisation_Specification))
			...
			if (newVariableCharacterisation_Specification != null)
				msgs = ((InternalEObject) newVariableCharacterisation_Specification)
						.eInverseAdd(
								this,
								ParameterPackage.VARIABLE_CHARACTERISATION__SPECIFICATION_VARIABLE_CHARACTERISATION,
								VariableCharacterisation.class, msgs);
			msgs = basicSetVariableCharacterisation_Specification(
					newVariableCharacterisation_Specification, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain basicSetPassiveResource_capacity_PCMRandomVariable(
			...
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newPassiveResource_capacity_PCMRandomVariable,
	...
	public void setPassiveResource_capacity_PCMRandomVariable(
		...
		if (newPassiveResource_capacity_PCMRandomVariable != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newPassiveResource_capacity_PCMRandomVariable))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newPassiveResource_capacity_PCMRandomVariable != null)
				msgs = ((InternalEObject) newPassiveResource_capacity_PCMRandomVariable)
						.eInverseAdd(
								this,
								RepositoryPackage.PASSIVE_RESOURCE__CAPACITY_PASSIVE_RESOURCE,
								PassiveResource.class, msgs);
			msgs = basicSetPassiveResource_capacity_PCMRandomVariable(
	...
	public NotificationChain basicSetParametricResourceDemand_PCMRandomVariable(
			...
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newParametricResourceDemand_PCMRandomVariable,
	...
	public void setParametricResourceDemand_PCMRandomVariable(
		...
		if (newParametricResourceDemand_PCMRandomVariable != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newParametricResourceDemand_PCMRandomVariable))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newParametricResourceDemand_PCMRandomVariable != null)
				msgs = ((InternalEObject) newParametricResourceDemand_PCMRandomVariable)
						.eInverseAdd(
								this,
			...
			msgs = basicSetParametricResourceDemand_PCMRandomVariable(
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLoopAction_PCMRandomVariable(
			LoopAction newLoopAction_PCMRandomVariable, NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newLoopAction_PCMRandomVariable,
				CorePackage.PCM_RANDOM_VARIABLE__LOOP_ACTION_PCM_RANDOM_VARIABLE,
				msgs);
		return msgs;
	}
	 ...
	 */
	@Override
	public void setLoopAction_PCMRandomVariable(
			LoopAction newLoopAction_PCMRandomVariable) {
		if (newLoopAction_PCMRandomVariable != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newLoopAction_PCMRandomVariable))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newLoopAction_PCMRandomVariable != null)
				msgs = ((InternalEObject) newLoopAction_PCMRandomVariable)
						.eInverseAdd(
								this,
								SeffPackage.LOOP_ACTION__ITERATION_COUNT_LOOP_ACTION,
								LoopAction.class, msgs);
			msgs = basicSetLoopAction_PCMRandomVariable(
					newLoopAction_PCMRandomVariable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public NotificationChain basicSetGuardedBranchTransition_PCMRandomVariable(
			...
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newGuardedBranchTransition_PCMRandomVariable,
	...
	public void setGuardedBranchTransition_PCMRandomVariable(
		...
		if (newGuardedBranchTransition_PCMRandomVariable != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newGuardedBranchTransition_PCMRandomVariable))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newGuardedBranchTransition_PCMRandomVariable != null)
				msgs = ((InternalEObject) newGuardedBranchTransition_PCMRandomVariable)
						.eInverseAdd(
								this,
								SeffPackage.GUARDED_BRANCH_TRANSITION__BRANCH_CONDITION_GUARDED_BRANCH_TRANSITION,
								GuardedBranchTransition.class, msgs);
			msgs = basicSetGuardedBranchTransition_PCMRandomVariable(
					newGuardedBranchTransition_PCMRandomVariable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLoop_LoopIteration(
			Loop newLoop_LoopIteration, NotificationChain msgs) {
	...
	public void setLoop_LoopIteration(Loop newLoop_LoopIteration) {
		if (newLoop_LoopIteration != eInternalContainer()
			...
			if (newLoop_LoopIteration != null)
				msgs = ((InternalEObject) newLoop_LoopIteration).eInverseAdd(
						this, UsagemodelPackage.LOOP__LOOP_ITERATION_LOOP,
						Loop.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.PCM_RANDOM_VARIABLE__LOOP_LOOP_ITERATION,
	...
	public NotificationChain basicSetSpecifiedExecutionTime_PCMRandomVariable(
			...
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newSpecifiedExecutionTime_PCMRandomVariable,
	...
	public void setSpecifiedExecutionTime_PCMRandomVariable(
		...
		if (newSpecifiedExecutionTime_PCMRandomVariable != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newSpecifiedExecutionTime_PCMRandomVariable))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newSpecifiedExecutionTime_PCMRandomVariable != null)
				msgs = ((InternalEObject) newSpecifiedExecutionTime_PCMRandomVariable)
						.eInverseAdd(
								this,
								QosPerformancePackage.SPECIFIED_EXECUTION_TIME__SPECIFICATION_SPECIFIED_EXECUTION_TIME,
								SpecifiedExecutionTime.class, msgs);
			msgs = basicSetSpecifiedExecutionTime_PCMRandomVariable(
					newSpecifiedExecutionTime_PCMRandomVariable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public NotificationChain basicSetAssemblyEventConnector__FilterCondition(
			...
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newAssemblyEventConnector__FilterCondition,
	...
	public void setAssemblyEventConnector__FilterCondition(
		...
		if (newAssemblyEventConnector__FilterCondition != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newAssemblyEventConnector__FilterCondition))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newAssemblyEventConnector__FilterCondition != null)
				msgs = ((InternalEObject) newAssemblyEventConnector__FilterCondition)
						.eInverseAdd(
								this,
								CompositionPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR,
								AssemblyEventConnector.class, msgs);
			msgs = basicSetAssemblyEventConnector__FilterCondition(
					newAssemblyEventConnector__FilterCondition, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public NotificationChain basicSetEventChannelSinkConnector__FilterCondition(
			...
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newEventChannelSinkConnector__FilterCondition,
	...
	public void setEventChannelSinkConnector__FilterCondition(
		...
		if (newEventChannelSinkConnector__FilterCondition != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newEventChannelSinkConnector__FilterCondition))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newEventChannelSinkConnector__FilterCondition != null)
				msgs = ((InternalEObject) newEventChannelSinkConnector__FilterCondition)
						.eInverseAdd(
								this,
			...
			msgs = basicSetEventChannelSinkConnector__FilterCondition(
	...
	public NotificationChain basicSetInfrastructureCall__PCMRandomVariable(
			InfrastructureCall newInfrastructureCall__PCMRandomVariable,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newInfrastructureCall__PCMRandomVariable,
	...
	public void setInfrastructureCall__PCMRandomVariable(
		...
		if (newInfrastructureCall__PCMRandomVariable != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newInfrastructureCall__PCMRandomVariable))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newInfrastructureCall__PCMRandomVariable != null)
				msgs = ((InternalEObject) newInfrastructureCall__PCMRandomVariable)
						.eInverseAdd(
								this,
								SeffPerformancePackage.INFRASTRUCTURE_CALL__NUMBER_OF_CALLS_INFRASTRUCTURE_CALL,
								InfrastructureCall.class, msgs);
			msgs = basicSetInfrastructureCall__PCMRandomVariable(
					newInfrastructureCall__PCMRandomVariable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public NotificationChain basicSetResourceCall__PCMRandomVariable(
			ResourceCall newResourceCall__PCMRandomVariable,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newResourceCall__PCMRandomVariable,
	 ...
	 */
	@Override
	public void setResourceCall__PCMRandomVariable(
			ResourceCall newResourceCall__PCMRandomVariable) {
		if (newResourceCall__PCMRandomVariable != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newResourceCall__PCMRandomVariable))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newResourceCall__PCMRandomVariable != null)
				msgs = ((InternalEObject) newResourceCall__PCMRandomVariable)
						.eInverseAdd(
								this,
								SeffPerformancePackage.RESOURCE_CALL__NUMBER_OF_CALLS_RESOURCE_CALL,
								ResourceCall.class, msgs);
			msgs = basicSetResourceCall__PCMRandomVariable(
					newResourceCall__PCMRandomVariable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public NotificationChain basicSetOpenWorkload_PCMRandomVariable(
			OpenWorkload newOpenWorkload_PCMRandomVariable,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newOpenWorkload_PCMRandomVariable,
	 ...
	 */
	@Override
	public void setOpenWorkload_PCMRandomVariable(
			OpenWorkload newOpenWorkload_PCMRandomVariable) {
		if (newOpenWorkload_PCMRandomVariable != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newOpenWorkload_PCMRandomVariable))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newOpenWorkload_PCMRandomVariable != null)
				msgs = ((InternalEObject) newOpenWorkload_PCMRandomVariable)
						.eInverseAdd(
								this,
								UsagemodelPackage.OPEN_WORKLOAD__INTER_ARRIVAL_TIME_OPEN_WORKLOAD,
								OpenWorkload.class, msgs);
			msgs = basicSetOpenWorkload_PCMRandomVariable(
					newOpenWorkload_PCMRandomVariable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public NotificationChain basicSetClosedWorkload_PCMRandomVariable(
			ClosedWorkload newClosedWorkload_PCMRandomVariable,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newClosedWorkload_PCMRandomVariable,
	 ...
	 */
	@Override
	public void setClosedWorkload_PCMRandomVariable(
			ClosedWorkload newClosedWorkload_PCMRandomVariable) {
		if (newClosedWorkload_PCMRandomVariable != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newClosedWorkload_PCMRandomVariable))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newClosedWorkload_PCMRandomVariable != null)
				msgs = ((InternalEObject) newClosedWorkload_PCMRandomVariable)
						.eInverseAdd(
								this,
								UsagemodelPackage.CLOSED_WORKLOAD__THINK_TIME_CLOSED_WORKLOAD,
								ClosedWorkload.class, msgs);
			msgs = basicSetClosedWorkload_PCMRandomVariable(
					newClosedWorkload_PCMRandomVariable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDelay_TimeSpecification(
			Delay newDelay_TimeSpecification, NotificationChain msgs) {
	...
	public void setDelay_TimeSpecification(Delay newDelay_TimeSpecification) {
		if (newDelay_TimeSpecification != eInternalContainer()
			...
			if (EcoreUtil
					.isAncestor(this, (EObject) newDelay_TimeSpecification))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newDelay_TimeSpecification != null)
				msgs = ((InternalEObject) newDelay_TimeSpecification)
						.eInverseAdd(
								this,
								UsagemodelPackage.DELAY__TIME_SPECIFICATION_DELAY,
								Delay.class, msgs);
			msgs = basicSetDelay_TimeSpecification(newDelay_TimeSpecification,
					msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.PCM_RANDOM_VARIABLE__DELAY_TIME_SPECIFICATION,
					newDelay_TimeSpecification, newDelay_TimeSpecification));
	}
			...
			if (newCommunicationLinkResourceSpecifcation_throughput_PCMRandomVariable != null)
				msgs = ((InternalEObject) newCommunicationLinkResourceSpecifcation_throughput_PCMRandomVariable)
						.eInverseAdd(
								...
								CommunicationLinkResourceSpecification.class,
								msgs);
	 ...
	 */
	@Override
	public boolean SpecificationMustNotBeNULL(DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(
				SPECIFICATION_MUST_NOT_BE_NULL__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case CorePackage.PCM_RANDOM_VARIABLE__CLOSED_WORKLOAD_PCM_RANDOM_VARIABLE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetClosedWorkload_PCMRandomVariable(
					(ClosedWorkload) otherEnd, msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__PASSIVE_RESOURCE_CAPACITY_PCM_RANDOM_VARIABLE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetPassiveResource_capacity_PCMRandomVariable(
					(PassiveResource) otherEnd, msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__VARIABLE_CHARACTERISATION_SPECIFICATION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetVariableCharacterisation_Specification(
					(VariableCharacterisation) otherEnd, msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__INFRASTRUCTURE_CALL_PCM_RANDOM_VARIABLE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetInfrastructureCall__PCMRandomVariable(
					(InfrastructureCall) otherEnd, msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__RESOURCE_CALL_PCM_RANDOM_VARIABLE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetResourceCall__PCMRandomVariable(
					(ResourceCall) otherEnd, msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__PARAMETRIC_RESOURCE_DEMAND_PCM_RANDOM_VARIABLE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetParametricResourceDemand_PCMRandomVariable(
					(ParametricResourceDemand) otherEnd, msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__LOOP_ACTION_PCM_RANDOM_VARIABLE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetLoopAction_PCMRandomVariable((LoopAction) otherEnd,
					msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__GUARDED_BRANCH_TRANSITION_PCM_RANDOM_VARIABLE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetGuardedBranchTransition_PCMRandomVariable(
					(GuardedBranchTransition) otherEnd, msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__SPECIFIED_EXECUTION_TIME_PCM_RANDOM_VARIABLE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetSpecifiedExecutionTime_PCMRandomVariable(
					(SpecifiedExecutionTime) otherEnd, msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__EVENT_CHANNEL_SINK_CONNECTOR_FILTER_CONDITION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetEventChannelSinkConnector__FilterCondition(
					(EventChannelSinkConnector) otherEnd, msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__ASSEMBLY_EVENT_CONNECTOR_FILTER_CONDITION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetAssemblyEventConnector__FilterCondition(
					(AssemblyEventConnector) otherEnd, msgs);
		...
		case CorePackage.PCM_RANDOM_VARIABLE__OPEN_WORKLOAD_PCM_RANDOM_VARIABLE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetOpenWorkload_PCMRandomVariable(
					(OpenWorkload) otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case CorePackage.PCM_RANDOM_VARIABLE__PASSIVE_RESOURCE_CAPACITY_PCM_RANDOM_VARIABLE:
			return basicSetPassiveResource_capacity_PCMRandomVariable(null,
					msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__VARIABLE_CHARACTERISATION_SPECIFICATION:
		...
		case CorePackage.PCM_RANDOM_VARIABLE__PARAMETRIC_RESOURCE_DEMAND_PCM_RANDOM_VARIABLE:
			return basicSetParametricResourceDemand_PCMRandomVariable(null,
					msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__LOOP_ACTION_PCM_RANDOM_VARIABLE:
		...
		case CorePackage.PCM_RANDOM_VARIABLE__EVENT_CHANNEL_SINK_CONNECTOR_FILTER_CONDITION:
			return basicSetEventChannelSinkConnector__FilterCondition(null,
					msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__ASSEMBLY_EVENT_CONNECTOR_FILTER_CONDITION:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
		...
		case CorePackage.PCM_RANDOM_VARIABLE__LOOP_LOOP_ITERATION:
			return eInternalContainer().eInverseRemove(this,
					UsagemodelPackage.LOOP__LOOP_ITERATION_LOOP, Loop.class,
					msgs);
		case CorePackage.PCM_RANDOM_VARIABLE__OPEN_WORKLOAD_PCM_RANDOM_VARIABLE:
			return eInternalContainer()
					.eInverseRemove(
	...
	public Expression basicGetExpression() {
		...
		if (this.lastParseExpression == null
				|| !this.lastParsedSpecification.equals(this.specification)) {
			// re-parsing required
			final MyPCMStoExLexer lexer = new MyPCMStoExLexer(
					new ANTLRStringStream(this.getSpecification()));

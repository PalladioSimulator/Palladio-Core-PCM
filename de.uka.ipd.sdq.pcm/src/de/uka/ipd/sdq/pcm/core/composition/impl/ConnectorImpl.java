...
public abstract class ConnectorImpl extends EntityImpl implements Connector {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetParentStructure__Connector(
			ComposedStructure newParentStructure__Connector,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newParentStructure__Connector,
	 ...
	 */
	@Override
	public void setParentStructure__Connector(
			ComposedStructure newParentStructure__Connector) {
		if (newParentStructure__Connector != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newParentStructure__Connector))
			...
			if (newParentStructure__Connector != null)
				msgs = ((InternalEObject) newParentStructure__Connector)
						.eInverseAdd(
								this,
								CompositionPackage.COMPOSED_STRUCTURE__CONNECTORS_COMPOSED_STRUCTURE,
								ComposedStructure.class, msgs);
			msgs = basicSetParentStructure__Connector(
					newParentStructure__Connector, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case CompositionPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetParentStructure__Connector(

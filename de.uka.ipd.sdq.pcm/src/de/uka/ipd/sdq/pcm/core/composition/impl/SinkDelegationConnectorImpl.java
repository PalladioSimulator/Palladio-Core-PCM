 ...
 * @generated
 */
public class SinkDelegationConnectorImpl extends DelegationConnectorImpl
		implements SinkDelegationConnector {
	/**
	...
	public AssemblyContext getAssemblyContext__SinkDelegationConnector() {
		if (assemblyContext__SinkDelegationConnector != null
				&& ((EObject) assemblyContext__SinkDelegationConnector)
						.eIsProxy()) {
			...
			if (assemblyContext__SinkDelegationConnector != oldAssemblyContext__SinkDelegationConnector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldAssemblyContext__SinkDelegationConnector,
	...
	public SinkRole getInnerSinkRole__SinkRole() {
		if (innerSinkRole__SinkRole != null
				&& ((EObject) innerSinkRole__SinkRole).eIsProxy()) {
	...
	public SinkRole getOuterSinkRole__SinkRole() {
		if (outerSinkRole__SinkRole != null
				&& ((EObject) outerSinkRole__SinkRole).eIsProxy()) {

...
public interface EntityPackage extends EPackage {
	 ...
	 * @generated
	 */
	EntityPackage eINSTANCE = de.uka.ipd.sdq.pcm.core.entity.impl.EntityPackageImpl
			.init();

	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.pcm.core.entity.impl.ResourceProvidedRoleImpl <em>Resource Provided Role</em>}' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.pcm.core.entity.impl.ResourceInterfaceProvidingRequiringEntityImpl <em>Resource Interface Providing Requiring Entity</em>}' class.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceProvidedRole <em>Resource Provided Role</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceProvidedRole#getResourceInterfaceProvidingEntity__ResourceProvidedRole <em>Resource Interface Providing Entity Resource Provided Role</em>}'.
	 * <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceProvidedRole#getProvidedResourceInterface__ResourceProvidedRole <em>Provided Resource Interface Resource Provided Role</em>}'.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.pcm.core.entity.impl.ResourceRequiredRoleImpl <em>Resource Required Role</em>}' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * {@link de.uka.ipd.sdq.pcm.core.entity.NamedElement#getEntityName <em>Entity Name</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceInterfaceProvidingRequiringEntity <em>Resource Interface Providing Requiring Entity</em>}'.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceInterfaceRequiringEntity#getResourceRequiredRoles__ResourceInterfaceRequiringEntity <em>Resource Required Roles Resource Interface Requiring Entity</em>}'.
	 * <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceRequiredRole <em>Resource Required Role</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceRequiredRole#getRequiredResourceInterface__ResourceRequiredRole <em>Required Resource Interface Resource Required Role</em>}'.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceRequiredRole#getResourceInterfaceRequiringEntity__ResourceRequiredRole <em>Resource Interface Requiring Entity Resource Required Role</em>}'.
	 * <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.pcm.core.entity.ResourceInterfaceProvidingEntity#getResourceProvidedRoles__ResourceInterfaceProvidingEntity <em>Resource Provided Roles Resource Interface Providing Entity</em>}'.
	 * <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.pcm.core.entity.impl.ResourceProvidedRoleImpl <em>Resource Provided Role</em>}' class.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.pcm.core.entity.impl.ResourceProvidedRoleImpl
		 * @see de.uka.ipd.sdq.pcm.core.entity.impl.EntityPackageImpl#getResourceProvidedRole()
		 * @generated
		 ...
		 * @generated
		 */
		EAttribute NAMED_ELEMENT__ENTITY_NAME = eINSTANCE
				.getNamedElement_EntityName();

		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.pcm.core.entity.impl.ResourceInterfaceProvidingRequiringEntityImpl <em>Resource Interface Providing Requiring Entity</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.pcm.core.entity.impl.ResourceInterfaceProvidingRequiringEntityImpl
		 * @see de.uka.ipd.sdq.pcm.core.entity.impl.EntityPackageImpl#getResourceInterfaceProvidingRequiringEntity()
		 * @generated
		 */
		EClass RESOURCE_INTERFACE_PROVIDING_REQUIRING_ENTITY = eINSTANCE
				.getResourceInterfaceProvidingRequiringEntity();
		 ...
		 * @generated
		 */
		EClass INTERFACE_PROVIDING_ENTITY = eINSTANCE
				.getInterfaceProvidingEntity();
		 ...
		 * @generated
		 */
		EClass INTERFACE_PROVIDING_REQUIRING_ENTITY = eINSTANCE
				.getInterfaceProvidingRequiringEntity();
		 ...
		 * @generated
		 */
		EClass INTERFACE_REQUIRING_ENTITY = eINSTANCE
				.getInterfaceRequiringEntity();
		 ...
		 * @generated
		 */
		EClass RESOURCE_INTERFACE_REQUIRING_ENTITY = eINSTANCE
				.getResourceInterfaceRequiringEntity();
		...
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.pcm.core.entity.impl.ResourceRequiredRoleImpl <em>Resource Required Role</em>}' class.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.pcm.core.entity.impl.ResourceRequiredRoleImpl
		 * @see de.uka.ipd.sdq.pcm.core.entity.impl.EntityPackageImpl#getResourceRequiredRole()
		 * @generated
		 ...
		 * @generated
		 */
		EClass COMPOSED_PROVIDING_REQUIRING_ENTITY = eINSTANCE
		 ...
		 * @generated
		 */
		EClass RESOURCE_INTERFACE_PROVIDING_ENTITY = eINSTANCE
				.getResourceInterfaceProvidingEntity();

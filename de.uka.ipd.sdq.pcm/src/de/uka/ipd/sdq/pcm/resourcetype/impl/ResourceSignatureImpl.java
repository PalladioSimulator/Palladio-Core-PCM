 ...
 * @generated
 */
public class ResourceSignatureImpl extends EntityImpl implements
		ResourceSignature {
	/**
	...
	public EList<Parameter> getParameter__ResourceSignature() {
		if (parameter__ResourceSignature == null) {
			parameter__ResourceSignature = new EObjectContainmentWithInverseEList<Parameter>(
					Parameter.class,
					this,
	...
	public void setResourceServiceId(int newResourceServiceId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					ResourcetypePackage.RESOURCE_SIGNATURE__RESOURCE_SERVICE_ID,
					oldResourceServiceId, resourceServiceId));
	}
	...
	public NotificationChain basicSetResourceInterface__ResourceSignature(
			ResourceInterface newResourceInterface__ResourceSignature,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newResourceInterface__ResourceSignature,
	...
	public void setResourceInterface__ResourceSignature(
		...
		if (newResourceInterface__ResourceSignature != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newResourceInterface__ResourceSignature))
			...
			if (newResourceInterface__ResourceSignature != null)
				msgs = ((InternalEObject) newResourceInterface__ResourceSignature)
						.eInverseAdd(
								this,
								ResourcetypePackage.RESOURCE_INTERFACE__RESOURCE_SIGNATURES_RESOURCE_INTERFACE,
								ResourceInterface.class, msgs);
			msgs = basicSetResourceInterface__ResourceSignature(
					newResourceInterface__ResourceSignature, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ResourcetypePackage.RESOURCE_SIGNATURE__RESOURCE_INTERFACE_RESOURCE_SIGNATURE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetResourceInterface__ResourceSignature(
					(ResourceInterface) otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case ResourcetypePackage.RESOURCE_SIGNATURE__PARAMETER_RESOURCE_SIGNATURE:
			return ((InternalEList<?>) getParameter__ResourceSignature())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ResourcetypePackage.RESOURCE_SIGNATURE__PARAMETER_RESOURCE_SIGNATURE:
			...
			getParameter__ResourceSignature().addAll(
	...
	public boolean eIsSet(int featureID) {
		...
		case ResourcetypePackage.RESOURCE_SIGNATURE__PARAMETER_RESOURCE_SIGNATURE:
			return parameter__ResourceSignature != null
					&& !parameter__ResourceSignature.isEmpty();
		case ResourcetypePackage.RESOURCE_SIGNATURE__RESOURCE_SERVICE_ID:

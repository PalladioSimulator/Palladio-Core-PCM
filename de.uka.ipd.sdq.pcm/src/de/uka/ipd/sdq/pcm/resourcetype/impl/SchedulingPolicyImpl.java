 ...
 * @generated
 */
public class SchedulingPolicyImpl extends EntityImpl implements
		SchedulingPolicy {
	/**
	...
	public NotificationChain basicSetResourceRepository__SchedulingPolicy(
			ResourceRepository newResourceRepository__SchedulingPolicy,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newResourceRepository__SchedulingPolicy,
	...
	public void setResourceRepository__SchedulingPolicy(
		...
		if (newResourceRepository__SchedulingPolicy != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newResourceRepository__SchedulingPolicy))
			...
			if (newResourceRepository__SchedulingPolicy != null)
				msgs = ((InternalEObject) newResourceRepository__SchedulingPolicy)
						.eInverseAdd(
								this,
								ResourcetypePackage.RESOURCE_REPOSITORY__SCHEDULING_POLICIES_RESOURCE_REPOSITORY,
								ResourceRepository.class, msgs);
			msgs = basicSetResourceRepository__SchedulingPolicy(
					newResourceRepository__SchedulingPolicy, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ResourcetypePackage.SCHEDULING_POLICY__RESOURCE_REPOSITORY_SCHEDULING_POLICY:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetResourceRepository__SchedulingPolicy(

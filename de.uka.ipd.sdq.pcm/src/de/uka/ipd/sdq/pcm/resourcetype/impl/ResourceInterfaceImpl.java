 ...
 * @generated
 */
public class ResourceInterfaceImpl extends EntityImpl implements
		ResourceInterface {
	/**
	...
	public NotificationChain basicSetResourceRepository__ResourceInterface(
			ResourceRepository newResourceRepository__ResourceInterface,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newResourceRepository__ResourceInterface,
	...
	public void setResourceRepository__ResourceInterface(
		...
		if (newResourceRepository__ResourceInterface != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newResourceRepository__ResourceInterface))
			...
			if (newResourceRepository__ResourceInterface != null)
				msgs = ((InternalEObject) newResourceRepository__ResourceInterface)
						.eInverseAdd(
								this,
								ResourcetypePackage.RESOURCE_REPOSITORY__RESOURCE_INTERFACES_RESOURCE_REPOSITORY,
								ResourceRepository.class, msgs);
			msgs = basicSetResourceRepository__ResourceInterface(
					newResourceRepository__ResourceInterface, msgs);
			if (msgs != null)
				msgs.dispatch();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ResourcetypePackage.RESOURCE_INTERFACE__RESOURCE_REPOSITORY_RESOURCE_INTERFACE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetResourceRepository__ResourceInterface(
					(ResourceRepository) otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case ResourcetypePackage.RESOURCE_INTERFACE__RESOURCE_SIGNATURES_RESOURCE_INTERFACE:
			return ((InternalEList<?>) getResourceSignatures__ResourceInterface())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ResourcetypePackage.RESOURCE_INTERFACE__RESOURCE_SIGNATURES_RESOURCE_INTERFACE:
			...
			getResourceSignatures__ResourceInterface().addAll(
					(Collection<? extends ResourceSignature>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case ResourcetypePackage.RESOURCE_INTERFACE__RESOURCE_SIGNATURES_RESOURCE_INTERFACE:
			return resourceSignatures__ResourceInterface != null
					&& !resourceSignatures__ResourceInterface.isEmpty();
		}

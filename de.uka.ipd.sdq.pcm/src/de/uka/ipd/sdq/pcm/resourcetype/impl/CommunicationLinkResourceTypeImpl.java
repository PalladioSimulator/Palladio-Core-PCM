 ...
 * @generated
 */
public class CommunicationLinkResourceTypeImpl extends ResourceTypeImpl
		implements CommunicationLinkResourceType {
	/**
	...
	public NetworkInducedFailureType getNetworkInducedFailureType__CommunicationLinkResourceType() {
		if (networkInducedFailureType__CommunicationLinkResourceType != null
				&& ((EObject) networkInducedFailureType__CommunicationLinkResourceType)
						.eIsProxy()) {

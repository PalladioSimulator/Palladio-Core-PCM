...
public class SystemImpl extends EntityImpl implements de.uka.ipd.sdq.pcm.system.System {
	 ...
	 * @ordered
	 */
	protected static final String MULTIPLE_CONNECTOR_CONSTRAINT_FOR_ASSEMBY_CONNECTORS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.assemblyConnectors_ComposedStructure->forAll( c1, c2 | c1 <> c2 implies c1.requiredRole_AssemblyConnector <> c2.requiredRole_AssemblyConnector) ";

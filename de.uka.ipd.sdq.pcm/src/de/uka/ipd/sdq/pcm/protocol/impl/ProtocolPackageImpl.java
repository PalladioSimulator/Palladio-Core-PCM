 ...
 * @generated
 */
public class ProtocolPackageImpl extends EPackageImpl implements
		ProtocolPackage {
	/**
	...
	public static ProtocolPackage init() {
		if (isInited)
			return (ProtocolPackage) EPackage.Registry.INSTANCE
		...
		ProtocolPackageImpl theProtocolPackage = (ProtocolPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ProtocolPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new ProtocolPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(ProtocolPackage.eNS_URI,
				theProtocolPackage);
	...
	public void initializePackageContents() {
		...
		initEClass(protocolEClass, Protocol.class, "Protocol", IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProtocol_ProtocolTypeID(), ecorePackage.getEString(),
				"protocolTypeID", null, 1, 1, Protocol.class, !IS_TRANSIENT,

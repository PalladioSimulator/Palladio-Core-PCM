 ...
 * @generated
 */
public class BranchTransitionImpl extends EStereotypableObjectImpl implements
		BranchTransition {
	/**
	...
	public void setBranchProbability(double newBranchProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UsagemodelPackage.BRANCH_TRANSITION__BRANCH_PROBABILITY,
					oldBranchProbability, branchProbability));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBranch_BranchTransition(
			Branch newBranch_BranchTransition, NotificationChain msgs) {
	...
	public void setBranch_BranchTransition(Branch newBranch_BranchTransition) {
		if (newBranch_BranchTransition != eInternalContainer()
			...
			if (EcoreUtil
					.isAncestor(this, (EObject) newBranch_BranchTransition))
			...
			if (newBranch_BranchTransition != null)
				msgs = ((InternalEObject) newBranch_BranchTransition)
						.eInverseAdd(
								this,
								UsagemodelPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH,
								Branch.class, msgs);
			msgs = basicSetBranch_BranchTransition(newBranch_BranchTransition,
					msgs);
			if (msgs != null)
				msgs.dispatch();
			...
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					UsagemodelPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION,
					newBranch_BranchTransition, newBranch_BranchTransition));
	}
	...
	public NotificationChain basicSetBranchedBehaviour_BranchTransition(
			ScenarioBehaviour newBranchedBehaviour_BranchTransition,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldBranchedBehaviour_BranchTransition,
	 ...
	 */
	@Override
	public void setBranchedBehaviour_BranchTransition(
			ScenarioBehaviour newBranchedBehaviour_BranchTransition) {
		if (newBranchedBehaviour_BranchTransition != branchedBehaviour_BranchTransition) {
			...
			if (newBranchedBehaviour_BranchTransition != null)
				msgs = ((InternalEObject) newBranchedBehaviour_BranchTransition)
						.eInverseAdd(
								this,
								UsagemodelPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR,
								ScenarioBehaviour.class, msgs);
			msgs = basicSetBranchedBehaviour_BranchTransition(
					newBranchedBehaviour_BranchTransition, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
				...
				msgs = ((InternalEObject) branchedBehaviour_BranchTransition)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- UsagemodelPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION,
								null, msgs);
			return basicSetBranchedBehaviour_BranchTransition(

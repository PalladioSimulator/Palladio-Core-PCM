...
public class LoopImpl extends AbstractUserActionImpl implements Loop {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLoopIteration_Loop(
			PCMRandomVariable newLoopIteration_Loop, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldLoopIteration_Loop, newLoopIteration_Loop);
			if (msgs == null)
				msgs = notification;
			else
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBodyBehaviour_Loop(
			ScenarioBehaviour newBodyBehaviour_Loop, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldBodyBehaviour_Loop, newBodyBehaviour_Loop);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
			...
			if (loopIteration_Loop != null)
				msgs = ((InternalEObject) loopIteration_Loop).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- UsagemodelPackage.LOOP__LOOP_ITERATION_LOOP,
						null, msgs);
			return basicSetLoopIteration_Loop((PCMRandomVariable) otherEnd,
					msgs);
		case UsagemodelPackage.LOOP__BODY_BEHAVIOUR_LOOP:
			if (bodyBehaviour_Loop != null)
				msgs = ((InternalEObject) bodyBehaviour_Loop).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- UsagemodelPackage.LOOP__BODY_BEHAVIOUR_LOOP,
						null, msgs);
			return basicSetBodyBehaviour_Loop((ScenarioBehaviour) otherEnd,
					msgs);
		}

...
public class OpenWorkloadImpl extends WorkloadImpl implements OpenWorkload {
	...
	public NotificationChain basicSetInterArrivalTime_OpenWorkload(
			PCMRandomVariable newInterArrivalTime_OpenWorkload,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldInterArrivalTime_OpenWorkload,
	...
	public void setInterArrivalTime_OpenWorkload(
		...
		if (newInterArrivalTime_OpenWorkload != interArrivalTime_OpenWorkload) {
			...
			if (newInterArrivalTime_OpenWorkload != null)
				msgs = ((InternalEObject) newInterArrivalTime_OpenWorkload)
						.eInverseAdd(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__OPEN_WORKLOAD_PCM_RANDOM_VARIABLE,
								PCMRandomVariable.class, msgs);
			msgs = basicSetInterArrivalTime_OpenWorkload(
					newInterArrivalTime_OpenWorkload, msgs);
			if (msgs != null)
				msgs.dispatch();
	 ...
	 */
	@Override
	public boolean InterArrivalTimeInOpenWorkloadNeedsToBeSpecified(
		...
		if (!EOCL_ENV
				.createQuery(
						INTER_ARRIVAL_TIME_IN_OPEN_WORKLOAD_NEEDS_TO_BE_SPECIFIED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
				...
				msgs = ((InternalEObject) interArrivalTime_OpenWorkload)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- UsagemodelPackage.OPEN_WORKLOAD__INTER_ARRIVAL_TIME_OPEN_WORKLOAD,
								null, msgs);
			return basicSetInterArrivalTime_OpenWorkload(

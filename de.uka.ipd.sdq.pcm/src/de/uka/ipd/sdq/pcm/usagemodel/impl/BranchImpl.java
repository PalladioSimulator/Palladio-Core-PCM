...
public class BranchImpl extends AbstractUserActionImpl implements Branch {
	...
	public EList<BranchTransition> getBranchTransitions_Branch() {
		if (branchTransitions_Branch == null) {
			branchTransitions_Branch = new EObjectContainmentWithInverseEList<BranchTransition>(
					BranchTransition.class,
					this,
	 ...
	 */
	@Override
	public boolean AllBranchProbabilitiesMustSumUpTo1(
		...
		if (!EOCL_ENV
				.createQuery(
						ALL_BRANCH_PROBABILITIES_MUST_SUM_UP_TO1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case UsagemodelPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getBranchTransitions_Branch())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case UsagemodelPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH:
			return ((InternalEList<?>) getBranchTransitions_Branch())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case UsagemodelPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH:
			...
			getBranchTransitions_Branch().addAll(
					(Collection<? extends BranchTransition>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case UsagemodelPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH:
			return branchTransitions_Branch != null
					&& !branchTransitions_Branch.isEmpty();
		}

...
public class DelayImpl extends AbstractUserActionImpl implements Delay {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTimeSpecification_Delay(
			PCMRandomVariable newTimeSpecification_Delay, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldTimeSpecification_Delay, newTimeSpecification_Delay);
			if (msgs == null)
				msgs = notification;
			else
	 ...
	 */
	@Override
	public void setTimeSpecification_Delay(
			PCMRandomVariable newTimeSpecification_Delay) {
		if (newTimeSpecification_Delay != timeSpecification_Delay) {
			NotificationChain msgs = null;
			if (timeSpecification_Delay != null)
				msgs = ((InternalEObject) timeSpecification_Delay)
						.eInverseRemove(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__DELAY_TIME_SPECIFICATION,
								PCMRandomVariable.class, msgs);
			if (newTimeSpecification_Delay != null)
				msgs = ((InternalEObject) newTimeSpecification_Delay)
						.eInverseAdd(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__DELAY_TIME_SPECIFICATION,
								PCMRandomVariable.class, msgs);
			msgs = basicSetTimeSpecification_Delay(newTimeSpecification_Delay,
					msgs);
			if (msgs != null)
				msgs.dispatch();
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					UsagemodelPackage.DELAY__TIME_SPECIFICATION_DELAY,
					newTimeSpecification_Delay, newTimeSpecification_Delay));
	}
				...
				msgs = ((InternalEObject) timeSpecification_Delay)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- UsagemodelPackage.DELAY__TIME_SPECIFICATION_DELAY,
								null, msgs);
			return basicSetTimeSpecification_Delay(

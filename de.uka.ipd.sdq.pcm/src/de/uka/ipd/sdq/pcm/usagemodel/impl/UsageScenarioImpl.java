 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.usagemodel.impl.UsageScenarioImpl#getUsageModel_UsageScenario <em>Usage Model Usage Scenario</em>}</li>
...
public class UsageScenarioImpl extends EntityImpl implements UsageScenario {
	...
	public NotificationChain basicSetScenarioBehaviour_UsageScenario(
			ScenarioBehaviour newScenarioBehaviour_UsageScenario,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldScenarioBehaviour_UsageScenario,
	...
	public void setScenarioBehaviour_UsageScenario(
		...
		if (newScenarioBehaviour_UsageScenario != scenarioBehaviour_UsageScenario) {
			...
			if (newScenarioBehaviour_UsageScenario != null)
				msgs = ((InternalEObject) newScenarioBehaviour_UsageScenario)
						.eInverseAdd(
								this,
								UsagemodelPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR,
								ScenarioBehaviour.class, msgs);
			msgs = basicSetScenarioBehaviour_UsageScenario(
					newScenarioBehaviour_UsageScenario, msgs);
			if (msgs != null)
				msgs.dispatch();
	 ...
	 * @generated
	 */
	public NotificationChain basicSetUsageModel_UsageScenario(
			UsageModel newUsageModel_UsageScenario, NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newUsageModel_UsageScenario,
	 ...
	 */
	@Override
	public void setUsageModel_UsageScenario(
			UsageModel newUsageModel_UsageScenario) {
		if (newUsageModel_UsageScenario != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newUsageModel_UsageScenario))
			...
			if (newUsageModel_UsageScenario != null)
				msgs = ((InternalEObject) newUsageModel_UsageScenario)
						.eInverseAdd(
								this,
								UsagemodelPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL,
								UsageModel.class, msgs);
			msgs = basicSetUsageModel_UsageScenario(
					newUsageModel_UsageScenario, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					UsagemodelPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO,
					newUsageModel_UsageScenario, newUsageModel_UsageScenario));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetWorkload_UsageScenario(
			Workload newWorkload_UsageScenario, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					...
					oldWorkload_UsageScenario, newWorkload_UsageScenario);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setWorkload_UsageScenario(Workload newWorkload_UsageScenario) {
		if (newWorkload_UsageScenario != workload_UsageScenario) {
			...
			if (workload_UsageScenario != null)
				msgs = ((InternalEObject) workload_UsageScenario)
						.eInverseRemove(
								this,
								UsagemodelPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD,
								Workload.class, msgs);
			if (newWorkload_UsageScenario != null)
				msgs = ((InternalEObject) newWorkload_UsageScenario)
						.eInverseAdd(
								this,
								UsagemodelPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD,
								Workload.class, msgs);
			msgs = basicSetWorkload_UsageScenario(newWorkload_UsageScenario,
					msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UsagemodelPackage.USAGE_SCENARIO__WORKLOAD_USAGE_SCENARIO,
					newWorkload_UsageScenario, newWorkload_UsageScenario));
	}
				...
				msgs = ((InternalEObject) scenarioBehaviour_UsageScenario)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- UsagemodelPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO,
								null, msgs);
			return basicSetScenarioBehaviour_UsageScenario(
					(ScenarioBehaviour) otherEnd, msgs);

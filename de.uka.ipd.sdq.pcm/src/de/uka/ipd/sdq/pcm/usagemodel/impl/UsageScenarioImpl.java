...
public class UsageScenarioImpl extends EntityImpl implements UsageScenario {
    ...
    public NotificationChain basicSetUsageModel_UsageScenario(UsageModel newUsageModel_UsageScenario,
		...
		msgs = eBasicSetContainer((InternalEObject)newUsageModel_UsageScenario, UsagemodelPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO, msgs);
		return msgs;
	}
    ...
    public void setUsageModel_UsageScenario(UsageModel newUsageModel_UsageScenario) {
		if (newUsageModel_UsageScenario != eInternalContainer() || (eContainerFeatureID() != UsagemodelPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO && newUsageModel_UsageScenario != null)) {
			...
			if (newUsageModel_UsageScenario != null)
				msgs = ((InternalEObject)newUsageModel_UsageScenario).eInverseAdd(this, UsagemodelPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL, UsageModel.class, msgs);
			msgs = basicSetUsageModel_UsageScenario(newUsageModel_UsageScenario, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsagemodelPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO, newUsageModel_UsageScenario, newUsageModel_UsageScenario));
	}
    ...
    public void setWorkload_UsageScenario(Workload newWorkload_UsageScenario) {
		if (newWorkload_UsageScenario != workload_UsageScenario) {
			...
			if (workload_UsageScenario != null)
				msgs = ((InternalEObject)workload_UsageScenario).eInverseRemove(this, UsagemodelPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD, Workload.class, msgs);
			if (newWorkload_UsageScenario != null)
				msgs = ((InternalEObject)newWorkload_UsageScenario).eInverseAdd(this, UsagemodelPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD, Workload.class, msgs);
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UsagemodelPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO:
				return eInternalContainer().eInverseRemove(this, UsagemodelPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL, UsageModel.class, msgs);
		}

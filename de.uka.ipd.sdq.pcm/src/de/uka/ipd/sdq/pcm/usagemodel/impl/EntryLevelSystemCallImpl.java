 ...
 * @generated
 */
public class EntryLevelSystemCallImpl extends AbstractUserActionImpl implements
	...
	public void setPriority(int newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UsagemodelPackage.ENTRY_LEVEL_SYSTEM_CALL__PRIORITY,
	 ...
	 */
	@Override
	public boolean EntryLevelSystemCallMustReferenceProvidedRoleOfASystem(
	 ...
	 */
	@Override
	public boolean EntryLevelSystemCallSignatureMustMatchItsProvidedRole(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public OperationProvidedRole getProvidedRole_EntryLevelSystemCall() {
		if (providedRole_EntryLevelSystemCall != null
				&& ((EObject) providedRole_EntryLevelSystemCall).eIsProxy()) {
			...
			if (providedRole_EntryLevelSystemCall != oldProvidedRole_EntryLevelSystemCall) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldProvidedRole_EntryLevelSystemCall,
	 ...
	 */
	@Override
	public void setProvidedRole_EntryLevelSystemCall(
			OperationProvidedRole newProvidedRole_EntryLevelSystemCall) {
	...
	public OperationSignature getOperationSignature__EntryLevelSystemCall() {
		if (operationSignature__EntryLevelSystemCall != null
				&& ((EObject) operationSignature__EntryLevelSystemCall)
						.eIsProxy()) {
			...
			if (operationSignature__EntryLevelSystemCall != oldOperationSignature__EntryLevelSystemCall) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							oldOperationSignature__EntryLevelSystemCall,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case UsagemodelPackage.ENTRY_LEVEL_SYSTEM_CALL__OUTPUT_PARAMETER_USAGES_ENTRY_LEVEL_SYSTEM_CALL:
			return ((InternalEList<?>) getOutputParameterUsages_EntryLevelSystemCall())
					.basicRemove(otherEnd, msgs);
		case UsagemodelPackage.ENTRY_LEVEL_SYSTEM_CALL__INPUT_PARAMETER_USAGES_ENTRY_LEVEL_SYSTEM_CALL:
			return ((InternalEList<?>) getInputParameterUsages_EntryLevelSystemCall())
					.basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case UsagemodelPackage.ENTRY_LEVEL_SYSTEM_CALL__OUTPUT_PARAMETER_USAGES_ENTRY_LEVEL_SYSTEM_CALL:
			...
			getOutputParameterUsages_EntryLevelSystemCall().addAll(
		...
		case UsagemodelPackage.ENTRY_LEVEL_SYSTEM_CALL__INPUT_PARAMETER_USAGES_ENTRY_LEVEL_SYSTEM_CALL:
			...
			getInputParameterUsages_EntryLevelSystemCall().addAll(
					(Collection<? extends VariableUsage>) newValue);
			return;
		}

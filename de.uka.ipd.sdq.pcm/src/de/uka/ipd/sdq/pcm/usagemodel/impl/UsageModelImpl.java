 ...
 * @generated
 */
public class UsageModelImpl extends EStereotypableObjectImpl implements
		UsageModel {
	/**
	...
	public EList<UserData> getUserData_UsageModel() {
		if (userData_UsageModel == null) {
			userData_UsageModel = new EObjectContainmentWithInverseEList<UserData>(
					UserData.class, this,
	...
	public EList<UsageScenario> getUsageScenario_UsageModel() {
		if (usageScenario_UsageModel == null) {
			usageScenario_UsageModel = new EObjectContainmentWithInverseEList<UsageScenario>(
					UsageScenario.class,
					this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case UsagemodelPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getUserData_UsageModel())
					.basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case UsagemodelPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL:
			return ((InternalEList<?>) getUsageScenario_UsageModel())
					.basicRemove(otherEnd, msgs);
		case UsagemodelPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL:
			return ((InternalEList<?>) getUserData_UsageModel()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case UsagemodelPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL:
			...
			getUsageScenario_UsageModel().addAll(
					(Collection<? extends UsageScenario>) newValue);
			return;
		case UsagemodelPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL:
			getUserData_UsageModel().clear();
			getUserData_UsageModel().addAll(
					(Collection<? extends UserData>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case UsagemodelPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL:
			return usageScenario_UsageModel != null
					&& !usageScenario_UsageModel.isEmpty();
		case UsagemodelPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL:
			return userData_UsageModel != null
					&& !userData_UsageModel.isEmpty();
		}

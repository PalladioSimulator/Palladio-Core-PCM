 ...
 * @generated
 */
public abstract class AbstractUserActionImpl extends EntityImpl implements
		AbstractUserAction {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSuccessor(AbstractUserAction newSuccessor,
	...
	public NotificationChain basicSetPredecessor(
			AbstractUserAction newPredecessor, NotificationChain msgs) {
	...
	public NotificationChain basicSetScenarioBehaviour_AbstractUserAction(
			ScenarioBehaviour newScenarioBehaviour_AbstractUserAction,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newScenarioBehaviour_AbstractUserAction,
	...
	public void setScenarioBehaviour_AbstractUserAction(
		...
		if (newScenarioBehaviour_AbstractUserAction != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newScenarioBehaviour_AbstractUserAction))
			...
			msgs = basicSetScenarioBehaviour_AbstractUserAction(
					newScenarioBehaviour_AbstractUserAction, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case UsagemodelPackage.ABSTRACT_USER_ACTION__SCENARIO_BEHAVIOUR_ABSTRACT_USER_ACTION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetScenarioBehaviour_AbstractUserAction(

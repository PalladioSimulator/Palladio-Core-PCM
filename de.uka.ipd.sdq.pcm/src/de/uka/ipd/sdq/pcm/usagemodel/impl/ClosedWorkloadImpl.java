...
public class ClosedWorkloadImpl extends WorkloadImpl implements ClosedWorkload {
	...
	public void setPopulation(int newPopulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UsagemodelPackage.CLOSED_WORKLOAD__POPULATION,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetThinkTime_ClosedWorkload(
			PCMRandomVariable newThinkTime_ClosedWorkload,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					...
					oldThinkTime_ClosedWorkload, newThinkTime_ClosedWorkload);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setThinkTime_ClosedWorkload(
		...
		if (newThinkTime_ClosedWorkload != thinkTime_ClosedWorkload) {
			...
			if (newThinkTime_ClosedWorkload != null)
				msgs = ((InternalEObject) newThinkTime_ClosedWorkload)
						.eInverseAdd(
								this,
								CorePackage.PCM_RANDOM_VARIABLE__CLOSED_WORKLOAD_PCM_RANDOM_VARIABLE,
								PCMRandomVariable.class, msgs);
			msgs = basicSetThinkTime_ClosedWorkload(
					newThinkTime_ClosedWorkload, msgs);
			if (msgs != null)
				msgs.dispatch();
			...
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					UsagemodelPackage.CLOSED_WORKLOAD__THINK_TIME_CLOSED_WORKLOAD,
					newThinkTime_ClosedWorkload, newThinkTime_ClosedWorkload));
	}
	 ...
	 */
	@Override
	public boolean PopulationInClosedWorkloadNeedsToBeSpecified(
		...
		if (!EOCL_ENV
				.createQuery(
						POPULATION_IN_CLOSED_WORKLOAD_NEEDS_TO_BE_SPECIFIED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
	...
	public boolean ThinkTimeInClosedWorkloadNeedsToBeSpecified(
		...
		if (!EOCL_ENV
				.createQuery(
						THINK_TIME_IN_CLOSED_WORKLOAD_NEEDS_TO_BE_SPECIFIED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
				...
				msgs = ((InternalEObject) thinkTime_ClosedWorkload)
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- UsagemodelPackage.CLOSED_WORKLOAD__THINK_TIME_CLOSED_WORKLOAD,
								null, msgs);
			return basicSetThinkTime_ClosedWorkload(

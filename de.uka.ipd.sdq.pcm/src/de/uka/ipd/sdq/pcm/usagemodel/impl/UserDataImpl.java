...
public class UserDataImpl extends EStereotypableObjectImpl implements UserData {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetUsageModel_UserData(
			UsageModel newUsageModel_UserData, NotificationChain msgs) {
	...
	public void setUsageModel_UserData(UsageModel newUsageModel_UserData) {
		if (newUsageModel_UserData != eInternalContainer()
			...
			if (newUsageModel_UserData != null)
				msgs = ((InternalEObject) newUsageModel_UserData).eInverseAdd(
						this,
	...
	public AssemblyContext getAssemblyContext_userData() {
		if (assemblyContext_userData != null
				&& ((EObject) assemblyContext_userData).eIsProxy()) {
			...
			if (assemblyContext_userData != oldAssemblyContext_userData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							UsagemodelPackage.USER_DATA__ASSEMBLY_CONTEXT_USER_DATA,
							oldAssemblyContext_userData,
	 ...
	 */
	@Override
	public void setAssemblyContext_userData(
			AssemblyContext newAssemblyContext_userData) {
		AssemblyContext oldAssemblyContext_userData = assemblyContext_userData;
		assemblyContext_userData = newAssemblyContext_userData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UsagemodelPackage.USER_DATA__ASSEMBLY_CONTEXT_USER_DATA,
					oldAssemblyContext_userData, assemblyContext_userData));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case UsagemodelPackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA:
			return ((InternalEList<?>) getUserDataParameterUsages_UserData())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case UsagemodelPackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA:
			...
			getUserDataParameterUsages_UserData().addAll(
	...
	public boolean eIsSet(int featureID) {
		...
		case UsagemodelPackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA:
			return userDataParameterUsages_UserData != null
					&& !userDataParameterUsages_UserData.isEmpty();
		}

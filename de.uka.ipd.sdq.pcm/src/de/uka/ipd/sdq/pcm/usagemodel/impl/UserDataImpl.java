...
public class UserDataImpl extends EObjectImpl implements UserData {
	 ...
	 * @ordered
	 */
	protected EList<SetVariable> userDataParameterUsages_UserData;
	 ...
	 * @generated
	 */
	public EList<SetVariable> getUserDataParameterUsages_UserData() {
		if (userDataParameterUsages_UserData == null) {
			userDataParameterUsages_UserData = new EObjectContainmentWithInverseEList<SetVariable>(SetVariable.class, this, UsagemodelPackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA, ParameterPackage.SET_VARIABLE__USER_DATA_VARIABLE_USAGE);
		}
	...
	public NotificationChain basicSetUsageModel_UserData(UsageModel newUsageModel_UserData, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newUsageModel_UserData, UsagemodelPackage.USER_DATA__USAGE_MODEL_USER_DATA, msgs);
		return msgs;
	}
	...
	public void setUsageModel_UserData(UsageModel newUsageModel_UserData) {
		if (newUsageModel_UserData != eInternalContainer() || (eContainerFeatureID() != UsagemodelPackage.USER_DATA__USAGE_MODEL_USER_DATA && newUsageModel_UserData != null)) {
			...
			if (newUsageModel_UserData != null)
				msgs = ((InternalEObject)newUsageModel_UserData).eInverseAdd(this, UsagemodelPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL, UsageModel.class, msgs);
			msgs = basicSetUsageModel_UserData(newUsageModel_UserData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsagemodelPackage.USER_DATA__USAGE_MODEL_USER_DATA, newUsageModel_UserData, newUsageModel_UserData));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UsagemodelPackage.USER_DATA__USAGE_MODEL_USER_DATA:
				return eInternalContainer().eInverseRemove(this, UsagemodelPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL, UsageModel.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UsagemodelPackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA:
				...
				getUserDataParameterUsages_UserData().addAll((Collection<? extends SetVariable>)newValue);
				return;
		}

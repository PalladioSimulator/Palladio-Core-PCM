 ...
 * @generated
 */
public class ScenarioBehaviourImpl extends EntityImpl implements
		ScenarioBehaviour {
	/**
	 ...
	 */
	@Override
	public boolean Exactlyonestart(DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(
				EXACTLYONESTART__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(this)) {
			if (diagnostics != null) {
				diagnostics
	 ...
	 */
	@Override
	public boolean Exactlyonestop(DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
				EXACTLYONESTOP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(this)) {
			if (diagnostics != null) {
	 ...
	 */
	@Override
	public boolean EachuseractionexceptStartandStopmusthaveapredecessorandsuccessor(
	...
	public NotificationChain basicSetBranchTransition_ScenarioBehaviour(
			BranchTransition newBranchTransition_ScenarioBehaviour,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newBranchTransition_ScenarioBehaviour,
	 ...
	 */
	@Override
	public void setBranchTransition_ScenarioBehaviour(
			BranchTransition newBranchTransition_ScenarioBehaviour) {
		if (newBranchTransition_ScenarioBehaviour != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newBranchTransition_ScenarioBehaviour))
			...
			if (newBranchTransition_ScenarioBehaviour != null)
				msgs = ((InternalEObject) newBranchTransition_ScenarioBehaviour)
						.eInverseAdd(
								this,
								UsagemodelPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION,
								BranchTransition.class, msgs);
			msgs = basicSetBranchTransition_ScenarioBehaviour(
					newBranchTransition_ScenarioBehaviour, msgs);
			if (msgs != null)
				msgs.dispatch();
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLoop_ScenarioBehaviour(
			Loop newLoop_ScenarioBehaviour, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newLoop_ScenarioBehaviour,
				UsagemodelPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR,
				msgs);
		return msgs;
	}
	...
	public void setLoop_ScenarioBehaviour(Loop newLoop_ScenarioBehaviour) {
		if (newLoop_ScenarioBehaviour != eInternalContainer()
			...
			if (newLoop_ScenarioBehaviour != null)
				msgs = ((InternalEObject) newLoop_ScenarioBehaviour)
						.eInverseAdd(this,
								UsagemodelPackage.LOOP__BODY_BEHAVIOUR_LOOP,
								Loop.class, msgs);
			msgs = basicSetLoop_ScenarioBehaviour(newLoop_ScenarioBehaviour,
					msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					UsagemodelPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR,
					newLoop_ScenarioBehaviour, newLoop_ScenarioBehaviour));
	}
	...
	public NotificationChain basicSetUsageScenario_SenarioBehaviour(
			UsageScenario newUsageScenario_SenarioBehaviour,
			NotificationChain msgs) {
		msgs = eBasicSetContainer(
				(InternalEObject) newUsageScenario_SenarioBehaviour,
	 ...
	 */
	@Override
	public void setUsageScenario_SenarioBehaviour(
			UsageScenario newUsageScenario_SenarioBehaviour) {
		if (newUsageScenario_SenarioBehaviour != eInternalContainer()
			...
			if (EcoreUtil.isAncestor(this,
					(EObject) newUsageScenario_SenarioBehaviour))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
			...
			if (newUsageScenario_SenarioBehaviour != null)
				msgs = ((InternalEObject) newUsageScenario_SenarioBehaviour)
						.eInverseAdd(
								this,
								UsagemodelPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO,
								UsageScenario.class, msgs);
			msgs = basicSetUsageScenario_SenarioBehaviour(
					newUsageScenario_SenarioBehaviour, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case UsagemodelPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetUsageScenario_SenarioBehaviour(
					(UsageScenario) otherEnd, msgs);
		case UsagemodelPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetBranchTransition_ScenarioBehaviour(
					(BranchTransition) otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case UsagemodelPackage.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR:
			return ((InternalEList<?>) getActions_ScenarioBehaviour())
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
		...
		case UsagemodelPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR:
			return eInternalContainer().eInverseRemove(this,
					UsagemodelPackage.LOOP__BODY_BEHAVIOUR_LOOP, Loop.class,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case UsagemodelPackage.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR:
			...
			getActions_ScenarioBehaviour().addAll(
					(Collection<? extends AbstractUserAction>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case UsagemodelPackage.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR:
			return actions_ScenarioBehaviour != null
					&& !actions_ScenarioBehaviour.isEmpty();
		}

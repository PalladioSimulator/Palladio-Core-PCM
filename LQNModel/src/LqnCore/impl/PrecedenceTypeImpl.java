 ...
 *   <li>{@link LqnCore.impl.PrecedenceTypeImpl#getPreAND <em>Pre AND</em>}</li>
 *   <li>{@link LqnCore.impl.PrecedenceTypeImpl#getPost <em>Post</em>}</li>
 *   <li>{@link LqnCore.impl.PrecedenceTypeImpl#getPostOR <em>Post OR</em>}</li>

 ...
 * <ul>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getResultJoinDelay <em>Result Join Delay</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getResultForwarding <em>Result Forwarding</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getServiceTimeDistribution <em>Service Time Distribution</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getResultActivity <em>Result Activity</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getCallOrder <em>Call Order</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getHostDemandCvsq <em>Host Demand Cvsq</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getHostDemandMean <em>Host Demand Mean</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getMaxServiceTime <em>Max Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getName <em>Name</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityDefBaseImpl#getThinkTime <em>Think Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityDefBaseImpl extends EObjectImpl implements ActivityDefBase {
	...
	public EList<OutputResultForwardingANDJoinDelay> getResultJoinDelay() {
		if (resultJoinDelay == null) {
			resultJoinDelay = new EObjectContainmentEList<OutputResultForwardingANDJoinDelay>(OutputResultForwardingANDJoinDelay.class, this, LqnCorePackage.ACTIVITY_DEF_BASE__RESULT_JOIN_DELAY);
		}
	...
	public EList<OutputResultForwardingANDJoinDelay> getResultForwarding() {
		if (resultForwarding == null) {
			resultForwarding = new EObjectContainmentEList<OutputResultForwardingANDJoinDelay>(OutputResultForwardingANDJoinDelay.class, this, LqnCorePackage.ACTIVITY_DEF_BASE__RESULT_FORWARDING);
		}
	...
	public EList<OutputDistributionType> getServiceTimeDistribution() {
		if (serviceTimeDistribution == null) {
			serviceTimeDistribution = new EObjectContainmentEList<OutputDistributionType>(OutputDistributionType.class, this, LqnCorePackage.ACTIVITY_DEF_BASE__SERVICE_TIME_DISTRIBUTION);
		}
	...
	public EList<OutputResultType> getResultActivity() {
		if (resultActivity == null) {
			resultActivity = new EObjectContainmentEList<OutputResultType>(OutputResultType.class, this, LqnCorePackage.ACTIVITY_DEF_BASE__RESULT_ACTIVITY);
		}
	...
	public void setCallOrder(CallOrderType newCallOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.ACTIVITY_DEF_BASE__CALL_ORDER, oldCallOrder, callOrder, !oldCallOrderESet));
	}
	...
	public void unsetCallOrder() {
		...
		callOrderESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnCorePackage.ACTIVITY_DEF_BASE__CALL_ORDER, oldCallOrder, CALL_ORDER_EDEFAULT, oldCallOrderESet));
	}
	...
	public void setHostDemandCvsq(Object newHostDemandCvsq) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.ACTIVITY_DEF_BASE__HOST_DEMAND_CVSQ, oldHostDemandCvsq, hostDemandCvsq));
	}
	...
	public void setHostDemandMean(Object newHostDemandMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.ACTIVITY_DEF_BASE__HOST_DEMAND_MEAN, oldHostDemandMean, hostDemandMean));
	}
	...
	public void setMaxServiceTime(Object newMaxServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.ACTIVITY_DEF_BASE__MAX_SERVICE_TIME, oldMaxServiceTime, maxServiceTime));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.ACTIVITY_DEF_BASE__NAME, oldName, name));
	}
	...
	public void setThinkTime(Object newThinkTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.ACTIVITY_DEF_BASE__THINK_TIME, oldThinkTime, thinkTime));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LqnCorePackage.ACTIVITY_DEF_BASE__RESULT_JOIN_DELAY:
				return ((InternalEList<?>)getResultJoinDelay()).basicRemove(otherEnd, msgs);
			case LqnCorePackage.ACTIVITY_DEF_BASE__RESULT_FORWARDING:
				return ((InternalEList<?>)getResultForwarding()).basicRemove(otherEnd, msgs);
			case LqnCorePackage.ACTIVITY_DEF_BASE__SERVICE_TIME_DISTRIBUTION:
				return ((InternalEList<?>)getServiceTimeDistribution()).basicRemove(otherEnd, msgs);
			case LqnCorePackage.ACTIVITY_DEF_BASE__RESULT_ACTIVITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LqnCorePackage.ACTIVITY_DEF_BASE__CALL_ORDER:
				return getCallOrder();
			case LqnCorePackage.ACTIVITY_DEF_BASE__HOST_DEMAND_CVSQ:
				return getHostDemandCvsq();
			case LqnCorePackage.ACTIVITY_DEF_BASE__HOST_DEMAND_MEAN:
				return getHostDemandMean();
			case LqnCorePackage.ACTIVITY_DEF_BASE__MAX_SERVICE_TIME:
				return getMaxServiceTime();
			case LqnCorePackage.ACTIVITY_DEF_BASE__NAME:
				return getName();
			case LqnCorePackage.ACTIVITY_DEF_BASE__THINK_TIME:
				return getThinkTime();
		}

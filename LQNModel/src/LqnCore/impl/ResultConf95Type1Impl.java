...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Result Conf95 Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getOpenWaitTime <em>Open Wait Time</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase1ProcWaiting <em>Phase1 Proc Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase1ServiceTime <em>Phase1 Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase1ServiceTimeVariance <em>Phase1 Service Time Variance</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase1Utilization <em>Phase1 Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase2ProcWaiting <em>Phase2 Proc Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase2ServiceTime <em>Phase2 Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase2ServiceTimeVariance <em>Phase2 Service Time Variance</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase2Utilization <em>Phase2 Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase3ProcWaiting <em>Phase3 Proc Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase3ServiceTime <em>Phase3 Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase3ServiceTimeVariance <em>Phase3 Service Time Variance</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getPhase3Utilization <em>Phase3 Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getProbExceedMaxServiceTime <em>Prob Exceed Max Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getProcUtilization <em>Proc Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getProcWaiting <em>Proc Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getServiceTime <em>Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getServiceTimeVariance <em>Service Time Variance</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getSquaredCoeffVariation <em>Squared Coeff Variation</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getThroughput <em>Throughput</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getThroughputBound <em>Throughput Bound</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getUtilization <em>Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getWaiting <em>Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95Type1Impl#getWaitingVariance <em>Waiting Variance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ResultConf95Type1Impl extends EObjectImpl implements ResultConf95Type1 {
	/**
	 ...
	 * @generated
	 */
	protected ResultConf95Type1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return LqnCorePackage.Literals.RESULT_CONF95_TYPE1;
	}
	...
	public void setOpenWaitTime(Object newOpenWaitTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__OPEN_WAIT_TIME, oldOpenWaitTime, openWaitTime));
	}
	...
	public void setPhase1ProcWaiting(Object newPhase1ProcWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE1_PROC_WAITING, oldPhase1ProcWaiting, phase1ProcWaiting));
	}
	...
	public void setPhase1ServiceTime(Object newPhase1ServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE1_SERVICE_TIME, oldPhase1ServiceTime, phase1ServiceTime));
	}
	...
	public void setPhase1ServiceTimeVariance(Object newPhase1ServiceTimeVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE1_SERVICE_TIME_VARIANCE, oldPhase1ServiceTimeVariance, phase1ServiceTimeVariance));
	}
	...
	public void setPhase1Utilization(Object newPhase1Utilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE1_UTILIZATION, oldPhase1Utilization, phase1Utilization));
	}
	...
	public void setPhase2ProcWaiting(Object newPhase2ProcWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE2_PROC_WAITING, oldPhase2ProcWaiting, phase2ProcWaiting));
	}
	...
	public void setPhase2ServiceTime(Object newPhase2ServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE2_SERVICE_TIME, oldPhase2ServiceTime, phase2ServiceTime));
	}
	...
	public void setPhase2ServiceTimeVariance(Object newPhase2ServiceTimeVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE2_SERVICE_TIME_VARIANCE, oldPhase2ServiceTimeVariance, phase2ServiceTimeVariance));
	}
	...
	public void setPhase2Utilization(Object newPhase2Utilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE2_UTILIZATION, oldPhase2Utilization, phase2Utilization));
	}
	...
	public void setPhase3ProcWaiting(Object newPhase3ProcWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE3_PROC_WAITING, oldPhase3ProcWaiting, phase3ProcWaiting));
	}
	...
	public void setPhase3ServiceTime(Object newPhase3ServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE3_SERVICE_TIME, oldPhase3ServiceTime, phase3ServiceTime));
	}
	...
	public void setPhase3ServiceTimeVariance(Object newPhase3ServiceTimeVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE3_SERVICE_TIME_VARIANCE, oldPhase3ServiceTimeVariance, phase3ServiceTimeVariance));
	}
	...
	public void setPhase3Utilization(Object newPhase3Utilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PHASE3_UTILIZATION, oldPhase3Utilization, phase3Utilization));
	}
	...
	public void setProbExceedMaxServiceTime(Object newProbExceedMaxServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PROB_EXCEED_MAX_SERVICE_TIME, oldProbExceedMaxServiceTime, probExceedMaxServiceTime));
	}
	...
	public void setProcUtilization(Object newProcUtilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PROC_UTILIZATION, oldProcUtilization, procUtilization));
	}
	...
	public void setProcWaiting(Object newProcWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__PROC_WAITING, oldProcWaiting, procWaiting));
	}
	...
	public void setServiceTime(Object newServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__SERVICE_TIME, oldServiceTime, serviceTime));
	}
	...
	public void setServiceTimeVariance(Object newServiceTimeVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__SERVICE_TIME_VARIANCE, oldServiceTimeVariance, serviceTimeVariance));
	}
	...
	public void setSquaredCoeffVariation(Object newSquaredCoeffVariation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__SQUARED_COEFF_VARIATION, oldSquaredCoeffVariation, squaredCoeffVariation));
	}
	...
	public void setThroughput(Object newThroughput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__THROUGHPUT, oldThroughput, throughput));
	}
	...
	public void setThroughputBound(Object newThroughputBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__THROUGHPUT_BOUND, oldThroughputBound, throughputBound));
	}
	...
	public void setUtilization(Object newUtilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__UTILIZATION, oldUtilization, utilization));
	}
	...
	public void setWaiting(Object newWaiting) {
		...
		waiting = newWaiting;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__WAITING, oldWaiting, waiting));
	}
	...
	public void setWaitingVariance(Object newWaitingVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE1__WAITING_VARIANCE, oldWaitingVariance, waitingVariance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LqnCorePackage.RESULT_CONF95_TYPE1__OPEN_WAIT_TIME:
				return getOpenWaitTime();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE1_PROC_WAITING:
				return getPhase1ProcWaiting();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE1_SERVICE_TIME:
				return getPhase1ServiceTime();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE1_SERVICE_TIME_VARIANCE:
				return getPhase1ServiceTimeVariance();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE1_UTILIZATION:
				return getPhase1Utilization();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE2_PROC_WAITING:
				return getPhase2ProcWaiting();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE2_SERVICE_TIME:
				return getPhase2ServiceTime();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE2_SERVICE_TIME_VARIANCE:
				return getPhase2ServiceTimeVariance();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE2_UTILIZATION:
				return getPhase2Utilization();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE3_PROC_WAITING:
				return getPhase3ProcWaiting();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE3_SERVICE_TIME:
				return getPhase3ServiceTime();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE3_SERVICE_TIME_VARIANCE:
				return getPhase3ServiceTimeVariance();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PHASE3_UTILIZATION:
				return getPhase3Utilization();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PROB_EXCEED_MAX_SERVICE_TIME:
				return getProbExceedMaxServiceTime();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PROC_UTILIZATION:
				return getProcUtilization();
			case LqnCorePackage.RESULT_CONF95_TYPE1__PROC_WAITING:
				return getProcWaiting();
			case LqnCorePackage.RESULT_CONF95_TYPE1__SERVICE_TIME:
				return getServiceTime();
			case LqnCorePackage.RESULT_CONF95_TYPE1__SERVICE_TIME_VARIANCE:
				return getServiceTimeVariance();
			case LqnCorePackage.RESULT_CONF95_TYPE1__SQUARED_COEFF_VARIATION:
				return getSquaredCoeffVariation();
			case LqnCorePackage.RESULT_CONF95_TYPE1__THROUGHPUT:
				return getThroughput();
			case LqnCorePackage.RESULT_CONF95_TYPE1__THROUGHPUT_BOUND:
				return getThroughputBound();
			case LqnCorePackage.RESULT_CONF95_TYPE1__UTILIZATION:
				return getUtilization();
			case LqnCorePackage.RESULT_CONF95_TYPE1__WAITING:
				return getWaiting();
			case LqnCorePackage.RESULT_CONF95_TYPE1__WAITING_VARIANCE:

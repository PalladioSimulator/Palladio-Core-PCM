...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Result Conf95 Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link LqnCore.impl.ResultConf95TypeImpl#getJoinVariance <em>Join Variance</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95TypeImpl#getJoinWaiting <em>Join Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.ResultConf95TypeImpl#getWaiting <em>Waiting</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResultConf95TypeImpl extends EObjectImpl implements ResultConf95Type {
	...
	protected EClass eStaticClass() {
		return LqnCorePackage.Literals.RESULT_CONF95_TYPE;
	}
	...
	public void setJoinVariance(Object newJoinVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE__JOIN_VARIANCE, oldJoinVariance, joinVariance));
	}
	...
	public void setJoinWaiting(Object newJoinWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE__JOIN_WAITING, oldJoinWaiting, joinWaiting));
	}
	...
	public void setWaiting(Object newWaiting) {
		...
		waiting = newWaiting;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_CONF95_TYPE__WAITING, oldWaiting, waiting));
	}

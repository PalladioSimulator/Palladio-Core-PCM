 ...
 * <ul>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getResultConf95 <em>Result Conf95</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getResultConf99 <em>Result Conf99</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getOpenWaitTime <em>Open Wait Time</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase1ProcWaiting <em>Phase1 Proc Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase1ServiceTime <em>Phase1 Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase1ServiceTimeVariance <em>Phase1 Service Time Variance</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase1Utilization <em>Phase1 Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase2ProcWaiting <em>Phase2 Proc Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase2ServiceTime <em>Phase2 Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase2ServiceTimeVariance <em>Phase2 Service Time Variance</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase2Utilization <em>Phase2 Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase3ProcWaiting <em>Phase3 Proc Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase3ServiceTime <em>Phase3 Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase3ServiceTimeVariance <em>Phase3 Service Time Variance</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getPhase3Utilization <em>Phase3 Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getProbExceedMaxServiceTime <em>Prob Exceed Max Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getProcUtilization <em>Proc Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getProcWaiting <em>Proc Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getServiceTime <em>Service Time</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getServiceTimeVariance <em>Service Time Variance</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getSquaredCoeffVariation <em>Squared Coeff Variation</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getThroughput <em>Throughput</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getThroughputBound <em>Throughput Bound</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getUtilization <em>Utilization</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getWaiting <em>Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultTypeImpl#getWaitingVariance <em>Waiting Variance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutputResultTypeImpl extends EObjectImpl implements OutputResultType {
	...
	public EList<ResultConf95Type1> getResultConf95() {
		if (resultConf95 == null) {
			resultConf95 = new EObjectContainmentEList<ResultConf95Type1>(ResultConf95Type1.class, this, LqnCorePackage.OUTPUT_RESULT_TYPE__RESULT_CONF95);
		}
		return resultConf95;
	}
	...
	public EList<ResultConf99Type1> getResultConf99() {
		if (resultConf99 == null) {
			resultConf99 = new EObjectContainmentEList<ResultConf99Type1>(ResultConf99Type1.class, this, LqnCorePackage.OUTPUT_RESULT_TYPE__RESULT_CONF99);
		}
		return resultConf99;
	}
	...
	public void setOpenWaitTime(Object newOpenWaitTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__OPEN_WAIT_TIME, oldOpenWaitTime, openWaitTime));
	}
	...
	public void setPhase1ProcWaiting(Object newPhase1ProcWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE1_PROC_WAITING, oldPhase1ProcWaiting, phase1ProcWaiting));
	}
	...
	public void setPhase1ServiceTime(Object newPhase1ServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE1_SERVICE_TIME, oldPhase1ServiceTime, phase1ServiceTime));
	}
	...
	public void setPhase1ServiceTimeVariance(Object newPhase1ServiceTimeVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE1_SERVICE_TIME_VARIANCE, oldPhase1ServiceTimeVariance, phase1ServiceTimeVariance));
	}
	...
	public void setPhase1Utilization(Object newPhase1Utilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE1_UTILIZATION, oldPhase1Utilization, phase1Utilization));
	}
	...
	public void setPhase2ProcWaiting(Object newPhase2ProcWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE2_PROC_WAITING, oldPhase2ProcWaiting, phase2ProcWaiting));
	}
	...
	public void setPhase2ServiceTime(Object newPhase2ServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE2_SERVICE_TIME, oldPhase2ServiceTime, phase2ServiceTime));
	}
	...
	public void setPhase2ServiceTimeVariance(Object newPhase2ServiceTimeVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE2_SERVICE_TIME_VARIANCE, oldPhase2ServiceTimeVariance, phase2ServiceTimeVariance));
	}
	...
	public void setPhase2Utilization(Object newPhase2Utilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE2_UTILIZATION, oldPhase2Utilization, phase2Utilization));
	}
	...
	public void setPhase3ProcWaiting(Object newPhase3ProcWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE3_PROC_WAITING, oldPhase3ProcWaiting, phase3ProcWaiting));
	}
	...
	public void setPhase3ServiceTime(Object newPhase3ServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE3_SERVICE_TIME, oldPhase3ServiceTime, phase3ServiceTime));
	}
	...
	public void setPhase3ServiceTimeVariance(Object newPhase3ServiceTimeVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE3_SERVICE_TIME_VARIANCE, oldPhase3ServiceTimeVariance, phase3ServiceTimeVariance));
	}
	...
	public void setPhase3Utilization(Object newPhase3Utilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE3_UTILIZATION, oldPhase3Utilization, phase3Utilization));
	}
	...
	public void setProbExceedMaxServiceTime(Object newProbExceedMaxServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PROB_EXCEED_MAX_SERVICE_TIME, oldProbExceedMaxServiceTime, probExceedMaxServiceTime));
	}
	...
	public void setProcUtilization(Object newProcUtilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PROC_UTILIZATION, oldProcUtilization, procUtilization));
	}
	...
	public void setProcWaiting(Object newProcWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__PROC_WAITING, oldProcWaiting, procWaiting));
	}
	...
	public void setServiceTime(Object newServiceTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__SERVICE_TIME, oldServiceTime, serviceTime));
	}
	...
	public void setServiceTimeVariance(Object newServiceTimeVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__SERVICE_TIME_VARIANCE, oldServiceTimeVariance, serviceTimeVariance));
	}
	...
	public void setSquaredCoeffVariation(Object newSquaredCoeffVariation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__SQUARED_COEFF_VARIATION, oldSquaredCoeffVariation, squaredCoeffVariation));
	}
	...
	public void setThroughput(Object newThroughput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__THROUGHPUT, oldThroughput, throughput));
	}
	...
	public void setThroughputBound(Object newThroughputBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__THROUGHPUT_BOUND, oldThroughputBound, throughputBound));
	}
	...
	public void setUtilization(Object newUtilization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__UTILIZATION, oldUtilization, utilization));
	}
	...
	public void setWaiting(Object newWaiting) {
		...
		waiting = newWaiting;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__WAITING, oldWaiting, waiting));
	}
	...
	public void setWaitingVariance(Object newWaitingVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_TYPE__WAITING_VARIANCE, oldWaitingVariance, waitingVariance));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LqnCorePackage.OUTPUT_RESULT_TYPE__RESULT_CONF95:
				return ((InternalEList<?>)getResultConf95()).basicRemove(otherEnd, msgs);
			case LqnCorePackage.OUTPUT_RESULT_TYPE__RESULT_CONF99:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LqnCorePackage.OUTPUT_RESULT_TYPE__OPEN_WAIT_TIME:
				return getOpenWaitTime();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE1_PROC_WAITING:
				return getPhase1ProcWaiting();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE1_SERVICE_TIME:
				return getPhase1ServiceTime();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE1_SERVICE_TIME_VARIANCE:
				return getPhase1ServiceTimeVariance();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE1_UTILIZATION:
				return getPhase1Utilization();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE2_PROC_WAITING:
				return getPhase2ProcWaiting();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE2_SERVICE_TIME:
				return getPhase2ServiceTime();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE2_SERVICE_TIME_VARIANCE:
				return getPhase2ServiceTimeVariance();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE2_UTILIZATION:
				return getPhase2Utilization();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE3_PROC_WAITING:
				return getPhase3ProcWaiting();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE3_SERVICE_TIME:
				return getPhase3ServiceTime();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE3_SERVICE_TIME_VARIANCE:
				return getPhase3ServiceTimeVariance();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PHASE3_UTILIZATION:
				return getPhase3Utilization();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PROB_EXCEED_MAX_SERVICE_TIME:
				return getProbExceedMaxServiceTime();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PROC_UTILIZATION:
				return getProcUtilization();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__PROC_WAITING:
				return getProcWaiting();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__SERVICE_TIME:
				return getServiceTime();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__SERVICE_TIME_VARIANCE:
				return getServiceTimeVariance();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__SQUARED_COEFF_VARIATION:
				return getSquaredCoeffVariation();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__THROUGHPUT:
				return getThroughput();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__THROUGHPUT_BOUND:
				return getThroughputBound();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__UTILIZATION:
				return getUtilization();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__WAITING:
				return getWaiting();
			case LqnCorePackage.OUTPUT_RESULT_TYPE__WAITING_VARIANCE:

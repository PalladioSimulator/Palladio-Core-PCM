 ...
 *   <li>{@link LqnCore.impl.SolverParamsTypeImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link LqnCore.impl.SolverParamsTypeImpl#getConvVal <em>Conv Val</em>}</li>
 *   <li>{@link LqnCore.impl.SolverParamsTypeImpl#getItLimit <em>It Limit</em>}</li>

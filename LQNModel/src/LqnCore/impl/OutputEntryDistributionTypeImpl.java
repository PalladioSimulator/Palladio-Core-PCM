 ...
 * <ul>
 *   <li>{@link LqnCore.impl.OutputEntryDistributionTypeImpl#getPhase <em>Phase</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutputEntryDistributionTypeImpl extends OutputDistributionTypeImpl implements OutputEntryDistributionType {
	...
	protected EClass eStaticClass() {
		return LqnCorePackage.Literals.OUTPUT_ENTRY_DISTRIBUTION_TYPE;
	}
	...
	public void setPhase(BigInteger newPhase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_ENTRY_DISTRIBUTION_TYPE__PHASE, oldPhase, phase));
	}

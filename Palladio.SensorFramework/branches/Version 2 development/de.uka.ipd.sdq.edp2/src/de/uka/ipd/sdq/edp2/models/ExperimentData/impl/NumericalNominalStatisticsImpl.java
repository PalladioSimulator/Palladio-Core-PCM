...
public class NumericalNominalStatisticsImpl extends IdentifiableImpl implements NumericalNominalStatistics {
	 ...
	 * @ordered
	 */
	protected static final Measure NUMBER_MEASUREMENTS_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Measure numberMeasurements = NUMBER_MEASUREMENTS_EDEFAULT;
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__NUMBER_MEASUREMENTS:
				return NUMBER_MEASUREMENTS_EDEFAULT == null ? numberMeasurements != null : !NUMBER_MEASUREMENTS_EDEFAULT.equals(numberMeasurements);
			case ExperimentDataPackage.NUMERICAL_NOMINAL_STATISTICS__NUMERICAL_MASS_DISTRIBUTION:

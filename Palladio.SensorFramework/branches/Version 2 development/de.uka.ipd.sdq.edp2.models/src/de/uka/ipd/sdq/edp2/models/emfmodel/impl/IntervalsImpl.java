 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.edp2.models.emfmodel.impl.IntervalsImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.edp2.models.emfmodel.impl.IntervalsImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.edp2.models.emfmodel.impl.IntervalsImpl#getNumberOfIntervals <em>Number Of Intervals</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.edp2.models.emfmodel.impl.IntervalsImpl#getAggregatedMeasurements <em>Aggregated Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IntervalsImpl extends RawXSeriesImpl implements Intervals {
	/**
	...
	protected EClass eStaticClass() {
		return EmfmodelPackage.Literals.INTERVALS;
	}
	...
	public void setLowerBound(Measure newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmodelPackage.INTERVALS__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setWidth(Measure newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmodelPackage.INTERVALS__WIDTH, oldWidth, width));
	}
	...
	public void setNumberOfIntervals(long newNumberOfIntervals) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmodelPackage.INTERVALS__NUMBER_OF_INTERVALS, oldNumberOfIntervals, numberOfIntervals));
	}
	...
	public FixedWidthAggregation getAggregatedMeasurements() {
		if (eContainerFeatureID != EmfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS) return null;
	...
	public NotificationChain basicSetAggregatedMeasurements(FixedWidthAggregation newAggregatedMeasurements, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newAggregatedMeasurements, EmfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS, msgs);
		return msgs;
	}
	...
	public void setAggregatedMeasurements(FixedWidthAggregation newAggregatedMeasurements) {
		if (newAggregatedMeasurements != eInternalContainer() || (eContainerFeatureID != EmfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS && newAggregatedMeasurements != null)) {
			...
			if (newAggregatedMeasurements != null)
				msgs = ((InternalEObject)newAggregatedMeasurements).eInverseAdd(this, EmfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_XSERIES, FixedWidthAggregation.class, msgs);
			msgs = basicSetAggregatedMeasurements(newAggregatedMeasurements, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS, newAggregatedMeasurements, newAggregatedMeasurements));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case EmfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS:
				return eInternalContainer().eInverseRemove(this, EmfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_XSERIES, FixedWidthAggregation.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfmodelPackage.INTERVALS__LOWER_BOUND:
				return getLowerBound();
			case EmfmodelPackage.INTERVALS__WIDTH:
				return getWidth();
			case EmfmodelPackage.INTERVALS__NUMBER_OF_INTERVALS:

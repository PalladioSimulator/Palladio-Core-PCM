 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.edp2.models.emfmodel.impl.DoubleBinaryMeasurementsImpl#getStorageUnit <em>Storage Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoubleBinaryMeasurementsImpl extends DataSeriesImpl implements DoubleBinaryMeasurements {
	...
	protected EClass eStaticClass() {
		return EmfmodelPackage.Literals.DOUBLE_BINARY_MEASUREMENTS;
	}
	...
	public void setStorageUnit(Unit newStorageUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmodelPackage.DOUBLE_BINARY_MEASUREMENTS__STORAGE_UNIT, oldStorageUnit, storageUnit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfmodelPackage.DOUBLE_BINARY_MEASUREMENTS__STORAGE_UNIT:

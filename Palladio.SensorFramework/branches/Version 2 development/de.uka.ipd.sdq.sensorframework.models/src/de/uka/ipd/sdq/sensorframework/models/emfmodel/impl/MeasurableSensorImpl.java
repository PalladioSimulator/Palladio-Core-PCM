 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.MeasurableSensorImpl#getUnitOfMeasurements <em>Unit Of Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MeasurableSensorImpl extends SensorDeclarationImpl implements MeasurableSensor {
	...
	protected EClass eStaticClass() {
		return emfmodelPackage.Literals.MEASURABLE_SENSOR;
	}
	...
	public void setUnitOfMeasurements(Unit newUnitOfMeasurements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.MEASURABLE_SENSOR__UNIT_OF_MEASUREMENTS, oldUnitOfMeasurements, unitOfMeasurements));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 emfmodelValidator.MEASURABLE_SENSOR__PERSISTENCY_KIND_NOT_EMF,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case emfmodelPackage.MEASURABLE_SENSOR__UNIT_OF_MEASUREMENTS:

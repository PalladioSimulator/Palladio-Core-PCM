 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.RawYValues#getStatistics <em>Statistics</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.RawYValues#getAggregatedMeasurements <em>Aggregated Measurements</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.RawYValues#getRawMeasurements <em>Raw Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.sensorframework.models.emfmodel.emfmodelPackage#getRawYValues()
 * @model abstract="true"
 * @generated
 */
public interface RawYValues extends Identifiable {
	/**
	 * Returns the value of the '<em><b>Statistics</b></em>' containment reference.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.Statistics#getRawYValues <em>Raw YValues</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.models.emfmodel.emfmodelPackage#getRawYValues_Statistics()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.RawYValues#getStatistics <em>Statistics</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.FixedWidthAggregation#getRawYValues <em>Raw YValues</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.models.emfmodel.emfmodelPackage#getRawYValues_AggregatedMeasurements()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.RawYValues#getAggregatedMeasurements <em>Aggregated Measurements</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.RawMeasurements#getRawYValues <em>Raw YValues</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.models.emfmodel.emfmodelPackage#getRawYValues_RawMeasurements()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.RawYValues#getRawMeasurements <em>Raw Measurements</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

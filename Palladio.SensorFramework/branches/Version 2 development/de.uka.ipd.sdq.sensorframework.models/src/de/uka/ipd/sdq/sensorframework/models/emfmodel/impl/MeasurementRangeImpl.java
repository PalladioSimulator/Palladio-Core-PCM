 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.MeasurementRangeImpl#getRawMeasurements <em>Raw Measurements</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.MeasurementRangeImpl#getEndTime <em>End Time</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.MeasurementRangeImpl#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.MeasurementRangeImpl#getCollectedData <em>Collected Data</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.MeasurementRangeImpl#getAggregatedMeasurements <em>Aggregated Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MeasurementRangeImpl extends EObjectImpl implements MeasurementRange {
	...
	public void setCollectedData(CollectedData newCollectedData) {
		if (newCollectedData != eInternalContainer() || (eContainerFeatureID != emfmodelPackage.MEASUREMENT_RANGE__COLLECTED_DATA && newCollectedData != null)) {
			...
			if (newCollectedData != null)
				msgs = ((InternalEObject)newCollectedData).eInverseAdd(this, emfmodelPackage.COLLECTED_DATA__MEASUREMENT_RANGE, CollectedData.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case emfmodelPackage.MEASUREMENT_RANGE__COLLECTED_DATA:
				return eInternalContainer().eInverseRemove(this, emfmodelPackage.COLLECTED_DATA__MEASUREMENT_RANGE, CollectedData.class, msgs);
		}

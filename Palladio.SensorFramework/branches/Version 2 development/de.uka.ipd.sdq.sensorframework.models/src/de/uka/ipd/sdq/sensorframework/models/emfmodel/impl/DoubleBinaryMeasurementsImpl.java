 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.DoubleBinaryMeasurementsImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoubleBinaryMeasurementsImpl extends RawYValuesImpl implements DoubleBinaryMeasurements {
	...
	public void setUnit(Unit newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.DOUBLE_BINARY_MEASUREMENTS__UNIT, oldUnit, unit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case emfmodelPackage.DOUBLE_BINARY_MEASUREMENTS__UNIT:
				return getUnit();
		}

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.FixedWidthAggregationImpl#getRawXValues <em>Raw XValues</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.FixedWidthAggregationImpl#getRawYValues <em>Raw YValues</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FixedWidthAggregationImpl extends AggregatedMeasurementsImpl implements FixedWidthAggregation {
	...
	public NotificationChain basicSetRawXValues(Intervals newRawXValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_XVALUES, oldRawXValues, newRawXValues);
	...
	public void setRawXValues(Intervals newRawXValues) {
		if (newRawXValues != rawXValues) {
			...
			if (rawXValues != null)
				msgs = ((InternalEObject)rawXValues).eInverseRemove(this, emfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS, Intervals.class, msgs);
			if (newRawXValues != null)
				msgs = ((InternalEObject)newRawXValues).eInverseAdd(this, emfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS, Intervals.class, msgs);
			msgs = basicSetRawXValues(newRawXValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_XVALUES, newRawXValues, newRawXValues));
	}
	...
	public NotificationChain basicSetRawYValues(RawYValues newRawYValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_YVALUES, oldRawYValues, newRawYValues);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRawYValues(RawYValues newRawYValues) {
		if (newRawYValues != rawYValues) {
			NotificationChain msgs = null;
			if (rawYValues != null)
				msgs = ((InternalEObject)rawYValues).eInverseRemove(this, emfmodelPackage.RAW_YVALUES__AGGREGATED_MEASUREMENTS, RawYValues.class, msgs);
			if (newRawYValues != null)
				msgs = ((InternalEObject)newRawYValues).eInverseAdd(this, emfmodelPackage.RAW_YVALUES__AGGREGATED_MEASUREMENTS, RawYValues.class, msgs);
			msgs = basicSetRawYValues(newRawYValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_YVALUES, newRawYValues, newRawYValues));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_XVALUES:
				if (rawXValues != null)
					msgs = ((InternalEObject)rawXValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_XVALUES, null, msgs);
				return basicSetRawXValues((Intervals)otherEnd, msgs);
			case emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_YVALUES:
				if (rawYValues != null)
					msgs = ((InternalEObject)rawYValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_YVALUES, null, msgs);

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.MeasureCharacterizationImpl#getMeasuredObject <em>Measured Object</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.MeasureCharacterizationImpl#getMetric <em>Metric</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.MeasureCharacterizationImpl#getSensorDeclaration <em>Sensor Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MeasureCharacterizationImpl extends PropertyableImpl implements MeasureCharacterization {
	...
	protected EClass eStaticClass() {
		return emfmodelPackage.Literals.MEASURE_CHARACTERIZATION;
	}
	...
	public void setMeasuredObject(String newMeasuredObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.MEASURE_CHARACTERIZATION__MEASURED_OBJECT, oldMeasuredObject, measuredObject));
	}
	...
	public void setMetric(String newMetric) {
		...
		metric = newMetric;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.MEASURE_CHARACTERIZATION__METRIC, oldMetric, metric));
	}
	...
	public SensorDeclaration getSensorDeclaration() {
		if (eContainerFeatureID != emfmodelPackage.MEASURE_CHARACTERIZATION__SENSOR_DECLARATION) return null;
	...
	public NotificationChain basicSetSensorDeclaration(SensorDeclaration newSensorDeclaration, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSensorDeclaration, emfmodelPackage.MEASURE_CHARACTERIZATION__SENSOR_DECLARATION, msgs);
		return msgs;
	}
	...
	public void setSensorDeclaration(SensorDeclaration newSensorDeclaration) {
		if (newSensorDeclaration != eInternalContainer() || (eContainerFeatureID != emfmodelPackage.MEASURE_CHARACTERIZATION__SENSOR_DECLARATION && newSensorDeclaration != null)) {
			...
			if (newSensorDeclaration != null)
				msgs = ((InternalEObject)newSensorDeclaration).eInverseAdd(this, emfmodelPackage.SENSOR_DECLARATION__MEASURE_CHARACTERIZATION, SensorDeclaration.class, msgs);
			msgs = basicSetSensorDeclaration(newSensorDeclaration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.MEASURE_CHARACTERIZATION__SENSOR_DECLARATION, newSensorDeclaration, newSensorDeclaration));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case emfmodelPackage.MEASURE_CHARACTERIZATION__SENSOR_DECLARATION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case emfmodelPackage.MEASURE_CHARACTERIZATION__SENSOR_DECLARATION:
				return eInternalContainer().eInverseRemove(this, emfmodelPackage.SENSOR_DECLARATION__MEASURE_CHARACTERIZATION, SensorDeclaration.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case emfmodelPackage.MEASURE_CHARACTERIZATION__MEASURED_OBJECT:
				return getMeasuredObject();
			case emfmodelPackage.MEASURE_CHARACTERIZATION__METRIC:
				return getMetric();
			case emfmodelPackage.MEASURE_CHARACTERIZATION__SENSOR_DECLARATION:

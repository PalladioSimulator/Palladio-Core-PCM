 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.AdvancedStatisticsImpl#getMedian <em>Median</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.AdvancedStatisticsImpl#getVariance <em>Variance</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.AdvancedStatisticsImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdvancedStatisticsImpl extends StatisticsImpl implements AdvancedStatistics {
	...
	protected EClass eStaticClass() {
		return emfmodelPackage.Literals.ADVANCED_STATISTICS;
	}
	...
	public void setMedian(Measure newMedian) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.ADVANCED_STATISTICS__MEDIAN, oldMedian, median));
	}
	...
	public void setVariance(double newVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.ADVANCED_STATISTICS__VARIANCE, oldVariance, variance));
	}
	...
	public void setStandardDeviation(double newStandardDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.ADVANCED_STATISTICS__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case emfmodelPackage.ADVANCED_STATISTICS__MEDIAN:
				return getMedian();
			case emfmodelPackage.ADVANCED_STATISTICS__VARIANCE:
				return new Double(getVariance());
			case emfmodelPackage.ADVANCED_STATISTICS__STANDARD_DEVIATION:

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.LongBinaryMeasurementsImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LongBinaryMeasurementsImpl extends RawYValuesImpl implements LongBinaryMeasurements {
	/**
	...
	public void setUnit(Unit newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.LONG_BINARY_MEASUREMENTS__UNIT, oldUnit, unit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case emfmodelPackage.LONG_BINARY_MEASUREMENTS__UNIT:
				return getUnit();
		}

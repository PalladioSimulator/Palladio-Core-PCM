 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.RawMeasurementsImpl#getRawXValues <em>Raw XValues</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.RawMeasurementsImpl#getRawYValues <em>Raw YValues</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.RawMeasurementsImpl#getMeasurementRange <em>Measurement Range</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RawMeasurementsImpl extends IdentifiableImpl implements RawMeasurements {
	...
	public NotificationChain basicSetRawXValues(RawXValues newRawXValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, emfmodelPackage.RAW_MEASUREMENTS__RAW_XVALUES, oldRawXValues, newRawXValues);
	...
	public void setRawXValues(RawXValues newRawXValues) {
		if (newRawXValues != rawXValues) {
			...
			if (rawXValues != null)
				msgs = ((InternalEObject)rawXValues).eInverseRemove(this, emfmodelPackage.RAW_XVALUES__RAW_MEASUREMENTS, RawXValues.class, msgs);
			if (newRawXValues != null)
				msgs = ((InternalEObject)newRawXValues).eInverseAdd(this, emfmodelPackage.RAW_XVALUES__RAW_MEASUREMENTS, RawXValues.class, msgs);
			msgs = basicSetRawXValues(newRawXValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.RAW_MEASUREMENTS__RAW_XVALUES, newRawXValues, newRawXValues));
	}
	...
	public NotificationChain basicSetRawYValues(RawYValues newRawYValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, emfmodelPackage.RAW_MEASUREMENTS__RAW_YVALUES, oldRawYValues, newRawYValues);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRawYValues(RawYValues newRawYValues) {
		if (newRawYValues != rawYValues) {
			NotificationChain msgs = null;
			if (rawYValues != null)
				msgs = ((InternalEObject)rawYValues).eInverseRemove(this, emfmodelPackage.RAW_YVALUES__RAW_MEASUREMENTS, RawYValues.class, msgs);
			if (newRawYValues != null)
				msgs = ((InternalEObject)newRawYValues).eInverseAdd(this, emfmodelPackage.RAW_YVALUES__RAW_MEASUREMENTS, RawYValues.class, msgs);
			msgs = basicSetRawYValues(newRawYValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.RAW_MEASUREMENTS__RAW_YVALUES, newRawYValues, newRawYValues));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case emfmodelPackage.RAW_MEASUREMENTS__RAW_XVALUES:
				if (rawXValues != null)
					msgs = ((InternalEObject)rawXValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - emfmodelPackage.RAW_MEASUREMENTS__RAW_XVALUES, null, msgs);
				return basicSetRawXValues((RawXValues)otherEnd, msgs);
			case emfmodelPackage.RAW_MEASUREMENTS__RAW_YVALUES:
				if (rawYValues != null)
					msgs = ((InternalEObject)rawYValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - emfmodelPackage.RAW_MEASUREMENTS__RAW_YVALUES, null, msgs);

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.edp2.models.emfmodel.impl.ObservedNominalMeasurementsImpl#getObservedCategories <em>Observed Categories</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.edp2.models.emfmodel.impl.ObservedNominalMeasurementsImpl#getUuid <em>Uuid</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObservedNominalMeasurementsImpl extends EObjectImpl implements ObservedNominalMeasurements {
	/**
	 * The cached value of the '{@link #getObservedCategories() <em>Observed Categories</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<CategoryIdentifier> observedCategories;
	 ...
	 * @generated
	 */
	public EList<CategoryIdentifier> getObservedCategories() {
		if (observedCategories == null) {
			observedCategories = new EObjectResolvingEList<CategoryIdentifier>(CategoryIdentifier.class, this, EmfmodelPackage.OBSERVED_NOMINAL_MEASUREMENTS__OBSERVED_CATEGORIES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EmfmodelPackage.OBSERVED_NOMINAL_MEASUREMENTS__OBSERVED_CATEGORIES:
				...
				getObservedCategories().addAll((Collection<? extends CategoryIdentifier>)newValue);
				return;
			case EmfmodelPackage.OBSERVED_NOMINAL_MEASUREMENTS__UUID:

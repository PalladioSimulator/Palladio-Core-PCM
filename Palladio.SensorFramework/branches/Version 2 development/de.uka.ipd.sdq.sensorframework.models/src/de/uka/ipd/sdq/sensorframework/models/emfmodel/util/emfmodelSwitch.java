...
public class emfmodelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case emfmodelPackage.COLLECTED_DATA: {
			...
			case emfmodelPackage.SENSOR_DECLARATION: {
			...
			case emfmodelPackage.MEASURE_CHARACTERIZATION: {
			...
			case emfmodelPackage.LONG_BINARY_MEASUREMENTS: {
				...
				if (result == null) result = caseIdentifiable(longBinaryMeasurements);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case emfmodelPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case emfmodelPackage.STATE_MEASUREMENTS: {
				...
				if (result == null) result = caseIdentifiable(stateMeasurements);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case emfmodelPackage.STATE_SENSOR: {
			...
			case emfmodelPackage.DOUBLE_BINARY_MEASUREMENTS: {
				...
				if (result == null) result = caseIdentifiable(doubleBinaryMeasurements);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case emfmodelPackage.MEASURABLE_SENSOR: {
			...
			case emfmodelPackage.JS_XML_MEASUREMENTS: {
				...
				if (result == null) result = caseIdentifiable(jsXmlMeasurements);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case emfmodelPackage.INCREASING_MEASURABLE_SENSOR: {
			...
			case emfmodelPackage.ADVANCED_STATISTICS: {
			...
			case emfmodelPackage.DOUBLE_BINARY_EVENT_TIMES: {
				...
				if (result == null) result = caseRawXValues(doubleBinaryEventTimes);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

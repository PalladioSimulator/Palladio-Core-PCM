 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.StateSensorImpl#getDefinedSensorStates <em>Defined Sensor States</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.StateSensorImpl#getInitialState <em>Initial State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateSensorImpl extends SensorDeclarationImpl implements StateSensor {
	...
	protected EClass eStaticClass() {
		return emfmodelPackage.Literals.STATE_SENSOR;
	}
	...
	public EList<State> getDefinedSensorStates() {
		if (definedSensorStates == null) {
			definedSensorStates = new EObjectContainmentEList<State>(State.class, this, emfmodelPackage.STATE_SENSOR__DEFINED_SENSOR_STATES);
		}
		...
		if (initialState != null && initialState.eIsProxy()) {
			...
			if (initialState != oldInitialState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, emfmodelPackage.STATE_SENSOR__INITIAL_STATE, oldInitialState, initialState));
			}
		}
		return initialState;
	}
	...
	public void setInitialState(State newInitialState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.STATE_SENSOR__INITIAL_STATE, oldInitialState, initialState));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 emfmodelValidator.STATE_SENSOR__PERSISTENCE_KIND_ONLY_EMF_ALLOWED,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case emfmodelPackage.STATE_SENSOR__DEFINED_SENSOR_STATES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case emfmodelPackage.STATE_SENSOR__INITIAL_STATE:

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.IntervalsImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.IntervalsImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.IntervalsImpl#getNumberOfIntervals <em>Number Of Intervals</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.IntervalsImpl#getAggregatedMeasurements <em>Aggregated Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntervalsImpl extends RawXValuesImpl implements Intervals {
	...
	public void setAggregatedMeasurements(FixedWidthAggregation newAggregatedMeasurements) {
		if (newAggregatedMeasurements != eInternalContainer() || (eContainerFeatureID != emfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS && newAggregatedMeasurements != null)) {
			...
			if (newAggregatedMeasurements != null)
				msgs = ((InternalEObject)newAggregatedMeasurements).eInverseAdd(this, emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_XVALUES, FixedWidthAggregation.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case emfmodelPackage.INTERVALS__AGGREGATED_MEASUREMENTS:
				return eInternalContainer().eInverseRemove(this, emfmodelPackage.FIXED_WIDTH_AGGREGATION__RAW_XVALUES, FixedWidthAggregation.class, msgs);
		}

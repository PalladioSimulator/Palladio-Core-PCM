 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.StateImpl#getStateLiteral <em>State Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends EObjectImpl implements State {
	...
	protected EClass eStaticClass() {
		return emfmodelPackage.Literals.STATE;
	}
	...
	public void setStateLiteral(String newStateLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, emfmodelPackage.STATE__STATE_LITERAL, oldStateLiteral, stateLiteral));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case emfmodelPackage.STATE__STATE_LITERAL:

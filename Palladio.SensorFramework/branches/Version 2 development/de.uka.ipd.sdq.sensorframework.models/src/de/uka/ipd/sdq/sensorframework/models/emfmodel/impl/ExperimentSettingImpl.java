 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.ExperimentSettingImpl#getExperimentName <em>Experiment Name</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.ExperimentSettingImpl#getExperimentRuns <em>Experiment Runs</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.models.emfmodel.impl.ExperimentSettingImpl#getSensors <em>Sensors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExperimentSettingImpl extends PropertyableImpl implements ExperimentSetting {
	...
	public EList<SensorDeclaration> getSensors() {
		if (sensors == null) {
			sensors = new EObjectContainmentWithInverseEList<SensorDeclaration>(SensorDeclaration.class, this, emfmodelPackage.EXPERIMENT_SETTING__SENSORS, emfmodelPackage.SENSOR_DECLARATION__EXPERIMENT_SETTING);
		}
		return sensors;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case emfmodelPackage.EXPERIMENT_SETTING__SENSORS:

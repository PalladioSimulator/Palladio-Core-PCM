...
public interface RawMeasurements extends Identifiable {
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.sensorframework.RawXValues#getRawMeasurements <em>Raw Measurements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.sensorframework.RawYValues#getRawMeasurements <em>Raw Measurements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>

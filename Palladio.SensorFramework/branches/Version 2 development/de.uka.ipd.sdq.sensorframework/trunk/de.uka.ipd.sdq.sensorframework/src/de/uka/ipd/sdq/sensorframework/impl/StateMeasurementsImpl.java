 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.impl.StateMeasurementsImpl#getObservedStates <em>Observed States</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateMeasurementsImpl extends RawYValuesImpl implements StateMeasurements {
	...
	protected EClass eStaticClass() {
		return SensorframeworkPackage.Literals.STATE_MEASUREMENTS;
	}
	...
	public EList<State> getObservedStates() {
		if (observedStates == null) {
			observedStates = new EObjectResolvingEList<State>(State.class, this, SensorframeworkPackage.STATE_MEASUREMENTS__OBSERVED_STATES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SensorframeworkPackage.STATE_MEASUREMENTS__OBSERVED_STATES:

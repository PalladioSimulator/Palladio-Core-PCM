 ...
 *   <li>{@link de.uka.ipd.sdq.sensorframework.impl.StatisticsImpl#getSum <em>Sum</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.impl.StatisticsImpl#getCount <em>Count</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.impl.StatisticsImpl#getRawYValues <em>Raw YValues</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatisticsImpl extends EObjectImpl implements Statistics {
	...
	public void setSum(Measure newSum) {
		...
		sum = newSum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensorframeworkPackage.STATISTICS__SUM, oldSum, sum));
	}
	...
	public void setCount(long newCount) {
		...
		count = newCount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensorframeworkPackage.STATISTICS__COUNT, oldCount, count));
	}
	...
	public RawYValues getRawYValues() {
		if (eContainerFeatureID != SensorframeworkPackage.STATISTICS__RAW_YVALUES) return null;
	...
	public NotificationChain basicSetRawYValues(RawYValues newRawYValues, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newRawYValues, SensorframeworkPackage.STATISTICS__RAW_YVALUES, msgs);
		return msgs;
	}
	...
	public void setRawYValues(RawYValues newRawYValues) {
		if (newRawYValues != eInternalContainer() || (eContainerFeatureID != SensorframeworkPackage.STATISTICS__RAW_YVALUES && newRawYValues != null)) {
			...
			if (newRawYValues != null)
				msgs = ((InternalEObject)newRawYValues).eInverseAdd(this, SensorframeworkPackage.RAW_YVALUES__STATISTICS, RawYValues.class, msgs);
			msgs = basicSetRawYValues(newRawYValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensorframeworkPackage.STATISTICS__RAW_YVALUES, newRawYValues, newRawYValues));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SensorframeworkPackage.STATISTICS__RAW_YVALUES:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case SensorframeworkPackage.STATISTICS__RAW_YVALUES:
				return eInternalContainer().eInverseRemove(this, SensorframeworkPackage.RAW_YVALUES__STATISTICS, RawYValues.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SensorframeworkPackage.STATISTICS__MAXIMUM:
				return getMaximum();
			case SensorframeworkPackage.STATISTICS__SUM:
				return getSum();
			case SensorframeworkPackage.STATISTICS__COUNT:

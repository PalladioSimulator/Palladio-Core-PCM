 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.impl.JSXmlMeasurementsImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JSXmlMeasurementsImpl extends RawYValuesImpl implements JSXmlMeasurements {
	...
	public void setValues(Measure newValues) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensorframeworkPackage.JS_XML_MEASUREMENTS__VALUES, oldValues, values));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SensorframeworkPackage.JS_XML_MEASUREMENTS__VALUES:
				return getValues();
		}

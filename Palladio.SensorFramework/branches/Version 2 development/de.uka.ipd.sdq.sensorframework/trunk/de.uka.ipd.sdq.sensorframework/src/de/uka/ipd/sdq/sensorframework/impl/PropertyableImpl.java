 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.impl.PropertyableImpl#getAdditionalInformation <em>Additional Information</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PropertyableImpl extends EObjectImpl implements Propertyable {
	...
	protected EClass eStaticClass() {
		return SensorframeworkPackage.Literals.PROPERTYABLE;
	}
	...
	public EMap<String, Object> getAdditionalInformation() {
		if (additionalInformation == null) {
			additionalInformation = new EcoreEMap<String,Object>(SensorframeworkPackage.Literals.ESTRINGTO_EOBJECT_MAP_ENTRY, EStringtoEObjectMapEntryImpl.class, this, SensorframeworkPackage.PROPERTYABLE__ADDITIONAL_INFORMATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SensorframeworkPackage.PROPERTYABLE__ADDITIONAL_INFORMATION:

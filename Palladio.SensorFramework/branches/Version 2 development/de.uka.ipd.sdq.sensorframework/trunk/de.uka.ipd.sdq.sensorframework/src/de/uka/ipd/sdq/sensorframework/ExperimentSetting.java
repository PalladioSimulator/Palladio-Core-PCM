 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.ExperimentSetting#getExperimentName <em>Experiment Name</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.ExperimentSetting#getExperimentRuns <em>Experiment Runs</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.ExperimentSetting#getSensors <em>Sensors</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.sensorframework.sensorframeworkPackage#getExperimentSetting()
 * @model
 * @generated
 */
public interface ExperimentSetting extends Propertyable {
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.sensorframeworkPackage#getExperimentSetting_ExperimentName()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.sensorframework.ExperimentSetting#getExperimentName <em>Experiment Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.uka.ipd.sdq.sensorframework.ExperimentRun}.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.sensorframework.ExperimentRun#getExperimentSetting <em>Experiment Setting</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.sensorframeworkPackage#getExperimentSetting_ExperimentRuns()
	 ...
	 * The list contents are of type {@link de.uka.ipd.sdq.sensorframework.SensorDeclaration}.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.sensorframework.SensorDeclaration#getOwningExperiment <em>Owning Experiment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.sensorframeworkPackage#getExperimentSetting_Sensors()
	 * @see de.uka.ipd.sdq.sensorframework.SensorDeclaration#getOwningExperiment
	 * @model opposite="owningExperiment" containment="true" ordered="false"
	 * @generated
	 */

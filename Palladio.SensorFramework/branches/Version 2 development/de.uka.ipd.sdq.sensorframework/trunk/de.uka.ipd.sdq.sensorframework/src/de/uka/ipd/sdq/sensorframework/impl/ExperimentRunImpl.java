 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.impl.ExperimentRunImpl#getAdditionalInformation <em>Additional Information</em>}</li>
...
public class ExperimentRunImpl extends IdentifiableImpl implements ExperimentRun {
	...
	public EMap<String, Object> getAdditionalInformation() {
		if (additionalInformation == null) {
			additionalInformation = new EcoreEMap<String,Object>(SensorframeworkPackage.Literals.ESTRINGTO_EOBJECT_MAP_ENTRY, EStringtoEObjectMapEntryImpl.class, this, SensorframeworkPackage.EXPERIMENT_RUN__ADDITIONAL_INFORMATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SensorframeworkPackage.EXPERIMENT_RUN__ADDITIONAL_INFORMATION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Propertyable.class) {
			switch (derivedFeatureID) {
				case SensorframeworkPackage.EXPERIMENT_RUN__ADDITIONAL_INFORMATION: return SensorframeworkPackage.PROPERTYABLE__ADDITIONAL_INFORMATION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Propertyable.class) {
			switch (baseFeatureID) {
				case SensorframeworkPackage.PROPERTYABLE__ADDITIONAL_INFORMATION: return SensorframeworkPackage.EXPERIMENT_RUN__ADDITIONAL_INFORMATION;
				default: return -1;
			}
		}

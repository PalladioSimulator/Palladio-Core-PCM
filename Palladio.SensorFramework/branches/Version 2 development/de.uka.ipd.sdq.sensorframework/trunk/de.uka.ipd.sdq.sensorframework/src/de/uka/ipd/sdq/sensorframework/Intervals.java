 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.Intervals#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.Intervals#getWidth <em>Width</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.Intervals#getNumberOfIntervals <em>Number Of Intervals</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.Intervals#getAggregatedMeasurements <em>Aggregated Measurements</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Intervals extends RawXValues {
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.SensorframeworkPackage#getIntervals_LowerBound()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.sensorframework.Intervals#getLowerBound <em>Lower Bound</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.SensorframeworkPackage#getIntervals_Width()
	 * @model dataType="de.uka.ipd.sdq.sensorframework.EJSMeasure" required="true" ordered="false"
	 * @generated
	 */
	Measure getWidth();
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.sensorframework.Intervals#getWidth <em>Width</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.sensorframework.FixedWidthAggregation#getRawXValues <em>Raw XValues</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.SensorframeworkPackage#getIntervals_AggregatedMeasurements()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.sensorframework.Intervals#getAggregatedMeasurements <em>Aggregated Measurements</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

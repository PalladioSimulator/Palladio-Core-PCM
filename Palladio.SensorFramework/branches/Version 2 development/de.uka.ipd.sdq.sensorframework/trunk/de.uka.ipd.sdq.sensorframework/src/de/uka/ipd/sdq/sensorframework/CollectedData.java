 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.CollectedData#getSensorDeclaration <em>Sensor Declaration</em>}</li>
...
public interface CollectedData extends Propertyable {
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.SensorframeworkPackage#getCollectedData_SensorDeclaration()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.sensorframework.CollectedData#getSensorDeclaration <em>Sensor Declaration</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensorframework.JSXmlMeasurements#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
...
public interface JSXmlMeasurements extends RawYValues {
	 ...
	 * @see de.uka.ipd.sdq.sensorframework.SensorframeworkPackage#getJSXmlMeasurements_Values()
	 * @model dataType="de.uka.ipd.sdq.sensorframework.EJSMeasure" required="true"
	 * @generated
	 */
	Measure getValues();

	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.sensorframework.JSXmlMeasurements#getValues <em>Values</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

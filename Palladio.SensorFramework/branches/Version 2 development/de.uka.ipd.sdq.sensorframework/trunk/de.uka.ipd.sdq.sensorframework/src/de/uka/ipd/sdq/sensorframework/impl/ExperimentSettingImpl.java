...
public class ExperimentSettingImpl extends PropertyableImpl implements ExperimentSetting {
	...
	public EList<SensorDeclaration> getSensors() {
		if (sensors == null) {
			sensors = new EObjectContainmentWithInverseEList<SensorDeclaration>(SensorDeclaration.class, this, sensorframeworkPackage.EXPERIMENT_SETTING__SENSORS, sensorframeworkPackage.SENSOR_DECLARATION__OWNING_EXPERIMENT);
		}
		return sensors;
	}

package de.uka.ipd.sdq.sensorframework.storage.file.impl;
 ...
 */
public class ChunkedFile<T> {
	/** Logger for this class. */
	private static Logger logger = Logger.getLogger(ChunkedFile.class.getName());

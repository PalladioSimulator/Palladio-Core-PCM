...
public class sensorframeworkAdapterFactory extends AdapterFactoryImpl {
	...
	protected sensorframeworkSwitch<Adapter> modelSwitch =
		new sensorframeworkSwitch<Adapter>() {
			...
			@Override
			public Adapter caseLongMeasurements(LongMeasurements object) {
				return createLongMeasurementsAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseDoubleMeasurements(DoubleMeasurements object) {
				return createDoubleMeasurementsAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseJSXmlEventTimes(JSXmlEventTimes object) {
				return createJSXmlEventTimesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.sensorframework.LongMeasurements <em>Long Measurements</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLongMeasurementsAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.sensorframework.DoubleMeasurements <em>Double Measurements</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDoubleMeasurementsAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.sensorframework.JSXmlEventTimes <em>JS Xml Event Times</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createJSXmlEventTimesAdapter() {
		return null;
	}

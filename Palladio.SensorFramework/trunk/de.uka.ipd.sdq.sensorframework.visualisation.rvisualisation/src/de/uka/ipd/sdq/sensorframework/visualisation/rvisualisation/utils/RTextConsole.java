...
/**Text console adapter for R engines.
 * This text console adapter is used to log inputs, outputs and the history
 * for a corresponding R engine. 
 * @author groenda
 */
public class RTextConsole implements RMainLoopCallbacks {
	...
	/** {@inheritDoc}
	 */
	public void rWriteConsole(final Rengine arg0, final String message, 
			final int arg2) {
		lastMessage = message;

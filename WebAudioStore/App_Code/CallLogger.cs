...
namespace WebAudioStore
{
	...
	public class CallLogger
	{
		...
		public static void SaveLoggedInformationXML(string fileName)
		{
			...
			XmlDocumentType type = document.CreateDocumentType("WebserverMeasure",null,OggEncoder.WORKINGDIR+"WebAudioStoreMeasure.dtd",null);
			...
			document.Save(OggEncoder.WORKINGDIR+fileName);
			ResetLogger();
		}

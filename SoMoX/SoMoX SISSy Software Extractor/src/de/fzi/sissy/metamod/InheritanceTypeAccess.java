...
public class InheritanceTypeAccess extends TypeAccess {
	 ...
	 * @param target
	 */
	public InheritanceTypeAccess(Class target) {
		super(target);
		pImplementationInheritance = false;
	}
	...
	public void acceptVisitor(ModelVisitor visitor) {
		visitor.visitInheritanceTypeAccess(this);
	}
	...
	public void toggleImplementationInheritance() {
		pImplementationInheritance =! pImplementationInheritance; 
	}

...
public class MethodHasMaxNumberOfStatementsConstraint extends MethodConstraint implements IntegerConstraint{

    public MethodHasMaxNumberOfStatementsConstraint(String check_object_identifier, int number) {

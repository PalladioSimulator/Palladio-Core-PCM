...
public class MethodFormalParametersAreMatching extends MethodConstraint implements IdentifierConstraint {
    

    public MethodFormalParametersAreMatching(String check_object_identifier, String method_identifier) {
    ...
    public boolean evaluateByIdentifier(Object check_object, Object evaluation_object) {
        if ((check_object instanceof de.fzi.sissy.metamod.Method)&&(evaluation_object instanceof de.fzi.sissy.metamod.Method))
            return MetamodRetrievalEngineImplementation.getSingleton().methodFormalParametersAreMatching((de.fzi.sissy.metamod.Method)check_object, (de.fzi.sissy.metamod.Method)evaluation_object);
        else
            return false;

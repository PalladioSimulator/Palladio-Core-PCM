...
public class DMSTab extends MetricTab {
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		try {
			String wildcardString = configuration.getAttribute("org.somox.metrics.dms.wildcards","");
			
			//Restore selection-state of the radio buttons
			boolean tempIndicator = configuration.getAttribute("org.somox.metrics.dms.blacklistIndicator",true);
			if (!tempIndicator) {

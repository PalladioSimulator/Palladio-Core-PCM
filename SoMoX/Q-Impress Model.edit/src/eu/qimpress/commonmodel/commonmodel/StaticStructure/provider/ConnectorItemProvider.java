...
/**
 * This is the item provider adapter for a {@link eu.qimpress.commonmodel.commonmodel.StaticStructure.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsDelegationPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Is Delegation feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsDelegationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_isDelegation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_isDelegation_feature", "_UI_Connector_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StaticStructurePackage.Literals.CONNECTOR__ENDPOINTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.CONNECTOR__ENDPOINTS,
				 StaticStructureFactory.eINSTANCE.createSubcomponentEndpoint()));

		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.CONNECTOR__ENDPOINTS,
				 StaticStructureFactory.eINSTANCE.createComponentEndpoint()));
	}

...
/**
 * This is the item provider adapter for a {@link eu.qimpress.commonmodel.commonmodel.StaticStructure.Exception} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExceptionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Exception_ExceptionMessage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Exception_ExceptionMessage_feature", "_UI_Exception_type"),
				 StaticStructurePackage.Literals.EXCEPTION__EXCEPTION_MESSAGE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((eu.qimpress.commonmodel.commonmodel.StaticStructure.Exception)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(eu.qimpress.commonmodel.commonmodel.StaticStructure.Exception.class)) {

...
/**
 * This is the item provider adapter for a {@link eu.qimpress.commonmodel.commonmodel.StaticStructure.ComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentType_behaviour_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentType_behaviour_feature", "_UI_ComponentType_type"),
				 StaticStructurePackage.Literals.COMPONENT_TYPE__BEHAVIOUR,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StaticStructurePackage.Literals.COMPONENT_TYPE__REQUIRED);
			childrenFeatures.add(StaticStructurePackage.Literals.COMPONENT_TYPE__PROVIDED);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.COMPONENT_TYPE__REQUIRED,
				 StaticStructureFactory.eINSTANCE.createEventPort()));

		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.COMPONENT_TYPE__REQUIRED,
				 StaticStructureFactory.eINSTANCE.createInterfacePort()));

		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.COMPONENT_TYPE__PROVIDED,
				 StaticStructureFactory.eINSTANCE.createEventPort()));

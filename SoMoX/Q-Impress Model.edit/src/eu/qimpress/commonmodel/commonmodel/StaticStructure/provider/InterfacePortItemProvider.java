...
/**
 * This is the item provider adapter for a {@link eu.qimpress.commonmodel.commonmodel.StaticStructure.InterfacePort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfacePortItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InterfacePort_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InterfacePort_type_feature", "_UI_InterfacePort_type"),
				 StaticStructurePackage.Literals.INTERFACE_PORT__TYPE,
				 true,
				 false,
				 true,
				 null,

...
/**
 * This is the item provider adapter for a {@link eu.qimpress.commonmodel.commonmodel.StaticStructure.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_inheritance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_inheritance_feature", "_UI_Interface_type"),
				 StaticStructurePackage.Literals.INTERFACE__INHERITANCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StaticStructurePackage.Literals.INTERFACE__SIGNATURES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Interface.class)) {
			case StaticStructurePackage.INTERFACE__SIGNATURES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.INTERFACE__SIGNATURES,
				 StaticStructureFactory.eINSTANCE.createOperation()));
	}

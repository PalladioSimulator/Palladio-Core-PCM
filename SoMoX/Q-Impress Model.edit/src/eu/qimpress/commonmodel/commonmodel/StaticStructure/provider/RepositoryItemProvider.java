...
/**
 * This is the item provider adapter for a {@link eu.qimpress.commonmodel.commonmodel.StaticStructure.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StaticStructurePackage.Literals.REPOSITORY__ENTITIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.REPOSITORY__ENTITIES,
				 StaticStructureFactory.eINSTANCE.createType()));

		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.REPOSITORY__ENTITIES,
				 StaticStructureFactory.eINSTANCE.createServiceArchitectureModel()));
		...
		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.REPOSITORY__ENTITIES,
				 StaticStructureFactory.eINSTANCE.createPrimitiveDataType()));

		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.REPOSITORY__ENTITIES,
				 StaticStructureFactory.eINSTANCE.createComplexDataType()));

		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.REPOSITORY__ENTITIES,
				 StaticStructureFactory.eINSTANCE.createCompositeComponent()));

		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.REPOSITORY__ENTITIES,
				 StaticStructureFactory.eINSTANCE.createPrimitiveComponent()));

		newChildDescriptors.add
			(createChildParameter
				(StaticStructurePackage.Literals.REPOSITORY__ENTITIES,
				 StaticStructureFactory.eINSTANCE.createCollectionDataType()));

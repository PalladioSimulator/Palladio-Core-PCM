...
/**
 * This is the item provider adapter for a {@link eu.qimpress.commonmodel.commonmodel.StaticStructure.EventPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventPortItemProvider
	 ...
	 * @generated
	 */
	public EventPortItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventPort_isSource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventPort_isSource_feature", "_UI_EventPort_type"),
	...
	protected void addMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventPort_message_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventPort_message_feature", "_UI_EventPort_type"),
				 StaticStructurePackage.Literals.EVENT_PORT__MESSAGE,
				 true,
				 false,
				 true,
				 null,

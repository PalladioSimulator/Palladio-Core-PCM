 ...
 * <ul>
 *   <li>{@link eu.qimpress.commonmodel.commonmodel.StaticStructure.impl.EntityImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EntityImpl extends EObjectImpl implements Entity {
	...
	protected EClass eStaticClass() {
		return StaticStructurePackage.Literals.ENTITY;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticStructurePackage.ENTITY__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StaticStructurePackage.ENTITY__ID:
				return getId();
		}

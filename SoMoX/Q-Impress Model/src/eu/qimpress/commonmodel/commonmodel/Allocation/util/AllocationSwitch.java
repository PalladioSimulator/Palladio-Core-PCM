	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AllocationPackage.SERVICE: {
				...
				if (result == null) result = caseCompositeStructure(service);
				if (result == null) result = caseComponentType(service);
				if (result == null) result = caseNamedEntity(service);
				if (result == null) result = caseFirstClassEntity(service);

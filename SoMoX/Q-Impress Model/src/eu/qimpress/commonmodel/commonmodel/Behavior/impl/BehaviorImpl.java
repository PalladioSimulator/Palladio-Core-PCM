 ...
 * <ul>
 *   <li>{@link eu.qimpress.commonmodel.commonmodel.Behavior.impl.BehaviorImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BehaviorImpl extends EObjectImpl implements Behavior {
		...
		if (operation != null && operation.eIsProxy()) {
			...
			if (operation != oldOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BehaviorPackage.BEHAVIOR__OPERATION, oldOperation, operation));
			}
		}
		return operation;
	}
	...
	public void setOperation(Operation newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.BEHAVIOR__OPERATION, oldOperation, operation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviorPackage.BEHAVIOR__OPERATION:

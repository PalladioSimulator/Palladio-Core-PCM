...
public class AbbTest {
	...
	private static final String modelPath = "abb.gast";
	...
	public void someTest () throws Exception {	
		...
		if (elements != null) {
			...
			for (List<GASTClass> currentClassList : elements) {
				for (List<GASTClass> currentClassList2 : elements) {
					i++;
					elements1 = new LinkedList<ModelElement>();
					elements2 = new LinkedList<ModelElement>();
					
					elements1.addAll(currentClassList);
					elements2.addAll(currentClassList2);
					
					double abstractness = abstractnessTest();
					double coupling = couplingTest();
					double dms = dmsTest();
					double instability = instabilityTest();
					double interfaceViolation = ifaceViolationTest();
					double packageMapping = packageMappingTest();
					double slaq = SLAQTest();
					double subsysComp = SubsystemComponentTest();
					double nameRes = nameResemblanceTest();
					...
					System.out.println("InterfaceViolation: " + interfaceViolation);
					System.out.println("PackageMapping: " + packageMapping);
					System.out.println("SLAQ: " + slaq);
					System.out.println("SubsystemComponent: " + subsysComp);
					System.out.println("NameResemblance: " + nameRes);
				}
			}
			System.out.println("Number of classes: " + elements.size());
	...
	public double couplingTest () {
		...
		cou.setBlacklist(new HashSet<String>());
	...
	public double instabilityTest () {
		...
		ins.setBlacklist(new HashSet<String>());
	...
	public double SubsystemComponentTest () {
		...
		sC.setBlacklist(new HashSet<String>());

 ...
 *
 * <p>
 * Software extractor instances provide the functionality to execute
 * the extraction process as well as access to the Software Artifact repository
 * </p>
 *
...
public interface SoftwareExtractor extends ConfigurableComponent {
	...
	/**
	 * Get a list of all extracted software artifacts.
	 * The persistence is handled within the extractor component but is
	 * this method provides the required access
	 *

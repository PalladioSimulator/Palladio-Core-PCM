...
public interface ISimulationControl {
     ...
     *            conditions, storage location, etc.
     * @param statusObserver
     *            An observer which gets notifications on the simulation progress
     * @param useOwnSensorstorage
     ...
     * 
     */
    public void prepareSimulation(AbstractSimulationConfig config, IStatusObserver statusObserver,
     ...
     */
    public SimulationResult startSimulation(AbstractSimulationConfig config, IStatusObserver statusObserver,
            boolean useOwnSensorstorage);

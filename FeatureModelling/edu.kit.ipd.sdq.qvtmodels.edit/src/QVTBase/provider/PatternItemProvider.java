...
/**
 * This is the item provider adapter for a {@link QVTBase.Pattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PatternItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pattern_bindsTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pattern_bindsTo_feature", "_UI_Pattern_type"),
				 QVTBasePackage.Literals.PATTERN__BINDS_TO,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QVTBasePackage.Literals.PATTERN__PREDICATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QVTBasePackage.Literals.PATTERN__PREDICATE,
				 QVTBaseFactory.eINSTANCE.createPredicate()));
	}

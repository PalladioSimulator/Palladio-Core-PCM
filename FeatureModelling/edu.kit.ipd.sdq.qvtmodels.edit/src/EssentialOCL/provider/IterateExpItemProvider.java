...
/**
 * This is the item provider adapter for a {@link EssentialOCL.IterateExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IterateExpItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EssentialOCLPackage.Literals.ITERATE_EXP__RESULT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IterateExp"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_IterateExp_type") :
			getString("_UI_IterateExp_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EssentialOCLPackage.Literals.ITERATE_EXP__RESULT,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == EssentialOCLPackage.Literals.LOOP_EXP__ITERATOR ||
			childFeature == EssentialOCLPackage.Literals.ITERATE_EXP__RESULT;

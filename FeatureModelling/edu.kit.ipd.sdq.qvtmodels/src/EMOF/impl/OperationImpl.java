 ...
 * <ul>
 *   <li>{@link EMOF.impl.OperationImpl#getIsOrdered <em>Is Ordered</em>}</li>
 *   <li>{@link EMOF.impl.OperationImpl#getIsUnique <em>Is Unique</em>}</li>
 *   <li>{@link EMOF.impl.OperationImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link EMOF.impl.OperationImpl#getUpper <em>Upper</em>}</li>
 *   <li>{@link EMOF.impl.OperationImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link EMOF.impl.OperationImpl#getOwnedParameter <em>Owned Parameter</em>}</li>
 *   <li>{@link EMOF.impl.OperationImpl#getRaisedException <em>Raised Exception</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

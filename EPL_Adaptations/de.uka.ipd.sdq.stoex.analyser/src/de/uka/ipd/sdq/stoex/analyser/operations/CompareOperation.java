...
public abstract class CompareOperation {
	...
	public IProbabilityMassFunction compare(Object left, Object right) {
		...
		if (left instanceof String) {
			if (((String) left).toUpperCase().equals(TRUE_STRING)) {
				left = new Boolean(true);
			} else if (((String) left).toUpperCase().equals(FALSE_STRING)) {
				left = new Boolean(false);
			}
		}
		if (right instanceof String) {
			if (((String) right).toUpperCase().equals(TRUE_STRING)) {
				right = new Boolean(true);
			} else if (((String) right).toUpperCase().equals(FALSE_STRING)) {

...
public class LessEqualOperation extends CompareOperation {
	...
	protected IProbabilityMassFunction getComparePMF(double left, IProbabilityMassFunction right) {
		return new GreaterEqualOperation().compare(right, left);
	}

	protected IProbabilityMassFunction getComparePMF(IProbabilityMassFunction left, double right) {
		return getBoolPMF(getThresholdProbability(left, right, true));
	}

	protected IProbabilityMassFunction getComparePMF(IProbabilityMassFunction left,

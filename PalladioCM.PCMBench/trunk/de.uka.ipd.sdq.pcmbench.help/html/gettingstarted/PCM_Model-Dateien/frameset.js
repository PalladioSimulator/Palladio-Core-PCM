...
var xmlData = XMLData("PCM_Model-Dateien/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='Diese Tabelle enthält Shape-Details'>";
		strStartTable += "<THEAD class='propViewerTHEAD'><TH>Beschriftung</TH><TH>Wert</TH></THEAD>";
	...
	if (shapeNode != null)
	{
		...
		{
			strCPHTML = "Keine Details verfügbar.";
		}
	}

...
public class ParametersItemProvider extends ItemProviderDecorator implements
	...
	public Object getColumnImage(Object object, int columnIndex) {
		if (columnIndex == ParametersDialogViewer.ICON_COLUMN_INDEX)
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		switch (columnIndex) {
		case ParametersDialogViewer.ICON_COLUMN_INDEX:
			break;
		case ParametersDialogViewer.CONTEXT_COLUMN_INDEX:
			result = ((Signature) parameter.eContainer()).getServiceName();
			break;
		case ParametersDialogViewer.NAME_COLUMN_INDEX:
			if (parameter.getParameterName() != null)
				result = parameter.getParameterName();
			else
				result = "null";
			break;
		case ParametersDialogViewer.TYPE_COLUMN_INDEX:

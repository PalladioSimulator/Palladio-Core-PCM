...
/**
 * The Class VariableUsage3EditPart.
 *
 * @generated
 */
public class VariableUsage3EditPart extends ShapeNodeEditPart {
    ...
    /**
     * Instantiates a new variable usage3 edit part.
     *
     * @param view the view
     * @generated
     */
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof VariableUsage3LabelEditPart) {
            ((VariableUsage3LabelEditPart) childEditPart).setLabel(getPrimaryShape()
    ...
    public EditPart getTargetEditPart(Request request) {
        if (request instanceof CreateViewAndElementRequest) {
            ...
            if (type == PalladioComponentModelElementTypes.VariableCharacterisation_3055) {
                return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry

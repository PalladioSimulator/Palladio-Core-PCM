...
/**
 * The Class AcquireActionEntityName2EditPart.
 *
 * @generated
 */
public class AcquireActionEntityName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new acquire action entity name2 edit part.
     *
     * @param view the view
     * @generated
     */
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider
                    .getParser(
                            PalladioComponentModelElementTypes.AcquireAction_3026,
                            getParserElement(),
                            PalladioComponentModelVisualIDRegistry
                                    .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.AcquireActionEntityName2EditPart.VISUAL_ID));
        }
        return parser;
    }

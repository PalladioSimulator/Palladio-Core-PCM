...
/**
 * The Class InternalAction2EditPart.
 *
 * @generated
 */
public class InternalAction2EditPart extends ShapeNodeEditPart {
    ...
    /**
     * Instantiates a new internal action2 edit part.
     *
     * @param view the view
     * @generated
     */
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InternalAction2ItemSemanticEditPolicy());
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof InternalActionEntityName2EditPart) {
            ((InternalActionEntityName2EditPart) childEditPart).setLabel(getPrimaryShape()
                    .getFigureInternalActionFigureNameLabel());
            return true;
        }
        if (childEditPart instanceof InternalActionResourceDemandEditPart) {
            IFigure pane = getPrimaryShape().getFigureInternalActionCompartment();
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.add(((InternalActionResourceDemandEditPart) childEditPart).getFigure());
            return true;
        }
        if (childEditPart instanceof InternalActionFailureOccurrenceDescriptionsEditPart) {
            IFigure pane = getPrimaryShape().getFigureInternalActionCompartment();
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.add(((InternalActionFailureOccurrenceDescriptionsEditPart) childEditPart).getFigure());
            return true;
        }
        if (childEditPart instanceof InternalActionInfrastructureCallsCompartmentEditPart) {
            IFigure pane = getPrimaryShape().getFigureInternalActionCompartment();
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.add(((InternalActionInfrastructureCallsCompartmentEditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    protected boolean removeFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof InternalActionResourceDemandEditPart) {
            ...
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.remove(((InternalActionResourceDemandEditPart) childEditPart).getFigure());
            return true;
        }
        if (childEditPart instanceof InternalActionFailureOccurrenceDescriptionsEditPart) {
            IFigure pane = getPrimaryShape().getFigureInternalActionCompartment();
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.remove(((InternalActionFailureOccurrenceDescriptionsEditPart) childEditPart).getFigure());
            return true;
        }
        if (childEditPart instanceof InternalActionInfrastructureCallsCompartmentEditPart) {
            IFigure pane = getPrimaryShape().getFigureInternalActionCompartment();
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.remove(((InternalActionInfrastructureCallsCompartmentEditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
        ...
        if (editPart instanceof InternalActionFailureOccurrenceDescriptionsEditPart) {
            return getPrimaryShape().getFigureInternalActionCompartment();
        }
        if (editPart instanceof InternalActionInfrastructureCallsCompartmentEditPart) {
            return getPrimaryShape().getFigureInternalActionCompartment();
        }
    ...
    public List/* <org.eclipse.gmf.runtime.emf.type.core.IElementType> */getMARelTypesOnSourceAndTarget(
        ...
        if (targetEditPart instanceof de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.InternalAction2EditPart) {
            types.add(PalladioComponentModelElementTypes.AbstractActionSuccessor_AbstractAction_4001);
        }
    ...
    public class InternalActionFigure extends RoundedRectangle {
        ...
        private void createContents() {
            ...
            internalActionStereotypeLabelFigure0.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode()
            ...
            fFigureInternalActionFigureNameLabel.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode()
                    .DPtoLP(0), getMapMode().DPtoLP(2), getMapMode().DPtoLP(0)));
            ...
            fFigureInternalActionCompartment.setMinimumSize(new Dimension(getMapMode().DPtoLP(0), getMapMode()
                    .DPtoLP(0)));
            ...
            this.add(fFigureInternalActionCompartment, constraintFFigureInternalActionCompartment);

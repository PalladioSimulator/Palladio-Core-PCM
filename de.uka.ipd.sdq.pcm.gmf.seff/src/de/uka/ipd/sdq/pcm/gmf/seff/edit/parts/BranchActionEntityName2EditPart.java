...
/**
 * The Class BranchActionEntityName2EditPart.
 *
 * @generated
 */
public class BranchActionEntityName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new branch action entity name2 edit part.
     *
     * @param view the view
     * @generated
     */
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(
                    PalladioComponentModelElementTypes.BranchAction_3009, getParserElement(),
                    PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.BranchActionEntityName2EditPart.VISUAL_ID));
        }
        return parser;
    }

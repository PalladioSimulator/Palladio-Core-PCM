 ...
 * @generated
 */
public class ResourceDemandingBehaviourBehaviourCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceDemandingBehaviourBehaviourCompartment_7018SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceDemandingBehaviourBehaviourCompartment_7018SemanticChildren((View) getHost().getModel());

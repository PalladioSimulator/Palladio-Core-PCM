...
/**
 * The Class VariableUsage4LabelEditPart.
 *
 * @generated
 */
public class VariableUsage4LabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new variable usage4 label edit part.
     *
     * @param view the view
     * @generated
     */
    public VariableUsage4LabelEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(
                    PalladioComponentModelElementTypes.VariableUsage_3047, getParserElement(),
                    PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.VariableUsage4LabelEditPart.VISUAL_ID));
        }
        return parser;
    }

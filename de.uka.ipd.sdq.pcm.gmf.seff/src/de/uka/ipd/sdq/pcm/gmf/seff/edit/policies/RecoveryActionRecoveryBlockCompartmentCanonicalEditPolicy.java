...
public class RecoveryActionRecoveryBlockCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getRecoveryActionRecoveryBlockCompartment_7058SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getRecoveryActionRecoveryBlockCompartment_7058SemanticChildren((View) getHost().getModel());

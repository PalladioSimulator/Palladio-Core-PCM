...
/**
 * The Class CollectionIteratorAction2EditPart.
 *
 * @generated
 */
public class CollectionIteratorAction2EditPart extends ShapeNodeEditPart {
    ...
    /**
     * Instantiates a new collection iterator action2 edit part.
     *
     * @param view the view
     * @generated
     */
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof CollectionIteratorActionEntityName2EditPart) {
            ((CollectionIteratorActionEntityName2EditPart) childEditPart).setLabel(getPrimaryShape()
                    .getFigureCollectionIteratorNameLabelFigure());
            return true;
        }
        if (childEditPart instanceof CollectionIteratorParameterLabelEditPart) {
            ((CollectionIteratorParameterLabelEditPart) childEditPart).setLabel(getPrimaryShape()

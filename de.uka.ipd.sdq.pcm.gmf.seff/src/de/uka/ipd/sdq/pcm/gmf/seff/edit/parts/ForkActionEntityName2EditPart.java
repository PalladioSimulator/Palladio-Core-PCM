...
/**
 * The Class ForkActionEntityName2EditPart.
 *
 * @generated
 */
public class ForkActionEntityName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new fork action entity name2 edit part.
     *
     * @param view the view
     * @generated
     */
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ForkAction_3023,
                    getParserElement(), PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ForkActionEntityName2EditPart.VISUAL_ID));
        }
        return parser;
    }

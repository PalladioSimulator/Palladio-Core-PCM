...
/**
 * The Class VariableUsageLabelEditPart.
 *
 * @generated
 */
public class VariableUsageLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new variable usage label edit part.
     *
     * @param view the view
     * @generated
     */
    public VariableUsageLabelEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(
                    PalladioComponentModelElementTypes.VariableUsage_3042, getParserElement(),
                    PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.VariableUsageLabelEditPart.VISUAL_ID));
        }
        return parser;
    }

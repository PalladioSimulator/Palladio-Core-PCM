...
/**
 * The Class EmitEventActionEntityNameEditPart.
 *
 * @generated
 */
public class EmitEventActionEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new emit event action entity name edit part.
     *
     * @param view the view
     * @generated
     */
    public EmitEventActionEntityNameEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider
                    .getParser(
                            PalladioComponentModelElementTypes.EmitEventAction_2013,
                            getParserElement(),
                            PalladioComponentModelVisualIDRegistry
                                    .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.EmitEventActionEntityNameEditPart.VISUAL_ID));
        }
        return parser;
    }

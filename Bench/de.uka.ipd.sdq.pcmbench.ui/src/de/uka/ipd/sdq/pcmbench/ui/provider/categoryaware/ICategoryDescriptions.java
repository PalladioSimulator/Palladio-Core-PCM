...
/**
 * @author Snowball Interface to characterise a set of category descriptions which is used to
 *         configure the generic category item provider / category aware item provider instances.
 */
public interface ICategoryDescriptions {
     ...
     * 
     * @param object
     *            The object to test for categories
     ...
     * 
     * @param object
     *            The object for which the categories should be retrieved
     * @return The set of category descriptors characterizing the categories into which the children
     *         of the object are divided
     */

...
public class InternalActionSensitivity extends MarkovSensitivity {
	...
	protected boolean alterModel() {
		...
		FailureOccurrenceDescription description = getFailureOccurrenceDescription();
		if (description == null) {
			return false;
		}
	 ...
	 */
	FailureOccurrenceDescription getFailureOccurrenceDescription() {
	 ...
	 */
	void setFailureProbability(final FailureOccurrenceDescription description) {

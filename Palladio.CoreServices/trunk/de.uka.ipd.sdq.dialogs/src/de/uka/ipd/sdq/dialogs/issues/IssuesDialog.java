package de.uka.ipd.sdq.dialogs.issues;
			...
			public Image getColumnImage(Object element, int columnIndex) {
				...
				case 0:
					if (sai.getError() == SeverityAndIssue.ERROR)
						return DialogsImages.imageRegistry.get(DialogsImages.ERROR);
					else
						return DialogsImages.imageRegistry.get(DialogsImages.WARNING);
				default:
					return null;
				}
			}

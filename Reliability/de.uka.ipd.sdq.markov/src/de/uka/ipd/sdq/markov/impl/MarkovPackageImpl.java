...
public class MarkovPackageImpl extends EPackageImpl implements MarkovPackage {
	...
	public static MarkovPackage init() {
		...
		MarkovPackageImpl theMarkovPackage = (MarkovPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MarkovPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MarkovPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getState_Labels(), this.getLabel(), null, "labels", null, 0, -1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getState_Labels().getEKeys().add(this.getLabel_Key());
		initEAttribute(getState_Traces(), ecorePackage.getEString(), "traces", "", 0, -1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

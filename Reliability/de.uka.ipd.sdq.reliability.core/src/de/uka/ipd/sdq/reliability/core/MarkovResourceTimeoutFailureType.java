...
/**
 * Represents a failure type for a failure-on-demand occurrence due to a timeout
 * while requesting a passive resource.
 * 
 * @author brosch
 * 
 */
public class MarkovResourceTimeoutFailureType extends MarkovFailureType {
	 ...
	 *            the assemblyContext in which the passive resource is
	 *            instantiated
	 * @param component
	...
	public static MarkovResourceTimeoutFailureType createResourceTimeoutFailureType(
		...
		return new MarkovResourceTimeoutFailureType(evaluationType,
				assemblyContext.getId(), assemblyContext.getEntityName(),
				component.getId(), component.getEntityName(), passiveResource
						.getId(), passiveResource.getEntityName());
	}
	...
	/**
	 * The ID of the component instance containing the passive resource, as
	 * specified through an AssemblyContext in a PCM System model.
	 */
	private String assemblyContextId = "";

	/**
	 * The name of the component instance containing the passive resource, as
	 * specified through an AssemblyContext in a PCM System model.
	 */
	...
	/**
	 * The resource ID, as specified for a PassiveResource in a PCM Repository
	 * model.
	 */
	private String passiveResourceId = "";

	/**
	 * The resource name, as specified for a PassiveResource in a PCM Repository
	 * model.
	 */
	 ...
	 *            PCM Repository model
	 */
	private MarkovResourceTimeoutFailureType(
			final MarkovEvaluationType evaluationType,
			final String assemblyContextId, final String assemblyContextName,
			final String componentId, final String componentName,
			final String passiveResourceId, final String passiveResourceName) {
		...
		case TYPES:
			...
			this.name = passiveResourceName
					+ " (passive resource timeout failure)";
			break;
		case CLASSES:
			this.id = RESOURCE_ID;

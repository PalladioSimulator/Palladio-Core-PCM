...
/**
 * Represents a type identification for failure-on-demand occurrences during the
 * reliability analysis / simulation.
 * 
 * @author brosch
 * 
 */
public abstract class MarkovFailureType implements
	 ...
	 * 
	 * The ID is unique across all failure types within an analysis or
	 * simulation run.
	 */
	...
	/**
	 * Indicates if this failure type is system-external, i.e. originated
	 * outside the system.
	 * 
	...
	public boolean equals(Object obj) {
		...
		if (evaluationType == MarkovEvaluationType.SINGLE) {
			return (obj instanceof MarkovFailureType)
					&& (this.getId().equals(((MarkovFailureType) obj).getId()));
		} else {
	...
	/**
	 * Retrieves the id of the (system-required) interface which exhibits the
	 * failure.
	 * 
	...
	/**
	 * Retrieves the name of the (system-required) interface which exhibits the
	 * failure.
	 * 
	 ...
	 * 
	 * The name is used for describing the failure type in the simulation result
	 * data.
	 * 
	...
	/**
	 * Retrieves the id of the (system-required) role which exhibits the
	 * failure.
	 * 
	 * @return the role id
	 */
	...
	/**
	 * Retrieves the name of the (system-required) role which exhibits the
	 * failure.
	 * 
	...
	/**
	 * Retrieves the id of the (system-required) signature which exhibits the
	 * failure.
	 * 
	...
	/**
	 * Retrieves the name of the (system-required) signature which exhibits the
	 * failure.
	 * 

...
/**
 * Represents a failure type for a failure-on-demand occurrence due to an
...
public class MarkovHardwareInducedFailureType extends MarkovFailureType {
	...
	public static MarkovHardwareInducedFailureType createExternalFailureType(
			...
			final ProcessingResourceType resoureType,
			final Signature signature, final Role role, final Interface iface) {
		return new MarkovHardwareInducedFailureType(evaluationType, resoureType
				.getId(), resoureType.getEntityName(), signature.getId(),
	...
	public static MarkovHardwareInducedFailureType createExternalFailureType(
			final MarkovEvaluationType evaluationType,
			final String resourceTypeId, final String signatureId,
			final String systemRequiredRoleId) {
		return new MarkovHardwareInducedFailureType(evaluationType,
				resourceTypeId, "", signatureId, "", systemRequiredRoleId, "",
				"", "");
	}
	...
	public static MarkovHardwareInducedFailureType createInternalFailureType(
		...
		return new MarkovHardwareInducedFailureType(evaluationType,
				resourceContainer.getId(), resourceContainer.getEntityName(),
				resourceType.getId(), resourceType.getEntityName());
	}
	...
	/**
	 * The ID of the surrounding resource container, as specified for a
	...
	/**
	 * The ID of the resource type, as specified for a ProcessingResourceType in
	 * a PCM ResourceRepository.
	 */
	private String resourceTypeId = "";

	/**
	 * The name of the resource type, as specified for a ProcessingResourceType
	 * in a PCM ResourceRepository.
	 */
	 ...
	 *            ProcessingResourceType in a PCM ResourceRepository model
	 */
	private MarkovHardwareInducedFailureType(
			final MarkovEvaluationType evaluationType,
			final String resourceContainerId,
			final String resourceContainerName, final String resourceTypeId,
			final String resourceTypeName) {
		...
		case POINTSOFFAILURE:
			...
			this.name = resourceContainerName + "/" + resourceTypeName
					+ " (system-internal hardware-induced failure)";
			break;
		case TYPES:
	...
	/**
	 * The constructor for resource failures outside the system, as annotated to

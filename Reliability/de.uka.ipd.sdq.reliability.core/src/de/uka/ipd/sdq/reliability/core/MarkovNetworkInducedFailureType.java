...
/**
 * Represents a failure type for a failure-on-demand occurrence due to a
 * communication link transmission error.
 * 
 * @author brosch
 * 
 */
public class MarkovNetworkInducedFailureType extends MarkovFailureType {
	...
	public static MarkovNetworkInducedFailureType createExternalFailureType(
			...
			final CommunicationLinkResourceType commLinkResourceType,
			final Signature signature, final Role role, final Interface iface) {
		return new MarkovNetworkInducedFailureType(evaluationType,
				commLinkResourceType.getId(), commLinkResourceType
						.getEntityName(), signature.getId(), signature
	...
	public static MarkovNetworkInducedFailureType createExternalFailureType(
			final MarkovEvaluationType evaluationType,
			final String commLinkResourceTypeId, final String signatureId,
	...
	public static MarkovNetworkInducedFailureType createInternalFailureType(
			...
			final CommunicationLinkResourceType commLinkResourceType) {
		return new MarkovNetworkInducedFailureType(evaluationType,
				linkingResource.getId(), linkingResource.getEntityName(),
				commLinkResourceType.getId(), commLinkResourceType
						.getEntityName());
	}
	 ...
	 *            the ID of the surrounding linking resource, as specified for a
	...
	/**
	 * The ID of the resource type, as specified through a
	 * CommunicationLinkResourceType in a PCM ResourceRepository model.
	 */
	...
	/**
	 * The ID of the communication link, as specified through a LinkingResource
	 ...
	 *            CommunicationLinkResourceType in a PCM ResourceRepository
	 */
	private MarkovNetworkInducedFailureType(
			final MarkovEvaluationType evaluationType,
			final String linkingResourceId, final String linkingResourceName,
			final String commLinkResourceTypeId,
			final String commLinkResourceTypeName) {
	...
	/**
	 * The constructor for communication failures outside the system, as

...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.sensitivity.UsageBranchParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UsageBranchParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_UsageBranchParameter_branch__UsageBranchParameter_feature", "_UI_UsageBranchParameter_type"),
				 SensitivityPackage.Literals.USAGE_BRANCH_PARAMETER__BRANCH_USAGE_BRANCH_PARAMETER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_UsageBranchParameter_scenarioBehaviour__UsageBranchParameter_feature", "_UI_UsageBranchParameter_type"),
				 SensitivityPackage.Literals.USAGE_BRANCH_PARAMETER__SCENARIO_BEHAVIOUR_USAGE_BRANCH_PARAMETER,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns UsageBranchParameter.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		try {
			branchName = ((UsageBranchParameter)object).
				getBranch__UsageBranchParameter().getEntityName();
		} catch(Exception e) {}
		String behaviourName = "UNSPECIFIED";
		try {
			behaviourName = ((UsageBranchParameter)object).
				getScenarioBehaviour__UsageBranchParameter().getEntityName();
		} catch(Exception e) {}
		return ((UsageBranchParameter)object).getEntityName()
			+ " (" + branchName + "/" + behaviourName + ")"

...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.sensitivity.ComponentReliabilityParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentReliabilityParameterItemProvider
	...
	/**
	 * This adds a property descriptor for the Basic Component Component Reliability Parameter feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentReliabilityParameter_basicComponent__ComponentReliabilityParameter_feature", "_UI_ComponentReliabilityParameter_type"),
	...
	/**
	 * This returns ComponentReliabilityParameter.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		try {
			componentName = ((ComponentReliabilityParameter)object).
				getBasicComponent__ComponentReliabilityParameter().
				getEntityName();
		} catch(Exception e) {}
		return ((ComponentReliabilityParameter)object).getEntityName()
			+ " (" + componentName + ")"
			+ " [ID: " + ((ComponentReliabilityParameter)object).getId() + "]"

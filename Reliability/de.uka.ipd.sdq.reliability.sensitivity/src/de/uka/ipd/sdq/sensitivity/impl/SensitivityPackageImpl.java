...
public class SensitivityPackageImpl extends EPackageImpl implements SensitivityPackage {
    ...
    public static SensitivityPackage init() {
        ...
        SensitivityPackageImpl theSensitivityPackage = (SensitivityPackageImpl) (EPackage.Registry.INSTANCE
    ...
    public void createPackageContents() {
        ...
        createEReference(sensitivityConfigurationEClass,
        ...
        createEReference(sensitivityParameterEClass,
        ...
        createEReference(combinedSensitivityParameterEClass,
        ...
        createEReference(singleSensitivityParameterEClass,
        ...
        createEReference(sensitivityParameterVariationEClass,
        ...
        createEReference(componentReliabilityParameterEClass,
        ...
        createEReference(internalActionReliabilityParameterEClass,
        ...
        createEReference(probabilisticBranchParameterEClass,
        ...
        createEReference(resourceMTTFParameterEClass,
        ...
        createEReference(resourceMTTRParameterEClass,
        ...
        createEReference(
                communicationLinkReliabilityParameterEClass,
        ...
        createEReference(variableUsageParameterEClass,
                VARIABLE_USAGE_PARAMETER__ENTRY_LEVEL_SYSTEM_CALL_VARIABLE_USAGE_PARAMETER);
        createEAttribute(variableUsageParameterEClass,
        ...
        createEReference(softwareFailureTypesParameterEClass,
        ...
        createEReference(failureTypeResultSpecificationEClass,
        ...
        createEAttribute(failureDimensionResultSpecificationEClass,
    ...
    public void initializePackageContents() {
        ...
        initEClass(sensitivityConfigurationEClass, SensitivityConfiguration.class, "SensitivityConfiguration",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSensitivityConfiguration_SensitivityParameters__SensitivityConfiguration(),
        ...
        initEClass(sensitivityParameterEClass, SensitivityParameter.class, "SensitivityParameter", IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSensitivityParameter_ParentParameter__SensitivityParameter(),
        ...
        initEReference(getSensitivityParameter_SensitivityConfiguration__SensitivityParameter(),
                this.getSensitivityConfiguration(),
                this.getSensitivityConfiguration_SensitivityParameters__SensitivityConfiguration(),
                "sensitivityConfiguration__SensitivityParameter", null, 0, 1, SensitivityParameter.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(combinedSensitivityParameterEClass, CombinedSensitivityParameter.class,
                "CombinedSensitivityParameter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getCombinedSensitivityParameter_IsCombinatory(), ecorePackage.getEBoolean(), "isCombinatory",
                null, 1, 1, CombinedSensitivityParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getCombinedSensitivityParameter_ChildParameters__CombinedSensitivityParameter(),
        ...
        initEClass(sensitivityResultSpecificationEClass, SensitivityResultSpecification.class,
                "SensitivityResultSpecification", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(singleSensitivityParameterEClass, SingleSensitivityParameter.class, "SingleSensitivityParameter",
                IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        ...
        initEClass(sensitivityParameterVariationEClass, SensitivityParameterVariation.class,
                "SensitivityParameterVariation", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSensitivityParameterVariation_SingleSensitivityParameter__SensitivityParameterVariation(),
        ...
        initEClass(componentReliabilityParameterEClass, ComponentReliabilityParameter.class,
                "ComponentReliabilityParameter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getComponentReliabilityParameter_BasicComponent__ComponentReliabilityParameter(),
        ...
        EOperation op = addEOperation(componentReliabilityParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(doubleParameterVariationEClass, DoubleParameterVariation.class, "DoubleParameterVariation",
                IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(stringParameterSequenceEClass, StringParameterSequence.class, "StringParameterSequence",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getStringParameterSequence_StringValues(), ecorePackage.getEString(), "stringValues", null, 1,
                -1, StringParameterSequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(doubleParameterRangeEClass, DoubleParameterRange.class, "DoubleParameterRange", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getDoubleParameterRange_ConsiderStepSize(), ecorePackage.getEBoolean(), "considerStepSize",
                null, 1, 1, DoubleParameterRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEAttribute(getDoubleParameterRange_FirstValue(), ecorePackage.getEDouble(), "firstValue", null, 1, 1,
                DoubleParameterRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEAttribute(getDoubleParameterRange_LastValue(), ecorePackage.getEDouble(), "lastValue", null, 1, 1,
                DoubleParameterRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEAttribute(getDoubleParameterRange_StepSize(), ecorePackage.getEDouble(), "stepSize", null, 1, 1,
                DoubleParameterRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEAttribute(getDoubleParameterRange_StepCount(), ecorePackage.getEInt(), "stepCount", null, 1, 1,
                DoubleParameterRange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(doubleParameterSequenceEClass, DoubleParameterSequence.class, "DoubleParameterSequence",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getDoubleParameterSequence_DoubleValues(), ecorePackage.getEDouble(), "doubleValues", null, 1,
                -1, DoubleParameterSequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(doubleParameterFunctionEClass, DoubleParameterFunction.class, "DoubleParameterFunction",
                IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(internalActionReliabilityParameterEClass, InternalActionReliabilityParameter.class,
        ...
        initEReference(getInternalActionReliabilityParameter_InternalAction__InternalActionReliabilityParameter(),
                theSeffPackage.getInternalAction(), null, "internalAction__InternalActionReliabilityParameter", null,
                1, 1, InternalActionReliabilityParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        op = addEOperation(internalActionReliabilityParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(probabilisticBranchParameterEClass, ProbabilisticBranchParameter.class,
        ...
        op = addEOperation(probabilisticBranchParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(hardwareMTTFParameterEClass, HardwareMTTFParameter.class, "HardwareMTTFParameter", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = addEOperation(hardwareMTTFParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(hardwareMTTRParameterEClass, HardwareMTTRParameter.class, "HardwareMTTRParameter", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = addEOperation(hardwareMTTRParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(resourceMTTFParameterEClass, ResourceMTTFParameter.class, "ResourceMTTFParameter", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getResourceMTTFParameter_ProcessingResourceType__ResourceMTTFParameter(),
                theResourcetypePackage.getProcessingResourceType(), null,
                "processingResourceType__ResourceMTTFParameter", null, 1, 1, ResourceMTTFParameter.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getResourceMTTFParameter_ResourceContainer__ResourceMTTFParameter(),
        ...
        op = addEOperation(resourceMTTFParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(resourceMTTRParameterEClass, ResourceMTTRParameter.class, "ResourceMTTRParameter", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getResourceMTTRParameter_ResourceContainer__ResourceMTTRParameter(),
                ...
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getResourceMTTRParameter_ProcessingResourceType__ResourceMTTRParameter(),
                theResourcetypePackage.getProcessingResourceType(), null,
                "processingResourceType__ResourceMTTRParameter", null, 1, 1, ResourceMTTRParameter.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        op = addEOperation(resourceMTTRParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(networkReliabilityParameterEClass, NetworkReliabilityParameter.class, "NetworkReliabilityParameter",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = addEOperation(networkReliabilityParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(communicationLinkReliabilityParameterEClass, CommunicationLinkReliabilityParameter.class,
        ...
        op = addEOperation(communicationLinkReliabilityParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(softwareReliabilityParameterEClass, SoftwareReliabilityParameter.class,
                "SoftwareReliabilityParameter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = addEOperation(softwareReliabilityParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(variableUsageParameterEClass, VariableUsageParameter.class, "VariableUsageParameter", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getVariableUsageParameter_VariableName(), ecorePackage.getEString(), "VariableName", null, 1, 1,
        ...
        initEReference(getVariableUsageParameter_EntryLevelSystemCall__VariableUsageParameter(),
                ...
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEAttribute(getVariableUsageParameter_VariableCharacterisationType__VariableUsageParameter(),
        ...
        initEAttribute(getVariableUsageParameter_VariableUsageType__VariableUsageParameter(),
        ...
        op = addEOperation(variableUsageParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(usageBranchParameterEClass, UsageBranchParameter.class, "UsageBranchParameter", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getUsageBranchParameter_Branch__UsageBranchParameter(), theUsagemodelPackage.getBranch(), null,
                "branch__UsageBranchParameter", null, 1, 1, UsageBranchParameter.class, !IS_TRANSIENT, !IS_VOLATILE,
        ...
        op = addEOperation(usageBranchParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(doubleOffsetSequenceEClass, DoubleOffsetSequence.class, "DoubleOffsetSequence", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getDoubleOffsetSequence_OffsetValues(), ecorePackage.getEDouble(), "offsetValues", null, 1, -1,
                DoubleOffsetSequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEAttribute(getDoubleOffsetSequence_DoubleOffsetType__DoubleOffsetSequence(), this.getDoubleOffsetType(),
                "doubleOffsetType__DoubleOffsetSequence", null, 1, 1, DoubleOffsetSequence.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(softwareFailureTypesParameterEClass, SoftwareFailureTypesParameter.class,
        ...
        op = addEOperation(softwareFailureTypesParameterEClass, ecorePackage.getEBoolean(),
        ...
        initEClass(failureTypeResultSpecificationEClass, FailureTypeResultSpecification.class,
                "FailureTypeResultSpecification", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getFailureTypeResultSpecification_FailureTypes__FailureTypeResultSpecification(),
        ...
        initEClass(failureDimensionResultSpecificationEClass, FailureDimensionResultSpecification.class,

 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.sensitivity.impl.DoubleParameterRangeImpl#isConsiderStepSize <em>
 * Consider Step Size</em>}</li>
 * <li>{@link de.uka.ipd.sdq.sensitivity.impl.DoubleParameterRangeImpl#getFirstValue <em>First Value
 * </em>}</li>
 * <li>{@link de.uka.ipd.sdq.sensitivity.impl.DoubleParameterRangeImpl#getLastValue <em>Last Value
 * </em>}</li>
 * <li>{@link de.uka.ipd.sdq.sensitivity.impl.DoubleParameterRangeImpl#getStepSize <em>Step Size
 * </em>}</li>
 * <li>{@link de.uka.ipd.sdq.sensitivity.impl.DoubleParameterRangeImpl#getStepCount <em>Step Count
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class DoubleParameterRangeImpl extends DoubleParameterVariationImpl implements DoubleParameterRange {
    ...
    public void setFirstValue(double newFirstValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SensitivityPackage.DOUBLE_PARAMETER_RANGE__FIRST_VALUE, oldFirstValue, firstValue));
    }
    ...
    public void setLastValue(double newLastValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SensitivityPackage.DOUBLE_PARAMETER_RANGE__LAST_VALUE, oldLastValue, lastValue));
    }
    ...
    public void setStepSize(double newStepSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SensitivityPackage.DOUBLE_PARAMETER_RANGE__STEP_SIZE,
    ...
    public void setStepCount(int newStepCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SensitivityPackage.DOUBLE_PARAMETER_RANGE__STEP_COUNT, oldStepCount, stepCount));
    }

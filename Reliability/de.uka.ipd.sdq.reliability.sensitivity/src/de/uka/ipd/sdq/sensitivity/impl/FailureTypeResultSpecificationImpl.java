 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.FailureTypeResultSpecificationImpl#getFailureTypes__FailureTypeResultSpecification
 ...
 * @generated
 */
public class FailureTypeResultSpecificationImpl extends SensitivityResultSpecificationImpl implements
    ...
    public EList<FailureType> getFailureTypes__FailureTypeResultSpecification() {
        if (failureTypes__FailureTypeResultSpecification == null) {
            failureTypes__FailureTypeResultSpecification = new EObjectResolvingEList<FailureType>(
                    FailureType.class,
                    this,
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case SensitivityPackage.FAILURE_TYPE_RESULT_SPECIFICATION__FAILURE_TYPES_FAILURE_TYPE_RESULT_SPECIFICATION:
            return failureTypes__FailureTypeResultSpecification != null
                    && !failureTypes__FailureTypeResultSpecification.isEmpty();
        }

 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.SensitivityConfigurationImpl#getSensitivityParameters__SensitivityConfiguration
 * <em>Sensitivity Parameters Sensitivity Configuration</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.SensitivityConfigurationImpl#getSensitivityResultSpecifications__SensitivityConfiguration
...
public class SensitivityConfigurationImpl extends EntityImpl implements SensitivityConfiguration {
    ...
    public NotificationChain basicSetSensitivityParameters__SensitivityConfiguration(
            SensitivityParameter newSensitivityParameters__SensitivityConfiguration, NotificationChain msgs) {
    ...
    public void setSensitivityParameters__SensitivityConfiguration(
            SensitivityParameter newSensitivityParameters__SensitivityConfiguration) {
        if (newSensitivityParameters__SensitivityConfiguration != sensitivityParameters__SensitivityConfiguration) {
            ...
            if (sensitivityParameters__SensitivityConfiguration != null)
                msgs = ((InternalEObject) sensitivityParameters__SensitivityConfiguration).eInverseRemove(this,
            ...
            if (newSensitivityParameters__SensitivityConfiguration != null)
                msgs = ((InternalEObject) newSensitivityParameters__SensitivityConfiguration).eInverseAdd(this,
                        SensitivityPackage.SENSITIVITY_PARAMETER__SENSITIVITY_CONFIGURATION_SENSITIVITY_PARAMETER,
                        SensitivityParameter.class, msgs);
            msgs = basicSetSensitivityParameters__SensitivityConfiguration(
    ...
    public EList<SensitivityResultSpecification> getSensitivityResultSpecifications__SensitivityConfiguration() {
        if (sensitivityResultSpecifications__SensitivityConfiguration == null) {
            sensitivityResultSpecifications__SensitivityConfiguration = new EObjectContainmentEList<SensitivityResultSpecification>(
                    SensitivityResultSpecification.class,
                    this,
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case SensitivityPackage.SENSITIVITY_CONFIGURATION__SENSITIVITY_PARAMETERS_SENSITIVITY_CONFIGURATION:
            if (sensitivityParameters__SensitivityConfiguration != null)
                msgs = ((InternalEObject) sensitivityParameters__SensitivityConfiguration)
                        .eInverseRemove(
                                this,
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case SensitivityPackage.SENSITIVITY_CONFIGURATION__SENSITIVITY_RESULT_SPECIFICATIONS_SENSITIVITY_CONFIGURATION:
            return ((InternalEList<?>) getSensitivityResultSpecifications__SensitivityConfiguration()).basicRemove(
                    otherEnd, msgs);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case SensitivityPackage.SENSITIVITY_CONFIGURATION__SENSITIVITY_RESULT_SPECIFICATIONS_SENSITIVITY_CONFIGURATION:
            ...
            getSensitivityResultSpecifications__SensitivityConfiguration().addAll(
                    (Collection<? extends SensitivityResultSpecification>) newValue);
            return;
        }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case SensitivityPackage.SENSITIVITY_CONFIGURATION__SENSITIVITY_RESULT_SPECIFICATIONS_SENSITIVITY_CONFIGURATION:
            return sensitivityResultSpecifications__SensitivityConfiguration != null
                    && !sensitivityResultSpecifications__SensitivityConfiguration.isEmpty();
        }

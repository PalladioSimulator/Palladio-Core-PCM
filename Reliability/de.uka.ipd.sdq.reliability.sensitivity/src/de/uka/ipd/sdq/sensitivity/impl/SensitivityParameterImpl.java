 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.SensitivityParameterImpl#getParentParameter__SensitivityParameter
 * <em>Parent Parameter Sensitivity Parameter</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.SensitivityParameterImpl#getSensitivityConfiguration__SensitivityParameter
...
public abstract class SensitivityParameterImpl extends EntityImpl implements SensitivityParameter {
    ...
    public CombinedSensitivityParameter getParentParameter__SensitivityParameter() {
        if (eContainerFeatureID() != SensitivityPackage.SENSITIVITY_PARAMETER__PARENT_PARAMETER_SENSITIVITY_PARAMETER)
            return null;
        return (CombinedSensitivityParameter) eInternalContainer();
    }
    ...
    public NotificationChain basicSetParentParameter__SensitivityParameter(
            CombinedSensitivityParameter newParentParameter__SensitivityParameter, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newParentParameter__SensitivityParameter,
    ...
    public void setParentParameter__SensitivityParameter(
            CombinedSensitivityParameter newParentParameter__SensitivityParameter) {
        if (newParentParameter__SensitivityParameter != eInternalContainer()
                || (eContainerFeatureID() != SensitivityPackage.SENSITIVITY_PARAMETER__PARENT_PARAMETER_SENSITIVITY_PARAMETER && newParentParameter__SensitivityParameter != null)) {
            ...
            if (newParentParameter__SensitivityParameter != null)
                msgs = ((InternalEObject) newParentParameter__SensitivityParameter)
                        .eInverseAdd(
                                this,
    ...
    public SensitivityConfiguration getSensitivityConfiguration__SensitivityParameter() {
        if (eContainerFeatureID() != SensitivityPackage.SENSITIVITY_PARAMETER__SENSITIVITY_CONFIGURATION_SENSITIVITY_PARAMETER)
            return null;
        return (SensitivityConfiguration) eInternalContainer();
    }
    ...
    public NotificationChain basicSetSensitivityConfiguration__SensitivityParameter(
            SensitivityConfiguration newSensitivityConfiguration__SensitivityParameter, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newSensitivityConfiguration__SensitivityParameter,
    ...
    public void setSensitivityConfiguration__SensitivityParameter(
            SensitivityConfiguration newSensitivityConfiguration__SensitivityParameter) {
        if (newSensitivityConfiguration__SensitivityParameter != eInternalContainer()
                || (eContainerFeatureID() != SensitivityPackage.SENSITIVITY_PARAMETER__SENSITIVITY_CONFIGURATION_SENSITIVITY_PARAMETER && newSensitivityConfiguration__SensitivityParameter != null)) {
            ...
            msgs = basicSetSensitivityConfiguration__SensitivityParameter(

 ...
 *
 * <!-- begin-model-doc --> This parameter refers to the set of all network failure probabilities
 * specified in the given PCM instance. All&nbsp;probabilities are altered together according to the
 * same sequence of values. <!-- end-model-doc -->
 *
 *

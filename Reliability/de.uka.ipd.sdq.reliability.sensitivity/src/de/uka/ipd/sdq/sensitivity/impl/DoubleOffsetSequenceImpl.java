 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.sensitivity.impl.DoubleOffsetSequenceImpl#getOffsetValues <em>Offset
 * Values</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.DoubleOffsetSequenceImpl#getDoubleOffsetType__DoubleOffsetSequence
...
public class DoubleOffsetSequenceImpl extends DoubleParameterVariationImpl implements DoubleOffsetSequence {
    ...
    public EList<Double> getOffsetValues() {
        if (offsetValues == null) {
            offsetValues = new EDataTypeEList<Double>(Double.class, this,
    ...
    public void setDoubleOffsetType__DoubleOffsetSequence(DoubleOffsetType newDoubleOffsetType__DoubleOffsetSequence) {
        ...
        doubleOffsetType__DoubleOffsetSequence = newDoubleOffsetType__DoubleOffsetSequence == null ? DOUBLE_OFFSET_TYPE_DOUBLE_OFFSET_SEQUENCE_EDEFAULT
                : newDoubleOffsetType__DoubleOffsetSequence;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SensitivityPackage.DOUBLE_OFFSET_SEQUENCE__DOUBLE_OFFSET_TYPE_DOUBLE_OFFSET_SEQUENCE,
                    oldDoubleOffsetType__DoubleOffsetSequence, doubleOffsetType__DoubleOffsetSequence));
    }

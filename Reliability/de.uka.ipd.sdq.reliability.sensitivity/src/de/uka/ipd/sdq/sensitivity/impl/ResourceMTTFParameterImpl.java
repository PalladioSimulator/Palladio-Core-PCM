 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.ResourceMTTFParameterImpl#getProcessingResourceType__ResourceMTTFParameter
 * <em>Processing Resource Type Resource MTTF Parameter</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.sensitivity.impl.ResourceMTTFParameterImpl#getResourceContainer__ResourceMTTFParameter
...
public class ResourceMTTFParameterImpl extends SingleSensitivityParameterImpl implements ResourceMTTFParameter {
    ...
    public ProcessingResourceType getProcessingResourceType__ResourceMTTFParameter() {
        if (processingResourceType__ResourceMTTFParameter != null
                && processingResourceType__ResourceMTTFParameter.eIsProxy()) {
            ...
            if (processingResourceType__ResourceMTTFParameter != oldProcessingResourceType__ResourceMTTFParameter) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            processingResourceType__ResourceMTTFParameter));
            }
        }
    ...
    public void setProcessingResourceType__ResourceMTTFParameter(
            ProcessingResourceType newProcessingResourceType__ResourceMTTFParameter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SensitivityPackage.RESOURCE_MTTF_PARAMETER__PROCESSING_RESOURCE_TYPE_RESOURCE_MTTF_PARAMETER,
                    oldProcessingResourceType__ResourceMTTFParameter, processingResourceType__ResourceMTTFParameter));
    }
            ...
            if (resourceContainer__ResourceMTTFParameter != oldResourceContainer__ResourceMTTFParameter) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ...
                            oldResourceContainer__ResourceMTTFParameter, resourceContainer__ResourceMTTFParameter));
            }
        }
    ...
    public void setResourceContainer__ResourceMTTFParameter(
            ResourceContainer newResourceContainer__ResourceMTTFParameter) {
                ...
                diagnostics
                        .add(new BasicDiagnostic(
                                ...
                                EcorePlugin.INSTANCE.getString(
                                        ...
                                        new Object[] {
                                                "ResourceMTTFParameterMustHaveDoubleVariation",
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case SensitivityPackage.RESOURCE_MTTF_PARAMETER__PROCESSING_RESOURCE_TYPE_RESOURCE_MTTF_PARAMETER:
            if (resolve)
                return getProcessingResourceType__ResourceMTTFParameter();
        ...
        case SensitivityPackage.RESOURCE_MTTF_PARAMETER__RESOURCE_CONTAINER_RESOURCE_MTTF_PARAMETER:
            if (resolve)
                return getResourceContainer__ResourceMTTFParameter();

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Variable Usage Parameter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensitivity.impl.VariableUsageParameterImpl#getVariableName <em>Variable Name</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensitivity.impl.VariableUsageParameterImpl#getEntryLevelSystemCall__VariableUsageParameter <em>Entry Level System Call Variable Usage Parameter</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensitivity.impl.VariableUsageParameterImpl#getVariableCharacterisationType__VariableUsageParameter <em>Variable Characterisation Type Variable Usage Parameter</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensitivity.impl.VariableUsageParameterImpl#getVariableUsageType__VariableUsageParameter <em>Variable Usage Type Variable Usage Parameter</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.sensitivity.impl.VariableUsageParameterImpl#getBasicComponent__VariableUsageParameter <em>Basic Component Variable Usage Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableUsageParameterImpl extends SingleSensitivityParameterImpl implements VariableUsageParameter {
	...
	/**
	 * The cached value of the '{@link #getEntryLevelSystemCall__VariableUsageParameter() <em>Entry Level System Call Variable Usage Parameter</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The default value of the '{@link #getVariableCharacterisationType__VariableUsageParameter() <em>Variable Characterisation Type Variable Usage Parameter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getVariableCharacterisationType__VariableUsageParameter() <em>Variable Characterisation Type Variable Usage Parameter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getVariableCharacterisationType__VariableUsageParameter()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getVariableUsageType__VariableUsageParameter() <em>Variable Usage Type Variable Usage Parameter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getVariableUsageType__VariableUsageParameter() <em>Variable Usage Type Variable Usage Parameter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getVariableUsageType__VariableUsageParameter()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getBasicComponent__VariableUsageParameter() <em>Basic Component Variable Usage Parameter</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setVariableName(String newVariableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensitivityPackage.VARIABLE_USAGE_PARAMETER__VARIABLE_NAME, oldVariableName, variableName));
	}
	...
	public EntryLevelSystemCall getEntryLevelSystemCall__VariableUsageParameter() {
		if (entryLevelSystemCall__VariableUsageParameter != null && entryLevelSystemCall__VariableUsageParameter.eIsProxy()) {
			...
			if (entryLevelSystemCall__VariableUsageParameter != oldEntryLevelSystemCall__VariableUsageParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SensitivityPackage.VARIABLE_USAGE_PARAMETER__ENTRY_LEVEL_SYSTEM_CALL_VARIABLE_USAGE_PARAMETER, oldEntryLevelSystemCall__VariableUsageParameter, entryLevelSystemCall__VariableUsageParameter));
			}
		}
	 ...
	 * @generated
	 */
	public void setEntryLevelSystemCall__VariableUsageParameter(EntryLevelSystemCall newEntryLevelSystemCall__VariableUsageParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensitivityPackage.VARIABLE_USAGE_PARAMETER__ENTRY_LEVEL_SYSTEM_CALL_VARIABLE_USAGE_PARAMETER, oldEntryLevelSystemCall__VariableUsageParameter, entryLevelSystemCall__VariableUsageParameter));
	}
	 ...
	 * @generated
	 */
	public void setVariableCharacterisationType__VariableUsageParameter(VariableCharacterisationType newVariableCharacterisationType__VariableUsageParameter) {
		...
		variableCharacterisationType__VariableUsageParameter = newVariableCharacterisationType__VariableUsageParameter == null ? VARIABLE_CHARACTERISATION_TYPE_VARIABLE_USAGE_PARAMETER_EDEFAULT : newVariableCharacterisationType__VariableUsageParameter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensitivityPackage.VARIABLE_USAGE_PARAMETER__VARIABLE_CHARACTERISATION_TYPE_VARIABLE_USAGE_PARAMETER, oldVariableCharacterisationType__VariableUsageParameter, variableCharacterisationType__VariableUsageParameter));
	}
	...
	public void setVariableUsageType__VariableUsageParameter(VariableUsageType newVariableUsageType__VariableUsageParameter) {
		...
		variableUsageType__VariableUsageParameter = newVariableUsageType__VariableUsageParameter == null ? VARIABLE_USAGE_TYPE_VARIABLE_USAGE_PARAMETER_EDEFAULT : newVariableUsageType__VariableUsageParameter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensitivityPackage.VARIABLE_USAGE_PARAMETER__VARIABLE_USAGE_TYPE_VARIABLE_USAGE_PARAMETER, oldVariableUsageType__VariableUsageParameter, variableUsageType__VariableUsageParameter));
	}
	...
	public BasicComponent getBasicComponent__VariableUsageParameter() {
		if (basicComponent__VariableUsageParameter != null && basicComponent__VariableUsageParameter.eIsProxy()) {
			...
			if (basicComponent__VariableUsageParameter != oldBasicComponent__VariableUsageParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SensitivityPackage.VARIABLE_USAGE_PARAMETER__BASIC_COMPONENT_VARIABLE_USAGE_PARAMETER, oldBasicComponent__VariableUsageParameter, basicComponent__VariableUsageParameter));
			}
		}
	...
	public void setBasicComponent__VariableUsageParameter(BasicComponent newBasicComponent__VariableUsageParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensitivityPackage.VARIABLE_USAGE_PARAMETER__BASIC_COMPONENT_VARIABLE_USAGE_PARAMETER, oldBasicComponent__VariableUsageParameter, basicComponent__VariableUsageParameter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SensitivityPackage.VARIABLE_USAGE_PARAMETER__ENTRY_LEVEL_SYSTEM_CALL_VARIABLE_USAGE_PARAMETER:
				if (resolve) return getEntryLevelSystemCall__VariableUsageParameter();
			...
			case SensitivityPackage.VARIABLE_USAGE_PARAMETER__BASIC_COMPONENT_VARIABLE_USAGE_PARAMETER:
				if (resolve) return getBasicComponent__VariableUsageParameter();

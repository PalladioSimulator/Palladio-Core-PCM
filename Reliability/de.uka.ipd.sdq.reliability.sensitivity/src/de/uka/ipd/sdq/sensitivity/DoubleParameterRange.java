...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Double Parameter Range</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 * Specifies&nbsp;a value range (i.e. an interval) with a given step size or step count, to define&nbsp;a
 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.sensitivity.DoubleParameterRange#isConsiderStepSize <em>Consider Step Size</em>}</li>
...
public interface DoubleParameterRange extends DoubleParameterVariation {
	/**
     * Returns the value of the '<em><b>Consider Step Size</b></em>' attribute.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Decides&nbsp;if&nbsp;the&nbsp;step&nbsp;width&nbsp;is&nbsp;used&nbsp;to&nbsp;determine&nbsp;the&nbsp;value&nbsp;sequence&nbsp;(considerStepSize&nbsp;==&nbsp;true)&nbsp;or&nbsp;the&nbsp;step&nbsp;count<br />
	...
	/**
     * Sets the value of the '{@link de.uka.ipd.sdq.sensitivity.DoubleParameterRange#isConsiderStepSize <em>Consider Step Size</em>}' attribute.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @param value the new value of the '<em>Consider Step Size</em>' attribute.
	...
	/**
     * Returns the value of the '<em><b>First Value</b></em>' attribute.
     * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>First Value</em>' attribute isn't clear,
	...
	/**
     * Sets the value of the '{@link de.uka.ipd.sdq.sensitivity.DoubleParameterRange#getFirstValue <em>First Value</em>}' attribute.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @param value the new value of the '<em>First Value</em>' attribute.
     * @see #getFirstValue()
     * @generated
     */
	...
	/**
     * Sets the value of the '{@link de.uka.ipd.sdq.sensitivity.DoubleParameterRange#getLastValue <em>Last Value</em>}' attribute.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
     * Sets the value of the '{@link de.uka.ipd.sdq.sensitivity.DoubleParameterRange#getStepSize <em>Step Size</em>}' attribute.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

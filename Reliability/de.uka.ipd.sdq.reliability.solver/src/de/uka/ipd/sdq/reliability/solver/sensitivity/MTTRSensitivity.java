...
public class MTTRSensitivity extends MarkovSensitivity {
	...
	/**
	 * Captures the current MTTR value.
	 */
	private double currentMTTR;
	 ...
	 */
	public MTTRSensitivity(final String name, final double firstValue,
	 ...
	 *            path where to log sensitivity analysis results
	 */
	public MTTRSensitivity(final String name, final List<Double> list,
			final String resultLogFile) {
	...
	protected List<String> getLogSingleResultsMulti() {
		...
		resultList.add(((Double) currentMTTR).toString());
	...
	/**
	 * Sets the MTTR value of the given processing resource specifications
	 * according to the current sensitivity analysis step.
	 * 
	 * @param specifications
	 *            the processing resource specifications
	 */
	void setMTTR(final List<ProcessingResourceSpecification> specifications) {

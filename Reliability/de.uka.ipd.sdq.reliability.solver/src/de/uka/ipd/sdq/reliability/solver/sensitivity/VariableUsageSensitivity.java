...
public class VariableUsageSensitivity extends MarkovSensitivity {
	...
	/**
	 * Type of parameter usage (input parameter for EntryLevelSystemCall or
	 * component parameter).
	 */
	 ...
	 * @param parameterType
	 *            the type of parameter usage (input parameter for
	 *            EntryLevelSystemCall or component parameter)
	 * @param sequence
	 *            the sequence of parameter value specifications
	 */
	public VariableUsageSensitivity(final String name, final String elementId,
			final String parameterName,
			final VariableCharacterisationType characterisationType,

 ...
 * FailureAnalysisFailureType when considering failure types.
 * 
...
public class TypesFailureProbabilityAggregation {
	 ...
	 */
	public TypesFailureProbabilityAggregation(
			FailureAnalysisFailureType failureType, String typeIdentifier,
	...
	/**
	 * Compares this instances failure type and type identifier to another
	 * instance's failure type and type identifier.
	 * 
	 * @param otherfailureType
	 *            the other instance's failure type
	 * @param otherTypeIdentifier
	 *            the other instance's type identifier
	 * @return <code>true</code>, if and only if both the failure types and type
	 *         identifiers match
	 */
	public boolean compareTo(FailureAnalysisFailureType otherfailureType,
			String otherTypeIdentifier) {

...
public class TypesFailureProbabilityAggregation {
	 ...
	 * @param failureAggregationType the failure analysis failure type
	...
	/**
	 * Compares this instances failure type and type identifier to another instance's failure type and
	 * type identifier.
	 * @param otherfailureType the other instance's failure type
	 * @param otherTypeIdentifier the other instance's type identifier

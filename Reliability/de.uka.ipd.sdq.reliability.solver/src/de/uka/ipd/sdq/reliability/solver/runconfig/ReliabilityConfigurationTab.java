...
public class ReliabilityConfigurationTab extends ConfigurationTab {
	 ...
	 * 
	 * @see
	 * de.uka.ipd.sdq.workflow.pcm.runconfig.ConfigurationTab#createFurtherSections
	...
	protected void createFurtherSections(Composite container) {
		...
		final GridData gd_sensitivityGroup = new GridData(SWT.FILL, SWT.CENTER,
				true, false);
		...
		textSensitivityFile = new Text(sensitivityGroup, SWT.SINGLE
				| SWT.BORDER);
		...
		TabHelper.createFileInputSection(sensitivityGroup, modifyListener,
				SENSITIVITY_FILE_LABEL,
				ConstantsContainer.SENSITIVITY_ANALYSIS_EXTENSION,
				textSensitivityFile, getShell(),
		...
		TabHelper.createFileInputSection(sensitivityGroup, modifyListener,
				LOG_FILE_LABEL, ConstantsContainer.SENSITIVITY_LOG_EXTENSION,
				textResultLogFile, getShell(),
	 ...
	 * 
	 * @see
	 * de.uka.ipd.sdq.workflow.pcm.runconfig.ConfigurationTab#initializeFrom
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try {
			...
			textSensitivityFile.setText(configuration.getAttribute(
					...
					ConstantsContainer.DEFAULT_SENSITIVITY_MODEL_FILE));
			textResultLogFile.setText(configuration.getAttribute(
					ConstantsContainer.SENSITIVITY_LOG_FILE,
					ConstantsContainer.DEFAULT_SENSITIVITY_LOG_FILE));
		} catch (CoreException e) {
			sensitivityButton
					.setSelection(ConstantsContainer.DEFAULT_DO_SENSITIVITY_ANALYSIS);
			textSensitivityFile
					.setText(ConstantsContainer.DEFAULT_SENSITIVITY_MODEL_FILE);
			textResultLogFile
					.setText(ConstantsContainer.DEFAULT_SENSITIVITY_LOG_FILE);
		}
	}
	 ...
	 * 
	 * @see
	 * de.uka.ipd.sdq.workflow.pcm.runconfig.ConfigurationTab#isValid(org.eclipse
	...
	public boolean isValid(ILaunchConfiguration launchConfig) {
		...
		if (sensitivityButton.getSelection() == true) {
			if (!TabHelper.validateFilenameExtension(textSensitivityFile
					.getText(),
					ConstantsContainer.SENSITIVITY_ANALYSIS_EXTENSION)) {
	 ...
	 * 
	 * @see
	 * de.uka.ipd.sdq.workflow.pcm.runconfig.ConfigurationTab#performApply(org
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		...
		configuration.setAttribute(ConstantsContainer.SENSITIVITY_LOG_FILE,
				this.textResultLogFile.getText());
	}
	 ...
	 * 
	 * @see
	 * de.uka.ipd.sdq.workflow.pcm.runconfig.ConfigurationTab#setDefaults(org
	 * .eclipse.debug.core.ILaunchConfigurationWorkingCopy)
	 */
	@Override

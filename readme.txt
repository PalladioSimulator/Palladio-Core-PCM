...
FileShare						File-sharing application used in the case study for CBSE2008 paper (bib key: kuperberg2008b)
Java2PCM						Eclipse plugins: Reverse engineering of RDSEFFs from Java source code. Based on work of Thomas Kappler.
Palladio.Benchmark				Project which simulates resource demands on physical hardware, used by ProtoCom as well as ???
Palladio.ByCounter				Runtime counting of bytecode instructions and method invocations in Java bytecode (stand-alone project)
Palladio.ByCounter				Bytecode-based performance prediction, on the basis of ByCounter (see above) and ByBench (not yet in this repository)
Palladio.CoreServices 			Core-Plugins which are needed more than once by other plugins
Palladio.DesignSpaceExploration	Plugins that realise the Design Space Exploration of PCM instances, as proposed in Annes work. Not included in the PCM Build yet. 
...
Palladio.SensorFramework		Framework to place and store sensors in Simulations or to instrument code
[removed] Palladio.SensorFrameworkGUI 	Visualisations for Sensors placed with the sensor framework on Eclipse
Palladio.Simulation				TODO: Jens
Palladio.StoEx 					Grammar and Parser tools for Stochastic Expressions
Palladio.TimerMeter				Application to measure resolution and cost of timer invocations
Palladio.Wrapper				Wrapper-Plugins for external libraries.
[removed] PalladioCM.Builder 				Eclipse RelEng build scripts to build the complete PCMBench plugin set

...
public interface IProbabilityFunctionFactory {
	...
	/**
	 * Set the random generator to use to the passed one. 
	 * If this method is never called, the {@link DefaultRandomGenerator}
	 * is used. 
	 * This method can be called at any time, however, to get consistent results
	 * it should be called before retrieving any functions from this factory.

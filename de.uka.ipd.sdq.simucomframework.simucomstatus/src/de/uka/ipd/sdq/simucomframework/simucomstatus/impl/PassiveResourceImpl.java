 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.PassiveResourceImpl#getWaitingProcesses
 * <em>Waiting Processes</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.PassiveResourceImpl#getInitialResourceCount
 * <em>Initial Resource Count</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.PassiveResourceImpl#getResourcesAvailable
 * <em>Resources Available</em>}</li>
 * <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.PassiveResourceImpl#getId <em>Id
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class PassiveResourceImpl extends EObjectImpl implements PassiveResource {
    /**
     * The cached value of the '{@link #getWaitingProcesses() <em>Waiting Processes</em>}' reference
    ...
    /**
     * The default value of the '{@link #getInitialResourceCount() <em>Initial Resource Count</em>}'
    ...
    /**
     * The cached value of the '{@link #getInitialResourceCount() <em>Initial Resource Count</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getInitialResourceCount()
     * @generated
    ...
    /**
     * The default value of the '{@link #getResourcesAvailable() <em>Resources Available</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    public EList<WaitForAcquire> getWaitingProcesses() {
        if (waitingProcesses == null) {
            waitingProcesses = new EObjectWithInverseResolvingEList<WaitForAcquire>(WaitForAcquire.class, this,
                    SimucomstatusPackage.PASSIVE_RESOURCE__WAITING_PROCESSES,
                    SimucomstatusPackage.WAIT_FOR_ACQUIRE__RESOURCE);
        }
    ...
    public void setInitialResourceCount(double newInitialResourceCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SimucomstatusPackage.PASSIVE_RESOURCE__INITIAL_RESOURCE_COUNT, oldInitialResourceCount,

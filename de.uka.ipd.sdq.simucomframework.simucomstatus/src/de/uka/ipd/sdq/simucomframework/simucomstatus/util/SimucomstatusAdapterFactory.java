...
public class SimucomstatusAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected SimucomstatusSwitch<Adapter> modelSwitch = new SimucomstatusSwitch<Adapter>() {
        @Override
     ...
     * <em>Simulated Processes</em>}'. <!-- begin-user-doc --> This default implementation returns
     ...
     * <em>Simulated Resources</em>}'. <!-- begin-user-doc --> This default implementation returns
     * null so that we can easily ignore cases; it's useful to ignore a case when inheritance will
     * catch all the cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
     ...
     * <em>Passive Resource</em>}'. <!-- begin-user-doc --> This default implementation returns null
     ...
     * <em>Wait For Acquire</em>}'. <!-- begin-user-doc --> This default implementation returns null
     * so that we can easily ignore cases; it's useful to ignore a case when inheritance will catch
     * all the cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.

 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.ProcessImpl#getCurrentAction <em>
 * Current Action</em>}</li>
 * <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.ProcessImpl#getId <em>Id</em>}</li>
 * <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.ProcessImpl#getProcessStartTime
 * <em>Process Start Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessImpl extends EObjectImpl implements de.uka.ipd.sdq.simucomframework.simucomstatus.Process {
    /**
     * The cached value of the '{@link #getCurrentAction() <em>Current Action</em>}' containment
    ...
    /**
     * The default value of the '{@link #getProcessStartTime() <em>Process Start Time</em>}'
    ...
    /**
     * The cached value of the '{@link #getProcessStartTime() <em>Process Start Time</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getProcessStartTime()
     * @generated
    ...
    public NotificationChain basicSetCurrentAction(Action newCurrentAction, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SimucomstatusPackage.PROCESS__CURRENT_ACTION, oldCurrentAction, newCurrentAction);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setCurrentAction(Action newCurrentAction) {
        if (newCurrentAction != currentAction) {
            ...
            if (currentAction != null)
                msgs = ((InternalEObject) currentAction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - SimucomstatusPackage.PROCESS__CURRENT_ACTION, null, msgs);
            if (newCurrentAction != null)
                msgs = ((InternalEObject) newCurrentAction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - SimucomstatusPackage.PROCESS__CURRENT_ACTION, null, msgs);
            msgs = basicSetCurrentAction(newCurrentAction, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.PROCESS__CURRENT_ACTION,
    ...
    public void setProcessStartTime(double newProcessStartTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.PROCESS__PROCESS_START_TIME,

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Simu Com Status</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.SimuComStatusImpl#getProcessStatus <em>Process Status</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.SimuComStatusImpl#getResourceStatus <em>Resource Status</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.SimuComStatusImpl#getCurrentSimulationTime <em>Current Simulation Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimuComStatusImpl extends EObjectImpl implements SimuComStatus {
	/**
	 * The cached value of the '{@link #getProcessStatus() <em>Process Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getResourceStatus() <em>Resource Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The default value of the '{@link #getCurrentSimulationTime() <em>Current Simulation Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getCurrentSimulationTime() <em>Current Simulation Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCurrentSimulationTime()
	 * @generated
	...
	public NotificationChain basicSetProcessStatus(SimulatedProcesses newProcessStatus, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.SIMU_COM_STATUS__PROCESS_STATUS, oldProcessStatus, newProcessStatus);
	...
	public void setProcessStatus(SimulatedProcesses newProcessStatus) {
		if (newProcessStatus != processStatus) {
			...
			if (processStatus != null)
				msgs = ((InternalEObject)processStatus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimucomstatusPackage.SIMU_COM_STATUS__PROCESS_STATUS, null, msgs);
			if (newProcessStatus != null)
				msgs = ((InternalEObject)newProcessStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimucomstatusPackage.SIMU_COM_STATUS__PROCESS_STATUS, null, msgs);
			msgs = basicSetProcessStatus(newProcessStatus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.SIMU_COM_STATUS__PROCESS_STATUS, newProcessStatus, newProcessStatus));
	}
	...
	public NotificationChain basicSetResourceStatus(SimulatedResources newResourceStatus, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.SIMU_COM_STATUS__RESOURCE_STATUS, oldResourceStatus, newResourceStatus);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setResourceStatus(SimulatedResources newResourceStatus) {
		if (newResourceStatus != resourceStatus) {
			...
			if (resourceStatus != null)
				msgs = ((InternalEObject)resourceStatus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimucomstatusPackage.SIMU_COM_STATUS__RESOURCE_STATUS, null, msgs);
			if (newResourceStatus != null)
				msgs = ((InternalEObject)newResourceStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimucomstatusPackage.SIMU_COM_STATUS__RESOURCE_STATUS, null, msgs);
			msgs = basicSetResourceStatus(newResourceStatus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.SIMU_COM_STATUS__RESOURCE_STATUS, newResourceStatus, newResourceStatus));
	}
	...
	public void setCurrentSimulationTime(double newCurrentSimulationTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.SIMU_COM_STATUS__CURRENT_SIMULATION_TIME, oldCurrentSimulationTime, currentSimulationTime));
	}

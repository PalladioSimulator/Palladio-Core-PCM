		...
		public class ResourceEnvironmentFactory {
			...
			public static void setUpResources(){
				...
				double cpuProcessingRate = 12.30221283;
	...
	if ("CPU".toLowerCase().contains("cpu")) {
	  ...
	  strategy.initializeStrategy(de.uka.ipd.sdq.measurement.strategies.activeresource.DegreeOfAccuracyEnum.HIGH,cpuProcessingRate);
	  ...
	  strategy.initializeStrategy(de.uka.ipd.sdq.measurement.strategies.activeresource.DegreeOfAccuracyEnum.HIGH,10.0);
	  de.uka.ipd.sdq.prototype.framework.strategies.DemandConsumerStrategiesRegistry.singleton()
	...
	if ("CPU".toLowerCase().contains("cpu")) {
	  ...
	  strategy = new de.uka.ipd.sdq.measurement.strategies.activeresource.hdd.ReadLargeChunksDemand("C://temp"); 
	  strategy.initializeStrategy(de.uka.ipd.sdq.measurement.strategies.activeresource.DegreeOfAccuracyEnum.HIGH,10);
	  de.uka.ipd.sdq.prototype.framework.strategies.DemandConsumerStrategiesRegistry.singleton()
	    .registerStrategyFor(de.uka.ipd.sdq.measurement.strategies.activeresource.ResourceTypeEnum.HDD, 
	    	strategy);
	}

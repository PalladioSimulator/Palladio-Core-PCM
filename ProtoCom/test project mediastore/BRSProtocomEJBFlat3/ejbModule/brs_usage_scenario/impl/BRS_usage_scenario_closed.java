...
import javax.naming.InitialContext;
		public class BRS_usage_scenario_closed implements java.lang.Runnable
		{
			
   protected brs_repository.IAdmin m_portIAdmin_System_Provided = null;

   protected brs_repository.IHTTP m_portIHTTP_System_Provided = null;


	public BRS_usage_scenario_closed() {
...
//
//			m_portIAdmin_System_Provided = (brs_repository.IAdmin) javax.rmi.PortableRemoteObject
//					.narrow(context.lookup("ejb/IAdmin"),
//							brs_repository.IAdmin.class);
//
//			m_portIHTTP_System_Provided = (brs_repository.IHTTP) javax.rmi.PortableRemoteObject
...
//							brs_repository.IHTTP.class);
			...
			//convert obj
			m_portIAdmin_System_Provided = (brs_repository.IAdmin)obj;
			}
			...
			//convert obj
			m_portIHTTP_System_Provided = (brs_repository.IHTTP)obj;
			}
	...
	de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> callResult =	
   	...
   	m_portIHTTP_System_Provided.processLoginLogout0 
	   	(
	ctx
);
	...
	//long resultCall_processLoginLogout0 = endTimeCall_processLoginLogout0 - startTimeCall_processLoginLogout0;
	//System.out.println("Call_processLoginLogout0: "+resultCall_processLoginLogout0);
   ...
   for (int iterationCount__votskNpBEdyxgfK4Hy_RFA = 0, maxIterationCount__votskNpBEdyxgfK4Hy_RFA = (Integer)ctx.evaluate("5",Integer.class); 
	...
	// Start a response time measurement
	//long startTimeCall_processOnlineView4 = System.nanoTime();
	...
	de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> callResult =	
   	...
   	m_portIHTTP_System_Provided.processOnlineView4 
	   	(
	ctx
);
	...
	//long resultCall_processOnlineView4 = endTimeCall_processOnlineView4 - startTimeCall_processOnlineView4;
	//System.out.println("Call_processOnlineView4: "+resultCall_processOnlineView4);
	...
	// Start a response time measurement
	//long startTimeCall_processGraphicalView3 = System.nanoTime();
	...
	de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> callResult =	
   	...
   	m_portIHTTP_System_Provided.processGraphicalView3 
	   	(
	ctx
);
	...
	//long resultCall_processGraphicalView3 = endTimeCall_processGraphicalView3 - startTimeCall_processGraphicalView3;
	//System.out.println("Call_processGraphicalView3: "+resultCall_processGraphicalView3);
	...
	de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> callResult =	
   	...
   	m_portIHTTP_System_Provided.processOnlineReport2 
	   	(
	ctx
);
	...
	//long resultCall_processOnlineReport2 = endTimeCall_processOnlineReport2 - startTimeCall_processOnlineReport2;
	//System.out.println("Call_processOnlineReport2: "+resultCall_processOnlineReport2);
	...
	de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> callResult =	
   	...
   	m_portIHTTP_System_Provided.processGraphicalReport1 
	   	(
	ctx
);
	...
	//long resultCall_processGraphicalReport1 = endTimeCall_processGraphicalReport1 - startTimeCall_processGraphicalReport1;
	//System.out.println("Call_processGraphicalReport1: "+resultCall_processGraphicalReport1);
	...
	de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> callResult =	
   	...
   	m_portIAdmin_System_Provided.maintain0 
	   	(
	ctx
);
	...
	//long resultCall_maintain0 = endTimeCall_maintain0 - startTimeCall_maintain0;
	...
	long resultBRS_usage_scenario = endTimeBRS_usage_scenario - startTimeBRS_usage_scenario;
	System.out.println("BRS_usage_scenario_closed in s: "+resultBRS_usage_scenario / 1000000000.0);

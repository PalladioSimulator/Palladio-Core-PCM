...
public class ScenarioStarter {
	...
	public static final String RESULT_OUTPUT_FOLDER = "results-protocom-server2-cand-2686-IA-1.5-LI-5";
	public static final String EXPERIMENT_NAME = "brs-server2-cand-2686";
	public static final int NUMBER_OF_MEASUREMENTS = 1000;
	public static final int NUMBER_OF_WARMUP_CYCLES = 10;

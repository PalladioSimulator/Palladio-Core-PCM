package com.palladio_simulator.protocom.framework.config;
...
public class ProtocomConfig {
	...
	/**
	 * @param maxMeasurements the maxMeasurements to set
	 */
	...
	/**
	 * @param warmUpRuns the warmUpRuns to set
	 */
	...
	/**
	 * @param warmupOnly the warmupOnly to set
	 */

package org.palladiosimulator.protocom.framework.java.ee.legacy;
...
public abstract class AbstractAllocationStorage {
    ...
    /**
     * Stores a tuple of container ID, name and one component, as well as the assembly context of
     * the component.
     * 
     * @param containerId
    ...
    /**
     * Returns the container of this current component. FIXME: Also returns the FIRST container if
     * local mode is active, since no container has been (and can not be) chosen for this hardware
     * node.
     * 
     * @return
     */

...
public class PojoUsageScenario extends PojoClass<UsageScenario> {
  ...
  public Collection<? extends IJMethod> constructors() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("expRun = org.palladiosimulator.protocom.framework.experiment.ExperimentManager.getLatestExperimentRun();");
    _builder.newLine();
  ...
  public Collection<? extends IJMethod> methods() {
    ...
    StringConcatenation _builder = new StringConcatenation();
    PcmSimulationAction _pcmSimulationAction = new PcmSimulationAction();
    ScenarioBehaviour _scenarioBehaviour_UsageScenario = this.pcmEntity.getScenarioBehaviour_UsageScenario();
    ...
    String _userActions = _pcmSimulationAction.userActions(_get);

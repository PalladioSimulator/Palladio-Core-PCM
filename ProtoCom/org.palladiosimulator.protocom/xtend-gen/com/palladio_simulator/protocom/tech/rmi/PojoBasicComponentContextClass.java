...
public class PojoBasicComponentContextClass extends PojoClass<BasicComponent> {
  ...
  public Collection<? extends IJMethod> constructors() {
    ...
    StringConcatenation _builder_1 = new StringConcatenation();
    {
      ...
      final Function1<RequiredRole,OperationRequiredRole> _function_3 = new Function1<RequiredRole,OperationRequiredRole>() {
        public OperationRequiredRole apply(final RequiredRole it) {
          return ((OperationRequiredRole) it);
        }
      };
      Iterable<OperationRequiredRole> _map_1 = IterableExtensions.<RequiredRole, OperationRequiredRole>map(_filter_1, _function_3);

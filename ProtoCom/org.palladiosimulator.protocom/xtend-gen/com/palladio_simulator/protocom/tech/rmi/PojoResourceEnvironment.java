...
public class PojoResourceEnvironment extends ConceptMapping<ResourceEnvironment> implements IJClass {
  ...
  public String superClass() {
    return "com.palladio_simulator.protocom.framework.AbstractResourceEnvironment";
  }
  ...
  public Collection<? extends IJMethod> methods() {
    ...
    JMethod _withParameters = _withName.withParameters("String cpuStrategy, String hddStrategy, String calibrationPath, com.palladio_simulator.protocom.resourcestrategies.activeresource.DegreeOfAccuracyEnum accuracy");
    JMethod _withStaticModifier = _withParameters.withStaticModifier();
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("String idContainer = com.palladio_simulator.protocom.framework.AbstractAllocationStorage.getActiveContainer();");
    _builder.newLine();
    {

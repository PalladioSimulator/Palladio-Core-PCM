 ...
 * 
 * Note that this is the lowest entry point, since Usage Model itself is
 * neither an Entity, nor a Named Entity.
 * 
 * @author Thomas Zolynski
 */
class XUsageScenario extends PcmRepresentative<UsageScenario> {

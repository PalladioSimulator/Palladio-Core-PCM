 ...
 * 
 * Sebastian: All bindings where currently copied from the link below
 * to establish xtext 2.5.3 compatibility (we came from 2.4.0). We should
 * investigate what's the optimal way to resolve these bindings.
 * 
 * TODO See comment by Sebastian.
 * 
 * @see http://git.eclipse.org/c/tmf/org.eclipse.xtext.git/plain/plugins/org.eclipse.xtext.ui.shared/src/org/eclipse/xtext/ui/shared/internal/SharedModule.java

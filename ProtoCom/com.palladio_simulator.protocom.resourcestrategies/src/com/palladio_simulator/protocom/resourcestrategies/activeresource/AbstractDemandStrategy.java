package com.palladio_simulator.protocom.resourcestrategies.activeresource;
...
public abstract class AbstractDemandStrategy implements IDemandStrategy {
	 ...
	 * @see com.palladio_simulator.protocom.resourcestrategies.activeresource.IDemandStrategy#getStrategysResource()
	 */
	public abstract ResourceTypeEnum getStrategysResource();

	/**
	 * Template method to return the name of this strategy
	 * @see com.palladio_simulator.protocom.resourcestrategies.activeresource.IDemandStrategy#getName()
	 */

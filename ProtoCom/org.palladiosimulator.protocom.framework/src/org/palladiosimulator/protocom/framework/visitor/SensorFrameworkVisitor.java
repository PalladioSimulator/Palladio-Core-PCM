...
public class SensorFrameworkVisitor implements ICallVisitor {
    ...
    public void preCallVisit(StackContext ctx, String callIdentifier) {
        if (sensors.get(callIdentifier) == null) {
            sensors.put(callIdentifier, org.palladiosimulator.protocom.framework.experiment.ExperimentManager
                    .createOrReuseTimeSpanSensor(callIdentifier));
        }
        startTimes.put(callIdentifier, org.palladiosimulator.protocom.framework.experiment.ExperimentManager
                .takeStartTimeForInnerMeasurement());
    }

    @Override
    public void postCallVisit(StackContext ctx, String callIdentifier) {
        org.palladiosimulator.protocom.framework.experiment.ExperimentManager.takeMeasurement(
                startTimes.get(callIdentifier),
                org.palladiosimulator.protocom.framework.experiment.ExperimentManager.getLatestExperimentRun(),
                sensors.get(callIdentifier));
    }

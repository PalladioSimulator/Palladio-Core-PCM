package de.uka.ipd.sdq.prototype.framework.experiment;
...
import de.uka.ipd.sdq.prototype.framework.registry.IRmiRegistry;
...
public class ExperimentManager extends UnicastRemoteObject implements IExperimentManager, Serializable {
	...
	public static void init(String experimentName, String directory, int remoteType) {
		...
		if (remoteType == EXPERIMENT_MANAGER_SLAVE) {
			IRmiRegistry registry = (IRmiRegistry) de.uka.ipd.sdq.prototype.framework.registry.RmiRegistry.lookup(IRmiRegistry.PCM_EXPERIMENT_MANAGER_REGISTRY);
			try {

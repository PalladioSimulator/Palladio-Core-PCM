    ...
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      for(final ParametricResourceDemand resourceDemand : _resourceDemand_Action) {
        ...
        _builder.newLine();
        {
          ...
          if (_matches) {
            _builder.append("\t");
            _builder.append("com.palladio_simulator.protocom.framework.strategies.DemandConsumerStrategiesRegistry.singleton().getStrategyFor(com.palladio_simulator.protocom.resourcestrategies.activeresource.ResourceTypeEnum.CPU).consume(demand);");
            _builder.newLine();
          } else {
            ...
            if (_matches_1) {
              _builder.append("\t");
              _builder.append("com.palladio_simulator.protocom.framework.strategies.DemandConsumerStrategiesRegistry.singleton().getStrategyFor(com.palladio_simulator.protocom.resourcestrategies.activeresource.ResourceTypeEnum.HDD).consume(demand);");
              _builder.newLine();
            } else {
              ...
              if (_matches_2) {
                _builder.append("\t");
                _builder.append("com.palladio_simulator.protocom.framework.AbstractResourceEnvironment.performDelay(demand);");
                _builder.newLine();
              } else {
                _builder.append("\t");

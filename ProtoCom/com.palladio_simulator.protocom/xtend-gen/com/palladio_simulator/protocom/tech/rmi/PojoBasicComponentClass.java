    ...
    LinkedList<JMethod> _xblockexpression = null;
    {
      ...
      final Function1<ServiceEffectSpecification,JMethod> _function = new Function1<ServiceEffectSpecification,JMethod>() {
          public JMethod apply(final ServiceEffectSpecification it) {
            ...
            String _actions = PcmActions.actions(_get);
      ...
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("String ip = com.palladio_simulator.protocom.framework.registry.RmiRegistry.getIpFromArguments(args);");
      _builder.newLine();
      _builder.append("int port = com.palladio_simulator.protocom.framework.registry.RmiRegistry.getPortFromArguments(args);");
      _builder.newLine();
      _builder.newLine();
      _builder.append("String assemblyContext = com.palladio_simulator.protocom.framework.AbstractMain.getAssemblyContextFromArguments(args);");
      _builder.newLine();
      _builder.newLine();
      _builder.append("com.palladio_simulator.protocom.framework.registry.RmiRegistry.setRemoteAddress(ip);");
      _builder.newLine();
      _builder.append("com.palladio_simulator.protocom.framework.registry.RmiRegistry.setRegistryPort(port);");
      _builder.newLine();
      _builder.newLine();
      _builder.append("new ");

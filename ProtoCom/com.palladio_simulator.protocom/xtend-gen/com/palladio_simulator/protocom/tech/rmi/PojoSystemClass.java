...
public class PojoSystemClass extends PojoComposedStructureClass<de.uka.ipd.sdq.pcm.system.System> {
  ...
  public Collection<? extends IJMethod> methods() {
    LinkedList<IJMethod> _xblockexpression = null;
    {
      ...
      _builder_1.append("String ip = com.palladio_simulator.protocom.framework.registry.RmiRegistry.getIpFromArguments(args);");
      _builder_1.newLine();
      _builder_1.append("int port = com.palladio_simulator.protocom.framework.registry.RmiRegistry.getPortFromArguments(args);");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("String assemblyContext = com.palladio_simulator.protocom.framework.AbstractMain.getAssemblyContextFromArguments(args);");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("com.palladio_simulator.protocom.framework.registry.RmiRegistry.setRemoteAddress(ip);");
      _builder_1.newLine();
      _builder_1.append("com.palladio_simulator.protocom.framework.registry.RmiRegistry.setRegistryPort(port);");
      _builder_1.newLine();
      _builder_1.newLine();

...
public class MarkovUsageModelVisitor extends UsagemodelSwitch<MarkovChain> {
	 ...
	 *            transformation
	 */
	public MarkovUsageModelVisitor(final PCMInformationProvider pcmInfoProvider,
	...
	public MarkovChain caseEntryLevelSystemCall(
		...
		if (contextWrapper == null) {
			contextWrapper = new ContextWrapper(entryLevelSystemCall, pcmInfoProvider.getModel());
		} else {
		...
		if (seff == null) {
			...
			MarkovSeffVisitor seffVisitor = new MarkovSeffVisitor(this.pcmInfoProvider,
					contextWrapper, optimize);

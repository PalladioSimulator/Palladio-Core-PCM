 ...
 * <ul>
 *   <li>{@link LqnCore.impl.ActivityPhasesTypeImpl#getCallList <em>Call List</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityPhasesTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityPhasesTypeImpl#getSynchCall <em>Synch Call</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityPhasesTypeImpl#getAsynchCall <em>Asynch Call</em>}</li>
 *   <li>{@link LqnCore.impl.ActivityPhasesTypeImpl#getPhase <em>Phase</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityPhasesTypeImpl extends ActivityDefBaseImpl implements ActivityPhasesType {
	...
	protected EClass eStaticClass() {
		return LqnCorePackage.Literals.ACTIVITY_PHASES_TYPE;
	}
	...
	public EList<CallListType> getCallList() {
		if (callList == null) {
			callList = new EObjectContainmentEList<CallListType>(CallListType.class, this, LqnCorePackage.ACTIVITY_PHASES_TYPE__CALL_LIST);
		}
		return callList;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, LqnCorePackage.ACTIVITY_PHASES_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<ActivityMakingCallType> getSynchCall() {
		return getGroup().list(LqnCorePackage.Literals.ACTIVITY_PHASES_TYPE__SYNCH_CALL);
	}
	...
	public EList<ActivityMakingCallType> getAsynchCall() {
		return getGroup().list(LqnCorePackage.Literals.ACTIVITY_PHASES_TYPE__ASYNCH_CALL);
	}
	...
	public void setPhase(BigInteger newPhase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.ACTIVITY_PHASES_TYPE__PHASE, oldPhase, phase));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case LqnCorePackage.ACTIVITY_PHASES_TYPE__SYNCH_CALL:
				return ((InternalEList<?>)getSynchCall()).basicRemove(otherEnd, msgs);
			case LqnCorePackage.ACTIVITY_PHASES_TYPE__ASYNCH_CALL:

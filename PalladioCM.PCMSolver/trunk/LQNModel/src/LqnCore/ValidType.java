...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Valid Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see LqnCore.LqnCorePackage#getValidType()
...
public enum ValidType implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>Valid Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public static ValidType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ValidType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static ValidType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ValidType(int value, String name, String literal) {
		this.value = value;
		this.name = name;

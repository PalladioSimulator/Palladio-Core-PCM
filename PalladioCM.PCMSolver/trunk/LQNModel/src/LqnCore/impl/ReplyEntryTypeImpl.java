...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Reply Entry Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link LqnCore.impl.ReplyEntryTypeImpl#getReplyActivity <em>Reply Activity</em>}</li>
 *   <li>{@link LqnCore.impl.ReplyEntryTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReplyEntryTypeImpl extends EObjectImpl implements ReplyEntryType {
	...
	protected EClass eStaticClass() {
		return LqnCorePackage.Literals.REPLY_ENTRY_TYPE;
	}
	...
	public EList<ReplyActivityType> getReplyActivity() {
		if (replyActivity == null) {
			replyActivity = new EObjectContainmentEList<ReplyActivityType>(ReplyActivityType.class, this, LqnCorePackage.REPLY_ENTRY_TYPE__REPLY_ACTIVITY);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.REPLY_ENTRY_TYPE__NAME, oldName, name));
	}

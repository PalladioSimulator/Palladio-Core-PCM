...
/**
 * This is the item provider adapter for a {@link LqnCore.AndJoinListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AndJoinListTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AndJoinListType_quorum_feature", "_UI_AndJoinListType_type"),
				 LqnCorePackage.Literals.AND_JOIN_LIST_TYPE__QUORUM,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LqnCorePackage.Literals.AND_JOIN_LIST_TYPE__ACTIVITY);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AndJoinListType_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LqnCorePackage.Literals.AND_JOIN_LIST_TYPE__ACTIVITY,

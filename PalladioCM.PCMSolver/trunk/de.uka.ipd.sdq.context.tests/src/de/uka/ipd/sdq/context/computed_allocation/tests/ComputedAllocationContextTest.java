 ...
 * @generated
 */
public class ComputedAllocationContextTest extends TestCase {
	 ...
	 * @generated
	 */
	protected ComputedAllocationContext fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(ComputedAllocationContextTest.class);
	}
	 ...
	 * @generated
	 */
	public ComputedAllocationContextTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(ComputedAllocationContext fixture) {
	 ...
	 * @generated
	 */
	private ComputedAllocationContext getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(ComputedAllocationFactory.eINSTANCE.createComputedAllocationContext());
	}

 ...
 * @generated
 */
public class Actual_AllocationSwitch {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public Actual_AllocationSwitch() {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Actual_AllocationPackage.ACTUAL_ALLOCATION_CONTEXT: {
				ActualAllocationContext actualAllocationContext = (ActualAllocationContext)theEObject;
				Object result = caseActualAllocationContext(actualAllocationContext);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Actual_AllocationPackage.ACTUAL_RESOURCE_DEMAND: {
			...
			case Actual_AllocationPackage.ACTUAL_ALLOCATION: {

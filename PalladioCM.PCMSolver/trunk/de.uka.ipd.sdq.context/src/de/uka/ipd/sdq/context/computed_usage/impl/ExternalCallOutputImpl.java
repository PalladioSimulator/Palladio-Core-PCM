...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>External Call Output</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.ExternalCallOutputImpl#getParameterCharacterisations_ExternalCallOutput <em>Parameter Characterisations External Call Output</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.ExternalCallOutputImpl#getExternalCallAction_ExternalCallOutput <em>External Call Action External Call Output</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExternalCallOutputImpl extends EObjectImpl implements ExternalCallOutput {
	...
	/**
	 * The cached value of the '{@link #getParameterCharacterisations_ExternalCallOutput() <em>Parameter Characterisations External Call Output</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList parameterCharacterisations_ExternalCallOutput;

	/**
	 * The cached value of the '{@link #getExternalCallAction_ExternalCallOutput() <em>External Call Action External Call Output</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public EList getParameterCharacterisations_ExternalCallOutput() {
		if (parameterCharacterisations_ExternalCallOutput == null) {
			parameterCharacterisations_ExternalCallOutput = new EObjectContainmentEList(VariableUsage.class, this, ComputedUsagePackage.EXTERNAL_CALL_OUTPUT__PARAMETER_CHARACTERISATIONS_EXTERNAL_CALL_OUTPUT);
		}
		...
		if (externalCallAction_ExternalCallOutput != null && externalCallAction_ExternalCallOutput.eIsProxy()) {
			...
			if (externalCallAction_ExternalCallOutput != oldExternalCallAction_ExternalCallOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComputedUsagePackage.EXTERNAL_CALL_OUTPUT__EXTERNAL_CALL_ACTION_EXTERNAL_CALL_OUTPUT, oldExternalCallAction_ExternalCallOutput, externalCallAction_ExternalCallOutput));
			}
		}
	...
	public void setExternalCallAction_ExternalCallOutput(ExternalCallAction newExternalCallAction_ExternalCallOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComputedUsagePackage.EXTERNAL_CALL_OUTPUT__EXTERNAL_CALL_ACTION_EXTERNAL_CALL_OUTPUT, oldExternalCallAction_ExternalCallOutput, externalCallAction_ExternalCallOutput));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ComputedUsagePackage.EXTERNAL_CALL_OUTPUT__EXTERNAL_CALL_ACTION_EXTERNAL_CALL_OUTPUT:
				if (resolve) return getExternalCallAction_ExternalCallOutput();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ComputedUsagePackage.EXTERNAL_CALL_OUTPUT__PARAMETER_CHARACTERISATIONS_EXTERNAL_CALL_OUTPUT:
				...
				getParameterCharacterisations_ExternalCallOutput().addAll((Collection)newValue);
				return;
			case ComputedUsagePackage.EXTERNAL_CALL_OUTPUT__EXTERNAL_CALL_ACTION_EXTERNAL_CALL_OUTPUT:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case ComputedUsagePackage.EXTERNAL_CALL_OUTPUT__PARAMETER_CHARACTERISATIONS_EXTERNAL_CALL_OUTPUT:
				return parameterCharacterisations_ExternalCallOutput != null && !parameterCharacterisations_ExternalCallOutput.isEmpty();
			case ComputedUsagePackage.EXTERNAL_CALL_OUTPUT__EXTERNAL_CALL_ACTION_EXTERNAL_CALL_OUTPUT:

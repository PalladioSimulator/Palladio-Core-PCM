 ...
 *
 */
public class MarshallingConnectorCompletionBuilder extends AbstractClientServerConnectorCompletionBuilder {

    public MarshallingConnectorCompletionBuilder(PCMAndCompletionModelHolder models, AssemblyConnector connector,
    ...
    protected IMiddlewareInteractingComponentBuilder createClientSideBuilder() {
        return new MarshallingComponentBuilder(myModels, this.connectorToReplace.getRequiredRole_AssemblyConnector()
                ...
                this.middlewareInterface, fromResourceContainer, MarshallingComponentBuilder.MarshallerSide.CLIENT);
    }
    ...
    protected IMiddlewareInteractingComponentBuilder createServerSideBuilder() {
        return new MarshallingComponentBuilder(myModels, this.connectorToReplace.getRequiredRole_AssemblyConnector()
                .getRequiredInterface__OperationRequiredRole(), this.connectorToReplace
                .getRequiredRole_AssemblyConnector().getRequiredInterface__OperationRequiredRole(),
                this.middlewareInterface, toResourceContainer, MarshallingComponentBuilder.MarshallerSide.SERVER);
    }
}

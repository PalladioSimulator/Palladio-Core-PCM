...
public class DelayInnerConnectorCompletionBuilder extends AbstractClientServerConnectorCompletionBuilder {
    ...
    public DelayInnerConnectorCompletionBuilder(PCMAndCompletionModelHolder models, AssemblyConnector connector,
            ResourceContainer fromResourceContainer, ResourceContainer toResourceContainer,
            IComponentBuilder innerBuilder, String delaySpec) {
        super(models, connector, fromResourceContainer, toResourceContainer, innerBuilder,
                "DelayInnerConnectorCompletion");
        if (delaySpec == null)
    ...
    protected IMiddlewareInteractingComponentBuilder createClientSideBuilder() {
        return new DelayMiddlewareComponentBuilder(myModels, this.connectorToReplace
                ...
                this.fromResourceContainer, delaySpec);
    }
    ...
    protected IMiddlewareInteractingComponentBuilder createServerSideBuilder() {
        return new DelayMiddlewareComponentBuilder(myModels, this.connectorToReplace
                ...
                this.connectorToReplace.getRequiredRole_AssemblyConnector()
                        .getRequiredInterface__OperationRequiredRole(), this.middlewareInterface,
                this.toResourceContainer, delaySpec);
    }
}

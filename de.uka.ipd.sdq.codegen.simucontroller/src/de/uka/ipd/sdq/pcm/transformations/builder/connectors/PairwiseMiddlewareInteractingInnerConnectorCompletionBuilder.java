...
/**
 * Implementation of an InnerConnectorCompletionBuilder which calls a process service on the client side,
 * forwards the message, calls deprocess on the server side, and does the same in reverse order for the
 * reply
 * @author Snowball
 *
 */
public class PairwiseMiddlewareInteractingInnerConnectorCompletionBuilder

...
public class SimuComConfigurationTab extends AbstractLaunchConfigurationTab {
    ...
    public void createControl(Composite parent) {
        ...
        /*
         * This part makes sure that only the Rerun Simulation simulator or the simucom simulator are available
         * depending on the chosen simulation. Rerun Simulation doesn't work for the SimuBench, SimuCom Simulation
         * doesn't work for the Rerun Simulation
         */

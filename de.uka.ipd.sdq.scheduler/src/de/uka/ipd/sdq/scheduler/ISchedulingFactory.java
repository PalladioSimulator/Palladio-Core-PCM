...
public interface ISchedulingFactory {
    ...
    // HDDParameterConfig hddParameterConfig);
    ...
    // public abstract IActiveResource createActiveResource(ActiveResourceConfiguration
    // configuration);

    // public abstract IPassiveResource createPassiveResource(PassiveResourceConfiguration
    // configuration);

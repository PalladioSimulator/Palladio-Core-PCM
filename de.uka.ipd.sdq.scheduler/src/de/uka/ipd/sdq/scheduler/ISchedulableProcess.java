...
public interface ISchedulableProcess extends IEntity {
    ...
    /**
     * Notifies the process to resume its execution. Is only called if the process has been
     * passivated before.
     */
    ...
    /**
     * Returns the root process that spawned this processes (directly or indirectly). The root
     * process is used to create this process' scheduling meta-data. The root process has to point
     * to itself.
     * 

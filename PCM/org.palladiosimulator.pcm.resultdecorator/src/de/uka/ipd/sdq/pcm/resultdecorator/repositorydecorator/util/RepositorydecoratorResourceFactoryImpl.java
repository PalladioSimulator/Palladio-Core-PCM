 ...
 * <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.pcm.resultdecorator.repositorydecorator.util.RepositorydecoratorResourceImpl
 * @generated
 */
public class RepositorydecoratorResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Resource createResource(URI uri) {
		XMLResource result = new RepositorydecoratorResourceImpl(uri);

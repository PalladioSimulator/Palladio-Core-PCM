 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.pcm.resourcetype.CommunicationLinkResourceType#getNetworkInducedFailureType__CommunicationLinkResourceType
...
public interface CommunicationLinkResourceType extends ResourceType {
    ...
    /**
     * Returns the value of the '<em><b>Network Induced Failure Type Communication Link Resource
     ...
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Network Induced Failure Type Communication Link Resource
     *         Type</em>' reference.
     ...
     *
     * @param value
     *            the new value of the ' <em>Network Induced Failure Type Communication Link
     *            Resource Type</em>' reference.

...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Required Infrastructure
 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.pcm.core.composition.RequiredInfrastructureDelegationConnector#getInnerRequiredRole__RequiredInfrastructureDelegationConnector
 * <em>Inner Required Role Required Infrastructure Delegation Connector</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.core.composition.RequiredInfrastructureDelegationConnector#getOuterRequiredRole__RequiredInfrastructureDelegationConnector
 * <em>Outer Required Role Required Infrastructure Delegation Connector</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.core.composition.RequiredInfrastructureDelegationConnector#getAssemblyContext__RequiredInfrastructureDelegationConnector
...
public interface RequiredInfrastructureDelegationConnector extends DelegationConnector {
    ...
    /**
     * Returns the value of the '<em><b>Inner Required Role Required Infrastructure Delegation
     * Connector</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the ' <em>Inner Required Role Required Infrastructure Delegation
     * Connector</em>' reference isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Inner Required Role Required Infrastructure Delegation
     ...
     *
     * @param value
     *            the new value of the ' <em>Inner Required Role Required Infrastructure Delegation
     *            Connector</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Outer Required Role Required Infrastructure Delegation
     * Connector</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the ' <em>Outer Required Role Required Infrastructure Delegation
     * Connector</em>' reference isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Outer Required Role Required Infrastructure Delegation
     *         Connector</em>' reference.
     ...
     *
     * @param value
     *            the new value of the ' <em>Outer Required Role Required Infrastructure Delegation
     *            Connector</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Assembly Context Required Infrastructure Delegation
     * Connector</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     ...
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Assembly Context Required Infrastructure Delegation
     *         Connector</em>' reference.
     ...
     *
     * @param value
     *            the new value of the ' <em>Assembly Context Required Infrastructure Delegation
     *            Connector</em>' reference.

...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Internal Failure Occurrence
 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.pcm.reliability.InternalFailureOccurrenceDescription#getInternalAction__InternalFailureOccurrenceDescription
 * <em>Internal Action Internal Failure Occurrence Description</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.reliability.InternalFailureOccurrenceDescription#getSoftwareInducedFailureType__InternalFailureOccurrenceDescription
...
public interface InternalFailureOccurrenceDescription extends FailureOccurrenceDescription {
    ...
    /**
     * Returns the value of the '<em><b>Internal Action Internal Failure Occurrence
     * Description</b></em>' container reference. It is bidirectional and its opposite is
     ...
     *
     * @param value
     *            the new value of the ' <em>Internal Action Internal Failure Occurrence
     *            Description</em>' container reference.
    ...
    /**
     * Returns the value of the ' <em><b>Software Induced Failure Type Internal Failure Occurrence
     * Description</b></em>' reference. It is bidirectional and its opposite is '
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the ' <em>Software Induced Failure Type Internal Failure Occurrence
     * Description</em>' reference isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     * @return the value of the ' <em>Software Induced Failure Type Internal Failure Occurrence
     *         Description</em>' reference.
     ...
     *
     * @param value
     *            the new value of the '<em>Software Induced Failure Type Internal Failure
     *            Occurrence Description</em>' reference.
     ...
     * @model annotation= "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot body='not
     *        self.softwareInducedFailureType__InternalFailureOccurrenceDescription.oclIsTypeOf(ResourceTimeoutFailureType)'"
     * @generated
     */

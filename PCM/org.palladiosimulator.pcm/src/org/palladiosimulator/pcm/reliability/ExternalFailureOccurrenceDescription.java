...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>External Failure Occurrence
 ...
 * any FailureType. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.pcm.reliability.ExternalFailureOccurrenceDescription#getSpecifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription
 * <em>Specified Reliability Annotation External Failure Occurrence Description</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.reliability.ExternalFailureOccurrenceDescription#getFailureType__ExternalFailureOccurrenceDescription
...
public interface ExternalFailureOccurrenceDescription extends FailureOccurrenceDescription {
    ...
    /**
     * Returns the value of the ' <em><b>Specified Reliability Annotation External Failure
     * Occurrence Description</b></em>' container reference. It is bidirectional and its opposite is
     * '
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the ' <em>Specified Reliability Annotation External Failure Occurrence
     * Description</em>' container reference isn't clear, there really should be more of a
     * description here...
     * </p>
     * <!-- end-user-doc -->
     *
     * @return the value of the ' <em>Specified Reliability Annotation External Failure Occurrence
     ...
     *
     * @param value
     *            the new value of the ' <em>Failure Type External Failure Occurrence
     ...
     *        self.failureType__ExternalFailureOccurrenceDescription.oclIsTypeOf(ResourceTimeoutFailureType)'"
     * @generated
     */

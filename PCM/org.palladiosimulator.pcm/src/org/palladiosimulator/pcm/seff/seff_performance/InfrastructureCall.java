 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.pcm.seff.seff_performance.InfrastructureCall#getSignature__InfrastructureCall
 * <em>Signature Infrastructure Call</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.seff.seff_performance.InfrastructureCall#getNumberOfCalls__InfrastructureCall
 * <em>Number Of Calls Infrastructure Call</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.seff.seff_performance.InfrastructureCall#getAction__InfrastructureCall
 * <em>Action Infrastructure Call</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.seff.seff_performance.InfrastructureCall#getRequiredRole__InfrastructureCall
...
public interface InfrastructureCall extends CallAction {
     ...
     *        body='signature__InfrastructureCall.infrastructureInterface__InfrastructureSignature =
     *        requiredRole__InfrastructureCall.requiredInterface__InfrastructureRequiredRole'"
     * @generated
     */
     ...
     *        entity.oclIsKindOf(pcm::core::entity::InterfaceRequiringEntity)).oclAsType(pcm::core::entity::InterfaceRequiringEntity).requiredRoles_InterfaceRequiringEntity->includes(self.requiredRole__InfrastructureCall)'"
     * @generated
     */
     ...
     *            The cache of context-specific information. <!-- end-model-doc -->
     * @model annotation= "http://www.eclipse.org/uml2/1.1.0/GenModel
     *        body='self.action__InfrastructureCall.infrastructureCall__Action->select(call |
     *        call.requiredRole__InfrastructureCall = self.requiredRole__InfrastructureCall and
     *        call.signature__InfrastructureCall=self.signature__InfrastructureCall)->size() = 1'"
     * @generated
     */

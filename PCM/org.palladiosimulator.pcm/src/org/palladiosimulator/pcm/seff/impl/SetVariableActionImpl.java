 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.SetVariableActionImpl#getLocalVariableUsages_SetVariableAction <em>Local Variable Usages Set Variable Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetVariableActionImpl extends AbstractInternalControlFlowActionImpl implements SetVariableAction {
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case SeffPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION:
            return !getLocalVariableUsages_SetVariableAction().isEmpty();
        }

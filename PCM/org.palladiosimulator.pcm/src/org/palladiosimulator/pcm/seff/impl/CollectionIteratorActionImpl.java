 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.CollectionIteratorActionImpl#getParameter_CollectionIteratorAction <em>Parameter Collection Iterator Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionIteratorActionImpl extends AbstractLoopActionImpl implements CollectionIteratorAction {
    ...
    public Parameter getParameter_CollectionIteratorAction() {
        return (Parameter) eDynamicGet(SeffPackage.COLLECTION_ITERATOR_ACTION__PARAMETER_COLLECTION_ITERATOR_ACTION,
    ...
    public void setParameter_CollectionIteratorAction(Parameter newParameter_CollectionIteratorAction) {
        eDynamicSet(SeffPackage.COLLECTION_ITERATOR_ACTION__PARAMETER_COLLECTION_ITERATOR_ACTION,
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case SeffPackage.COLLECTION_ITERATOR_ACTION__PARAMETER_COLLECTION_ITERATOR_ACTION:
            return basicGetParameter_CollectionIteratorAction() != null;
        }

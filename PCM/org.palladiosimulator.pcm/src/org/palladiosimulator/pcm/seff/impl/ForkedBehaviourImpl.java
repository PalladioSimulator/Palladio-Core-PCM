 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.ForkedBehaviourImpl#getSynchronisationPoint_ForkedBehaviour <em>Synchronisation Point Forked Behaviour</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.ForkedBehaviourImpl#getForkAction_ForkedBehaivour <em>Fork Action Forked Behaivour</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForkedBehaviourImpl extends ResourceDemandingBehaviourImpl implements ForkedBehaviour {
    ...
    public SynchronisationPoint getSynchronisationPoint_ForkedBehaviour() {
        return (SynchronisationPoint) eDynamicGet(SeffPackage.FORKED_BEHAVIOUR__SYNCHRONISATION_POINT_FORKED_BEHAVIOUR,
    ...
    public void setSynchronisationPoint_ForkedBehaviour(SynchronisationPoint newSynchronisationPoint_ForkedBehaviour) {
        eDynamicSet(SeffPackage.FORKED_BEHAVIOUR__SYNCHRONISATION_POINT_FORKED_BEHAVIOUR,
    ...
    public ForkAction getForkAction_ForkedBehaivour() {
        return (ForkAction) eDynamicGet(SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR,
    ...
    public void setForkAction_ForkedBehaivour(ForkAction newForkAction_ForkedBehaivour) {
        eDynamicSet(SeffPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR,

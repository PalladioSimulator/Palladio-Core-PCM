...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Communication Link Resource
 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.CommunicationLinkResourceSpecification#getLinkingResource_CommunicationLinkResourceSpecification
 * <em>Linking Resource Communication Link Resource Specification</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.CommunicationLinkResourceSpecification#getFailureProbability
 * <em>Failure Probability</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.CommunicationLinkResourceSpecification#getCommunicationLinkResourceType_CommunicationLinkResourceSpecification
 * <em>Communication Link Resource Type Communication Link Resource Specification</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.CommunicationLinkResourceSpecification#getLatency_CommunicationLinkResourceSpecification
 * <em>Latency Communication Link Resource Specification</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.CommunicationLinkResourceSpecification#getThroughput_CommunicationLinkResourceSpecification
...
public interface CommunicationLinkResourceSpecification extends Identifier {
    ...
    /**
     * Returns the value of the '<em><b>Linking Resource Communication Link Resource
     * Specification</b></em>' container reference. It is bidirectional and its opposite is
     ...
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Linking Resource Communication Link Resource
     *         Specification</em>' container reference.
     ...
     *
     * @param value
     *            the new value of the '<em>Linking Resource Communication Link Resource
     *            Specification</em>' container reference.
    ...
    /**
     * Returns the value of the '<em><b>Communication Link Resource Type Communication Link Resource
     * Specification</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the ' <em>Communication Link Resource Type Communication Link Resource
     * Specification</em>' reference isn't clear, there really should be more of a description
     * here...
     * </p>
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Communication Link Resource Type Communication Link Resource
     *         Specification</em>' reference.
     ...
     *
     * @param value
     *            the new value of the '<em>Communication Link Resource Type Communication Link
    ...
    /**
     * Returns the value of the ' <em><b>Throughput Communication Link Resource
     * Specification</b></em>' containment reference. It is bidirectional and its opposite is '
     ...
     *
     * @param value
     *            the new value of the ' <em>Throughput Communication Link Resource

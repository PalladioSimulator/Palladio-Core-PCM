...
public class ResourceenvironmentSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        ...
        case ResourceenvironmentPackage.HDD_PROCESSING_RESOURCE_SPECIFICATION: {
            final HDDProcessingResourceSpecification hddProcessingResourceSpecification = (HDDProcessingResourceSpecification) theEObject;
            T result = this.caseHDDProcessingResourceSpecification(hddProcessingResourceSpecification);
            if (result == null) {
                result = this.caseProcessingResourceSpecification(hddProcessingResourceSpecification);
            }
            if (result == null) {
                result = this.caseIdentifier(hddProcessingResourceSpecification);
            }
            if (result == null) {
                result = this.defaultCase(theEObject);
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Resource
     * Container</em>'. <!-- begin-user-doc --> This implementation returns null; returning a
     * non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     ...
     * Resource Specification</em>'. <!-- begin-user-doc --> This implementation returns null;
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>HDD Processing Resource
     * Specification</em>'. <!-- begin-user-doc --> This implementation returns null; returning a
     * non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>HDD Processing Resource
     *         Specification</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseHDDProcessingResourceSpecification(final HDDProcessingResourceSpecification object) {
        return null;
    }

...
public class ResourceenvironmentAdapterFactory extends AdapterFactoryImpl {
	...
	protected ResourceenvironmentSwitch<Adapter> modelSwitch = new ResourceenvironmentSwitch<Adapter>() {
		...
		@Override
		public Adapter caseHDDProcessingResourceSpecification(HDDProcessingResourceSpecification object) {
			return createHDDProcessingResourceSpecificationAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.resourceenvironment.LinkingResource <em>Linking Resource</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.resourceenvironment.ProcessingResourceSpecification <em>Processing Resource Specification</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.resourceenvironment.CommunicationLinkResourceSpecification <em>Communication Link Resource Specification</em>}'.
	 * <!-- begin-user-doc --> This default
	         * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	         * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.resourceenvironment.HDDProcessingResourceSpecification <em>HDD Processing Resource Specification</em>}'.
	 * <!-- begin-user-doc -->

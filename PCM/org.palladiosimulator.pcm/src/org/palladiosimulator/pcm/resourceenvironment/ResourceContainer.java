 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.resourceenvironment.ResourceContainer#getActiveResourceSpecifications_ResourceContainer <em>Active Resource Specifications Resource Container</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.resourceenvironment.ResourceContainer#getResourceEnvironment_ResourceContainer <em>Resource Environment Resource Container</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.resourceenvironment.ResourceContainer#getNestedResourceContainers__ResourceContainer <em>Nested Resource Containers Resource Container</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.resourceenvironment.ResourceContainer#getParentResourceContainer__ResourceContainer <em>Parent Resource Container Resource Container</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.resourceenvironment.ResourceContainer#getHddResourceSpecifications <em>Hdd Resource Specifications</em>}</li>
 * </ul>
 *
...
public interface ResourceContainer extends Entity {
	 ...
	 * It is bidirectional and its opposite is '{@link org.palladiosimulator.pcm.resourceenvironment.ProcessingResourceSpecification#getResourceContainer_ProcessingResourceSpecification <em>Resource Container Processing Resource Specification</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * It is bidirectional and its opposite is '{@link org.palladiosimulator.pcm.resourceenvironment.ResourceEnvironment#getResourceContainer_ResourceEnvironment <em>Resource Container Resource Environment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.pcm.resourceenvironment.ResourceContainer#getResourceEnvironment_ResourceContainer <em>Resource Environment Resource Container</em>}' container reference.
	 * <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link org.palladiosimulator.pcm.resourceenvironment.ResourceContainer#getParentResourceContainer__ResourceContainer <em>Parent Resource Container Resource Container</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * It is bidirectional and its opposite is '{@link org.palladiosimulator.pcm.resourceenvironment.ResourceContainer#getNestedResourceContainers__ResourceContainer <em>Nested Resource Containers Resource Container</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * The list contents are of type {@link org.palladiosimulator.pcm.resourceenvironment.HDDProcessingResourceSpecification}.
	 * It is bidirectional and its opposite is '{@link org.palladiosimulator.pcm.resourceenvironment.HDDProcessingResourceSpecification#getResourceContainer <em>Resource Container</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Hdd Resource Specifications</em>' reference list isn't clear,

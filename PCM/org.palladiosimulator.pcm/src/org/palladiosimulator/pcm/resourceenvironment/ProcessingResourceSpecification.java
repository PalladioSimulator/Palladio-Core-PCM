 ...
 * <em>MTTF</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.ProcessingResourceSpecification#isRequiredByContainer
 * <em>Required By Container</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.ProcessingResourceSpecification#getSchedulingPolicy
 * <em>Scheduling Policy</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.ProcessingResourceSpecification#getActiveResourceType_ActiveResourceSpecification
 * <em>Active Resource Type Active Resource Specification</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.ProcessingResourceSpecification#getProcessingRate_ProcessingResourceSpecification
 * <em>Processing Rate Processing Resource Specification</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.ProcessingResourceSpecification#getNumberOfReplicas
 * <em>Number Of Replicas</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.resourceenvironment.ProcessingResourceSpecification#getResourceContainer_ProcessingResourceSpecification
...
public interface ProcessingResourceSpecification extends Identifier {
    ...
    /**
     * Returns the value of the '<em><b>Resource Container Processing Resource
     ...
     *
     * @param value
     *            the new value of the ' <em>Resource Container Processing Resource

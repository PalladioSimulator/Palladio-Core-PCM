...
public interface ResourceenvironmentPackage extends EPackage {
     ...
     * -->
     *
     * @return the meta object for the containment reference list ' <em>Linking Resources Resource
     *         Environment</em>'.
     ...
     * -->
     *
     * @return the meta object for the containment reference list ' <em>Resource Container Resource
     *         Environment</em>'.
     ...
     * -->
     *
     * @return the meta object for the container reference ' <em>Resource Environment Linking
     *         Resource</em>'.
     ...
     * -->
     *
     * @return the meta object for the container reference ' <em>Resource Environment Resource
     *         Container</em>'.
     ...
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the reference ' <em>Communication Link Resource Type
     *         Communication Link Resource Specification</em>'.
     ...
     * <em>HDD Processing Resource Specification</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *

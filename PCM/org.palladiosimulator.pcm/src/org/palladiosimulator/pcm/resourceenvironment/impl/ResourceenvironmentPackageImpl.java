...
public class ResourceenvironmentPackageImpl extends EPackageImpl implements ResourceenvironmentPackage {
    ...
    public EReference getResourceContainer_HddResourceSpecifications() {
        return (EReference) this.resourceContainerEClass.getEStructuralFeatures().get(4);
    }
    ...
    public EClass getHDDProcessingResourceSpecification() {
        return this.hddProcessingResourceSpecificationEClass;
    }
    ...
    public EReference getHDDProcessingResourceSpecification_WriteProcessingRate() {
        return (EReference) this.hddProcessingResourceSpecificationEClass.getEStructuralFeatures().get(0);
    }
    ...
    public EReference getHDDProcessingResourceSpecification_ReadProcessingRate() {
        return (EReference) this.hddProcessingResourceSpecificationEClass.getEStructuralFeatures().get(1);
    }
    ...
    public EReference getHDDProcessingResourceSpecification_ResourceContainer() {
        return (EReference) this.hddProcessingResourceSpecificationEClass.getEStructuralFeatures().get(2);
    }
    ...
    public void createPackageContents() {
        ...
        this.createEReference(this.resourceContainerEClass, RESOURCE_CONTAINER__HDD_RESOURCE_SPECIFICATIONS);
        ...
        this.hddProcessingResourceSpecificationEClass = this.createEClass(HDD_PROCESSING_RESOURCE_SPECIFICATION);
        this.createEReference(this.hddProcessingResourceSpecificationEClass,
    ...
    public void initializePackageContents() {
        ...
        this.hddProcessingResourceSpecificationEClass.getESuperTypes().add(this.getProcessingResourceSpecification());
        ...
        this.initEReference(this.getResourceContainer_ParentResourceContainer__ResourceContainer(),
                ...
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        this.initEReference(this.getResourceContainer_HddResourceSpecifications(),
                this.getHDDProcessingResourceSpecification(),
        ...
        this.initEClass(this.hddProcessingResourceSpecificationEClass, HDDProcessingResourceSpecification.class,
                "HDDProcessingResourceSpecification", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        this.initEReference(this.getHDDProcessingResourceSpecification_WriteProcessingRate(),
                ...
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getHDDProcessingResourceSpecification_ReadProcessingRate(),
                theCorePackage.getPCMRandomVariable(), null, "readProcessingRate", null, 1, 1,
                HDDProcessingResourceSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getHDDProcessingResourceSpecification_ResourceContainer(), this.getResourceContainer(),

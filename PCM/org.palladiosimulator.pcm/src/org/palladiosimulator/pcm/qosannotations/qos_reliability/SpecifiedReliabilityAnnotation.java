...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Specified Reliability
 * Annotation</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> A SpecifiedFailureProbability of a service resembles its "Probability of
 * Failure on Demand" (POFOD). Whenever the service is called, this values states the probability
 * that it returns successfully. For reliability prediction, the PCMRandomVariable specified in its
 * superclass SpecifiedQoSAnnotation must evaluate to a real number between 0 and 1.
 *
 *
 * <!-- end-model-doc -->
 *
 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.pcm.qosannotations.qos_reliability.SpecifiedReliabilityAnnotation#getExternalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation
...
public interface SpecifiedReliabilityAnnotation extends SpecifiedQoSAnnotation {
    ...
    /**
     * Returns the value of the ' <em><b>External Failure Occurrence Descriptions Specified
     * Reliability Annotation</b></em>' containment reference list. The list contents are of type
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the ' <em>External Failure Occurrence Descriptions Specified Reliability
     * Annotation</em>' containment reference list isn't clear, there really should be more of a
     * description here...
     * </p>
     * <!-- end-user-doc -->
     *
     * @return the value of the ' <em>External Failure Occurrence Descriptions Specified Reliability
     *         Annotation</em>' containment reference list.
     ...
     *        body='(self.role_SpecifiedQoSAnnotation.oclIsTypeOf(pcm::repository::OperationRequiredRole))
     *        and
     *        (self.role_SpecifiedQoSAnnotation.oclAsType(pcm::repository::OperationRequiredRole).requiringEntity_RequiredRole.oclIsTypeOf(pcm::system::System))\r\n\r\n\r\n'"
     * @generated
     */
     ...
     *            The cache of context-specific information. <!-- end-model-doc -->
     * @model annotation= "http://www.eclipse.org/uml2/1.1.0/GenModel
     *        body='self.externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation->forAll(x:pcm::reliability::ExternalFailureOccurrenceDescription,y:pcm::reliability::ExternalFailureOccurrenceDescription
     *        | x<>y implies x.failureType__ExternalFailureOccurrenceDescription <>

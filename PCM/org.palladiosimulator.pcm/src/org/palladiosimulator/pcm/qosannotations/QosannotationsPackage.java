...
public interface QosannotationsPackage extends EPackage {
    ...
    /**
     * The feature id for the '<em><b>Specified Output Parameter Abstractions Qo
     * SAnnotations</b></em>' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     * @ordered
    ...
    /**
     * The feature id for the '<em><b>Expected External Outputs Specified Output Parameter
     * Abstraction</b></em>' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     * @ordered
     ...
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the containment reference list ' <em>Expected External Outputs
     *         Specified Output Parameter Abstraction</em>'.

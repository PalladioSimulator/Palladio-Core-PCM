 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.pcm.repository.OperationInterface#getSignatures__OperationInterface
...
public interface OperationInterface extends Interface {
     ...
     * @model annotation= "http://www.eclipse.org/uml2/1.1.0/GenModel body='-- full signature has to
     *        be unique \r\n-- (use of ocl-tupels) #\r\nlet sigs : Bag(\r\n\t-- parameters: Sequence
     *        of DataType, NOT name #\r\n\t-- exceptions have not to be considered
     *        #\r\n\tTuple(returnType : DataType, serviceName : String, parameters :
     *        Sequence(DataType) ) \r\n) = \r\nself.signatures__OperationInterface->collect(sig :
     *        OperationSignature |\r\n\tTuple{\r\n\t\treturnType : DataType =
     *        sig.returnType__OperationSignature,\r\n\t\tserviceName : String =
     *        sig.entityName,\r\n\t\tparameters : Sequence(DataType) =
     *        sig.parameters__OperationSignature.dataType__Parameter\r\n\t}\r\n)\r\nin\r\nsigs->isUnique(s|s)'"
     * @generated
     */

 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.repository.impl.RequiredCharacterisationImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.repository.impl.RequiredCharacterisationImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.repository.impl.RequiredCharacterisationImpl#getInterface_RequiredCharacterisation <em>Interface Required Characterisation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequiredCharacterisationImpl extends CDOObjectImpl implements RequiredCharacterisation {
    ...
    public VariableCharacterisationType getType() {
        return (VariableCharacterisationType) eDynamicGet(RepositoryPackage.REQUIRED_CHARACTERISATION__TYPE,
    ...
    public void setType(VariableCharacterisationType newType) {
        eDynamicSet(RepositoryPackage.REQUIRED_CHARACTERISATION__TYPE,
    ...
    public Parameter getParameter() {
        return (Parameter) eDynamicGet(RepositoryPackage.REQUIRED_CHARACTERISATION__PARAMETER,
    ...
    public void setParameter(Parameter newParameter) {
        eDynamicSet(RepositoryPackage.REQUIRED_CHARACTERISATION__PARAMETER,
    ...
    public Interface getInterface_RequiredCharacterisation() {
        return (Interface) eDynamicGet(RepositoryPackage.REQUIRED_CHARACTERISATION__INTERFACE_REQUIRED_CHARACTERISATION,
     ...
     * @generated
     */
    public NotificationChain basicSetInterface_RequiredCharacterisation(Interface newInterface_RequiredCharacterisation,
    ...
    public void setInterface_RequiredCharacterisation(Interface newInterface_RequiredCharacterisation) {
        eDynamicSet(RepositoryPackage.REQUIRED_CHARACTERISATION__INTERFACE_REQUIRED_CHARACTERISATION,

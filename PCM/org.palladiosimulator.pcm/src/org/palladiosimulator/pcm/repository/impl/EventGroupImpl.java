 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.repository.impl.EventGroupImpl#getEventTypes__EventGroup <em>Event Types Event Group</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventGroupImpl extends InterfaceImpl implements EventGroup {
    ...
    public EList<EventType> getEventTypes__EventGroup() {
        return (EList<EventType>) eDynamicGet(RepositoryPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP,
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case RepositoryPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP:
            return !getEventTypes__EventGroup().isEmpty();
        }

 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.repository.impl.InfrastructureInterfaceImpl#getInfrastructureSignatures__InfrastructureInterface <em>Infrastructure Signatures Infrastructure Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InfrastructureInterfaceImpl extends InterfaceImpl implements InfrastructureInterface {
    ...
    public EList<InfrastructureSignature> getInfrastructureSignatures__InfrastructureInterface() {
        return (EList<InfrastructureSignature>) eDynamicGet(
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case RepositoryPackage.INFRASTRUCTURE_INTERFACE__INFRASTRUCTURE_SIGNATURES_INFRASTRUCTURE_INTERFACE:
            return !getInfrastructureSignatures__InfrastructureInterface().isEmpty();
        }

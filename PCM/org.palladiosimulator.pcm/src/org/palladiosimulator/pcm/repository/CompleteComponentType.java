...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Complete Component
 * Type</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> Complete (Component) types abstract from the realisation of components.
 * They only contain provided and required roles omitting the components’ internal structure,
 * i.e., the service effect specifications or assemblies. Thus, complete types represent a black box
 * view on components. Leaving the implementation open allows for a higher flexibility of software
 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.pcm.repository.CompleteComponentType#getParentProvidesComponentTypes
...
public interface CompleteComponentType extends RepositoryComponent {
     ...
     * @param context
     *            The cache of context-specific information. <!-- end-model-doc -->
     * @model annotation= "http://www.eclipse.org/uml2/1.1.0/GenModel body='-- CompleteTypes
     *        provided Interfaces have to be a superset\r\n-- of ProvidesComponentType provided
     ...
     *        Bag(Interface) =\r\n--\tself.providedRoles->iterate(r : ProvidedRole; acc2 :
     *        Bag(Interface) = Bag{}
     ...
     *        --already Set/Bag\r\n--\t\t)\r\n--\t) in\r\n--\t-- Directly provided
     *        anchestorInterfaces need to be a superset of provided interfaces of Supertype

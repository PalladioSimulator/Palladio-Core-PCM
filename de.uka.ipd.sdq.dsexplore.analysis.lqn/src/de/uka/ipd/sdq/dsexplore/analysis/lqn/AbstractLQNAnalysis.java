...
public abstract class AbstractLQNAnalysis implements IAnalysis {
	...
	public IAnalysisResult retrieveLastResultsForCriterion(Criterion criterion) throws AnalysisFailedException{
		PCMInstance pcm = new PCMInstance((PCMResourceSetPartition)this.blackboard.getPartition(LoadPCMModelsIntoBlackboardJob.PCM_MODELS_PARTITION_ID));
		IAnalysisResult result = retrieveLQNSolverResults(pcm,criterion);
		return result;
	}
	...
	ILQNResult retrieveLQNSolverResults(PCMInstance pcm, Criterion criterion) throws AnalysisFailedException {

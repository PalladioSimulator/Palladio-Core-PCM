...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>External Call
 ...
 * <li>{@link org.palladiosimulator.pcm.seff.ExternalCallAction#getRole_ExternalService <em>Role
 * External Service</em>}</li>
 * <li>{@link org.palladiosimulator.pcm.seff.ExternalCallAction#getRetryCount <em>Retry
 * Count</em>}</li>
 * </ul>
 *
...
public interface ExternalCallAction extends AbstractAction, CallReturnAction, FailureHandlingEntity {
     ...
     * External Service</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     ...
     *        entity.oclIsKindOf(pcm::core::entity::InterfaceRequiringEntity)).oclAsType(pcm::core::entity::InterfaceRequiringEntity).requiredRoles_InterfaceRequiringEntity->includes(self.role_ExternalService)'"
     * @generated
     */

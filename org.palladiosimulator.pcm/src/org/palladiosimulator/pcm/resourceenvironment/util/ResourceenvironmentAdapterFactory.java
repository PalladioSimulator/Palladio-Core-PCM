...
public class ResourceenvironmentAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ResourceenvironmentSwitch<Adapter> modelSwitch = new ResourceenvironmentSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseHDDProcessingResourceSpecification(final HDDProcessingResourceSpecification object) {
     ...
     * Container</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
     * can easily ignore cases; it's useful to ignore a case when inheritance will catch all the
     * cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
     ...
     * <em>HDD Processing Resource Specification</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.

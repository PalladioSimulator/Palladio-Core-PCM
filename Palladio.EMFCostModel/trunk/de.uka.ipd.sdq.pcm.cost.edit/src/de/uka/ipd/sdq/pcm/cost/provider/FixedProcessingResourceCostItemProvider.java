		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FixedProcessingResourceCost_processingresourcespecification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FixedProcessingResourceCost_processingresourcespecification_feature", "_UI_FixedProcessingResourceCost_type"),
				 costPackage.Literals.FIXED_PROCESSING_RESOURCE_COST__PROCESSINGRESOURCESPECIFICATION,
				 true,
				 false,
				 true,
				 null,

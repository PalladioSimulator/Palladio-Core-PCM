...
public class CollectionDataTypeItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInnerDataType__CollectionDataTypePropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Inner Data Type Collection Data Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInnerDataType__CollectionDataTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollectionDataType_innerDataType__CollectionDataType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollectionDataType_innerDataType__CollectionDataType_feature", "_UI_CollectionDataType_type"),
				 RepositoryPackage.Literals.COLLECTION_DATA_TYPE__INNER_DATA_TYPE_COLLECTION_DATA_TYPE,
				 true,
				 false,
				 true,
				 null,

...
public class GuardedBranchTransitionItemProvider extends AbstractBranchTransitionItemProvider {
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/GuardedBranchTransition"));
    }
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_GuardedBranchTransition_type") : this

...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.pcm.seff.FailureOccurrenceDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FailureOccurrenceDescriptionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FailureOccurrenceDescription_failureProbability_feature", "_UI_FailureOccurrenceDescription_type"),
				 SeffPackage.Literals.FAILURE_OCCURRENCE_DESCRIPTION__FAILURE_PROBABILITY,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Failure Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFailureTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FailureOccurrenceDescription_failureType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FailureOccurrenceDescription_failureType_feature", "_UI_FailureOccurrenceDescription_type"),
				 SeffPackage.Literals.FAILURE_OCCURRENCE_DESCRIPTION__FAILURE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_FailureOccurrenceDescription_type") + " " + failureOccurrenceDescription.getFailureProbability();
	}

...
public class InternalActionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SeffPackage.Literals.INTERNAL_ACTION__FAILURE_OCCURRENCE_DESCRIPTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SeffPackage.Literals.INTERNAL_ACTION__FAILURE_OCCURRENCE_DESCRIPTIONS,
				 SeffFactory.eINSTANCE.createFailureOccurrenceDescription()));
	}

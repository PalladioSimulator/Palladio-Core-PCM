 ...
 * @generated
 */
public class SinkDelegationConnectorItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInnerSinkRole__SinkDelegationConnectorPropertyDescriptor(object);
			addOuterSinkRole__SinkDelegationConnectorPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Inner Sink Role Sink Delegation Connector feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInnerSinkRole__SinkDelegationConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SinkDelegationConnector_innerSinkRole__SinkDelegationConnector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SinkDelegationConnector_innerSinkRole__SinkDelegationConnector_feature", "_UI_SinkDelegationConnector_type"),
				 CompositionPackage.Literals.SINK_DELEGATION_CONNECTOR__INNER_SINK_ROLE_SINK_DELEGATION_CONNECTOR,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Outer Sink Role Sink Delegation Connector feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOuterSinkRole__SinkDelegationConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SinkDelegationConnector_outerSinkRole__SinkDelegationConnector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SinkDelegationConnector_outerSinkRole__SinkDelegationConnector_feature", "_UI_SinkDelegationConnector_type"),
				 CompositionPackage.Literals.SINK_DELEGATION_CONNECTOR__OUTER_SINK_ROLE_SINK_DELEGATION_CONNECTOR,
				 true,
				 false,
				 true,
				 null,

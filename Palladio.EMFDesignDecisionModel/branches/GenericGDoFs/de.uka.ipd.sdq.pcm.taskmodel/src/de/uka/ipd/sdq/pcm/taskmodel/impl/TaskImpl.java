...
public class TaskImpl extends EObjectImpl implements Task {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case taskmodelPackage.TASK__PROBABILITY_OF_EXECUTION:
				return new Double(getProbabilityOfExecution());
			...
			case taskmodelPackage.TASK__MEAN_DEMANDED_TIME:
				return new Double(getMeanDemandedTime());
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case taskmodelPackage.TASK__PROBABILITY_OF_EXECUTION:
				setProbabilityOfExecution(((Double)newValue).doubleValue());
				return;
			case taskmodelPackage.TASK__FAILURE_PROBABILITY:
				setFailureProbability(((Double)newValue).doubleValue());
				return;
			case taskmodelPackage.TASK__MEAN_DEMANDED_TIME:
				setMeanDemandedTime(((Double)newValue).doubleValue());
				return;
			case taskmodelPackage.TASK__REPOSITORYCOMPONENT:

...
public class GDoFAdapterFactory extends AdapterFactoryImpl {
	...
	protected GDoFSwitch<Adapter> modelSwitch =
		new GDoFSwitch<Adapter>() {
			...
			@Override
			public Adapter caseGenericDegreeOfFreedom(GenericDegreeOfFreedom object) {
				return createGenericDegreeOfFreedomAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GDoFRepository <em>Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom <em>Generic Degree Of Freedom</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

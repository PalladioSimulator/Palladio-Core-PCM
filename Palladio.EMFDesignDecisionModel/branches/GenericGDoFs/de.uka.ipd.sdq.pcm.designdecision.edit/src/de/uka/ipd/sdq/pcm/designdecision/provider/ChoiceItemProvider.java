...
public class ChoiceItemProvider
	...
	protected void addDegreeOfFreedomPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Choice_degreeOfFreedom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Choice_degreeOfFreedom_feature", "_UI_Choice_type"),
				 designdecisionPackage.Literals.CHOICE__DEGREE_OF_FREEDOM,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Object labelValue = ((Choice)object).getValue();

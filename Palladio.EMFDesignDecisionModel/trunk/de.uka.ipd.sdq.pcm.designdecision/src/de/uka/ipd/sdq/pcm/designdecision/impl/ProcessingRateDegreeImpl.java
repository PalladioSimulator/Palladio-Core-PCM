 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.designdecision.impl.ProcessingRateDegreeImpl#getProcessingresourcetype <em>Processingresourcetype</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProcessingRateDegreeImpl extends ContinuousRangeDegreeImpl implements ProcessingRateDegree {
	/**
		...
		if (processingresourcetype != null && processingresourcetype.eIsProxy()) {
			...
			if (processingresourcetype != oldProcessingresourcetype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, designdecisionPackage.PROCESSING_RATE_DEGREE__PROCESSINGRESOURCETYPE, oldProcessingresourcetype, processingresourcetype));
			}
		}
	...
	public void setProcessingresourcetype(ProcessingResourceType newProcessingresourcetype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, designdecisionPackage.PROCESSING_RATE_DEGREE__PROCESSINGRESOURCETYPE, oldProcessingresourcetype, processingresourcetype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case designdecisionPackage.PROCESSING_RATE_DEGREE__PROCESSINGRESOURCETYPE:

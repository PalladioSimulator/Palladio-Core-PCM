...
public class ChoiceItemProvider
	...
	/**
	 * This adds a property descriptor for the Designdecision feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Choice_designdecision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Choice_designdecision_feature", "_UI_Choice_type"),
				 designdecisionPackage.Literals.CHOICE__DESIGNDECISION,
				 true,
				 false,
				 true,
				 null,

...
public interface taskmodelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int TASK__PROBABILITY_OF_EXECUTION = 0;
	 ...
	 * @ordered
	 */
	int TASK__FAILURE_PROBABILITY = 1;
	 ...
	 * @ordered
	 */
	int TASK__MEAN_DEMANDED_TIME = 2;
	 ...
	 * @ordered
	 */
	int TASK__REPOSITORYCOMPONENT = 3;

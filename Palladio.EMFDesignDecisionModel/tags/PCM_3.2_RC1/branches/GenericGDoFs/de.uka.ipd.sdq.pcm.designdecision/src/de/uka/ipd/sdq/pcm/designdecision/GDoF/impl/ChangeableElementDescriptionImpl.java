 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.ChangeableElementDescriptionImpl#getChangeableContainer <em>Changeable Container</em>}</li>
...
public class ChangeableElementDescriptionImpl extends EObjectImpl implements ChangeableElementDescription {
	/**
	 * The cached value of the '{@link #getChangeableContainer() <em>Changeable Container</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getChangeableContainer()
	 * @generated
	 * @ordered
	 */
	protected EClass changeableContainer;
	 ...
	 * @generated
	 */
	public EClass getChangeableContainer() {
		if (changeableContainer != null && changeableContainer.eIsProxy()) {
			InternalEObject oldChangeableContainer = (InternalEObject)changeableContainer;
			changeableContainer = (EClass)eResolveProxy(oldChangeableContainer);
			if (changeableContainer != oldChangeableContainer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GDoFPackage.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE_CONTAINER, oldChangeableContainer, changeableContainer));
			}
		}
		return changeableContainer;
	}
	 ...
	 * @generated
	 */
	public EClass basicGetChangeableContainer() {
		return changeableContainer;
	}
	 ...
	 * @generated
	 */
	public void setChangeableContainer(EClass newChangeableContainer) {
		EClass oldChangeableContainer = changeableContainer;
		changeableContainer = newChangeableContainer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GDoFPackage.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE_CONTAINER, oldChangeableContainer, changeableContainer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GDoFPackage.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE_CONTAINER:
				if (resolve) return getChangeableContainer();
				return basicGetChangeableContainer();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case GDoFPackage.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE_CONTAINER:
				setChangeableContainer((EClass)newValue);
				return;
			case GDoFPackage.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case GDoFPackage.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE_CONTAINER:
				setChangeableContainer((EClass)null);
				return;
			case GDoFPackage.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case GDoFPackage.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE_CONTAINER:
				return changeableContainer != null;
			case GDoFPackage.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE:

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.ChangeableElementDescription#getChangeableContainer <em>Changeable Container</em>}</li>
...
public interface ChangeableElementDescription extends EObject {
	/**
	 * Returns the value of the '<em><b>Changeable Container</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Changeable Container</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Changeable Container</em>' reference.
	 * @see #setChangeableContainer(EClass)
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.GDoFPackage#getChangeableElementDescription_ChangeableContainer()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	EClass getChangeableContainer();

	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.ChangeableElementDescription#getChangeableContainer <em>Changeable Container</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Changeable Container</em>' reference.
	 * @see #getChangeableContainer()
	 * @generated
	 */
	void setChangeableContainer(EClass value);
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Value Rule</em>' containment reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->

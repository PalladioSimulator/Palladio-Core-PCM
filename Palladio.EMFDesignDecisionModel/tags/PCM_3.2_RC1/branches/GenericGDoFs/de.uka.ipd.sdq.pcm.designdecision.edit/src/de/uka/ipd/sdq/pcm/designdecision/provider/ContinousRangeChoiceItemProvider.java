...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.pcm.designdecision.ContinousRangeChoice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContinousRangeChoiceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 designdecisionPackage.Literals.CONTINOUS_RANGE_CHOICE__CHOSEN_VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Object labelValue = ((ContinousRangeChoice)object).getValue();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ContinousRangeChoice_type") :
			getString("_UI_ContinousRangeChoice_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.pcm.designdecision.ContinuousRangeDegree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContinuousRangeDegreeItemProvider
	 ...
	 * @generated
	 */
	public ContinuousRangeDegreeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContinuousRangeDegree_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContinuousRangeDegree_to_feature", "_UI_ContinuousRangeDegree_type"),
				 designdecisionPackage.Literals.CONTINUOUS_RANGE_DEGREE__TO,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ContinuousRangeDegree_from_feature", "_UI_ContinuousRangeDegree_type"),
				 designdecisionPackage.Literals.CONTINUOUS_RANGE_DEGREE__FROM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,

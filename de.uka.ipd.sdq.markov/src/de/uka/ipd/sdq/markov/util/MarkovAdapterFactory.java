...
public class MarkovAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MarkovSwitch<Adapter> modelSwitch =
		new MarkovSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.markov.Label <em>Label</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

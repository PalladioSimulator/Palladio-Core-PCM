...
public class TransitionImpl extends EntityImpl implements Transition {
    ...
    public void setProbability(double newProbability) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MarkovPackage.TRANSITION__PROBABILITY,
    ...
    public State getFromState() {
        if (fromState != null && fromState.eIsProxy()) {
            ...
            if (fromState != oldFromState) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, MarkovPackage.TRANSITION__FROM_STATE,
    ...
    public void setFromState(State newFromState) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MarkovPackage.TRANSITION__FROM_STATE, oldFromState,
                    fromState));
    }
    ...
    public State getToState() {
        if (toState != null && toState.eIsProxy()) {
            ...
            if (toState != oldToState) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, MarkovPackage.TRANSITION__TO_STATE,
                            oldToState, toState));
            }
        }
        return toState;
    ...
    public void setToState(State newToState) {
        ...
        toState = newToState;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MarkovPackage.TRANSITION__TO_STATE, oldToState,
                    toState));
    }

 ...
 */
public class CMultipleConditionTestsEstimator extends AbstractQVTOEstimator {
	/** Name of the criterion which is estimated. */
	public static final String CRITERION_NAME = "CMultipleConditionTests";
	...
	protected AbstractEstimateQVTO createEstimateJob() {
		return new EstimateCMultipleConditionTests();
	}

 ...
 * {@link de.fzi.se.quality.parameters.pcm.PCMInfrastructureOperationReference} object. <!--
...
public class PCMInfrastructureOperationReferenceItemProvider extends OperationReferenceItemProvider {
    ...
    protected void addRolePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMInfrastructureOperationReference_role_feature"), this.getString(
                        "_UI_PropertyDescriptor_description", "_UI_PCMInfrastructureOperationReference_role_feature",
    ...
    protected void addSignaturePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_PCMInfrastructureOperationReference_signature_feature"), this.getString(

...
/**
 * This is the item provider adapter for a {@link de.fzi.se.quality.parameters.ComponentInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentInstanceItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ParametersPackage.Literals.COMPONENT_INSTANCE__COMPONENT_REFERENCE);
			childrenFeatures.add(ParametersPackage.Literals.COMPONENT_INSTANCE__PARAMETER_INSTANCES);
		}
	...
	public String getText(Object object) {
		String label = ((ComponentInstance)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ParametersPackage.Literals.COMPONENT_INSTANCE__COMPONENT_REFERENCE,
				 PCMFactory.eINSTANCE.createPCMComponentReference()));

		newChildDescriptors.add
			(createChildParameter
				(ParametersPackage.Literals.COMPONENT_INSTANCE__PARAMETER_INSTANCES,

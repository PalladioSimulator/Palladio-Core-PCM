 ...
 * @generated
 */
public class PCMRequiredBusinessOperationReturnParameterReferenceItemProvider extends PCMParameterReferenceItemProvider {
    ...
    protected void addRequiredRolePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMRequiredBusinessOperationReturnParameterReference_requiredRole_feature"), this
    ...
    protected void addSignaturePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_PCMRequiredBusinessOperationReturnParameterReference_signature_feature"), this
                .getString("_UI_PropertyDescriptor_description",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this
                .getString("_UI_PCMRequiredBusinessOperationReturnParameterReference_type") : this

...
/**
 * This is the item provider adapter for a {@link de.fzi.se.quality.qualityannotation.PCMRECategory}
...
public class PCMRECategoryItemProvider extends PCMREItemProvider {
    ...
    protected void addCategoryPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMRECategory_category_feature"), this.getString(
                        "_UI_PropertyDescriptor_description", "_UI_PCMRECategory_category_feature",
                        "_UI_PCMRECategory_type"), QualityAnnotationPackage.Literals.PCMRE_CATEGORY__CATEGORY, true,
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_PCMRECategory_type") : this

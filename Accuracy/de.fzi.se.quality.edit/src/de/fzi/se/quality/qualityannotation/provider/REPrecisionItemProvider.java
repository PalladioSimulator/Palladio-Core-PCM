...
/**
 * This is the item provider adapter for a {@link de.fzi.se.quality.qualityannotation.REPrecision}
...
public class REPrecisionItemProvider extends IdentifierItemProvider {
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_REPrecision_type") : this

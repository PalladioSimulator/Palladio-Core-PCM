 ...
 * {@link de.fzi.se.quality.qualityannotation.PCMParameterPartition} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class PCMParameterPartitionItemProvider extends ParameterPartitionItemProvider {
     ...
     * @generated
     */
    public PCMParameterPartitionItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures
                    .add(QualityAnnotationPackage.Literals.PCM_PARAMETER_PARTITION__CHARACERISED_PARAMETER_PARTITIONS);
        }
    ...
    /**
     * This returns PCMParameterPartition.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/PCMParameterPartition"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((PCMParameterPartition) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_PCMParameterPartition_type") : this

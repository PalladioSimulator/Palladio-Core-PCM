 ...
 * {@link de.fzi.se.quality.qualityannotation.CharacterisedPCMParameterPartition} object. <!--
...
public class CharacterisedPCMParameterPartitionItemProvider extends IdentifierItemProvider {
    ...
    protected void addForCharacterisationPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_CharacterisedPCMParameterPartition_forCharacterisation_feature"), this.getString(
    ...
    protected void addQualifiedElementNamePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_CharacterisedPCMParameterPartition_qualifiedElementName_feature"), this.getString(
                        "_UI_PropertyDescriptor_description",

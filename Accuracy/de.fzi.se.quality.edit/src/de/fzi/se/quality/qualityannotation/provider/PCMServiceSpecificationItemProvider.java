 ...
 * {@link de.fzi.se.quality.qualityannotation.PCMServiceSpecification} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class PCMServiceSpecificationItemProvider extends ServiceSpecificationItemProvider {
    ...
    protected void addResourceDemandingSEFFPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMServiceSpecification_resourceDemandingSEFF_feature"), this
                .getString("_UI_PropertyDescriptor_description",
                                "_UI_PCMServiceSpecification_resourceDemandingSEFF_feature",
                                "_UI_PCMServiceSpecification_type"),
                        QualityAnnotationPackage.Literals.PCM_SERVICE_SPECIFICATION__RESOURCE_DEMANDING_SEFF, true, false,
                        true, null, null, null));
    }
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_PCMServiceSpecification_type") : this

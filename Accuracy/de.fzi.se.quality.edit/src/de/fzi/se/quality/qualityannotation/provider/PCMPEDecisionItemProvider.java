...
/**
 * This is the item provider adapter for a {@link de.fzi.se.quality.qualityannotation.PCMPEDecision}
...
public class PCMPEDecisionItemProvider extends PCMPEItemProvider {
    ...
    protected void addBranchActionPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMPEDecision_branchAction_feature"), this.getString(
                        "_UI_PropertyDescriptor_description", "_UI_PCMPEDecision_branchAction_feature",
                        "_UI_PCMPEDecision_type"), QualityAnnotationPackage.Literals.PCMPE_DECISION__BRANCH_ACTION,

 ...
 * {@link de.fzi.se.quality.qualityannotation.PCMRECIBehavior} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class PCMRECIBehaviorItemProvider extends PCMREItemProvider {
    ...
    protected void addInternalBehaviourPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMRECIBehavior_internalBehaviour_feature"), this.getString(
                        "_UI_PropertyDescriptor_description", "_UI_PCMRECIBehavior_internalBehaviour_feature",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_PCMRECIBehavior_type") : this

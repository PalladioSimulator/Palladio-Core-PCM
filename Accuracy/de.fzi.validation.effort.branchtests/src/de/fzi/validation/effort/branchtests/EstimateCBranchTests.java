...
/**
 * Validation effort estimation algorithm CBranchTest.
...
public class EstimateCBranchTests  extends AbstractEstimateQVTO {
	...
	protected void executeScript(IProgressMonitor monitor) throws JobFailedException, UserCanceledException {
		executeStep(monitor, new ModelLocation[] {targetBehaviour, resultModelLocation}, CBRANCHTEST_TRANSFORMATION_SCRIPT);
	}

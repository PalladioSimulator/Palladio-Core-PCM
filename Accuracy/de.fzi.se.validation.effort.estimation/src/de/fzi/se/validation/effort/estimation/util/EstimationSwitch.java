 ...
 * $Id$
 */
package de.fzi.se.validation.effort.estimation.util;
 ...
 * @generated
 */
public class EstimationSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EstimationPackage.EFFORT_ESTIMATION_RESULT: {
				EffortEstimationResult effortEstimationResult = (EffortEstimationResult)theEObject;
				T result = caseEffortEstimationResult(effortEstimationResult);

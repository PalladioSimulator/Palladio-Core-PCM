...
public interface QualityPackage extends EPackage {
     ...
     * @ordered
     */
    int QUALITY_REPOSITORY__PROFILEABLE_ELEMENT = IdentifierPackage.IDENTIFIER__PROFILEABLE_ELEMENT;
     ...
     * @ordered
     */
    int QUALITY_STATEMENT__PROFILEABLE_ELEMENT = IdentifierPackage.IDENTIFIER__PROFILEABLE_ELEMENT;

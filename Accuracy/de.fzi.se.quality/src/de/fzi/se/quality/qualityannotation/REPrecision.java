...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>RE Precision</b></em>'. <!--
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> Precision&nbsp;of specification on&nbsp;required element. <!--
 * end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.fzi.se.quality.qualityannotation.REPrecision#getDefaultPrecisionNumberOfCalls <em>
 * Default Precision Number Of Calls</em>}</li>
 * <li>{@link de.fzi.se.quality.qualityannotation.REPrecision#getDefaultPrecisionCallParameter <em>
 * Default Precision Call Parameter</em>}</li>
 * <li>{@link de.fzi.se.quality.qualityannotation.REPrecision#getRequiredElement <em>Required
 * Element</em>}</li>
 * </ul>
 * </p>
 *
...
public interface REPrecision extends Identifier {
    ...
    /**
     * Returns the value of the '<em><b>Default Precision Number Of Calls</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Default Precision Number Of Calls</em>' containment reference
    ...
    /**
     * Returns the value of the '<em><b>Default Precision Call Parameter</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Default Precision Call Parameter</em>' containment reference isn't
    ...
    /**
     * Returns the value of the '<em><b>Required Element</b></em>' container reference. It is
     * bidirectional and its opposite is '
     * {@link de.fzi.se.quality.qualityannotation.RequiredElement#getPrecision <em>Precision</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Required Element</em>' container reference isn't clear, there
     ...
     * <em>Required Element</em>}' container reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @param value
     *            the new value of the '<em>Required Element</em>' container reference.

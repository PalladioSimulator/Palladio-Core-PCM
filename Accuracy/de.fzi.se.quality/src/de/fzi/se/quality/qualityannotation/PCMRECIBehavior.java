...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>PCMRECI Behavior</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link de.fzi.se.quality.qualityannotation.PCMRECIBehavior#getInternalBehaviour <em>Internal Behaviour</em>}</li>
 * </ul>
 * </p>
 *
...
public interface PCMRECIBehavior extends PCMRE {
	/**
     * Returns the value of the '<em><b>Internal Behaviour</b></em>' reference.
     * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Internal Behaviour</em>' reference isn't clear,
	...
	/**
     * Sets the value of the '{@link de.fzi.se.quality.qualityannotation.PCMRECIBehavior#getInternalBehaviour <em>Internal Behaviour</em>}' reference.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @param value the new value of the '<em>Internal Behaviour</em>' reference.
     ...
     * @param context The cache of context-specific information.
     * <!-- end-model-doc -->
     * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.parentRE.childREs->select(pcmre | pcmre.oclAsType(PCMRECIBehavior).internalBehaviour = self.internalBehaviour)->size() = 1'"
     * @generated
     */

...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>PCMRE Resource Role</b></em>
 * '. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.fzi.se.quality.qualityannotation.PCMREResourceRole#getResourceRole <em>Resource
 * Role</em>}</li>
 * </ul>
 * </p>
 *
...
public interface PCMREResourceRole extends PCMRE {
    ...
    /**
     * Returns the value of the '<em><b>Resource Role</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Resource Role</em>' reference isn't clear, there really should be
     ...
     * @model annotation=
     *        "http://www.eclipse.org/uml2/1.1.0/GenModel body='self.childREs->select(pcmre | not pcmre.oclIsTypeOf(PCMREResourceSignature))->size() = 0'"
     * @generated
     */
    boolean NextLowerLevelMustConsistOfTypePCMREResourceSignature(DiagnosticChain diagnostics,
     ...
     *            The cache of context-specific information. <!-- end-model-doc -->
     * @model annotation=
     *        "http://www.eclipse.org/uml2/1.1.0/GenModel body='self.parentRE.childREs->select(pcmre | pcmre.oclAsType(PCMREResourceRole).resourceRequiredRole = self.resourceRequiredRole)->size() = 1'"
     * @generated
     */

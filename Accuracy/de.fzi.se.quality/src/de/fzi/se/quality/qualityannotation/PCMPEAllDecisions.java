...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>PCMPE All Decisions</b></em>'.
 * <!-- end-user-doc -->
 *
 *
...
public interface PCMPEAllDecisions extends PCMPE {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.childPEs->forAll(child | child.oclIsKindOf(PCMPEDecision))'"
	 * @generated
	 */

 ...
 * <ul>
 * <li>{@link de.fzi.se.quality.qualityannotation.impl.PCMRESignatureImpl#getSignature <em>Signature
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class PCMRESignatureImpl extends PCMREImpl implements PCMRESignature {
    ...
    public boolean ThisIsTheLowestComponentHierarchyLevel(final DiagnosticChain diagnostics,
        ...
        if (!EOCL_ENV.createQuery(THIS_IS_THE_LOWEST_COMPONENT_HIERARCHY_LEVEL__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
                this)) {
            if (diagnostics != null) {

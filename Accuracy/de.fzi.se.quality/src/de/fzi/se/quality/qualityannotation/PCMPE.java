...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>PCMPE</b></em>'. <!--
 * end-user-doc -->
 *
 *
...
public interface PCMPE extends ProbabilisticElement {
     ...
     * @model annotation=
     *        "http://www.eclipse.org/uml2/1.1.0/GenModel body='self.parentPE.oclIsUndefined() implies self.oclIsKindOf(PCMPEAllDecisions)'"
     * @generated
     */

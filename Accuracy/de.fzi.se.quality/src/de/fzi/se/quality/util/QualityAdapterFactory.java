...
public class QualityAdapterFactory extends AdapterFactoryImpl {
	...
	protected QualitySwitch<Adapter> modelSwitch =
		new QualitySwitch<Adapter>() {
			@Override
			public Adapter caseQualityRepository(QualityRepository object) {
				return createQualityRepositoryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.fzi.se.quality.QualityRepository <em>Repository</em>}'.
	 * <!-- begin-user-doc -->

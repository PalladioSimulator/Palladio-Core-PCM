...
public interface PCMPackage extends EPackage {
    ...
    interface Literals {
         ...
         * @generated
         */
        EReference PCM_INFRASTRUCTURE_OPERATION_REFERENCE__ROLE = eINSTANCE
         ...
         * @generated
         */
        EReference PCM_INFRASTRUCTURE_OPERATION_REFERENCE__SIGNATURE = eINSTANCE
         ...
         * @generated
         */
        EReference PCM_COMPONENT_PARAMETER_REFERENCE__VARIABLE_USAGE = eINSTANCE
         ...
         * @generated
         */
        EReference PCM_OPERATION_PARAMETER_REFERENCE__PARAMETER = eINSTANCE
                .getPCMOperationParameterReference_Parameter();

        /**
         * The meta object literal for the '
         * {@link de.fzi.se.quality.parameters.pcm.impl.PCMRequiredBusinessOperationReturnParameterReferenceImpl
         * <em>Required Business Operation Return Parameter Reference</em>}' class. <!--
         * begin-user-doc --> <!-- end-user-doc -->
         *
         * @see de.fzi.se.quality.parameters.pcm.impl.PCMRequiredBusinessOperationReturnParameterReferenceImpl
         * @see de.fzi.se.quality.parameters.pcm.impl.PCMPackageImpl#getPCMRequiredBusinessOperationReturnParameterReference()
         * @generated
         */
        EClass PCM_REQUIRED_BUSINESS_OPERATION_RETURN_PARAMETER_REFERENCE = eINSTANCE
         ...
         * @generated
         */
        EReference PCM_REQUIRED_BUSINESS_OPERATION_RETURN_PARAMETER_REFERENCE__REQUIRED_ROLE = eINSTANCE
         ...
         * @generated
         */
        EReference PCM_REQUIRED_BUSINESS_OPERATION_RETURN_PARAMETER_REFERENCE__SIGNATURE = eINSTANCE

 ...
 * <ul>
 *   <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getParameterReference <em>Parameter Reference</em>}</li>
 *   <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getInputCallInstance <em>Input Call Instance</em>}</li>
 *   <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getOutputCallInstance <em>Output Call Instance</em>}</li>
 *   <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getComponentInstance <em>Component Instance</em>}</li>
 *   <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getParameterValue <em>Parameter Value</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ParameterInstance extends Identifier {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Reference to the parameter. No reference if, and only if, the return value of an operation is addressed.
	 * <!-- end-model-doc -->
	...
	/**
	 * Sets the value of the '{@link de.fzi.se.quality.parameters.ParameterInstance#getParameterReference <em>Parameter Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Input Call Instance</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link de.fzi.se.quality.parameters.CallInstance#getInputParameterInstances <em>Input Parameter Instances</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Input Call Instance</em>' container reference isn't clear,
	...
	/**
	 * Sets the value of the '{@link de.fzi.se.quality.parameters.ParameterInstance#getInputCallInstance <em>Input Call Instance</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Input Call Instance</em>' container reference.
	...
	/**
	 * Returns the value of the '<em><b>Output Call Instance</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link de.fzi.se.quality.parameters.CallInstance#getOutputParameterInstances <em>Output Parameter Instances</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Output Call Instance</em>' container reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.fzi.se.quality.parameters.ParameterInstance#getOutputCallInstance <em>Output Call Instance</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Output Call Instance</em>' container reference.
	 ...
	 * It is bidirectional and its opposite is '{@link de.fzi.se.quality.parameters.ComponentInstance#getParameterInstances <em>Parameter Instances</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link de.fzi.se.quality.parameters.ParameterInstance#getComponentInstance <em>Component Instance</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.fzi.se.quality.parameters.ParameterValue#getParameterInstance <em>Parameter Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link de.fzi.se.quality.parameters.ParameterInstance#getParameterValue <em>Parameter Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

...
public class GraphAdapterFactory extends AdapterFactoryImpl {
	...
	protected GraphSwitch<Adapter> modelSwitch =
		new GraphSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTransitionProbability(TransitionProbability object) {
				return createTransitionProbabilityAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.fzi.se.controlflowdescription.graph.Graph <em>Graph</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.fzi.se.controlflowdescription.graph.Vertex <em>Vertex</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.fzi.se.controlflowdescription.graph.TransitionProbability <em>Transition Probability</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTransitionProbabilityAdapter() {
		return null;
	}

...
public class GraphFactoryImpl extends EFactoryImpl implements GraphFactory {
	...
	public static GraphFactory init() {
		try {
			GraphFactory theGraphFactory = (GraphFactory)EPackage.Registry.INSTANCE.getEFactory("http://se.fzi.de/ControlFlowDescription/Graph/0.6"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case GraphPackage.TRANSITION_PROBABILITY: return createTransitionProbability();
			default:
	...
	public TransitionProbability createTransitionProbability() {
		TransitionProbabilityImpl transitionProbability = new TransitionProbabilityImpl();

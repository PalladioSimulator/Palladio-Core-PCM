...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Internal Call</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.fzi.se.validation.testbased.trace.impl.InternalCallImpl#getCallInstance <em>Call Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InternalCallImpl extends TraceActionImpl implements InternalCall {
	/**
	...
	public NotificationChain basicSetCallInstance(CallInstance newCallInstance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TracePackage.INTERNAL_CALL__CALL_INSTANCE, oldCallInstance, newCallInstance);
	...
	public void setCallInstance(CallInstance newCallInstance) {
		if (newCallInstance != callInstance) {
			...
			if (callInstance != null)
				msgs = ((InternalEObject)callInstance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TracePackage.INTERNAL_CALL__CALL_INSTANCE, null, msgs);
			if (newCallInstance != null)
				msgs = ((InternalEObject)newCallInstance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TracePackage.INTERNAL_CALL__CALL_INSTANCE, null, msgs);
			msgs = basicSetCallInstance(newCallInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.INTERNAL_CALL__CALL_INSTANCE, newCallInstance, newCallInstance));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TracePackage.INTERNAL_CALL__CALL_INSTANCE:

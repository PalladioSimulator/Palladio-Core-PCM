...
/**Validation effort estimation algorithm CBranchTests.
 * IEstimator interface is needed so that this estimator can be called by 
 * the estimation job ({@link RunEstimationsJob}.
 * @author Martin Krogmann *
 */
public class CBranchTestsEstimator extends AbstractQVTOEstimator {
	/** Name of the criterion which is estimated. */
	public static final String CRITERION_NAME = "CBranchTests";
	...
	protected AbstractEstimateQVTO createEstimateJob() {
		return new EstimateCBranchTests();
	}

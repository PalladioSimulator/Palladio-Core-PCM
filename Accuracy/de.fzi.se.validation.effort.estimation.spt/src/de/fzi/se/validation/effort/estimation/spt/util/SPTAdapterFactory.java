...
public class SPTAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SPTSwitch<Adapter> modelSwitch =
		new SPTSwitch<Adapter>() {
			@Override
			public Adapter caseSPTEffortEstimationResult(SPTEffortEstimationResult object) {
				return createSPTEffortEstimationResultAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.fzi.se.validation.effort.estimation.spt.SPTEffortEstimationResult <em>Effort Estimation Result</em>}'.
	 * <!-- begin-user-doc -->

...
public class SPTSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SPTPackage.SPT_EFFORT_ESTIMATION_RESULT: {
				SPTEffortEstimationResult sptEffortEstimationResult = (SPTEffortEstimationResult)theEObject;
				T result = caseSPTEffortEstimationResult(sptEffortEstimationResult);
				if (result == null) result = caseEffortEstimationResult(sptEffortEstimationResult);
	 ...
	 * @generated
	 */
	public T caseSPTEffortEstimationResult(SPTEffortEstimationResult object) {
		return null;
	}

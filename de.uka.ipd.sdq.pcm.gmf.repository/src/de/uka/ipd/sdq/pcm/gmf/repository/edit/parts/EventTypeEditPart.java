...
import de.uka.ipd.sdq.pcm.gmf.repository.edit.policies.EventTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EventTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EventTypeItemSemanticEditPolicy());
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.EventType_3107,
                    getParserElement(), PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.repository.edit.parts.EventTypeEditPart.VISUAL_ID));
        }
        return parser;
    }
    ...
    protected IFigure createFigurePrim() {
        return new EventTypeHandlerNameFigure();
    }

    /**
     * @generated
     */
    public class EventTypeHandlerNameFigure extends WrappingLabel {

        /**
         * @generated
         */
        public EventTypeHandlerNameFigure() {
            this.setText("<...>");
        }

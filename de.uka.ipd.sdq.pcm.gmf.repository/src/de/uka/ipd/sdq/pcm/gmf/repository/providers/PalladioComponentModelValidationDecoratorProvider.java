...
public class PalladioComponentModelValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
     ...
     * @generated
     */
    private static final String MARKER_TYPE = PalladioComponentModelRepositoryDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$ //$NON-NLS-2$
    /**
     * @generated
     */
    ...
    public boolean provides(IOperation operation) {
        ...
        return view != null
                && RepositoryEditPart.MODEL_ID.equals(PalladioComponentModelVisualIDRegistry.getModelID(view));
    }
    ...
    public static class StatusDecorator extends AbstractDecorator {
        ...
        public StatusDecorator(IDecoratorTarget decoratorTarget) {
            ...
            try {
                ...
                PalladioComponentModelRepositoryDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
            }
        }

 ...
 * @generated
 */
public class OperationProvidedRoleLabelEditPart extends LabelEditPart implements ITextAwareEditPart {

    /**
     * @generated
     */
    public static final int VISUAL_ID = 6105;
    ...
    static {
        registerSnapBackPosition(
                PalladioComponentModelVisualIDRegistry
                        .getType(de.uka.ipd.sdq.pcm.gmf.repository.edit.parts.OperationProvidedRoleLabelEditPart.VISUAL_ID),
                new Point(0, 40));
    }
     ...
     * @generated
     */
    public OperationProvidedRoleLabelEditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new RepositoryEditPart.LinkLabelDragPolicy());
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(
                    PalladioComponentModelElementTypes.OperationProvidedRole_4105, getParserElement(),

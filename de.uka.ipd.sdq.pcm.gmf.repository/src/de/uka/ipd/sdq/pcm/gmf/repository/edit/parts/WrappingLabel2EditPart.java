...
public class WrappingLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public static final int VISUAL_ID = 6112;
    ...
    static {
        registerSnapBackPosition(
                PalladioComponentModelVisualIDRegistry
                        .getType(de.uka.ipd.sdq.pcm.gmf.repository.edit.parts.WrappingLabel2EditPart.VISUAL_ID),
                new Point(0, 40));
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(
                    PalladioComponentModelElementTypes.InfrastructureRequiredRole_4112, getParserElement(),

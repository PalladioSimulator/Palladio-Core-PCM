...
public class SchedulerAdapterFactory extends AdapterFactoryImpl {
	...
	protected SchedulerSwitch<Adapter> modelSwitch =
		new SchedulerSwitch<Adapter>() {
			@Override
			public Adapter caseResourceStrategyMeasurementTask(ResourceStrategyMeasurementTask object) {
			...
			@Override
			public Adapter caseResourceStrategyMeasurementAfterIoTask(ResourceStrategyMeasurementAfterIoTask object) {
				return createResourceStrategyMeasurementAfterIoTaskAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.measurements.scheduler.ResourceStrategyMeasurementTask <em>Resource Strategy Measurement Task</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.measurements.scheduler.ParallelProcessTask <em>Parallel Process Task</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.measurements.scheduler.ResourceStrategyMeasurementAfterIoTask <em>Resource Strategy Measurement After Io Task</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

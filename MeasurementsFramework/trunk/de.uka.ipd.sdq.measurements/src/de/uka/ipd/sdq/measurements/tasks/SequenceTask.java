 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.measurements.tasks.SequenceTask#getTasks <em>Tasks</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.measurements.tasks.TasksPackage#getSequenceTask()
 * @model
 * @generated
 */
public interface SequenceTask extends AbstractTask {
	 ...
	 * @see de.uka.ipd.sdq.measurements.tasks.TasksPackage#getSequenceTask_Tasks()

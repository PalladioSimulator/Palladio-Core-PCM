...
public class ProcessActionPrintVisitor extends SimucomstatusSwitch<String> {
	...
	/* (non-Javadoc)
	 * @see de.uka.ipd.sdq.simucomframework.simucomstatus.util.SimucomstatusSwitch#caseWaitForAcquire(de.uka.ipd.sdq.simucomframework.simucomstatus.WaitForAcquire)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.uka.ipd.sdq.simucomframework.simucomstatus.util.SimucomstatusSwitch#caseWaitForDelay(de.uka.ipd.sdq.simucomframework.simucomstatus.WaitForDelay)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.uka.ipd.sdq.simucomframework.simucomstatus.util.SimucomstatusSwitch#caseWaitForDemand(de.uka.ipd.sdq.simucomframework.simucomstatus.WaitForDemand)
	 */
	@Override

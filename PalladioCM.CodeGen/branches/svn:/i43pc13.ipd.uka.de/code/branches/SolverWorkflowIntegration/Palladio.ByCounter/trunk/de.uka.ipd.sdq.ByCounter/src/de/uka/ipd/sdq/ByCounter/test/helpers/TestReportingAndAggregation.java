...
//        	log.debug("really equals...");
    ...
    private void test() {
		...
		artefacts = this.myCollector.getCountingArtefactsByBeginning().values();
...
//		this.myCollector.getCountingInformationsByMethodname();
		...
		results = this.myCollector.getAllCountingResultsByArtefacts().values();
...
//    	log.debug("First caller artefacts time: "+callerTime);
		callerCounts_evaluated = this.myCollector.getCountingResultByStartTime_evaluateCallingTree(callerTime, false);

package evaluation.palladiofileshare.algorithms;
...
public class SimpleLZW {
	...
	public static boolean INLINED_VERBOSE = true;
...
//						+ convertIntArrayToString(compressed_int, " "));
	...
	*/
	...
	public void run_MK(){ //non-final, yet calling a static method
		...
		if(variant<0 || variant>uploadFiles.length){
	...
	private final void runCompression(Integer param) {
		...
		System.out.println("Compressing for option " + param + ", i.e. file "
		...
		try {
			...
			System.out.println((finish - start) + " ns to compute statistics");
			...
			System.out.println(nsDuration + " ns=" + usDuration + " us=" + msDuration

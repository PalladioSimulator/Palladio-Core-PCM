...
class ByCountsModel extends AbstractTableModel {
	...
	public static final CountingResultCollector crc = CountingResultCollector.getInstance();
...
//		/*255*/,"null"
  ...
  { 
    return this.opcodesInt.length;//or make a constant... 
  } 
...
public class CountingResultCollectorMonitor  implements Runnable{
	...
	public static void main(String args[]){
		System.out.println("Monitoring "+ByCountsModel.opcodesNumber+" opcodes");
	...
	public CountingResultCollectorMonitor(long sleepInMilliseconds){
		if(ByCountsModel.opcodesInt.length!=ByCountsModel.opcodesString.length){
			...
			System.out.println("NUmber of active opcode arrays: "+nrOfActiveOpcodes);
		}
	...
	public void run() {
		while(true && crc.isMonitorShouldStop()==false){
			...
			System.err.println(System.currentTimeMillis()+": "+crc.getInlined_countingResult());
		}

...
package deprecated.spec.benchmarks.compress;
...
public final class Harness {
    ...
    public void runCompress(int btid) {
        deprecated.spec.harness.Context.getOut().println("Loop count = " + LOOP_COUNT);
    ...
    static class Source {
        ...
        private static byte[] fillBuffer(String fileName) {
            try {
                ...
                if (counter != length) {
                    deprecated.spec.harness.Context.getOut().println(

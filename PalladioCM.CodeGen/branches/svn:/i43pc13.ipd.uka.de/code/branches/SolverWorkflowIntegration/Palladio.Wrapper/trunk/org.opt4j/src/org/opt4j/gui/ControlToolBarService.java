...
/**
 * The {@code ControlToolBarService} is a {@link ToolBarService} that allows to
 * {@link Control} the {@code Optimizer}.This service has an {@link Order} with
 * {@code -100}.
 * 
 * @see Control
 * @author lukasiewycz
...
public class ControlToolBarService implements ToolBarService {
	...
	/**
	 * Constructs a {@code ControlToolBarService}.
	 * 
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.opt4j.gui.ToolBarService#getToolBar()
	 */
	@Override

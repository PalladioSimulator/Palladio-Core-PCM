...
/**
 * The {@code CrossoverDoubleBLX} is an implementation of the blend crossover
...
public class CrossoverDoubleBLX extends CrossoverDoubleElementwise {
	...
	/**
	 * Constructs a {@code CrossoverDoubleBLX} with an alpha value and a a
	...
	/**
	 * Calculates a random value in the interval {@code

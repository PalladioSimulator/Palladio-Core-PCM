...
public class CoreFactoryImpl extends EFactoryImpl implements CoreFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CorePackage.REPLICATED_PROCESS: return createReplicatedProcess();
			...
			case CorePackage.VARIABLE_RESOURCE_USAGE: return createVariableResourceUsage();
			default:
	 ...
	 * @generated
	 */
	public ReplicatedProcess createReplicatedProcess() {
		ReplicatedProcessImpl replicatedProcess = new ReplicatedProcessImpl();
	 ...
	 * @generated
	 */
	public VariableResourceUsage createVariableResourceUsage() {
		VariableResourceUsageImpl variableResourceUsage = new VariableResourceUsageImpl();
		return variableResourceUsage;
	}

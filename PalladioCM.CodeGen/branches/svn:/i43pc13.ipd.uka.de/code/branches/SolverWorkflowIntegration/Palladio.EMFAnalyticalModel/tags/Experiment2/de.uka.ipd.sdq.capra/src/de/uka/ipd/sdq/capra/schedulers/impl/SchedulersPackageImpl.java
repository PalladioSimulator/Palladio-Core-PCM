...
public class SchedulersPackageImpl extends EPackageImpl implements SchedulersPackage {
	 ...
	 * @generated
	 */
	public EReference getTimeConsumption_Time() {
		return (EReference)timeConsumptionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getPriortyQuantums_Priority() {
		return (EReference)priortyQuantumsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getPriortyQuantums_NumberOfQuantums() {
		return (EReference)priortyQuantumsEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(timeConsumptionEClass, TIME_CONSUMPTION__TIME);
		...
		createEReference(priortyQuantumsEClass, PRIORTY_QUANTUMS__PRIORITY);
		createEReference(priortyQuantumsEClass, PRIORTY_QUANTUMS__NUMBER_OF_QUANTUMS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getScheduler_Name(), ecorePackage.getEString(), "name", "", 1, 1, Scheduler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScheduler_LoadBalancing(), this.getLoadBalancing(), "loadBalancing", null, 1, 1, Scheduler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTimeConsumption_Time(), ecorePackage.getEObject(), null, "time", null, 1, 1, TimeConsumption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeConsumption_Scaling(), this.getBigOClass(), "scaling", null, 1, 1, TimeConsumption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPriority_Preference(), this.getPreference(), "preference", null, 1, 1, Priority.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPriortyQuantums_Priority(), ecorePackage.getEObject(), null, "priority", null, 1, 1, PriortyQuantums.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPriortyQuantums_NumberOfQuantums(), ecorePackage.getEObject(), null, "numberOfQuantums", null, 1, 1, PriortyQuantums.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

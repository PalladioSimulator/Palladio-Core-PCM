...
public interface ExtensionPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ACQUIRE_ACTION__IDENTIFIER = CorePackage.EVENT_ACTION__IDENTIFIER;
	 ...
	 * @ordered
	 */
	int ACQUIRE_ACTION__NUMBER = CorePackage.EVENT_ACTION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ACQUIRE_ACTION__RESOURCE = CorePackage.EVENT_ACTION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ACQUIRE_ACTION_FEATURE_COUNT = CorePackage.EVENT_ACTION_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RELEASE_ACTION__IDENTIFIER = CorePackage.EVENT_ACTION__IDENTIFIER;
	 ...
	 * @ordered
	 */
	int RELEASE_ACTION__NUMBER = CorePackage.EVENT_ACTION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RELEASE_ACTION__RESOURCE = CorePackage.EVENT_ACTION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RELEASE_ACTION_FEATURE_COUNT = CorePackage.EVENT_ACTION_FEATURE_COUNT + 2;

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Time Span Sensor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.capra.measurement.impl.AbstractTimeSpanSensorImpl#getTimeSpanRecorders <em>Time Span Recorders</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.capra.measurement.impl.AbstractTimeSpanSensorImpl#getStopMeasurement <em>Stop Measurement</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.capra.measurement.impl.AbstractTimeSpanSensorImpl#getStartMeasurement <em>Start Measurement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class AbstractTimeSpanSensorImpl extends SensorImpl implements AbstractTimeSpanSensor {
	/**
	 ...
	 * @generated
	 */
	protected AbstractTimeSpanSensorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MeasurementPackage.Literals.ABSTRACT_TIME_SPAN_SENSOR;
	}
	...
	public EList<TimeSpanRecorder> getTimeSpanRecorders() {
		if (timeSpanRecorders == null) {
			timeSpanRecorders = new EObjectContainmentWithInverseEList<TimeSpanRecorder>(TimeSpanRecorder.class, this, MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__TIME_SPAN_RECORDERS, MeasurementPackage.TIME_SPAN_RECORDER__TIME_SPAN_SENSOR);
		}
		...
		if (stopMeasurement != null && stopMeasurement.eIsProxy()) {
			...
			if (stopMeasurement != oldStopMeasurement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__STOP_MEASUREMENT, oldStopMeasurement, stopMeasurement));
			}
		}
	...
	public NotificationChain basicSetStopMeasurement(TimeProbe newStopMeasurement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__STOP_MEASUREMENT, oldStopMeasurement, newStopMeasurement);
	...
	public void setStopMeasurement(TimeProbe newStopMeasurement) {
		if (newStopMeasurement != stopMeasurement) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__STOP_MEASUREMENT, newStopMeasurement, newStopMeasurement));
	}
	...
	public TimeProbe getStartMeasurement() {
		if (startMeasurement != null && startMeasurement.eIsProxy()) {
			...
			if (startMeasurement != oldStartMeasurement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__START_MEASUREMENT, oldStartMeasurement, startMeasurement));
			}
		}
	...
	public NotificationChain basicSetStartMeasurement(TimeProbe newStartMeasurement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__START_MEASUREMENT, oldStartMeasurement, newStartMeasurement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartMeasurement(TimeProbe newStartMeasurement) {
		if (newStartMeasurement != startMeasurement) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__START_MEASUREMENT, newStartMeasurement, newStartMeasurement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__TIME_SPAN_RECORDERS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTimeSpanRecorders()).basicAdd(otherEnd, msgs);
			case MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__STOP_MEASUREMENT:
				if (stopMeasurement != null)
					msgs = ((InternalEObject)stopMeasurement).eInverseRemove(this, MeasurementPackage.TIME_PROBE__SENSORS_TO_STOP, TimeProbe.class, msgs);
				return basicSetStopMeasurement((TimeProbe)otherEnd, msgs);
			case MeasurementPackage.ABSTRACT_TIME_SPAN_SENSOR__START_MEASUREMENT:
				if (startMeasurement != null)
					msgs = ((InternalEObject)startMeasurement).eInverseRemove(this, MeasurementPackage.TIME_PROBE__SENSORS_TO_START, TimeProbe.class, msgs);

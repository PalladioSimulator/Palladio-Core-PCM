	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case UsageScenarioEditPart.VISUAL_ID: {
			...
			PalladioComponentModelNavigatorGroup links = new PalladioComponentModelNavigatorGroup(
					Messages.NavigatorGroupName_UsageScenario_1000_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), ScenarioBehaviourEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					ClosedWorkloadEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					OpenWorkloadEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case ScenarioBehaviourEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(
					...
					ScenarioBehaviourScenarioBehaviourStepsCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					EntryLevelSystemCallEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(view),
		...
		case EntryLevelSystemCallEditPart.VISUAL_ID: {
			...
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view),
					EntryLevelSystemCallParameterUsageEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
		...
		case ScenarioBehaviour2EditPart.VISUAL_ID: {
			...
			Collection connectedViews = getChildrenByType(
					Collections.singleton(view),
					ScenarioBehaviourScenarioBehaviourStepsCompartment2EditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					StartEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));

 ...
 * @generated
 */
public class WrappingLabel4EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				PalladioComponentModelVisualIDRegistry
						.getType(de.uka.ipd.sdq.pcm.gmf.repository.edit.parts.WrappingLabel4EditPart.VISUAL_ID),
				new Point(0, 40));
	}

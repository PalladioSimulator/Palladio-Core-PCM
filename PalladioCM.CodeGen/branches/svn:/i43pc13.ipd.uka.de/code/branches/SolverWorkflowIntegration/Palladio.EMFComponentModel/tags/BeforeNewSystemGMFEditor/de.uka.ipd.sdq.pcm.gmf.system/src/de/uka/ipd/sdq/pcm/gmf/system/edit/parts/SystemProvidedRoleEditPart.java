 ...
 * @generated
 */
public class SystemProvidedRoleEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new SystemProvidedRoleGraphicalNodeEditPolicy());
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof SystemProvidedRoleEntityNameEditPart) {
			return true;
		}
		return false;
	}

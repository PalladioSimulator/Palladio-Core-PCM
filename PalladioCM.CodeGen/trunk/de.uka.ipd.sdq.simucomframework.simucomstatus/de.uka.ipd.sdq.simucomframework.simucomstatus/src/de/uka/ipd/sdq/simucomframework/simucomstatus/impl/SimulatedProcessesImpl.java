...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Simulated Processes</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.SimulatedProcessesImpl#getProcesses <em>Processes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimulatedProcessesImpl extends EObjectImpl implements SimulatedProcesses {
	...
	public EList<de.uka.ipd.sdq.simucomframework.simucomstatus.Process> getProcesses() {
		if (processes == null) {
			processes = new EObjectContainmentEList<de.uka.ipd.sdq.simucomframework.simucomstatus.Process>(de.uka.ipd.sdq.simucomframework.simucomstatus.Process.class, this, SimucomstatusPackage.SIMULATED_PROCESSES__PROCESSES);
		}
		return processes;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SimucomstatusPackage.SIMULATED_PROCESSES__PROCESSES:
				getProcesses().clear();
				getProcesses().addAll((Collection<? extends de.uka.ipd.sdq.simucomframework.simucomstatus.Process>)newValue);
				return;
		}

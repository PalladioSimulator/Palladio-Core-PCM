...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Wait For Demand</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.WaitForDemandImpl#getDemand <em>Demand</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.WaitForDemandImpl#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WaitForDemandImpl extends ActionImpl implements WaitForDemand {
	...
	public void setDemand(double newDemand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.WAIT_FOR_DEMAND__DEMAND, oldDemand, demand));
	}
	...
	public ActiveResouce getResource() {
		if (resource != null && resource.eIsProxy()) {
			...
			if (resource != oldResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimucomstatusPackage.WAIT_FOR_DEMAND__RESOURCE, oldResource, resource));
			}
		}
		return resource;
	}
	...
	public NotificationChain basicSetResource(ActiveResouce newResource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.WAIT_FOR_DEMAND__RESOURCE, oldResource, newResource);
	...
	public void setResource(ActiveResouce newResource) {
		if (newResource != resource) {
			...
			if (resource != null)
				msgs = ((InternalEObject)resource).eInverseRemove(this, SimucomstatusPackage.ACTIVE_RESOUCE__WAITING_DEMANDS, ActiveResouce.class, msgs);
			if (newResource != null)
				msgs = ((InternalEObject)newResource).eInverseAdd(this, SimucomstatusPackage.ACTIVE_RESOUCE__WAITING_DEMANDS, ActiveResouce.class, msgs);
			msgs = basicSetResource(newResource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.WAIT_FOR_DEMAND__RESOURCE, newResource, newResource));
	}

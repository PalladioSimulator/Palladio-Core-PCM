...
namespace Palladio.WebserverAnalyser.Interceptor
{
	...
	public class InterceptedWebserverFactory : IWebserverFactory
	{
		...
		{
			IDispatcher dispatcher = factory.CreateDispatcher(requestParser, webserverMonitor, webserverConfiguration, requestFactory);
		...
		{
			IHTTPRequestProcessor processor = factory.CreateBibTeXProvider(CorSuccessor,webserverMonitor, webserverConfiguration, requestProcessorTools);

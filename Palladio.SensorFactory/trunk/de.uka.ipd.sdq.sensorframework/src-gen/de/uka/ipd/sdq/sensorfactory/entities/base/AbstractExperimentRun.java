	...
	de.uka.ipd.sdq.sensorfactory.entities.ExperimentRun

		{
				...
				public AbstractExperimentRun(de.uka.ipd.sdq.sensorfactory.entities.dao.IDAOFactory myFactory) {
...
;
 ...
 value)
 {
	...
	@javax.persistence.JoinTable(name="ExperimentRun_measurements",
					joinColumns={@javax.persistence.JoinColumn(name="EXPERIMENTRUN_ID")},
					inverseJoinColumns={@javax.persistence.JoinColumn(name="MEASUREMENT_ID")})

	private java.util.Collection<
	de.uka.ipd.sdq.sensorfactory.entities.Measurement
> m_measurements 
...
,
 ...
 result = 
				myDAOFactory.createMeasurementDAO().addStateMeasurement(
	...
	de.uka.ipd.sdq.sensorfactory.entities.TimeSpanSensor
 p_sensor
...
,
	...
	)
 {
	...
	de.uka.ipd.sdq.sensorfactory.entities.TimeSpanMeasurement
 result = 
				myDAOFactory.createMeasurementDAO().addTimeSpanMeasurement(

	...
	de.uka.ipd.sdq.sensorfactory.entities.Experiment

		{
				...
				public AbstractExperiment(de.uka.ipd.sdq.sensorfactory.entities.dao.IDAOFactory myFactory) {
...
;
 ...
 value)
 {
	...
	@javax.persistence.JoinTable(name="Experiment_sensors",
					joinColumns={@javax.persistence.JoinColumn(name="EXPERIMENT_ID")},
					inverseJoinColumns={@javax.persistence.JoinColumn(name="SENSOR_ID")})
...
>(10000);
 ...
 result = 
				myDAOFactory.createSensorDAO().addStateSensor(
 ...
 result = 
				myDAOFactory.createSensorDAO().addTimeSpanSensor(
...
;
	...
	@javax.persistence.OneToMany(cascade=javax.persistence.CascadeType.ALL)
	@javax.persistence.JoinTable(name="Experiment_experimentRuns",
					joinColumns={@javax.persistence.JoinColumn(name="EXPERIMENT_ID")},
					inverseJoinColumns={@javax.persistence.JoinColumn(name="EXPERIMENTRUN_ID")})
...
>(10000);
	...
	)
 {
	...
	de.uka.ipd.sdq.sensorfactory.entities.ExperimentRun
 result = 
				myDAOFactory.createExperimentRunDAO().addExperimentRun(

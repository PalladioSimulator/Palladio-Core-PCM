...
public class TakeScheduledResourceDemandStrategy implements IProbeStrategy {
	 ...
	 */
	public BasicMeasurement<Double, Duration> takeSample(String probeId, Object... o) {
		Double demand = null;
		...
		Measure<Double, Duration> demandMeasure = Measure.valueOf(demand,
				SI.SECOND);
		BasicMeasurement<Double, Duration> sample = new BasicMeasurement<Double, Duration>(

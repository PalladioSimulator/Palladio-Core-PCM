...
public class OperationProvidedRoleEditPart extends BorderedBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OperationProvidedRoleItemSemanticEditPolicy());
	 ...
	 * This triggers the drawing of the ball figure
	 * 
	 * @generated not
	 */
	protected NodeFigure createNodePlate() {
		...
		BallFigure result = new BallFigure(getMapMode().DPtoLP(
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (targetEditPart instanceof de.uka.ipd.sdq.pcm.gmf.composite.edit.parts.OperationProvidedRoleEditPart) {
			types
					.add(PalladioComponentModelElementTypes.ProvidedDelegationConnector_4006);
		}

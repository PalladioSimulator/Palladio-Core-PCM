...
import de.uka.ipd.sdq.pcm.gmf.composite.edit.policies.EventChannelSinkConnectorItemSemanticEditPolicy;

/**
 * @generated
 */
public class EventChannelSinkConnectorEditPart extends ConnectionNodeEditPart
	 ...
	 * @generated
	 */
	public EventChannelSinkConnectorEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EventChannelSinkConnectorItemSemanticEditPolicy());
	}
	...
	protected Connection createConnectionFigure() {
		return new EventChannelSinkConnectorFigure();
	}

	/**
	 * @generated
	 */
	public EventChannelSinkConnectorFigure getPrimaryShape() {
		return (EventChannelSinkConnectorFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class EventChannelSinkConnectorFigure extends PolylineConnectionEx {
	...
	Color c=null;
	 if (resolveSemanticElement() instanceof EventChannelSinkConnector) 
	 {
		 ...
		 if ((con.getFilterCondition__EventChannelSinkConnector()!=null) &&
				 !(con.getFilterCondition__EventChannelSinkConnector().getSpecification().equalsIgnoreCase("TRUE"))){

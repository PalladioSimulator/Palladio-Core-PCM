...
/**
 * The Class OperationRequiredRoleCreateCommand.
 *
 * @generated
 */
public class OperationRequiredRoleCreateCommand extends EditElementCommand {
	...
	/**
	 * Instantiates a new operation required role create command.
	 *
	 * @param req the req
	 * @generated
	 */
	public OperationRequiredRoleCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		OperationRequiredRole newElement = RepositoryFactory.eINSTANCE

 ...
 * @generated
 */
public class EventChannelSinkConnectorReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public EventChannelSinkConnectorReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEventChannelSinkConnector_4010(container,
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		ComposedStructure container = (ComposedStructure) getLink()
				.eContainer();
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEventChannelSinkConnector_4010(container, source,
						getNewTarget());
	}

...
public class AssemblyInfrastructureConnectorCreateCommand extends
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		CreateRelationshipRequest req = (CreateRelationshipRequest) this
				.getRequest();
		newElement
				.setRequiringAssemblyContext__AssemblyInfrastructureConnector((AssemblyContext) req
						.getParameter("SOURCE_ASSEMBLY_CONTEXT"));
		newElement
				.setProvidingAssemblyContext__AssemblyInfrastructureConnector((AssemblyContext) req

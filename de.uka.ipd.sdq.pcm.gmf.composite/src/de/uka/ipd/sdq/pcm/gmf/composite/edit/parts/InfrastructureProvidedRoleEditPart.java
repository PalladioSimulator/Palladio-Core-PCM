...
public class InfrastructureProvidedRoleEditPart extends
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InfrastructureProvidedRoleItemSemanticEditPolicy());
	...
	public InfrastructureProvidedRoleFigure getPrimaryShape() {
		return (InfrastructureProvidedRoleFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof InfrastructureProvidedRoleEntityNameEditPart) {
	 ...
	 * 
	 * Manually modified to generate a specific source figure 
	 * instead of the standard shape configured in the map model.
	 * 
	 * @generated not
	 */
	protected NodeFigure createMainFigure() {
		InfrastructureProvidedRoleManualFigure figure = new InfrastructureProvidedRoleManualFigure(
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForSource(
		...
		if (relationshipType == PalladioComponentModelElementTypes.AssemblyInfrastructureConnector_4008) {
			types
					.add(PalladioComponentModelElementTypes.InfrastructureRequiredRole_3016);
		}
		return types;
	}
	...
	public class InfrastructureProvidedRoleFigure extends RectangleFigure {
		...
		public InfrastructureProvidedRoleFigure() {
			...
			this.setMinimumSize(new Dimension(getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(0)));
			this.setLocation(new Point(getMapMode().DPtoLP(40), getMapMode()
					.DPtoLP(40)));
		}

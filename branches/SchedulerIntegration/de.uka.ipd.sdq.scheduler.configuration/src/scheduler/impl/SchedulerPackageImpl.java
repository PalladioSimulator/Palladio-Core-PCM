...
public class SchedulerPackageImpl extends EPackageImpl implements SchedulerPackage {
	...
	public static SchedulerPackage init() {
		...
		SchedulerPackageImpl theSchedulerPackage = (SchedulerPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof SchedulerPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new SchedulerPackageImpl());

 ...
 * <ul>
 *   <li>{@link LqnCore.impl.OutputResultForwardingANDJoinDelayImpl#getResultConf95 <em>Result Conf95</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultForwardingANDJoinDelayImpl#getResultConf99 <em>Result Conf99</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultForwardingANDJoinDelayImpl#getDest <em>Dest</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultForwardingANDJoinDelayImpl#getJoinVariance <em>Join Variance</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultForwardingANDJoinDelayImpl#getJoinWaiting <em>Join Waiting</em>}</li>
 *   <li>{@link LqnCore.impl.OutputResultForwardingANDJoinDelayImpl#getWaiting <em>Waiting</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutputResultForwardingANDJoinDelayImpl extends EObjectImpl implements OutputResultForwardingANDJoinDelay {
	...
	public EList<ResultConf95Type> getResultConf95() {
		if (resultConf95 == null) {
			resultConf95 = new EObjectContainmentEList<ResultConf95Type>(ResultConf95Type.class, this, LqnCorePackage.OUTPUT_RESULT_FORWARDING_AND_JOIN_DELAY__RESULT_CONF95);
		}
		return resultConf95;
	}
	...
	public EList<ResultConf99Type> getResultConf99() {
		if (resultConf99 == null) {
			resultConf99 = new EObjectContainmentEList<ResultConf99Type>(ResultConf99Type.class, this, LqnCorePackage.OUTPUT_RESULT_FORWARDING_AND_JOIN_DELAY__RESULT_CONF99);
		}
		return resultConf99;
	}
	...
	public void setDest(String newDest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_FORWARDING_AND_JOIN_DELAY__DEST, oldDest, dest));
	}
	...
	public void setJoinVariance(Object newJoinVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_FORWARDING_AND_JOIN_DELAY__JOIN_VARIANCE, oldJoinVariance, joinVariance));
	}
	...
	public void setJoinWaiting(Object newJoinWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_FORWARDING_AND_JOIN_DELAY__JOIN_WAITING, oldJoinWaiting, joinWaiting));
	}
	...
	public void setWaiting(Object newWaiting) {
		...
		waiting = newWaiting;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.OUTPUT_RESULT_FORWARDING_AND_JOIN_DELAY__WAITING, oldWaiting, waiting));
	}

 ...
 * @generated
 */
public class AbstractUserActionSuccessorReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public AbstractUserActionSuccessorReorientCommand(
	...
	public boolean canExecute() {
		if (!(referenceOwner instanceof AbstractUserAction)) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistAbstractUserActionSuccessor_4002(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistAbstractUserActionSuccessor_4002(getOldSource(),
						getNewTarget());
	}

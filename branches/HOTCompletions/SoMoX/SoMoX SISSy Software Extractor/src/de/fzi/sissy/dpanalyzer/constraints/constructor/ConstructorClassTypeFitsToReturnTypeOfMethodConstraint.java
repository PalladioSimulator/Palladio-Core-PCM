...
public class ConstructorClassTypeFitsToReturnTypeOfMethodConstraint 
extends ConstructorConstraint implements IdentifierConstraint {

    public ConstructorClassTypeFitsToReturnTypeOfMethodConstraint(String check_object_identifier, String method_identifier) {
    ...
    public boolean evaluateByIdentifier(Object check_object, Object evaluation_object) {
        if ((check_object instanceof de.fzi.sissy.metamod.Constructor)&&(evaluation_object instanceof de.fzi.sissy.metamod.Method))
            return MetamodRetrievalEngineImplementation.typesAreFitting(
                    ...
                    (de.fzi.sissy.metamod.Type)MetamodRetrievalEngineImplementation.getSingleton().getContainerClassOfConstructor((de.fzi.sissy.metamod.Constructor)check_object));
        else
            return false;
    }

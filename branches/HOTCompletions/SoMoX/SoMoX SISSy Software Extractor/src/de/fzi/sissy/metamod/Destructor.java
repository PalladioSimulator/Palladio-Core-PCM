 ...
 *
 */
public class Destructor extends Function implements Member, Referenceable {
    /**
	 * @param name
	 * @param hasSource
	 */
    ...
    public boolean hasExplicitSuperAccess() {
		...
		while(itr.hasNext()) {
			...
			if (function instanceof Destructor)
				if (thisClass.extendsClass(((Destructor)function).getSurroundingClass())) 
					return true;
		}
	...
	/**
	 * Do not call this method directly. Use Class.addDestructor instead.
	 */
	...
	public void moveToClass(Class cls) {
		getSurroundingClass().simpleRemoveDestructor(this);
		setSurroundingClass(cls);
		cls.simpleAddDestructor(this);
	}
}

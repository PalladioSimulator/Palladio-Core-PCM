...
public class MethodIsAbstractConstraint extends MethodConstraint implements BooleanConstraint {
    ...
    public MethodIsAbstractConstraint(String check_object_identifier, boolean isTrue) {
    ...
    public boolean evaluateBoolean(Object check_object, boolean isTrue) {
        if (check_object instanceof de.fzi.sissy.metamod.Method)
            return MetamodRetrievalEngineImplementation.getSingleton().methodIsAbstract((de.fzi.sissy.metamod.Method)check_object, isTrue);
        else
            return false;
    }

 ...
 * @author phil
 */
public class ASTDoStatement extends ASTAbstractStatement implements IASTLoopStatement {

	//private IASTExpression cond = null;
	private IASTStatement body = null;
	
	public ASTDoStatement(IASTExpression condition, IASTStatement body) {
		//cond = condition;
		this.body = body;
	}
	
    public ASTDoStatement() {
    }

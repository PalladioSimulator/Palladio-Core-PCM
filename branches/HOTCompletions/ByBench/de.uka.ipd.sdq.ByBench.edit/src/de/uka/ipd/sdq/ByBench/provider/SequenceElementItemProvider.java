...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.ByBench.SequenceElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SequenceElement_successor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SequenceElement_successor_feature", "_UI_SequenceElement_type"),
				 ByBenchPackage.Literals.SEQUENCE_ELEMENT__SUCCESSOR,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((SequenceElement)object).getId();

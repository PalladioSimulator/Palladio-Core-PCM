 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.capra.core.impl.ReplicatedProcessImpl#getNumReplicas <em>Num Replicas</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.capra.core.impl.ReplicatedProcessImpl#getProcessvariable <em>Processvariable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReplicatedProcessImpl extends EObjectImpl implements ReplicatedProcess {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.REPLICATED_PROCESS;
	}
	...
	public void setNumReplicas(int newNumReplicas) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.REPLICATED_PROCESS__NUM_REPLICAS, oldNumReplicas, numReplicas));
	}
	...
	public NotificationChain basicSetProcessvariable(ProcessVariable newProcessvariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CorePackage.REPLICATED_PROCESS__PROCESSVARIABLE, oldProcessvariable, newProcessvariable);
	...
	public void setProcessvariable(ProcessVariable newProcessvariable) {
		if (newProcessvariable != processvariable) {
			...
			if (processvariable != null)
				msgs = ((InternalEObject)processvariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CorePackage.REPLICATED_PROCESS__PROCESSVARIABLE, null, msgs);
			if (newProcessvariable != null)
				msgs = ((InternalEObject)newProcessvariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CorePackage.REPLICATED_PROCESS__PROCESSVARIABLE, null, msgs);
			msgs = basicSetProcessvariable(newProcessvariable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.REPLICATED_PROCESS__PROCESSVARIABLE, newProcessvariable, newProcessvariable));
	}

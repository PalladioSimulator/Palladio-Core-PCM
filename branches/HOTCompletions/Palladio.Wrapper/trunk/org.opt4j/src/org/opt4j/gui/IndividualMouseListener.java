...
/**
 * Listener for mouse events on {@code Individuals}. By default this listener is
...
public interface IndividualMouseListener {
	...
	/**
	 * Invoked if an {@code Individual} is selected by a {@code popup} (usually
	...
	/**
	 * Invoked if an {@code Individual} is selected by a {@code double click}.
	 * 
	 * @param individual
	 *            the selected individual
	 * @param component

...
/**
 * The {@code MutateDoublePolynomial}.
 * 
 * @author lukasiewycz
 * 
 */
public class MutateDoublePolynomial extends MutateDoubleElementwise {
	...
	/**
	 * Constructs a {@code MutateDoubleGauss} with a {@code MutationRate}, a
	 * {@code Random} number generator, a {@code DoubleNormalizeOPerator}, and
	 * an eta value.
	 * 
	 * @param mutationRate
	 *            the mutation rate

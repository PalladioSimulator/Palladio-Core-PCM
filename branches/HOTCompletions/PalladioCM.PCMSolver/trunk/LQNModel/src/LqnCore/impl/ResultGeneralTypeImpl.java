 ...
 * <ul>
 *   <li>{@link LqnCore.impl.ResultGeneralTypeImpl#getConvVal <em>Conv Val</em>}</li>
 *   <li>{@link LqnCore.impl.ResultGeneralTypeImpl#getElapsedTime <em>Elapsed Time</em>}</li>
 *   <li>{@link LqnCore.impl.ResultGeneralTypeImpl#getIterations <em>Iterations</em>}</li>
 *   <li>{@link LqnCore.impl.ResultGeneralTypeImpl#getPlatformInfo <em>Platform Info</em>}</li>
 *   <li>{@link LqnCore.impl.ResultGeneralTypeImpl#getSolverInfo <em>Solver Info</em>}</li>
 *   <li>{@link LqnCore.impl.ResultGeneralTypeImpl#getSystemCpuTime <em>System Cpu Time</em>}</li>
 *   <li>{@link LqnCore.impl.ResultGeneralTypeImpl#getUserCpuTime <em>User Cpu Time</em>}</li>
 *   <li>{@link LqnCore.impl.ResultGeneralTypeImpl#getValid <em>Valid</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResultGeneralTypeImpl extends EObjectImpl implements ResultGeneralType {
	...
	public void setConvVal(Object newConvVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_GENERAL_TYPE__CONV_VAL, oldConvVal, convVal));
	}
	...
	public void setElapsedTime(String newElapsedTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_GENERAL_TYPE__ELAPSED_TIME, oldElapsedTime, elapsedTime));
	}
	...
	public void setIterations(Object newIterations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_GENERAL_TYPE__ITERATIONS, oldIterations, iterations));
	}
	...
	public void setPlatformInfo(String newPlatformInfo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_GENERAL_TYPE__PLATFORM_INFO, oldPlatformInfo, platformInfo));
	}
	...
	public void setSolverInfo(String newSolverInfo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_GENERAL_TYPE__SOLVER_INFO, oldSolverInfo, solverInfo));
	}
	...
	public void setSystemCpuTime(String newSystemCpuTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_GENERAL_TYPE__SYSTEM_CPU_TIME, oldSystemCpuTime, systemCpuTime));
	}
	...
	public void setUserCpuTime(String newUserCpuTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_GENERAL_TYPE__USER_CPU_TIME, oldUserCpuTime, userCpuTime));
	}
	...
	public void setValid(ValidType newValid) {
		...
		validESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.RESULT_GENERAL_TYPE__VALID, oldValid, valid, !oldValidESet));
	}
	...
	public void unsetValid() {
		...
		validESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnCorePackage.RESULT_GENERAL_TYPE__VALID, oldValid, VALID_EDEFAULT, oldValidESet));
	}

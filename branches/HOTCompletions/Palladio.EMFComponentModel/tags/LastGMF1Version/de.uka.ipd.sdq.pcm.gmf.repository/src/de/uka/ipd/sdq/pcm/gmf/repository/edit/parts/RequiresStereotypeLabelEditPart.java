 ...
 * @generated
 */
public class RequiresStereotypeLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(PcmVisualIDRegistry
				.getType(RequiresStereotypeLabelEditPart.VISUAL_ID), new Point(
				0, 40));
	}
	 ...
	 * @generated
	 */
	public RequiresStereotypeLabelEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.RequiredRole_3002;
					}
	...
	protected IFigure createFigurePrim() {
		return new RequiresStereotypeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RequiresStereotypeLabelFigure extends
			org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel {

		/**
		 * @generated
		 */
		public RequiresStereotypeLabelFigure() {

...
public class SignatureEditPart extends CompartmentEditPart implements
	 ...
	 * @generated
	 */
	public SignatureEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SignatureItemSemanticEditPolicy());
	...
	protected Image getLabelIcon() {
		ImageDescriptor descriptor = RepositoryDiagramEditorPlugin
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.Signature_2001;
					}
	 ...
	 * @generated
	 */
	public class SignatureServiceNameFigure extends

...
public class Evaluation {
	...
	@SuppressWarnings("unused")
	private static String TEST_CLASSNAME = TestSubject.class.getCanonicalName();
	@SuppressWarnings("unused")
	...
	private void analyseData(HashMap<Integer, Integer> opcodeCounts) {
		...
		try {
			fosCSV = new FileOutputStream("./" + System.nanoTime()
					+ ".csv.MLSet");
			Integer count = null;
			...
			fosSSV = new FileOutputStream("./" + System.nanoTime()
					+ ".ssv.MLSet");
	 ...
	 * @param inputVarValue
	 */
	public void makeMLSetFromResult(IFullCountingResult r, int inputVarValue) {
		@SuppressWarnings("unused")
		long time = r.getMethodInvocationBeginning();
		@SuppressWarnings("unused")
		String qualifyingMethodName = r.getQualifyingMethodName();
		TreeMap<Integer, Long> opcodeCounts = r.getOpcodeCounts();
		@SuppressWarnings("unused")
		TreeMap<String, Long> methodCallCounts = r.getMethodCallCounts();
		...
		List<Long> outputVarsValues = new ArrayList<Long>();

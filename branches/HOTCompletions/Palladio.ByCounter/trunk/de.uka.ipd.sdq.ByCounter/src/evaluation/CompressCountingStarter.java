...
import evaluation.palladiofileshare.algorithms.SimpleLZW;
import evaluation.palladiofileshare.algorithms.SimpleTestDriver;
...
//		log.debug("(NOT INITIALISED)" + counter.getInstrumParams().toString());

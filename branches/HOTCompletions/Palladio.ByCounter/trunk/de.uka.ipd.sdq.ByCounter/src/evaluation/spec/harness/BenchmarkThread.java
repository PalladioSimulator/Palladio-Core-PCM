 ...
 */
package evaluation.spec.harness;

import java.io.PrintStream;

import evaluation.spec.harness.results.BenchmarkResult;
import evaluation.spec.harness.results.IterationResult;
import evaluation.spec.harness.results.LoopResult;
import evaluation.spec.harness.results.TestResult;
import evaluation.spec.io.ValidityCheckOutputStream;
...
public abstract class BenchmarkThread extends Thread {
    ...
    public LoopResult runLoop(IterationResult iResult) {
        ...
        try {
            ...
            if (Context.getVerify()) {
                // evaluation.spec.io.FileOutputStream.printCount(checksum);
     ...
     *
     * @see evaluation.spec.harness.ProgramRunner
     * @see evaluation.spec.harness.BenchmarkThread
     */

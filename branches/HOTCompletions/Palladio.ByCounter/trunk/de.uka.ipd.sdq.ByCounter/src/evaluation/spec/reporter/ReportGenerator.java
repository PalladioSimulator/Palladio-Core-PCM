 ...
 */
package evaluation.spec.reporter;
...
import evaluation.spec.harness.results.TestResult;
...
public class ReportGenerator {	
    ...
    public void generateCopyRightStatement(Writer w) {
        ...
        if (year > 2008) {
            al.add("Copyright " + w.getCopyRightSign() + " 2008-" + year + " evaluation.spec. All rights reserved");
        } else {
            al.add("Copyright " + w.getCopyRightSign() + " 2008 evaluation.spec. All rights reserved");
        }
    ...
    public static String main2(String[] args) throws Exception {
        ...
        if (rawFile == null) {
            System.out.println("java evaluation.spec.reporter.Reporter <raw file>");
            System.out.println("java evaluation.spec.reporter.Reporter <raw file> [-html <bool>] [-txt <bool>] [-summary <bool>] [-sub <bool>]");
            return null;
        }

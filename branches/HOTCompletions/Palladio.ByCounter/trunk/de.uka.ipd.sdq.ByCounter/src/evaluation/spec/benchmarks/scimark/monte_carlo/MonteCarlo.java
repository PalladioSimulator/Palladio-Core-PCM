...
import evaluation.spec.benchmarks.scimark.utils.Constants;
import evaluation.spec.benchmarks.scimark.utils.Random;
import evaluation.spec.benchmarks.scimark.utils.Stopwatch;
...
public class MonteCarlo {
    ...
    public double measureMonteCarlo(double min_time, Random R) {
        PrintStream p = evaluation.spec.harness.Context.getOut();

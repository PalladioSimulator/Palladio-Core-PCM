...
public class Utils {
	...
	public static CountingResult getAssertedResult(boolean recursive) {
		CountingResult[] r = CountingResultCollector.getInstance().getAllCountingResultsAsArray(recursive);
	 ...
	 */
	public static int getOpcCount(IFullCountingResult r, int opcode) {

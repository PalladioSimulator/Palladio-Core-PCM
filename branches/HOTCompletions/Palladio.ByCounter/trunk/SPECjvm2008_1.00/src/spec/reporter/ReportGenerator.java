...
//                result.add(current.getTextContent()); TODO MK document this
            }
        }        
        return result;
    }
    ...
    private void generateInfoTable(Node base, Writer w, String [] fields) {    	
    	...
    	for (Node current = base.getFirstChild();
			...
			Pair<String, String> p = new Pair<String, String>(current.getNodeName(), null /*current.getTextContent()*/); //TODO MK document this
    		if (isNotTextNode(current)) {
    			l1.add(p);
    		} 
    	}
...
//                        iterRecord.addError(errors.item(j).getTextContent()); TODO MK document this
                    }
                }
            }
        }
    ...
    private String getProperty(String prop) {
        return null; //root.getElementsByTagName(prop).item(0).getTextContent(); TODO MK document this
    }

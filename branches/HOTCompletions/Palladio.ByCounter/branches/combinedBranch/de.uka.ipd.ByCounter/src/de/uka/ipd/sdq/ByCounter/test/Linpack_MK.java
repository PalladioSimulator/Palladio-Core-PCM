...
public static void main(String[] args)
  {
    Linpack_MK l = new Linpack_MK();
    int rep = 40;
    System.out.println("Linpack_MK, "+rep+" times : ");
...
//		long µs = Math.round((double) ns / 1000);// MK TODO
//		long ms = Math.round((double) µs / 1000);// MK TODO
...
*/
	...
	//TODO DRINGEND AUSGABE ZUR JIT-Vermeidung (wir können allerdings dadurch nur besser werden)

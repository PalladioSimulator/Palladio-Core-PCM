...
public class MethodInvocationHelper {
	...
	/** 
	 * Call the specfied methods using reflection.
	...
	public static void callMethods(Logger log, 
		...
		try {
			...
			if(params == null) {
				...
				log.warn("Warning: callMethods called with less parameterlists than method. Assuming no parameters for those methods.");
				// fill up the list

...
//			long 탎 = Math.round((double) ns / 1000);// MK TODO
//			long ms = Math.round((double) 탎 / 1000);// MK TODO
...
//		long ns = stop - start;
//		long 탎 = Math.round((double) ns / 1000);
//		long ms = Math.round((double) 탎 / 1000);
//		long s = Math.round((double) ms / 1000);
//		System.out.println("MonteCarlo.integrate(" + NUM_SAMPLES + ") "
//				+ "executed in " + ns + " ns = " + 탎 + " 탎 = " + ms

 ...
 * Needs to be filled with fields
 * @author Michael
 */
public class AbstractBenchmarkingSetting implements Comparable<AbstractBenchmarkingSetting>, Serializable{
	...
	@Override
	public int compareTo(AbstractBenchmarkingSetting o) {
...
//	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AbstractBenchmarkingSetting other = (AbstractBenchmarkingSetting) obj;
		if (description == null) {

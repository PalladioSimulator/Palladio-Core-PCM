 ...
 * @author Michael
 */
public abstract class AbstractBenchmarkingResult implements Serializable{
	 ...
	 */
	private AbstractBenchmarkingSetting setting;
...
//	int timeUnitExponentOfSecond;
	...
	public AbstractBenchmarkingSetting getSetting() {
		return setting;
	}
	...
	@SuppressWarnings("unused")
	private void setSetting(AbstractBenchmarkingSetting setting) {

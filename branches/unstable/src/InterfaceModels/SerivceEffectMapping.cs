...
namespace Palladio.ComponentModel.InterfaceModels 
{
	...
	internal class ServiceEffectMapping : IServiceEffectMapping 
	{
		...
		/// </summary>
		public IServiceEffectSpecification EffectSpec 
		{ 
		...
		public ServiceEffectMapping(ISignature aSignature, IServiceEffectSpecification aServiceEffectSpec)
		{
			signature = (ISignature) aSignature.Clone();
			effectSpec = (IServiceEffectSpecification) aServiceEffectSpec.Clone();
		}
		...
		private IServiceEffectSpecification effectSpec;

 ...
 * <code>Perfcount.readcounter()</code> method (rdtsc). 
 ...
 *
 */
public class RdtscLinux_TimerMeter extends AbstractTimerMeter {
	...
	public static void main(String[] args) {
		RdtscLinux_TimerMeter tm = new RdtscLinux_TimerMeter();
		tm.run(args);
...
/**Changes increase step width to 10 and number of iteration increases to 400.
	 */
	public RdtscLinux_TimerMeter() {
		super();
		this.timerClassName = "uka.perfcount.Perfcount";
		this.timerMethodIsStatic = true;
		this.timerMethodName = "readcounter";
...
//				System.gc();// TODO manualGC...
				this.methodReturnAtMeasurementStart = Perfcount.readcounter();
				this.methodReturnAtMeasurementFinish = Perfcount.readcounter();

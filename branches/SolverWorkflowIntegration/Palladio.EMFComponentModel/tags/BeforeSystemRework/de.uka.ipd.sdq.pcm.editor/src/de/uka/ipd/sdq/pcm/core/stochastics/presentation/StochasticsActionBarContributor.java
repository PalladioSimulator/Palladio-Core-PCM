...
/**
 * This is the action bar contributor for the Stochastics model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StochasticsActionBarContributor
	 ...
	 * @generated
	 */
	public StochasticsActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("stochastics-settings"));
		toolBarManager.add(new Separator("stochastics-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PcmEditorPlugin.INSTANCE.getString("_UI_StochasticsEditor_menu"), "de.uka.ipd.sdq.pcm.core.stochasticsMenuID");

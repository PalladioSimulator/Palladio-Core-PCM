 ...
 * @generated
 */
public class CompleteComponentTypeEntityNameEditPart extends
	 ...
	 * @generated
	 */
	public CompleteComponentTypeEntityNameEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.CompleteComponentType_1003;
					}

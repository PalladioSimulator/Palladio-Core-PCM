...
public class RoleLabelEditPart extends XYLayoutLabel implements
	...
	static {
		registerSnapBackPosition(PcmVisualIDRegistry
				.getType(RoleLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public RoleLabelEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return PcmElementTypes.Node_2001;
					}
	 ...
	 * @generated
	 */
	public class RoleLabelFigure extends

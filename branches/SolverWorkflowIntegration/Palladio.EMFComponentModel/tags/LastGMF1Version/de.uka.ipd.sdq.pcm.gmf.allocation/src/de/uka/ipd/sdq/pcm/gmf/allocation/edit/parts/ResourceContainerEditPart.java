...
import de.uka.ipd.sdq.pcm.gmf.allocation.edit.policies.ResourceContainerCanonicalEditPolicy;
import de.uka.ipd.sdq.pcm.gmf.allocation.edit.policies.ResourceContainerGraphicalNodeEditPolicy;
import de.uka.ipd.sdq.pcm.gmf.allocation.edit.policies.ResourceContainerItemSemanticEditPolicy;
...
public class ResourceContainerEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new ResourceContainerGraphicalNodeEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ResourceContainerCanonicalEditPolicy());
		...
		if (childEditPart instanceof ResourceContainerEntityNameEditPart) {
			((ResourceContainerEntityNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureResContainerNameFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class ResourceContainerFigure extends
		...
		private void createContents() {
			...
			setFigureResContainerNameFigure(fig_0);
		 ...
		 * @generated
		 */
		private org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel fResContainerNameFigure;

		/**
		 * @generated
		 */
		public org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel getFigureResContainerNameFigure() {
			return fResContainerNameFigure;
		}

		/**
		 * @generated
		 */
		private void setFigureResContainerNameFigure(
				org.eclipse.gmf.runtime.draw2d.ui.figures.WrapLabel fig) {
			fResContainerNameFigure = fig;
		}

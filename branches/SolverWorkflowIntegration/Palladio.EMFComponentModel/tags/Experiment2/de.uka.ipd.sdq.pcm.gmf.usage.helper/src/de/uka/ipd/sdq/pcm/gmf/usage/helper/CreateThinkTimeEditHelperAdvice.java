 ...
 *
 */
public class CreateThinkTimeEditHelperAdvice extends
	...
	protected ICommand getAfterConfigureCommand(ConfigureRequest request) {
		...
		IElementType elementType = ElementTypeRegistry.getInstance().getType("de.uka.ipd.sdq.pcm.gmf.usage.ThinkTime_9100");

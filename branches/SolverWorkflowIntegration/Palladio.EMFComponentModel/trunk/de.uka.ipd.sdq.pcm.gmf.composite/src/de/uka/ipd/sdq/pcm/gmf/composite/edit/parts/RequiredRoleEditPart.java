 ...
 * @generated
 */
public class RequiredRoleEditPart extends BorderedBorderItemEditPart {
	...
	protected IFigure createNodeShape() {
		ReqRoleFigure figure = new ReqRoleFigure();
	 ...
	 * @generated
	 */
	public ReqRoleFigure getPrimaryShape() {
		return (ReqRoleFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof RequiredRoleEntityNameEditPart) {
	...
	protected NodeFigure createNodePlate() {
		...
		SocketFigure result = new SocketFigure(getMapMode().DPtoLP(FIGURE_LOGICAL_SIZE),POSITION_TYPE.POS_INTERNAL);
	 ...
	 * @generated
	 */
	public class ReqRoleFigure extends Ellipse {
		/**
		 * @generated
		 */
		public ReqRoleFigure() {
			this.setFill(true);

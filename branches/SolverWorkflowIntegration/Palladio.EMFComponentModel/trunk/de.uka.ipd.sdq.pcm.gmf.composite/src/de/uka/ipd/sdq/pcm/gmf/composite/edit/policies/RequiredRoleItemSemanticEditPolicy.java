...
public class RequiredRoleItemSemanticEditPolicy extends
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (PalladioComponentModelElementTypes.AssemblyConnector_4001 == req
				.getElementType()) {
			return req.getTarget() == null ? getCreateStartOutgoingAssemblyConnector_4001Command(req)
					: null;
		}
		if (PalladioComponentModelElementTypes.RequiredDelegationConnector_4002 == req
				.getElementType()) {
			return req.getTarget() == null ? getCreateStartOutgoingRequiredDelegationConnector_4002Command(req)
					: null;
		}

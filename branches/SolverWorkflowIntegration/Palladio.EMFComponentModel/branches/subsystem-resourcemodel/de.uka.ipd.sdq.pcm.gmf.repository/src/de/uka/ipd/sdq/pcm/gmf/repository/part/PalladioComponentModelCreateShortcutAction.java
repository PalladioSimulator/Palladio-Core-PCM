 ...
 * @generated
 */
public class PalladioComponentModelCreateShortcutAction implements
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof RepositoryEditPart) {
				mySelectedElement = (RepositoryEditPart) structuredSelection
						.getFirstElement();
			}
		}

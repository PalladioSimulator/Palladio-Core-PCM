 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.designdecision.impl.RangeImpl#isUpperBoundIncluded <em>Upper Bound Included</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcm.designdecision.impl.RangeImpl#isLowerBoundIncluded <em>Lower Bound Included</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class RangeImpl extends DomainImpl implements Range {
	/**
	...
	protected EClass eStaticClass() {
		return designdecisionPackage.Literals.RANGE;
	}
	...
	public void setUpperBoundIncluded(boolean newUpperBoundIncluded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, designdecisionPackage.RANGE__UPPER_BOUND_INCLUDED, oldUpperBoundIncluded, upperBoundIncluded));
	}
	...
	public void setLowerBoundIncluded(boolean newLowerBoundIncluded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, designdecisionPackage.RANGE__LOWER_BOUND_INCLUDED, oldLowerBoundIncluded, lowerBoundIncluded));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case designdecisionPackage.RANGE__UPPER_BOUND_INCLUDED:
				return isUpperBoundIncluded() ? Boolean.TRUE : Boolean.FALSE;
			case designdecisionPackage.RANGE__LOWER_BOUND_INCLUDED:

 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.capra.core.impl.IdentifierImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IdentifierImpl extends EObjectImpl implements Identifier {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.IDENTIFIER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.IDENTIFIER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.IDENTIFIER__NAME:
				return getName();
		}

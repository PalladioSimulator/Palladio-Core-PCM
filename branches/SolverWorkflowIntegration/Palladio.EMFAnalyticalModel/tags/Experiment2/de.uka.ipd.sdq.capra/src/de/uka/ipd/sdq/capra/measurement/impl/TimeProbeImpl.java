...
public class TimeProbeImpl extends ProbeActionImpl implements TimeProbe {
	 ...
	 * @ordered
	 */
	protected EList<TimeSpanSensor> sensorsToStart;
	 ...
	 * @ordered
	 */
	protected EList<TimeSpanSensor> sensorsToStop;
	 ...
	 * @generated
	 */
	public EList<TimeSpanSensor> getSensorsToStart() {
		if (sensorsToStart == null) {
			sensorsToStart = new EObjectWithInverseResolvingEList<TimeSpanSensor>(TimeSpanSensor.class, this, MeasurementPackage.TIME_PROBE__SENSORS_TO_START, MeasurementPackage.TIME_SPAN_SENSOR__START_MEASUREMENT);
		}
	 ...
	 * @generated
	 */
	public EList<TimeSpanSensor> getSensorsToStop() {
		if (sensorsToStop == null) {
			sensorsToStop = new EObjectWithInverseResolvingEList<TimeSpanSensor>(TimeSpanSensor.class, this, MeasurementPackage.TIME_PROBE__SENSORS_TO_STOP, MeasurementPackage.TIME_SPAN_SENSOR__STOP_MEASUREMENT);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MeasurementPackage.TIME_PROBE__SENSORS_TO_START:
				...
				getSensorsToStart().addAll((Collection<? extends TimeSpanSensor>)newValue);
				return;
			case MeasurementPackage.TIME_PROBE__SENSORS_TO_STOP:
				getSensorsToStop().clear();
				getSensorsToStop().addAll((Collection<? extends TimeSpanSensor>)newValue);
				return;
		}

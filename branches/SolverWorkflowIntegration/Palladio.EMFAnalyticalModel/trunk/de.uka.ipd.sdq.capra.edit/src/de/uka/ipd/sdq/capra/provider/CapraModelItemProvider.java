...
public class CapraModelItemProvider
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CapraPackage.Literals.CAPRA_MODEL__PROCESSES,
				 CoreFactory.eINSTANCE.createReplicatedProcess()));
		...
		newChildDescriptors.add
			(createChildParameter
				(CapraPackage.Literals.CAPRA_MODEL__SENSORS,
				 MeasurementFactory.eINSTANCE.createGlobalTimeSpanSensor()));

		newChildDescriptors.add
			(createChildParameter
				(CapraPackage.Literals.CAPRA_MODEL__SENSORS,
				 MeasurementFactory.eINSTANCE.createLocalTimeSpanSensor()));

		newChildDescriptors.add
			(createChildParameter
				(CapraPackage.Literals.CAPRA_MODEL__SENSORS,
				 MeasurementFactory.eINSTANCE.createInterruptionTimeSpanSensor()));

		newChildDescriptors.add
			(createChildParameter
				(CapraPackage.Literals.CAPRA_MODEL__SENSORS,
				 MeasurementFactory.eINSTANCE.createProcessorShareSensor()));

		newChildDescriptors.add
			(createChildParameter
				(CapraPackage.Literals.CAPRA_MODEL__SENSORS,
				 MeasurementFactory.eINSTANCE.createResourceUtilisationSensor()));
	}

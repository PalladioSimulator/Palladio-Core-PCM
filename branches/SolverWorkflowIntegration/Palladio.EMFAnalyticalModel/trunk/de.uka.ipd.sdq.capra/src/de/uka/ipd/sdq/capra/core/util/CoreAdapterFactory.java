...
public class CoreAdapterFactory extends AdapterFactoryImpl {
	...
	protected CoreSwitch<Adapter> modelSwitch =
		new CoreSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAbstractResourceUsage(AbstractResourceUsage object) {
			...
			@Override
			public Adapter caseVariableResourceUsage(VariableResourceUsage object) {
				return createVariableResourceUsageAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.capra.core.ReplicatedProcess <em>Replicated Process</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.capra.core.AbstractResourceUsage <em>Abstract Resource Usage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.capra.core.VariableResourceUsage <em>Variable Resource Usage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

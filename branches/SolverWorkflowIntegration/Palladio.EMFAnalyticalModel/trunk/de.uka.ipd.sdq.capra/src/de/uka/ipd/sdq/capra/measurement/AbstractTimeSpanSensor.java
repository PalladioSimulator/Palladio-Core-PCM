...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Abstract Time Span Sensor</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.capra.measurement.AbstractTimeSpanSensor#getTimeSpanRecorders <em>Time Span Recorders</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.capra.measurement.AbstractTimeSpanSensor#getStopMeasurement <em>Stop Measurement</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.capra.measurement.AbstractTimeSpanSensor#getStartMeasurement <em>Start Measurement</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.capra.measurement.MeasurementPackage#getAbstractTimeSpanSensor()
 * @model abstract="true"
 * @generated
 */
public interface AbstractTimeSpanSensor extends Sensor {
	/**
	 ...
	 * @see de.uka.ipd.sdq.capra.measurement.MeasurementPackage#getAbstractTimeSpanSensor_TimeSpanRecorders()
	 * @see de.uka.ipd.sdq.capra.measurement.TimeSpanRecorder#getTimeSpanSensor
	 * @model opposite="timeSpanSensor" containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see de.uka.ipd.sdq.capra.measurement.MeasurementPackage#getAbstractTimeSpanSensor_StopMeasurement()
	 * @see de.uka.ipd.sdq.capra.measurement.TimeProbe#getSensorsToStop
	 * @model opposite="sensorsToStop" required="true" ordered="false"
	 * @generated
	 */
	TimeProbe getStopMeasurement();

	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.capra.measurement.AbstractTimeSpanSensor#getStopMeasurement <em>Stop Measurement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uka.ipd.sdq.capra.measurement.MeasurementPackage#getAbstractTimeSpanSensor_StartMeasurement()
	 * @see de.uka.ipd.sdq.capra.measurement.TimeProbe#getSensorsToStart
	 * @model opposite="sensorsToStart" required="true" ordered="false"
	 * @generated
	 */
	TimeProbe getStartMeasurement();

	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.capra.measurement.AbstractTimeSpanSensor#getStartMeasurement <em>Start Measurement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

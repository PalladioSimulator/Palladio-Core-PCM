...
//		ComprehensivePredictionResult_CBSE2008[] predAcer = bpp.predictAllFiles(
//				BenchmarkedBytecode.KLAUS_ACER, 
//				BenchmarkedBytecode.IS_NOT_JITTED);
//		ComprehensivePredictionResult_CBSE2008[] predLenovo = bpp.predictAllFiles(
//				BenchmarkedBytecode.MICHAEL_LENOVO, 
//				BenchmarkedBytecode.IS_NOT_JITTED);
//		@SuppressWarnings("unused")
//		ComprehensivePredictionResult_CBSE2008[] predToshiba = bpp.predictAllFiles(
//				BenchmarkedBytecode.MICHAEL_TOSHIBA, 
//				BenchmarkedBytecode.IS_NOT_JITTED);
//		@SuppressWarnings("unused")
//		ComprehensivePredictionResult_CBSE2008[] predSDQLenovo = bpp.predictAllFiles(
...
//	}
//
//	private ComprehensivePredictionResult_CBSE2008[] predictAllFiles(
//			int platform, 
//			int jitFlag) {
////		long[] allResults = new long[20];
////		long[] allCounts  = new long[20];
//		ComprehensivePredictionResult_CBSE2008[] results = new ComprehensivePredictionResult_CBSE2008[20];
...
//	public ComprehensivePredictionResult_CBSE2008 predictSingleFile(
//			int platformID, 
//			int isJitted, 
//			int rowNumber //one greater than the file index
//		){
//		PalladioFileShareLearnedBytecode lb = new PalladioFileShareLearnedBytecode(); //does not need to read any files...
//		
...
//			currInstructionOpcode = PalladioFileShareLearnedBytecode.LEARNED_BYTECODES[i];
//			
...
//		return new ComprehensivePredictionResult_CBSE2008(tempPlatformID,tempCounts,tempDurations);
//	}
//	

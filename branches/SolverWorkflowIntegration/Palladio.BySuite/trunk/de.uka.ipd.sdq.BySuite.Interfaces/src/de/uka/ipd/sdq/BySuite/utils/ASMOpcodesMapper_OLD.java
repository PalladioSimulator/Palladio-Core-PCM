...
import de.uka.ipd.sdq.BySuite.counting.IByCounterConstants;
 ...
 * @version 1.1
 */
public class ASMOpcodesMapper_OLD implements Opcodes {

	/**
	 * Singleton instance; dao = display ASM opcodes (not "data access object")
	 */
	private static ASMOpcodesMapper_OLD mapper = new ASMOpcodesMapper_OLD();
	
	/** 
	 * Get the singleton instance
	 *  @return the singleton instance
	 */
	public static ASMOpcodesMapper_OLD getInstance(){
		return instance();
	}
	 ...
	 * @return the singleton instance
	 */
	public static ASMOpcodesMapper_OLD instance(){
		return mapper;
	}
	...
	public static void main(String[] args){
		ASMOpcodesMapper_OLD daoInstance = ASMOpcodesMapper_OLD.instance();
	...
	private ASMOpcodesMapper_OLD(boolean displayListAtStartup){
		super();
...
//		this.codes.put(1008,"NOP");
	 ...
	 */
	@SuppressWarnings("nls")
	private void printAllInstructions(ASMOpcodesMapper_OLD daoInstance){
		for (int i = 0; i < 256; i++) {

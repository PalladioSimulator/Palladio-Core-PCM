 ...
 * TODO rename methods to match the int-String problem of methods vs. opcodes
 * TODO there may exist several Results for an opcode or signature, depending on input parameters - iterate over the list to retrieve? tree-formed structure? or Google Collections (MultiTrees)?
 */
public class SerializableBytecodeBenchmarkingResults extends AbstractBytecodeBenchmarkingResults_forSetting{
...
//	/*255*/,"null"
	...
	public AbstractBenchmarkingResult getBenchmarkingResult_forOpcode(int opcode)
		...
		if(opcodeMap.keySet().contains(opcode)){
			AbstractBenchmarkingResult abr = results.get(this.getOpcodeStringByIntOpcode(opcode));
			if(abr==null){
	...
	public String getOpcodeStringByIntOpcode(int opcode) throws NoSuchOpcodeException {
		if(opcodeMap.keySet().contains(opcode)){
	...
	public AbstractBenchmarkingResult getBenchmarkingResult_forOpcode(
			int opcode, Object[] parameterValues, String[] parameterTypes)
			throws NoSuchOpcodeException {
		try {
	...
	public AbstractBenchmarkingResult getBenchmarkingResult_forOpcode(
		...
		if(abr==null){
			throw new NoSuchMethodSignatureException("TODO"); //TODO stimmt nicht...
		}else{
			return abr;
		}
	}

package de.uka.ipd.sdq.BySuite.ByPred.prediction;

import java.util.HashMap;
import java.util.Map;

import de.uka.ipd.sdq.BySuite.ByPred.counting.results.LearnedDataErrorCalculation;
import de.uka.ipd.sdq.BySuite.ByPred.counting.results.PalladioFileShareLearnedBytecode;
...
////				BenchmarkedBytecodeCBSE2008.KLAUS_ACER, 
////				BenchmarkedBytecodeCBSE2008.IS_NOT_JITTED);
////		ComprehensivePredictionResult[] predLenovo = bpp.predictAllFiles(
////				BenchmarkedBytecodeCBSE2008.MICHAEL_LENOVO, 
////				BenchmarkedBytecodeCBSE2008.IS_NOT_JITTED);
////		@SuppressWarnings("unused")
////		ComprehensivePredictionResult[] predToshiba = bpp.predictAllFiles(
////				BenchmarkedBytecodeCBSE2008.MICHAEL_TOSHIBA, 
////				BenchmarkedBytecodeCBSE2008.IS_NOT_JITTED);
////		@SuppressWarnings("unused")
////		ComprehensivePredictionResult[] predSDQLenovo = bpp.predictAllFiles(
////				BenchmarkedBytecodeCBSE2008.SDQ_LENOVO, 
////				BenchmarkedBytecodeCBSE2008.IS_NOT_JITTED);
...
//		
//		BenchmarkedBytecodeCBSE2008 bb;
//		bb = new BenchmarkedBytecodeCBSE2008(platformID, isJitted);//reads from file //TODO optimise
//		

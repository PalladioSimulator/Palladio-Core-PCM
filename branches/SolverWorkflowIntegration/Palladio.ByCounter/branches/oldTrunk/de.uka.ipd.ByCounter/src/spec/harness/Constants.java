...
public class Constants {
    ...
    /** Property that specifies which port to use in the serial benchmark. */
    public final static String SUNFLOW_THREADS = "specjvm.benchmark.sunflow.threads.per.instance";
    
    /** Property that specifies which port to use in the serial benchmark. */
    public final static String SERIAL_STARTUP_PORT_PROP = "specjvm.benchmark.serial.startport";

...
public class ASMBytecodeOccurences {
	 ...
	 *
	 */
	public static class Interfaced implements Interface {
	...
	public static void invokationsAndClasses() {
		Interfaced.staticMethod();				// INVOKESTATIC
		Interface inter = new Interfaced();	// INVOKESPECIAL
		inter.test();		// INVOKEINTERFACE
		((Interfaced)inter).integer = 2;
		Interfaced.character = 'd';

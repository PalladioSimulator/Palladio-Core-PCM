...
final class Compress {
    ...
    public static OutputBuffer performAction(byte[] src, int srcLength,
        ...
        if (action == COMPRESS) {
        	// BYCOUTER changed for measurement:
        	Compressor c = new Compressor(in, out);
			long startTime = System.nanoTime();
			System.err.println("START OF METHOD: " + startTime);
            c.compress();
			long stopTime = System.nanoTime();
			System.err.println("END OF METHOD: " + stopTime);
			System.err.println("METHOD RUN DURATION: " + (stopTime-startTime) + "ns");
        } else {

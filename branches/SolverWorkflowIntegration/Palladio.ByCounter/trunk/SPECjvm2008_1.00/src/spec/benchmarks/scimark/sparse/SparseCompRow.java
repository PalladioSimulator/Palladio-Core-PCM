...
public class SparseCompRow {
    ...
    public static void main(String[] args) {
        SparseCompRow sparse= new SparseCompRow();
        sparse.run();
    }
    ...
    public double measureSparseMatmult(int N, int nz,
        ...
        //while(true)
        //{
        System.out.println("MK: SPARSE input (sparse.SparseCompRow.matmult): "+
        		"y[0]="+y[0]+", " +
        		"y[last]="+y[y.length-1]+", " +
        		"val[0]=" +val[0]+", " +
        		"val[last]=" +val[val.length-1]+", " +
        		"row[0]=" +row[0]+", " +
        		"row[last]=" +row[row.length-1]+", " +
        		"col[0]=" +col[0]+", " +
        		"col[last]= " +col[col.length-1]+", " +
        		"x[0]= " +x[0]+", " +
        		"x[last]= " +x[x.length-1]+", " +
        		"cycles " +cycles+","+
        		"count="+count);
        ...
        Q.stop();
        System.out.println("MK: SPARSE took "+(stop-start)+" ns (incl. 1* nanoTime())");

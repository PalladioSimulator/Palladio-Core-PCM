...
public class InstrumentationParameters {
	...
	public static final String RESULT_LOG_DEFAULT_FILENAME = 
		"ByCounter output" + 
		File.separatorChar +
...
//
	...
	private boolean counterPrecision;
	 ...
	 */
	public boolean getCounterPrecision() {
	 ...
	 */
	public void setCounterPrecision(boolean counterPrecision) {
		this.counterPrecision = counterPrecision;
	}
	 ...
	 * {$TIME}				- The System.nanoTime() value returned when instrumenting the method.
	 ...
	 */
	@Override
	public String toString() {//TODO better performance with StringBuffer?
		StringBuilder b = new StringBuilder("InstrumentationParameters {");
		b.append("counterPrecisionIsLONG: " 	+ counterPrecision + ", ");
		...
		b.append("writeClassesToDisk: " 		+ writeClassesToDisk + ", ");
		b.append("}");
		return b.toString();
	}
}

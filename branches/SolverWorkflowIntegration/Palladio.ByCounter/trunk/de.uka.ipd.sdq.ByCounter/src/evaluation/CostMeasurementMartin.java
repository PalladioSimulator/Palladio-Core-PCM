...
import de.uka.ipd.sdq.ByCounter.measurement.IMeasurable;
import de.uka.ipd.sdq.ByCounter.measurement.MeasurableCostsForMethodRun;
import de.uka.ipd.sdq.ByCounter.measurement.MeasurableInstrumentationCostsForMethod;
import de.uka.ipd.sdq.ByCounter.utils.ChartResultWriter;
import de.uka.ipd.sdq.ByCounter.utils.MethodDescriptor;
import evaluation.Linpack.Linpack;
...
//		log.info("  Variance: " + stats.getVariance());
	...
	public void measure() {
		...
		MeasurableCostsForMethodRun measurableRun = 
			new MeasurableCostsForMethodRun( 
					new MethodDescriptor(TEST_CLASSNAME, TEST_METHODSIGNATURE), 
					INSTRUMENTATION_NONE);
		...
		MeasurableInstrumentationCostsForMethod measurableInstrum = 
			new MeasurableInstrumentationCostsForMethod(
					new MethodDescriptor(TEST_CLASSNAME, TEST_METHODSIGNATURE), false);

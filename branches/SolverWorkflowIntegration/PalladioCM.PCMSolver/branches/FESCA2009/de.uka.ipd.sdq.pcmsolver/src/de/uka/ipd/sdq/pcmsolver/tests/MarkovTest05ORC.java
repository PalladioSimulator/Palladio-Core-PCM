...
public class MarkovTest05ORC {
	 ...
	 */
	private static final int ITEMCOUNTSTEP = 20;
	...
	private void generateScript(final ArrayList<Integer> xValues,
		...
		out.write("pdf(\"" + PLOTPATH.replace("\\", "\\\\")
				+ "\", height = 3, width = 4.5, pointsize = 9);");
		out.write("par(mar=c(5, 6, 1, 6), bg = \"white\")");
		out.newLine();
		...
		out.write("plot.window(xlim = c(" + xValues.get(0) + ","
				+ xValues.get(xValues.size() - 1) + "), ylim = c(0.99985,1))");
		out.newLine();
		...
		// Plot a target line of 99.99% reliability:
		out.write("abline(h = 0.9999, lty = 2);");

		// Plot helper lines:
		out.write("abline(h = 0.99985, lty = 3);");
		out.write("abline(h = 0.999875, lty = 3);");
		out.write("abline(h = 0.999925, lty = 3);");
		out.write("abline(h = 0.99995, lty = 3);");
		out.write("abline(h = 0.999975, lty = 3);");
		out.write("abline(h = 1, lty = 3);");
		out.write("abline(v = 0, lty = 3);");
		out.write("abline(v = 20, lty = 3);");
		out.write("abline(v = 40, lty = 3);");
		out.write("abline(v = 60, lty = 3);");
		out.write("abline(v = 80, lty = 3);");
		out.write("abline(v = 100, lty = 3)");
		out.newLine();
		...
		out.write("mtext(\"reliability\", side = 2, line = 5)");
		out.newLine();

		// Add a legend:
		String strLegend = "legend(x = 0, y = 0.999895, legend = c(";

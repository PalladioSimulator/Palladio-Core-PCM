...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>usage</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class UsageExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(UsagePackage.eNS_URI, 
			 UsagePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.usage"));
				UsageContext root = UsageFactory.eINSTANCE.createUsageContext();

...
/**
 * This is the item provider adapter for a {@link LqnCore.InterfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LqnCorePackage.Literals.INTERFACE_TYPE__IN_PORT);
			childrenFeatures.add(LqnCorePackage.Literals.INTERFACE_TYPE__OUT_PORT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LqnCorePackage.Literals.INTERFACE_TYPE__IN_PORT,
				 LqnCoreFactory.eINSTANCE.createInPortType()));

		newChildDescriptors.add
			(createChildParameter
				(LqnCorePackage.Literals.INTERFACE_TYPE__OUT_PORT,
				 LqnCoreFactory.eINSTANCE.createOutPortType()));
	}

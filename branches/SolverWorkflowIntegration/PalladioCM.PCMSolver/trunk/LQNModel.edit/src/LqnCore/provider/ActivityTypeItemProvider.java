...
/**
 * This is the item provider adapter for a {@link LqnCore.ActivityType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivityType_name_feature", "_UI_ActivityType_type"),
				 LqnCorePackage.Literals.ACTIVITY_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ActivityType.class)) {
			case LqnCorePackage.ACTIVITY_TYPE__NAME:

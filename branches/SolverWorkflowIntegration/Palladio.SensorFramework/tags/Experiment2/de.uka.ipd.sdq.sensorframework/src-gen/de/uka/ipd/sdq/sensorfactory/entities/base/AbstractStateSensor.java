		...
		public abstract class AbstractStateSensor
			...
			extends de.uka.ipd.sdq.sensorfactory.entities.base.AbstractSensor
	...
	de.uka.ipd.sdq.sensorfactory.entities.StateSensor

		{
				...
				public AbstractStateSensor(de.uka.ipd.sdq.sensorfactory.entities.dao.IDAOFactory myFactory) {
					super(myFactory);
				}

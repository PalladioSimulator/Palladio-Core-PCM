...
public class SimucomstatusPackageImpl extends EPackageImpl implements SimucomstatusPackage {
	...
	public static SimucomstatusPackage init() {
		if (isInited) return (SimucomstatusPackage)EPackage.Registry.INSTANCE.getEPackage(SimucomstatusPackage.eNS_URI);

		// Obtain or create and register package
		SimucomstatusPackageImpl theSimucomstatusPackage = (SimucomstatusPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof SimucomstatusPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new SimucomstatusPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(simuComStatusEClass, SimuComStatus.class, "SimuComStatus", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSimuComStatus_ProcessStatus(), this.getSimulatedProcesses(), null, "processStatus", null, 1, 1, SimuComStatus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSimuComStatus_ResourceStatus(), this.getSimulatedResources(), null, "resourceStatus", null, 1, 1, SimuComStatus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getSimuComStatus_CurrentSimulationTime(), ecorePackage.getEDouble(), "currentSimulationTime", null, 1, 1, SimuComStatus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(simulatedProcessesEClass, SimulatedProcesses.class, "SimulatedProcesses", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSimulatedProcesses_Processes(), this.getProcess(), null, "processes", null, 0, -1, SimulatedProcesses.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(processEClass, de.uka.ipd.sdq.simucomframework.simucomstatus.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProcess_CurrentAction(), this.getAction(), null, "currentAction", null, 1, 1, de.uka.ipd.sdq.simucomframework.simucomstatus.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getProcess_Id(), ecorePackage.getEString(), "id", null, 1, 1, de.uka.ipd.sdq.simucomframework.simucomstatus.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getProcess_ProcessStartTime(), ecorePackage.getEDouble(), "processStartTime", null, 1, 1, de.uka.ipd.sdq.simucomframework.simucomstatus.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(actionEClass, Action.class, "Action", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAction_ActionStartTime(), ecorePackage.getEDouble(), "actionStartTime", null, 1, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getAction_ActionDuration(), ecorePackage.getEDouble(), "actionDuration", null, 1, 1, Action.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(simulatedResourcesEClass, SimulatedResources.class, "SimulatedResources", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSimulatedResources_ActiveResources(), this.getActiveResouce(), null, "activeResources", null, 0, -1, SimulatedResources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSimulatedResources_PassiveResources(), this.getPassiveResource(), null, "passiveResources", null, 0, -1, SimulatedResources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(activeResouceEClass, ActiveResouce.class, "ActiveResouce", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActiveResouce_WaitingDemands(), this.getWaitForDemand(), this.getWaitForDemand_Resource(), "waitingDemands", null, 0, -1, ActiveResouce.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getActiveResouce_Id(), ecorePackage.getEString(), "id", null, 1, 1, ActiveResouce.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(waitForDemandEClass, WaitForDemand.class, "WaitForDemand", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getWaitForDemand_Demand(), ecorePackage.getEDouble(), "demand", null, 1, 1, WaitForDemand.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getWaitForDemand_Resource(), this.getActiveResouce(), this.getActiveResouce_WaitingDemands(), "resource", null, 1, 1, WaitForDemand.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getPassiveResource_WaitingProcesses(), this.getWaitForAcquire(), this.getWaitForAcquire_Resource(), "waitingProcesses", null, 0, -1, PassiveResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getPassiveResource_InitialResourceCount(), ecorePackage.getEDouble(), "initialResourceCount", null, 1, 1, PassiveResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getPassiveResource_ResourcesAvailable(), ecorePackage.getEDouble(), "resourcesAvailable", null, 1, 1, PassiveResource.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getPassiveResource_Id(), ecorePackage.getEString(), "id", null, 1, 1, PassiveResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(waitForAcquireEClass, WaitForAcquire.class, "WaitForAcquire", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWaitForAcquire_Resource(), this.getPassiveResource(), this.getPassiveResource_WaitingProcesses(), "resource", null, 1, 1, WaitForAcquire.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(waitForDelayEClass, WaitForDelay.class, "WaitForDelay", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getWaitForDelay_Delay(), ecorePackage.getEDouble(), "delay", null, 1, 1, WaitForDelay.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

...
/**
 * A simulated stack used by simulation threads to store their local variables
 * during their execution
 * @author Steffen Becker
 *
 * @param <T> Content-type of the stacks contents
 */
public class SimulatedStack<T> implements Serializable {
	 ...
	 * @param parent The parent frame of the frame to create
	 ...
	 * @param copyFrame The frame to push on the stack
	 */

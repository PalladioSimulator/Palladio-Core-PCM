...
public class SchedulerSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SchedulerPackage.SCHEDULER_LIBRARY: {
				SchedulerLibrary schedulerLibrary = (SchedulerLibrary)theEObject;
				T result = caseSchedulerLibrary(schedulerLibrary);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchedulerPackage.SYSTEM_CONFIGURATION: {
	 ...
	 * @generated
	 */
	public T caseSchedulerLibrary(SchedulerLibrary object) {
		return null;
	}

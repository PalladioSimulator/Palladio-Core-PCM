...
*/
@javax.ejb.Stateless
public class AudioDBBean extends mediastorerepository.impl.AudioDB implements mediastorerepository.impl.bean.IAudioDBBean {
    public AudioDBBean() {
    }
    ...
    public void setContext(
        mediastorerepository.impl.contexts.IAudioDBContext context) {

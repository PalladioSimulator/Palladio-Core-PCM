...
public class MediaStore_System {
    ...
    */
    private void initInnerComponents() {
        myAssCtx_MediaStore = new mediastorerepository.impl.MediaStore();

        myAssCtx_WebGUI = new mediastorerepository.impl.WebGUI();

        myAssCtx_DigitalWatermarking = new mediastorerepository.impl.DigitalWatermarking();

        myAssCtx_DBAdapter = new mediastorerepository.impl.DBAdapter();

        myAssCtx_AudioDB = new mediastorerepository.impl.AudioDB();

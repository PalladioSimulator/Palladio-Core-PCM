...
/**
 * The {@code DoubleBounds} is an implementation of the {@link Bounds} for the
 * {@code DoubleGenotype} that accepts arrays as well as lists for as bounds.
 * 
 * @author lukasiewycz
 * 
 */
public class DoubleBounds implements Bounds<Double> {
	...
	/**
	 * Constructs a {@code DoubleBounds} with arrays.
	 * 
	 * @param lower
	 *            the lower bounds
	 * @param upper
	...
	/**
	 * Constructs a {@code DoubleBounds} with lists.
	 * 
	 * @param lower
	 *            the lower bounds
	 * @param upper

...
/**
 * The {@code Viewport} is a desktop for {@code Widgets}.
 * 
 * @see Widget
 * @author lukasiewycz
 * 
...
public class Viewport {
	...
	/**
	 * Constructs a {@code Viewport} for {@code Widgets}.
	 * 
	 */
	public Viewport() {
	...
	/**
	 * Creates a widget as a {@code JInternalFrame}.
	 * 
	 * @param widget
	 *            the widget
	 * @return the constructed {@code JInternalFrame}
	 */
	protected JInternalFrame createInternalFrame(final Widget widget) {
		...
		WidgetParameters parameters = widget.getClass().getAnnotation(
		...
		final JInternalFrame inFrame = new JInternalFrame(frameTitle,
	...
	/**
	 * Adds a {@code JInternalFrame}.
	 * 
	 * @param inFrame
	 *            the {@code JInternalFrame} to be added
	 */
	...
	/**
	 * Returns the {@code JInternalFrame} of a {@code Widget} if it exists and
	 * {@code null} otherwise.
	 * 
	 * @param widget
	 *            the widget

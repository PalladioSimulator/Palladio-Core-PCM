...
public class DefaultContentPanel extends ContentPanel {
	...
	/**
	 * Constructs a {@code DefaultContentPanel}.
	 * 
	 ...
	 */
	@Inject
	public DefaultContentPanel(final ExecutionEnvironment executionEnvironment,
			final ModulesPanel modulesPanel, final SelectedPanel selectedPanel,
			final TasksPanel tasksPanel) {
		super();

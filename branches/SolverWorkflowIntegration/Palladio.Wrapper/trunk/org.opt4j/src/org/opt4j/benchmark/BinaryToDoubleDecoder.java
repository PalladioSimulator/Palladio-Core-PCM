...
/**
 * The {@code BinaryToDoubleDecoder}.
 * 
 * @author lukasiewycz
 * 
 */
public class BinaryToDoubleDecoder implements
		Decoder<BinaryString, DoubleString> {
	...
	/**
	 * Constructs a {@code BinaryToDoubleDecoder}.
	 * 
	 * @param n
	 *            the n value
	 * @param bits
	 ...
	 */
	@Inject
	public BinaryToDoubleDecoder(@N
	int n, @Bits
	int bits) {
		super();
		this.n = n;

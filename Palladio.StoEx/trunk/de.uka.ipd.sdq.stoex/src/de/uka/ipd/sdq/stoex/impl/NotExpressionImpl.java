...
public class NotExpressionImpl extends UnaryImpl implements NotExpression {
	...
	public NotificationChain basicSetInner(Unary newInner, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StoexPackage.NOT_EXPRESSION__INNER, oldInner, newInner);
	...
	public void setInner(Unary newInner) {
		if (newInner != inner) {
			...
			if (inner != null)
				msgs = ((InternalEObject)inner).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StoexPackage.NOT_EXPRESSION__INNER, null, msgs);
			if (newInner != null)
				msgs = ((InternalEObject)newInner).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StoexPackage.NOT_EXPRESSION__INNER, null, msgs);
			msgs = basicSetInner(newInner, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoexPackage.NOT_EXPRESSION__INNER, newInner, newInner));
	}

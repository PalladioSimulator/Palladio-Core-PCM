...
/**
 * This is the item provider adapter for a {@link LqnCore.ActivityDefBase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityDefBaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.ACTIVITY_DEF_BASE__CALL_ORDER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.ACTIVITY_DEF_BASE__HOST_DEMAND_CVSQ,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.ACTIVITY_DEF_BASE__HOST_DEMAND_MEAN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.ACTIVITY_DEF_BASE__MAX_SERVICE_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.ACTIVITY_DEF_BASE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.ACTIVITY_DEF_BASE__THINK_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LqnCorePackage.Literals.ACTIVITY_DEF_BASE__RESULT_JOIN_DELAY);
			childrenFeatures.add(LqnCorePackage.Literals.ACTIVITY_DEF_BASE__RESULT_FORWARDING);
			childrenFeatures.add(LqnCorePackage.Literals.ACTIVITY_DEF_BASE__SERVICE_TIME_DISTRIBUTION);
			childrenFeatures.add(LqnCorePackage.Literals.ACTIVITY_DEF_BASE__RESULT_ACTIVITY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LqnCorePackage.Literals.ACTIVITY_DEF_BASE__RESULT_JOIN_DELAY,
				 LqnCoreFactory.eINSTANCE.createOutputResultForwardingANDJoinDelay()));

		newChildDescriptors.add
			(createChildParameter
				(LqnCorePackage.Literals.ACTIVITY_DEF_BASE__RESULT_FORWARDING,
				 LqnCoreFactory.eINSTANCE.createOutputResultForwardingANDJoinDelay()));

		newChildDescriptors.add
			(createChildParameter
				(LqnCorePackage.Literals.ACTIVITY_DEF_BASE__SERVICE_TIME_DISTRIBUTION,
				 LqnCoreFactory.eINSTANCE.createOutputDistributionType()));
		...
		newChildDescriptors.add
			(createChildParameter
				(LqnCorePackage.Literals.ACTIVITY_DEF_BASE__RESULT_ACTIVITY,

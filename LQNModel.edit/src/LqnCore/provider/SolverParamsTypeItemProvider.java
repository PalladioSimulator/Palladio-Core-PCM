...
/**
 * This is the item provider adapter for a {@link LqnCore.SolverParamsType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolverParamsTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.SOLVER_PARAMS_TYPE__COMMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.SOLVER_PARAMS_TYPE__CONV_VAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.SOLVER_PARAMS_TYPE__IT_LIMIT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.SOLVER_PARAMS_TYPE__PRINT_INT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnCorePackage.Literals.SOLVER_PARAMS_TYPE__UNDERRELAX_COEFF,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LqnCorePackage.Literals.SOLVER_PARAMS_TYPE__RESULT_GENERAL);
			childrenFeatures.add(LqnCorePackage.Literals.SOLVER_PARAMS_TYPE__PRAGMA);
		}
	...
	public String getText(Object object) {
		String label = ((SolverParamsType)object).getComment();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LqnCorePackage.Literals.SOLVER_PARAMS_TYPE__RESULT_GENERAL,
				 LqnCoreFactory.eINSTANCE.createResultGeneralType()));

		newChildDescriptors.add
			(createChildParameter
				(LqnCorePackage.Literals.SOLVER_PARAMS_TYPE__PRAGMA,
				 LqnCoreFactory.eINSTANCE.createPragmaType()));
	}

...
public class ComponentResultItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAverageResourceDemandPropertyDescriptor(object);
			addMeanResponseTimePropertyDescriptor(object);
			addAverageNumberOfSentMessagesPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Average Resource Demand feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAverageResourceDemandPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentResult_averageResourceDemand_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentResult_averageResourceDemand_feature", "_UI_ComponentResult_type"),
				 RepositorydecoratorPackage.Literals.COMPONENT_RESULT__AVERAGE_RESOURCE_DEMAND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addMeanResponseTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentResult_meanResponseTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentResult_meanResponseTime_feature", "_UI_ComponentResult_type"),
				 RepositorydecoratorPackage.Literals.COMPONENT_RESULT__MEAN_RESPONSE_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	 ...
	 * @generated
	 */
	protected void addAverageNumberOfSentMessagesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentResult_averageNumberOfSentMessages_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentResult_averageNumberOfSentMessages_feature", "_UI_ComponentResult_type"),
				 RepositorydecoratorPackage.Literals.COMPONENT_RESULT__AVERAGE_NUMBER_OF_SENT_MESSAGES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,

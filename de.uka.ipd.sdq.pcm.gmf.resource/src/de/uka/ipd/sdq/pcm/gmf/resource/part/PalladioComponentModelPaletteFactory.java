...
public class PalladioComponentModelPaletteFactory {
	...
	private PaletteContainer createPcm1Group() {
		...
		paletteContainer
				.add(createProcessingResourceSpecification3CreationTool());
	...
	private ToolEntry createResourceContainer1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(PalladioComponentModelElementTypes.ResourceContainer_2004));
	...
	private ToolEntry createLinkingResource2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(PalladioComponentModelElementTypes.LinkingResource_2005));
	...
	private ToolEntry createProcessingResourceSpecification3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				...
				Collections
						.singletonList(PalladioComponentModelElementTypes.ProcessingResourceSpecification_3003));

 ...
 * @generated
 */
public class LinkingResourceConnectedResourceContainers_LinkingResourceReorientCommand
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getConnectedResourceContainers_LinkingResource().remove(
				getOldTarget());
		getNewSource().getConnectedResourceContainers_LinkingResource().add(
				getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getConnectedResourceContainers_LinkingResource().remove(
				getOldTarget());
		getOldSource().getConnectedResourceContainers_LinkingResource().add(
				getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

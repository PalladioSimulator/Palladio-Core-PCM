 ...
 * @generated
 */
public class ResourceContainerResourceContainerCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected EStructuralFeature getFeatureToSynchronize() {
        return ResourceenvironmentPackage.eINSTANCE.getResourceContainer_NestedResourceContainers__ResourceContainer();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceContainerResourceContainerCompartment_7009SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return ResourceContainer2EditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceContainerResourceContainerCompartment_7009SemanticChildren((View) getHost().getModel());

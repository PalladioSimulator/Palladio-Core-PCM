 ...
 * {@link de.uka.ipd.sdq.context.computed_usage.ComputedUsageContext} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ComputedUsageContextItemProvider extends EntityItemProvider implements IEditingDomainItemProvider,
     ...
     * @generated
     */
    public ComputedUsageContextItemProvider(AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addAssemblyContext_ComputedUsageContextPropertyDescriptor(object);
        }
        return itemPropertyDescriptors;
    }

    /**
     * This adds a property descriptor for the Assembly Context Computed Usage Context feature. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected void addAssemblyContext_ComputedUsageContextPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(),
                getString("_UI_ComputedUsageContext_assemblyContext_ComputedUsageContext_feature"),
    ...
    /**
     * This returns ComputedUsageContext.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ComputedUsageContext_type")

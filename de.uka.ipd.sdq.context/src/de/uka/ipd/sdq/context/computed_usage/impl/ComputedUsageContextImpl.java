 ...
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.ComputedUsageContextImpl#getInput_ComputedUsageContext <em>Input Computed Usage Context</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.ComputedUsageContextImpl#getExternalCallOutput_ComputedUsageContext <em>External Call Output Computed Usage Context</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.ComputedUsageContextImpl#getExternalCallInput_ComputedUsageContext <em>External Call Input Computed Usage Context</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.ComputedUsageContextImpl#getOutput_ComputedUsageContext <em>Output Computed Usage Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComputedUsageContextImpl extends EntityImpl implements ComputedUsageContext {
	...
	/**
	 * The cached value of the '{@link #getInput_ComputedUsageContext() <em>Input Computed Usage Context</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getExternalCallOutput_ComputedUsageContext() <em>External Call Output Computed Usage Context</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInput_ComputedUsageContext(Input newInput_ComputedUsageContext, NotificationChain msgs) {
		Input oldInput_ComputedUsageContext = input_ComputedUsageContext;
		input_ComputedUsageContext = newInput_ComputedUsageContext;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__INPUT_COMPUTED_USAGE_CONTEXT, oldInput_ComputedUsageContext, newInput_ComputedUsageContext);
	...
	public void setInput_ComputedUsageContext(Input newInput_ComputedUsageContext) {
		if (newInput_ComputedUsageContext != input_ComputedUsageContext) {
			...
			if (input_ComputedUsageContext != null)
				msgs = ((InternalEObject)input_ComputedUsageContext).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__INPUT_COMPUTED_USAGE_CONTEXT, null, msgs);
			if (newInput_ComputedUsageContext != null)
				msgs = ((InternalEObject)newInput_ComputedUsageContext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__INPUT_COMPUTED_USAGE_CONTEXT, null, msgs);
			msgs = basicSetInput_ComputedUsageContext(newInput_ComputedUsageContext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__INPUT_COMPUTED_USAGE_CONTEXT, newInput_ComputedUsageContext, newInput_ComputedUsageContext));
	}
	...
	public EList<ExternalCallInput> getExternalCallInput_ComputedUsageContext() {
		if (externalCallInput_ComputedUsageContext == null) {
			externalCallInput_ComputedUsageContext = new EObjectContainmentWithInverseEList<ExternalCallInput>(ExternalCallInput.class, this, ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__EXTERNAL_CALL_INPUT_COMPUTED_USAGE_CONTEXT, ComputedUsagePackage.EXTERNAL_CALL_INPUT__COMPUTED_USAGE_CONTEXT_EXTERNAL_CALL_INPUT);
		}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOutput_ComputedUsageContext(Output newOutput_ComputedUsageContext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__OUTPUT_COMPUTED_USAGE_CONTEXT, oldOutput_ComputedUsageContext, newOutput_ComputedUsageContext);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOutput_ComputedUsageContext(Output newOutput_ComputedUsageContext) {
		if (newOutput_ComputedUsageContext != output_ComputedUsageContext) {
			...
			if (output_ComputedUsageContext != null)
				msgs = ((InternalEObject)output_ComputedUsageContext).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__OUTPUT_COMPUTED_USAGE_CONTEXT, null, msgs);
			if (newOutput_ComputedUsageContext != null)
				msgs = ((InternalEObject)newOutput_ComputedUsageContext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__OUTPUT_COMPUTED_USAGE_CONTEXT, null, msgs);
			msgs = basicSetOutput_ComputedUsageContext(newOutput_ComputedUsageContext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__OUTPUT_COMPUTED_USAGE_CONTEXT, newOutput_ComputedUsageContext, newOutput_ComputedUsageContext));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__EXTERNAL_CALL_INPUT_COMPUTED_USAGE_CONTEXT:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getExternalCallInput_ComputedUsageContext()).basicAdd(otherEnd, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__EXTERNAL_CALL_OUTPUT_COMPUTED_USAGE_CONTEXT:
				return externalCallOutput_ComputedUsageContext != null && !externalCallOutput_ComputedUsageContext.isEmpty();
			case ComputedUsagePackage.COMPUTED_USAGE_CONTEXT__EXTERNAL_CALL_INPUT_COMPUTED_USAGE_CONTEXT:

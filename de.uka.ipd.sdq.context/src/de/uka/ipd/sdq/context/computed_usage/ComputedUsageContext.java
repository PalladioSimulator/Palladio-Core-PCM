...
public interface ComputedUsageContext extends Entity {
    ...
    /**
     * Returns the value of the '<em><b>Branch Probabilities Computed Usage Context</b></em>'
     * containment reference list. The list contents are of type
     * {@link de.uka.ipd.sdq.context.computed_usage.BranchProbability}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Branch Probabilities Computed Usage Context</em>' containment
    ...
    /**
     * Returns the value of the '<em><b>Loopiterations Computed Usage Context</b></em>' containment
     * reference list. The list contents are of type
     * {@link de.uka.ipd.sdq.context.computed_usage.LoopIteration}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Loopiterations Computed Usage Context</em>' containment reference
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Assembly Context Computed Usage Context</em>' reference isn't
    ...
    /**
     * Returns the value of the '<em><b>Input Computed Usage Context</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Input Computed Usage Context</em>' containment reference isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>External Call Output Computed Usage Context</b></em>'
     * containment reference list. The list contents are of type
     * {@link de.uka.ipd.sdq.context.computed_usage.ExternalCallOutput}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>External Call Output Computed Usage Context</em>' containment
     * reference list isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>External Call Input Computed Usage Context</b></em>'
     * containment reference list. The list contents are of type
     * {@link de.uka.ipd.sdq.context.computed_usage.ExternalCallInput}. It is bidirectional and its
     * opposite is '
     ...
     * <p>
     * If the meaning of the '<em>External Call Input Computed Usage Context</em>' containment
     * reference list isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Output Computed Usage Context</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Output Computed Usage Context</em>' containment reference isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 

 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_usage.impl.ExternalCallInputImpl#getParameterCharacterisations_ExternalCallInput
 * <em>Parameter Characterisations External Call Input</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_usage.impl.ExternalCallInputImpl#getExternalCallAction_ExternalCallInput
 * <em>External Call Action External Call Input</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_usage.impl.ExternalCallInputImpl#getComputedUsageContext_ExternalCallInput
...
public class ExternalCallInputImpl extends EObjectImpl implements ExternalCallInput {
    ...
    public EList<VariableUsage> getParameterCharacterisations_ExternalCallInput() {
        if (parameterCharacterisations_ExternalCallInput == null) {
            parameterCharacterisations_ExternalCallInput = new EObjectContainmentEList<VariableUsage>(
            ...
            if (externalCallAction_ExternalCallInput != oldExternalCallAction_ExternalCallInput) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ...
                            oldExternalCallAction_ExternalCallInput, externalCallAction_ExternalCallInput));
            }
        }
    ...
    public ComputedUsageContext getComputedUsageContext_ExternalCallInput() {
        if (eContainerFeatureID() != ComputedUsagePackage.EXTERNAL_CALL_INPUT__COMPUTED_USAGE_CONTEXT_EXTERNAL_CALL_INPUT)
            return null;
    ...
    public NotificationChain basicSetComputedUsageContext_ExternalCallInput(
            ComputedUsageContext newComputedUsageContext_ExternalCallInput, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newComputedUsageContext_ExternalCallInput,
    ...
    public void setComputedUsageContext_ExternalCallInput(ComputedUsageContext newComputedUsageContext_ExternalCallInput) {
        if (newComputedUsageContext_ExternalCallInput != eInternalContainer()
                || (eContainerFeatureID() != ComputedUsagePackage.EXTERNAL_CALL_INPUT__COMPUTED_USAGE_CONTEXT_EXTERNAL_CALL_INPUT && newComputedUsageContext_ExternalCallInput != null)) {
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case ComputedUsagePackage.EXTERNAL_CALL_INPUT__EXTERNAL_CALL_ACTION_EXTERNAL_CALL_INPUT:
            if (resolve)
                return getExternalCallAction_ExternalCallInput();
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case ComputedUsagePackage.EXTERNAL_CALL_INPUT__PARAMETER_CHARACTERISATIONS_EXTERNAL_CALL_INPUT:
            return parameterCharacterisations_ExternalCallInput != null
                    && !parameterCharacterisations_ExternalCallInput.isEmpty();
        case ComputedUsagePackage.EXTERNAL_CALL_INPUT__EXTERNAL_CALL_ACTION_EXTERNAL_CALL_INPUT:

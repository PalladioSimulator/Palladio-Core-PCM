 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.BranchProbabilityImpl#getProbability <em>Probability</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.BranchProbabilityImpl#getBranchtransition_BranchProbability <em>Branchtransition Branch Probability</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BranchProbabilityImpl extends EObjectImpl implements BranchProbability {
	...
	public void setProbability(double newProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComputedUsagePackage.BRANCH_PROBABILITY__PROBABILITY, oldProbability, probability));
	}
	...
	public AbstractBranchTransition getBranchtransition_BranchProbability() {
		if (branchtransition_BranchProbability != null && branchtransition_BranchProbability.eIsProxy()) {
			...
			if (branchtransition_BranchProbability != oldBranchtransition_BranchProbability) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComputedUsagePackage.BRANCH_PROBABILITY__BRANCHTRANSITION_BRANCH_PROBABILITY, oldBranchtransition_BranchProbability, branchtransition_BranchProbability));
			}
		}
	...
	public void setBranchtransition_BranchProbability(AbstractBranchTransition newBranchtransition_BranchProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComputedUsagePackage.BRANCH_PROBABILITY__BRANCHTRANSITION_BRANCH_PROBABILITY, oldBranchtransition_BranchProbability, branchtransition_BranchProbability));
	}

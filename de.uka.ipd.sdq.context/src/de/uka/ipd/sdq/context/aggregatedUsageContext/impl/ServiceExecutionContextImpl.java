 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.ServiceExecutionContextImpl#getGlobalExecutionFrequency
 * <em>Global Execution Frequency</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.ServiceExecutionContextImpl#getAllocationContext_ServiceExecutionContext
 * <em>Allocation Context Service Execution Context</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.ServiceExecutionContextImpl#getDescribedSEFF_ServiceExecutionContext
 * <em>Described SEFF Service Execution Context</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.ServiceExecutionContextImpl#getAggregatedResourceDemands_ServiceExecutionContext
 * <em>Aggregated Resource Demands Service Execution Context</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.ServiceExecutionContextImpl#getUsageScenario_ServiceExecutionContext
 * <em>Usage Scenario Service Execution Context</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.ServiceExecutionContextImpl#getSentAggregatedCommunications_ServiceExecutionContext
 * <em>Sent Aggregated Communications Service Execution Context</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.ServiceExecutionContextImpl#getReceivedAggregatedCommunication_AggregatedCommunication
...
public class ServiceExecutionContextImpl extends EObjectImpl implements ServiceExecutionContext {
    ...
    public void setGlobalExecutionFrequency(double newGlobalExecutionFrequency) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ...
                    oldGlobalExecutionFrequency, globalExecutionFrequency));
    }
            ...
            if (allocationContext_ServiceExecutionContext != oldAllocationContext_ServiceExecutionContext) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            oldAllocationContext_ServiceExecutionContext, allocationContext_ServiceExecutionContext));
            }
        }
    ...
    public void setAllocationContext_ServiceExecutionContext(
            AllocationContext newAllocationContext_ServiceExecutionContext) {
            ...
            if (describedSEFF_ServiceExecutionContext != oldDescribedSEFF_ServiceExecutionContext) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            oldDescribedSEFF_ServiceExecutionContext, describedSEFF_ServiceExecutionContext));
            }
        }
    ...
    public EList<AggregatedResourceDemand> getAggregatedResourceDemands_ServiceExecutionContext() {
        if (aggregatedResourceDemands_ServiceExecutionContext == null) {
            aggregatedResourceDemands_ServiceExecutionContext = new EObjectContainmentEList<AggregatedResourceDemand>(
            ...
            if (usageScenario_ServiceExecutionContext != oldUsageScenario_ServiceExecutionContext) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            oldUsageScenario_ServiceExecutionContext, usageScenario_ServiceExecutionContext));
            }
        }
    ...
    public EList<AggregatedCommunication> getSentAggregatedCommunications_ServiceExecutionContext() {
        if (sentAggregatedCommunications_ServiceExecutionContext == null) {
            sentAggregatedCommunications_ServiceExecutionContext = new EObjectContainmentEList<AggregatedCommunication>(
    ...
    public EList<AggregatedCommunication> getReceivedAggregatedCommunication_AggregatedCommunication() {
        if (receivedAggregatedCommunication_AggregatedCommunication == null) {
            receivedAggregatedCommunication_AggregatedCommunication = new EObjectWithInverseResolvingEList<AggregatedCommunication>(
                    AggregatedCommunication.class,
                    this,
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__RECEIVED_AGGREGATED_COMMUNICATION_AGGREGATED_COMMUNICATION:
            return ((InternalEList<InternalEObject>) (InternalEList<?>) getReceivedAggregatedCommunication_AggregatedCommunication())
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__AGGREGATED_RESOURCE_DEMANDS_SERVICE_EXECUTION_CONTEXT:
            return ((InternalEList<?>) getAggregatedResourceDemands_ServiceExecutionContext()).basicRemove(otherEnd,
                    msgs);
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__SENT_AGGREGATED_COMMUNICATIONS_SERVICE_EXECUTION_CONTEXT:
            return ((InternalEList<?>) getSentAggregatedCommunications_ServiceExecutionContext()).basicRemove(otherEnd,
                    msgs);
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__RECEIVED_AGGREGATED_COMMUNICATION_AGGREGATED_COMMUNICATION:
            return ((InternalEList<?>) getReceivedAggregatedCommunication_AggregatedCommunication()).basicRemove(
                    otherEnd, msgs);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__ALLOCATION_CONTEXT_SERVICE_EXECUTION_CONTEXT:
            if (resolve)
                return getAllocationContext_ServiceExecutionContext();
        ...
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__DESCRIBED_SEFF_SERVICE_EXECUTION_CONTEXT:
            if (resolve)
                return getDescribedSEFF_ServiceExecutionContext();
        ...
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__USAGE_SCENARIO_SERVICE_EXECUTION_CONTEXT:
            if (resolve)
                return getUsageScenario_ServiceExecutionContext();
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__AGGREGATED_RESOURCE_DEMANDS_SERVICE_EXECUTION_CONTEXT:
            ...
            getAggregatedResourceDemands_ServiceExecutionContext().addAll(
        ...
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__SENT_AGGREGATED_COMMUNICATIONS_SERVICE_EXECUTION_CONTEXT:
            ...
            getSentAggregatedCommunications_ServiceExecutionContext().addAll(
                    (Collection<? extends AggregatedCommunication>) newValue);
            return;
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__RECEIVED_AGGREGATED_COMMUNICATION_AGGREGATED_COMMUNICATION:
            getReceivedAggregatedCommunication_AggregatedCommunication().clear();
            getReceivedAggregatedCommunication_AggregatedCommunication().addAll(
                    (Collection<? extends AggregatedCommunication>) newValue);
            return;
        }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__AGGREGATED_RESOURCE_DEMANDS_SERVICE_EXECUTION_CONTEXT:
            return aggregatedResourceDemands_ServiceExecutionContext != null
                    && !aggregatedResourceDemands_ServiceExecutionContext.isEmpty();
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__USAGE_SCENARIO_SERVICE_EXECUTION_CONTEXT:
            return usageScenario_ServiceExecutionContext != null;
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__SENT_AGGREGATED_COMMUNICATIONS_SERVICE_EXECUTION_CONTEXT:
            return sentAggregatedCommunications_ServiceExecutionContext != null
                    && !sentAggregatedCommunications_ServiceExecutionContext.isEmpty();
        case AggregatedUsageContextPackage.SERVICE_EXECUTION_CONTEXT__RECEIVED_AGGREGATED_COMMUNICATION_AGGREGATED_COMMUNICATION:
            return receivedAggregatedCommunication_AggregatedCommunication != null
                    && !receivedAggregatedCommunication_AggregatedCommunication.isEmpty();
        }

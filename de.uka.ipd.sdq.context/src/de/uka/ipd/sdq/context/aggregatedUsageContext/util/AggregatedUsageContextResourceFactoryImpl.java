 ...
 * <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.context.aggregatedUsageContext.util.AggregatedUsageContextResourceImpl
 * @generated
 */
public class AggregatedUsageContextResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Resource createResource(URI uri) {
		XMLResource result = new AggregatedUsageContextResourceImpl(uri);

 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.AggregatedCommunicationImpl#getAverageMessageSize
 * <em>Average Message Size</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.AggregatedCommunicationImpl#getAverageMessageFrequency
 * <em>Average Message Frequency</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.AggregatedCommunicationImpl#getReceiver_AggregatedCommunication
 * <em>Receiver Aggregated Communication</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.AggregatedCommunicationImpl#getUsedCommunicationLinkResourceSpecification_AggregatedCommunication
...
public class AggregatedCommunicationImpl extends EObjectImpl implements AggregatedCommunication {
    ...
    public void setAverageMessageSize(double newAverageMessageSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ...
                    oldAverageMessageSize, averageMessageSize));
    }
    ...
    public void setAverageMessageFrequency(double newAverageMessageFrequency) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ...
                    oldAverageMessageFrequency, averageMessageFrequency));
    }
            ...
            if (receiver_AggregatedCommunication != oldReceiver_AggregatedCommunication) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ...
                            oldReceiver_AggregatedCommunication, receiver_AggregatedCommunication));
            }
        }
    ...
    public NotificationChain basicSetReceiver_AggregatedCommunication(
            ServiceExecutionContext newReceiver_AggregatedCommunication, NotificationChain msgs) {
    ...
    public void setReceiver_AggregatedCommunication(ServiceExecutionContext newReceiver_AggregatedCommunication) {
        if (newReceiver_AggregatedCommunication != receiver_AggregatedCommunication) {
            ...
            if (receiver_AggregatedCommunication != null)
                msgs = ((InternalEObject) receiver_AggregatedCommunication)
                        .eInverseRemove(
                                this,
    ...
    public CommunicationLinkResourceSpecification getUsedCommunicationLinkResourceSpecification_AggregatedCommunication() {
        if (usedCommunicationLinkResourceSpecification_AggregatedCommunication != null
                && usedCommunicationLinkResourceSpecification_AggregatedCommunication.eIsProxy()) {
            ...
            if (usedCommunicationLinkResourceSpecification_AggregatedCommunication != oldUsedCommunicationLinkResourceSpecification_AggregatedCommunication) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            usedCommunicationLinkResourceSpecification_AggregatedCommunication));
            }
        }
    ...
    public void setUsedCommunicationLinkResourceSpecification_AggregatedCommunication(
            CommunicationLinkResourceSpecification newUsedCommunicationLinkResourceSpecification_AggregatedCommunication) {
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case AggregatedUsageContextPackage.AGGREGATED_COMMUNICATION__RECEIVER_AGGREGATED_COMMUNICATION:
            if (resolve)
                return getReceiver_AggregatedCommunication();
        ...
        case AggregatedUsageContextPackage.AGGREGATED_COMMUNICATION__USED_COMMUNICATION_LINK_RESOURCE_SPECIFICATION_AGGREGATED_COMMUNICATION:
            if (resolve)
                return getUsedCommunicationLinkResourceSpecification_AggregatedCommunication();

...
public class AggregatedUsageContextFactoryImpl extends EFactoryImpl implements AggregatedUsageContextFactory {
    ...
    public static AggregatedUsageContextFactory init() {
        try {
            AggregatedUsageContextFactory theAggregatedUsageContextFactory = (AggregatedUsageContextFactory) EPackage.Registry.INSTANCE
                    .getEFactory("http:///context/aggregatedUsageContext.ecore");

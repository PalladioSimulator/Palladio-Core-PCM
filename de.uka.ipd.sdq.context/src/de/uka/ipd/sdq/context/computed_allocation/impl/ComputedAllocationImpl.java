 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_allocation.impl.ComputedAllocationImpl#getComputedAllocationContexts_ComputedAllocation
...
public class ComputedAllocationImpl extends EObjectImpl implements ComputedAllocation {
    ...
    public EList<ComputedAllocationContext> getComputedAllocationContexts_ComputedAllocation() {
        if (computedAllocationContexts_ComputedAllocation == null) {
            computedAllocationContexts_ComputedAllocation = new EObjectContainmentEList<ComputedAllocationContext>(
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case ComputedAllocationPackage.COMPUTED_ALLOCATION__COMPUTED_ALLOCATION_CONTEXTS_COMPUTED_ALLOCATION:
            ...
            getComputedAllocationContexts_ComputedAllocation().addAll(
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case ComputedAllocationPackage.COMPUTED_ALLOCATION__COMPUTED_ALLOCATION_CONTEXTS_COMPUTED_ALLOCATION:
            return computedAllocationContexts_ComputedAllocation != null
                    && !computedAllocationContexts_ComputedAllocation.isEmpty();
        }

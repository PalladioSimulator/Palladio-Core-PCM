 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_allocation.impl.ComputedAllocationContextImpl#getResourceDemands_ComputedAllocationContext
 * <em>Resource Demands Computed Allocation Context</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_allocation.impl.ComputedAllocationContextImpl#getUsageContext_ComputedAllocationContext
 * <em>Usage Context Computed Allocation Context</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_allocation.impl.ComputedAllocationContextImpl#getAllocationContext_ComputedAllocationContext
...
public class ComputedAllocationContextImpl extends EntityImpl implements ComputedAllocationContext {
    ...
    public EList<ResourceDemand> getResourceDemands_ComputedAllocationContext() {
        if (resourceDemands_ComputedAllocationContext == null) {
            resourceDemands_ComputedAllocationContext = new EObjectContainmentEList<ResourceDemand>(
            ...
            if (usageContext_ComputedAllocationContext != oldUsageContext_ComputedAllocationContext) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            oldUsageContext_ComputedAllocationContext, usageContext_ComputedAllocationContext));
            }
        }
    ...
    public AllocationContext getAllocationContext_ComputedAllocationContext() {
        if (allocationContext_ComputedAllocationContext != null
                && allocationContext_ComputedAllocationContext.eIsProxy()) {
            ...
            if (allocationContext_ComputedAllocationContext != oldAllocationContext_ComputedAllocationContext) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            oldAllocationContext_ComputedAllocationContext, allocationContext_ComputedAllocationContext));
            }
        }
    ...
    public void setAllocationContext_ComputedAllocationContext(
            AllocationContext newAllocationContext_ComputedAllocationContext) {
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case ComputedAllocationPackage.COMPUTED_ALLOCATION_CONTEXT__USAGE_CONTEXT_COMPUTED_ALLOCATION_CONTEXT:
            if (resolve)
                return getUsageContext_ComputedAllocationContext();
        ...
        case ComputedAllocationPackage.COMPUTED_ALLOCATION_CONTEXT__ALLOCATION_CONTEXT_COMPUTED_ALLOCATION_CONTEXT:
            if (resolve)
                return getAllocationContext_ComputedAllocationContext();
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case ComputedAllocationPackage.COMPUTED_ALLOCATION_CONTEXT__RESOURCE_DEMANDS_COMPUTED_ALLOCATION_CONTEXT:
            return resourceDemands_ComputedAllocationContext != null
                    && !resourceDemands_ComputedAllocationContext.isEmpty();
        case ComputedAllocationPackage.COMPUTED_ALLOCATION_CONTEXT__USAGE_CONTEXT_COMPUTED_ALLOCATION_CONTEXT:

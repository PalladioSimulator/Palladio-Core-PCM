 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_allocation.impl.ResourceDemandImpl#getParametricResourceDemand_ResourceDemand
 * <em>Parametric Resource Demand Resource Demand</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_allocation.impl.ResourceDemandImpl#getSpecification_ResourceDemand
...
public class ResourceDemandImpl extends EObjectImpl implements ResourceDemand {
            ...
            if (parametricResourceDemand_ResourceDemand != oldParametricResourceDemand_ResourceDemand) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ...
                            oldParametricResourceDemand_ResourceDemand, parametricResourceDemand_ResourceDemand));
            }
        }
    ...
    public void setParametricResourceDemand_ResourceDemand(
            ParametricResourceDemand newParametricResourceDemand_ResourceDemand) {
     ...
     * @generated
     */
    public NotificationChain basicSetSpecification_ResourceDemand(PCMRandomVariable newSpecification_ResourceDemand,
    ...
    public void setSpecification_ResourceDemand(PCMRandomVariable newSpecification_ResourceDemand) {
        if (newSpecification_ResourceDemand != specification_ResourceDemand) {
            ...
            if (specification_ResourceDemand != null)
                msgs = ((InternalEObject) specification_ResourceDemand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case ComputedAllocationPackage.RESOURCE_DEMAND__PARAMETRIC_RESOURCE_DEMAND_RESOURCE_DEMAND:
            if (resolve)
                return getParametricResourceDemand_ResourceDemand();

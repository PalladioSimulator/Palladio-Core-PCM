 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.context.computed_allocation.ResourceDemand#getParametricResourceDemand_ResourceDemand <em>Parametric Resource Demand Resource Demand</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.context.computed_allocation.ResourceDemand#getSpecification_ResourceDemand <em>Specification Resource Demand</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ResourceDemand extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Parametric Resource Demand Resource Demand</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Parametric Resource Demand Resource Demand</em>' reference isn't clear,
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.context.computed_allocation.ResourceDemand#getParametricResourceDemand_ResourceDemand <em>Parametric Resource Demand Resource Demand</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Parametric Resource Demand Resource Demand</em>' reference.
	...
	/**
	 * Returns the value of the '<em><b>Specification Resource Demand</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Specification Resource Demand</em>' containment reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Specification Resource Demand</em>' containment reference.

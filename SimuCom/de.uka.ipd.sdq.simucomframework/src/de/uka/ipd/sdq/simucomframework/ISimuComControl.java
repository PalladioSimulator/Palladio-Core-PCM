...
/**
 * Control interface for the SimuCom Framework. It defines methods, which are responsible for
 * starting and stopping the simulation.
 * 
 * The code generated for each SimuCom instance contains the class main.SimuComControl that extends
 * {@link AbstractMain} and provides the missing information.
 * 
 * @author Roman Andrej
 * @author Steffen Becker
 * @deprecated This interface has been replaced by the more general interface
 *             {@link ISimulationControl}.
 */

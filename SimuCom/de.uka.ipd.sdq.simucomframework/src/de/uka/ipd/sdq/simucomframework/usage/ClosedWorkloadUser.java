...
public class ClosedWorkloadUser extends SimuComSimProcess implements IUser {
    ...
    public void scenarioRunner(final SimuComSimProcess thread) {
        final double thinkTimeEvaluation = Context.evaluateStatic(this.thinkTime, Double.class, null);
     ...
     * {@link SimuComSimProcess} is used. In order to be able to distinguish between the different

...
public class SimProcessorSharingResourceWindows extends AbstractActiveResource {
    ...
    private static final Logger LOGGER = Logger.getLogger(SimProcessorSharingResourceWindows.class);
     ...
     * @return
     */
    private int getLastCoreProcessWasRunningOn(final ISchedulableProcess process) {
    ...
    private void putProcessOnCore(final ISchedulableProcess process, final double demand, final int core) {
        if (all_processes.containsKey(process)) {

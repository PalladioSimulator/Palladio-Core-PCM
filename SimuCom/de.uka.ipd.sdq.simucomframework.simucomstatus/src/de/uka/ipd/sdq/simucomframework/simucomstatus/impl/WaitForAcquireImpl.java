...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Wait For Acquire</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.WaitForAcquireImpl#getResource <em>
 * Resource</em>}</li>
 * </ul>
 * </p>
 *
            ...
            if (resource != oldResource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            SimucomstatusPackage.WAIT_FOR_ACQUIRE__RESOURCE, oldResource, resource));
            }
        }
        return resource;
    }
    ...
    public NotificationChain basicSetResource(PassiveResource newResource, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SimucomstatusPackage.WAIT_FOR_ACQUIRE__RESOURCE, oldResource, newResource);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newResource != resource) {
            ...
            if (resource != null)
                msgs = ((InternalEObject) resource).eInverseRemove(this,
                        SimucomstatusPackage.PASSIVE_RESOURCE__WAITING_PROCESSES, PassiveResource.class, msgs);
            if (newResource != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.WAIT_FOR_ACQUIRE__RESOURCE,

 ...
 * <em><b>Simulated Resources</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.SimulatedResourcesImpl#getActiveResources
 * <em>Active Resources</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.SimulatedResourcesImpl#getPassiveResources
...
public class SimulatedResourcesImpl extends EObjectImpl implements SimulatedResources {
    /**
     * The cached value of the '{@link #getActiveResources() <em>Active Resources</em>}' containment
    ...
    /**
     * The cached value of the '{@link #getPassiveResources() <em>Passive Resources</em>}'
    ...
    public EList<ActiveResouce> getActiveResources() {
        if (activeResources == null) {
            activeResources = new EObjectContainmentEList<ActiveResouce>(ActiveResouce.class, this,
                    SimucomstatusPackage.SIMULATED_RESOURCES__ACTIVE_RESOURCES);
        }
    ...
    public EList<PassiveResource> getPassiveResources() {
        if (passiveResources == null) {
            passiveResources = new EObjectContainmentEList<PassiveResource>(PassiveResource.class, this,
                    SimucomstatusPackage.SIMULATED_RESOURCES__PASSIVE_RESOURCES);
        }

...
public interface SimucomstatusFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Simu Com Status</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Simulated Processes</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Simulated Resources</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Active Resouce</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Wait For Demand</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Wait For Acquire</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Wait For Delay</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 

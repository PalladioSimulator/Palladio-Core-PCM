...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Wait For Demand</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.WaitForDemand#getDemand <em>Demand</em>}
 * </li>
 * <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.WaitForDemand#getResource <em>Resource
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public interface WaitForDemand extends Action {
    /**
     * Returns the value of the '<em><b>Demand</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Demand</em>' attribute isn't clear, there really should be more of
     * a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * 
     * @param value
     *            the new value of the '<em>Demand</em>' attribute.
     * @see #getDemand()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Resource</b></em>' reference. It is bidirectional and its
     * opposite is '
     * {@link de.uka.ipd.sdq.simucomframework.simucomstatus.ActiveResouce#getWaitingDemands
     * <em>Waiting Demands</em>}'. <!-- begin-user-doc -->
     * <p>

 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.ActionImpl#getActionStartTime <em>
 * Action Start Time</em>}</li>
 * <li>{@link de.uka.ipd.sdq.simucomframework.simucomstatus.impl.ActionImpl#getActionDuration <em>
 * Action Duration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ActionImpl extends EObjectImpl implements Action {
    /**
     * The default value of the '{@link #getActionStartTime() <em>Action Start Time</em>}'
    ...
    public void setActionStartTime(double newActionStartTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SimucomstatusPackage.ACTION__ACTION_START_TIME,
                    oldActionStartTime, actionStartTime));
    }

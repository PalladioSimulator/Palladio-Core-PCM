...
public class StaticPriorityBoostConfigurationItemProvider
	 ...
	 * @generated
	 */
	public StaticPriorityBoostConfigurationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigurationPackage.Literals.STATIC_PRIORITY_BOOST_CONFIGURATION__STARVATION_BOOST);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StaticPriorityBoostConfiguration"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_StaticPriorityBoostConfiguration_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StaticPriorityBoostConfiguration.class)) {

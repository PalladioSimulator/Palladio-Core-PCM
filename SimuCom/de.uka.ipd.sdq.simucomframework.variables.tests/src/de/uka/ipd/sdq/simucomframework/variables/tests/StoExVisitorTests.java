...
public class StoExVisitorTests extends TestCase {
	...
	public void testFunctions() {
		...
		Assert.assertEquals(2,StackContext.evaluateStatic("Min(2,5)"));
		Assert.assertEquals(2.3,StackContext.evaluateStatic("Min(2.3,5.3)"));
		logger.info(MaxFunction.MAX_FUNCTION_NAME);
		Assert.assertEquals(5,StackContext.evaluateStatic("Max(2,5)"));
		Assert.assertEquals(5.3,StackContext.evaluateStatic("Max(2.3,5.3)"));
		logger.info(MinDeviationFunction.MIN_DEVIATION_FUNCTION_NAME);
		Assert.assertEquals(5, StackContext.evaluateStatic("MinDeviation(10, 5.0, 0.1)"));
		Assert.assertEquals(4, StackContext.evaluateStatic("MinDeviation(10, 5.0, 0.6)"));
		Assert.assertEquals(5.0, StackContext.evaluateStatic("MinDeviation(10.0, 5.0, 0.1)"));
		Assert.assertEquals(4.0, StackContext.evaluateStatic("MinDeviation(10.0, 5.0, 0.6)"));
		logger.info(MaxDeviationFunction.MAX_DEVIATION_FUNCTION_NAME);
		Assert.assertEquals(15, StackContext.evaluateStatic("MaxDeviation(10, 5.0, 0.1)"));
		Assert.assertEquals(16, StackContext.evaluateStatic("MaxDeviation(10, 5.0, 0.6)"));
		Assert.assertEquals(15.0, StackContext.evaluateStatic("MaxDeviation(10.0, 5.0, 0.1)"));
		Assert.assertEquals(16.0, StackContext.evaluateStatic("MaxDeviation(10.0, 5.0, 0.6)"));
	}

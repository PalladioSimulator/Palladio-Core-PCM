...
public class SimuComWorkflowLauncher extends
	...
	protected ArrayList<LoggerAppenderStruct> setupLogging(Level logLevel) throws CoreException {
		...
		loggerList.add(setupLogger("org.palladiosimulator.probeframework", logLevel, Level.DEBUG == logLevel ? DETAILED_LOG_PATTERN : SHORT_LOG_PATTERN));
		loggerList.add(setupLogger("org.palladiosimulator.recorderframework", logLevel, Level.DEBUG == logLevel ? DETAILED_LOG_PATTERN : SHORT_LOG_PATTERN));

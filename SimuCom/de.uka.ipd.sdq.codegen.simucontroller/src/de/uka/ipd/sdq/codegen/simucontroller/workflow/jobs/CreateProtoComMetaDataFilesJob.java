...
public class CreateProtoComMetaDataFilesJob extends AbstractCreateMetaDataFilesJob implements IJob {
    ...
    private final static String[] BUNDLES = new String[] {
            ...
            "de.uka.ipd.sdq.sensorframework", "de.uka.ipd.sdq.simucomframework.variables", "org.apache.log4j",
            "org.eclipse.osgi", "de.uka.ipd.sdq.scheduler", "org.jscience", "de.uka.ipd.sdq.probespec.framework",
            "de.uka.ipd.sdq.pipesandfilters", "de.uka.ipd.sdq.pipesandfilters.framework",

...
public class FeatureOptionsTab extends AbstractLaunchConfigurationTab {
	...
	public void createControl(Composite parent) {
		...
		TabHelper.createFileInputSection(featureConfigGroup, modifyListener,
				DEFAULT_FEATURE_CONFIGURATION_FILE_LABEL,
				ConstantsContainer.FEATURECONFIG_EXTENSION, textFeatureConfig,
				getShell(), ConstantsContainer.DEFAULT_FEATURE_CONFIGURATION_FILE);
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try {
			simulateFailuresButton.setSelection(configuration.getAttribute(
					ConstantsContainer.SIMULATE_FAILURES, true));
		} catch (CoreException e) {
			simulateFailuresButton.setSelection(false);
		}
		try {
			textFeatureConfig.setText(configuration.getAttribute(
					ConstantsContainer.FEATURE_CONFIG, ConstantsContainer.DEFAULT_FEATURE_CONFIGURATION_FILE));
		} catch (CoreException e) {
...
/*	TODO: Maybe this can be used to check whether models are needed
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(
				ConstantsContainer.SIMULATE_LINKING_RESOURCES, DEFAULT_SIMULATE_LINKING_RESOURCES);
		configuration.setAttribute(
				ConstantsContainer.SIMULATE_FAILURES, DEFAULT_SIMULATE_FAILURES);
;		configuration.setAttribute(ConstantsContainer.FEATURE_CONFIG,

...
public class FeatureOptionsTab extends AbstractLaunchConfigurationTab {
	...
	private static final String SIMULATE_NETWORK_EXPLANATION = "Latency is always simulated if linking resources connect containers. No linking resource implies zero latency. The linking resource is treated as a FCFS resource.";

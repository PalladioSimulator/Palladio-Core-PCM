	...
	private AllocationContext findAllocationContext(
		...
		for (AllocationContext context : models.getAllocation().getAllocationContexts_Allocation()) {
			if (context.getResourceContainer_AllocationContext() == resourceContainer
				...
				ProvidedRole providedRole = context
				.getAssemblyContext_AllocationContext()
				.getEncapsulatedComponent__AssemblyContext()
				.getProvidedRoles_InterfaceProvidingEntity().get(0);
				if (providedRole instanceof OperationProvidedRole) {
					OperationProvidedRole role = (OperationProvidedRole) providedRole;
					...
					InfrastructureProvidedRole role = (InfrastructureProvidedRole) providedRole;

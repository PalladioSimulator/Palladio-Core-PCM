...
public class EventsTransformationJob 
	 ...
	 */
	public EventsTransformationJob(AbstractCodeGenerationWorkflowRunConfiguration configuration) {
		super();
	...
	public void execute(IProgressMonitor monitor) throws JobFailedException,
		...
		// build file paths
		URI traceFileURI = URI.createURI(getProject(configuration.getPluginID())
								.getFolder(ConstantsContainer.TRACESFOLDER)

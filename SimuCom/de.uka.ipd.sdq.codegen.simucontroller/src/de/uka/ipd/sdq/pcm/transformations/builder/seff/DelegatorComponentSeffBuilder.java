...
public class DelegatorComponentSeffBuilder extends AbstractSeffBuilder implements ISeffBuilder {
     ...
     * 
     * @param signatureDependentDemand
    ...
    public void build() {
        for (OperationSignature providedService : domainProvRole.getProvidedInterface__OperationProvidedRole()
    ...
    private void setSignatureInActions(ArrayList<AbstractActionDescriptor> actions, OperationSignature sig) {
     ...
     * 
     * @see
     * de.uka.sdq.pcm.transformations.builder.seff.ISeffBuilder#getSeff(de.uka.ipd.sdq.pcm.repository
     * .Signature)
     */

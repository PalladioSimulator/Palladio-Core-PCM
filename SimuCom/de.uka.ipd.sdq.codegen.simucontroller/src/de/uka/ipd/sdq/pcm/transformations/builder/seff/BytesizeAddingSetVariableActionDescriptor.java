 ...
 *
 */
public class BytesizeAddingSetVariableActionDescriptor extends
		SetVariableActionDescriptor implements ISignatureDependentAction {
...
//	}
	...
	public BytesizeAddingSetVariableActionDescriptor(
			VariableUsage variableUsage, Modifier modifier) {
		super(variableUsage);
	...
	protected Collection<? extends VariableUsage> getSignatureDependentVariableUsages(OperationSignature currentSignature){

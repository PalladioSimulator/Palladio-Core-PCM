...
public class Request extends EventSimEntity {
     ...
     *            the User that has issued the Request
     */
    public Request(final EventSimModel model, final EntryLevelSystemCall call, final User user) {
        super(model, "Request");
        this.call = call;
        this.user = user;
    ...
    public String getName() {
        return "Request#" + this.getEntityId() + " of " + this.getUser().getName();
    }
     ...
     */
    public void passivate(AbstractSimEvent<EventSimModel, Request> activationEvent) {
     ...
     * 
     * @see #passivate(AbstractSimEvent)
     */

...
public class SchedulerAdapterFactory extends AdapterFactoryImpl {
	...
	protected SchedulerSwitch<Adapter> modelSwitch =
		new SchedulerSwitch<Adapter>() {
			@Override
			public Adapter caseSchedulerLibrary(SchedulerLibrary object) {
				return createSchedulerLibraryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link scheduler.SchedulerLibrary <em>Library</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link scheduler.SystemConfiguration <em>System Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

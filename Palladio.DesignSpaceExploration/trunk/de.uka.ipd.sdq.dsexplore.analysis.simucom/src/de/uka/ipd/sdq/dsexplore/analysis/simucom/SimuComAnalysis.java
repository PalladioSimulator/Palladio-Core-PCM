...
public class SimuComAnalysis extends SimuComWorkflowLauncher implements IAnalysis {
	...
	private String getExperimentName(PCMPhenotype pheno) {
		return this.initialExperimentName+" "+pheno.getGenotypeID().hashCode();
	}

	
/**
 * FIXME: This method should not depend on the state of the blackboard anymore... 
 * 
 * @param pheno
 * @param usageScenario
 * @return
...
//	}	
	...
	public void initialise(ILaunchConfiguration configuration) throws CoreException {
		...
		this.initialExperimentName = configuration.getAttribute(SimuComConfig.EXPERIMENT_RUN, "");
...
//		}
		...
		initialiseCriteria(pcmInstance, configuration, scenarios);
	}

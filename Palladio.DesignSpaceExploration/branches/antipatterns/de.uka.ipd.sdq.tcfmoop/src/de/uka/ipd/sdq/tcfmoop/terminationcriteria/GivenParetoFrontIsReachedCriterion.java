...
public class GivenParetoFrontIsReachedCriterion extends
	...
	public StringBuilder getOutputInformation() {
		...
		this.outputInformation.append("Criterion Name: Given Pareto Front Is Reached" + '\n');
		this.outputInformation.append("Front Coverage: " + this.currentPercentagesCovered + "/" + this.requiredPercentagesCovered + '\n');

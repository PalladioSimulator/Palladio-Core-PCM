...
public class NoNewParetoOptimalCandidatesFoundConfig extends
	...
	public NoNewParetoOptimalCandidatesFoundConfig(){
		this.criterionName = TerminationCriteriaNames.NO_NEW_PARETO_OPTIMAL_CANDIDATES_FOUND;
	}
	...
	public boolean validateConfiguration() {
		if (this.criterionName != TerminationCriteriaNames.NO_NEW_PARETO_OPTIMAL_CANDIDATES_FOUND

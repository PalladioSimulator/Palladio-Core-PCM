...
public class InsignificantParetoFrontChangeConfig extends AbstractConfiguration {
	...
	public InsignificantParetoFrontChangeConfig(){
		this.criterionName = TerminationCriteriaNames.INSIGNIFICANT_PARETO_FRONT_CHANGE;
	}
	...
	public boolean validateConfiguration() {
		if (this.criterionName != TerminationCriteriaNames.INSIGNIFICANT_PARETO_FRONT_CHANGE ||

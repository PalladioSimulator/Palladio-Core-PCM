package de.uka.ipd.sdq.dsexplore.opt4j;
 ...
 */
public class DSEOpt4JActivator extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "de.uka.ipd.sdq.dsexplore.opt4j";

	// The shared instance
	private static DSEOpt4JActivator plugin;
	
	/**
	 * The constructor
	 */
	public DSEOpt4JActivator() {
		plugin= this;
	 ...
	 */
	public static DSEOpt4JActivator getDefault() {
		return plugin;
	}

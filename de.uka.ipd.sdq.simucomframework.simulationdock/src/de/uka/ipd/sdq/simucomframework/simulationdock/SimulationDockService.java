...
public interface SimulationDockService {
     ...
     * Installs, and prepares the simulation.
     * 
     * @param config
     *            The simulation configuration object describing simulation parameters
     * @param simulationBundle
     *            The jar file of the bundle containing the simulation
     * @param isRemoteRun
    ...
    /**
     * Takes a byte array containing a bundle jar which contains the code for a single simulation.
     * Installs, starts, and runs the contained simulation.
     * 
     * @param config
     *            The simulation configuration object describing simulation parameters
     * @param simulationBundle

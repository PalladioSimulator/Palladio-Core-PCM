...
namespace RequestParserForLateThread
{
	...
	public class HTTPParser
	{
		...
		protected ThreadedRequestProzessor.ThreadedRequestProzessorComponent pro;
		...
		public HTTPParser(DateTime da, TcpClient tcp, ref ThreadedRequestProzessor.ThreadedRequestProzessorComponent rp)
		{
			this.pro = rp;
		...
		internal void ReactOnTimeElapsed(object o,System.Timers.ElapsedEventArgs e)
		{
			...
			{
				byte[] msg =
					System.Text.Encoding.ASCII.GetBytes("411 Time Out");

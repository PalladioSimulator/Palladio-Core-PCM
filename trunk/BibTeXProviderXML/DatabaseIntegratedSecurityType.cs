//
// DatabaseIntegratedSecurityType.cs.cs
//
...
{
	public class DatabaseIntegratedSecurityType : Altova.Xml.Node
	{
		#region Forward constructors
		public DatabaseIntegratedSecurityType() : base() { SetCollectionParents(); }
		public DatabaseIntegratedSecurityType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public DatabaseIntegratedSecurityType(XmlNode node) : base(node) { SetCollectionParents(); }
		public DatabaseIntegratedSecurityType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            DatabaseIntegratedSecurityType parent;
            public DatabaseIntegratedSecurityType Parent
			{
				set
				{
					parent = value;
        ...
        public class ValueEnumerator: IEnumerator 
        {
			int nIndex;
			DatabaseIntegratedSecurityType parent;
			public ValueEnumerator(DatabaseIntegratedSecurityType par) 
			{
				parent = par;
				nIndex = -1;
			}

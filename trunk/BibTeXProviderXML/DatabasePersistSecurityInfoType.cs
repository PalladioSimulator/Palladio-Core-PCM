//
// DatabasePersistSecurityInfoType.cs.cs
//
...
{
	public class DatabasePersistSecurityInfoType : Altova.Xml.Node
	{
		#region Forward constructors
		public DatabasePersistSecurityInfoType() : base() { SetCollectionParents(); }
		public DatabasePersistSecurityInfoType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public DatabasePersistSecurityInfoType(XmlNode node) : base(node) { SetCollectionParents(); }
		public DatabasePersistSecurityInfoType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            DatabasePersistSecurityInfoType parent;
            public DatabasePersistSecurityInfoType Parent
			{
				set
				{
					parent = value;
        ...
        public class ValueEnumerator: IEnumerator 
        {
			int nIndex;
			DatabasePersistSecurityInfoType parent;
			public ValueEnumerator(DatabasePersistSecurityInfoType par) 
			{
				parent = par;
				nIndex = -1;
			}

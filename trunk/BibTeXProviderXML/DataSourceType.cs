...
{
	public class DataSourceType : Altova.Xml.Node
	{
		#region Forward constructors
		public DataSourceType() : base() { SetCollectionParents(); }
		public DataSourceType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public DataSourceType(XmlNode node) : base(node) { SetCollectionParents(); }
		public DataSourceType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            DataSourceType parent;
            public DataSourceType Parent
			{
				set
				{
					parent = value;
        ...
        public class NameEnumerator: IEnumerator 
        {
			int nIndex;
			DataSourceType parent;
			public NameEnumerator(DataSourceType par) 
			{
				parent = par;
				nIndex = -1;
			}

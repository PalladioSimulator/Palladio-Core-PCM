...
public class ScheduledResource extends AbstractScheduledResource {
	...
	protected IActiveResource createActiveResource() {
		...
		IActiveResource aResource = getScheduledResource(this.schedulingStrategy, this.numberOfInstances, "Utilisation of " + this.getName() + " " + this.description);
		return aResource;
	}
	...
	public void deactivateResource() {
		...
		double totalTime = getModel().getSimulationControl().getCurrentSimulationTime() * this.numberOfInstances;

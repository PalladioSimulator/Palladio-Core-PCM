...
\begin{figure}[htbp]
	...
	\caption{Spezialisierung eines \textit{Provided Type} zu einem \textit{Complete Type} (aus cite{TODO})}
...
\begin{figure}[htbp]
	...
	\caption{Typ-Hierarchie: \textit{Provided Type}, \textit{Complete Type} und \textit{Implementation Type} (aus cite{TODO})}

...
\begin{itemize}
	\item \textbf{Assembly}, dann werden die Kompositionsstrukturen (Komponentenarchitektur) eindeutig. Hierzu zählen die im Kontext liegende Komponente mit allen angebotenen und benötigen Schnittstellen (Rollenbeziehung), die direkt auf diesen Schnittstellen definierten Konnektoren, sowie die Rollen die über die Konnektoren erreicht werden. Zudem wird die Assembly berücksichtigt, in der ein Kontext liegt.

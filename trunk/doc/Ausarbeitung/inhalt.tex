...
Da \textit{Composite Components} vor allem eine logische Kapselung bieten, lassen sie sich vollständig auflösen, sofern ihre direkt enthaltenen (in der "`contains"'-Relation enhaltenen) Komponente vollständig einschließlich aller Delegationskonnektoren und Assembly Konnektoren bekannt sind.
(muss nicht immer voll spezifiziert werden / informationsverliust): Auflösen von CCs

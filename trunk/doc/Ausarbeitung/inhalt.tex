...
Ja, eine hätte ich spontan noch: Unsere Komponenten sind nur reaktiv und nicht proaktiv. Sprich, ich muss von außen einen Dienst aufrufen, damit die Komponente etwas tut. Es kann aber durchaus Komponenten geben, die von sichaus aktiv sind.

keine Möglichkeit die Semantik auf Diensten zu definieren. Keine Anotationen auf Diensten möglich. Nur Name des Dienstes + Signatur kann derzeit Hinweis auf Semantik geben. --> derzeit nicht überprüfbar ob semantik passt (bspw. bei erbenden Schnittstellen).

...
Protokoll-Zustand ist Zustand der Komp, nicht der Schnittstelle.

Der Zustand einer Komponente kann nicht über Protokolle verschiedener Schnittstellen hinweg synchronisiert werden.

Protokoll"=Synchronisation
- keine Unterstützung für Zustände über mehrere schnittstellen hinweg.
- echte einschränkung? --> zusammenhängede fkt müssen auf *einer* schnittstelle def werden.

...
\begin{itemize}
	\item Eine Assembly fasst eine Menge von Komponenten und die dazugehörigen "`äußeren"' Assembly"=Konnektoren zusammen. Als "`äußere"' Assembly"=Konnektoren gelten dabei jene, die innerhalb keiner Komponente liegen.
	...
	\item Assemblies werden nur von System"=Deployern verwendet. Die für diese Zielgruppe definierte Sicht blendet dabei das Innere von \textit{Composite Components} aus. In der Folge kann ein \textit{System"=Deployer} bei der Allokation Composite Components nicht auf verschiedene Ressourcen verteilen, da sich diese Komponente keine für ihn identifizierbaren Sub"=Komponenten besitzt, die sich einzeln ansprechen ließen. 
\end{itemize}

Die Assembly"=Ebene (und die darunter liegenden Ebenen Allokation und \textit{Runtime}) haben daher nur für das \textit{Deployment} / die Allokation eine Funktion.

TODO: kann mehr als eine Assembly zur zeit deployed werden?

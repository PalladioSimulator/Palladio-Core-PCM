...
Non-Calc Ressources verbinden je genau zwei ressourcen bi-direktional.

NIcht jene Assembly Connection (delegation conn werden gar nicht deployed) muss deployed werden: liegt nur auf einem rechner ohne VErbindung über Netzwerk

was genau enthalten CCs? - Kontext-Komps + Konnektoren. Rollen nicht?

nur assembly konnektors und context comp können deployed werden --> kein Blick ins innere von CCs --> keine del conn. deploybar. und auch nicht sinnvoll, da bereits aufgelöst.

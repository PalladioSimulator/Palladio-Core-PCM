% $Log$
% Revision 1.93  2006/02/11 16:01:36  kelsaka
...
Komponenten und Rollen können, wie zu erwarten, verwendet werden. Werden Komponenten und Rollen verwendet, stehen sie, vereinfacht betrachtet, in einem Verwendungs"=\textit{Kontext}. Es ist also strikt zwischen \textit{Komponenten"=Typen} und der Verwendung von Komponenten"=Typen in einem \textit{Kontext} zu unterscheiden. Ein Komponenten"=Typ kann also in einer beliebigen Anzahl (\texttt{0..*}) von Kontexten verwendet werden. Der Kontext ermöglicht eine eindeutige Identifikation des Verwendungsortes. Die Verwendung einer Komponente bzw. Rolle impliziert einen Kontext, in dem die Komponente bzw. Rolle liegt.

...
Mit Analogien zu den angebotenen Schnittstellen ist es auch auf der Seite der benötigten Schnittstellen einer Komponente untersagt, dass die gleiche Schnittstelle, im Beispiel in Abbildung \ref{fig:cm-interface-twice-forbidden-req-01} \texttt{Ir} genannt, mehr als ein mal von einer Komponente als benötigt angeben wird.

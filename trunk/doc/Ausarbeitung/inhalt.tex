...
\paragraph{Quantifizierung der Spezialisierungsbeziehungen}
\label{sec:QuantifizierungderSpezialisierungsbeziehungen}
...
\subparagraph{m:n}
Insgesamt ergeben sich somit zwischen den "`benachbarten"' Typ"=Ebenen \texttt{m:n}"=Beziehungen.



\subparagraph{Co- und Contra-Varianz}

...
\subsubsection{Angebot von Schnittstellen}
\label{sec:Angebot von Schnittstellen}
...
Das Komponentenmodell reglementiert stark die Art und Weise, in der Schnittstellen angeboten und angebotene Schnittstellen verwendet werden dürfen.

Abbildung \ref{fig:cm-interface-twice-forbidden-01}.

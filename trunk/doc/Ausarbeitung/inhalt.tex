...
\begin{figure}[htbp]
	...
	\caption{Transformation einer Assembly in eine \textit{Composite Component} (aus Sicht eines System Deployers)}
	\label{fig:cm-assembly-to-cc-01}
\end{figure}



Abbildung \ref{fig:cm-assembly-to-cc-01} beschreibt die Umwandlung einer Assembly in eine \textit{Composite Component}, so wie der Vorgang von einem \textit{System Deployer} wahrgenommen würde. Da das Innere einer Composite Component nicht mehr sichtbar ist, würden innere Komponenten und Konnektoren bei einer Transformation unsichtbar. Dafür muss für eine solche Transformation definiert werden, welche Schnittstellen angeboten und benötigt werden, damit die neue Composite Componente vollständig spezifiziert ist. Auch die Delegation"=Konnektoren müssen definiert werden, auch wenn sie für den System Deployer nicht sichtbar sind, damit alle Aufrufe definierten Aufrufpfaden folgen können.

...
Bewußt und klar von der Funktionalität eines Datenspeichers für Komponentenarchitekturen getrennt, ist die Anwendung oder Definition von Algorithmen auf Komponentenmodell"=Instanzen. Entsprechend der Grundsätze des Strategie Musters (\textit{Strategy Pattern}, vgl. \cite{GAMMA}, TODO: S. XXff), können auf einer Modell"=Instanz beliebig viele strategy"=abhängige Algorithmen angewendet werden. Daher sind weitergehende Algorithmen, die Bereiche wie Validitätsprüfung, Interoperabilitätsprüfung oder ähnliches betreffen, nicht Bestandteil des Komponenten"=Meta"=Modells, sondern flexibel anwendbar.
...
\begin{verbatim}
>> - Anotation habe ich derzeit definiert als Tripel aus 
>> > > (Anotationsnamen, Datentyp, Datenfeld), wobei 
> > Anotationsname so etwas 
>> > > wie Laufzeitmesswert XY (auch über alle Komponenten hinweg) 
> > sein kann, 
>> > > der Datentyp legt die Interpretation für das Datenfeld (den 
>> > > eigentlichen Wert) fest. Soll es für Anotationsnamen und Datentypen 
>> > > ein ID-Konzept geben? Oder sollen Datentyp und Datenfeld in einem 
>> > > komplexen Typ zusammengefasst werden?
> > 
> > Hmmm.... müsste ich mal genauer drüber nachdenken. Auf  den 
> > ersten Blick 
> > würde ich sagen, dass ID's auch da ne gute Sache sind. Das 
> > sollten wir 
> > evtl. noch mal mit Steffen diskutieren, wenn möglich.
Ich finde das gut und verfolge immer noch die Idee, dass ein Annotationstyp,
den einer einführt, durchaus von anderen wiederverwendet werden könnte...
Z.B. definiere ich Steffens Performance Annotation und Jens findet die
hilfreich in seinem Verfahren. Dann verwendet er meine ID weiter...
\end{verbatim}

...
\begin{itemize}
	\item \textbf{Implementation}, dann werden die Kompositionsstrukturen innerhalb von \textit{Composite Components} eindeutig. Zu den zu erfassenden Informationen gehören die im Kontext liegende Komponente mit allen angebotenen und benötigen Schnittstellen (Rollenbeziehung), die direkt auf diesen Schnittstellen definierten Konnektoren, sowie die Rollen die über die Konnektoren erreicht werden.

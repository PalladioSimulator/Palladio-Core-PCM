-------------------------------------------------------------
CodeSmith DBDocumenter Templates v2.0
...
Requirements:
  * CodeSmith v2.5.9 or higher
  * Aylar Highlighting Component (Aylar.Highlight) (included)


About Aylar.Highlight - Aylar.Highlight is a great syntax highlighting tool that is highlighly customizable, fast, and (best of all) FREE! Please see http://authors.aspalliance.com/aylar/highlight/ for more details.
...
- providerType
Ignore this. You should never have to change this.
...
2.) Click build.bat and let it run! Keep in mind, the batch file relies on the CodeSmith console application (CodeSmithConsole.exe), and hardcodes the assumed path to this executable (c:\Program Files\CodeSmith\v2.5\). If this differs, please edit the build.bat accordingly.

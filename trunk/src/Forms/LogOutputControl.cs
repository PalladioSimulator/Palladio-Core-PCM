...
namespace Palladio.Editor.Forms
{
	...
	/// <summary>
	/// Zusammenfassung für OutputControl.
	/// </summary>
	public class LogOutputControl : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridTextBoxColumnDispatcher.Width = 230;
			// 
			...
			this.dataGridTextBoxColumnMessage.Width = 1000;
			// 
			// LogOutputControl
			// 

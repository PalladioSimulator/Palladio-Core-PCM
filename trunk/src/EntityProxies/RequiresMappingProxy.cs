...
namespace Palladio.Editor.Common.EntityProxies
{
	...
	/// </summary>
	public class RequiresMappingProxy : ConnectionProxy, ICustomTypeDescriptor
	{
		...
		public RequiresMappingProxy(IMapping mapping, RoleProxy innerRole, RoleProxy outerRole, CommandHandler cmdHandler, AttributeProvider attrProv)
		...
		Category("Default"),
		DescriptionAttribute("The inner role of this requires mapping.") ]
		...
		TypeConverter(typeof(RoleTypeConverter)),
		Category("Default"),
		DescriptionAttribute("The outer role of this requires mapping.") ]

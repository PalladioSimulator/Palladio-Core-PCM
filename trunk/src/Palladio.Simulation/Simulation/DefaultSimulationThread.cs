...
namespace Palladio.Simulation.Simulation
{
	...
	/// </summary>
	public enum SimulationThreadType 
	{
		/// <summary>
		/// the thread of this type logs all informations
		/// </summary>
		TYPE_LOG_ALL,

		/// <summary>
		/// the thread of this type logs all loggingpoints
		/// </summary>
		TYPE_LOG_ON_LPS,
		
		/// <summary>
		/// the thread of this type logs doesn't log anything
		/// </summary>
		TYPE_LOG_NOTHING
	};
	...
	/// </pre>
	/// </remarks>
	internal class DefaultSimulationThread : ISimulationThread
	{
		#region event
		...
		/// </summary>
		public Palladio.Simulation.Model.ITimeConsumer CurrentTimeConsumer
		{
			get
			{
		...
		/// </summary>
		public Palladio.Simulation.Simulation.SimulationThreadType TheType
		{
			get
			{
				return this.type;

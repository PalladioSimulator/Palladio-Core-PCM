...
namespace Palladio.Simulation.Simulation
{
	...
	/// </pre>
	/// </remarks>
	internal class DefaultThreadScheduler : IThreadScheduler
	{
		#region events
		...
		/// <summary>
		/// called if no more threads are alive
		/// </summary>
		...
		/// </summary>
		/// <param name="message">the message of the logevent.</param>
		/// <param name="simulationThread">the simulationthread that fired this event</param>
		/// <param name="type">the type of event</param>
		/// <param name="timeConsumer">the previous timeconsumer</param>

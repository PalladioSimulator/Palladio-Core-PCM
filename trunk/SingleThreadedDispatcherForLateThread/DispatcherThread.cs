...
namespace SingleThreadedDispatcherForLateThread
{
	...
	public class Dispatcher 
	{
		...
		ThreadedRequestProzessorComponent sendsResponse;
		...
		public Dispatcher(TcpClient aSocket,DateTime now, ref RequestParserComponent parser, ref ThreadedRequestProzessorComponent prozzesor )
		{

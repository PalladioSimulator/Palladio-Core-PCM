...
namespace Palladio.ComponentModel.BuilderConstraints
{
	...
	/// <summary>
	/// Interface that has to be implemented by all signature builder contraints.
	...
	/// </pre>
	/// </remarks>
	public interface ISignatureBuilderConstraint : IBuilderConstraint, ISignatureBuilder
	{

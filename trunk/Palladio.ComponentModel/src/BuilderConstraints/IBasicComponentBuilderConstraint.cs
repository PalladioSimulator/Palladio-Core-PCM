...
namespace Palladio.ComponentModel.BuilderConstraints
{
	...
	/// <summary>
	/// Interface that has to be implemented by all basic component builder contraints.
	...
	/// </pre>
	/// </remarks>
	public interface IBasicComponentBuilderConstraint : IBuilderConstraint, IBasicComponentBuilder
	{

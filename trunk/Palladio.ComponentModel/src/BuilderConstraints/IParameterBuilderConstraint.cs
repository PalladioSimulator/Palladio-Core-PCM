...
namespace Palladio.ComponentModel.BuilderConstraints
{
	...
	/// <summary>
	/// Interface that has to be implemented by all parameter builder contraints.
	...
	/// </pre>
	/// </remarks>
	public interface IParameterBuilderConstraint : IBuilderConstraint, IParameterBuilder
	{

...
namespace Palladio.ComponentModel.BuilderConstraints
{
	...
	/// <summary>
	/// Interface that has to be implemented by all composite component builder contraints.
	...
	/// </pre>
	/// </remarks>
	public interface ICompositeComponentBuilderConstraint : IBuilderConstraint, ICompositeComponentBuilder
	{

...
{
	/// <summary>
	/// Typed List of RootTypeLevelBuilder. Typed collection for constraints / builders.
	/// </summary>
	/// <remarks>
	/// <pre>
	/// Version history:
	...
	internal class RootTypeLevelBuilderList
	{
		...
		/// </summary>
		/// <returns>The very most outer wrapper.</returns>
		public IRootTypeLevelBuilder GetOuterBuilder()
		{
			...
			builderList.CopyTo(rootBuilders);
			...
			return rootBuilders[builderList.Count]; // return the outer constraint

...
{
	/// <summary>
	/// Typed List of <see cref="IBasicComponentTypeLevelBuilder"/>. Typed collection for constraints / builders.
	/// </summary>
	/// <remarks>
	/// <pre>
	/// Version history:
	...
	/// </pre>
	/// </remarks>
	internal class BasicComponentTypeLevelBuilderList
	{
		...
		/// </summary>
		public BasicComponentTypeLevelBuilderList()
		{
			Init();
		}
		...
		public void Add(IBasicComponentTypeLevelBuilder builder)
		{
		...
		public void Remove(IBasicComponentTypeLevelBuilder builder)
		{
		...
		/// </summary>
		/// <param name="compId">The id of the component to build and to apply the constraints to.</param>
		/// <returns>The very most outer wrapper of the chain.</returns>
		public IBasicComponentTypeLevelBuilder GetOuterBuilder(IComponentIdentifier compId)
		{
			IBasicComponentTypeLevelBuilder[] outBuilders = new IBasicComponentTypeLevelBuilder[builderList.Count];

			// make a copy using the clone-method of the builders
			for(int x = 0; x < builderList.Count; x++)
			{
				outBuilders[x] = ((IBasicComponentTypeLevelBuilder)builderList[x]).Clone(compId);
			}

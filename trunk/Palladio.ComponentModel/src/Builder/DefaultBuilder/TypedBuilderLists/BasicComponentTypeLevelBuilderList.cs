...
namespace Palladio.ComponentModel.Builder.DefaultBuilder.TypedBuilderLists
{
	...
	internal class BasicComponentTypeLevelBuilderList
	{
		...
		public IBasicComponentTypeLevelBuilder GetOuterBuilder(IComponent component)
		{
			...
			{
				outBuilders[x] = ((IBasicComponentTypeLevelBuilder)builderList[x]).Clone(component);
			}

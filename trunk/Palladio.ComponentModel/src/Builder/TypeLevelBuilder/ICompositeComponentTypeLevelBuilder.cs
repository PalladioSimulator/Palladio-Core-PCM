...
namespace Palladio.ComponentModel.Builder.TypeLevelBuilder
{
	...
	public interface ICompositeComponentTypeLevelBuilder : ICompositeComponentBuilder
	{
		...
		/// </summary>
		/// <param name="compId">The id of component model entity that has to be builder supervised.</param>
		...
		ICompositeComponentTypeLevelBuilder Clone(IComponentIdentifier compId);

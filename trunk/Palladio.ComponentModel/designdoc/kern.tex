...
Da die gewählte Datenbank (siehe Abschnitt \ref{sec:kern:beschr:dataset}) nur die Speicherung von Standartdatentypen zuläßt, muss eine zusätzliche Infrastruktur geschaffen werden, welche die Entitäten des Modells hält. Hierfür bot sich die Hashtable des .NET-Frameworks an, in der die Entitäten durch ihre ID referenzierbar sind. ....
%id konzept ...

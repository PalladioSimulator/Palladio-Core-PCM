...
\subsubsection{Identifizierung von Entitäten}
...
Das derzeitige Komponentenmodells enthält die von außen nutzbare Fabrik \verb+ComponentModelIdentifier+ zur Erzeugung von IDs. Es wird von dieser Fabrik für alle erzeugten IDs dieselbe alle ID-Interfaces implementierende Klasse \verb+InternalEntityIdentifier+ verwendet. Als Folge hieraus lassen sich IDs unterschiedlichen Typs ineinander casten. Dies sollte bei der Nutzung des Komponentenmodells keinerlei Probleme bereiten, da die Klasse selber nicht von außen sichtbar ist. 

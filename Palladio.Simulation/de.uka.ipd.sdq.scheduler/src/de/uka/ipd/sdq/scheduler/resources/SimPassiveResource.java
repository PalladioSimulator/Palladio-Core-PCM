...
import de.uka.ipd.sdq.scheduler.resources.waiting.AbstractWaitingPolicy;
...
public class SimPassiveResource extends AbstractSimResource implements IPassiveResource {
			 ...
			 * @uml.associationEnd   aggregation="composite" inverse="passiveResource:de.uka.ipd.sdq.capra.simulator.resources.AbstractWaitingPolicy"
			 */
			 ...
			 * @uml.associationEnd   aggregation="composite" inverse="simPassiveResource:de.uka.ipd.sdq.capra.simulator.resources.IPriorityBoost"
			 */

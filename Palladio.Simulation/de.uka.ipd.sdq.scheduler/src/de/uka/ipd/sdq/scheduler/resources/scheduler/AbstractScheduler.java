...
public abstract class AbstractScheduler implements IScheduler {
	 ...
	 * @uml.associationEnd   aggregation="composite" inverse="abstractScheduler:de.uka.ipd.sdq.capra.simulator.resources.ProcessRegistry"
	 */
	 ...
	 * @uml.associationEnd   multiplicity="(0 -1)" ordering="true" aggregation="composite" inverse="abstractScheduler:de.uka.ipd.sdq.capra.simulator.resources.SimResourceInstance"
	 */
	 ...
	 * @uml.associationEnd   inverse="abstractScheduler:de.uka.ipd.sdq.capra.simulator.resources.SimActiveResource"
	 */
	...
	public void setResource(SimActiveResource resource) {
		 ...
		 * @uml.associationEnd   inverse="abstractScheduler:de.uka.ipd.sdq.capra.simulator.resources.IQueueingStrategy"
		 */

...
public class SetupConcurrentPipesAndFiltersStrategy implements ISetupDataSinkStrategy {
    ...
    public SetupConcurrentPipesAndFiltersStrategy(EventSimModel model) {
        this.model = model;
    }
    ...
    private IRawWriteStrategy createWriteStrategy() {
        try {
            String writeStrategyClass = RecorderExtensionHelper.getWriteStrategyClassNameForName(model

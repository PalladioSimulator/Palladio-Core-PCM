...
public class Opt4JTask extends Task implements ControlListener,
	...
	/**
	 * Initialize with a parent {@code Injector}.
	 * 
	 * @param injector
	 *            the parent injector
	 */
	...
	/**
	 * Returns the {@code Injector} of the task.
	 * 
	 * @return the injector
	 */
	...
	/**
	 * Returns the {@code Optimizer} of the task.
	 * 
	...
	private void check(Injector injector) {
		...
		try {
			...
			Type evaluatorType0 = Parameters.getType(Evaluator.class,
					evaluator, "P");

...
/**
 * The {@code ModuleRegister} contains all found modules for the {@code
 * Configurator}.
 * 
 * @author lukasiewycz.
 * 
...
public class ModuleRegister implements Iterable<Class<? extends Module>> {
	...
	/**
	 * Constructs and populates the {@code ModuleRegister}.
	 * 
	 * @param finder
	...
	/**
	 * Returns the {@code PropertyModule} of the specified class and creates a
	 * new instance if necessary.
	 * 
	 * @param clazz
	 *            the class of the {@code Module}
	 * @return the {@code PropertyModule}
	 */
	public PropertyModule get(Class<? extends Module> clazz) {
		...
		if (map.containsKey(clazz)) {
			...
			try {
				...
				System.err.println("Failed to create an instance of module "
						+ clazz + ".");

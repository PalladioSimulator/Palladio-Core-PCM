 ...
 * PopulationWidget}, or {@code ParetoPlotWidget}. This service has a
...
public class ViewsToolBarService implements ToolBarService {
	...
	public ViewsToolBarService(Viewport viewport,
			...
			Provider<ParetoPlotWidget> plotWidgetProvider,
	...
	public JToolBar getToolBar() {
		...
		JButton buttonObjectivesPlot = new JButton(Icons
				.getIcon(Icons.CONVERGENCE));

...
/**
 * The {@code DefaultApplicationFrame}.
 * 
 * @author lukasiewycz
 * 
 */
...
public class DefaultApplicationFrame extends ApplicationFrame {
	...
	/**
	 * Constructs a {@code DefaultApplicationFrame} .
	 * 
	 * @param panel
	 *            the content panel
	 * @param about
	 ...
	 */
	@Inject
	public DefaultApplicationFrame(ContentPanel panel, About about, Menu menu,
			ToolBar toolBar, FileOperations fileOperations)
			throws HeadlessException {

...
/**
 * The {@code IntegerBounds} is an implementation of the {@link Bounds} for the
 * {@code IntegerGenotype} that accepts arrays as well as lists for as bounds.
 * 
 * @author lukasiewycz
 * 
 */
public class IntegerBounds implements Bounds<Integer> {
	...
	/**
	 * Constructs a {@code IntegerBounds} with arrays.
	 * 
	 * @param lower
	 *            the lower bounds
	 * @param upper
	...
	/**
	 * Constructs a {@code IntegerBounds} with lists.
	 * 
	 * @param lower
	 *            the lower bounds
	 * @param upper

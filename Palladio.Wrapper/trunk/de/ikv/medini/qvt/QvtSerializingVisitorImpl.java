...
public class QvtSerializingVisitorImpl extends OclSerializingVisitorImpl implements QvtVisitor {
	...
	public static final String[] fgQVTkeywords = {
	        "transformation", "relation", "enforce", "domain", "top", "when", "where", "primitive", "key", "checkonly", "query", "import" }; //$NON-NLS-1$
	...
	protected boolean isKeyword(String string) {
		return Arrays.asList(QvtSerializingVisitorImpl.fgQVTkeywords).contains(string) || super.isKeyword(string);
	}

...
public class QvtSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QvtPackage.QVT_VISITOR: {
				QvtVisitor qvtVisitor = (QvtVisitor)theEObject;
				Object result = caseQvtVisitor(qvtVisitor);
				if (result == null) result = caseOclVisitor(qvtVisitor);
	 ...
	 * @generated
	 */
	public Object caseQvtVisitor(QvtVisitor object) {
		return null;
	}

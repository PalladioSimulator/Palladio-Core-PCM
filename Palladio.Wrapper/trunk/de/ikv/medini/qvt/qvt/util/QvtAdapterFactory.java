...
public class QvtAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected QvtSwitch modelSwitch =
		new QvtSwitch() {
			public Object caseQvtVisitor(QvtVisitor object) {
				return createQvtVisitorAdapter();
			}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ikv.medini.qvt.qvt.QvtVisitor <em>Visitor</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.oslo.ocl20.semantics.OclVisitor <em>Ocl Visitor</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

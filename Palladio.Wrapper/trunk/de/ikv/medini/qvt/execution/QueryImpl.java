...
public class QueryImpl implements Query {
	...
	/**
	 * If this model list is set, the query can access on the elements in the model list. 
	 * If not set, the query can only access on elements which are in the same resource
	 * as the "self" element, or on no elements if there is no "self" element. 
	 */

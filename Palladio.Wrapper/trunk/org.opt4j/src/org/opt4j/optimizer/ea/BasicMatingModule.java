...
/**
 * The {@code BasicMatingModule} is the basic property module for the {@code
 * Mating} and {@code Coupler}.
 * 
 * @author glass
 * 
 */
...
public class BasicMatingModule extends MatingModule {
	...
	/**
	 * The {@code CouplerType} determines the coupler operator to use.
	 * 
	 * @author glass
	 * 
	 */
	public enum CouplerType {
		/**
		 * Use the {@code CouplerDefault} operator.
		 */
		DEFAULT,
		/**
		 * Use the {@code CouplerRandom} operator.
		 */
		RANDOM,
		/**
		 * Use the {@code CouplerUnique} operator.
		 */
		UNIQUE;
	}

	/**
	 * Constructs a {@code BasicMatingModule}.
	 * 
	 */
	...
	/**
	 * Returns the type of {@code Coupler} operator to use.
	 * 
	...
	/**
	 * Sets the the type of {@code Coupler} operator to use.
	 * 
	 * @param type
	 *            the type to set
	 */

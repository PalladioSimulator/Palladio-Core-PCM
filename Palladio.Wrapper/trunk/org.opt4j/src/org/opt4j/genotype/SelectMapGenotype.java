...
/**
 * The {@code SelectGenotype} selects for each key an element from a given list.
 * 
 * @author lukasiewycz
 * 
 * @param <K>
 ...
 */
public class SelectMapGenotype<K, V> extends IntegerGenotype implements
		MapGenotype<K, V> {

	protected List<K> keys;
	protected Map<K, List<V>> values;
	...
	/**
	 * Constructs a {@code SelectMapGenotype}.
	 * 
	 * @param keys
	 *            the keys
	 * @param values
	...
	/**
	 * Constructs a {@code SelectMapGenotype}. Here, each key has the same
	...
	/**
	 * Not supported. Use {@code SelectMapGenotype#init(Random)} instead.
	 * 
	 * @see org.opt4j.genotype.IntegerGenotype#init(java.util.Random, int)
	 */
	@Override
	...
	public <G extends Genotype> G newInstance() {
		try {
			Constructor<? extends SelectMapGenotype> cstr = this.getClass()

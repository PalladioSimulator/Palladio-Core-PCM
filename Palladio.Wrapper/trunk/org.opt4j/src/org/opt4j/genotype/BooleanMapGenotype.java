 ...
 *            the type of keys
 */
public class BooleanMapGenotype<K> extends BooleanGenotype implements
		MapGenotype<K, Boolean> {

	protected final List<K> list;

	/**
	 * Constructs a {@code BooleanMapGenotype}.
	 * 
	 * @param list
	 *            the list of keys
	 */
	...
	public <G extends Genotype> G newInstance() {
		try {
			Constructor<? extends BooleanMapGenotype> cstr = this.getClass()

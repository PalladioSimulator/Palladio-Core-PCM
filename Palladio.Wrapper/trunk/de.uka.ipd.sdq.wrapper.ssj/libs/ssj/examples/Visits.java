...
public class Visits {
   ...
   RandomVariateGen genArriv = new RandomVariateGen
       (new MRG32k3a(), new ExponentialDist (20.0)); // Interarriv.
   ...
   public void simulateRuns (int numRuns) {
      ...
      System.out.println (avLost.reportAndConfidenceIntervalStudent (0.9, 3));
   }

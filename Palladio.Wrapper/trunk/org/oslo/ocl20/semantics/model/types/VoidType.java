...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Void Type</b></em>'. <!--
 * end-user-doc -->
 * 
 * @see org.oslo.ocl20.semantics.model.types.TypesPackage#getVoidType()
 * @model
 * @generated
 */
public interface VoidType extends StringType, OrderedSetType, IntegerType, BooleanType, SetType, SequenceType,
        OclModelElementType, BagType {
	/**

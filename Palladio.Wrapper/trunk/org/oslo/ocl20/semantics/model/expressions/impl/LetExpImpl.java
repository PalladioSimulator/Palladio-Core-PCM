 ...
 * <ul>
 * <li>{@link org.oslo.ocl20.semantics.model.expressions.impl.LetExpImpl#getIn <em>In</em>}</li>
 * <li>{@link org.oslo.ocl20.semantics.model.expressions.impl.LetExpImpl#getVariable <em>Variable
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class LetExpImpl extends OclExpressionImpl implements LetExp {
	...
	public NotificationChain basicSetIn(OclExpression newIn, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
			    ExpressionsPackage.LET_EXP__IN, oldIn, newIn);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newIn != in) {
			...
			if (in != null)
				msgs = ((InternalEObject) in).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
				        - ExpressionsPackage.LET_EXP__IN, null, msgs);
			if (newIn != null)
	...
	public NotificationChain basicSetVariable(VariableDeclaration newVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
			    ExpressionsPackage.LET_EXP__VARIABLE, oldVariable, newVariable);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setVariable(VariableDeclaration newVariable) {
		if (newVariable != variable) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.LET_EXP__VARIABLE, newVariable,
			    newVariable));
	}

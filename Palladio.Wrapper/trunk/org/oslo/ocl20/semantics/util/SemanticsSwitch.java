...
public class SemanticsSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SemanticsPackage.SEMANTICS_VISITABLE: {
				SemanticsVisitable semanticsVisitable = (SemanticsVisitable) theEObject;
				Object result = caseSemanticsVisitable(semanticsVisitable);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
			case SemanticsPackage.SEMANTICS_VISITOR: {
				SemanticsVisitor semanticsVisitor = (SemanticsVisitor) theEObject;
				Object result = caseSemanticsVisitor(semanticsVisitor);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
			case SemanticsPackage.OCL_VISITOR: {
				OclVisitor oclVisitor = (OclVisitor) theEObject;
				Object result = caseOclVisitor(oclVisitor);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ocl Visitor</em>'. <!--
	 * begin-user-doc --> This implementation returns null; returning a non-null result will
	 * terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ocl Visitor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */

...
public class CodeGenerator {
	...
	public CodeGenerator(OclProcessor proc, String inputFileName, String outputDir, String pkgName,
	        String outputClassName, ILog log) {
		this.processor = proc;
	...
	public void generate() {
		...
		try {
			...
			// --- Prepare output ---
			String outputFileName = outputDir + "/" + this.pkgName.replaceAll("[.]", "/") + "/" + outputClassName
			        + ".java";
	...
	public static void main(String args[]) {
		...
		Ocl4Emf.InitModel(args[0], args[1], args[3], log);

		// Create a code generator
		CodeGenerator codeGen = new CodeGenerator(Ocl4Emf.processor, args[3], args[4], args[5], args[6], log);
		// Generate the code
		codeGen.generate();
	}

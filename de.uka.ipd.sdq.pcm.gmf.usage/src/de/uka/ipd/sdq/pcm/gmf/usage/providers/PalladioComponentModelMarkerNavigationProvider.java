...
import de.uka.ipd.sdq.pcm.gmf.usage.part.PalladioComponentModelDiagramEditorUtil;
...
public class PalladioComponentModelMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {
    ...
    public static final String MARKER_TYPE = PalladioComponentModelUsageDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$

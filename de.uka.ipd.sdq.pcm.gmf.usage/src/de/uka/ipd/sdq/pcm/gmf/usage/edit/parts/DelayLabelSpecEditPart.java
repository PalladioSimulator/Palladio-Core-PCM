...
import de.uka.ipd.sdq.pcm.dialogs.usage.DelaySpecificationDialog;
...
/**
 * The Class DelayLabelSpecEditPart.
 *
 * @generated
 */
public class DelayLabelSpecEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new delay label spec edit part.
     *
     * @param view the view
     * @generated
     */
    public DelayLabelSpecEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.Delay_3017,
                    getParserElement(), PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.usage.edit.parts.DelayLabelSpecEditPart.VISUAL_ID));
        }
        return parser;
    }

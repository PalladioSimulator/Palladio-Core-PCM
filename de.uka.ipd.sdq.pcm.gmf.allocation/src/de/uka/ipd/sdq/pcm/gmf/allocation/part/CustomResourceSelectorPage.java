...
/**
 * This wizard allows the user to select a resource. It can be passed an already selected resource
 * which then can be changed. A value of null will leave it up to the user to locate the resource.
 * 

...
//		comboLqsimOutput.addSelectionListener(comboListener);
	...
	private Group createSREWidgets(Composite container) {
		...
		//Label label6 = new Label(group, SWT.NONE);
		//label6.setText("Expression Model File (use as input or output):");
		//label6.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false));
		...
		checkboxUseExpressionAsInput.setText("Use Expression Model File as input");
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try{
			lqnsConfig1.setText(configuration.getAttribute(MessageStrings.CONV_VALUE, "1e-003"));
		} catch(CoreException e){
			lqnsConfig1.setText("1e-003");
		}
		try{

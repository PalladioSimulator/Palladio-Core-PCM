 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see completions.CompletionsFactory
 * @model kind="package"
 * @generated
 */
public interface CompletionsPackage extends EPackage {
	 ...
	 * @generated
	 */
	CompletionsPackage eINSTANCE = completions.impl.CompletionsPackageImpl.init();

	/**
	 * The meta object id for the '{@link completions.impl.CompletionImpl <em>Completion</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see completions.impl.CompletionImpl
	 * @see completions.impl.CompletionsPackageImpl#getCompletion()
	 * @generated
	 */
	int COMPLETION = 0;
	...
	/**
	 * The meta object id for the '{@link completions.impl.CompletionRepositoryImpl <em>Completion Repository</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see completions.impl.CompletionRepositoryImpl
	 * @see completions.impl.CompletionsPackageImpl#getCompletionRepository()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link completions.impl.DelegatingExternalCallActionImpl <em>Delegating External Call Action</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see completions.impl.DelegatingExternalCallActionImpl
	 * @see completions.impl.CompletionsPackageImpl#getDelegatingExternalCallAction()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link completions.Completion <em>Completion</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Completion</em>'.
	 * @see completions.Completion
	 * @generated
	 */
	EClass getCompletion();

	/**
	 * Returns the meta object for class '{@link completions.CompletionRepository <em>Completion Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Completion Repository</em>'.
	 * @see completions.CompletionRepository
	 * @generated
	 */
	EClass getCompletionRepository();

	/**
	 * Returns the meta object for the containment reference list '{@link completions.CompletionRepository#getCompletions_CompletionRepository <em>Completions Completion Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Completions Completion Repository</em>'.
	 * @see completions.CompletionRepository#getCompletions_CompletionRepository()
	...
	/**
	 * Returns the meta object for class '{@link completions.DelegatingExternalCallAction <em>Delegating External Call Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Delegating External Call Action</em>'.
	 * @see completions.DelegatingExternalCallAction
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link completions.impl.CompletionImpl <em>Completion</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see completions.impl.CompletionImpl
		 * @see completions.impl.CompletionsPackageImpl#getCompletion()
		...
		/**
		 * The meta object literal for the '{@link completions.impl.CompletionRepositoryImpl <em>Completion Repository</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see completions.impl.CompletionRepositoryImpl
		 * @see completions.impl.CompletionsPackageImpl#getCompletionRepository()
		...
		/**
		 * The meta object literal for the '{@link completions.impl.DelegatingExternalCallActionImpl <em>Delegating External Call Action</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see completions.impl.DelegatingExternalCallActionImpl
		 * @see completions.impl.CompletionsPackageImpl#getDelegatingExternalCallAction()

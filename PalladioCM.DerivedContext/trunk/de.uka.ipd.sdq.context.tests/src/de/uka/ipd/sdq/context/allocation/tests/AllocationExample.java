...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>allocation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AllocationExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.allocation"));
				ActualAllocationContext root = AllocationFactory.eINSTANCE.createActualAllocationContext();

...
public class LoopIterationImpl extends EObjectImpl implements LoopIteration {
	 ...
	 * @ordered
	 */
	protected LoopAction loopaction_LoopIteration = null;
	 ...
	 * @ordered
	 */
	protected RandomVariable iterations_LoopIteration = null;
	 ...
	 * @generated
	 */
	public LoopAction getLoopaction_LoopIteration() {
		if (loopaction_LoopIteration != null && loopaction_LoopIteration.eIsProxy()) {
			...
			loopaction_LoopIteration = (LoopAction)eResolveProxy(oldLoopaction_LoopIteration);
	 ...
	 * @generated
	 */
	public LoopAction basicGetLoopaction_LoopIteration() {
		return loopaction_LoopIteration;
	}
	 ...
	 * @generated
	 */
	public void setLoopaction_LoopIteration(LoopAction newLoopaction_LoopIteration) {
		LoopAction oldLoopaction_LoopIteration = loopaction_LoopIteration;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case UsagePackage.LOOP_ITERATION__LOOPACTION_LOOP_ITERATION:
				setLoopaction_LoopIteration((LoopAction)newValue);
				return;
			case UsagePackage.LOOP_ITERATION__ITERATIONS_LOOP_ITERATION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case UsagePackage.LOOP_ITERATION__LOOPACTION_LOOP_ITERATION:
				setLoopaction_LoopIteration((LoopAction)null);
				return;
			case UsagePackage.LOOP_ITERATION__ITERATIONS_LOOP_ITERATION:

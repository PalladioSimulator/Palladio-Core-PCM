...
public interface AllocationPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.context.allocation.ActualAllocation#getActualAllocationContexts_ActualAllocation <em>Actual Allocation Contexts Actual Allocation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Actual Allocation Contexts Actual Allocation</em>'.
	 * @see de.uka.ipd.sdq.context.allocation.ActualAllocation#getActualAllocationContexts_ActualAllocation()

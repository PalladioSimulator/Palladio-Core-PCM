...
public class UsagePackageImpl extends EPackageImpl implements UsagePackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getUsageContext_ActualParameterUsage_UsageContext(), theParameterPackage.getParameterUsage(), null, "actualParameterUsage_UsageContext", null, 0, -1, UsageContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getBranchProbability_Branchtransition_BranchProbability(), theSeffPackage.getBranchTransition(), null, "branchtransition_BranchProbability", null, 1, 1, BranchProbability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

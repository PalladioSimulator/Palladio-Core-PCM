 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.context.allocation.ActualAllocationContext#getActualResourceDemands_ActualAllocationContext <em>Actual Resource Demands Actual Allocation Context</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.context.allocation.ActualAllocationContext#getUsageContext_ActualAllocationContext <em>Usage Context Actual Allocation Context</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.context.allocation.AllocationPackage#getActualAllocationContext()
 * @model
 * @generated
 */
public interface ActualAllocationContext extends EObject {
	 ...
	 * The list contents are of type {@link de.uka.ipd.sdq.context.allocation.ActualResourceDemand}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.uka.ipd.sdq.context.allocation.AllocationPackage#getActualAllocationContext_ActualResourceDemands_ActualAllocationContext()
	 ...
	 * @see de.uka.ipd.sdq.context.allocation.AllocationPackage#getActualAllocationContext_UsageContext_ActualAllocationContext()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.context.allocation.ActualAllocationContext#getUsageContext_ActualAllocationContext <em>Usage Context Actual Allocation Context</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

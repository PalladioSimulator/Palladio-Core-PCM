...
public abstract class MarkovSensitivity {
	 ...
	 * 
	 * @param successProbabilitiy
	 *            the success probability of the current sensitivity analysis
	 *            step
	 */
	public void logResults(final double successProbability) {
		List<String> logResults = getLogSingleResults(successProbability);
		try {
	 ...
	 */
	protected abstract List<String> getLogSingleResults(

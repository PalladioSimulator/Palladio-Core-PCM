...
public class FailureDescription {
	 ...
	 */
	public static FailureDescription createSoftwareInducedFailureDescription(
			final String failureName, final String failureId,
			final double failureProbability) {

		// Create an environment failure type:
		MarkovSoftwareInducedFailureType failureType = new MarkovSoftwareInducedFailureType();
	 ...
	 * @return a corresponding FailureDescription.
	 */
	public static FailureDescription createResourceFailureDescription(
			final String resourceName,
			final String resourceId,
			final double failureProbability) {

		// Create an environment failure type:
		MarkovResourceType resourceType = new MarkovResourceType();
		resourceType.setName(resourceName);
		resourceType.setId(resourceId);
		MarkovResourceFailureType failureType = new MarkovResourceFailureType();

...
public class LzmaBench
{
	...
	static public int LzmaBenchmark(int numIterations, int dictionarySize) throws Exception
	{
		...
		de.uka.ipd.sdq.palladiofileshare.legacy.algorithms.SevenZip.Compression.LZMA.Encoder encoder = new de.uka.ipd.sdq.palladiofileshare.legacy.algorithms.SevenZip.Compression.LZMA.Encoder();
		de.uka.ipd.sdq.palladiofileshare.legacy.algorithms.SevenZip.Compression.LZMA.Decoder decoder = new de.uka.ipd.sdq.palladiofileshare.legacy.algorithms.SevenZip.Compression.LZMA.Decoder();

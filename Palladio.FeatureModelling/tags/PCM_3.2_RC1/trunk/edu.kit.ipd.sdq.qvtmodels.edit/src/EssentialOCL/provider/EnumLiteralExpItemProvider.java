...
/**
 * This is the item provider adapter for a {@link EssentialOCL.EnumLiteralExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumLiteralExpItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumLiteralExp_referredEnumLiteral_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumLiteralExp_referredEnumLiteral_feature", "_UI_EnumLiteralExp_type"),
				 EssentialOCLPackage.Literals.ENUM_LITERAL_EXP__REFERRED_ENUM_LITERAL,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EnumLiteralExp"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_EnumLiteralExp_type") :
			getString("_UI_EnumLiteralExp_type") + " " + label;
	}

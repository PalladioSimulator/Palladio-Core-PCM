...
public class UnitRepositoryItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UnitsPackage.Literals.UNIT_REPOSITORY__UNITS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UnitRepository"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_UnitRepository_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnitRepository.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UnitsPackage.Literals.UNIT_REPOSITORY__UNITS,

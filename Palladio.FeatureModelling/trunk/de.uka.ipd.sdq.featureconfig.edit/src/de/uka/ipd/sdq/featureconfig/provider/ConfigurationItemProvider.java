...
public class ConfigurationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(featureconfigPackage.Literals.CONFIGURATION__DEFAULT_CONFIG);
			childrenFeatures.add(featureconfigPackage.Literals.CONFIGURATION__CONFIG_OVERRIDES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(featureconfigPackage.Literals.CONFIGURATION__DEFAULT_CONFIG,
				 featureconfigFactory.eINSTANCE.createFeatureConfig()));

		newChildDescriptors.add
			(createChildParameter
				(featureconfigPackage.Literals.CONFIGURATION__CONFIG_OVERRIDES,
				 featureconfigFactory.eINSTANCE.createFeatureConfig()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == featureconfigPackage.Literals.CONFIGURATION__DEFAULT_CONFIG ||
			childFeature == featureconfigPackage.Literals.CONFIGURATION__CONFIG_OVERRIDES;

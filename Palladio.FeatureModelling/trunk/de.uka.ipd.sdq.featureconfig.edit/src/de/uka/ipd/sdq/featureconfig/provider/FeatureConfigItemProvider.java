...
public class FeatureConfigItemProvider
	 ...
	 * @generated
	 */
	public FeatureConfigItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addAnnotatedElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureConfig_annotatedElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureConfig_annotatedElement_feature", "_UI_FeatureConfig_type"),
				 featureconfigPackage.Literals.FEATURE_CONFIG__ANNOTATED_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FeatureConfig"));
	}

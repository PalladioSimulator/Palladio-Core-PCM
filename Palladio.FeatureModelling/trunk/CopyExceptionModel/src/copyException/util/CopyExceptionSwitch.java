...
public class CopyExceptionSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CopyExceptionPackage.DELETION: {
				Deletion deletion = (Deletion)theEObject;
				T result = caseDeletion(deletion);
				if (result == null) result = caseException(deletion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CopyExceptionPackage.REPLACEMENT: {
				Replacement replacement = (Replacement)theEObject;
				T result = caseReplacement(replacement);
				if (result == null) result = caseException(replacement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CopyExceptionPackage.REFERENCE: {
				Reference reference = (Reference)theEObject;
				T result = caseReference(reference);
				if (result == null) result = caseException(reference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

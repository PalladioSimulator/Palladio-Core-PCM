 ...
 * <ul>
 *   <li>{@link EMOF.impl.PackageImpl#getNestedPackage <em>Nested Package</em>}</li>
 *   <li>{@link EMOF.impl.PackageImpl#getNestingPackage <em>Nesting Package</em>}</li>
 *   <li>{@link EMOF.impl.PackageImpl#getOwnedType <em>Owned Type</em>}</li>
 *   <li>{@link EMOF.impl.PackageImpl#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageImpl extends NamedElementImpl implements EMOF.Package {
	/**
	...
	public EList<EMOF.Package> getNestedPackage() {
		if (nestedPackage == null) {
			nestedPackage = new EObjectContainmentWithInverseEList<EMOF.Package>(EMOF.Package.class, this, EMOFPackage.PACKAGE__NESTED_PACKAGE, EMOFPackage.PACKAGE__NESTING_PACKAGE);
		}
	...
	public EMOF.Package getNestingPackage() {
		...
		return (EMOF.Package)eContainer();
	}

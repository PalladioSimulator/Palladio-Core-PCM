 ...
 *   <li>{@link QVTBase.impl.TransformationImpl#getNestingPackage <em>Nesting Package</em>}</li>
...
public class TransformationImpl extends ClassImpl implements Transformation {
	...
	public EList<EMOF.Package> getNestedPackage() {
		if (nestedPackage == null) {
			nestedPackage = new EObjectContainmentWithInverseEList<EMOF.Package>(EMOF.Package.class, this, QVTBasePackage.TRANSFORMATION__NESTED_PACKAGE, EMOFPackage.PACKAGE__NESTING_PACKAGE);
		}

	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QVTBasePackage.DOMAIN: {
				...
				if (result == null) result = caseObject(domain);
			...
			case QVTBasePackage.FUNCTION: {
				...
				if (result == null) result = caseObject(function);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTBasePackage.FUNCTION_PARAMETER: {
				...
				if (result == null) result = caseObject(functionParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTBasePackage.PATTERN: {
				...
				if (result == null) result = caseObject(pattern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case QVTBasePackage.RULE: {
				...
				if (result == null) result = caseObject(rule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTBasePackage.TRANSFORMATION: {
				...
				if (result == null) result = casePackage(transformation);
				...
				if (result == null) result = caseObject(transformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTBasePackage.TYPED_MODEL: {
				...
				if (result == null) result = caseObject(typedModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

...
/**
 * This is the item provider adapter for a {@link QVTBase.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_overrides_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_overrides_feature", "_UI_Rule_type"),
				 QVTBasePackage.Literals.RULE__OVERRIDES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QVTBasePackage.Literals.RULE__DOMAIN);
		}

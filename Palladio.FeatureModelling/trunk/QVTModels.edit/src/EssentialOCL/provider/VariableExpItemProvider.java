...
/**
 * This is the item provider adapter for a {@link EssentialOCL.VariableExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableExpItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VariableExp"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_VariableExp_type") :
			getString("_UI_VariableExp_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link EssentialOCL.IntegerLiteralExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerLiteralExpItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerLiteralExp_integerSymbol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerLiteralExp_integerSymbol_feature", "_UI_IntegerLiteralExp_type"),
				 EssentialOCLPackage.Literals.INTEGER_LITERAL_EXP__INTEGER_SYMBOL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_IntegerLiteralExp_type") :
			getString("_UI_IntegerLiteralExp_type") + " " + label;
	}

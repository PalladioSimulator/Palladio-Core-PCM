...
/**
 * This is the item provider adapter for a {@link EssentialOCL.BooleanLiteralExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanLiteralExpItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanLiteralExp_booleanSymbol_feature", "_UI_BooleanLiteralExp_type"),
				 EssentialOCLPackage.Literals.BOOLEAN_LITERAL_EXP__BOOLEAN_SYMBOL,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BooleanLiteralExp"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BooleanLiteralExp_type") :
			getString("_UI_BooleanLiteralExp_type") + " " + label;
	}

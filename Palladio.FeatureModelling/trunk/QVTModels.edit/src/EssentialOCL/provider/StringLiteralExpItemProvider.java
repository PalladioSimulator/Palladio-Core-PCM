...
/**
 * This is the item provider adapter for a {@link EssentialOCL.StringLiteralExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringLiteralExpItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringLiteralExp_stringSymbol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringLiteralExp_stringSymbol_feature", "_UI_StringLiteralExp_type"),
				 EssentialOCLPackage.Literals.STRING_LITERAL_EXP__STRING_SYMBOL,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StringLiteralExp"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_StringLiteralExp_type") :
			getString("_UI_StringLiteralExp_type") + " " + label;
	}

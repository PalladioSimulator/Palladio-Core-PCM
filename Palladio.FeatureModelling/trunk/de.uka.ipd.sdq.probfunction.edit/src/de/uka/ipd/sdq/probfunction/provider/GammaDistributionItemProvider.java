 ...
 * @generated
 */
public class GammaDistributionItemProvider
	...
	protected void addBetaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GammaDistribution_beta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GammaDistribution_beta_feature", "_UI_GammaDistribution_type"),
				 ProbfunctionPackage.Literals.GAMMA_DISTRIBUTION__BETA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GammaDistribution"));
	}

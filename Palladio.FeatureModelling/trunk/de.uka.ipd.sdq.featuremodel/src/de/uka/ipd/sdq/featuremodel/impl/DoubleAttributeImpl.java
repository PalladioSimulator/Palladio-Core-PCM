 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.featuremodel.impl.DoubleAttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoubleAttributeImpl extends AttributeImpl implements DoubleAttribute {
	...
	protected EClass eStaticClass() {
		return featuremodelPackage.Literals.DOUBLE_ATTRIBUTE;
	}
	...
	public void setDefaultValue(double newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, featuremodelPackage.DOUBLE_ATTRIBUTE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Synch Call Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link LqnCore.impl.SynchCallTypeImpl#getDest <em>Dest</em>}</li>
 *   <li>{@link LqnCore.impl.SynchCallTypeImpl#getFanin <em>Fanin</em>}</li>
 *   <li>{@link LqnCore.impl.SynchCallTypeImpl#getFanout <em>Fanout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SynchCallTypeImpl extends EObjectImpl implements SynchCallType {
	...
	public void setDest(String newDest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.SYNCH_CALL_TYPE__DEST, oldDest, dest));
	}
	...
	public void setFanin(int newFanin) {
		...
		faninESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.SYNCH_CALL_TYPE__FANIN, oldFanin, fanin, !oldFaninESet));
	}
	...
	public void unsetFanin() {
		...
		faninESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnCorePackage.SYNCH_CALL_TYPE__FANIN, oldFanin, FANIN_EDEFAULT, oldFaninESet));
	}
	...
	public void setFanout(int newFanout) {
		...
		fanoutESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.SYNCH_CALL_TYPE__FANOUT, oldFanout, fanout, !oldFanoutESet));
	}
	...
	public void unsetFanout() {
		...
		fanoutESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnCorePackage.SYNCH_CALL_TYPE__FANOUT, oldFanout, FANOUT_EDEFAULT, oldFanoutESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LqnCorePackage.SYNCH_CALL_TYPE__DEST:
				return getDest();
			case LqnCorePackage.SYNCH_CALL_TYPE__FANIN:
				return new Integer(getFanin());
			case LqnCorePackage.SYNCH_CALL_TYPE__FANOUT:

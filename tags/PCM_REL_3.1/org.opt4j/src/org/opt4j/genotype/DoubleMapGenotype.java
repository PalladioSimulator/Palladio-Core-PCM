 ...
 *            the type of keys
 */
public class DoubleMapGenotype<K> extends DoubleGenotype implements
		MapGenotype<K, Double> {

	protected final List<K> list;

	/**
	 * Constructs a {@code DoubleMapGenotype}.
	 * 
	 * @param list
	 *            the list of keys
	 * @param bounds
	...
	public <G extends Genotype> G newInstance() {
		try {
			Constructor<? extends DoubleMapGenotype> cstr = this.getClass()

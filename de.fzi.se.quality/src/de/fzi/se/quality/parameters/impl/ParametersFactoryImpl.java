...
public class ParametersFactoryImpl extends EFactoryImpl implements ParametersFactory {
	...
	public static ParametersFactory init() {
		try {
			ParametersFactory theParametersFactory = (ParametersFactory)EPackage.Registry.INSTANCE.getEFactory("http://fzi.de/PalladioComponentModel/Quality/Parameters/0.2"); 

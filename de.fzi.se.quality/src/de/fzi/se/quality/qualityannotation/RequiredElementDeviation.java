...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Required Element Deviation</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link de.fzi.se.quality.qualityannotation.RequiredElementDeviation#getInternalStateInfluenceAnalysisAggregation <em>Internal State Influence Analysis Aggregation</em>}</li>
 *   <li>{@link de.fzi.se.quality.qualityannotation.RequiredElementDeviation#getMaximumDeviationNumberOfCalls <em>Maximum Deviation Number Of Calls</em>}</li>
 *   <li>{@link de.fzi.se.quality.qualityannotation.RequiredElementDeviation#getMaximumDeviationCallParameterValues <em>Maximum Deviation Call Parameter Values</em>}</li>
 *   <li>{@link de.fzi.se.quality.qualityannotation.RequiredElementDeviation#getRequiredElement <em>Required Element</em>}</li>
 * </ul>
 * </p>
 *
...
public interface RequiredElementDeviation extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link de.fzi.se.quality.qualityannotation.InternalStateInfluenceAnalysisAggregation#getRequiredElementDeviations <em>Required Element Deviations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link de.fzi.se.quality.qualityannotation.RequiredElementDeviation#getInternalStateInfluenceAnalysisAggregation <em>Internal State Influence Analysis Aggregation</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.fzi.se.quality.qualityannotation.RequiredElementDeviation#getMaximumDeviationNumberOfCalls <em>Maximum Deviation Number Of Calls</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Maximum Deviation Number Of Calls</em>' reference.
	...
	/**
	 * Returns the value of the '<em><b>Maximum Deviation Call Parameter Values</b></em>' containment reference list.
	 * The list contents are of type {@link de.fzi.se.quality.qualityannotation.ParameterValueDeviation}.
	 * It is bidirectional and its opposite is '{@link de.fzi.se.quality.qualityannotation.ParameterValueDeviation#getRequiredElementDeviation <em>Required Element Deviation</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Maximum Deviation Call Parameter Values</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Maximum Deviation Call Parameter Values</em>' containment reference list.
	 ...
	 * It is bidirectional and its opposite is '{@link de.fzi.se.quality.qualityannotation.RequiredElement#getRequiredElementDeviation <em>Required Element Deviation</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link de.fzi.se.quality.qualityannotation.RequiredElementDeviation#getRequiredElement <em>Required Element</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

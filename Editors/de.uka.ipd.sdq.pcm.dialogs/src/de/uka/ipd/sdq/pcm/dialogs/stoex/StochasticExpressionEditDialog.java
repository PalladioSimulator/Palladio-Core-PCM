...
public class StochasticExpressionEditDialog extends
	 ...
	 * @param ch The characterisation to check.
	...
	/**
	 * Get the context the expression edit dialog is working on.
	 * This provides access to the surrounding seff and the described signature. 
	 * It is used to access provided variables etc.
	 * 
	 * @param The object to access the environment.
	...
	private Parameter[] getContext(EObject rv) {
		...
		if (seff != null && seff.getDescribedService__SEFF() != null) {
			...
			// if the actual context is an ExternalCallAction, that has a return value other than void 
	 ...
	 * @param a The object to get the RDSEFF for.
	...
	/**
	 * Check if the actual container of an object is an external call action.
	 * If this is the case, return the action, otherwise null.
	 * 
	 * @param  a The object to check the container for.

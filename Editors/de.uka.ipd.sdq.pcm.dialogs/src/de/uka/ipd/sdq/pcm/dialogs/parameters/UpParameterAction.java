...
public class UpParameterAction extends EditorContentsSelectionAction
	...
	public void widgetSelected(SelectionEvent e) {
		...
		final EList<Parameter> parameters = getParametersOfSignature(parentSignature);
	...
	private EList<Parameter> getParametersOfSignature(Signature signature){
		if (parentSignature instanceof OperationSignature)
			return ((OperationSignature)parentSignature).getParameters__OperationSignature();
		return null;
	}

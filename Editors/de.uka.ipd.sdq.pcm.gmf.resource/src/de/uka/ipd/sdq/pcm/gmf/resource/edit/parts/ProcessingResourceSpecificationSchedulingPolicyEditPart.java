 ...
 * @generated
 */
public class ProcessingResourceSpecificationSchedulingPolicyEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ProcessingResourceSpecificationSchedulingPolicyEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ProcessingResourceSpecification_3001,
					getParserElement(), PalladioComponentModelVisualIDRegistry
							.getType(de.uka.ipd.sdq.pcm.gmf.resource.edit.parts.ProcessingResourceSpecificationSchedulingPolicyEditPart.VISUAL_ID));
		}
		return parser;
	}

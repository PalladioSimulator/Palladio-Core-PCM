...
public class PalladioComponentModelElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType CommunicationLinkResourceSpecification_3003 = getElementType("de.uka.ipd.sdq.pcm.gmf.resource.CommunicationLinkResourceSpecification_3003"); //$NON-NLS-1$

	/**
	 * @generated
	 */
	public static final IElementType LinkingResourceConnectedResourceContainers_4003 = getElementType("de.uka.ipd.sdq.pcm.gmf.resource.LinkingResourceConnectedResourceContainers_4003"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ResourceContainer_2001, ResourceenvironmentPackage.eINSTANCE.getResourceContainer());

			elements.put(LinkingResource_2003, ResourceenvironmentPackage.eINSTANCE.getLinkingResource());

			elements.put(ProcessingResourceSpecification_3001, ResourceenvironmentPackage.eINSTANCE.getProcessingResourceSpecification());

			elements.put(CommunicationLinkResourceSpecification_3003, ResourceenvironmentPackage.eINSTANCE.getCommunicationLinkResourceSpecification());

			elements
					.put(LinkingResourceConnectedResourceContainers_4003, ResourceenvironmentPackage.eINSTANCE.getLinkingResource_ConnectedResourceContainers());
		}
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(CommunicationLinkResourceSpecification_3003);
			KNOWN_ELEMENT_TYPES.add(LinkingResourceConnectedResourceContainers_4003);
		}
	...
	public static IElementType getElementType(int visualID) {
		...
		case CommunicationLinkResourceSpecificationEditPart.VISUAL_ID:
			return CommunicationLinkResourceSpecification_3003;
		case LinkingResourceConnectedResourceContainersEditPart.VISUAL_ID:
			return LinkingResourceConnectedResourceContainers_4003;
		}
		return null;
	}

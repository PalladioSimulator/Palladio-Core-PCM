...
public class PalladioComponentModelDiagramEditorPlugin extends AbstractUIPlugin {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, PalladioComponentModelDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, PalladioComponentModelDiagramEditorPlugin.ID, IStatus.OK, message, throwable));

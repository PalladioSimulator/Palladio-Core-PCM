...
public class CommunicationLinkResourceSpecificationEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CommunicationLinkResourceSpecificationItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CommunicationLinkResourceSpecificationFailureProbabilityEditPart) {
			((CommunicationLinkResourceSpecificationFailureProbabilityEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureNetworkSwitchSpecificationNameFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel3EditPart) {
			((WrappingLabel3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureThroughputLabelFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel2EditPart) {
			((WrappingLabel2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLatencyLabelFigure());
			return true;
		}
		return false;
	}
	...
	public class NetworkSwitchSpecificationFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureNetworkSwitchSpecificationNameFigure.setText("Network Switch Specification");

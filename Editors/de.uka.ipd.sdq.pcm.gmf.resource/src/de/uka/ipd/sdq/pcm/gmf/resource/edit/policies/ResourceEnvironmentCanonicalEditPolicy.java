...
public class ResourceEnvironmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ResourceContainerEditPart.VISUAL_ID
				|| visualID == LinkingResourceEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
				.getResourceEnvironment_1000SemanticChildren((View) getHost()
						.getModel());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<PalladioComponentModelLinkDescriptor> linkDescriptors = collectAllLinks(
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			for (Iterator<PalladioComponentModelLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				PalladioComponentModelLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<PalladioComponentModelLinkDescriptor> collectAllLinks(
		...
		case ResourceEnvironmentEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PalladioComponentModelDiagramUpdater
						.getResourceEnvironment_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
	...
	private Collection<IAdaptable> createConnections(
			Collection<PalladioComponentModelLinkDescriptor> linkDescriptors,

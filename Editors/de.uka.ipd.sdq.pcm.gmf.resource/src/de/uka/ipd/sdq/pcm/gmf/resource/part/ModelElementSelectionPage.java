...
public class ModelElementSelectionPage extends WizardPage {
    ...
    public void createControl(Composite parent) {
        ...
        modelViewer.setContentProvider(new AdapterFactoryContentProvider(PalladioComponentModelDiagramEditorPlugin
                .getInstance().getItemProvidersAdapterFactory()));
        modelViewer.setLabelProvider(new AdapterFactoryLabelProvider(PalladioComponentModelDiagramEditorPlugin
                .getInstance().getItemProvidersAdapterFactory()));
        if (selectedModelElement != null) {
            modelViewer.setInput(selectedModelElement.eResource());
            modelViewer.setSelection(new StructuredSelection(selectedModelElement));

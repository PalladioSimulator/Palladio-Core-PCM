...
public class ResourceEnvironmentEditPart extends DiagramEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ResourceEnvironmentItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ResourceEnvironmentCanonicalEditPolicy());

...
import de.uka.ipd.sdq.pcm.gmf.resource.part.PalladioComponentModelDiagramEditorUtil;
...
public class PalladioComponentModelMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {
     ...
     * @generated
     */
    public static final String MARKER_TYPE = PalladioComponentModelDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
    ...
    public static void deleteMarkers(IResource resource) {
        try {
            ...
            PalladioComponentModelDiagramEditorPlugin.getInstance().logError("Failed to delete validation markers", e); //$NON-NLS-1$
        }
    }
    ...
    public static IMarker addMarker(IFile file, String elementId, String location, String message, int statusSeverity) {
        ...
        try {
            ...
            PalladioComponentModelDiagramEditorPlugin.getInstance().logError("Failed to create validation marker", e); //$NON-NLS-1$
        }
        return marker;
    }
}

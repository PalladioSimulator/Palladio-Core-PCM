...
public class PalladioComponentModelDiagramUpdater {
     ...
     * @generated
     */
    public static List getResourceContainerResourceContainerCompartment_7004SemanticChildren(View view) {
     ...
     * @generated
     */
    public static List getLinkingResourceNetworkSwitchCompartment_7006SemanticChildren(View view) {
        if (false == view.eContainer() instanceof View) {
            return Collections.EMPTY_LIST;
        }
        View containerView = (View) view.eContainer();
    ...
    public static List getResourceEnvironment_1000SemanticChildren(View view) {
        ...
        for (Iterator it = modelElement.getLinkingResources__ResourceEnvironment().iterator(); it.hasNext();) {
     ...
     * @generated
     */
    public static List getProcessingResourceSpecification_3003ContainedLinks(View view) {
        return Collections.EMPTY_LIST;
    }
     ...
     * @generated
     */
    public static List getCommunicationLinkResourceSpecification_3004ContainedLinks(View view) {
        return Collections.EMPTY_LIST;
    }
     ...
     * @generated
     */
    public static List getProcessingResourceSpecification_3003IncomingLinks(View view) {
        return Collections.EMPTY_LIST;
    }
     ...
     * @generated
     */
    public static List getCommunicationLinkResourceSpecification_3004IncomingLinks(View view) {
        return Collections.EMPTY_LIST;
    }
     ...
     * @generated
     */
    public static List getProcessingResourceSpecification_3003OutgoingLinks(View view) {
        return Collections.EMPTY_LIST;
    }
     ...
     * @generated
     */
    public static List getCommunicationLinkResourceSpecification_3004OutgoingLinks(View view) {
        return Collections.EMPTY_LIST;
    }
    ...
    private static Collection getOutgoingFeatureModelFacetLinks_LinkingResource_ConnectedResourceContainers_LinkingResource_4003(
        ...
        Collection result = new LinkedList();
        for (Iterator destinations = source.getConnectedResourceContainers_LinkingResource().iterator(); destinations
                .hasNext();) {

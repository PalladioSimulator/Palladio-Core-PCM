...
public class PalladioComponentModelNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider,
     ...
     */
    static {
        PalladioComponentModelDiagramEditorPlugin.getInstance().getImageRegistry()
    ...
    public Image getImage(View view) {
        ...
        case CommunicationLinkResourceSpecificationEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/ResourceEnvironment/5.1?CommunicationLinkResourceSpecification", PalladioComponentModelElementTypes.CommunicationLinkResourceSpecification_3004); //$NON-NLS-1$
        case LinkingResourceEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?TopLevelNode?http://palladiosimulator.org/PalladioComponentModel/ResourceEnvironment/5.1?LinkingResource", PalladioComponentModelElementTypes.LinkingResource_2005); //$NON-NLS-1$
        case ProcessingResourceSpecificationEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/ResourceEnvironment/5.1?ProcessingResourceSpecification", PalladioComponentModelElementTypes.ProcessingResourceSpecification_3003); //$NON-NLS-1$
        case ResourceContainer2EditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/ResourceEnvironment/5.1?ResourceContainer", PalladioComponentModelElementTypes.ResourceContainer_3005); //$NON-NLS-1$
        case ResourceContainerEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?TopLevelNode?http://palladiosimulator.org/PalladioComponentModel/ResourceEnvironment/5.1?ResourceContainer", PalladioComponentModelElementTypes.ResourceContainer_2004); //$NON-NLS-1$
        case LinkingResourceConnectedResourceContainers_LinkingResourceEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Link?http://palladiosimulator.org/PalladioComponentModel/ResourceEnvironment/5.1?LinkingResource?connectedResourceContainers_LinkingResource", PalladioComponentModelElementTypes.LinkingResourceConnectedResourceContainers_LinkingResource_4003); //$NON-NLS-1$
        case ResourceEnvironmentEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Diagram?http://palladiosimulator.org/PalladioComponentModel/ResourceEnvironment/5.1?ResourceEnvironment", PalladioComponentModelElementTypes.ResourceEnvironment_1000); //$NON-NLS-1$
        }
    ...
    private String getResourceEnvironment_1000Text(View view) {
        ResourceEnvironment domainModelElement = (ResourceEnvironment) view.getElement();
    ...
    private String getResourceContainer_2004Text(View view) {
        ...
        if (parser != null) {
            ...
            PalladioComponentModelDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5019); //$NON-NLS-1$
            return ""; //$NON-NLS-1$
        }
    }
    ...
    private String getLinkingResource_2005Text(View view) {
        IParser parser = PalladioComponentModelParserProvider.getParser(
                PalladioComponentModelElementTypes.LinkingResource_2005, view.getElement() != null ? view.getElement()
        ...
        if (parser != null) {
            ...
            PalladioComponentModelDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5024); //$NON-NLS-1$
            return ""; //$NON-NLS-1$
        }
    }
    ...
    private String getCommunicationLinkResourceSpecification_3004Text(View view) {
        ...
        if (parser != null) {
            ...
            PalladioComponentModelDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5020); //$NON-NLS-1$
            return ""; //$NON-NLS-1$
        }
    }

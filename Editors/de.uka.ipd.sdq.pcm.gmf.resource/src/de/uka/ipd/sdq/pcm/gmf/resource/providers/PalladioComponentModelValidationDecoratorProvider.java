...
public class PalladioComponentModelValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
     ...
     * @generated
     */
    private static final String MARKER_TYPE = PalladioComponentModelDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
    ...
    public void createDecorators(IDecoratorTarget decoratorTarget) {
        ...
        if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
            ...
            if (((DiagramEditDomain) ed).getEditorPart() instanceof PalladioComponentModelDiagramEditor) {
    ...
    public boolean provides(IOperation operation) {
        ...
        return view != null
                && ResourceEnvironmentEditPart.MODEL_ID.equals(PalladioComponentModelVisualIDRegistry.getModelID(view));
    }
        ...
        PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    PalladioComponentModelDiagramEditorPlugin.getInstance().logError("Decorator refresh failure", e); //$NON-NLS-1$
                }
            }
        });
    }
    ...
    public static class StatusDecorator extends AbstractDecorator {
        ...
        public StatusDecorator(IDecoratorTarget decoratorTarget) {
            ...
            try {
                ...
                PalladioComponentModelDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
            }
        }

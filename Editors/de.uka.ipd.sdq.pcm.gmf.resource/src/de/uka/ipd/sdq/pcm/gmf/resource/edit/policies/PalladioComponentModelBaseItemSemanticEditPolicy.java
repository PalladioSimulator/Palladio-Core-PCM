...
import de.uka.ipd.sdq.pcm.gmf.resource.edit.helpers.PalladioComponentModelBaseEditHelper;
...
public class PalladioComponentModelBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateLinkingResourceConnectedResourceContainers_4003(LinkingResource source, ResourceContainer target) {
			if (source != null) {
				if (source.getConnectedResourceContainers().contains(target)) {
					return false;
				}
			}

			return canExistLinkingResourceConnectedResourceContainers_4003(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistLinkingResourceConnectedResourceContainers_4003(LinkingResource source, ResourceContainer target) {
			return true;
		}
	}

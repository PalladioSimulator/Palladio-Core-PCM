...
public class CustomProcessingResourceSpecificationSchedulingPolicyLabelEditPart
		extends ProcessingResourceSpecificationSchedulingPolicyLabelEditPart {

	public CustomProcessingResourceSpecificationSchedulingPolicyLabelEditPart(
			View view) {
		super(view);

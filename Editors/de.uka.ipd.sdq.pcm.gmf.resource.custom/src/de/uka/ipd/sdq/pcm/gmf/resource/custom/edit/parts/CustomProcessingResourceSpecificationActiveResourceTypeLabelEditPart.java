...
public class CustomProcessingResourceSpecificationActiveResourceTypeLabelEditPart
		extends ProcessingResourceSpecificationActiveResourceTypeLabelEditPart {

	public CustomProcessingResourceSpecificationActiveResourceTypeLabelEditPart(
			View view) {
		super(view);
	}

...
/**
 * This is the action bar contributor for the Entity model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class EntityActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
     ...
     * @generated
     */
    public EntityActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("entity-settings"));
        toolBarManager.add(new Separator("entity-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                PalladioComponentModelEditorPlugin.INSTANCE.getString("_UI_EntityEditor_menu"),
                "org.palladiosimulator.pcm.core.entityMenuID");

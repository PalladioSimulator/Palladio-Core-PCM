 ...
 * @generated
 */
public class SystemDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "de.uka.ipd.sdq.pcm.gmf.system"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static SystemDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	public SystemDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static SystemDiagramEditorPlugin getInstance() {
		return instance;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, SystemDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, SystemDiagramEditorPlugin.ID,

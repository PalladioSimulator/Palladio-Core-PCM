 ...
 * @generated
 */
public class SystemDiagramEditor extends FileDiagramEditor implements
		IGotoMarker {

	/**
	 * @generated
	 */
	public static final String ID = "de.uka.ipd.sdq.pcm.gmf.system.part.SystemDiagramEditorID"; //$NON-NLS-1$
	...
	protected String getEditingDomainID() {
		return "de.uka.ipd.sdq.pcm.gmf.system.EditingDomain"; //$NON-NLS-1$
	}

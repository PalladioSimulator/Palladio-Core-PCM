 ...
 * @generated
 */
public class SinkRoleLabelEditPart extends LabelEditPart implements ITextAwareEditPart {

    /**
     * @generated
     */
    public static final int VISUAL_ID = 6109;
    ...
    static {
        registerSnapBackPosition(
                PalladioComponentModelVisualIDRegistry
                        .getType(de.uka.ipd.sdq.pcm.gmf.repository.edit.parts.SinkRoleLabelEditPart.VISUAL_ID),
                new Point(0, 40));
    }
     ...
     * @generated
     */
    public SinkRoleLabelEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.SinkRole_4109,

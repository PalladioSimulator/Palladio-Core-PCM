...
public class SubSystemEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		SubSystemFigure figure = new SubSystemFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SubSystemEntityNameEditPart) {
			((SubSystemEntityNameEditPart) childEditPart)
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForTarget(
		...
		if (relationshipType == PalladioComponentModelElementTypes.OperationProvidedRole_4105) {
			types
					.add(PalladioComponentModelElementTypes.OperationInterface_2107);
		}
	...
	public class SubSystemFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureSubSystem_Name_LabelFigure.setBorder(new MarginBorder(
			...
			this.add(fFigureSubSystem_Name_LabelFigure,
					constraintFFigureSubSystem_Name_LabelFigure);

 ...
 */
package de.uka.ipd.sdq.pcm.gmf.repository.parsers;
...
public class MessageFormatParser extends AbstractParser {
    ...
    public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
        ...
        if (values == null) {
            return new ParserEditStatus(PalladioComponentModelRepositoryDiagramEditorPlugin.ID,
                    IParserEditStatus.UNEDITABLE, NLS.bind(Messages.MessageFormatParser_InvalidInputError, new Integer(
                            pos.getErrorIndex())));
        }

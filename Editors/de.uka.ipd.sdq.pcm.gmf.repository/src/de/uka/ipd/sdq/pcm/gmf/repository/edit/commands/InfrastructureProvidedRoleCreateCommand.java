...
public class InfrastructureProvidedRoleCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InfrastructureProvidedRoleCreateCommand(
	...
	public boolean canExecute() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateInfrastructureProvidedRole_4111(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		InfrastructureProvidedRole newElement = RepositoryFactory.eINSTANCE
				.createInfrastructureProvidedRole();
		getSource().getProvidedRoles_InterfaceProvidingEntity().add(newElement);
		newElement
				.setProvidedInterface__InfrastructureProvidedRole(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(InfrastructureProvidedRole newElement,

...
import de.uka.ipd.sdq.pcm.gmf.repository.providers.ElementInitializers;
 ...
 * @generated
 */
public class PalladioComponentModelRepositoryDiagramEditorPlugin extends AbstractUIPlugin {
    ...
    protected AdapterFactory createAdapterFactory() {
        ...
        final ComposedAdapterFactory caf = new ComposedAdapterFactory(factories) {
            ...
            public ComposeableAdapterFactory getRootAdapterFactory() {
                return (ComposeableAdapterFactory) PalladioComponentModelRepositoryDiagramEditorPlugin.this.adapterFactory;
            }
    ...
    public void logError(String error, final Throwable throwable) {
        ...
        getLog().log(
                new Status(IStatus.ERROR, PalladioComponentModelRepositoryDiagramEditorPlugin.ID, IStatus.OK, error,
                        throwable));
    ...
    public void logInfo(String message, final Throwable throwable) {
        ...
        getLog().log(
                new Status(IStatus.INFO, PalladioComponentModelRepositoryDiagramEditorPlugin.ID, IStatus.OK, message,
                        throwable));

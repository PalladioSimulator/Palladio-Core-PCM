...
public class EventGroupEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EventGroupItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		EventGroupFigure figure = new EventGroupFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventGroupEntityNameEditPart) {
			((EventGroupEntityNameEditPart) childEditPart)
		...
		if (childEditPart instanceof EventGroupEventTypeListEditPart) {
			...
			pane.add(((EventGroupEventTypeListEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventGroupEventTypeListEditPart) {
			IFigure pane = getPrimaryShape().getFigureEventGroupCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((EventGroupEventTypeListEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public class EventGroupFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureEventGroup_Name_LabelFigure.setBorder(new MarginBorder(
			...
			this.add(fFigureEventGroup_Name_LabelFigure,
					constraintFFigureEventGroup_Name_LabelFigure);
			...
			fFigureEventGroupCompartment.setLineWidth(1);
			fFigureEventGroupCompartment.setMinimumSize(new Dimension(

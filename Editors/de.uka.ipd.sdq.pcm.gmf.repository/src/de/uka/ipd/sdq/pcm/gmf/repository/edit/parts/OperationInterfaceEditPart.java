...
public class OperationInterfaceEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OperationInterfaceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationInterfaceEntityNameEditPart) {
			((OperationInterfaceEntityNameEditPart) childEditPart)
		...
		if (childEditPart instanceof OperationInterfaceSignatureListEditPart) {
			...
			pane.add(((OperationInterfaceSignatureListEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof OperationInterfaceSignatureListEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((OperationInterfaceSignatureListEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	public class InterfaceFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureInterfaceCompartment.setMinimumSize(new Dimension(

...
public class InfrastructureRequiredRoleCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InfrastructureRequiredRoleCreateCommand(
	...
	public boolean canExecute() {
		...
		if (target != null
				&& false == target instanceof InfrastructureInterface) {
			return false;
		}
		if (getSource() == null) {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateInfrastructureRequiredRole_4112(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		InfrastructureRequiredRole newElement = RepositoryFactory.eINSTANCE
				.createInfrastructureRequiredRole();
		getSource().getRequiredRoles_InterfaceRequiringEntity().add(newElement);
		newElement
				.setRequiredInterface__InfrastructureRequiredRole(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(InfrastructureRequiredRole newElement,

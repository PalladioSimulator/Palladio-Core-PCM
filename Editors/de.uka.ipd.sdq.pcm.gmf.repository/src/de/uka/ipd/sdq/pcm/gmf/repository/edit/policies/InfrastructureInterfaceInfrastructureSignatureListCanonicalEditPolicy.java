 ...
 * @generated
 */
public class InfrastructureInterfaceInfrastructureSignatureListCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getInfrastructureInterfaceInfrastructureSignatureList_7108SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return InfrastructureSignatureEditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getInfrastructureInterfaceInfrastructureSignatureList_7108SemanticChildren((View) getHost().getModel());

 ...
 * @generated
 */
public class BasicComponentComponentParameterCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getBasicComponentComponentParameterCompartment_7104SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getBasicComponentComponentParameterCompartment_7104SemanticChildren((View) getHost().getModel());

...
public class PalladioComponentModelViewProvider extends AbstractProvider
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return InterfaceEditPart.VISUAL_ID == visualID
				...
				|| SignatureEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case InterfaceEditPart.VISUAL_ID:
			return createInterface_2101(domainElement, containerView, index,
		...
		case SubSystemEditPart.VISUAL_ID:
			return createSubSystem_2106(domainElement, containerView, index,
					persisted, preferencesHint);
		case SignatureEditPart.VISUAL_ID:
			return createSignature_3101(domainElement, containerView, index,
					persisted, preferencesHint);
		case ResourceDemandingSEFFEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case ProvidedRoleEditPart.VISUAL_ID:
			return createProvidedRole_4101(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case RequiredRoleEditPart.VISUAL_ID:
			return createRequiredRole_4102(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
	 ...
	 * @generated
	 */
	public Node createInterface_2101(EObject domainElement, View containerView,
		...
		createCompartment(node, PalladioComponentModelVisualIDRegistry
				.getType(InterfaceSignatureListEditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createSignature_3101(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createProvidedRole_4101(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createRequiredRole_4102(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6102 = createLabel(edge,
				PalladioComponentModelVisualIDRegistry
						.getType(WrappingLabel3EditPart.VISUAL_ID));
		label6102.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label6102.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location6102 = (Location) label6102.getLayoutConstraint();
		location6102.setX(0);
		location6102.setY(40);
		return edge;
	}

...
public class PalladioComponentModelNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider,
    ...
    public Image getImage(View view) {
        ...
        case InterfaceParentInterfaces__InterfaceEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Link?http://sdq.ipd.uka.de/PalladioComponentModel/Repository/5.0?Interface?parentInterfaces__Interface", PalladioComponentModelElementTypes.InterfaceParentInterfaces__Interface_4113); //$NON-NLS-1$

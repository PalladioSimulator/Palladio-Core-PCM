 ...
 * @generated
 */
public class CompositeComponentItemSemanticEditPolicy extends PalladioComponentModelBaseItemSemanticEditPolicy {
    ...
    protected Command getDestroyElementCommand(DestroyElementRequest req) {
        ...
        for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
            ...
            if (PalladioComponentModelVisualIDRegistry.getVisualID(outgoingLink) == ImplementationComponentTypeParentCompleteComponentTypesEditPart.VISUAL_ID) {

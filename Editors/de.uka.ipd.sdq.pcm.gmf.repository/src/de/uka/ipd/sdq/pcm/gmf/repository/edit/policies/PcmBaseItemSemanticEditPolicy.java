...
import de.uka.ipd.sdq.pcm.gmf.repository.edit.helpers.PcmBaseEditHelper;

/**
 * @generated
 */
public class PcmBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (epCommand != null) {
			...
			completedRequest.setParameter(
					PcmBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}

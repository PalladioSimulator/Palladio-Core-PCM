...
import de.uka.ipd.sdq.pcm.gmf.repository.edit.policies.ResourceServiceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ResourceServiceEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResourceServiceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ResourceServiceItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new PalladioComponentModelParserProvider.HintAdapter(
					PalladioComponentModelElementTypes.ResourceService_3106,
	...
	protected IFigure createFigurePrim() {
		return new ResourceServiceServiceNameFigure();
	}

	/**
	 * @generated
	 */
	public class ResourceServiceServiceNameFigure extends WrapLabel {

		/**
		 * @generated
		 */
		public ResourceServiceServiceNameFigure() {
			this.setText("<...>");
		}

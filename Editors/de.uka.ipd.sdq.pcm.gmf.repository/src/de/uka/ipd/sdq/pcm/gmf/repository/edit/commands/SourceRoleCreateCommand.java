...
public class SourceRoleCreateCommand extends EditElementCommand {
     ...
     * @generated
     */
    public SourceRoleCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
    ...
    public boolean canExecute() {
        ...
        if (target != null && false == target instanceof EventGroup) {
            return false;
        }
        if (getSource() == null) {
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
        ...
        SourceRole newElement = RepositoryFactory.eINSTANCE.createSourceRole();
        getSource().getRequiredRoles_InterfaceRequiringEntity().add(newElement);
        newElement.setEventGroup__SourceRole(getTarget());
     ...
     * @generated
     */
    protected void doConfigure(SourceRole newElement, IProgressMonitor monitor, IAdaptable info)
     ...
     * @generated
     */
    protected EventGroup getTarget() {
        return (EventGroup) target;
    }

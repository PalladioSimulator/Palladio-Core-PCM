 ...
 * @generated
 */
public class InfrastructureSignatureEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public InfrastructureSignatureEditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InfrastructureSignatureItemSemanticEditPolicy());
            ...
            parser = PalladioComponentModelParserProvider
                    .getParser(
                            ...
                            PalladioComponentModelVisualIDRegistry
                                    .getType(de.uka.ipd.sdq.pcm.gmf.repository.edit.parts.InfrastructureSignatureEditPart.VISUAL_ID));
        }
        return parser;
    }
    ...
    protected void addSemanticListeners() {
        InfrastructureSignature element = (InfrastructureSignature) resolveSemanticElement();
    ...
    protected void handleNotificationEvent(Notification event) {
        ...
        if (NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
            ...
            if (notifier instanceof Parameter) {
                ...
                notifier = param.getInfrastructureSignature__Parameter();
            }
    ...
    protected IFigure createFigurePrim() {
        return new SignatureServiceNameFigure();
    }

    /**
     * @generated
     */
    public class SignatureServiceNameFigure extends WrappingLabel {

        /**
         * @generated
         */
        public SignatureServiceNameFigure() {
            this.setText("<...>");
        }

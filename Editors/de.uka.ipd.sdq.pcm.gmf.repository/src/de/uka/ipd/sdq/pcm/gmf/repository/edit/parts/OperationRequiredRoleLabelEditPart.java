 ...
 * @generated
 */
public class OperationRequiredRoleLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
    ...
    static {
        registerSnapBackPosition(
                PalladioComponentModelVisualIDRegistry
                        .getType(de.uka.ipd.sdq.pcm.gmf.repository.edit.parts.OperationRequiredRoleLabelEditPart.VISUAL_ID),
                new Point(0, 40));
    }
     ...
     * @generated
     */
    public OperationRequiredRoleLabelEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(
                    PalladioComponentModelElementTypes.OperationRequiredRole_4106, getParserElement(),

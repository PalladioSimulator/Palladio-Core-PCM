...
public class EventChannelSinkConnectorSection extends AbstractPropertySection {
	...
	* The Property Sheet Page used to display the standard properties
	...
	private EventFilterEditorSection propertySection;
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		propertySection.getAddButtonListener().setSelectedConnector((Connector) input);
		propertySection.getDeleteButtonListener().setSelectedConnector((Connector) input);
	}

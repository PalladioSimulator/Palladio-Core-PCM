...
public class PalladioComponentModelNavigatorLabelProvider extends LabelProvider
	...
	public Image getImage(View view) {
		...
		case EmitEventActionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://sdq.ipd.uka.de/PalladioComponentModel/SEFF/4.0?EmitEventAction", PalladioComponentModelElementTypes.EmitEventAction_2013); //$NON-NLS-1$
		...
		case RecoveryBlockActionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://sdq.ipd.uka.de/PalladioComponentModel/SEFF/SEFF_Reliability/1.0?RecoveryBlockAction", PalladioComponentModelElementTypes.RecoveryBlockAction_2015); //$NON-NLS-1$
		case VariableUsageEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/Parameter/4.0?VariableUsage", PalladioComponentModelElementTypes.VariableUsage_3042); //$NON-NLS-1$
		...
		case VariableUsage2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/Parameter/4.0?VariableUsage", PalladioComponentModelElementTypes.VariableUsage_3049); //$NON-NLS-1$
		...
		case VariableUsage4EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/Parameter/4.0?VariableUsage", PalladioComponentModelElementTypes.VariableUsage_3047); //$NON-NLS-1$
		...
		case InternalFailureOccurrenceDescriptionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/Reliability/4.0?InternalFailureOccurrenceDescription", PalladioComponentModelElementTypes.InternalFailureOccurrenceDescription_3050); //$NON-NLS-1$
		...
		case VariableUsage5EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/Parameter/4.0?VariableUsage", PalladioComponentModelElementTypes.VariableUsage_3054); //$NON-NLS-1$
		case VariableCharacterisation4EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/Parameter/4.0?VariableCharacterisation", PalladioComponentModelElementTypes.VariableCharacterisation_3048); //$NON-NLS-1$
		...
		case EmitEventAction2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/SEFF/4.0?EmitEventAction", PalladioComponentModelElementTypes.EmitEventAction_3046); //$NON-NLS-1$
		...
		case RecoveryBlockAction2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/SEFF/SEFF_Reliability/1.0?RecoveryBlockAction", PalladioComponentModelElementTypes.RecoveryBlockAction_3056); //$NON-NLS-1$
		case RecoveryBlockAlternativeBehaviourEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/SEFF/SEFF_Reliability/1.0?RecoveryBlockAlternativeBehaviour", PalladioComponentModelElementTypes.RecoveryBlockAlternativeBehaviour_3052); //$NON-NLS-1$
		...
		case VariableCharacterisation5EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/Parameter/4.0?VariableCharacterisation", PalladioComponentModelElementTypes.VariableCharacterisation_3055); //$NON-NLS-1$
		case SynchronisationPointEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/SEFF/4.0?SynchronisationPoint", PalladioComponentModelElementTypes.SynchronisationPoint_3038); //$NON-NLS-1$
		case ForkedBehaviour2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://sdq.ipd.uka.de/PalladioComponentModel/SEFF/4.0?ForkedBehaviour", PalladioComponentModelElementTypes.ForkedBehaviour_3039); //$NON-NLS-1$
		...
		case RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviourEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://sdq.ipd.uka.de/PalladioComponentModel/SEFF/SEFF_Reliability/1.0?RecoveryBlockAlternativeBehaviour?nextAlternative_RecoveryBlockAlternativeBehaviour", PalladioComponentModelElementTypes.RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviour_4002); //$NON-NLS-1$
		}
	...
	public String getText(View view) {
		...
		case RecoveryBlockActionEditPart.VISUAL_ID:
			return getRecoveryBlockAction_2015Text(view);
		case VariableUsageEditPart.VISUAL_ID:
		...
		case RecoveryBlockAction2EditPart.VISUAL_ID:
			return getRecoveryBlockAction_3056Text(view);
		case RecoveryBlockAlternativeBehaviourEditPart.VISUAL_ID:
			return getRecoveryBlockAlternativeBehaviour_3052Text(view);
		case SetVariableAction2EditPart.VISUAL_ID:
		...
		case RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviourEditPart.VISUAL_ID:
			return getRecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviour_4002Text(view);
		}
	...
	private String getEmitEventAction_2013Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.EmitEventAction_2013, view
	 ...
	 * @generated
	 */
	private String getRecoveryBlockAction_2015Text(View view) {
		IParser parser = PalladioComponentModelParserProvider
				.getParser(
						PalladioComponentModelElementTypes.RecoveryBlockAction_2015,
						view.getElement() != null ? view.getElement() : view,
						PalladioComponentModelVisualIDRegistry
	...
	private String getVariableUsage_3042Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.VariableUsage_3042, view
						.getElement() != null ? view.getElement() : view,
				PalladioComponentModelVisualIDRegistry
	...
	private String getVariableUsage_3049Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.VariableUsage_3049, view
						.getElement() != null ? view.getElement() : view,
				PalladioComponentModelVisualIDRegistry
	...
	private String getVariableUsage_3047Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.VariableUsage_3047, view
						.getElement() != null ? view.getElement() : view,
				PalladioComponentModelVisualIDRegistry
	...
	private String getParametricResourceDemand_3051Text(View view) {
		...
		if (parser != null) {
			...
			PalladioComponentModelSeffDiagramEditorPlugin.getInstance()
					.logError("Parser was not found for label " + 3051); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getInternalFailureOccurrenceDescription_3050Text(View view) {
		...
		if (parser != null) {
			...
			PalladioComponentModelSeffDiagramEditorPlugin.getInstance()
					.logError("Parser was not found for label " + 3050); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getVariableUsage_3054Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.VariableUsage_3054, view
						.getElement() != null ? view.getElement() : view,
				PalladioComponentModelVisualIDRegistry
						.getType(VariableUsage5LabelEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(
					view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
	...
	private String getEmitEventAction_3046Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.EmitEventAction_3046, view
						.getElement() != null ? view.getElement() : view,
				PalladioComponentModelVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getRecoveryBlockAction_3056Text(View view) {
		IParser parser = PalladioComponentModelParserProvider
				.getParser(
						PalladioComponentModelElementTypes.RecoveryBlockAction_3056,
						view.getElement() != null ? view.getElement() : view,
						PalladioComponentModelVisualIDRegistry
	...
	private String getVariableUsage_3036Text(View view) {
		IParser parser = PalladioComponentModelParserProvider.getParser(
				PalladioComponentModelElementTypes.VariableUsage_3036, view
						.getElement() != null ? view.getElement() : view,
				PalladioComponentModelVisualIDRegistry
						.getType(VariableUsage3LabelEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(
					view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
	...
	private String getVariableCharacterisation_3055Text(View view) {
		IParser parser = PalladioComponentModelParserProvider
				.getParser(
						...
						view.getElement() != null ? view.getElement() : view,
						PalladioComponentModelVisualIDRegistry
								.getType(VariableCharacterisation5EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(
					view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
			...
			PalladioComponentModelSeffDiagramEditorPlugin.getInstance()
					.logError("Parser was not found for label " + 3055); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getVariableCharacterisation_3048Text(View view) {
		IParser parser = PalladioComponentModelParserProvider
				.getParser(
						...
						view.getElement() != null ? view.getElement() : view,
						PalladioComponentModelVisualIDRegistry
								.getType(VariableCharacterisation4EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(
					view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
			...
			PalladioComponentModelSeffDiagramEditorPlugin.getInstance()
					.logError("Parser was not found for label " + 3048); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getRecoveryBlockAlternativeBehaviour_3052Text(View view) {
		IParser parser = PalladioComponentModelParserProvider
				.getParser(
						PalladioComponentModelElementTypes.RecoveryBlockAlternativeBehaviour_3052,
						view.getElement() != null ? view.getElement() : view,
						PalladioComponentModelVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getRecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviour_4002Text(
			View view) {
		return ""; //$NON-NLS-1$
	}

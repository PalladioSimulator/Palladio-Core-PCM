 ...
 * @generated
 */
public class InternalActionInfrastructureCallsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected EStructuralFeature getFeatureToSynchronize() {
        return SeffPackage.eINSTANCE.getAbstractInternalControlFlowAction_InfrastructureCall__Action();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getInternalActionInfrastructureCallsCompartment_7051SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return InfrastructureCallEditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getInternalActionInfrastructureCallsCompartment_7051SemanticChildren((View) getHost().getModel());

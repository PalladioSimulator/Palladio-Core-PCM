...
public class VariableUsage4EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new VariableUsage4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof VariableUsage4LabelEditPart) {
			((VariableUsage4LabelEditPart) childEditPart)
		...
		if (childEditPart instanceof VariableUsageVariableCharacterisation4EditPart) {
			...
			pane
					.add(((VariableUsageVariableCharacterisation4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof VariableUsageVariableCharacterisation4EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((VariableUsageVariableCharacterisation4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;

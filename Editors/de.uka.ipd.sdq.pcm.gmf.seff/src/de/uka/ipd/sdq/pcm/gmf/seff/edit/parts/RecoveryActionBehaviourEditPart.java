...
public class RecoveryActionBehaviourEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RecoveryActionBehaviourItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RecoveryActionBehaviourEntityNameEditPart) {
			((RecoveryActionBehaviourEntityNameEditPart) childEditPart)
		...
		if (childEditPart instanceof RecoveryActionBehaviourAlternativeBehaviourCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRecoveryActionBehaviourCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RecoveryActionBehaviourAlternativeBehaviourCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RecoveryActionBehaviourAlternativeBehaviourCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RecoveryActionBehaviourAlternativeBehaviourCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (relationshipType == PalladioComponentModelElementTypes.RecoveryActionBehaviourNextAlternative__RecoveryActionBehaviour_4003) {
			types
	...
	public class RecoveryActionBehaviourFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			recoveryActionBehaviourStereotype0
					.setText("<<RecoveryActionBehaviour>>");
			recoveryActionBehaviourStereotype0.setBorder(new MarginBorder(
			...
			this.add(recoveryActionBehaviourStereotype0,
					constraintRecoveryActionBehaviourStereotype0);

			fFigureRecoveryActionBehaviourNameLabel = new WrappingLabel();
			fFigureRecoveryActionBehaviourNameLabel.setText("");
			fFigureRecoveryActionBehaviourNameLabel.setBorder(new MarginBorder(
					getMapMode().DPtoLP(2), getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(2), getMapMode().DPtoLP(0)));
			...
			this.add(fFigureRecoveryActionBehaviourNameLabel,
					constraintFFigureRecoveryActionBehaviourNameLabel);
			...
			fFigureRecoveryActionBehaviourCompartment
			...
			this.add(fFigureRecoveryActionBehaviourCompartment,
					constraintFFigureRecoveryActionBehaviourCompartment);

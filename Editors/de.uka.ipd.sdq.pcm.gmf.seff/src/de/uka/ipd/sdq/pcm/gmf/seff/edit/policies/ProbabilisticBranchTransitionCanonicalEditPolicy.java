...
public class ProbabilisticBranchTransitionCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getProbabilisticBranchTransition_3010SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return ResourceDemandingBehaviour2EditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getProbabilisticBranchTransition_3010SemanticChildren((View) getHost().getModel());

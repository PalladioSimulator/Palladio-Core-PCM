...
public class ReleaseActionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ReleaseActionEntityNameEditPart) {
			((ReleaseActionEntityNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureReleaseNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(ReleaseActionEntityNameEditPart.VISUAL_ID));
	}

...
public class ExternalCallActionOutputVariableUsage2CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getExternalCallActionOutputVariableUsage_7023SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getExternalCallActionOutputVariableUsage_7023SemanticChildren((View) getHost().getModel());

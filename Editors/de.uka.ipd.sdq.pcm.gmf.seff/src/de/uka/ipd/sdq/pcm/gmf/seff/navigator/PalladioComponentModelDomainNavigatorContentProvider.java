...
public class PalladioComponentModelDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	public PalladioComponentModelDomainNavigatorContentProvider() {
		myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(PalladioComponentModelSeffDiagramEditorPlugin.getInstance()
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof PalladioComponentModelDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(((PalladioComponentModelDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new PalladioComponentModelDomainNavigatorItem((EObject) objects[i], parentElement, myAdapterFctoryContentProvier));
			}
		}

...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.policies.RecoveryBlockAction2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RecoveryBlockAction2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RecoveryBlockAction2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RecoveryBlockAction2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RecoveryBlockActionEntityName2EditPart) {
			((RecoveryBlockActionEntityName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRecoveryBlockActionNameLabel());
			return true;
		}
		if (childEditPart instanceof RecoveryBlockActionRecoveryBlockCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRecoveryBlockActionCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RecoveryBlockActionRecoveryBlockCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RecoveryBlockActionRecoveryBlockCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RecoveryBlockActionRecoveryBlockCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.RecoveryBlockAction2EditPart) {
			types
					.add(PalladioComponentModelElementTypes.AbstractActionSuccessor_AbstractAction_4001);
		}

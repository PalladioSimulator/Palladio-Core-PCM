...
public class ResourceDemandingBehaviourBehaviourCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceDemandingBehaviourBehaviourCompartment_7009SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceDemandingBehaviourBehaviourCompartment_7009SemanticChildren((View) getHost().getModel());

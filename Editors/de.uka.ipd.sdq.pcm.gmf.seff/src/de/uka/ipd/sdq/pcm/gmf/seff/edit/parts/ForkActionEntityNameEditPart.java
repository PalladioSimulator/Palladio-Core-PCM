 ...
 * @generated
 */
public class ForkActionEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ForkActionEntityNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ForkAction_2011, getParserElement(),
					PalladioComponentModelVisualIDRegistry.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ForkActionEntityNameEditPart.VISUAL_ID));
		}
		return parser;
	}

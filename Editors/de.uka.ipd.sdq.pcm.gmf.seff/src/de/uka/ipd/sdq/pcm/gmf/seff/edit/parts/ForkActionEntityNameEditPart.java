...
/**
 * The Class ForkActionEntityNameEditPart.
 *
 * @generated
 */
public class ForkActionEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new fork action entity name edit part.
     *
     * @param view the view
     * @generated
     */
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.ForkAction_2011,
                    getParserElement(), PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ForkActionEntityNameEditPart.VISUAL_ID));
        }
        return parser;
    }

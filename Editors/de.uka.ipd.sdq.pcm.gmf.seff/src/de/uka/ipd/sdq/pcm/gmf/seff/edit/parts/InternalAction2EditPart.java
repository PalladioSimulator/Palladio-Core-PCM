...
public class InternalAction2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InternalActionFailureOccurrenceDescriptionsEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((InternalActionFailureOccurrenceDescriptionsEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof InternalActionInfrastructureCallsCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((InternalActionInfrastructureCallsCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InternalActionFailureOccurrenceDescriptionsEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((InternalActionFailureOccurrenceDescriptionsEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof InternalActionInfrastructureCallsCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((InternalActionInfrastructureCallsCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;

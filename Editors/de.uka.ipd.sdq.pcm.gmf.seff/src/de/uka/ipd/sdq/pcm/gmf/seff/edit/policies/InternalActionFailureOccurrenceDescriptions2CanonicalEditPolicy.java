 ...
 * @generated
 */
public class InternalActionFailureOccurrenceDescriptions2CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected EStructuralFeature getFeatureToSynchronize() {
        return SeffPackage.eINSTANCE.getInternalAction_InternalFailureOccurrenceDescriptions__InternalAction();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getInternalActionFailureOccurrenceDescriptions_7046SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return InternalFailureOccurrenceDescriptionEditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getInternalActionFailureOccurrenceDescriptions_7046SemanticChildren((View) getHost().getModel());

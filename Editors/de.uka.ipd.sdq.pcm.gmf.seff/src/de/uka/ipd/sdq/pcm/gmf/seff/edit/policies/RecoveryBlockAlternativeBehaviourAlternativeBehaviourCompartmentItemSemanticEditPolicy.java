 ...
 * @generated
 */
public class RecoveryBlockAlternativeBehaviourAlternativeBehaviourCompartmentItemSemanticEditPolicy
		extends PalladioComponentModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RecoveryBlockAlternativeBehaviourAlternativeBehaviourCompartmentItemSemanticEditPolicy() {
		super(
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (PalladioComponentModelElementTypes.EmitEventAction_3046 == req
				.getElementType()) {

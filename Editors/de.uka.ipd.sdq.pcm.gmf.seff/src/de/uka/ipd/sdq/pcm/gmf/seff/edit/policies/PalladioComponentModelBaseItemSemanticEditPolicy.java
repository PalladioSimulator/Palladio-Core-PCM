...
public class PalladioComponentModelBaseItemSemanticEditPolicy extends
	...
	public static class LinkConstraints {
		...
		public static boolean canCreateAbstractActionSuccessor_AbstractAction_4001(
			...
			if (target != null
					&& (target.getPredecessor_AbstractAction() != null)) {
				return false;
			}

			return canExistAbstractActionSuccessor_AbstractAction_4001(source,
					target);
		}
		...
		public static boolean canCreateRecoveryActionBehaviourFailureHandlingAlternatives__RecoveryActionBehaviour_4004(
			...
			return canExistRecoveryActionBehaviourFailureHandlingAlternatives__RecoveryActionBehaviour_4004(
					source, target);
		}

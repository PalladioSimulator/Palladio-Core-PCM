 ...
 * @generated
 */
public class ExternalCallActionInputVariableUsageItemSemanticEditPolicy extends PalladioComponentModelBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PalladioComponentModelElementTypes.VariableUsage_3038 == req.getElementType()) {

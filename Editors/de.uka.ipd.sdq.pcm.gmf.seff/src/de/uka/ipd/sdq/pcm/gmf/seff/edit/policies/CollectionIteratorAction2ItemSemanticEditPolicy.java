 ...
 * @generated
 */
public class CollectionIteratorAction2ItemSemanticEditPolicy extends PalladioComponentModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CollectionIteratorAction2ItemSemanticEditPolicy() {
		super(PalladioComponentModelElementTypes.CollectionIteratorAction_3013);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PalladioComponentModelElementTypes.ResourceDemandingBehaviour_3014 == req.getElementType()) {
			return getGEFWrapper(new ResourceDemandingBehaviour3CreateCommand(req));
		}
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (PalladioComponentModelElementTypes.AbstractActionSuccessor_AbstractAction_4001 == req.getElementType()) {
			return getGEFWrapper(new AbstractActionSuccessor_AbstractActionCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}

 ...
 * @generated
 */
public class LoopAction2ItemSemanticEditPolicy extends PalladioComponentModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public LoopAction2ItemSemanticEditPolicy() {
		super(PalladioComponentModelElementTypes.LoopAction_3006);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PalladioComponentModelElementTypes.ResourceDemandingBehaviour_3003 == req.getElementType()) {
			return getGEFWrapper(new ResourceDemandingBehaviourCreateCommand(req));
		}

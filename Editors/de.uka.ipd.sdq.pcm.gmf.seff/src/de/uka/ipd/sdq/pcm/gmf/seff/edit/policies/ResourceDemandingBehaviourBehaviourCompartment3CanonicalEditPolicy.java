 ...
 * @generated
 */
public class ResourceDemandingBehaviourBehaviourCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceDemandingBehaviourBehaviourCompartment_7014SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceDemandingBehaviourBehaviourCompartment_7014SemanticChildren((View) getHost().getModel());

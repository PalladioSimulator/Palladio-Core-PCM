 ...
 * @generated
 */
public class CollectionIteratorActionEntityName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CollectionIteratorActionEntityName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.CollectionIteratorAction_3013, getParserElement(),
					PalladioComponentModelVisualIDRegistry
							.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.CollectionIteratorActionEntityName2EditPart.VISUAL_ID));
		}
		return parser;
	}

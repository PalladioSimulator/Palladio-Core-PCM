 ...
 * @generated
 */
public class VariableUsageVariableCharacterisation2CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getVariableUsageVariableCharacterisation_7044SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return VariableCharacterisation2EditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getVariableUsageVariableCharacterisation_7044SemanticChildren((View) getHost().getModel());

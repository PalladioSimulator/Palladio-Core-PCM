 ...
 * @generated
 */
public class VariableUsageVariableCharacterisationCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getVariableUsageVariableCharacterisation_7037SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return VariableCharacterisationEditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getVariableUsageVariableCharacterisation_7037SemanticChildren((View) getHost().getModel());

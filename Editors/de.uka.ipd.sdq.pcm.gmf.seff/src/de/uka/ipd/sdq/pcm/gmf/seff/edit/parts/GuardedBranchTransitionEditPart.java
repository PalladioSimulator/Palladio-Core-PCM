...
public class GuardedBranchTransitionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel8EditPart) {
			((WrappingLabel8EditPart) childEditPart).setLabel(getPrimaryShape().getFigureBranchTransitionConditionLabel());
			return true;
		}
		if (childEditPart instanceof GuardedBranchTransitionEntityNameEditPart) {
			((GuardedBranchTransitionEntityNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureBranchTransitionNameLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(GuardedBranchTransitionEntityNameEditPart.VISUAL_ID));
	}

...
/**
 * The Class RecoveryActionEntityNameEditPart.
 *
 * @generated
 */
public class RecoveryActionEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new recovery action entity name edit part.
     *
     * @param view the view
     * @generated
     */
    public RecoveryActionEntityNameEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider
                    .getParser(
                            PalladioComponentModelElementTypes.RecoveryAction_2016,
                            getParserElement(),
                            PalladioComponentModelVisualIDRegistry
                                    .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.RecoveryActionEntityNameEditPart.VISUAL_ID));
        }
        return parser;
    }

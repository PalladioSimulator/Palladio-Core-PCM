...
public class RecoveryActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RecoveryActionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RecoveryActionEntityNameEditPart) {
			((RecoveryActionEntityNameEditPart) childEditPart)
		...
		if (childEditPart instanceof RecoveryActionRecoveryBlockCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRecoveryActionCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RecoveryActionRecoveryBlockCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RecoveryActionRecoveryBlockCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RecoveryActionRecoveryBlockCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	public class RecoveryActionFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			recoveryActionStereotype0.setBorder(new MarginBorder(getMapMode()
			...
			this.add(recoveryActionStereotype0,
					constraintRecoveryActionStereotype0);

			fFigureRecoveryActionNameLabel = new WrappingLabel();
			fFigureRecoveryActionNameLabel.setText("");
			fFigureRecoveryActionNameLabel.setBorder(new MarginBorder(
			...
			this.add(fFigureRecoveryActionNameLabel,
					constraintFFigureRecoveryActionNameLabel);
			...
			fFigureRecoveryActionCompartment.setMinimumSize(new Dimension(
			...
			this.add(fFigureRecoveryActionCompartment,
					constraintFFigureRecoveryActionCompartment);

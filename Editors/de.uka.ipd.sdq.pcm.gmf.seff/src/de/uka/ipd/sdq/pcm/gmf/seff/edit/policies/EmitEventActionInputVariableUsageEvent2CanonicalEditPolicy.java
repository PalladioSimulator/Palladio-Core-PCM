...
public class EmitEventActionInputVariableUsageEvent2CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getEmitEventActionInputVariableUsageEvent_7041SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getEmitEventActionInputVariableUsageEvent_7041SemanticChildren((View) getHost().getModel());

...
/**
 * The Class EmitEventActionEntityName2EditPart.
 *
 * @generated
 */
public class EmitEventActionEntityName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new emit event action entity name2 edit part.
     *
     * @param view the view
     * @generated
     */
    public EmitEventActionEntityName2EditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider
                    .getParser(
                            PalladioComponentModelElementTypes.EmitEventAction_3046,
                            getParserElement(),
                            PalladioComponentModelVisualIDRegistry
                                    .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.EmitEventActionEntityName2EditPart.VISUAL_ID));
        }
        return parser;
    }

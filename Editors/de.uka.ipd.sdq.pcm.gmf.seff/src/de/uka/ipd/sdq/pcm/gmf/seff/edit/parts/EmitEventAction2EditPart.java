...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.policies.EmitEventAction2ItemSemanticEditPolicy;
...
public class EmitEventAction2EditPart extends ShapeNodeEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EmitEventAction2ItemSemanticEditPolicy());
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof EmitEventActionEntityName2EditPart) {
            ((EmitEventActionEntityName2EditPart) childEditPart).setLabel(getPrimaryShape()
                    .getFigureComponentEmitEventAction());
            return true;
        }
        if (childEditPart instanceof EmitEventActionInputVariableUsageEvent2EditPart) {
            ...
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.add(((EmitEventActionInputVariableUsageEvent2EditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    protected boolean removeFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof EmitEventActionInputVariableUsageEvent2EditPart) {
            ...
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.remove(((EmitEventActionInputVariableUsageEvent2EditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
        if (editPart instanceof EmitEventActionInputVariableUsageEvent2EditPart) {
    ...
    public List/* <org.eclipse.gmf.runtime.emf.type.core.IElementType> */getMARelTypesOnSourceAndTarget(
        ...
        if (targetEditPart instanceof de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.EmitEventAction2EditPart) {
            types.add(PalladioComponentModelElementTypes.AbstractActionSuccessor_AbstractAction_4001);
        }

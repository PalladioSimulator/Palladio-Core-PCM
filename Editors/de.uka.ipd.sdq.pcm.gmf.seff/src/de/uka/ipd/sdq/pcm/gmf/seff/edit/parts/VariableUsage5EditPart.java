...
public class VariableUsage5EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new VariableUsage5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof VariableUsage5LabelEditPart) {
			((VariableUsage5LabelEditPart) childEditPart)
		...
		if (childEditPart instanceof VariableUsageVariableCharacterisation5EditPart) {
			...
			pane
					.add(((VariableUsageVariableCharacterisation5EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof VariableUsageVariableCharacterisation5EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((VariableUsageVariableCharacterisation5EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;

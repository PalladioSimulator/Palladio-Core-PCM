...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.policies.VariableUsage5ItemSemanticEditPolicy;
...
/**
 * The Class VariableUsage5EditPart.
 *
 * @generated
 */
public class VariableUsage5EditPart extends ShapeNodeEditPart {
    ...
    /**
     * Instantiates a new variable usage5 edit part.
     *
     * @param view the view
     * @generated
     */
    public VariableUsage5EditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new VariableUsage5ItemSemanticEditPolicy());
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof VariableUsage5LabelEditPart) {
            ((VariableUsage5LabelEditPart) childEditPart).setLabel(getPrimaryShape()
                    .getFigureVariableUsageReferenceLabelFigure());
            return true;
        }
        if (childEditPart instanceof VariableUsageVariableCharacterisation5EditPart) {
            ...
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.add(((VariableUsageVariableCharacterisation5EditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    protected boolean removeFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof VariableUsageVariableCharacterisation5EditPart) {
            ...
            setupContentPane(pane); // FIXME each comparment should handle his content pane in his
                                    // own way
            pane.remove(((VariableUsageVariableCharacterisation5EditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
        if (editPart instanceof VariableUsageVariableCharacterisation5EditPart) {
    ...
    public EditPart getTargetEditPart(Request request) {
        if (request instanceof CreateViewAndElementRequest) {
            ...
            if (type == PalladioComponentModelElementTypes.VariableCharacterisation_3048) {
                return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry

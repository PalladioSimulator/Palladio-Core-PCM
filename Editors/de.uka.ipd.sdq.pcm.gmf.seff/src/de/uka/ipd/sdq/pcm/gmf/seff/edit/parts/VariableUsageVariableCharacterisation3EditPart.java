...
/**
 * The Class VariableUsageVariableCharacterisation3EditPart.
 *
 * @generated
 */
public class VariableUsageVariableCharacterisation3EditPart extends ListCompartmentEditPart {
    ...
    /**
     * Instantiates a new variable usage variable characterisation3 edit part.
     *
     * @param view the view
     * @generated
     */
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
                new VariableUsageVariableCharacterisation3ItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
                new VariableUsageVariableCharacterisation3CanonicalEditPolicy());
    }

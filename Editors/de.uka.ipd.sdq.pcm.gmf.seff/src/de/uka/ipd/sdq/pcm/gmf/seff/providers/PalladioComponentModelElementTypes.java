...
public class PalladioComponentModelElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType VariableUsage_3038 = getElementType("de.uka.ipd.sdq.pcm.gmf.seff.VariableUsage_3038"); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public static final IElementType VariableUsage_3039 = getElementType("de.uka.ipd.sdq.pcm.gmf.seff.VariableUsage_3039"); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public static final IElementType FailureOccurrenceDescription_3041 = getElementType("de.uka.ipd.sdq.pcm.gmf.seff.FailureOccurrenceDescription_3041"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(VariableUsage_3038, ParameterPackage.eINSTANCE.getVariableUsage());

			elements.put(VariableCharacterisation_3033, ParameterPackage.eINSTANCE.getVariableCharacterisation());

			elements.put(VariableUsage_3039, ParameterPackage.eINSTANCE.getVariableUsage());
			...
			elements.put(FailureOccurrenceDescription_3041, SeffPackage.eINSTANCE.getFailureOccurrenceDescription());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(VariableUsage_3038);
			KNOWN_ELEMENT_TYPES.add(VariableCharacterisation_3033);
			KNOWN_ELEMENT_TYPES.add(VariableUsage_3039);
			...
			KNOWN_ELEMENT_TYPES.add(FailureOccurrenceDescription_3041);
	...
	public static IElementType getElementType(int visualID) {
		...
		case FailureOccurrenceDescriptionEditPart.VISUAL_ID:
			return FailureOccurrenceDescription_3041;

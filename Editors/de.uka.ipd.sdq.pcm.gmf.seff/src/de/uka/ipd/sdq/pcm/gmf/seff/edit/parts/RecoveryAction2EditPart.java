...
public class RecoveryAction2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RecoveryAction2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RecoveryActionEntityName2EditPart) {
			((RecoveryActionEntityName2EditPart) childEditPart)
		...
		if (childEditPart instanceof RecoveryActionRecoveryBlockCompartmentEditPart) {
			...
			pane
					.add(((RecoveryActionRecoveryBlockCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RecoveryActionRecoveryBlockCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RecoveryActionRecoveryBlockCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;

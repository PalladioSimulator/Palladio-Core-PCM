...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.commands.RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviourCreateCommand;
import de.uka.ipd.sdq.pcm.gmf.seff.edit.commands.RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviourReorientCommand;
 ...
 * @generated
 */
public class RecoveryBlockAlternativeBehaviourItemSemanticEditPolicy extends
		PalladioComponentModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RecoveryBlockAlternativeBehaviourItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (PalladioComponentModelVisualIDRegistry
					.getVisualID(incomingLink) == RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviourEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (PalladioComponentModelVisualIDRegistry
					.getVisualID(outgoingLink) == RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviourEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (PalladioComponentModelElementTypes.RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviour_4002 == req
				.getElementType()) {
			return getGEFWrapper(new RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviourCreateCommand(
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviourEditPart.VISUAL_ID:
			return getGEFWrapper(new RecoveryBlockAlternativeBehaviourNextAlternative_RecoveryBlockAlternativeBehaviourReorientCommand(
					req));
		}

 ...
 * @generated
 */
public class ExternalCallActionOutputVariableUsageCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected EStructuralFeature getFeatureToSynchronize() {
        return SeffPackage.eINSTANCE.getCallReturnAction_ReturnVariableUsage__CallReturnAction();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getExternalCallActionOutputVariableUsage_7021SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return VariableUsage2EditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getExternalCallActionOutputVariableUsage_7021SemanticChildren((View) getHost().getModel());

 ...
 * @generated
 */
public class BranchActionBranchTransitionCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected EStructuralFeature getFeatureToSynchronize() {
        return SeffPackage.eINSTANCE.getBranchAction_Branches_Branch();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getBranchActionBranchTransitionCompartment_7007SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        ...
        return visualID == ProbabilisticBranchTransitionEditPart.VISUAL_ID
                || visualID == GuardedBranchTransitionEditPart.VISUAL_ID;
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getBranchActionBranchTransitionCompartment_7007SemanticChildren((View) getHost().getModel());

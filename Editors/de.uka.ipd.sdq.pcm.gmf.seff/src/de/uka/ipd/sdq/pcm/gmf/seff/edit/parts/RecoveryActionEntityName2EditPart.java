...
/**
 * The Class RecoveryActionEntityName2EditPart.
 *
 * @generated
 */
public class RecoveryActionEntityName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new recovery action entity name2 edit part.
     *
     * @param view the view
     * @generated
     */
    public RecoveryActionEntityName2EditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider
                    .getParser(
                            PalladioComponentModelElementTypes.RecoveryAction_3057,
                            getParserElement(),
                            PalladioComponentModelVisualIDRegistry
                                    .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.RecoveryActionEntityName2EditPart.VISUAL_ID));
        }
        return parser;
    }

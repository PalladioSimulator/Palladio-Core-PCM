...
public class InfrastructureCallInfrastructureCallInputVariableUsagesCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getInfrastructureCallInfrastructureCallInputVariableUsages_7057SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return VariableUsage5EditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getInfrastructureCallInfrastructureCallInputVariableUsages_7057SemanticChildren((View) getHost()
                        .getModel());

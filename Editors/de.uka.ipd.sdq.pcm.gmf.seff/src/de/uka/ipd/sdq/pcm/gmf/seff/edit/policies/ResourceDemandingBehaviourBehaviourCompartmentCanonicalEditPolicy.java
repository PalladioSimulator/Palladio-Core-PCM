 ...
 * @generated
 */
public class ResourceDemandingBehaviourBehaviourCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceDemandingBehaviourBehaviourCompartment_7004SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getResourceDemandingBehaviourBehaviourCompartment_7004SemanticChildren((View) getHost().getModel());

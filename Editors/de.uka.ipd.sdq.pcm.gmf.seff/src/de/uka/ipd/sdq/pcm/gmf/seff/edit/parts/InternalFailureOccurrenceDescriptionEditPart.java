...
import de.uka.ipd.sdq.pcm.gmf.seff.edit.policies.InternalFailureOccurrenceDescriptionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InternalFailureOccurrenceDescriptionEditPart extends
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new InternalFailureOccurrenceDescriptionItemSemanticEditPolicy());
			...
			parser = PalladioComponentModelParserProvider
					.getParser(
							...
							PalladioComponentModelVisualIDRegistry
									.getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.InternalFailureOccurrenceDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new FailureOccurrenceDescriptionFigure();
	}

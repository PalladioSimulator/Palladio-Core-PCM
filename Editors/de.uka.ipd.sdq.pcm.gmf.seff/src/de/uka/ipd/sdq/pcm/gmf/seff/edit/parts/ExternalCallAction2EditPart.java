...
public class ExternalCallAction2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ExternalCallAction2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ExternalCallActionEntityName2EditPart) {
			((ExternalCallActionEntityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureComponentExternalCallName());
			return true;
		}
		if (childEditPart instanceof ExternalCallActionInputVariableUsage2EditPart) {
			...
			pane.add(((ExternalCallActionInputVariableUsage2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ExternalCallActionOutputVariableUsage2EditPart) {
			IFigure pane = getPrimaryShape().getFigureExternalCallActionCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ExternalCallActionOutputVariableUsage2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ExternalCallActionInputVariableUsage2EditPart) {
			IFigure pane = getPrimaryShape().getFigureExternalCallActionCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ExternalCallActionInputVariableUsage2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ExternalCallActionOutputVariableUsage2EditPart) {
			IFigure pane = getPrimaryShape().getFigureExternalCallActionCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ExternalCallActionOutputVariableUsage2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PalladioComponentModelVisualIDRegistry.getType(ExternalCallActionEntityName2EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.ExternalCallAction2EditPart) {
			types.add(PalladioComponentModelElementTypes.AbstractActionSuccessor_AbstractAction_4001);
		}
	...
	public class ExternalCallActionFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			stereotypeLabel0.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode().DPtoLP(0), getMapMode().DPtoLP(2), getMapMode().DPtoLP(0)));
			...
			fFigureComponentExternalCallName.setBorder(new MarginBorder(getMapMode().DPtoLP(2), getMapMode().DPtoLP(0), getMapMode().DPtoLP(2), getMapMode()
					.DPtoLP(0)));
			...
			this.add(fFigureExternalCallActionCompartmentRectangle, constraintFFigureExternalCallActionCompartmentRectangle);

...
/**
 * The Class ExternalCallAction2EditPart.
 *
 * @generated
 */
public class ExternalCallAction2EditPart extends ShapeNodeEditPart {
    ...
    /**
     * Instantiates a new external call action2 edit part.
     *
     * @param view the view
     * @generated
     */
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof ExternalCallActionEntityName2EditPart) {
            ((ExternalCallActionEntityName2EditPart) childEditPart).setLabel(getPrimaryShape()

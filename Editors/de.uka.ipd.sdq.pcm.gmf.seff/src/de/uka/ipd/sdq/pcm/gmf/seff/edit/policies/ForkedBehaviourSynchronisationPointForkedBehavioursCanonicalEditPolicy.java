...
public class ForkedBehaviourSynchronisationPointForkedBehavioursCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getForkedBehaviourBehaviourCompartment_7033SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getForkedBehaviourBehaviourCompartment_7033SemanticChildren((View) getHost().getModel());

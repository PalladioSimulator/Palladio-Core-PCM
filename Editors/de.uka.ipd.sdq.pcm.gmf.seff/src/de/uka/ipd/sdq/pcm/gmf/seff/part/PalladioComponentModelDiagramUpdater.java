...
public class PalladioComponentModelDiagramUpdater {
	...
	public static List getExternalCallActionInputVariableUsage_7001SemanticChildren(
		...
		ExternalCallAction modelElement = (ExternalCallAction) containerView
				.getElement();
		List result = new LinkedList();
		for (Iterator it = modelElement.getInputVariableUsages__CallAction()
				.iterator(); it.hasNext();) {
	...
	public static List getExternalCallActionOutputVariableUsage_7021SemanticChildren(
		...
		for (Iterator it = modelElement
				.getReturnVariableUsage__CallReturnAction().iterator(); it
				.hasNext();) {
			VariableUsage childElement = (VariableUsage) it.next();
			int visualID = PalladioComponentModelVisualIDRegistry
					.getNodeVisualID(view, childElement);
	 ...
	 * @generated
	 */
	public static List getVariableUsageVariableCharacterisation_7037SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	 ...
	 * @generated
	 */
	public static List getVariableUsageVariableCharacterisation_7044SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	 ...
	 * @generated
	 */
	public static List getEmitEventActionInputVariableUsageEvent_7042SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
		...
		EmitEventAction modelElement = (EmitEventAction) containerView
				.getElement();
		List result = new LinkedList();
		for (Iterator it = modelElement.getInputVariableUsages__CallAction()
				.iterator(); it.hasNext();) {
	 ...
	 * @generated
	 */
	public static List getVariableUsageVariableCharacterisation_7043SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	 ...
	 * @generated
	 */
	public static List getInternalActionResourceDemands_7006SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	 ...
	 * @generated
	 */
	public static List getInternalActionFailureOccurrenceDescriptions_7045SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
		...
		for (Iterator it = modelElement
				...
				.iterator(); it.hasNext();) {
			InternalFailureOccurrenceDescription childElement = (InternalFailureOccurrenceDescription) it
					.next();
			int visualID = PalladioComponentModelVisualIDRegistry
					.getNodeVisualID(view, childElement);
	 ...
	 * @generated
	 */
	public static List getEmitEventActionInputVariableUsageEvent_7041SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	...
	public static List getForkActionForkedBehaviours_7024SemanticChildren(
		...
		{
			SynchronisationPoint childElement = modelElement
	 ...
	 * @generated
	 */
	public static List getSynchronisationPointSynchronisationPoint_7034SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
		...
		SynchronisationPoint modelElement = (SynchronisationPoint) containerView
				.getElement();
		List result = new LinkedList();
		for (Iterator it = modelElement
	 ...
	 * @generated
	 */
	public static List getForkedBehaviourBehaviourCompartment_7033SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	...
	public static List getSetVariableActionVariableSetter_7025SemanticChildren(
		...
		List result = new LinkedList();
		for (Iterator it = modelElement
				.getLocalVariableUsages_SetVariableAction().iterator(); it
				.hasNext();) {
			VariableUsage childElement = (VariableUsage) it.next();
			int visualID = PalladioComponentModelVisualIDRegistry
					.getNodeVisualID(view, childElement);
	 ...
	 * @generated
	 */
	public static List getVariableUsageVariableCharacterisation_7032SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	 ...
	 * @generated
	 */
	public static List getInternalActionResourceDemands_7012SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	 ...
	 * @generated
	 */
	public static List getInternalActionFailureOccurrenceDescriptions_7046SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	...
	public static List getContainedLinks(View view) {
		...
		case RecoveryBlockActionEditPart.VISUAL_ID:
			return getRecoveryBlockAction_2014ContainedLinks(view);
	...
	public static List getIncomingLinks(View view) {
		...
		case RecoveryBlockActionEditPart.VISUAL_ID:
			return getRecoveryBlockAction_2014IncomingLinks(view);
		case VariableUsageEditPart.VISUAL_ID:
	...
	public static List getOutgoingLinks(View view) {
		...
		case RecoveryBlockActionEditPart.VISUAL_ID:
			return getRecoveryBlockAction_2014OutgoingLinks(view);
		case VariableUsageEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List getRecoveryBlockAction_2014ContainedLinks(View view) {
		RecoveryBlockAction modelElement = (RecoveryBlockAction) view
				.getElement();
		List result = new LinkedList();
		result
				.addAll(getOutgoingFeatureModelFacetLinks_AbstractAction_Successor_AbstractAction_4001(modelElement));
	 ...
	 * @generated
	 */
	public static List getInternalFailureOccurrenceDescription_3050ContainedLinks(
			View view) {
		return Collections.EMPTY_LIST;
	}
	 ...
	 * @generated
	 */
	public static List getRecoveryBlockAction_2014IncomingLinks(View view) {
		RecoveryBlockAction modelElement = (RecoveryBlockAction) view
				.getElement();
		Map crossReferences = EcoreUtil.CrossReferencer.find(view.eResource()
				.getResourceSet().getResources());
	 ...
	 * @generated
	 */
	public static List getInternalFailureOccurrenceDescription_3050IncomingLinks(
			View view) {
		return Collections.EMPTY_LIST;
	}
	 ...
	 * @generated
	 */
	public static List getRecoveryBlockAction_2014OutgoingLinks(View view) {
		RecoveryBlockAction modelElement = (RecoveryBlockAction) view
				.getElement();
		List result = new LinkedList();
		result
	 ...
	 * @generated
	 */
	public static List getInternalFailureOccurrenceDescription_3050OutgoingLinks(
			View view) {
		return Collections.EMPTY_LIST;
	}

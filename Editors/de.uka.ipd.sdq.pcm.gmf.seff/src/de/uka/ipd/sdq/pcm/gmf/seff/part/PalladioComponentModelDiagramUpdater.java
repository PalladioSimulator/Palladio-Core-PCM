...
public class PalladioComponentModelDiagramUpdater {
	 ...
	 * @generated
	 */
	public static List getInternalActionInfrastructureCallsCompartment_7048SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
		...
		InternalAction modelElement = (InternalAction) containerView
				.getElement();
		List result = new LinkedList();
		for (Iterator it = modelElement.getInfrastructureCall__Action()
				.iterator(); it.hasNext();) {
	 ...
	 * @generated
	 */
	public static List getInfrastructureCallInfrastructureCallInputVariableUsages_7049SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	 ...
	 * @generated
	 */
	public static List getVariableUsageVariableCharacterisation_7050SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	 ...
	 * @generated
	 */
	public static List getInternalActionInfrastructureCallsCompartment_7051SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}

...
/**
 * The Class VariableUsage5LabelEditPart.
 *
 * @generated
 */
public class VariableUsage5LabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new variable usage5 label edit part.
     *
     * @param view the view
     * @generated
     */
    public VariableUsage5LabelEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(
                    PalladioComponentModelElementTypes.VariableUsage_3054, getParserElement(),
                    PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.seff.edit.parts.VariableUsage5LabelEditPart.VISUAL_ID));
        }
        return parser;
    }

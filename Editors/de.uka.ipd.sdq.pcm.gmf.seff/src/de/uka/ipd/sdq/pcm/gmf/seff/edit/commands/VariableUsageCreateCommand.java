...
public class VariableUsageCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		owner.getInputParameterUsages_ExternalCallAction().add(newElement);
		CallAction childHolder = (CallAction) getElementToEdit();
		childHolder.getOutputVariableUsages_ExternalCallAction().add(newElement);

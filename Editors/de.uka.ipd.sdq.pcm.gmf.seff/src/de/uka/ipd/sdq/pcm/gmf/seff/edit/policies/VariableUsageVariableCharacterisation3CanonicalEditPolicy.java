 ...
 * @generated
 */
public class VariableUsageVariableCharacterisation3CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected EStructuralFeature getFeatureToSynchronize() {
        return ParameterPackage.eINSTANCE.getVariableUsage_VariableCharacterisation_VariableUsage();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getVariableUsageVariableCharacterisation_7032SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return VariableCharacterisation5EditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getVariableUsageVariableCharacterisation_7032SemanticChildren((View) getHost().getModel());

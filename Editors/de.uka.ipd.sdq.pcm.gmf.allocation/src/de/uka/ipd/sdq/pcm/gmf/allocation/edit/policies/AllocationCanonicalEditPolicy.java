 ...
 * @generated
 */
public class AllocationCanonicalEditPolicy extends CanonicalEditPolicy {
...
//		return result;
	...
	private boolean isMyDiagramElement(View view) {
		return ResourceContainerEditPart.VISUAL_ID == PalladioComponentModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
				.getAllocation_1000SemanticChildren((View) getHost().getModel());

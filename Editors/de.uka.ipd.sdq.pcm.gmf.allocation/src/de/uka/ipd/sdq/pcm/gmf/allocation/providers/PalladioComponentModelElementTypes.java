...
public class PalladioComponentModelElementTypes extends ElementInitializers {
    ...
    private static ImageDescriptor getProvidedImageDescriptor(ENamedElement element) {
        ...
        if (element instanceof EClass) {
            ...
            if (!eClass.isAbstract()) {
                return PalladioComponentModelAllocationDiagramEditorPlugin.getInstance().getItemImageDescriptor(
    ...
    public static ENamedElement getElement(IAdaptable hint) {
        ...
        if (elements == null) {
            ...
            elements.put(Allocation_1000, AllocationPackage.eINSTANCE.getAllocation());

            elements.put(ResourceContainer_2002, ResourceenvironmentPackage.eINSTANCE.getResourceContainer());

            elements.put(AllocationContext_3001, AllocationPackage.eINSTANCE.getAllocationContext());
        }
    ...
    public static boolean isKnownElementType(IElementType elementType) {
        if (KNOWN_ELEMENT_TYPES == null) {
            ...
            KNOWN_ELEMENT_TYPES.add(ResourceContainer_2002);
            KNOWN_ELEMENT_TYPES.add(AllocationContext_3001);
        }

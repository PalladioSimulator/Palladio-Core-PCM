...
public class PalladioComponentModelElementTypes extends ElementInitializers {
    ...
    public static ENamedElement getElement(IAdaptable hint) {
        ...
        if (elements == null) {
            ...
            elements.put(ResourceContainer_2003, ResourceenvironmentPackage.eINSTANCE.getResourceContainer());

            elements.put(AllocationContext_3002, AllocationPackage.eINSTANCE.getAllocationContext());
        }

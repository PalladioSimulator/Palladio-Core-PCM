...
public class ModelElementSelectionPage extends WizardPage {
    ...
    public void createControl(Composite parent) {
        ...
        modelVewer.setContentProvider(new AdapterFactoryContentProvider(
                PalladioComponentModelAllocationDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory()));
        modelVewer.setLabelProvider(new AdapterFactoryLabelProvider(PalladioComponentModelAllocationDiagramEditorPlugin

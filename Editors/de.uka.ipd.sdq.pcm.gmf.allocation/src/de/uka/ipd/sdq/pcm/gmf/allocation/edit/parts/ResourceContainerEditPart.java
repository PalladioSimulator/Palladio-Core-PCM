...
public class ResourceContainerEditPart extends ShapeNodeEditPart {
	...
	public class ResourceContainerFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureResContainerNameFigure;
		...
		private void createContents() {
			...
			fFigureResContainerNameFigure = new WrappingLabel();
			fFigureResContainerNameFigure.setText("<...>");
			fFigureResContainerNameFigure.setMaximumSize(new Dimension(
					getMapMode().DPtoLP(100000), getMapMode().DPtoLP(40)));
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureResContainerNameFigure() {

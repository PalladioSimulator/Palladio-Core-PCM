...
public class PalladioComponentModelViewProvider extends AbstractProvider
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return ResourceContainerEditPart.VISUAL_ID == visualID
				|| AllocationContextEditPart.VISUAL_ID == visualID;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ResourceContainerEditPart.VISUAL_ID:
			return createResourceContainer_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case AllocationContextEditPart.VISUAL_ID:
			return createAllocationContext_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createResourceContainer_2003(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createAllocationContext_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());

    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy() {
            ...
            private void addChangeBoundsCommand(CompositeCommand cc, Node source, EObject element, Rectangle newBounds) {
                SetBoundsCommand setBounds = new SetBoundsCommand(ResourceContainerAllocationCompartmentEditPart.this
                        .getEditingDomain(), "Set Position", new EObjectAdapter(source), newBounds);
                cc.add(setBounds);
            }
            ...
            private Rectangle getNewBounds(Node source, EObject element, IGraphicalEditPart editPart,
                ...
                ResourceContainerAllocationCompartmentEditPart.this.getContentPane().translateToRelative(newBounds);
            ...
            private void addChangeSemanticModelCommand(CompositeCommand cc, EObject element) {
                SetRequest setRequest = new SetRequest(element, AllocationPackage.eINSTANCE
                        ...
                        ResourceContainerAllocationCompartmentEditPart.this.resolveSemanticElement());
            ...
            private void addAddViewCommand(CompositeCommand cc, Node source, EObject element) {
                View targetView = (View) ResourceContainerAllocationCompartmentEditPart.this.getModel();
                AddCommand addCommand = new AddCommand(ResourceContainerAllocationCompartmentEditPart.this

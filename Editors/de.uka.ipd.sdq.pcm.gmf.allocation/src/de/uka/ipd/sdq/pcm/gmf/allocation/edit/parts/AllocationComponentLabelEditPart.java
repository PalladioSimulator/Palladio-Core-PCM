 ...
 * @generated
 */
public class AllocationComponentLabelEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AllocationComponentLabelEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		if (ctx.getAssemblyContext_AllocationContext() != null) {
			if (ctx.getAssemblyContext_AllocationContext()
					.getEncapsulatedComponent__AssemblyContext() != null) {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PalladioComponentModelParserProvider
					.getParser(
							PalladioComponentModelElementTypes.AllocationContext_3002,
							getParserElement(),
							PalladioComponentModelVisualIDRegistry
									.getType(de.uka.ipd.sdq.pcm.gmf.allocation.edit.parts.AllocationComponentLabelEditPart.VISUAL_ID));
		}
		return parser;
	}

...
public class AllocationEditPart extends DiagramEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AllocationItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new AllocationCanonicalEditPolicy());

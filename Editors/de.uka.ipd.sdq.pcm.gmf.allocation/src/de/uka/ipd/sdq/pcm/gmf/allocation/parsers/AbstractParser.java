...
public abstract class AbstractParser implements IParser {
    ...
    protected IParserEditStatus validateNewValues(Object[] values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (value instanceof InvalidValue) {
                return new ParserEditStatus(PalladioComponentModelAllocationDiagramEditorPlugin.ID,
        ...
        if (type instanceof EDataType) {
            ...
            if (Boolean.TYPE.equals(iClass)) {
                if (value instanceof Boolean) {
                    ...
                    value = new InvalidValue(NLS.bind(Messages.AbstractParser_UnexpectedValueTypeMessage,
                            iClass.getName()));
                }
                ...
                if (value instanceof Byte) {
                    ...
                    if (s.length() == 0) {
                        ...
                        try {
                            ...
                            value = new InvalidValue(NLS.bind(Messages.AbstractParser_WrongStringConversionMessage,
                                    iClass.getName()));
                        }
                    }
                } else {

...
public class EntryLevelSystemCallConfigureCommand extends ConfigureElementCommand {
	...
	public EntryLevelSystemCallConfigureCommand(ConfigureRequest request,
	...
	/* (non-Javadoc)
	 * @see org.eclipse.gmf.runtime.emf.type.core.commands.SetValueCommand#doExecuteWithResult(org.eclipse.core.runtime.IProgressMonitor, org.eclipse.core.runtime.IAdaptable)
	 */
	@Override
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {

		CommandResult commandResult = setSignatureEntryLevelSystemCall(monitor,
				info);
		if (!isOK(commandResult)) {
			return CommandResult
					.newErrorCommandResult("Set Signature for the EntryLevelSystemCall failed!");
		}
		commandResult = setProvidedRoleEntryLevelSystemCall(monitor, info);
		if (!isOK(commandResult)) {
			return CommandResult
					.newErrorCommandResult("Set ProvidedRole for the EntryLevelSystemCall failed!");
		}
		return CommandResult.newOKCommandResult();
	}

	private CommandResult setSignatureEntryLevelSystemCall(
	...
	private CommandResult setProvidedRoleEntryLevelSystemCall(
			IProgressMonitor monitor, IAdaptable info)
			throws ExecutionException {

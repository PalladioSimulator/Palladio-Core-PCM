...
public class InterfacePropertySection extends GenericEMFPropertySection {
	...
	/* (non-Javadoc)
	 * @see de.uka.ipd.sdq.pcmbench.tabs.GenericEMFPropertySection#getEClassToEdit()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.uka.ipd.sdq.pcmbench.tabs.GenericEMFPropertySection#getEditableTextFields()
	 */
	@Override

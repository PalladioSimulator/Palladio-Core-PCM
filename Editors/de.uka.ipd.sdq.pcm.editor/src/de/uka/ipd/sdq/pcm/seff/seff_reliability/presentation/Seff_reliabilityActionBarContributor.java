...
/**
 * This is the action bar contributor for the Seff_reliability model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Seff_reliabilityActionBarContributor
	 ...
	 * @generated
	 */
	public Seff_reliabilityActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("seff_reliability-settings"));
		toolBarManager.add(new Separator("seff_reliability-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PalladioComponentModelEditorPlugin.INSTANCE.getString("_UI_Seff_reliabilityEditor_menu"), "de.uka.ipd.sdq.pcm.seff.seff_reliabilityMenuID");

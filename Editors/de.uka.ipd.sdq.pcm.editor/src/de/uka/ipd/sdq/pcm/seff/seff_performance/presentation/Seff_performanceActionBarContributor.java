...
/**
 * This is the action bar contributor for the Seff_performance model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Seff_performanceActionBarContributor
	 ...
	 * @generated
	 */
	public Seff_performanceActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("seff_performance-settings"));
		toolBarManager.add(new Separator("seff_performance-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PalladioComponentModelEditorPlugin.INSTANCE.getString("_UI_Seff_performanceEditor_menu"), "de.uka.ipd.sdq.pcm.seff.seff_performanceMenuID");

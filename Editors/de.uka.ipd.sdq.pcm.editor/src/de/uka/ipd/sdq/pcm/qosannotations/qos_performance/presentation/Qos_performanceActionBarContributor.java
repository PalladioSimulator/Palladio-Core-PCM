...
/**
 * This is the action bar contributor for the Qos_performance model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Qos_performanceActionBarContributor
	 ...
	 * @generated
	 */
	public Qos_performanceActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("qos_performance-settings"));
		toolBarManager.add(new Separator("qos_performance-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PalladioComponentModelEditorPlugin.INSTANCE.getString("_UI_Qos_performanceEditor_menu"), "de.uka.ipd.sdq.pcm.qosannotations.qos_performanceMenuID");

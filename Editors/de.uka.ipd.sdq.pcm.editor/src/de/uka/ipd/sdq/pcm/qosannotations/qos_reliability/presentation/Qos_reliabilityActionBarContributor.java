...
/**
 * This is the action bar contributor for the Qos_reliability model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Qos_reliabilityActionBarContributor
	 ...
	 * @generated
	 */
	public Qos_reliabilityActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("qos_reliability-settings"));
		toolBarManager.add(new Separator("qos_reliability-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PalladioComponentModelEditorPlugin.INSTANCE.getString("_UI_Qos_reliabilityEditor_menu"), "de.uka.ipd.sdq.pcm.qosannotations.qos_reliabilityMenuID");

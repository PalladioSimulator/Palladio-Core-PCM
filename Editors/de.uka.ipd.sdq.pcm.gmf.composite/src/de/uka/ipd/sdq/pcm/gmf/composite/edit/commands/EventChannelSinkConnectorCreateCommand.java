 ...
 * @generated
 */
public class EventChannelSinkConnectorCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EventChannelSinkConnectorCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof SinkRole) {
			return false;
		}
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateEventChannelSinkConnector_4010(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		EventChannelSinkConnector newElement = CompositionFactory.eINSTANCE
		...
		CreateRelationshipRequest req = (CreateRelationshipRequest) this
				.getRequest();
		newElement
				.setAssemblyContext__EventChannelSinkConnector((AssemblyContext) req
	 ...
	 * @generated
	 */
	protected void doConfigure(EventChannelSinkConnector newElement,
	 ...
	 * @generated
	 */
	protected SinkRole getSource() {
		return (SinkRole) source;
	}

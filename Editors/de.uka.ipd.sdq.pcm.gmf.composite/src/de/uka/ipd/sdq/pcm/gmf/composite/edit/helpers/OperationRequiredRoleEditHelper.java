...
/**
 * Edit helper for operation required roles.
 * This edit helper opens a dialog to enable the user to choose the 
 * operation interface the configured role requires.
 * 
 * 
 * @generated NOT
 */
public class OperationRequiredRoleEditHelper extends

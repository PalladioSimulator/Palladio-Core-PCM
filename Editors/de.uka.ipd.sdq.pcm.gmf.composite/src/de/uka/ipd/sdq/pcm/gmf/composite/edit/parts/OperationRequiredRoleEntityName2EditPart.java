...
/**
 * The Class OperationRequiredRoleEntityName2EditPart.
 * 
 * @generated
 */
public class OperationRequiredRoleEntityName2EditPart extends LabelEditPart implements ITextAwareEditPart,
        IBorderItemEditPart {
    ...
    static {
        registerSnapBackPosition(
                PalladioComponentModelVisualIDRegistry
                        .getType(de.uka.ipd.sdq.pcm.gmf.composite.edit.parts.OperationRequiredRoleEntityName2EditPart.VISUAL_ID),
                new Point(0, 0));
    }

    /**
     * Instantiates a new operation required role entity name2 edit part.
     * 
     * @param view
     *            the view
     * @generated
     */
    public OperationRequiredRoleEntityName2EditPart(View view) {
        super(view);
    }
    ...
    protected IFigure createFigurePrim() {
        return new SystemOperationRequiredRoleLabelFigure();
    }

    /**
     * The Class SystemOperationRequiredRoleLabelFigure.
     * 
     * @generated
     */
    public class SystemOperationRequiredRoleLabelFigure extends WrappingLabel {

        /**
         * Instantiates a new system operation required role label figure.
         * 
         * @generated
         */
        public SystemOperationRequiredRoleLabelFigure() {
            this.setText("<SR>");
        }

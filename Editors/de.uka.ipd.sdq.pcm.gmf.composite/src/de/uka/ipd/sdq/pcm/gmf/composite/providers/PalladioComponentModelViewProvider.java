...
public class PalladioComponentModelViewProvider extends AbstractProvider
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ComposedProvidingRequiringEntityEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return ComposedProvidingRequiringEntity2EditPart.VISUAL_ID == visualID
				|| AssemblyContextEditPart.VISUAL_ID == visualID
				|| OperationProvidedRoleEditPart.VISUAL_ID == visualID
				|| OperationRequiredRoleEditPart.VISUAL_ID == visualID
				|| SourceRoleEditPart.VISUAL_ID == visualID
				|| SinkRoleEditPart.VISUAL_ID == visualID
				|| InfrastructureProvidedRoleEditPart.VISUAL_ID == visualID
				|| InfrastructureRequiredRoleEditPart.VISUAL_ID == visualID
				|| OperationProvidedRole2EditPart.VISUAL_ID == visualID
				|| OperationRequiredRole2EditPart.VISUAL_ID == visualID
				|| EventChannelEditPart.VISUAL_ID == visualID;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ComposedProvidingRequiringEntity2EditPart.VISUAL_ID:
			return createComposedProvidingRequiringEntity_2002(domainElement,
					containerView, index, persisted, preferencesHint);
		case AssemblyContextEditPart.VISUAL_ID:
			return createAssemblyContext_3006(domainElement, containerView,
					index, persisted, preferencesHint);
		case OperationProvidedRoleEditPart.VISUAL_ID:
			return createOperationProvidedRole_3007(domainElement,
					containerView, index, persisted, preferencesHint);
		case OperationRequiredRoleEditPart.VISUAL_ID:
			return createOperationRequiredRole_3008(domainElement,
					containerView, index, persisted, preferencesHint);
		case SourceRoleEditPart.VISUAL_ID:
			return createSourceRole_3013(domainElement, containerView, index,
					persisted, preferencesHint);
		case SinkRoleEditPart.VISUAL_ID:
			return createSinkRole_3014(domainElement, containerView, index,
					persisted, preferencesHint);
		case InfrastructureProvidedRoleEditPart.VISUAL_ID:
			return createInfrastructureProvidedRole_3015(domainElement,
					containerView, index, persisted, preferencesHint);
		case InfrastructureRequiredRoleEditPart.VISUAL_ID:
			return createInfrastructureRequiredRole_3016(domainElement,
					containerView, index, persisted, preferencesHint);
		case OperationProvidedRole2EditPart.VISUAL_ID:
			return createOperationProvidedRole_3011(domainElement,
					containerView, index, persisted, preferencesHint);
		case OperationRequiredRole2EditPart.VISUAL_ID:
			return createOperationRequiredRole_3012(domainElement,
					containerView, index, persisted, preferencesHint);
		case EventChannelEditPart.VISUAL_ID:
			return createEventChannel_3017(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case EventChannelSinkConnectorEditPart.VISUAL_ID:
			return createEventChannelSinkConnector_4010(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case EventChannelSourceConnectorEditPart.VISUAL_ID:
			return createEventChannelSourceConnector_4009(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case AssemblyConnectorEditPart.VISUAL_ID:
			return createAssemblyConnector_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case AssemblyEventConnectorEditPart.VISUAL_ID:
			return createAssemblyEventConnector_4007(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case RequiredDelegationConnectorEditPart.VISUAL_ID:
			return createRequiredDelegationConnector_4005(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ProvidedDelegationConnectorEditPart.VISUAL_ID:
			return createProvidedDelegationConnector_4006(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case AssemblyInfrastructureConnectorEditPart.VISUAL_ID:
			return createAssemblyInfrastructureConnector_4008(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createEventChannel_3017(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createEventChannelSinkConnector_4010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createEventChannelSourceConnector_4009(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ComposedProvidingRequiringEntityEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put(
							"modelID", ComposedProvidingRequiringEntityEditPart.MODEL_ID); //$NON-NLS-1$

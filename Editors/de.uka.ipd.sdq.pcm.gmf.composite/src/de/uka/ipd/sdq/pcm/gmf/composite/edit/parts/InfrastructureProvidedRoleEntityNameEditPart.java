...
/**
 * The Class InfrastructureProvidedRoleEntityNameEditPart.
 * 
 * @generated
 */
public class InfrastructureProvidedRoleEntityNameEditPart extends LabelEditPart implements ITextAwareEditPart,
        IBorderItemEditPart {
    ...
    static {
        registerSnapBackPosition(
                PalladioComponentModelVisualIDRegistry
                        .getType(de.uka.ipd.sdq.pcm.gmf.composite.edit.parts.InfrastructureProvidedRoleEntityNameEditPart.VISUAL_ID),
                new Point(0, 0));
    }

    /**
     * Instantiates a new infrastructure provided role entity name edit part.
     * 
     * @param view
     *            the view
     * @generated
     */
    public InfrastructureProvidedRoleEntityNameEditPart(View view) {
        super(view);
    }
    ...
    protected IFigure createFigurePrim() {
        return new InfrastructureRoleLabelFigure();
    }

    /**
     * The Class InfrastructureRoleLabelFigure.
     * 
     * @generated
     */
    public class InfrastructureRoleLabelFigure extends WrappingLabel {

        /**
         * Instantiates a new infrastructure role label figure.
         * 
         * @generated
         */
        public InfrastructureRoleLabelFigure() {
            this.setText("<InfrastructureRole>");
        }

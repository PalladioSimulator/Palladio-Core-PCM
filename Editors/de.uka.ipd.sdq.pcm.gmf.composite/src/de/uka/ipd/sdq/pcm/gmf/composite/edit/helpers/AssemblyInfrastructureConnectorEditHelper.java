...
public class AssemblyInfrastructureConnectorEditHelper extends
	...
	protected ICommand getConfigureCommand(ConfigureRequest req) {
		...
		name += con.getRequiringAssemblyContext__AssemblyInfrastructureConnector() == null ? ""
				: con.getRequiringAssemblyContext__AssemblyInfrastructureConnector()
						.getEntityName();
		name += " -> ";
		name += con.getProvidingAssemblyContext__AssemblyInfrastructureConnector() == null ? ""
				: con.getProvidingAssemblyContext__AssemblyInfrastructureConnector()
						.getEntityName();

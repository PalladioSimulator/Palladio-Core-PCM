...
public class AssemblyConnectorReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistAssemblyConnector_4004(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		OperationRequiredRole source = getLink()
		...
		ComposedStructure container = (ComposedStructure) getLink()
				.eContainer();
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistAssemblyConnector_4004(container, source,
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		...
		messageBox
				.setMessage("Please delete the link and create a new one instead of reorienting it.");
		messageBox.open();

 ...
 * @generated
 */
public class EventChannelEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public EventChannelEntityNameEditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
                new ComposedProvidingRequiringEntityEditPart.NodeLabelDragPolicy());
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider
                    .getParser(
                            PalladioComponentModelElementTypes.EventChannel_3017,
                            getParserElement(),
                            PalladioComponentModelVisualIDRegistry
                                    .getType(de.uka.ipd.sdq.pcm.gmf.composite.edit.parts.EventChannelEntityNameEditPart.VISUAL_ID));
        }
        return parser;
    }

 ...
 * @generated
 */
public class EventChannelSourceConnectorReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public EventChannelSourceConnectorReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEventChannelSourceConnector_4009(container,
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		ComposedStructure container = (ComposedStructure) getLink()
				.eContainer();
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEventChannelSourceConnector_4009(container, source,
						getNewTarget());
	}

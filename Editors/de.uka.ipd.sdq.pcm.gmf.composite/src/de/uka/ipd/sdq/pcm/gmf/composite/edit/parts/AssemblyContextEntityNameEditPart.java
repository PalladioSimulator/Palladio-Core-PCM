 ...
 * @generated
 */
public class AssemblyContextEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider
                    .getParser(
                            PalladioComponentModelElementTypes.AssemblyContext_3006,
                            getParserElement(),
                            PalladioComponentModelVisualIDRegistry
                                    .getType(de.uka.ipd.sdq.pcm.gmf.composite.edit.parts.AssemblyContextEntityNameEditPart.VISUAL_ID));
        }
        return parser;
    }

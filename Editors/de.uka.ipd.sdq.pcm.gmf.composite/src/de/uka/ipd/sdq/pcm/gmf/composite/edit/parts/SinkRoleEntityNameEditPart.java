...
/**
 * The Class SinkRoleEntityNameEditPart.
 * 
 * @generated
 */
public class SinkRoleEntityNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
    ...
    static {
        registerSnapBackPosition(
                PalladioComponentModelVisualIDRegistry
                        .getType(de.uka.ipd.sdq.pcm.gmf.composite.edit.parts.SinkRoleEntityNameEditPart.VISUAL_ID),
                new Point(0, 0));
    }

    /**
     * Instantiates a new sink role entity name edit part.
     * 
     * @param view
     *            the view
     * @generated
     */
    public SinkRoleEntityNameEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.SinkRole_3014,

...
public class AssemblyInfrastructureConnectorReorientCommand extends
	...
	protected boolean canReorientSource() {
		...
		InfrastructureProvidedRole target = getLink()
		...
		return PalladioComponentModelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistAssemblyInfrastructureConnector_4008(container,
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		InfrastructureRequiredRole source = getLink()
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getLink().setRequiredRole__AssemblyInfrastructureConnector(
				getNewSource());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getLink().setProvidedRole__AssemblyInfrastructureConnector(
				getNewTarget());
		return CommandResult.newOKCommandResult(getLink());
	}

...
public class OperationRequiredRole2ItemSemanticEditPolicy extends
	 ...
	 * 
	 * This method has manually adopted to disallow any connectors to be started at the 
	 * system required role. AssemblyConnectors are not allowed anyway and delegation connectors
	 * should be started at the inner operation required role. 
	 * 
	 * @generated not
	 */

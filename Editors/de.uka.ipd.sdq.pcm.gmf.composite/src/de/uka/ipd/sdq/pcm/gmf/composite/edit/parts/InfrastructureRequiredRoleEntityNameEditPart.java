...
/**
 * The Class InfrastructureRequiredRoleEntityNameEditPart.
 * 
 * @generated
 */
public class InfrastructureRequiredRoleEntityNameEditPart extends LabelEditPart implements ITextAwareEditPart,
        IBorderItemEditPart {
    ...
    static {
        registerSnapBackPosition(
                PalladioComponentModelVisualIDRegistry
                        .getType(de.uka.ipd.sdq.pcm.gmf.composite.edit.parts.InfrastructureRequiredRoleEntityNameEditPart.VISUAL_ID),
                new Point(0, 0));
    }

    /**
     * Instantiates a new infrastructure required role entity name edit part.
     * 
     * @param view
     *            the view
     * @generated
     */
    public InfrastructureRequiredRoleEntityNameEditPart(View view) {
        super(view);
    }

...
/**
 * The Class OperationProvidedRoleEntityNameEditPart.
 * 
 * @generated
 */
public class OperationProvidedRoleEntityNameEditPart extends LabelEditPart implements ITextAwareEditPart,
        IBorderItemEditPart {
    ...
    static {
        registerSnapBackPosition(
                PalladioComponentModelVisualIDRegistry
                        .getType(de.uka.ipd.sdq.pcm.gmf.composite.edit.parts.OperationProvidedRoleEntityNameEditPart.VISUAL_ID),
                new Point(0, 0));
    }

    /**
     * Instantiates a new operation provided role entity name edit part.
     * 
     * @param view
     *            the view
     * @generated
     */
    public OperationProvidedRoleEntityNameEditPart(View view) {
        super(view);
    }

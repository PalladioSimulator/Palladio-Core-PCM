...
public class PalladioComponentModelElementTypes extends ElementInitializers {
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(UsageModel_1000, UsagemodelPackage.eINSTANCE
					.getUsageModel());

			elements.put(UsageScenario_2004, UsagemodelPackage.eINSTANCE
					.getUsageScenario());

			elements.put(ScenarioBehaviour_3014, UsagemodelPackage.eINSTANCE
			...
			elements.put(ClosedWorkload_3015, UsagemodelPackage.eINSTANCE
					.getClosedWorkload());

			elements.put(OpenWorkload_3016, UsagemodelPackage.eINSTANCE
					.getOpenWorkload());

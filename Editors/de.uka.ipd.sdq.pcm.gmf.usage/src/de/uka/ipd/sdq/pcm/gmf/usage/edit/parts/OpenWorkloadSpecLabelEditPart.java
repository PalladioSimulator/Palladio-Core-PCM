...
import org.palladiosimulator.pcm.dialogs.usage.OpenInterArrivalTimeDialog;
...
public class OpenWorkloadSpecLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenInterArrivalTimeDialog());
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(
                    PalladioComponentModelElementTypes.OpenWorkload_3016, getParserElement(),

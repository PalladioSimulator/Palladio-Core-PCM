...
/**
 * The Class UsageScenarioLabelEditPart.
 *
 * @generated
 */
public class UsageScenarioLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new usage scenario label edit part.
     *
     * @param view the view
     * @generated
     */
    public UsageScenarioLabelEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(
                    PalladioComponentModelElementTypes.UsageScenario_2004, getParserElement(),
                    PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.usage.edit.parts.UsageScenarioLabelEditPart.VISUAL_ID));
        }
        return parser;
    }

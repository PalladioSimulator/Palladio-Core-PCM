 ...
 * @generated
 */
public class ScenarioBehaviourScenarioBehaviourStepsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected EStructuralFeature getFeatureToSynchronize() {
        return UsagemodelPackage.eINSTANCE.getScenarioBehaviour_Actions_ScenarioBehaviour();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getScenarioBehaviourScenarioBehaviourStepsCompartment_7005SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getScenarioBehaviourScenarioBehaviourStepsCompartment_7005SemanticChildren((View) getHost().getModel());

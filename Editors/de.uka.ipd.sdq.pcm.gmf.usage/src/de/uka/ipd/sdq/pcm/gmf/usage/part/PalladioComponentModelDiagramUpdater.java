...
public class PalladioComponentModelDiagramUpdater {
	 ...
	 * @generated
	 */
	public static List getUsageScenarioUsageScenarioCompartment_7012SemanticChildren(
			View view) {
	 ...
	 * @generated
	 */
	public static List getScenarioBehaviourScenarioBehaviourStepsCompartment_7013SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.EMPTY_LIST;
		}
	...
	public static List getEntryLevelSystemCallSystemCallVariableUsageCompartment_7002SemanticChildren(
		...
		for (Iterator it = modelElement
				.getInputParameterUsages_EntryLevelSystemCall().iterator(); it
				.hasNext();) {
	...
	public static List getUsageModel_1000SemanticChildren(View view) {
		...
		List result = new LinkedList();
		for (Iterator it = modelElement.getUsageScenario_UsageModel()
				.iterator(); it.hasNext();) {

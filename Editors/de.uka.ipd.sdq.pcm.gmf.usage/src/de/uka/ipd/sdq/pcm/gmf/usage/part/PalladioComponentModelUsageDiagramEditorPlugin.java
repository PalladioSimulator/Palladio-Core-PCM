 ...
 * @generated
 */
public class PalladioComponentModelUsageDiagramEditorPlugin extends
		AbstractUIPlugin {
	...
	protected void fillItemProviderFactories(List factories) {
		...
		factories.add(new Qos_performanceItemProviderAdapterFactory());
		factories.add(new Qos_reliabilityItemProviderAdapterFactory());
		factories.add(new ParameterItemProviderAdapterFactory());
		factories.add(new SeffItemProviderAdapterFactory());
		factories.add(new Seff_performanceItemProviderAdapterFactory());
		factories.add(new Seff_reliabilityItemProviderAdapterFactory());

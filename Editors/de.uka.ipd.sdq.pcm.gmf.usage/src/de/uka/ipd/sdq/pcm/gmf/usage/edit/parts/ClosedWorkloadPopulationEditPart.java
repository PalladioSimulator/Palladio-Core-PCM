...
/**
 * The Class ClosedWorkloadPopulationEditPart.
 *
 * @generated
 */
public class ClosedWorkloadPopulationEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new closed workload population edit part.
     *
     * @param view the view
     * @generated
     */
    public ClosedWorkloadPopulationEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = PalladioComponentModelParserProvider
                    .getParser(
                            PalladioComponentModelElementTypes.ClosedWorkload_3015,
                            getParserElement(),
                            PalladioComponentModelVisualIDRegistry
                                    .getType(de.uka.ipd.sdq.pcm.gmf.usage.edit.parts.ClosedWorkloadPopulationEditPart.VISUAL_ID));
        }
        return parser;
    }

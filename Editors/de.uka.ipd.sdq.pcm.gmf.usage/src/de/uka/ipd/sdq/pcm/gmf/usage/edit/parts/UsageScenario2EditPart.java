...
public class UsageScenario2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UsageScenario2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UsageScenarioLabelEditPart) {
			((UsageScenarioLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureUsageScenarioLabelName());
			return true;
		}
		return false;
	}
	...
	public class UsageScenarioFigure extends RectangleFigure {
		...
		public UsageScenarioFigure() {
			...
			this.setBorder(new CompoundBorder(new LineBorder(null, getMapMode()
					.DPtoLP(3)), new MarginBorder(getMapMode().DPtoLP(4),
		...
		private void createContents() {
			...
			fFigureUsageScenarioLabelName.setMaximumSize(new Dimension(
					getMapMode().DPtoLP(300), getMapMode().DPtoLP(40)));
			fFigureUsageScenarioLabelName.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(30), getMapMode().DPtoLP(40)));

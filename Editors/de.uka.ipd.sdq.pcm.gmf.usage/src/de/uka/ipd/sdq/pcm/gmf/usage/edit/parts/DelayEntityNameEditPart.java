...
/**
 * The Class DelayEntityNameEditPart.
 *
 * @generated
 */
public class DelayEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    /**
     * Instantiates a new delay entity name edit part.
     *
     * @param view the view
     * @generated
     */
    public DelayEntityNameEditPart(View view) {
        super(view);
    }
        ...
        if (parser == null) {
            parser = PalladioComponentModelParserProvider.getParser(PalladioComponentModelElementTypes.Delay_3017,
                    getParserElement(), PalladioComponentModelVisualIDRegistry
                            .getType(de.uka.ipd.sdq.pcm.gmf.usage.edit.parts.DelayEntityNameEditPart.VISUAL_ID));
        }
        return parser;
    }

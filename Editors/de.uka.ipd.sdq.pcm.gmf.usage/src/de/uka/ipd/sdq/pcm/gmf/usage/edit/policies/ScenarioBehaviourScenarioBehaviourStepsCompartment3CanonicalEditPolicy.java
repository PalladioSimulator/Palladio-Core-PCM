...
public class ScenarioBehaviourScenarioBehaviourStepsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getScenarioBehaviourScenarioBehaviourStepsCompartment_7008SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<PalladioComponentModelNodeDescriptor> childDescriptors = PalladioComponentModelDiagramUpdater
                .getScenarioBehaviourScenarioBehaviourStepsCompartment_7008SemanticChildren((View) getHost().getModel());

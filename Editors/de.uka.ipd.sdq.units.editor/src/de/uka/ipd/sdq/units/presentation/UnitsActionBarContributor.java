...
/**
 * This is the action bar contributor for the Units model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class UnitsActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(UnitsEditorPlugin.INSTANCE.getString("_UI_UnitsEditor_menu"),

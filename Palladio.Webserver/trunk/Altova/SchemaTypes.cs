...
namespace Altova.Types
{
	...
	public class SchemaDouble : ISchemaTypeNumber
	{
		...
		public override string ToString()
		{
			if( isEmpty )
				return "";
			return myValue.ToString(CultureInfo.InvariantCulture);
		}
	...
	public class SchemaDateTime : SchemaCalendarBase
	{
		...
		public override SchemaTime TimeValue()
		{
			...
			return new SchemaTime( myValue.Hour, myValue.Minute, myValue.Second, (double)myValue.Millisecond);
		}
	...
	public class SchemaBase64Binary : SchemaBinaryBase
	{
		...
		public override void Parse( string newvalue )
		{
			...
			sValue.Replace( " ","" );
			sValue.Replace( "\t","" );
			for( int i = newvalue.Length % 4; i != 0 && i < 4; i++ )
				newvalue += "="; // concat pad-chars up to a complete base64 number
			// convert to array of bytes
			myValue = Convert.FromBase64String( newvalue );
			isEmpty = false;
		}
		#endregion // Get, Set

...
{
	public class ActiveType : Altova.Xml.Node
	{
		#region Forward constructors
		public ActiveType() : base() { SetCollectionParents(); }
		public ActiveType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ActiveType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ActiveType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class ValueEnumerator: IEnumerator 
        {
			int nIndex;
			ActiveType parent;
			public ValueEnumerator(ActiveType par) 
			{
				parent = par;
				nIndex = -1;
			}

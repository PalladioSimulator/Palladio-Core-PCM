...
{
	public class FieldNameType : Altova.Xml.Node
	{
		#region Forward constructors
		public FieldNameType() : base() { SetCollectionParents(); }
		public FieldNameType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public FieldNameType(XmlNode node) : base(node) { SetCollectionParents(); }
		public FieldNameType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            FieldNameType parent;
            public FieldNameType Parent
			{
				set
				{
					parent = value;
        ...
        public class NameEnumerator: IEnumerator 
        {
			int nIndex;
			FieldNameType parent;
			public NameEnumerator(FieldNameType par) 
			{
				parent = par;
				nIndex = -1;
			}

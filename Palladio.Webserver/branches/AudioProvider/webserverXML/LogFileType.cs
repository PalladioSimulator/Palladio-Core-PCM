...
{
	public class LogFileType : Altova.Xml.Node
	{
		#region Forward constructors
		public LogFileType() : base() { SetCollectionParents(); }
		public LogFileType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public LogFileType(XmlNode node) : base(node) { SetCollectionParents(); }
		public LogFileType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class pathEnumerator: IEnumerator 
        {
			int nIndex;
			LogFileType parent;
			public pathEnumerator(LogFileType par) 
			{
				parent = par;
				nIndex = -1;
			}

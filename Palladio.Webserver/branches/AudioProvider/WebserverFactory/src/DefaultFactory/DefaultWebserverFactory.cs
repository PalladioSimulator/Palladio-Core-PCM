...
namespace Palladio.Webserver.WebserverFactory
{
	...
	public class DefaultWebserverFactory : IWebserverFactory
	{
		...
		/// <param name="webserverConfiguration">The Configuration of the actual webserver.</param>
		/// <returns>SimpleTemplateFileProvider</returns>
		public IHTTPRequestProcessor CreateAudioFileProvider (IHTTPRequestProcessor CorSuccessor, IWebserverMonitor webserverMonitor, IWebserverConfiguration webserverConfiguration, IHTTPRequestProcessorTools requestProcessorTools)
		{
			return new AudioFileProvider.AudioFileProvider(CorSuccessor, webserverMonitor, webserverConfiguration, requestProcessorTools);
		}

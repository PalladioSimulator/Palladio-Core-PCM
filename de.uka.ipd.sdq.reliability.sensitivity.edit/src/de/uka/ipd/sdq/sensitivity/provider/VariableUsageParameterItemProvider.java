...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.sensitivity.VariableUsageParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableUsageParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableUsageParameter_VariableName_feature", "_UI_VariableUsageParameter_type"),
				 SensitivityPackage.Literals.VARIABLE_USAGE_PARAMETER__VARIABLE_NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Entry Level System Call Variable Usage Parameter feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableUsageParameter_entryLevelSystemCall__VariableUsageParameter_feature", "_UI_VariableUsageParameter_type"),
	...
	/**
	 * This adds a property descriptor for the Variable Characterisation Type Variable Usage Parameter feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableUsageParameter_variableCharacterisationType__VariableUsageParameter_feature", "_UI_VariableUsageParameter_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableUsageParameter_variableUsageType__VariableUsageParameter_feature", "_UI_VariableUsageParameter_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableUsageParameter_basicComponent__VariableUsageParameter_feature", "_UI_VariableUsageParameter_type"),
				 SensitivityPackage.Literals.VARIABLE_USAGE_PARAMETER__BASIC_COMPONENT_VARIABLE_USAGE_PARAMETER,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns VariableUsageParameter.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {		
		...
		try {
			switch(((VariableUsageParameter)object).
					getVariableUsageType__VariableUsageParameter()) {
			case SYSTEM_CALL_INPUT:
				paramName = ((VariableUsageParameter)object).
					getEntryLevelSystemCall__VariableUsageParameter().getEntityName();
				break;
			case COMPONENT_CONFIGURATION:
				paramName = ((VariableUsageParameter)object).
					getBasicComponent__VariableUsageParameter().getEntityName();
				break;
			}
		} catch(Exception e) {}
		String inputCharacterisation = ((VariableUsageParameter)object).
			getVariableName() + "." + ((VariableUsageParameter)object).
			getVariableCharacterisationType__VariableUsageParameter().toString();
		return ((VariableUsageParameter)object).getEntityName()
			+ " (" + paramName + "/" + inputCharacterisation + ")"

...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.sensitivity.ResourceMTTRParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceMTTRParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceMTTRParameter_resourceContainer__ResourceMTTRParameter_feature", "_UI_ResourceMTTRParameter_type"),
				 SensitivityPackage.Literals.RESOURCE_MTTR_PARAMETER__RESOURCE_CONTAINER_RESOURCE_MTTR_PARAMETER,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Processing Resource Type Resource MTTR Parameter feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceMTTRParameter_processingResourceType__ResourceMTTRParameter_feature", "_UI_ResourceMTTRParameter_type"),
	...
	/**
	 * This returns ResourceMTTRParameter.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		try {
			resourceContainerName = ((ResourceMTTRParameter)object).
				getResourceContainer__ResourceMTTRParameter().getEntityName();
		} catch(Exception e) {}
		String resourceTypeName = "UNSPECIFIED";
		try {
			resourceTypeName = ((ResourceMTTRParameter)object).
				getProcessingResourceType__ResourceMTTRParameter().getEntityName();
		} catch(Exception e) {}
		return ((ResourceMTTRParameter)object).getEntityName()

...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.sensitivity.DoubleOffsetSequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DoubleOffsetSequenceItemProvider
	...
	/**
	 * This adds a property descriptor for the Offset Values feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DoubleOffsetSequence_offsetValues_feature", "_UI_DoubleOffsetSequence_type"),
				 SensitivityPackage.Literals.DOUBLE_OFFSET_SEQUENCE__OFFSET_VALUES,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DoubleOffsetSequence_doubleOffsetType__DoubleOffsetSequence_feature", "_UI_DoubleOffsetSequence_type"),
				 SensitivityPackage.Literals.DOUBLE_OFFSET_SEQUENCE__DOUBLE_OFFSET_TYPE_DOUBLE_OFFSET_SEQUENCE,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns DoubleOffsetSequence.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		try {
			...
			doubleSequence = offsetType + values.get(0).toString() + " ... "
				+ offsetType + values.get(values.size() - 1).toString();
		} catch(Exception e) {}

...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.sensitivity.DoubleParameterRange}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DoubleParameterRangeItemProvider extends DoubleParameterVariationItemProvider implements
    ...
    protected void addConsiderStepSizePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                SensitivityPackage.Literals.DOUBLE_PARAMETER_RANGE__CONSIDER_STEP_SIZE, true, false, false,
    ...
    protected void addFirstValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_DoubleParameterRange_firstValue_feature",
                        "_UI_DoubleParameterRange_type"),
                SensitivityPackage.Literals.DOUBLE_PARAMETER_RANGE__FIRST_VALUE, true, false, false,
    ...
    protected void addLastValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_DoubleParameterRange_lastValue_feature",
                        "_UI_DoubleParameterRange_type"),
                SensitivityPackage.Literals.DOUBLE_PARAMETER_RANGE__LAST_VALUE, true, false, false,
                ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addStepSizePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_DoubleParameterRange_stepSize_feature",
                        "_UI_DoubleParameterRange_type"),
                SensitivityPackage.Literals.DOUBLE_PARAMETER_RANGE__STEP_SIZE, true, false, false,
                ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addStepCountPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_DoubleParameterRange_stepCount_feature",
                        "_UI_DoubleParameterRange_type"),
                SensitivityPackage.Literals.DOUBLE_PARAMETER_RANGE__STEP_COUNT, true, false, false,

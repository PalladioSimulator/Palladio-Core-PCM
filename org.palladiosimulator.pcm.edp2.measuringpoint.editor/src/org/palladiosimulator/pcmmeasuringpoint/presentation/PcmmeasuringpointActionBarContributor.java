...
/**
 * This is the action bar contributor for the Pcmmeasuringpoint model editor. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PcmmeasuringpointActionBarContributor extends EditingDomainActionBarContributor implements
ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
            PcmmeasuringpointEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                PcmmeasuringpointActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
            PcmmeasuringpointEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return PcmmeasuringpointActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (PcmmeasuringpointActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) PcmmeasuringpointActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
     ...
     * @generated
     */
    public PcmmeasuringpointActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("pcmmeasuringpoint-settings"));
        toolBarManager.add(new Separator("pcmmeasuringpoint-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                PcmmeasuringpointEditorPlugin.INSTANCE.getString("_UI_PcmmeasuringpointEditor_menu"),
                "org.palladiosimulator.pcmmeasuringpointMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                PcmmeasuringpointEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                PcmmeasuringpointEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(final IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(PcmmeasuringpointEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));

...
public class AggregatedCommunicationItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCommunicationPartner_AggregatedCommunicationPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Communication Partner Aggregated Communication feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCommunicationPartner_AggregatedCommunicationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AggregatedCommunication_communicationPartner_AggregatedCommunication_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AggregatedCommunication_communicationPartner_AggregatedCommunication_feature", "_UI_AggregatedCommunication_type"),
				 AggregatedUsageContextPackage.Literals.AGGREGATED_COMMUNICATION__COMMUNICATION_PARTNER_AGGREGATED_COMMUNICATION,
				 true,
				 false,
				 true,
				 null,

...
public class OptionImpl extends EObjectImpl implements Option {
    ...
    public void setProbability(double newProbability) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ResourceModelPackage.OPTION__PROBABILITY,
    ...
    public void setResourceUsage(AbstractResourceUsage newResourceUsage) {
        if (newResourceUsage != resourceUsage) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ResourceModelPackage.OPTION__RESOURCE_USAGE,

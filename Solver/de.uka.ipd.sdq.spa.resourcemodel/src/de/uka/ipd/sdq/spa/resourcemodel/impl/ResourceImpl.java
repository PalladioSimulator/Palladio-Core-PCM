 ...
 *   <li>{@link de.uka.ipd.sdq.spa.resourcemodel.impl.ResourceImpl#getNumberOfServers <em>Number Of Servers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ResourceImpl extends EObjectImpl implements Resource {
	...
	public void setNumberOfServers(int newNumberOfServers) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourceModelPackage.RESOURCE__NUMBER_OF_SERVERS, oldNumberOfServers, numberOfServers));
	}

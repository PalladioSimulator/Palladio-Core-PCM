 ...
 * <li>{@link de.uka.ipd.sdq.spa.resourcemodel.Resource#getNumberOfServers <em>Number Of Servers
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public interface Resource extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Number Of Servers</b></em>' attribute. <!-- begin-user-doc
     * -->
     * <p>
     * If the meaning of the '<em>Number Of Servers</em>' attribute isn't clear, there really should
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.spa.resourcemodel.Resource#getNumberOfServers
     * <em>Number Of Servers</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Number Of Servers</em>' attribute.

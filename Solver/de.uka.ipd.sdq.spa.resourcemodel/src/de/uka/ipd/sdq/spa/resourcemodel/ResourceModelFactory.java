...
public interface ResourceModelFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Sequential Resource Usage</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Alternative Resource Usage</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Resource Usage</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Processing Resource</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Delay Resource</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 

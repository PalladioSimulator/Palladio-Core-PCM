...
public class SeffVisitor extends SeffSwitch {
	...
	private RecoveryBlockActionHandler recoveryBlockActionHandler;
	...
	public SeffVisitor(ContextWrapper ctxWrp) {
		...
		recoveryBlockActionHandler=new RecoveryBlockActionHandler(this);
	}
	...
	@Override
	public Object caseRecoveryBlockAction(RecoveryBlockAction object) {
		logger.debug("Visit"+object.getClass().getSimpleName());
		recoveryBlockActionHandler.handle(object);
		return object;
	}
	/**

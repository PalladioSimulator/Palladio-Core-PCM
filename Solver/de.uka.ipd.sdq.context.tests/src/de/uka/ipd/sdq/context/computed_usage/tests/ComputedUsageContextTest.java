 ...
 * @generated
 */
public class ComputedUsageContextTest extends TestCase {
	 ...
	 * @generated
	 */
	protected ComputedUsageContext fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(ComputedUsageContextTest.class);
	}
	 ...
	 * @generated
	 */
	public ComputedUsageContextTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(ComputedUsageContext fixture) {
	 ...
	 * @generated
	 */
	protected ComputedUsageContext getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(ComputedUsageFactory.eINSTANCE.createComputedUsageContext());
	}

...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>computed_allocation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ComputedAllocationExample {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ComputedAllocationPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.computedallocation"));
				ComputedAllocationContext root = ComputedAllocationFactory.eINSTANCE.createComputedAllocationContext();

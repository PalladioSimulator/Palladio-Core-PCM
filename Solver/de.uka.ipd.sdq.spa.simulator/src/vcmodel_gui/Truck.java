...
public class Truck extends SimProcess {
	...
	*/
	private Vancarrier_1st_p_model myModel;
	/**
	...
	public Truck(Model owner, String name, boolean showInTrace) {
		...
		myModel = (Vancarrier_1st_p_model) owner;
	...
	public void lifeCycle() {
		...
		if (!myModel.idleVCQueue.isEmpty()) { // it is available
			...
			//have to cast it to VC because I get a SimProcess
			//returned back from the queue and not a special VC SimProcess
			VC vancarrier = (VC) myModel.idleVCQueue.first();

...
public class MarkovResultApproximation {
	...
	/**
	 * The accuracy (i.e., number of exact decimal places) of this
	 * approximation.
	 */
	 ...
	 */
	public MarkovResultApproximation(final double lowerBound,
	...
	/**
	 * Checks if the approximation fulfills a required accuracy (i.e., number of

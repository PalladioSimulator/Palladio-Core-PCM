 ...
 * <!-- end-user-doc -->
 * @see LqnCore.LqnCorePackage#getSchedulingType()
...
public enum SchedulingType implements Enumerator {
	...
	/**
	 * @generated This would appear if the latest LQN model would be read in. 
	 * However, I did not succeed in recreating the models automatically, so I have done it manually.  
	 */
	INF(7,"inf","inf");

 ...
 * <ul>
 *   <li>{@link LqnCore.impl.HistogramBinTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link LqnCore.impl.HistogramBinTypeImpl#getConf95 <em>Conf95</em>}</li>
 *   <li>{@link LqnCore.impl.HistogramBinTypeImpl#getConf99 <em>Conf99</em>}</li>
 *   <li>{@link LqnCore.impl.HistogramBinTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link LqnCore.impl.HistogramBinTypeImpl#getProb <em>Prob</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HistogramBinTypeImpl extends EObjectImpl implements HistogramBinType {
	...
	public void setBegin(Object newBegin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.HISTOGRAM_BIN_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setConf95(Object newConf95) {
		...
		conf95 = newConf95;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.HISTOGRAM_BIN_TYPE__CONF95, oldConf95, conf95));
	}
	...
	public void setConf99(Object newConf99) {
		...
		conf99 = newConf99;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.HISTOGRAM_BIN_TYPE__CONF99, oldConf99, conf99));
	}
	...
	public void setEnd(Object newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.HISTOGRAM_BIN_TYPE__END, oldEnd, end));
	}
	...
	public void setProb(Object newProb) {
		...
		prob = newProb;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.HISTOGRAM_BIN_TYPE__PROB, oldProb, prob));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LqnCorePackage.HISTOGRAM_BIN_TYPE__BEGIN:
				return getBegin();
			case LqnCorePackage.HISTOGRAM_BIN_TYPE__CONF95:
				return getConf95();
			case LqnCorePackage.HISTOGRAM_BIN_TYPE__CONF99:
				return getConf99();
			case LqnCorePackage.HISTOGRAM_BIN_TYPE__END:
				return getEnd();
			case LqnCorePackage.HISTOGRAM_BIN_TYPE__PROB:
				return getProb();
		}

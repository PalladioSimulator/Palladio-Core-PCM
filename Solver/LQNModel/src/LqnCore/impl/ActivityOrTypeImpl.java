 ...
 * <ul>
 *   <li>{@link LqnCore.impl.ActivityOrTypeImpl#getProb <em>Prob</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityOrTypeImpl extends ActivityTypeImpl implements ActivityOrType {
	...
	public void setProb(String newProb) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnCorePackage.ACTIVITY_OR_TYPE__PROB, oldProb, prob, !oldProbESet));
	}
	...
	public void unsetProb() {
		...
		probESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnCorePackage.ACTIVITY_OR_TYPE__PROB, oldProb, PROB_EDEFAULT, oldProbESet));
	}

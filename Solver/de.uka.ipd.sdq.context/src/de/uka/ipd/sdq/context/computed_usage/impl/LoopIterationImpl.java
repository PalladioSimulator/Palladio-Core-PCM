 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.LoopIterationImpl#getLoopaction_LoopIteration <em>Loopaction Loop Iteration</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.impl.LoopIterationImpl#getSpecification_LoopIteration <em>Specification Loop Iteration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoopIterationImpl extends EObjectImpl implements LoopIteration {
	...
	/**
	 * The cached value of the '{@link #getSpecification_LoopIteration() <em>Specification Loop Iteration</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
		...
		if (loopaction_LoopIteration != null && loopaction_LoopIteration.eIsProxy()) {
			...
			if (loopaction_LoopIteration != oldLoopaction_LoopIteration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComputedUsagePackage.LOOP_ITERATION__LOOPACTION_LOOP_ITERATION, oldLoopaction_LoopIteration, loopaction_LoopIteration));
			}
		}
	...
	public void setLoopaction_LoopIteration(AbstractLoopAction newLoopaction_LoopIteration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComputedUsagePackage.LOOP_ITERATION__LOOPACTION_LOOP_ITERATION, oldLoopaction_LoopIteration, loopaction_LoopIteration));
	}
	...
	public void setSpecification_LoopIteration(PCMRandomVariable newSpecification_LoopIteration) {
		if (newSpecification_LoopIteration != specification_LoopIteration) {
			...
			if (specification_LoopIteration != null)
				msgs = ((InternalEObject)specification_LoopIteration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComputedUsagePackage.LOOP_ITERATION__SPECIFICATION_LOOP_ITERATION, null, msgs);
			if (newSpecification_LoopIteration != null)
				msgs = ((InternalEObject)newSpecification_LoopIteration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComputedUsagePackage.LOOP_ITERATION__SPECIFICATION_LOOP_ITERATION, null, msgs);
			msgs = basicSetSpecification_LoopIteration(newSpecification_LoopIteration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComputedUsagePackage.LOOP_ITERATION__SPECIFICATION_LOOP_ITERATION, newSpecification_LoopIteration, newSpecification_LoopIteration));
	}

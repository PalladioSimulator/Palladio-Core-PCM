 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.ComputedAggregatedUsageImpl#getServiceExecutionContexts_ComputedAggregatedUsage
...
public class ComputedAggregatedUsageImpl extends EObjectImpl implements ComputedAggregatedUsage {
    ...
    public EList<ServiceExecutionContext> getServiceExecutionContexts_ComputedAggregatedUsage() {
        if (serviceExecutionContexts_ComputedAggregatedUsage == null) {
            serviceExecutionContexts_ComputedAggregatedUsage = new EObjectContainmentEList<ServiceExecutionContext>(
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case AggregatedUsageContextPackage.COMPUTED_AGGREGATED_USAGE__SERVICE_EXECUTION_CONTEXTS_COMPUTED_AGGREGATED_USAGE:
            return ((InternalEList<?>) getServiceExecutionContexts_ComputedAggregatedUsage()).basicRemove(otherEnd,
                    msgs);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case AggregatedUsageContextPackage.COMPUTED_AGGREGATED_USAGE__SERVICE_EXECUTION_CONTEXTS_COMPUTED_AGGREGATED_USAGE:
            ...
            getServiceExecutionContexts_ComputedAggregatedUsage().addAll(
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case AggregatedUsageContextPackage.COMPUTED_AGGREGATED_USAGE__SERVICE_EXECUTION_CONTEXTS_COMPUTED_AGGREGATED_USAGE:
            return serviceExecutionContexts_ComputedAggregatedUsage != null
                    && !serviceExecutionContexts_ComputedAggregatedUsage.isEmpty();
        }

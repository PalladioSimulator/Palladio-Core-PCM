...
public class AggregatedUsageContextPackageImpl extends EPackageImpl implements AggregatedUsageContextPackage {
	...
	public void createPackageContents() {
		...
		createEReference(serviceExecutionContextEClass, SERVICE_EXECUTION_CONTEXT__SENT_AGGREGATED_COMMUNICATIONS_SERVICE_EXECUTION_CONTEXT);
		createEReference(serviceExecutionContextEClass, SERVICE_EXECUTION_CONTEXT__RECEIVED_AGGREGATED_COMMUNICATION_AGGREGATED_COMMUNICATION);
	...
	public void initializePackageContents() {
		...
		initEReference(getServiceExecutionContext_ReceivedAggregatedCommunication_AggregatedCommunication(), this.getAggregatedCommunication(), this.getAggregatedCommunication_Receiver_AggregatedCommunication(), "receivedAggregatedCommunication_AggregatedCommunication", null, 0, -1, ServiceExecutionContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getAggregatedCommunication_Receiver_AggregatedCommunication(), this.getServiceExecutionContext(), this.getServiceExecutionContext_ReceivedAggregatedCommunication_AggregatedCommunication(), "receiver_AggregatedCommunication", null, 1, 1, AggregatedCommunication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

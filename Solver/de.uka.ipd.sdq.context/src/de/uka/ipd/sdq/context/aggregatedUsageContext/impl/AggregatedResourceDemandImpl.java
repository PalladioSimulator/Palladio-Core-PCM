 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.AggregatedResourceDemandImpl#getAggregatedResourceDemand
 * <em>Aggregated Resource Demand</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.context.aggregatedUsageContext.impl.AggregatedResourceDemandImpl#getResourceType_AggregatedResourceDemand
...
public class AggregatedResourceDemandImpl extends EObjectImpl implements AggregatedResourceDemand {
    ...
    public void setAggregatedResourceDemand(double newAggregatedResourceDemand) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ...
                    oldAggregatedResourceDemand, aggregatedResourceDemand));
    }
            ...
            if (resourceType_AggregatedResourceDemand != oldResourceType_AggregatedResourceDemand) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(
                            ...
                            oldResourceType_AggregatedResourceDemand, resourceType_AggregatedResourceDemand));
            }
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case AggregatedUsageContextPackage.AGGREGATED_RESOURCE_DEMAND__RESOURCE_TYPE_AGGREGATED_RESOURCE_DEMAND:
            if (resolve)
                return getResourceType_AggregatedResourceDemand();

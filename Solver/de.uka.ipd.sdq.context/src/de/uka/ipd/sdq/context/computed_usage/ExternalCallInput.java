 ...
 *   <li>{@link de.uka.ipd.sdq.context.computed_usage.ExternalCallInput#getComputedUsageContext_ExternalCallInput <em>Computed Usage Context External Call Input</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ExternalCallInput extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Computed Usage Context External Call Input</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link de.uka.ipd.sdq.context.computed_usage.ComputedUsageContext#getExternalCallInput_ComputedUsageContext <em>External Call Input Computed Usage Context</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Computed Usage Context External Call Input</em>' container reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Computed Usage Context External Call Input</em>' container reference.
	 ...
	 * @model opposite="externalCallInput_ComputedUsageContext" required="true" transient="false" ordered="false"
	 * @generated
	 */
	ComputedUsageContext getComputedUsageContext_ExternalCallInput();

	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.context.computed_usage.ExternalCallInput#getComputedUsageContext_ExternalCallInput <em>Computed Usage Context External Call Input</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Computed Usage Context External Call Input</em>' container reference.

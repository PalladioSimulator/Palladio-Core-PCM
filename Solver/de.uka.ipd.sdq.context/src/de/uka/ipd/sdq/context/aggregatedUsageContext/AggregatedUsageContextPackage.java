...
public interface AggregatedUsageContextPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Aggregated Communications Service Execution Context</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SERVICE_EXECUTION_CONTEXT__AGGREGATED_COMMUNICATIONS_SERVICE_EXECUTION_CONTEXT = 5;
	 ...
	 * @ordered
	 */
	int SERVICE_EXECUTION_CONTEXT_FEATURE_COUNT = 6;
	...
	/**
	 * The feature id for the '<em><b>Communication Partner Aggregated Communication</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int AGGREGATED_COMMUNICATION__COMMUNICATION_PARTNER_AGGREGATED_COMMUNICATION = 2;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.context.aggregatedUsageContext.ServiceExecutionContext#getAggregatedCommunications_ServiceExecutionContext <em>Aggregated Communications Service Execution Context</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Aggregated Communications Service Execution Context</em>'.
	 * @see de.uka.ipd.sdq.context.aggregatedUsageContext.ServiceExecutionContext#getAggregatedCommunications_ServiceExecutionContext()
	 * @see #getServiceExecutionContext()
	 * @generated
	 */
	EReference getServiceExecutionContext_AggregatedCommunications_ServiceExecutionContext();
	...
	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.context.aggregatedUsageContext.AggregatedCommunication#getCommunicationPartner_AggregatedCommunication <em>Communication Partner Aggregated Communication</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Communication Partner Aggregated Communication</em>'.
	 * @see de.uka.ipd.sdq.context.aggregatedUsageContext.AggregatedCommunication#getCommunicationPartner_AggregatedCommunication()
	 * @see #getAggregatedCommunication()
	 * @generated
	 */
	EReference getAggregatedCommunication_CommunicationPartner_AggregatedCommunication();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Aggregated Communications Service Execution Context</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference SERVICE_EXECUTION_CONTEXT__AGGREGATED_COMMUNICATIONS_SERVICE_EXECUTION_CONTEXT = eINSTANCE.getServiceExecutionContext_AggregatedCommunications_ServiceExecutionContext();
		...
		/**
		 * The meta object literal for the '<em><b>Communication Partner Aggregated Communication</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference AGGREGATED_COMMUNICATION__COMMUNICATION_PARTNER_AGGREGATED_COMMUNICATION = eINSTANCE.getAggregatedCommunication_CommunicationPartner_AggregatedCommunication();

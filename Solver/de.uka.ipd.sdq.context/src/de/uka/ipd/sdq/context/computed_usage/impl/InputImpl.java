 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.context.computed_usage.impl.InputImpl#getParameterChacterisations_Input
...
public class InputImpl extends EObjectImpl implements Input {
    ...
    public EList<VariableUsage> getParameterChacterisations_Input() {
        if (parameterChacterisations_Input == null) {
            parameterChacterisations_Input = new EObjectContainmentEList<VariableUsage>(VariableUsage.class, this,

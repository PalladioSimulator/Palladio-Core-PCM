 ...
 * @generated
 */
public class AggregatedUsageContextActionBarContributor extends EditingDomainActionBarContributor implements
    ...
    protected IAction showPropertiesViewAction = new Action(
            ContextEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
    ...
    protected IAction refreshViewerAction = new Action(
            ContextEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(
                ContextEditorPlugin.INSTANCE.getString("_UI_AggregatedUsageContextEditor_menu"),
                "de.uka.ipd.sdq.context.aggregatedUsageContextMenuID");
        ...
        createSiblingMenuManager = new MenuManager(
                ContextEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

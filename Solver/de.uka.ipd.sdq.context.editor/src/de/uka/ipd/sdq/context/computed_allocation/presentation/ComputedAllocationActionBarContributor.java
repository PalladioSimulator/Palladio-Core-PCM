...
/**
 * This is the action bar contributor for the ComputedAllocation model editor. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ComputedAllocationActionBarContributor extends EditingDomainActionBarContributor implements
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(
                ContextEditorPlugin.INSTANCE.getString("_UI_ComputedAllocationEditor_menu"),
                "de.uka.ipd.sdq.context.computed_allocationMenuID");

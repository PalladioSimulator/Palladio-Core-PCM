...
public class taskmodelPackageImpl extends EPackageImpl implements taskmodelPackage {
	...
	public static taskmodelPackage init() {
		...
		taskmodelPackageImpl thetaskmodelPackage = (taskmodelPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof taskmodelPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new taskmodelPackageImpl());

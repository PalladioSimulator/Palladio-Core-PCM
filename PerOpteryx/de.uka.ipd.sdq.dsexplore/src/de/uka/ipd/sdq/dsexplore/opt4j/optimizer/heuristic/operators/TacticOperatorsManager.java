...
public class TacticOperatorsManager {
	 ...
	 */
	private Collection<ITactic> heuristics = new ArrayList<ITactic>();
	...
	public TacticOperatorsManager(Copy<Genotype> copy, DSEIndividualBuilder individualBuilder) {
		...
		writer.writeToLogFile("Tactic;Candidate id;Parent id;Candidate genome (several cols);Parent genome (several cols);Utilization value and whether returned;Info\n");
	}

...
public class DSEAnalysisMethodTab extends AbstractLaunchConfigurationTab {
	...
	private de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.Dimension qualityAttributeDimension;
	
	private String qualityAttributeId;
	
	public DSEAnalysisMethodTab(de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.Dimension qualityAttributeDimension) {
		super();
		
		this.qualityAttributeDimension = qualityAttributeDimension;
		this.qualityAttributeId = qualityAttributeDimension.getId();
	}
	...
	@Override
	public String getId(){
		return this.qualityAttributeId;
	}
	...
	public String getName() {
		return this.qualityAttributeDimension.getEntityName() + " Analysis Method";
	}

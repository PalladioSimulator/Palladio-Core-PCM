...
public class EMFHelper {
	 ...
	 */
	public static boolean contains(Collection<? extends Identifier> coll, Identifier i){
		for (Identifier identifier : coll) {
	...
	public static List<AssemblyContext> getAllUsedAssemblyContexts(ComposedProvidingRequiringEntity composite){
		...
		List<AssemblyContext> currentAssemblyContexts = composite.getAssemblyContexts_ComposedStructure();

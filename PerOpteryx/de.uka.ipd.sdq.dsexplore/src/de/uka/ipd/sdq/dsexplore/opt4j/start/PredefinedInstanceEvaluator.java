...
public abstract class PredefinedInstanceEvaluator {
	...
	//		}
			...
			ResultsWriter.writeDSEIndividualsToFile(individuals, this.resultFolder+"allCandidates", 1, exceptionList);
			
			ResultsWriter.writeDSEIndividualsToFile(optimalCandidates, this.resultFolder+"optimalCandidates", 1, exceptionList);

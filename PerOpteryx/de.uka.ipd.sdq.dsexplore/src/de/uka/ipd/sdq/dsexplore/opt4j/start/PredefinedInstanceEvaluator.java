...
public abstract class PredefinedInstanceEvaluator {
	...
	public PredefinedInstanceEvaluator(DSEWorkflowConfiguration dseConfig, DecisionSpace problem) throws CoreException {
		super();
	...
	public void start() throws CoreException {
			...
			for (DesignDecisionGenotype genotype : this.genotypes) {
				...
				DSEIndividual i = new NonListenableIndividual(problem);

...
public class UnorderedPrimitiveDegreeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(designdecisionPackage.Literals.UNORDERED_PRIMITIVE_DEGREE__PRIMITIVE_VALUES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnorderedPrimitiveDegree.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(designdecisionPackage.Literals.UNORDERED_PRIMITIVE_DEGREE__PRIMITIVE_VALUES,

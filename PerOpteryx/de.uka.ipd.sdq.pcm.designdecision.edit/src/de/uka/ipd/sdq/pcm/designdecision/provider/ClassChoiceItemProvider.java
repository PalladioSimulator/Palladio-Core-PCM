 ...
 * @generated
 */
public class ClassChoiceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClassChoice_entity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClassChoice_entity_feature", "_UI_ClassChoice_type"),
				 designdecisionPackage.Literals.CLASS_CHOICE__ENTITY,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Object labelValue = ((ClassChoice)object).getValue();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ClassChoice_type") :
			getString("_UI_ClassChoice_type") + " " + label;
	}

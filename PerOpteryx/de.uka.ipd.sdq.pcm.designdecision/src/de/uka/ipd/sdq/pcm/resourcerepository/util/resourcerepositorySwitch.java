 ...
 * @generated
 */
public class resourcerepositorySwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case resourcerepositoryPackage.RESOURCE_DESCRIPTION_REPOSITORY: {
				ResourceDescriptionRepository resourceDescriptionRepository = (ResourceDescriptionRepository)theEObject;
				T result = caseResourceDescriptionRepository(resourceDescriptionRepository);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resource Description Repository</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resource Description Repository</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResourceDescriptionRepository(ResourceDescriptionRepository object) {
		return null;
	}

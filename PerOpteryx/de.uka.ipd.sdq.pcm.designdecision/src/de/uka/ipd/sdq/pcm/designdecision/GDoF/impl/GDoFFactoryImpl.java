...
public class GDoFFactoryImpl extends EFactoryImpl implements GDoFFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case GDoFPackage.GDO_FREPOSITORY: return createGDoFRepository();
			...
			case GDoFPackage.GENERIC_DEGREE_OF_FREEDOM: return createGenericDegreeOfFreedom();
			default:
	 ...
	 * @generated
	 */
	public GenericDegreeOfFreedom createGenericDegreeOfFreedom() {
		GenericDegreeOfFreedomImpl genericDegreeOfFreedom = new GenericDegreeOfFreedomImpl();
		return genericDegreeOfFreedom;
	}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Continuous Processing Rate Degree</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.designdecision.impl.ContinuousProcessingRateDegreeImpl#getProcessingresourcetype <em>Processingresourcetype</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContinuousProcessingRateDegreeImpl extends ContinuousRangeDegreeImpl implements ContinuousProcessingRateDegree {
	...
	protected EClass eStaticClass() {
		return designdecisionPackage.Literals.CONTINUOUS_PROCESSING_RATE_DEGREE;
	}
		...
		if (processingresourcetype != null && processingresourcetype.eIsProxy()) {
			...
			if (processingresourcetype != oldProcessingresourcetype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, designdecisionPackage.CONTINUOUS_PROCESSING_RATE_DEGREE__PROCESSINGRESOURCETYPE, oldProcessingresourcetype, processingresourcetype));
			}
		}
	...
	public void setProcessingresourcetype(ProcessingResourceType newProcessingresourcetype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, designdecisionPackage.CONTINUOUS_PROCESSING_RATE_DEGREE__PROCESSINGRESOURCETYPE, oldProcessingresourcetype, processingresourcetype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case designdecisionPackage.CONTINUOUS_PROCESSING_RATE_DEGREE__PROCESSINGRESOURCETYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ProcessingResourceDegree.class) {
			switch (derivedFeatureID) {
				case designdecisionPackage.CONTINUOUS_PROCESSING_RATE_DEGREE__PROCESSINGRESOURCETYPE: return designdecisionPackage.PROCESSING_RESOURCE_DEGREE__PROCESSINGRESOURCETYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ProcessingResourceDegree.class) {
			switch (baseFeatureID) {
				case designdecisionPackage.PROCESSING_RESOURCE_DEGREE__PROCESSINGRESOURCETYPE: return designdecisionPackage.CONTINUOUS_PROCESSING_RATE_DEGREE__PROCESSINGRESOURCETYPE;
				default: return -1;
			}
		}

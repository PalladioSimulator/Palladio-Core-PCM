...
public interface GDoFPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Changeable Container</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE_CONTAINER = 0;
	 ...
	 * @ordered
	 */
	int CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE = 1;
	 ...
	 * @ordered
	 */
	int CHANGEABLE_ELEMENT_DESCRIPTION__VALUE_RULE = 2;
	 ...
	 * @ordered
	 */
	int CHANGEABLE_ELEMENT_DESCRIPTION__SELECTION_RULE = 3;
	 ...
	 * @ordered
	 */
	int CHANGEABLE_ELEMENT_DESCRIPTION_FEATURE_COUNT = 4;
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GDoFRepositoryImpl <em>Repository</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GDoFRepositoryImpl
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GDoFPackageImpl#getGDoFRepository()
	 * @generated
	 */
	int GDO_FREPOSITORY = 6;
	...
	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GenericDegreeOfFreedomImpl <em>Generic Degree Of Freedom</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GenericDegreeOfFreedomImpl
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GDoFPackageImpl#getGenericDegreeOfFreedom()
	 * @generated
	 */
	int GENERIC_DEGREE_OF_FREEDOM = 9;
	 ...
	 * @ordered
	 */
	int GENERIC_DEGREE_OF_FREEDOM__NAME = 0;
	 ...
	 * @ordered
	 */
	int GENERIC_DEGREE_OF_FREEDOM__ADDED_ELEMENTS = 1;

	/**
	 * The feature id for the '<em><b>Changeable Element Description</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GENERIC_DEGREE_OF_FREEDOM__CHANGEABLE_ELEMENT_DESCRIPTION = 2;

	/**
	 * The feature id for the '<em><b>Interaction Constraint</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GENERIC_DEGREE_OF_FREEDOM__INTERACTION_CONSTRAINT = 3;
	 ...
	 * @ordered
	 */
	int GENERIC_DEGREE_OF_FREEDOM__PRIMARY_CHANGEABLE = 4;

	/**
	 * The number of structural features of the '<em>Generic Degree Of Freedom</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GENERIC_DEGREE_OF_FREEDOM_FEATURE_COUNT = 5;
	...
	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.ChangeableElementDescription#getChangeableContainer <em>Changeable Container</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Changeable Container</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.ChangeableElementDescription#getChangeableContainer()
	 * @see #getChangeableElementDescription()
	 * @generated
	 */
	EReference getChangeableElementDescription_ChangeableContainer();
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GDoFRepository <em>Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Repository</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.GDoFRepository
	 * @generated
	 */
	EClass getGDoFRepository();

	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GDoFRepository#getGdofs <em>Gdofs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Gdofs</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.GDoFRepository#getGdofs()
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom <em>Generic Degree Of Freedom</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Generic Degree Of Freedom</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom
	 * @generated
	 */
	EClass getGenericDegreeOfFreedom();

	/**
	 * Returns the meta object for the attribute '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getName()
	 * @see #getGenericDegreeOfFreedom()
	 * @generated
	 */
	EAttribute getGenericDegreeOfFreedom_Name();

	/**
	 * Returns the meta object for the reference list '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getAddedElements <em>Added Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Added Elements</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getAddedElements()
	 * @see #getGenericDegreeOfFreedom()
	 * @generated
	 */
	EReference getGenericDegreeOfFreedom_AddedElements();

	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getChangeableElementDescription <em>Changeable Element Description</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Changeable Element Description</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getChangeableElementDescription()
	 * @see #getGenericDegreeOfFreedom()
	 * @generated
	 */
	EReference getGenericDegreeOfFreedom_ChangeableElementDescription();

	/**
	 * Returns the meta object for the reference list '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getInteractionConstraint <em>Interaction Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Interaction Constraint</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getInteractionConstraint()
	 * @see #getGenericDegreeOfFreedom()
	 * @generated
	 */
	EReference getGenericDegreeOfFreedom_InteractionConstraint();

	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getPrimaryChangeable <em>Primary Changeable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Primary Changeable</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.GenericDegreeOfFreedom#getPrimaryChangeable()
	 * @see #getGenericDegreeOfFreedom()
	 * @generated
	 */
	EReference getGenericDegreeOfFreedom_PrimaryChangeable();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Changeable Container</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE_CONTAINER = eINSTANCE.getChangeableElementDescription_ChangeableContainer();
		...
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GDoFRepositoryImpl <em>Repository</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GDoFRepositoryImpl
		 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GDoFPackageImpl#getGDoFRepository()
		...
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GenericDegreeOfFreedomImpl <em>Generic Degree Of Freedom</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GenericDegreeOfFreedomImpl
		 * @see de.uka.ipd.sdq.pcm.designdecision.GDoF.impl.GDoFPackageImpl#getGenericDegreeOfFreedom()
		 * @generated
		 */
		EClass GENERIC_DEGREE_OF_FREEDOM = eINSTANCE.getGenericDegreeOfFreedom();
		 ...
		 * @generated
		 */
		EAttribute GENERIC_DEGREE_OF_FREEDOM__NAME = eINSTANCE.getGenericDegreeOfFreedom_Name();
		 ...
		 * @generated
		 */
		EReference GENERIC_DEGREE_OF_FREEDOM__ADDED_ELEMENTS = eINSTANCE.getGenericDegreeOfFreedom_AddedElements();

		/**
		 * The meta object literal for the '<em><b>Changeable Element Description</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference GENERIC_DEGREE_OF_FREEDOM__CHANGEABLE_ELEMENT_DESCRIPTION = eINSTANCE.getGenericDegreeOfFreedom_ChangeableElementDescription();

		/**
		 * The meta object literal for the '<em><b>Interaction Constraint</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference GENERIC_DEGREE_OF_FREEDOM__INTERACTION_CONSTRAINT = eINSTANCE.getGenericDegreeOfFreedom_InteractionConstraint();
		 ...
		 * @generated
		 */
		EReference GENERIC_DEGREE_OF_FREEDOM__PRIMARY_CHANGEABLE = eINSTANCE.getGenericDegreeOfFreedom_PrimaryChangeable();

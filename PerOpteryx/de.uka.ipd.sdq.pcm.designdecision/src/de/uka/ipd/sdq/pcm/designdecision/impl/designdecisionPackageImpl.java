...
public class designdecisionPackageImpl extends EPackageImpl implements designdecisionPackage {
	 ...
	 * @generated
	 */
	public EReference getDegreeOfFreedom_Gdof() {
	 ...
	 * @generated
	 */
	public EReference getClassDegree_DesignOptions() {
	 ...
	 * @generated
	 */
	public EReference getClassChoice_Entity() {
	...
	public void createPackageContents() {
		...
		createEReference(degreeOfFreedomEClass, DEGREE_OF_FREEDOM__GDOF);
		...
		createEReference(classDegreeEClass, CLASS_DEGREE__DESIGN_OPTIONS);

		classChoiceEClass = createEClass(CLASS_CHOICE);
		createEReference(classChoiceEClass, CLASS_CHOICE__ENTITY);
	...
	public void initializePackageContents() {
		...
		dataTypeDegreeEClass.getESuperTypes().add(this.getDegreeOfFreedom());
		classDegreeEClass.getESuperTypes().add(this.getDegreeOfFreedom());
		...
		initEReference(getDegreeOfFreedom_PrimaryChanged(), theEntityPackage.getEntity(), null, "primaryChanged", null, 1, 1, DegreeOfFreedom.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getDegreeOfFreedom_Gdof(), theGDoFPackage.getGenericDegreeOfFreedom(), null, "gdof", null, 1, 1, DegreeOfFreedom.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getChoice_IsActive(), ecorePackage.getEBoolean(), "isActive", null, 1, 1, Choice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getClassDegree_DesignOptions(), theEntityPackage.getEntity(), null, "designOptions", null, 1, -1, ClassDegree.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(classChoiceEClass, ClassChoice.class, "ClassChoice", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClassChoice_Entity(), theEntityPackage.getEntity(), null, "entity", null, 0, 1, ClassChoice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

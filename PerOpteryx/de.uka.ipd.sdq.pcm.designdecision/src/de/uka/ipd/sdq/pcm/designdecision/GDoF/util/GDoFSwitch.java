...
public class GDoFSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GDoFPackage.GDO_FREPOSITORY: {
			...
			case GDoFPackage.GENERIC_DEGREE_OF_FREEDOM: {
				GenericDegreeOfFreedom genericDegreeOfFreedom = (GenericDegreeOfFreedom)theEObject;
				T result = caseGenericDegreeOfFreedom(genericDegreeOfFreedom);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Generic Degree Of Freedom</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Generic Degree Of Freedom</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGenericDegreeOfFreedom(GenericDegreeOfFreedom object) {
		return null;
	}

...
public class TaskmodelFileNamesInputTab extends FileNamesInputTab {
	...
	public void createControl(Composite parent) {
		...
		this.createFileInputSection(container, modifyListener, "Design decision file", designDecisionExtension, textTaskModelFile);
	
		this.textTaskModelResult = new Text(container, SWT.SINGLE | SWT.BORDER);
		String[] taskmodelExtension = {"*.taskmodel"};
		this.createFileInputSection(container, modifyListener, "Output taskmodel file", taskmodelExtension, textTaskModelResult);

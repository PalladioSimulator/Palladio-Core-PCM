...
public class InsignificantSetQualityImprovementCriterion extends
	...
	public StringBuilder getOutputInformation() {
		...
		this.outputInformation.append("Criterion Name: Insignificant Set Quality Improvement" + '\n');
		for(AverageValuesArchive ava : this.averageValueArchive){
			this.outputInformation.append("Criteria - Average: " + ava.objective.getName() + " - " + ava.getCurrentAverage() + '\n');
			this.outputInformation.append("Difference current/required: " + ava.getCurrentAverageDifference()+ "/" + ava.requiredAveragesDifference + '\n');
		}
		this.outputInformation.append("Current Generation is compared with : " + this.pastIterationNumber + " iterations ago interation" + '\n');

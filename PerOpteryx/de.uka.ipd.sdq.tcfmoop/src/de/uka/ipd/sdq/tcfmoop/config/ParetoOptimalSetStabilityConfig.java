...
import de.uka.ipd.sdq.tcfmoop.terminationcriteria.ParetoOptimalSetStabilityCriterion.EvaluationMode;
...
public class ParetoOptimalSetStabilityConfig extends AbstractConfiguration {
	...
	public ParetoOptimalSetStabilityConfig() {
		this.criterionName = TerminationCriteriaNames.PARETO_OPTIMAL_SET_STABILITY;
	}
	...
	public boolean validateConfiguration() {
		if (this.criterionName != TerminationCriteriaNames.PARETO_OPTIMAL_SET_STABILITY

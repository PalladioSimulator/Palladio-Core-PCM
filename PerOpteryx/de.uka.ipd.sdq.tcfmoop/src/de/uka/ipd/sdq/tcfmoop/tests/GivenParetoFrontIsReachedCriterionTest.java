...
public class GivenParetoFrontIsReachedCriterionTest {
	...
	public void testGetEvaluationResult() {
		...
		gpfircrit = new GivenParetoFrontIsReachedCriterion();
		gpfircrit.initialize(gpfirconf, null, front25);
		...
		gpfircrit = new GivenParetoFrontIsReachedCriterion();
		gpfircrit.initialize(gpfirconf, null, front75);
		gpfircrit.evaluate(0, 0);
		...
		gpfircrit = new GivenParetoFrontIsReachedCriterion();
		gpfircrit.initialize(gpfirconf, null, front100);
		gpfircrit.evaluate(0, 0);
		assertTrue(gpfircrit.getEvaluationResult());
